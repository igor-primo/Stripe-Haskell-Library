...
deleteAccountsAccountExternalAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => DeleteAccountsAccountExternalAccountsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteAccountsAccountExternalAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
deleteAccountsAccountExternalAccountsId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteAccountsAccountExternalAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteAccountsAccountExternalAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       DeletedExternalAccount)
                                                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> DeleteAccountsAccountExternalAccountsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data DeleteAccountsAccountExternalAccountsIdParameters = DeleteAccountsAccountExternalAccountsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteAccountsAccountExternalAccountsIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathAccount" Data.Aeson.Types.ToJSON..= deleteAccountsAccountExternalAccountsIdParametersPathAccount obj] : ["pathId" Data.Aeson.Types.ToJSON..= deleteAccountsAccountExternalAccountsIdParametersPathId obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DeleteAccountsAccountExternalAccountsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteAccountsAccountExternalAccountsIdParameters" (\obj -> (GHC.Base.pure DeleteAccountsAccountExternalAccountsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId"))}
-- | Create a new 'DeleteAccountsAccountExternalAccountsIdParameters' with all required fields.
mkDeleteAccountsAccountExternalAccountsIdParameters :: Data.Text.Internal.Text -- ^ 'deleteAccountsAccountExternalAccountsIdParametersPathAccount'
  -> Data.Text.Internal.Text -- ^ 'deleteAccountsAccountExternalAccountsIdParametersPathId'
  -> DeleteAccountsAccountExternalAccountsIdParameters
mkDeleteAccountsAccountExternalAccountsIdParameters deleteAccountsAccountExternalAccountsIdParametersPathAccount deleteAccountsAccountExternalAccountsIdParametersPathId = DeleteAccountsAccountExternalAccountsIdParameters{deleteAccountsAccountExternalAccountsIdParametersPathAccount = deleteAccountsAccountExternalAccountsIdParametersPathAccount,
...
data DeleteAccountsAccountExternalAccountsIdResponse =
   DeleteAccountsAccountExternalAccountsIdResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
