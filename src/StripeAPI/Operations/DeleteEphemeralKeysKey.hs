...
deleteEphemeralKeysKey :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ key | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe DeleteEphemeralKeysKeyRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteEphemeralKeysKeyResponse) -- ^ Monadic computation which returns the result of the operation
deleteEphemeralKeysKey key
                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteEphemeralKeysKeyResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteEphemeralKeysKeyResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              EphemeralKey)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> DeleteEphemeralKeysKeyResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
...
data DeleteEphemeralKeysKeyRequestBody = DeleteEphemeralKeysKeyRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteEphemeralKeysKeyRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (deleteEphemeralKeysKeyRequestBodyExpand obj) : GHC.Base.mempty));
