...
deleteSubscriptionsSubscriptionExposedId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ subscription_exposed_id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe DeleteSubscriptionsSubscriptionExposedIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response DeleteSubscriptionsSubscriptionExposedIdResponse) -- ^ Monadic computation which returns the result of the operation
deleteSubscriptionsSubscriptionExposedId subscriptionExposedId
                                         body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either DeleteSubscriptionsSubscriptionExposedIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> DeleteSubscriptionsSubscriptionExposedIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Subscription)
                                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> DeleteSubscriptionsSubscriptionExposedIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
data DeleteSubscriptionsSubscriptionExposedIdRequestBody = DeleteSubscriptionsSubscriptionExposedIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteSubscriptionsSubscriptionExposedIdRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON DeleteSubscriptionsSubscriptionExposedIdRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteSubscriptionsSubscriptionExposedIdRequestBody" (\obj -> (((GHC.Base.pure DeleteSubscriptionsSubscriptionExposedIdRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cancellation_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice_now")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "prorate"))}
...
mkDeleteSubscriptionsSubscriptionExposedIdRequestBody = DeleteSubscriptionsSubscriptionExposedIdRequestBody{deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails = GHC.Maybe.Nothing,
...
data DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails' = DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("comment" Data.Aeson.Types.ToJSON..=)) (deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("feedback" Data.Aeson.Types.ToJSON..=)) (deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("comment" Data.Aeson.Types.ToJSON..=)) (deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("feedback" Data.Aeson.Types.ToJSON..=)) (deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'" (\obj -> (GHC.Base.pure DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "comment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "feedback"))}
...
mkDeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails' = DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'{deleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment = GHC.Maybe.Nothing,
...
data DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'Variants =
   DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'EmptyString -- ^ Represents the JSON value @""@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'Variants
    where {toJSON (DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Comment'EmptyString
...
data DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback' =
   DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumEmptyString -- ^ Represents the JSON value @""@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumCustomerService -- ^ Represents the JSON value @"customer_service"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumLowQuality -- ^ Represents the JSON value @"low_quality"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumMissingFeatures -- ^ Represents the JSON value @"missing_features"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumOther -- ^ Represents the JSON value @"other"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumSwitchedService -- ^ Represents the JSON value @"switched_service"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumTooComplex -- ^ Represents the JSON value @"too_complex"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumTooExpensive -- ^ Represents the JSON value @"too_expensive"@
  | DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumUnused -- ^ Represents the JSON value @"unused"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'
    where {toJSON (DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> DeleteSubscriptionsSubscriptionExposedIdRequestBodyCancellationDetails'Feedback'EnumEmptyString
