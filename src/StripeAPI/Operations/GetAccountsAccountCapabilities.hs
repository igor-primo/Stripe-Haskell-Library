...
getAccountsAccountCapabilities :: forall m . StripeAPI.Common.MonadHTTP m => GetAccountsAccountCapabilitiesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAccountsAccountCapabilitiesResponse) -- ^ Monadic computation which returns the result of the operation
getAccountsAccountCapabilities parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetAccountsAccountCapabilitiesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetAccountsAccountCapabilitiesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            GetAccountsAccountCapabilitiesResponseBody200)
                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetAccountsAccountCapabilitiesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                              Error)
...
data GetAccountsAccountCapabilitiesParameters = GetAccountsAccountCapabilitiesParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAccountsAccountCapabilitiesParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathAccount" Data.Aeson.Types.ToJSON..= getAccountsAccountCapabilitiesParametersPathAccount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getAccountsAccountCapabilitiesParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAccountsAccountCapabilitiesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountsAccountCapabilitiesParameters" (\obj -> (GHC.Base.pure GetAccountsAccountCapabilitiesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetAccountsAccountCapabilitiesParameters' with all required fields.
mkGetAccountsAccountCapabilitiesParameters :: Data.Text.Internal.Text -- ^ 'getAccountsAccountCapabilitiesParametersPathAccount'
  -> GetAccountsAccountCapabilitiesParameters
mkGetAccountsAccountCapabilitiesParameters getAccountsAccountCapabilitiesParametersPathAccount = GetAccountsAccountCapabilitiesParameters{getAccountsAccountCapabilitiesParametersPathAccount = getAccountsAccountCapabilitiesParametersPathAccount,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAccountsAccountCapabilitiesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAccountsAccountCapabilitiesResponseBody200" (\obj -> ((GHC.Base.pure GetAccountsAccountCapabilitiesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetAccountsAccountCapabilitiesResponseBody200' with all required fields.
mkGetAccountsAccountCapabilitiesResponseBody200 :: [Capability] -- ^ 'getAccountsAccountCapabilitiesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getAccountsAccountCapabilitiesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getAccountsAccountCapabilitiesResponseBody200Url'
  -> GetAccountsAccountCapabilitiesResponseBody200
mkGetAccountsAccountCapabilitiesResponseBody200 getAccountsAccountCapabilitiesResponseBody200Data getAccountsAccountCapabilitiesResponseBody200HasMore getAccountsAccountCapabilitiesResponseBody200Url = GetAccountsAccountCapabilitiesResponseBody200{getAccountsAccountCapabilitiesResponseBody200Data = getAccountsAccountCapabilitiesResponseBody200Data,
