...
getApplePayDomainsDomain :: forall m . StripeAPI.Common.MonadHTTP m => GetApplePayDomainsDomainParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetApplePayDomainsDomainResponse) -- ^ Monadic computation which returns the result of the operation
getApplePayDomainsDomain parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetApplePayDomainsDomainResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetApplePayDomainsDomainResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          ApplePayDomain)
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetApplePayDomainsDomainResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
...
data GetApplePayDomainsDomainParameters = GetApplePayDomainsDomainParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetApplePayDomainsDomainParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathDomain" Data.Aeson.Types.ToJSON..= getApplePayDomainsDomainParametersPathDomain obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getApplePayDomainsDomainParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetApplePayDomainsDomainParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetApplePayDomainsDomainParameters" (\obj -> (GHC.Base.pure GetApplePayDomainsDomainParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathDomain")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetApplePayDomainsDomainParameters' with all required fields.
mkGetApplePayDomainsDomainParameters :: Data.Text.Internal.Text -- ^ 'getApplePayDomainsDomainParametersPathDomain'
  -> GetApplePayDomainsDomainParameters
mkGetApplePayDomainsDomainParameters getApplePayDomainsDomainParametersPathDomain = GetApplePayDomainsDomainParameters{getApplePayDomainsDomainParametersPathDomain = getApplePayDomainsDomainParametersPathDomain,
