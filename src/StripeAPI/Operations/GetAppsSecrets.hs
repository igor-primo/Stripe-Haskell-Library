...
getAppsSecrets :: forall m . StripeAPI.Common.MonadHTTP m => GetAppsSecretsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetAppsSecretsResponse) -- ^ Monadic computation which returns the result of the operation
getAppsSecrets parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetAppsSecretsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetAppsSecretsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                            GetAppsSecretsResponseBody200)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetAppsSecretsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                              Error)
                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/apps/secrets" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getAppsSecretsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetAppsSecretsParameters = GetAppsSecretsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAppsSecretsParameters
...
data GetAppsSecretsParametersQueryScope' = GetAppsSecretsParametersQueryScope' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAppsSecretsParametersQueryScope'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["type" Data.Aeson.Types.ToJSON..= getAppsSecretsParametersQueryScope'Type obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user" Data.Aeson.Types.ToJSON..=)) (getAppsSecretsParametersQueryScope'User obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAppsSecretsParametersQueryScope'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAppsSecretsParametersQueryScope'" (\obj -> (GHC.Base.pure GetAppsSecretsParametersQueryScope' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user"))}
-- | Create a new 'GetAppsSecretsParametersQueryScope'' with all required fields.
mkGetAppsSecretsParametersQueryScope' :: GetAppsSecretsParametersQueryScope'Type' -- ^ 'getAppsSecretsParametersQueryScope'Type'
  -> GetAppsSecretsParametersQueryScope'
mkGetAppsSecretsParametersQueryScope' getAppsSecretsParametersQueryScope'Type = GetAppsSecretsParametersQueryScope'{getAppsSecretsParametersQueryScope'Type = getAppsSecretsParametersQueryScope'Type,
...
data GetAppsSecretsParametersQueryScope'Type' =
   GetAppsSecretsParametersQueryScope'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetAppsSecretsParametersQueryScope'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetAppsSecretsParametersQueryScope'Type'EnumAccount -- ^ Represents the JSON value @"account"@
  | GetAppsSecretsParametersQueryScope'Type'EnumUser -- ^ Represents the JSON value @"user"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAppsSecretsParametersQueryScope'Type'
    where {toJSON (GetAppsSecretsParametersQueryScope'Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAppsSecretsParametersQueryScope'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> GetAppsSecretsParametersQueryScope'Type'EnumAccount
...
data GetAppsSecretsResponse =
   GetAppsSecretsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetAppsSecretsResponse200 GetAppsSecretsResponseBody200 -- ^ Successful response.
  | GetAppsSecretsResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetAppsSecretsResponseBody200 = GetAppsSecretsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetAppsSecretsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getAppsSecretsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getAppsSecretsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getAppsSecretsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetAppsSecretsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetAppsSecretsResponseBody200" (\obj -> ((GHC.Base.pure GetAppsSecretsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetAppsSecretsResponseBody200' with all required fields.
mkGetAppsSecretsResponseBody200 :: [Apps'secret] -- ^ 'getAppsSecretsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getAppsSecretsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getAppsSecretsResponseBody200Url'
  -> GetAppsSecretsResponseBody200
mkGetAppsSecretsResponseBody200 getAppsSecretsResponseBody200Data getAppsSecretsResponseBody200HasMore getAppsSecretsResponseBody200Url = GetAppsSecretsResponseBody200{getAppsSecretsResponseBody200Data = getAppsSecretsResponseBody200Data,
