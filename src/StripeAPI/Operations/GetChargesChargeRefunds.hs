...
getChargesChargeRefunds :: forall m . StripeAPI.Common.MonadHTTP m => GetChargesChargeRefundsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetChargesChargeRefundsResponse) -- ^ Monadic computation which returns the result of the operation
getChargesChargeRefunds parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetChargesChargeRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetChargesChargeRefundsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       GetChargesChargeRefundsResponseBody200)
                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetChargesChargeRefundsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/charges/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getChargesChargeRefundsParametersPathCharge parameters))) GHC.Base.<> "/refunds")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "starting_after") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getChargesChargeRefundsParametersQueryStartingAfter parameters) (Data.Text.Internal.pack "form") GHC.Types.True])
...
instance Data.Aeson.Types.FromJSON.FromJSON GetChargesChargeRefundsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetChargesChargeRefundsParameters" (\obj -> ((((GHC.Base.pure GetChargesChargeRefundsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCharge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetChargesChargeRefundsParameters' with all required fields.
mkGetChargesChargeRefundsParameters :: Data.Text.Internal.Text -- ^ 'getChargesChargeRefundsParametersPathCharge'
  -> GetChargesChargeRefundsParameters
mkGetChargesChargeRefundsParameters getChargesChargeRefundsParametersPathCharge = GetChargesChargeRefundsParameters{getChargesChargeRefundsParametersPathCharge = getChargesChargeRefundsParametersPathCharge,
...
data GetChargesChargeRefundsResponse =
   GetChargesChargeRefundsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
...
data GetChargesChargeRefundsResponseBody200 = GetChargesChargeRefundsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetChargesChargeRefundsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getChargesChargeRefundsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getChargesChargeRefundsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getChargesChargeRefundsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetChargesChargeRefundsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetChargesChargeRefundsResponseBody200" (\obj -> ((GHC.Base.pure GetChargesChargeRefundsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetChargesChargeRefundsResponseBody200' with all required fields.
mkGetChargesChargeRefundsResponseBody200 :: [Refund] -- ^ 'getChargesChargeRefundsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getChargesChargeRefundsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getChargesChargeRefundsResponseBody200Url'
  -> GetChargesChargeRefundsResponseBody200
mkGetChargesChargeRefundsResponseBody200 getChargesChargeRefundsResponseBody200Data getChargesChargeRefundsResponseBody200HasMore getChargesChargeRefundsResponseBody200Url = GetChargesChargeRefundsResponseBody200{getChargesChargeRefundsResponseBody200Data = getChargesChargeRefundsResponseBody200Data,
