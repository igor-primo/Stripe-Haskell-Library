...
getCheckoutSessions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCheckoutSessionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCheckoutSessionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                           GetCheckoutSessionsResponseBody200)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCheckoutSessionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                             Error)
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/checkout/sessions" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "created") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCheckoutSessionsParametersQueryCreated parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCheckoutSessionsParameters" (\obj -> ((((((((((GHC.Base.pure GetCheckoutSessionsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCustomer_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPayment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPayment_link")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStatus")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "querySubscription"))}
...
mkGetCheckoutSessionsParameters = GetCheckoutSessionsParameters{getCheckoutSessionsParametersQueryCreated = GHC.Maybe.Nothing,
...
data GetCheckoutSessionsParametersQueryCreated'OneOf1 = GetCheckoutSessionsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCheckoutSessionsParametersQueryCreated'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getCheckoutSessionsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsParametersQueryCreated'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCheckoutSessionsParametersQueryCreated'OneOf1" (\obj -> (((GHC.Base.pure GetCheckoutSessionsParametersQueryCreated'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetCheckoutSessionsParametersQueryCreated'OneOf1 = GetCheckoutSessionsParametersQueryCreated'OneOf1{getCheckoutSessionsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetCheckoutSessionsParametersQueryCreated'Variants
    where {toJSON (GetCheckoutSessionsParametersQueryCreated'GetCheckoutSessionsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetCheckoutSessionsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsParametersQueryCreated'Variants
    where {parseJSON val = case (GetCheckoutSessionsParametersQueryCreated'GetCheckoutSessionsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetCheckoutSessionsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetCheckoutSessionsParametersQueryCustomerDetails' = GetCheckoutSessionsParametersQueryCustomerDetails' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCheckoutSessionsParametersQueryCustomerDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["email" Data.Aeson.Types.ToJSON..= getCheckoutSessionsParametersQueryCustomerDetails'Email obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsParametersQueryCustomerDetails'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCheckoutSessionsParametersQueryCustomerDetails'" (\obj -> GHC.Base.pure GetCheckoutSessionsParametersQueryCustomerDetails' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "email"))}
-- | Create a new 'GetCheckoutSessionsParametersQueryCustomerDetails'' with all required fields.
mkGetCheckoutSessionsParametersQueryCustomerDetails' :: Data.Text.Internal.Text -- ^ 'getCheckoutSessionsParametersQueryCustomerDetails'Email'
...
data GetCheckoutSessionsParametersQueryStatus' =
   GetCheckoutSessionsParametersQueryStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCheckoutSessionsParametersQueryStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCheckoutSessionsParametersQueryStatus'EnumComplete -- ^ Represents the JSON value @"complete"@
  | GetCheckoutSessionsParametersQueryStatus'EnumExpired -- ^ Represents the JSON value @"expired"@
  | GetCheckoutSessionsParametersQueryStatus'EnumOpen -- ^ Represents the JSON value @"open"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCheckoutSessionsParametersQueryStatus'
    where {toJSON (GetCheckoutSessionsParametersQueryStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsParametersQueryStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "complete" -> GetCheckoutSessionsParametersQueryStatus'EnumComplete
