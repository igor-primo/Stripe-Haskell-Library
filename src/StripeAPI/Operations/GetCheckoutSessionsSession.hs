...
getCheckoutSessionsSession :: forall m . StripeAPI.Common.MonadHTTP m => GetCheckoutSessionsSessionParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCheckoutSessionsSessionResponse) -- ^ Monadic computation which returns the result of the operation
getCheckoutSessionsSession parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCheckoutSessionsSessionResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCheckoutSessionsSessionResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                Checkout'session)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCheckoutSessionsSessionResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data GetCheckoutSessionsSessionParameters = GetCheckoutSessionsSessionParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCheckoutSessionsSessionParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCheckoutSessionsSessionParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCheckoutSessionsSessionParameters" (\obj -> (GHC.Base.pure GetCheckoutSessionsSessionParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathSession")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetCheckoutSessionsSessionParameters' with all required fields.
mkGetCheckoutSessionsSessionParameters :: Data.Text.Internal.Text -- ^ 'getCheckoutSessionsSessionParametersPathSession'
  -> GetCheckoutSessionsSessionParameters
mkGetCheckoutSessionsSessionParameters getCheckoutSessionsSessionParametersPathSession = GetCheckoutSessionsSessionParameters{getCheckoutSessionsSessionParametersPathSession = getCheckoutSessionsSessionParametersPathSession,
