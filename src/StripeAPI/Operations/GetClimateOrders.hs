...
getClimateOrders :: forall m . StripeAPI.Common.MonadHTTP m => GetClimateOrdersParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetClimateOrdersResponse) -- ^ Monadic computation which returns the result of the operation
getClimateOrders parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetClimateOrdersResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetClimateOrdersResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  GetClimateOrdersResponseBody200)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetClimateOrdersResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/climate/orders" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getClimateOrdersParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetClimateOrdersParameters = GetClimateOrdersParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetClimateOrdersParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetClimateOrdersParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetClimateOrdersParameters" (\obj -> (((GHC.Base.pure GetClimateOrdersParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetClimateOrdersParameters' with all required fields.
mkGetClimateOrdersParameters :: GetClimateOrdersParameters
mkGetClimateOrdersParameters = GetClimateOrdersParameters{getClimateOrdersParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
data GetClimateOrdersResponse =
   GetClimateOrdersResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetClimateOrdersResponse200 GetClimateOrdersResponseBody200 -- ^ Successful response.
  | GetClimateOrdersResponseDefault Error -- ^ Error response.
...
instance Data.Aeson.Types.FromJSON.FromJSON GetClimateOrdersResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetClimateOrdersResponseBody200" (\obj -> ((GHC.Base.pure GetClimateOrdersResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetClimateOrdersResponseBody200' with all required fields.
mkGetClimateOrdersResponseBody200 :: [Climate'order] -- ^ 'getClimateOrdersResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getClimateOrdersResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getClimateOrdersResponseBody200Url'
  -> GetClimateOrdersResponseBody200
mkGetClimateOrdersResponseBody200 getClimateOrdersResponseBody200Data getClimateOrdersResponseBody200HasMore getClimateOrdersResponseBody200Url = GetClimateOrdersResponseBody200{getClimateOrdersResponseBody200Data = getClimateOrdersResponseBody200Data,
