...
getCreditNotesPreviewLines :: forall m . StripeAPI.Common.MonadHTTP m => GetCreditNotesPreviewLinesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCreditNotesPreviewLinesResponse) -- ^ Monadic computation which returns the result of the operation
getCreditNotesPreviewLines parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCreditNotesPreviewLinesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCreditNotesPreviewLinesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                GetCreditNotesPreviewLinesResponseBody200)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCreditNotesPreviewLinesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/credit_notes/preview/lines" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "amount") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesPreviewLinesParametersQueryAmount parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "email_type") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesPreviewLinesParametersQueryEmailType parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "refunds") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCreditNotesPreviewLinesParametersQueryRefunds parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetCreditNotesPreviewLinesParameters = GetCreditNotesPreviewLinesParameters {
  ...
  -- | queryEmail_type: Represents the parameter named \'email_type\'
  -- 
  -- Type of email to send to the customer, one of \`credit_note\` or \`none\` and the default is \`credit_note\`.
  , getCreditNotesPreviewLinesParametersQueryEmailType :: (GHC.Maybe.Maybe GetCreditNotesPreviewLinesParametersQueryEmailType')
  ...
  -- | queryRefunds: Represents the parameter named \'refunds\'
  -- 
  -- Refunds to link to this credit note.
  , getCreditNotesPreviewLinesParametersQueryRefunds :: (GHC.Maybe.Maybe [GetCreditNotesPreviewLinesParametersQueryRefunds'])
...
mkGetCreditNotesPreviewLinesParameters getCreditNotesPreviewLinesParametersQueryInvoice = GetCreditNotesPreviewLinesParameters{getCreditNotesPreviewLinesParametersQueryAmount = GHC.Maybe.Nothing,
                                                                                                                               ...
                                                                                                                               getCreditNotesPreviewLinesParametersQueryEmailType = GHC.Maybe.Nothing,
                                                                                                                               ...
                                                                                                                               getCreditNotesPreviewLinesParametersQueryRefunds = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @paths.\/v1\/credit_notes\/preview\/lines.GET.parameters.properties.queryEmail_type@ in the specification.
-- 
-- Represents the parameter named \'email_type\'
-- 
-- Type of email to send to the customer, one of \`credit_note\` or \`none\` and the default is \`credit_note\`.
data GetCreditNotesPreviewLinesParametersQueryEmailType' =
   GetCreditNotesPreviewLinesParametersQueryEmailType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCreditNotesPreviewLinesParametersQueryEmailType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCreditNotesPreviewLinesParametersQueryEmailType'EnumCreditNote -- ^ Represents the JSON value @"credit_note"@
  | GetCreditNotesPreviewLinesParametersQueryEmailType'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryEmailType'
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryEmailType'Other val) = val;
           toJSON (GetCreditNotesPreviewLinesParametersQueryEmailType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (GetCreditNotesPreviewLinesParametersQueryEmailType'EnumCreditNote) = "credit_note";
           toJSON (GetCreditNotesPreviewLinesParametersQueryEmailType'EnumNone) = "none"}
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryEmailType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_note" -> GetCreditNotesPreviewLinesParametersQueryEmailType'EnumCreditNote
                                             | val GHC.Classes.== "none" -> GetCreditNotesPreviewLinesParametersQueryEmailType'EnumNone
                                             | GHC.Base.otherwise -> GetCreditNotesPreviewLinesParametersQueryEmailType'Other val)}
...
data GetCreditNotesPreviewLinesParametersQueryLines' = GetCreditNotesPreviewLinesParametersQueryLines' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'
...
data GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1 = GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1Amount obj] : ["tax_rate" Data.Aeson.Types.ToJSON..= getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxRate obj] : ["taxable_amount" Data.Aeson.Types.ToJSON..= getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxableAmount obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1
...
mkGetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1 :: GHC.Types.Int -- ^ 'getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1Amount'
  -> Data.Text.Internal.Text -- ^ 'getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxRate'
  -> GHC.Types.Int -- ^ 'getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxableAmount'
  -> GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1
mkGetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1 getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1Amount getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxRate getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1TaxableAmount = GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1{getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1Amount = getCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1Amount,
...
data GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2 =
   GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2EnumEmptyString -- ^ Represents the JSON value @""@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf2EnumEmptyString
...
data GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'Variants
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'ListTGetCreditNotesPreviewLinesParametersQueryLines'TaxAmounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2 =
   GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2EnumEmptyString -- ^ Represents the JSON value @""@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2EnumEmptyString
...
data GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'Variants
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'Variants
    where {parseJSON val = case (GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'ListTText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'GetCreditNotesPreviewLinesParametersQueryLines'TaxRates'OneOf2 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data GetCreditNotesPreviewLinesParametersQueryLines'Type' =
   GetCreditNotesPreviewLinesParametersQueryLines'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCreditNotesPreviewLinesParametersQueryLines'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCreditNotesPreviewLinesParametersQueryLines'Type'EnumCustomLineItem -- ^ Represents the JSON value @"custom_line_item"@
  | GetCreditNotesPreviewLinesParametersQueryLines'Type'EnumInvoiceLineItem -- ^ Represents the JSON value @"invoice_line_item"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryLines'Type'
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryLines'Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryLines'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "custom_line_item" -> GetCreditNotesPreviewLinesParametersQueryLines'Type'EnumCustomLineItem
...
data GetCreditNotesPreviewLinesParametersQueryReason' =
   GetCreditNotesPreviewLinesParametersQueryReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetCreditNotesPreviewLinesParametersQueryReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetCreditNotesPreviewLinesParametersQueryReason'EnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | GetCreditNotesPreviewLinesParametersQueryReason'EnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | GetCreditNotesPreviewLinesParametersQueryReason'EnumOrderChange -- ^ Represents the JSON value @"order_change"@
  | GetCreditNotesPreviewLinesParametersQueryReason'EnumProductUnsatisfactory -- ^ Represents the JSON value @"product_unsatisfactory"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryReason'
    where {toJSON (GetCreditNotesPreviewLinesParametersQueryReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "duplicate" -> GetCreditNotesPreviewLinesParametersQueryReason'EnumDuplicate
...
-- | Defines the object schema located at @paths.\/v1\/credit_notes\/preview\/lines.GET.parameters.properties.queryRefunds.items@ in the specification.
-- 
-- 
data GetCreditNotesPreviewLinesParametersQueryRefunds' = GetCreditNotesPreviewLinesParametersQueryRefunds' {
  -- | amount_refunded
  getCreditNotesPreviewLinesParametersQueryRefunds'AmountRefunded :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | refund
  , getCreditNotesPreviewLinesParametersQueryRefunds'Refund :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryRefunds'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_refunded" Data.Aeson.Types.ToJSON..=)) (getCreditNotesPreviewLinesParametersQueryRefunds'AmountRefunded obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund" Data.Aeson.Types.ToJSON..=)) (getCreditNotesPreviewLinesParametersQueryRefunds'Refund obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_refunded" Data.Aeson.Types.ToJSON..=)) (getCreditNotesPreviewLinesParametersQueryRefunds'AmountRefunded obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund" Data.Aeson.Types.ToJSON..=)) (getCreditNotesPreviewLinesParametersQueryRefunds'Refund obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryRefunds'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCreditNotesPreviewLinesParametersQueryRefunds'" (\obj -> (GHC.Base.pure GetCreditNotesPreviewLinesParametersQueryRefunds' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_refunded")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund"))}
-- | Create a new 'GetCreditNotesPreviewLinesParametersQueryRefunds'' with all required fields.
mkGetCreditNotesPreviewLinesParametersQueryRefunds' :: GetCreditNotesPreviewLinesParametersQueryRefunds'
mkGetCreditNotesPreviewLinesParametersQueryRefunds' = GetCreditNotesPreviewLinesParametersQueryRefunds'{getCreditNotesPreviewLinesParametersQueryRefunds'AmountRefunded = GHC.Maybe.Nothing,
                                                                                                        getCreditNotesPreviewLinesParametersQueryRefunds'Refund = GHC.Maybe.Nothing}
...
data GetCreditNotesPreviewLinesParametersQueryShippingCost' = GetCreditNotesPreviewLinesParametersQueryShippingCost' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCreditNotesPreviewLinesParametersQueryShippingCost'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (getCreditNotesPreviewLinesParametersQueryShippingCost'ShippingRate obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesParametersQueryShippingCost'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCreditNotesPreviewLinesParametersQueryShippingCost'" (\obj -> GHC.Base.pure GetCreditNotesPreviewLinesParametersQueryShippingCost' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate"))}
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCreditNotesPreviewLinesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCreditNotesPreviewLinesResponseBody200" (\obj -> ((GHC.Base.pure GetCreditNotesPreviewLinesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetCreditNotesPreviewLinesResponseBody200' with all required fields.
mkGetCreditNotesPreviewLinesResponseBody200 :: [CreditNoteLineItem] -- ^ 'getCreditNotesPreviewLinesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getCreditNotesPreviewLinesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getCreditNotesPreviewLinesResponseBody200Url'
  -> GetCreditNotesPreviewLinesResponseBody200
mkGetCreditNotesPreviewLinesResponseBody200 getCreditNotesPreviewLinesResponseBody200Data getCreditNotesPreviewLinesResponseBody200HasMore getCreditNotesPreviewLinesResponseBody200Url = GetCreditNotesPreviewLinesResponseBody200{getCreditNotesPreviewLinesResponseBody200Data = getCreditNotesPreviewLinesResponseBody200Data,
