...
getCustomersCustomerBalanceTransactionsTransaction :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerBalanceTransactionsTransactionParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerBalanceTransactionsTransactionResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerBalanceTransactionsTransaction parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerBalanceTransactionsTransactionResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerBalanceTransactionsTransactionResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        CustomerBalanceTransaction)
                                                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerBalanceTransactionsTransactionResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Error)
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerBalanceTransactionsTransactionParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerBalanceTransactionsTransactionParameters" (\obj -> ((GHC.Base.pure GetCustomersCustomerBalanceTransactionsTransactionParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathTransaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetCustomersCustomerBalanceTransactionsTransactionParameters' with all required fields.
mkGetCustomersCustomerBalanceTransactionsTransactionParameters :: Data.Text.Internal.Text -- ^ 'getCustomersCustomerBalanceTransactionsTransactionParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerBalanceTransactionsTransactionParametersPathTransaction'
  -> GetCustomersCustomerBalanceTransactionsTransactionParameters
mkGetCustomersCustomerBalanceTransactionsTransactionParameters getCustomersCustomerBalanceTransactionsTransactionParametersPathCustomer getCustomersCustomerBalanceTransactionsTransactionParametersPathTransaction = GetCustomersCustomerBalanceTransactionsTransactionParameters{getCustomersCustomerBalanceTransactionsTransactionParametersPathCustomer = getCustomersCustomerBalanceTransactionsTransactionParametersPathCustomer,
