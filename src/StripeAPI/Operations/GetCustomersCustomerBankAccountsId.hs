...
getCustomersCustomerBankAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerBankAccountsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerBankAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerBankAccountsId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerBankAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerBankAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        BankAccount)
                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerBankAccountsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                          Error)
...
data GetCustomersCustomerBankAccountsIdParameters = GetCustomersCustomerBankAccountsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersCustomerBankAccountsIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathCustomer" Data.Aeson.Types.ToJSON..= getCustomersCustomerBankAccountsIdParametersPathCustomer obj] : ["pathId" Data.Aeson.Types.ToJSON..= getCustomersCustomerBankAccountsIdParametersPathId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getCustomersCustomerBankAccountsIdParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerBankAccountsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerBankAccountsIdParameters" (\obj -> ((GHC.Base.pure GetCustomersCustomerBankAccountsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetCustomersCustomerBankAccountsIdParameters' with all required fields.
mkGetCustomersCustomerBankAccountsIdParameters :: Data.Text.Internal.Text -- ^ 'getCustomersCustomerBankAccountsIdParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerBankAccountsIdParametersPathId'
  -> GetCustomersCustomerBankAccountsIdParameters
mkGetCustomersCustomerBankAccountsIdParameters getCustomersCustomerBankAccountsIdParametersPathCustomer getCustomersCustomerBankAccountsIdParametersPathId = GetCustomersCustomerBankAccountsIdParameters{getCustomersCustomerBankAccountsIdParametersPathCustomer = getCustomersCustomerBankAccountsIdParametersPathCustomer,
