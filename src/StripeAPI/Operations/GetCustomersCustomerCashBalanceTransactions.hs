...
getCustomersCustomerCashBalanceTransactions :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerCashBalanceTransactionsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerCashBalanceTransactionsResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerCashBalanceTransactions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerCashBalanceTransactionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerCashBalanceTransactionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   GetCustomersCustomerCashBalanceTransactionsResponseBody200)
                                                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerCashBalanceTransactionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
                                                                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/customers/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerCashBalanceTransactionsParametersPathCustomer parameters))) GHC.Base.<> "/cash_balance_transactions")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCustomersCustomerCashBalanceTransactionsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetCustomersCustomerCashBalanceTransactionsResponse =
   GetCustomersCustomerCashBalanceTransactionsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetCustomersCustomerCashBalanceTransactionsResponse200 GetCustomersCustomerCashBalanceTransactionsResponseBody200 -- ^ Successful response.
  | GetCustomersCustomerCashBalanceTransactionsResponseDefault Error -- ^ Error response.
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerCashBalanceTransactionsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerCashBalanceTransactionsResponseBody200" (\obj -> ((GHC.Base.pure GetCustomersCustomerCashBalanceTransactionsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetCustomersCustomerCashBalanceTransactionsResponseBody200' with all required fields.
mkGetCustomersCustomerCashBalanceTransactionsResponseBody200 :: [CustomerCashBalanceTransaction] -- ^ 'getCustomersCustomerCashBalanceTransactionsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getCustomersCustomerCashBalanceTransactionsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerCashBalanceTransactionsResponseBody200Url'
  -> GetCustomersCustomerCashBalanceTransactionsResponseBody200
mkGetCustomersCustomerCashBalanceTransactionsResponseBody200 getCustomersCustomerCashBalanceTransactionsResponseBody200Data getCustomersCustomerCashBalanceTransactionsResponseBody200HasMore getCustomersCustomerCashBalanceTransactionsResponseBody200Url = GetCustomersCustomerCashBalanceTransactionsResponseBody200{getCustomersCustomerCashBalanceTransactionsResponseBody200Data = getCustomersCustomerCashBalanceTransactionsResponseBody200Data,
