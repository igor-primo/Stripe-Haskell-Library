...
getCustomersCustomerSubscriptionsSubscriptionExposedId :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerSubscriptionsSubscriptionExposedIdResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerSubscriptionsSubscriptionExposedId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerSubscriptionsSubscriptionExposedIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerSubscriptionsSubscriptionExposedIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Subscription)
                                                                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerSubscriptionsSubscriptionExposedIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/customers/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathCustomer parameters))) GHC.Base.<> ("/subscriptions/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathSubscriptionExposedId parameters))) GHC.Base.<> "")))) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True])
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters" (\obj -> ((GHC.Base.pure GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathSubscription_exposed_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters' with all required fields.
mkGetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters :: Data.Text.Internal.Text -- ^ 'getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathSubscriptionExposedId'
  -> GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters
mkGetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathCustomer getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathSubscriptionExposedId = GetCustomersCustomerSubscriptionsSubscriptionExposedIdParameters{getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathCustomer = getCustomersCustomerSubscriptionsSubscriptionExposedIdParametersPathCustomer,
