...
getCustomersCustomerTaxIds :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerTaxIdsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerTaxIdsResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerTaxIds parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerTaxIdsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerTaxIdsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                GetCustomersCustomerTaxIdsResponseBody200)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerTaxIdsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/customers/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getCustomersCustomerTaxIdsParametersPathCustomer parameters))) GHC.Base.<> "/tax_ids")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCustomersCustomerTaxIdsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerTaxIdsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerTaxIdsParameters" (\obj -> ((((GHC.Base.pure GetCustomersCustomerTaxIdsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetCustomersCustomerTaxIdsParameters' with all required fields.
mkGetCustomersCustomerTaxIdsParameters :: Data.Text.Internal.Text -- ^ 'getCustomersCustomerTaxIdsParametersPathCustomer'
  -> GetCustomersCustomerTaxIdsParameters
mkGetCustomersCustomerTaxIdsParameters getCustomersCustomerTaxIdsParametersPathCustomer = GetCustomersCustomerTaxIdsParameters{getCustomersCustomerTaxIdsParametersPathCustomer = getCustomersCustomerTaxIdsParametersPathCustomer,
...
data GetCustomersCustomerTaxIdsResponseBody200 = GetCustomersCustomerTaxIdsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersCustomerTaxIdsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getCustomersCustomerTaxIdsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getCustomersCustomerTaxIdsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getCustomersCustomerTaxIdsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerTaxIdsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerTaxIdsResponseBody200" (\obj -> ((GHC.Base.pure GetCustomersCustomerTaxIdsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetCustomersCustomerTaxIdsResponseBody200' with all required fields.
mkGetCustomersCustomerTaxIdsResponseBody200 :: [TaxId] -- ^ 'getCustomersCustomerTaxIdsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getCustomersCustomerTaxIdsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerTaxIdsResponseBody200Url'
  -> GetCustomersCustomerTaxIdsResponseBody200
mkGetCustomersCustomerTaxIdsResponseBody200 getCustomersCustomerTaxIdsResponseBody200Data getCustomersCustomerTaxIdsResponseBody200HasMore getCustomersCustomerTaxIdsResponseBody200Url = GetCustomersCustomerTaxIdsResponseBody200{getCustomersCustomerTaxIdsResponseBody200Data = getCustomersCustomerTaxIdsResponseBody200Data,
