...
getCustomersCustomerTaxIdsId :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersCustomerTaxIdsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersCustomerTaxIdsIdResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersCustomerTaxIdsId parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersCustomerTaxIdsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerTaxIdsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      TaxId)
                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersCustomerTaxIdsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                        Error)
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersCustomerTaxIdsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersCustomerTaxIdsIdParameters" (\obj -> ((GHC.Base.pure GetCustomersCustomerTaxIdsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetCustomersCustomerTaxIdsIdParameters' with all required fields.
mkGetCustomersCustomerTaxIdsIdParameters :: Data.Text.Internal.Text -- ^ 'getCustomersCustomerTaxIdsIdParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'getCustomersCustomerTaxIdsIdParametersPathId'
  -> GetCustomersCustomerTaxIdsIdParameters
mkGetCustomersCustomerTaxIdsIdParameters getCustomersCustomerTaxIdsIdParametersPathCustomer getCustomersCustomerTaxIdsIdParametersPathId = GetCustomersCustomerTaxIdsIdParameters{getCustomersCustomerTaxIdsIdParametersPathCustomer = getCustomersCustomerTaxIdsIdParametersPathCustomer,
