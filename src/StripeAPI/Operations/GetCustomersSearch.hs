...
getCustomersSearch :: forall m . StripeAPI.Common.MonadHTTP m => GetCustomersSearchParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetCustomersSearchResponse) -- ^ Monadic computation which returns the result of the operation
getCustomersSearch parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetCustomersSearchResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersSearchResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                             ...
                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetCustomersSearchResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                          Error)
                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/customers/search" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getCustomersSearchParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetCustomersSearchParameters = GetCustomersSearchParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetCustomersSearchParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersSearchParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersSearchParameters" (\obj -> (((GHC.Base.pure GetCustomersSearchParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryQuery"))}
-- | Create a new 'GetCustomersSearchParameters' with all required fields.
mkGetCustomersSearchParameters :: Data.Text.Internal.Text -- ^ 'getCustomersSearchParametersQueryQuery'
  -> GetCustomersSearchParameters
mkGetCustomersSearchParameters getCustomersSearchParametersQueryQuery = GetCustomersSearchParameters{getCustomersSearchParametersQueryExpand = GHC.Maybe.Nothing,
...
data GetCustomersSearchResponse =
   GetCustomersSearchResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetCustomersSearchResponse200 GetCustomersSearchResponseBody200 -- ^ Successful response.
  | GetCustomersSearchResponseDefault Error -- ^ Error response.
...
instance Data.Aeson.Types.FromJSON.FromJSON GetCustomersSearchResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetCustomersSearchResponseBody200" (\obj -> ((((GHC.Base.pure GetCustomersSearchResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "next_page")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "total_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetCustomersSearchResponseBody200' with all required fields.
mkGetCustomersSearchResponseBody200 :: [Customer] -- ^ 'getCustomersSearchResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getCustomersSearchResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getCustomersSearchResponseBody200Url'
  -> GetCustomersSearchResponseBody200
mkGetCustomersSearchResponseBody200 getCustomersSearchResponseBody200Data getCustomersSearchResponseBody200HasMore getCustomersSearchResponseBody200Url = GetCustomersSearchResponseBody200{getCustomersSearchResponseBody200Data = getCustomersSearchResponseBody200Data,
