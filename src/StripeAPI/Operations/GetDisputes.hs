...
getDisputes :: forall m . StripeAPI.Common.MonadHTTP m => GetDisputesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetDisputesResponse) -- ^ Monadic computation which returns the result of the operation
getDisputes parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetDisputesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetDisputesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                   GetDisputesResponseBody200)
                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetDisputesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                     Error)
                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/disputes" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "charge") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getDisputesParametersQueryCharge parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetDisputesParameters = GetDisputesParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetDisputesParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetDisputesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetDisputesParameters" (\obj -> ((((((GHC.Base.pure GetDisputesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCharge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPayment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetDisputesParameters' with all required fields.
mkGetDisputesParameters :: GetDisputesParameters
mkGetDisputesParameters = GetDisputesParameters{getDisputesParametersQueryCharge = GHC.Maybe.Nothing,
...
data GetDisputesParametersQueryCreated'OneOf1 = GetDisputesParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetDisputesParametersQueryCreated'OneOf1
...
mkGetDisputesParametersQueryCreated'OneOf1 = GetDisputesParametersQueryCreated'OneOf1{getDisputesParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetDisputesParametersQueryCreated'Variants
    where {toJSON (GetDisputesParametersQueryCreated'GetDisputesParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetDisputesParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetDisputesParametersQueryCreated'Variants
    where {parseJSON val = case (GetDisputesParametersQueryCreated'GetDisputesParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetDisputesParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetDisputesResponseBody200 = GetDisputesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetDisputesResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getDisputesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getDisputesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getDisputesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetDisputesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetDisputesResponseBody200" (\obj -> ((GHC.Base.pure GetDisputesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetDisputesResponseBody200' with all required fields.
mkGetDisputesResponseBody200 :: [Dispute] -- ^ 'getDisputesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getDisputesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getDisputesResponseBody200Url'
  -> GetDisputesResponseBody200
mkGetDisputesResponseBody200 getDisputesResponseBody200Data getDisputesResponseBody200HasMore getDisputesResponseBody200Url = GetDisputesResponseBody200{getDisputesResponseBody200Data = getDisputesResponseBody200Data,
