...
getFinancialConnectionsTransactions :: forall m . StripeAPI.Common.MonadHTTP m => GetFinancialConnectionsTransactionsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetFinancialConnectionsTransactionsResponse) -- ^ Monadic computation which returns the result of the operation
getFinancialConnectionsTransactions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetFinancialConnectionsTransactionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetFinancialConnectionsTransactionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           GetFinancialConnectionsTransactionsResponseBody200)
                                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetFinancialConnectionsTransactionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                             Error)
                                                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/financial_connections/transactions" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "account") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (getFinancialConnectionsTransactionsParametersQueryAccount parameters)) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetFinancialConnectionsTransactionsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetFinancialConnectionsTransactionsParameters" (\obj -> ((((((GHC.Base.pure GetFinancialConnectionsTransactionsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryTransacted_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryTransaction_refresh"))}
-- | Create a new 'GetFinancialConnectionsTransactionsParameters' with all required fields.
mkGetFinancialConnectionsTransactionsParameters :: Data.Text.Internal.Text -- ^ 'getFinancialConnectionsTransactionsParametersQueryAccount'
  -> GetFinancialConnectionsTransactionsParameters
mkGetFinancialConnectionsTransactionsParameters getFinancialConnectionsTransactionsParametersQueryAccount = GetFinancialConnectionsTransactionsParameters{getFinancialConnectionsTransactionsParametersQueryAccount = getFinancialConnectionsTransactionsParametersQueryAccount,
...
data GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1 = GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1
...
mkGetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1 = GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1{getFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetFinancialConnectionsTransactionsParametersQueryTransactedAt'Variants
    where {toJSON (GetFinancialConnectionsTransactionsParametersQueryTransactedAt'GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetFinancialConnectionsTransactionsParametersQueryTransactedAt'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetFinancialConnectionsTransactionsParametersQueryTransactedAt'Variants
    where {parseJSON val = case (GetFinancialConnectionsTransactionsParametersQueryTransactedAt'GetFinancialConnectionsTransactionsParametersQueryTransactedAt'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetFinancialConnectionsTransactionsParametersQueryTransactedAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh' = GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["after" Data.Aeson.Types.ToJSON..= getFinancialConnectionsTransactionsParametersQueryTransactionRefresh'After obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh'" (\obj -> GHC.Base.pure GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "after"))}
-- | Create a new 'GetFinancialConnectionsTransactionsParametersQueryTransactionRefresh'' with all required fields.
mkGetFinancialConnectionsTransactionsParametersQueryTransactionRefresh' :: Data.Text.Internal.Text -- ^ 'getFinancialConnectionsTransactionsParametersQueryTransactionRefresh'After'
...
data GetFinancialConnectionsTransactionsResponse =
   GetFinancialConnectionsTransactionsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetFinancialConnectionsTransactionsResponse200 GetFinancialConnectionsTransactionsResponseBody200 -- ^ Successful response.
  | GetFinancialConnectionsTransactionsResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetFinancialConnectionsTransactionsResponseBody200 = GetFinancialConnectionsTransactionsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetFinancialConnectionsTransactionsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getFinancialConnectionsTransactionsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getFinancialConnectionsTransactionsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getFinancialConnectionsTransactionsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetFinancialConnectionsTransactionsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetFinancialConnectionsTransactionsResponseBody200" (\obj -> ((GHC.Base.pure GetFinancialConnectionsTransactionsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetFinancialConnectionsTransactionsResponseBody200' with all required fields.
mkGetFinancialConnectionsTransactionsResponseBody200 :: [FinancialConnections'transaction] -- ^ 'getFinancialConnectionsTransactionsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getFinancialConnectionsTransactionsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getFinancialConnectionsTransactionsResponseBody200Url'
  -> GetFinancialConnectionsTransactionsResponseBody200
mkGetFinancialConnectionsTransactionsResponseBody200 getFinancialConnectionsTransactionsResponseBody200Data getFinancialConnectionsTransactionsResponseBody200HasMore getFinancialConnectionsTransactionsResponseBody200Url = GetFinancialConnectionsTransactionsResponseBody200{getFinancialConnectionsTransactionsResponseBody200Data = getFinancialConnectionsTransactionsResponseBody200Data,
