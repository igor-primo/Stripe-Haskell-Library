...
getInvoicesInvoiceLines :: forall m . StripeAPI.Common.MonadHTTP m => GetInvoicesInvoiceLinesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetInvoicesInvoiceLinesResponse) -- ^ Monadic computation which returns the result of the operation
getInvoicesInvoiceLines parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetInvoicesInvoiceLinesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetInvoicesInvoiceLinesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       GetInvoicesInvoiceLinesResponseBody200)
                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetInvoicesInvoiceLinesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/invoices/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getInvoicesInvoiceLinesParametersPathInvoice parameters))) GHC.Base.<> "/lines")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getInvoicesInvoiceLinesParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetInvoicesInvoiceLinesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetInvoicesInvoiceLinesParameters" (\obj -> ((((GHC.Base.pure GetInvoicesInvoiceLinesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathInvoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetInvoicesInvoiceLinesParameters' with all required fields.
mkGetInvoicesInvoiceLinesParameters :: Data.Text.Internal.Text -- ^ 'getInvoicesInvoiceLinesParametersPathInvoice'
  -> GetInvoicesInvoiceLinesParameters
mkGetInvoicesInvoiceLinesParameters getInvoicesInvoiceLinesParametersPathInvoice = GetInvoicesInvoiceLinesParameters{getInvoicesInvoiceLinesParametersPathInvoice = getInvoicesInvoiceLinesParametersPathInvoice,
...
data GetInvoicesInvoiceLinesResponseBody200 = GetInvoicesInvoiceLinesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetInvoicesInvoiceLinesResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getInvoicesInvoiceLinesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getInvoicesInvoiceLinesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getInvoicesInvoiceLinesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetInvoicesInvoiceLinesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetInvoicesInvoiceLinesResponseBody200" (\obj -> ((GHC.Base.pure GetInvoicesInvoiceLinesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetInvoicesInvoiceLinesResponseBody200' with all required fields.
mkGetInvoicesInvoiceLinesResponseBody200 :: [LineItem] -- ^ 'getInvoicesInvoiceLinesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getInvoicesInvoiceLinesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getInvoicesInvoiceLinesResponseBody200Url'
  -> GetInvoicesInvoiceLinesResponseBody200
mkGetInvoicesInvoiceLinesResponseBody200 getInvoicesInvoiceLinesResponseBody200Data getInvoicesInvoiceLinesResponseBody200HasMore getInvoicesInvoiceLinesResponseBody200Url = GetInvoicesInvoiceLinesResponseBody200{getInvoicesInvoiceLinesResponseBody200Data = getInvoicesInvoiceLinesResponseBody200Data,
