...
getIssuingAuthorizations :: forall m . StripeAPI.Common.MonadHTTP m => GetIssuingAuthorizationsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetIssuingAuthorizationsResponse) -- ^ Monadic computation which returns the result of the operation
getIssuingAuthorizations parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetIssuingAuthorizationsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingAuthorizationsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          GetIssuingAuthorizationsResponseBody200)
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingAuthorizationsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/issuing/authorizations" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "card") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getIssuingAuthorizationsParametersQueryCard parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetIssuingAuthorizationsParameters = GetIssuingAuthorizationsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingAuthorizationsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingAuthorizationsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingAuthorizationsParameters" (\obj -> (((((((GHC.Base.pure GetIssuingAuthorizationsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCardholder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStatus"))}
...
mkGetIssuingAuthorizationsParameters = GetIssuingAuthorizationsParameters{getIssuingAuthorizationsParametersQueryCard = GHC.Maybe.Nothing,
...
data GetIssuingAuthorizationsParametersQueryCreated'OneOf1 = GetIssuingAuthorizationsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingAuthorizationsParametersQueryCreated'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getIssuingAuthorizationsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingAuthorizationsParametersQueryCreated'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingAuthorizationsParametersQueryCreated'OneOf1" (\obj -> (((GHC.Base.pure GetIssuingAuthorizationsParametersQueryCreated'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetIssuingAuthorizationsParametersQueryCreated'OneOf1 = GetIssuingAuthorizationsParametersQueryCreated'OneOf1{getIssuingAuthorizationsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingAuthorizationsParametersQueryCreated'Variants
    where {toJSON (GetIssuingAuthorizationsParametersQueryCreated'GetIssuingAuthorizationsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetIssuingAuthorizationsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingAuthorizationsParametersQueryCreated'Variants
    where {parseJSON val = case (GetIssuingAuthorizationsParametersQueryCreated'GetIssuingAuthorizationsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetIssuingAuthorizationsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetIssuingAuthorizationsParametersQueryStatus' =
   GetIssuingAuthorizationsParametersQueryStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetIssuingAuthorizationsParametersQueryStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetIssuingAuthorizationsParametersQueryStatus'EnumClosed -- ^ Represents the JSON value @"closed"@
  | GetIssuingAuthorizationsParametersQueryStatus'EnumExpired -- ^ Represents the JSON value @"expired"@
  | GetIssuingAuthorizationsParametersQueryStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  | GetIssuingAuthorizationsParametersQueryStatus'EnumReversed -- ^ Represents the JSON value @"reversed"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingAuthorizationsParametersQueryStatus'
    where {toJSON (GetIssuingAuthorizationsParametersQueryStatus'Other val) = val;
           ...
           toJSON (GetIssuingAuthorizationsParametersQueryStatus'EnumExpired) = "expired";
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingAuthorizationsParametersQueryStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "closed" -> GetIssuingAuthorizationsParametersQueryStatus'EnumClosed
                                             | val GHC.Classes.== "expired" -> GetIssuingAuthorizationsParametersQueryStatus'EnumExpired
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingAuthorizationsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingAuthorizationsResponseBody200" (\obj -> ((GHC.Base.pure GetIssuingAuthorizationsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetIssuingAuthorizationsResponseBody200' with all required fields.
mkGetIssuingAuthorizationsResponseBody200 :: [Issuing'authorization] -- ^ 'getIssuingAuthorizationsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getIssuingAuthorizationsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getIssuingAuthorizationsResponseBody200Url'
  -> GetIssuingAuthorizationsResponseBody200
mkGetIssuingAuthorizationsResponseBody200 getIssuingAuthorizationsResponseBody200Data getIssuingAuthorizationsResponseBody200HasMore getIssuingAuthorizationsResponseBody200Url = GetIssuingAuthorizationsResponseBody200{getIssuingAuthorizationsResponseBody200Data = getIssuingAuthorizationsResponseBody200Data,
