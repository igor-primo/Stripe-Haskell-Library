...
getIssuingCards parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetIssuingCardsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingCardsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               GetIssuingCardsResponseBody200)
                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingCardsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/issuing/cards" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "cardholder") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getIssuingCardsParametersQueryCardholder parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                    StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "personalization_design") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getIssuingCardsParametersQueryPersonalizationDesign parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetIssuingCardsParameters = GetIssuingCardsParameters {
  ...
  -- | queryPersonalization_design: Represents the parameter named \'personalization_design\'
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , getIssuingCardsParametersQueryPersonalizationDesign :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
...
mkGetIssuingCardsParameters = GetIssuingCardsParameters{getIssuingCardsParametersQueryCardholder = GHC.Maybe.Nothing,
                                                        ...
                                                        getIssuingCardsParametersQueryPersonalizationDesign = GHC.Maybe.Nothing,
