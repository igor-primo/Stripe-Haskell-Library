...
getIssuingTokens :: forall m . StripeAPI.Common.MonadHTTP m => GetIssuingTokensParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetIssuingTokensResponse) -- ^ Monadic computation which returns the result of the operation
getIssuingTokens parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetIssuingTokensResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingTokensResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  GetIssuingTokensResponseBody200)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingTokensResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/issuing/tokens" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "card") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (getIssuingTokensParametersQueryCard parameters)) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTokensParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingTokensParameters" (\obj -> ((((((GHC.Base.pure GetIssuingTokensParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryCard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStatus"))}
-- | Create a new 'GetIssuingTokensParameters' with all required fields.
mkGetIssuingTokensParameters :: Data.Text.Internal.Text -- ^ 'getIssuingTokensParametersQueryCard'
  -> GetIssuingTokensParameters
mkGetIssuingTokensParameters getIssuingTokensParametersQueryCard = GetIssuingTokensParameters{getIssuingTokensParametersQueryCard = getIssuingTokensParametersQueryCard,
...
data GetIssuingTokensParametersQueryCreated'OneOf1 = GetIssuingTokensParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTokensParametersQueryCreated'OneOf1
...
mkGetIssuingTokensParametersQueryCreated'OneOf1 = GetIssuingTokensParametersQueryCreated'OneOf1{getIssuingTokensParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTokensParametersQueryCreated'Variants
    where {toJSON (GetIssuingTokensParametersQueryCreated'GetIssuingTokensParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetIssuingTokensParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTokensParametersQueryCreated'Variants
    where {parseJSON val = case (GetIssuingTokensParametersQueryCreated'GetIssuingTokensParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetIssuingTokensParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetIssuingTokensParametersQueryStatus' =
   GetIssuingTokensParametersQueryStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetIssuingTokensParametersQueryStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetIssuingTokensParametersQueryStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | GetIssuingTokensParametersQueryStatus'EnumDeleted -- ^ Represents the JSON value @"deleted"@
  | GetIssuingTokensParametersQueryStatus'EnumRequested -- ^ Represents the JSON value @"requested"@
  | GetIssuingTokensParametersQueryStatus'EnumSuspended -- ^ Represents the JSON value @"suspended"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTokensParametersQueryStatus'
    where {toJSON (GetIssuingTokensParametersQueryStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTokensParametersQueryStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> GetIssuingTokensParametersQueryStatus'EnumActive
...
data GetIssuingTokensResponse =
   GetIssuingTokensResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetIssuingTokensResponse200 GetIssuingTokensResponseBody200 -- ^ Successful response.
  | GetIssuingTokensResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetIssuingTokensResponseBody200 = GetIssuingTokensResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTokensResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getIssuingTokensResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getIssuingTokensResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getIssuingTokensResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTokensResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingTokensResponseBody200" (\obj -> ((GHC.Base.pure GetIssuingTokensResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetIssuingTokensResponseBody200' with all required fields.
mkGetIssuingTokensResponseBody200 :: [Issuing'token] -- ^ 'getIssuingTokensResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getIssuingTokensResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getIssuingTokensResponseBody200Url'
  -> GetIssuingTokensResponseBody200
mkGetIssuingTokensResponseBody200 getIssuingTokensResponseBody200Data getIssuingTokensResponseBody200HasMore getIssuingTokensResponseBody200Url = GetIssuingTokensResponseBody200{getIssuingTokensResponseBody200Data = getIssuingTokensResponseBody200Data,
