...
getIssuingTransactions :: forall m . StripeAPI.Common.MonadHTTP m => GetIssuingTransactionsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetIssuingTransactionsResponse) -- ^ Monadic computation which returns the result of the operation
getIssuingTransactions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetIssuingTransactionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingTransactionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                    GetIssuingTransactionsResponseBody200)
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetIssuingTransactionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/issuing/transactions" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "card") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getIssuingTransactionsParametersQueryCard parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetIssuingTransactionsParameters = GetIssuingTransactionsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTransactionsParameters
...
mkGetIssuingTransactionsParameters = GetIssuingTransactionsParameters{getIssuingTransactionsParametersQueryCard = GHC.Maybe.Nothing,
...
data GetIssuingTransactionsParametersQueryCreated'OneOf1 = GetIssuingTransactionsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTransactionsParametersQueryCreated'OneOf1
...
mkGetIssuingTransactionsParametersQueryCreated'OneOf1 = GetIssuingTransactionsParametersQueryCreated'OneOf1{getIssuingTransactionsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTransactionsParametersQueryCreated'Variants
    where {toJSON (GetIssuingTransactionsParametersQueryCreated'GetIssuingTransactionsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetIssuingTransactionsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTransactionsParametersQueryCreated'Variants
    where {parseJSON val = case (GetIssuingTransactionsParametersQueryCreated'GetIssuingTransactionsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetIssuingTransactionsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetIssuingTransactionsParametersQueryType' =
   GetIssuingTransactionsParametersQueryType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetIssuingTransactionsParametersQueryType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetIssuingTransactionsParametersQueryType'EnumCapture -- ^ Represents the JSON value @"capture"@
  | GetIssuingTransactionsParametersQueryType'EnumRefund -- ^ Represents the JSON value @"refund"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTransactionsParametersQueryType'
    where {toJSON (GetIssuingTransactionsParametersQueryType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTransactionsParametersQueryType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "capture" -> GetIssuingTransactionsParametersQueryType'EnumCapture
...
data GetIssuingTransactionsResponseBody200 = GetIssuingTransactionsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetIssuingTransactionsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getIssuingTransactionsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getIssuingTransactionsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getIssuingTransactionsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetIssuingTransactionsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetIssuingTransactionsResponseBody200" (\obj -> ((GHC.Base.pure GetIssuingTransactionsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetIssuingTransactionsResponseBody200' with all required fields.
mkGetIssuingTransactionsResponseBody200 :: [Issuing'transaction] -- ^ 'getIssuingTransactionsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getIssuingTransactionsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getIssuingTransactionsResponseBody200Url'
  -> GetIssuingTransactionsResponseBody200
mkGetIssuingTransactionsResponseBody200 getIssuingTransactionsResponseBody200Data getIssuingTransactionsResponseBody200HasMore getIssuingTransactionsResponseBody200Url = GetIssuingTransactionsResponseBody200{getIssuingTransactionsResponseBody200Data = getIssuingTransactionsResponseBody200Data,
