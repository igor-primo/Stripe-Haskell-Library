...
getLinkedAccountsAccountOwners :: forall m . StripeAPI.Common.MonadHTTP m => GetLinkedAccountsAccountOwnersParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetLinkedAccountsAccountOwnersResponse) -- ^ Monadic computation which returns the result of the operation
getLinkedAccountsAccountOwners parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetLinkedAccountsAccountOwnersResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetLinkedAccountsAccountOwnersResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            GetLinkedAccountsAccountOwnersResponseBody200)
                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetLinkedAccountsAccountOwnersResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                              Error)
                                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/linked_accounts/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getLinkedAccountsAccountOwnersParametersPathAccount parameters))) GHC.Base.<> "/owners")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getLinkedAccountsAccountOwnersParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetLinkedAccountsAccountOwnersParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetLinkedAccountsAccountOwnersParameters" (\obj -> (((((GHC.Base.pure GetLinkedAccountsAccountOwnersParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryOwnership")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetLinkedAccountsAccountOwnersParameters' with all required fields.
mkGetLinkedAccountsAccountOwnersParameters :: Data.Text.Internal.Text -- ^ 'getLinkedAccountsAccountOwnersParametersPathAccount'
  -> Data.Text.Internal.Text -- ^ 'getLinkedAccountsAccountOwnersParametersQueryOwnership'
  -> GetLinkedAccountsAccountOwnersParameters
mkGetLinkedAccountsAccountOwnersParameters getLinkedAccountsAccountOwnersParametersPathAccount getLinkedAccountsAccountOwnersParametersQueryOwnership = GetLinkedAccountsAccountOwnersParameters{getLinkedAccountsAccountOwnersParametersPathAccount = getLinkedAccountsAccountOwnersParametersPathAccount,
...
data GetLinkedAccountsAccountOwnersResponse =
   GetLinkedAccountsAccountOwnersResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetLinkedAccountsAccountOwnersResponse200 GetLinkedAccountsAccountOwnersResponseBody200 -- ^ Successful response.
  | GetLinkedAccountsAccountOwnersResponseDefault Error -- ^ Error response.
...
data GetLinkedAccountsAccountOwnersResponseBody200 = GetLinkedAccountsAccountOwnersResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetLinkedAccountsAccountOwnersResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getLinkedAccountsAccountOwnersResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getLinkedAccountsAccountOwnersResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getLinkedAccountsAccountOwnersResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetLinkedAccountsAccountOwnersResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetLinkedAccountsAccountOwnersResponseBody200" (\obj -> ((GHC.Base.pure GetLinkedAccountsAccountOwnersResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetLinkedAccountsAccountOwnersResponseBody200' with all required fields.
mkGetLinkedAccountsAccountOwnersResponseBody200 :: [FinancialConnections'accountOwner] -- ^ 'getLinkedAccountsAccountOwnersResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getLinkedAccountsAccountOwnersResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getLinkedAccountsAccountOwnersResponseBody200Url'
  -> GetLinkedAccountsAccountOwnersResponseBody200
mkGetLinkedAccountsAccountOwnersResponseBody200 getLinkedAccountsAccountOwnersResponseBody200Data getLinkedAccountsAccountOwnersResponseBody200HasMore getLinkedAccountsAccountOwnersResponseBody200Url = GetLinkedAccountsAccountOwnersResponseBody200{getLinkedAccountsAccountOwnersResponseBody200Data = getLinkedAccountsAccountOwnersResponseBody200Data,
