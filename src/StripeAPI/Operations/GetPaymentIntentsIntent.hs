...
getPaymentIntentsIntent :: forall m . StripeAPI.Common.MonadHTTP m => GetPaymentIntentsIntentParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetPaymentIntentsIntentResponse) -- ^ Monadic computation which returns the result of the operation
getPaymentIntentsIntent parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetPaymentIntentsIntentResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentIntentsIntentResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       PaymentIntent)
                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentIntentsIntentResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/payment_intents/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getPaymentIntentsIntentParametersPathIntent parameters))) GHC.Base.<> "")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "client_secret") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getPaymentIntentsIntentParametersQueryClientSecret parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetPaymentIntentsIntentParameters = GetPaymentIntentsIntentParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPaymentIntentsIntentParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathIntent" Data.Aeson.Types.ToJSON..= getPaymentIntentsIntentParametersPathIntent obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryClient_secret" Data.Aeson.Types.ToJSON..=)) (getPaymentIntentsIntentParametersQueryClientSecret obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getPaymentIntentsIntentParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetPaymentIntentsIntentParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPaymentIntentsIntentParameters" (\obj -> ((GHC.Base.pure GetPaymentIntentsIntentParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathIntent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryClient_secret")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetPaymentIntentsIntentParameters' with all required fields.
mkGetPaymentIntentsIntentParameters :: Data.Text.Internal.Text -- ^ 'getPaymentIntentsIntentParametersPathIntent'
  -> GetPaymentIntentsIntentParameters
mkGetPaymentIntentsIntentParameters getPaymentIntentsIntentParametersPathIntent = GetPaymentIntentsIntentParameters{getPaymentIntentsIntentParametersPathIntent = getPaymentIntentsIntentParametersPathIntent,
