...
getPaymentMethodDomains :: forall m . StripeAPI.Common.MonadHTTP m => GetPaymentMethodDomainsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetPaymentMethodDomainsResponse) -- ^ Monadic computation which returns the result of the operation
getPaymentMethodDomains parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetPaymentMethodDomainsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentMethodDomainsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       GetPaymentMethodDomainsResponseBody200)
                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentMethodDomainsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
                                                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/payment_method_domains" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "domain_name") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getPaymentMethodDomainsParametersQueryDomainName parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetPaymentMethodDomainsParameters = GetPaymentMethodDomainsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPaymentMethodDomainsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetPaymentMethodDomainsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPaymentMethodDomainsParameters" (\obj -> (((((GHC.Base.pure GetPaymentMethodDomainsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryDomain_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
...
mkGetPaymentMethodDomainsParameters = GetPaymentMethodDomainsParameters{getPaymentMethodDomainsParametersQueryDomainName = GHC.Maybe.Nothing,
...
data GetPaymentMethodDomainsResponse =
   GetPaymentMethodDomainsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetPaymentMethodDomainsResponse200 GetPaymentMethodDomainsResponseBody200 -- ^ Successful response.
  | GetPaymentMethodDomainsResponseDefault Error -- ^ Error response.
...
data GetPaymentMethodDomainsResponseBody200 = GetPaymentMethodDomainsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPaymentMethodDomainsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getPaymentMethodDomainsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getPaymentMethodDomainsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getPaymentMethodDomainsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetPaymentMethodDomainsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPaymentMethodDomainsResponseBody200" (\obj -> ((GHC.Base.pure GetPaymentMethodDomainsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetPaymentMethodDomainsResponseBody200' with all required fields.
mkGetPaymentMethodDomainsResponseBody200 :: [PaymentMethodDomain] -- ^ 'getPaymentMethodDomainsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getPaymentMethodDomainsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getPaymentMethodDomainsResponseBody200Url'
  -> GetPaymentMethodDomainsResponseBody200
mkGetPaymentMethodDomainsResponseBody200 getPaymentMethodDomainsResponseBody200Data getPaymentMethodDomainsResponseBody200HasMore getPaymentMethodDomainsResponseBody200Url = GetPaymentMethodDomainsResponseBody200{getPaymentMethodDomainsResponseBody200Data = getPaymentMethodDomainsResponseBody200Data,
