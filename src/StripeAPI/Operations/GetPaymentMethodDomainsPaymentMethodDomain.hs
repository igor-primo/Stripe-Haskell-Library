...
getPaymentMethodDomainsPaymentMethodDomain :: forall m . StripeAPI.Common.MonadHTTP m => GetPaymentMethodDomainsPaymentMethodDomainParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetPaymentMethodDomainsPaymentMethodDomainResponse) -- ^ Monadic computation which returns the result of the operation
getPaymentMethodDomainsPaymentMethodDomain parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetPaymentMethodDomainsPaymentMethodDomainResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentMethodDomainsPaymentMethodDomainResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                PaymentMethodDomain)
                                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetPaymentMethodDomainsPaymentMethodDomainResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data GetPaymentMethodDomainsPaymentMethodDomainParameters = GetPaymentMethodDomainsPaymentMethodDomainParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPaymentMethodDomainsPaymentMethodDomainParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathPayment_method_domain" Data.Aeson.Types.ToJSON..= getPaymentMethodDomainsPaymentMethodDomainParametersPathPaymentMethodDomain obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getPaymentMethodDomainsPaymentMethodDomainParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetPaymentMethodDomainsPaymentMethodDomainParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPaymentMethodDomainsPaymentMethodDomainParameters" (\obj -> (GHC.Base.pure GetPaymentMethodDomainsPaymentMethodDomainParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathPayment_method_domain")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetPaymentMethodDomainsPaymentMethodDomainParameters' with all required fields.
mkGetPaymentMethodDomainsPaymentMethodDomainParameters :: Data.Text.Internal.Text -- ^ 'getPaymentMethodDomainsPaymentMethodDomainParametersPathPaymentMethodDomain'
  -> GetPaymentMethodDomainsPaymentMethodDomainParameters
mkGetPaymentMethodDomainsPaymentMethodDomainParameters getPaymentMethodDomainsPaymentMethodDomainParametersPathPaymentMethodDomain = GetPaymentMethodDomainsPaymentMethodDomainParameters{getPaymentMethodDomainsPaymentMethodDomainParametersPathPaymentMethodDomain = getPaymentMethodDomainsPaymentMethodDomainParametersPathPaymentMethodDomain,
...
data GetPaymentMethodDomainsPaymentMethodDomainResponse =
   GetPaymentMethodDomainsPaymentMethodDomainResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetPaymentMethodDomainsPaymentMethodDomainResponse200 PaymentMethodDomain -- ^ Successful response.
  | GetPaymentMethodDomainsPaymentMethodDomainResponseDefault Error -- ^ Error response.
