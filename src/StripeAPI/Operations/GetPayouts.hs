...
getPayouts :: forall m . StripeAPI.Common.MonadHTTP m => GetPayoutsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetPayoutsResponse) -- ^ Monadic computation which returns the result of the operation
getPayouts parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetPayoutsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetPayoutsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                GetPayoutsResponseBody200)
                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetPayoutsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/payouts" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "arrival_date") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getPayoutsParametersQueryArrivalDate parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetPayoutsParameters = GetPayoutsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPayoutsParameters
...
data GetPayoutsParametersQueryArrivalDate'OneOf1 = GetPayoutsParametersQueryArrivalDate'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPayoutsParametersQueryArrivalDate'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getPayoutsParametersQueryArrivalDate'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetPayoutsParametersQueryArrivalDate'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPayoutsParametersQueryArrivalDate'OneOf1" (\obj -> (((GHC.Base.pure GetPayoutsParametersQueryArrivalDate'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetPayoutsParametersQueryArrivalDate'OneOf1 = GetPayoutsParametersQueryArrivalDate'OneOf1{getPayoutsParametersQueryArrivalDate'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetPayoutsParametersQueryArrivalDate'Variants
    where {toJSON (GetPayoutsParametersQueryArrivalDate'GetPayoutsParametersQueryArrivalDate'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetPayoutsParametersQueryArrivalDate'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetPayoutsParametersQueryArrivalDate'Variants
    where {parseJSON val = case (GetPayoutsParametersQueryArrivalDate'GetPayoutsParametersQueryArrivalDate'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetPayoutsParametersQueryArrivalDate'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetPayoutsParametersQueryCreated'OneOf1 = GetPayoutsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPayoutsParametersQueryCreated'OneOf1
...
mkGetPayoutsParametersQueryCreated'OneOf1 = GetPayoutsParametersQueryCreated'OneOf1{getPayoutsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
data GetPayoutsParametersQueryCreated'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetPayoutsParametersQueryCreated'Variants
    where {toJSON (GetPayoutsParametersQueryCreated'GetPayoutsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetPayoutsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetPayoutsParametersQueryCreated'Variants
    where {parseJSON val = case (GetPayoutsParametersQueryCreated'GetPayoutsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetPayoutsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
instance Data.Aeson.Types.FromJSON.FromJSON GetPayoutsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetPayoutsResponseBody200" (\obj -> ((GHC.Base.pure GetPayoutsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetPayoutsResponseBody200' with all required fields.
mkGetPayoutsResponseBody200 :: [Payout] -- ^ 'getPayoutsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getPayoutsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getPayoutsResponseBody200Url'
  -> GetPayoutsResponseBody200
mkGetPayoutsResponseBody200 getPayoutsResponseBody200Data getPayoutsResponseBody200HasMore getPayoutsResponseBody200Url = GetPayoutsResponseBody200{getPayoutsResponseBody200Data = getPayoutsResponseBody200Data,
