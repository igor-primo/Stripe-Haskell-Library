...
getProductsSearch :: forall m . StripeAPI.Common.MonadHTTP m => GetProductsSearchParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetProductsSearchResponse) -- ^ Monadic computation which returns the result of the operation
getProductsSearch parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetProductsSearchResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetProductsSearchResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                     GetProductsSearchResponseBody200)
                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetProductsSearchResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                       Error)
                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/products/search" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getProductsSearchParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetProductsSearchParameters = GetProductsSearchParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetProductsSearchParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetProductsSearchParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetProductsSearchParameters" (\obj -> (((GHC.Base.pure GetProductsSearchParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryQuery"))}
-- | Create a new 'GetProductsSearchParameters' with all required fields.
mkGetProductsSearchParameters :: Data.Text.Internal.Text -- ^ 'getProductsSearchParametersQueryQuery'
  -> GetProductsSearchParameters
mkGetProductsSearchParameters getProductsSearchParametersQueryQuery = GetProductsSearchParameters{getProductsSearchParametersQueryExpand = GHC.Maybe.Nothing,
...
data GetProductsSearchResponse =
   GetProductsSearchResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetProductsSearchResponse200 GetProductsSearchResponseBody200 -- ^ Successful response.
  | GetProductsSearchResponseDefault Error -- ^ Error response.
...
instance Data.Aeson.Types.FromJSON.FromJSON GetProductsSearchResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetProductsSearchResponseBody200" (\obj -> ((((GHC.Base.pure GetProductsSearchResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "next_page")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "total_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetProductsSearchResponseBody200' with all required fields.
mkGetProductsSearchResponseBody200 :: [Product] -- ^ 'getProductsSearchResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getProductsSearchResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getProductsSearchResponseBody200Url'
  -> GetProductsSearchResponseBody200
mkGetProductsSearchResponseBody200 getProductsSearchResponseBody200Data getProductsSearchResponseBody200HasMore getProductsSearchResponseBody200Url = GetProductsSearchResponseBody200{getProductsSearchResponseBody200Data = getProductsSearchResponseBody200Data,
