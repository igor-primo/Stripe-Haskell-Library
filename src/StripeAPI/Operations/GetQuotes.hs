...
getQuotes :: forall m . StripeAPI.Common.MonadHTTP m => GetQuotesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetQuotesResponse) -- ^ Monadic computation which returns the result of the operation
getQuotes parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetQuotesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetQuotesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                             GetQuotesResponseBody200)
                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetQuotesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/quotes" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "customer") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getQuotesParametersQueryCustomer parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetQuotesParameters = GetQuotesParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetQuotesParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetQuotesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetQuotesParameters" (\obj -> ((((((GHC.Base.pure GetQuotesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStatus")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryTest_clock"))}
-- | Create a new 'GetQuotesParameters' with all required fields.
mkGetQuotesParameters :: GetQuotesParameters
mkGetQuotesParameters = GetQuotesParameters{getQuotesParametersQueryCustomer = GHC.Maybe.Nothing,
...
data GetQuotesParametersQueryStatus' =
   GetQuotesParametersQueryStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetQuotesParametersQueryStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetQuotesParametersQueryStatus'EnumAccepted -- ^ Represents the JSON value @"accepted"@
  | GetQuotesParametersQueryStatus'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | GetQuotesParametersQueryStatus'EnumDraft -- ^ Represents the JSON value @"draft"@
  | GetQuotesParametersQueryStatus'EnumOpen -- ^ Represents the JSON value @"open"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetQuotesParametersQueryStatus'
    where {toJSON (GetQuotesParametersQueryStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetQuotesParametersQueryStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "accepted" -> GetQuotesParametersQueryStatus'EnumAccepted
...
data GetQuotesResponse =
   GetQuotesResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetQuotesResponse200 GetQuotesResponseBody200 -- ^ Successful response.
  | GetQuotesResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetQuotesResponseBody200 = GetQuotesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetQuotesResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getQuotesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getQuotesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getQuotesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetQuotesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetQuotesResponseBody200" (\obj -> ((GHC.Base.pure GetQuotesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetQuotesResponseBody200' with all required fields.
mkGetQuotesResponseBody200 :: [Quote] -- ^ 'getQuotesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getQuotesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getQuotesResponseBody200Url'
  -> GetQuotesResponseBody200
mkGetQuotesResponseBody200 getQuotesResponseBody200Data getQuotesResponseBody200HasMore getQuotesResponseBody200Url = GetQuotesResponseBody200{getQuotesResponseBody200Data = getQuotesResponseBody200Data,
