...
getRadarEarlyFraudWarnings :: forall m . StripeAPI.Common.MonadHTTP m => GetRadarEarlyFraudWarningsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetRadarEarlyFraudWarningsResponse) -- ^ Monadic computation which returns the result of the operation
getRadarEarlyFraudWarnings parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetRadarEarlyFraudWarningsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetRadarEarlyFraudWarningsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                GetRadarEarlyFraudWarningsResponseBody200)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetRadarEarlyFraudWarningsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/radar/early_fraud_warnings" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "charge") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getRadarEarlyFraudWarningsParametersQueryCharge parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetRadarEarlyFraudWarningsParameters = GetRadarEarlyFraudWarningsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRadarEarlyFraudWarningsParameters
...
mkGetRadarEarlyFraudWarningsParameters = GetRadarEarlyFraudWarningsParameters{getRadarEarlyFraudWarningsParametersQueryCharge = GHC.Maybe.Nothing,
...
data GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 = GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1" (\obj -> (((GHC.Base.pure GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 = GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1{getRadarEarlyFraudWarningsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetRadarEarlyFraudWarningsParametersQueryCreated'Variants
    where {toJSON (GetRadarEarlyFraudWarningsParametersQueryCreated'GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetRadarEarlyFraudWarningsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetRadarEarlyFraudWarningsParametersQueryCreated'Variants
    where {parseJSON val = case (GetRadarEarlyFraudWarningsParametersQueryCreated'GetRadarEarlyFraudWarningsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetRadarEarlyFraudWarningsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRadarEarlyFraudWarningsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRadarEarlyFraudWarningsResponseBody200" (\obj -> ((GHC.Base.pure GetRadarEarlyFraudWarningsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetRadarEarlyFraudWarningsResponseBody200' with all required fields.
mkGetRadarEarlyFraudWarningsResponseBody200 :: [Radar'earlyFraudWarning] -- ^ 'getRadarEarlyFraudWarningsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getRadarEarlyFraudWarningsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getRadarEarlyFraudWarningsResponseBody200Url'
  -> GetRadarEarlyFraudWarningsResponseBody200
mkGetRadarEarlyFraudWarningsResponseBody200 getRadarEarlyFraudWarningsResponseBody200Data getRadarEarlyFraudWarningsResponseBody200HasMore getRadarEarlyFraudWarningsResponseBody200Url = GetRadarEarlyFraudWarningsResponseBody200{getRadarEarlyFraudWarningsResponseBody200Data = getRadarEarlyFraudWarningsResponseBody200Data,
