...
getRadarValueListsValueList :: forall m . StripeAPI.Common.MonadHTTP m => GetRadarValueListsValueListParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetRadarValueListsValueListResponse) -- ^ Monadic computation which returns the result of the operation
getRadarValueListsValueList parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetRadarValueListsValueListResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetRadarValueListsValueListResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Radar'valueList)
                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetRadarValueListsValueListResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
...
data GetRadarValueListsValueListParameters = GetRadarValueListsValueListParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRadarValueListsValueListParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathValue_list" Data.Aeson.Types.ToJSON..= getRadarValueListsValueListParametersPathValueList obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getRadarValueListsValueListParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRadarValueListsValueListParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRadarValueListsValueListParameters" (\obj -> (GHC.Base.pure GetRadarValueListsValueListParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathValue_list")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetRadarValueListsValueListParameters' with all required fields.
mkGetRadarValueListsValueListParameters :: Data.Text.Internal.Text -- ^ 'getRadarValueListsValueListParametersPathValueList'
  -> GetRadarValueListsValueListParameters
mkGetRadarValueListsValueListParameters getRadarValueListsValueListParametersPathValueList = GetRadarValueListsValueListParameters{getRadarValueListsValueListParametersPathValueList = getRadarValueListsValueListParametersPathValueList,
