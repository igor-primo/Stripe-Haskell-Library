...
getRefunds :: forall m . StripeAPI.Common.MonadHTTP m => GetRefundsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetRefundsResponse) -- ^ Monadic computation which returns the result of the operation
getRefunds parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetRefundsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                GetRefundsResponseBody200)
                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetRefundsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/refunds" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "charge") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getRefundsParametersQueryCharge parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetRefundsParameters = GetRefundsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRefundsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRefundsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRefundsParameters" (\obj -> ((((((GHC.Base.pure GetRefundsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCharge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPayment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetRefundsParameters' with all required fields.
mkGetRefundsParameters :: GetRefundsParameters
mkGetRefundsParameters = GetRefundsParameters{getRefundsParametersQueryCharge = GHC.Maybe.Nothing,
...
data GetRefundsParametersQueryCreated'OneOf1 = GetRefundsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetRefundsParametersQueryCreated'OneOf1
...
mkGetRefundsParametersQueryCreated'OneOf1 = GetRefundsParametersQueryCreated'OneOf1{getRefundsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetRefundsParametersQueryCreated'Variants
    where {toJSON (GetRefundsParametersQueryCreated'GetRefundsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetRefundsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetRefundsParametersQueryCreated'Variants
    where {parseJSON val = case (GetRefundsParametersQueryCreated'GetRefundsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetRefundsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
instance Data.Aeson.Types.FromJSON.FromJSON GetRefundsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetRefundsResponseBody200" (\obj -> ((GHC.Base.pure GetRefundsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetRefundsResponseBody200' with all required fields.
mkGetRefundsResponseBody200 :: [Refund] -- ^ 'getRefundsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getRefundsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getRefundsResponseBody200Url'
  -> GetRefundsResponseBody200
mkGetRefundsResponseBody200 getRefundsResponseBody200Data getRefundsResponseBody200HasMore getRefundsResponseBody200Url = GetRefundsResponseBody200{getRefundsResponseBody200Data = getRefundsResponseBody200Data,
