...
getSetupAttempts :: forall m . StripeAPI.Common.MonadHTTP m => GetSetupAttemptsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSetupAttemptsResponse) -- ^ Monadic computation which returns the result of the operation
getSetupAttempts parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSetupAttemptsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSetupAttemptsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  GetSetupAttemptsResponseBody200)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSetupAttemptsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/setup_attempts" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "created") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSetupAttemptsParametersQueryCreated parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSetupAttemptsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSetupAttemptsParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSetupAttemptsParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "setup_intent") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (getSetupAttemptsParametersQuerySetupIntent parameters)) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                       StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "starting_after") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSetupAttemptsParametersQueryStartingAfter parameters) (Data.Text.Internal.pack "form") GHC.Types.True])
...
data GetSetupAttemptsParameters = GetSetupAttemptsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSetupAttemptsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSetupAttemptsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSetupAttemptsParameters" (\obj -> (((((GHC.Base.pure GetSetupAttemptsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "querySetup_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetSetupAttemptsParameters' with all required fields.
mkGetSetupAttemptsParameters :: Data.Text.Internal.Text -- ^ 'getSetupAttemptsParametersQuerySetupIntent'
  -> GetSetupAttemptsParameters
mkGetSetupAttemptsParameters getSetupAttemptsParametersQuerySetupIntent = GetSetupAttemptsParameters{getSetupAttemptsParametersQueryCreated = GHC.Maybe.Nothing,
...
data GetSetupAttemptsParametersQueryCreated'OneOf1 = GetSetupAttemptsParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSetupAttemptsParametersQueryCreated'OneOf1
...
mkGetSetupAttemptsParametersQueryCreated'OneOf1 = GetSetupAttemptsParametersQueryCreated'OneOf1{getSetupAttemptsParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetSetupAttemptsParametersQueryCreated'Variants
    where {toJSON (GetSetupAttemptsParametersQueryCreated'GetSetupAttemptsParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetSetupAttemptsParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetSetupAttemptsParametersQueryCreated'Variants
    where {parseJSON val = case (GetSetupAttemptsParametersQueryCreated'GetSetupAttemptsParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetSetupAttemptsParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetSetupAttemptsResponse =
   GetSetupAttemptsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
...
data GetSetupAttemptsResponseBody200 = GetSetupAttemptsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSetupAttemptsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getSetupAttemptsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getSetupAttemptsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getSetupAttemptsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSetupAttemptsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSetupAttemptsResponseBody200" (\obj -> ((GHC.Base.pure GetSetupAttemptsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetSetupAttemptsResponseBody200' with all required fields.
mkGetSetupAttemptsResponseBody200 :: [SetupAttempt] -- ^ 'getSetupAttemptsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getSetupAttemptsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getSetupAttemptsResponseBody200Url'
  -> GetSetupAttemptsResponseBody200
mkGetSetupAttemptsResponseBody200 getSetupAttemptsResponseBody200Data getSetupAttemptsResponseBody200HasMore getSetupAttemptsResponseBody200Url = GetSetupAttemptsResponseBody200{getSetupAttemptsResponseBody200Data = getSetupAttemptsResponseBody200Data,
