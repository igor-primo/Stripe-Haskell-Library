...
getShippingRates :: forall m . StripeAPI.Common.MonadHTTP m => GetShippingRatesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetShippingRatesResponse) -- ^ Monadic computation which returns the result of the operation
getShippingRates parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetShippingRatesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetShippingRatesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  GetShippingRatesResponseBody200)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetShippingRatesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/shipping_rates" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "active") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getShippingRatesParametersQueryActive parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetShippingRatesParameters = GetShippingRatesParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetShippingRatesParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetShippingRatesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetShippingRatesParameters" (\obj -> ((((((GHC.Base.pure GetShippingRatesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryActive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCurrency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetShippingRatesParameters' with all required fields.
mkGetShippingRatesParameters :: GetShippingRatesParameters
mkGetShippingRatesParameters = GetShippingRatesParameters{getShippingRatesParametersQueryActive = GHC.Maybe.Nothing,
...
data GetShippingRatesParametersQueryCreated'OneOf1 = GetShippingRatesParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetShippingRatesParametersQueryCreated'OneOf1
...
mkGetShippingRatesParametersQueryCreated'OneOf1 = GetShippingRatesParametersQueryCreated'OneOf1{getShippingRatesParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetShippingRatesParametersQueryCreated'Variants
    where {toJSON (GetShippingRatesParametersQueryCreated'GetShippingRatesParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetShippingRatesParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetShippingRatesParametersQueryCreated'Variants
    where {parseJSON val = case (GetShippingRatesParametersQueryCreated'GetShippingRatesParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetShippingRatesParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetShippingRatesResponse =
   GetShippingRatesResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetShippingRatesResponse200 GetShippingRatesResponseBody200 -- ^ Successful response.
  | GetShippingRatesResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetShippingRatesResponseBody200 = GetShippingRatesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetShippingRatesResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getShippingRatesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getShippingRatesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getShippingRatesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetShippingRatesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetShippingRatesResponseBody200" (\obj -> ((GHC.Base.pure GetShippingRatesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetShippingRatesResponseBody200' with all required fields.
mkGetShippingRatesResponseBody200 :: [ShippingRate] -- ^ 'getShippingRatesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getShippingRatesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getShippingRatesResponseBody200Url'
  -> GetShippingRatesResponseBody200
mkGetShippingRatesResponseBody200 getShippingRatesResponseBody200Data getShippingRatesResponseBody200HasMore getShippingRatesResponseBody200Url = GetShippingRatesResponseBody200{getShippingRatesResponseBody200Data = getShippingRatesResponseBody200Data,
