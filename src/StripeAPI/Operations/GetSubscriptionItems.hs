...
getSubscriptionItems :: forall m . StripeAPI.Common.MonadHTTP m => GetSubscriptionItemsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSubscriptionItemsResponse) -- ^ Monadic computation which returns the result of the operation
getSubscriptionItems parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSubscriptionItemsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionItemsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              GetSubscriptionItemsResponseBody200)
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionItemsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
                                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/subscription_items" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionItemsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetSubscriptionItemsParameters = GetSubscriptionItemsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionItemsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionItemsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSubscriptionItemsParameters" (\obj -> ((((GHC.Base.pure GetSubscriptionItemsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "querySubscription"))}
-- | Create a new 'GetSubscriptionItemsParameters' with all required fields.
mkGetSubscriptionItemsParameters :: Data.Text.Internal.Text -- ^ 'getSubscriptionItemsParametersQuerySubscription'
  -> GetSubscriptionItemsParameters
mkGetSubscriptionItemsParameters getSubscriptionItemsParametersQuerySubscription = GetSubscriptionItemsParameters{getSubscriptionItemsParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
data GetSubscriptionItemsResponseBody200 = GetSubscriptionItemsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionItemsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getSubscriptionItemsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getSubscriptionItemsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getSubscriptionItemsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionItemsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSubscriptionItemsResponseBody200" (\obj -> ((GHC.Base.pure GetSubscriptionItemsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetSubscriptionItemsResponseBody200' with all required fields.
mkGetSubscriptionItemsResponseBody200 :: [SubscriptionItem] -- ^ 'getSubscriptionItemsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getSubscriptionItemsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getSubscriptionItemsResponseBody200Url'
  -> GetSubscriptionItemsResponseBody200
mkGetSubscriptionItemsResponseBody200 getSubscriptionItemsResponseBody200Data getSubscriptionItemsResponseBody200HasMore getSubscriptionItemsResponseBody200Url = GetSubscriptionItemsResponseBody200{getSubscriptionItemsResponseBody200Data = getSubscriptionItemsResponseBody200Data,
