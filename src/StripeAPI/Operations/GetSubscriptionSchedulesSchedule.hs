...
getSubscriptionSchedulesSchedule :: forall m . StripeAPI.Common.MonadHTTP m => GetSubscriptionSchedulesScheduleParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSubscriptionSchedulesScheduleResponse) -- ^ Monadic computation which returns the result of the operation
getSubscriptionSchedulesSchedule parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSubscriptionSchedulesScheduleResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionSchedulesScheduleResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  SubscriptionSchedule)
                                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionSchedulesScheduleResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                    Error)
...
data GetSubscriptionSchedulesScheduleParameters = GetSubscriptionSchedulesScheduleParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionSchedulesScheduleParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathSchedule" Data.Aeson.Types.ToJSON..= getSubscriptionSchedulesScheduleParametersPathSchedule obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getSubscriptionSchedulesScheduleParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionSchedulesScheduleParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSubscriptionSchedulesScheduleParameters" (\obj -> (GHC.Base.pure GetSubscriptionSchedulesScheduleParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathSchedule")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetSubscriptionSchedulesScheduleParameters' with all required fields.
mkGetSubscriptionSchedulesScheduleParameters :: Data.Text.Internal.Text -- ^ 'getSubscriptionSchedulesScheduleParametersPathSchedule'
  -> GetSubscriptionSchedulesScheduleParameters
mkGetSubscriptionSchedulesScheduleParameters getSubscriptionSchedulesScheduleParametersPathSchedule = GetSubscriptionSchedulesScheduleParameters{getSubscriptionSchedulesScheduleParametersPathSchedule = getSubscriptionSchedulesScheduleParametersPathSchedule,
