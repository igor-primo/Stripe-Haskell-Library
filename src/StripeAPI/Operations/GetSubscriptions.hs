...
getSubscriptions parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSubscriptionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                  GetSubscriptionsResponseBody200)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                    Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/subscriptions" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "automatic_tax") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionsParametersQueryAutomaticTax parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetSubscriptionsParametersQueryAutomaticTax' = GetSubscriptionsParametersQueryAutomaticTax' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionsParametersQueryAutomaticTax'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= getSubscriptionsParametersQueryAutomaticTax'Enabled obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionsParametersQueryAutomaticTax'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSubscriptionsParametersQueryAutomaticTax'" (\obj -> GHC.Base.pure GetSubscriptionsParametersQueryAutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))}
-- | Create a new 'GetSubscriptionsParametersQueryAutomaticTax'' with all required fields.
mkGetSubscriptionsParametersQueryAutomaticTax' :: GHC.Types.Bool -- ^ 'getSubscriptionsParametersQueryAutomaticTax'Enabled'
...
data GetSubscriptionsParametersQueryStatus' =
  ...
  | GetSubscriptionsParametersQueryStatus'EnumPaused -- ^ Represents the JSON value @"paused"@
