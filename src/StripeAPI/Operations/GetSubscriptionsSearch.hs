...
getSubscriptionsSearch :: forall m . StripeAPI.Common.MonadHTTP m => GetSubscriptionsSearchParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetSubscriptionsSearchResponse) -- ^ Monadic computation which returns the result of the operation
getSubscriptionsSearch parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetSubscriptionsSearchResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionsSearchResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                     ...
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetSubscriptionsSearchResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/subscriptions/search" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionsSearchParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                         StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionsSearchParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                         StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "page") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getSubscriptionsSearchParametersQueryPage parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                         StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "query") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (getSubscriptionsSearchParametersQueryQuery parameters)) (Data.Text.Internal.pack "form") GHC.Types.True])
...
data GetSubscriptionsSearchParameters = GetSubscriptionsSearchParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetSubscriptionsSearchParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionsSearchParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetSubscriptionsSearchParameters" (\obj -> (((GHC.Base.pure GetSubscriptionsSearchParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryPage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryQuery"))}
-- | Create a new 'GetSubscriptionsSearchParameters' with all required fields.
mkGetSubscriptionsSearchParameters :: Data.Text.Internal.Text -- ^ 'getSubscriptionsSearchParametersQueryQuery'
  -> GetSubscriptionsSearchParameters
mkGetSubscriptionsSearchParameters getSubscriptionsSearchParametersQueryQuery = GetSubscriptionsSearchParameters{getSubscriptionsSearchParametersQueryExpand = GHC.Maybe.Nothing,
...
data GetSubscriptionsSearchResponse =
   GetSubscriptionsSearchResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetSubscriptionsSearchResponse200 GetSubscriptionsSearchResponseBody200 -- ^ Successful response.
  | GetSubscriptionsSearchResponseDefault Error -- ^ Error response.
...
instance Data.Aeson.Types.FromJSON.FromJSON GetSubscriptionsSearchResponseBody200
...
mkGetSubscriptionsSearchResponseBody200 :: [Subscription] -- ^ 'getSubscriptionsSearchResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getSubscriptionsSearchResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getSubscriptionsSearchResponseBody200Url'
  -> GetSubscriptionsSearchResponseBody200
mkGetSubscriptionsSearchResponseBody200 getSubscriptionsSearchResponseBody200Data getSubscriptionsSearchResponseBody200HasMore getSubscriptionsSearchResponseBody200Url = GetSubscriptionsSearchResponseBody200{getSubscriptionsSearchResponseBody200Data = getSubscriptionsSearchResponseBody200Data,
