...
getTaxCalculationsCalculationLineItems :: forall m . StripeAPI.Common.MonadHTTP m => GetTaxCalculationsCalculationLineItemsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTaxCalculationsCalculationLineItemsResponse) -- ^ Monadic computation which returns the result of the operation
getTaxCalculationsCalculationLineItems parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTaxCalculationsCalculationLineItemsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTaxCalculationsCalculationLineItemsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    GetTaxCalculationsCalculationLineItemsResponseBody200)
                                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTaxCalculationsCalculationLineItemsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
                                                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/tax/calculations/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getTaxCalculationsCalculationLineItemsParametersPathCalculation parameters))) GHC.Base.<> "/line_items")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTaxCalculationsCalculationLineItemsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTaxCalculationsCalculationLineItemsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTaxCalculationsCalculationLineItemsParameters" (\obj -> ((((GHC.Base.pure GetTaxCalculationsCalculationLineItemsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCalculation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
-- | Create a new 'GetTaxCalculationsCalculationLineItemsParameters' with all required fields.
mkGetTaxCalculationsCalculationLineItemsParameters :: Data.Text.Internal.Text -- ^ 'getTaxCalculationsCalculationLineItemsParametersPathCalculation'
  -> GetTaxCalculationsCalculationLineItemsParameters
mkGetTaxCalculationsCalculationLineItemsParameters getTaxCalculationsCalculationLineItemsParametersPathCalculation = GetTaxCalculationsCalculationLineItemsParameters{getTaxCalculationsCalculationLineItemsParametersPathCalculation = getTaxCalculationsCalculationLineItemsParametersPathCalculation,
...
data GetTaxCalculationsCalculationLineItemsResponse =
   GetTaxCalculationsCalculationLineItemsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetTaxCalculationsCalculationLineItemsResponse200 GetTaxCalculationsCalculationLineItemsResponseBody200 -- ^ Successful response.
  | GetTaxCalculationsCalculationLineItemsResponseDefault Error -- ^ Error response.
...
data GetTaxCalculationsCalculationLineItemsResponseBody200 = GetTaxCalculationsCalculationLineItemsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTaxCalculationsCalculationLineItemsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getTaxCalculationsCalculationLineItemsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getTaxCalculationsCalculationLineItemsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getTaxCalculationsCalculationLineItemsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTaxCalculationsCalculationLineItemsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTaxCalculationsCalculationLineItemsResponseBody200" (\obj -> ((GHC.Base.pure GetTaxCalculationsCalculationLineItemsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetTaxCalculationsCalculationLineItemsResponseBody200' with all required fields.
mkGetTaxCalculationsCalculationLineItemsResponseBody200 :: [Tax'calculationLineItem] -- ^ 'getTaxCalculationsCalculationLineItemsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getTaxCalculationsCalculationLineItemsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getTaxCalculationsCalculationLineItemsResponseBody200Url'
  -> GetTaxCalculationsCalculationLineItemsResponseBody200
mkGetTaxCalculationsCalculationLineItemsResponseBody200 getTaxCalculationsCalculationLineItemsResponseBody200Data getTaxCalculationsCalculationLineItemsResponseBody200HasMore getTaxCalculationsCalculationLineItemsResponseBody200Url = GetTaxCalculationsCalculationLineItemsResponseBody200{getTaxCalculationsCalculationLineItemsResponseBody200Data = getTaxCalculationsCalculationLineItemsResponseBody200Data,
