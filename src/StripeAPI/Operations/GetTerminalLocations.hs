...
getTerminalLocations :: forall m . StripeAPI.Common.MonadHTTP m => GetTerminalLocationsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTerminalLocationsResponse) -- ^ Monadic computation which returns the result of the operation
getTerminalLocations parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTerminalLocationsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalLocationsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              GetTerminalLocationsResponseBody200)
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalLocationsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
                                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/terminal/locations" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTerminalLocationsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetTerminalLocationsParameters = GetTerminalLocationsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalLocationsParameters
...
mkGetTerminalLocationsParameters = GetTerminalLocationsParameters{getTerminalLocationsParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalLocationsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalLocationsResponseBody200" (\obj -> ((GHC.Base.pure GetTerminalLocationsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetTerminalLocationsResponseBody200' with all required fields.
mkGetTerminalLocationsResponseBody200 :: [Terminal'location] -- ^ 'getTerminalLocationsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getTerminalLocationsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getTerminalLocationsResponseBody200Url'
  -> GetTerminalLocationsResponseBody200
mkGetTerminalLocationsResponseBody200 getTerminalLocationsResponseBody200Data getTerminalLocationsResponseBody200HasMore getTerminalLocationsResponseBody200Url = GetTerminalLocationsResponseBody200{getTerminalLocationsResponseBody200Data = getTerminalLocationsResponseBody200Data,
