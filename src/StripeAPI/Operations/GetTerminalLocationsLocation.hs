...
getTerminalLocationsLocation :: forall m . StripeAPI.Common.MonadHTTP m => GetTerminalLocationsLocationParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTerminalLocationsLocationResponse) -- ^ Monadic computation which returns the result of the operation
getTerminalLocationsLocation parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTerminalLocationsLocationResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalLocationsLocationResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      GetTerminalLocationsLocationResponseBody200)
                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalLocationsLocationResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                        Error)
                                                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") ("/v1/terminal/locations/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (getTerminalLocationsLocationParametersPathLocation parameters))) GHC.Base.<> "")) [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTerminalLocationsLocationParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True])
...
data GetTerminalLocationsLocationParameters = GetTerminalLocationsLocationParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalLocationsLocationParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathLocation" Data.Aeson.Types.ToJSON..= getTerminalLocationsLocationParametersPathLocation obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getTerminalLocationsLocationParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalLocationsLocationParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalLocationsLocationParameters" (\obj -> (GHC.Base.pure GetTerminalLocationsLocationParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathLocation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetTerminalLocationsLocationParameters' with all required fields.
mkGetTerminalLocationsLocationParameters :: Data.Text.Internal.Text -- ^ 'getTerminalLocationsLocationParametersPathLocation'
  -> GetTerminalLocationsLocationParameters
mkGetTerminalLocationsLocationParameters getTerminalLocationsLocationParametersPathLocation = GetTerminalLocationsLocationParameters{getTerminalLocationsLocationParametersPathLocation = getTerminalLocationsLocationParametersPathLocation,
...
data GetTerminalLocationsLocationResponse =
  ...
  | GetTerminalLocationsLocationResponse200 GetTerminalLocationsLocationResponseBody200 -- ^ Successful response.
...
data GetTerminalLocationsLocationResponseBody200 = GetTerminalLocationsLocationResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalLocationsLocationResponseBody200
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalLocationsLocationResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalLocationsLocationResponseBody200" (\obj -> (((((((GHC.Base.pure GetTerminalLocationsLocationResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "configuration_overrides")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "deleted")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "display_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object"))}
...
mkGetTerminalLocationsLocationResponseBody200 = GetTerminalLocationsLocationResponseBody200{getTerminalLocationsLocationResponseBody200Address = GHC.Maybe.Nothing,
...
data GetTerminalLocationsLocationResponseBody200Deleted' =
   GetTerminalLocationsLocationResponseBody200Deleted'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalLocationsLocationResponseBody200Deleted'Typed GHC.Types.Bool -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalLocationsLocationResponseBody200Deleted'EnumTrue -- ^ Represents the JSON value @true@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalLocationsLocationResponseBody200Deleted'
    where {toJSON (GetTerminalLocationsLocationResponseBody200Deleted'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalLocationsLocationResponseBody200Deleted'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== Data.Aeson.Types.Internal.Bool GHC.Types.True -> GetTerminalLocationsLocationResponseBody200Deleted'EnumTrue
...
data GetTerminalLocationsLocationResponseBody200Object' =
   GetTerminalLocationsLocationResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalLocationsLocationResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalLocationsLocationResponseBody200Object'EnumTerminal'location -- ^ Represents the JSON value @"terminal.location"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalLocationsLocationResponseBody200Object'
    where {toJSON (GetTerminalLocationsLocationResponseBody200Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalLocationsLocationResponseBody200Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "terminal.location" -> GetTerminalLocationsLocationResponseBody200Object'EnumTerminal'location
