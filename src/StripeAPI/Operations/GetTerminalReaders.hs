...
getTerminalReaders parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTerminalReadersResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalReadersResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                        GetTerminalReadersResponseBody200)
                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalReadersResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                          Error)
...
data GetTerminalReadersParametersQueryDeviceType' =
  ...
  | GetTerminalReadersParametersQueryDeviceType'EnumMobilePhoneReader -- ^ Represents the JSON value @"mobile_phone_reader"@
  | GetTerminalReadersParametersQueryDeviceType'EnumSimulatedStripeS700 -- ^ Represents the JSON value @"simulated_stripe_s700"@
  ...
  | GetTerminalReadersParametersQueryDeviceType'EnumStripeS700 -- ^ Represents the JSON value @"stripe_s700"@
...
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersParametersQueryDeviceType'
    where {toJSON (GetTerminalReadersParametersQueryDeviceType'Other val) = val;
           ...
           toJSON (GetTerminalReadersParametersQueryDeviceType'EnumMobilePhoneReader) = "mobile_phone_reader";
           toJSON (GetTerminalReadersParametersQueryDeviceType'EnumSimulatedStripeS700) = "simulated_stripe_s700";
           ...
           toJSON (GetTerminalReadersParametersQueryDeviceType'EnumStripeS700) = "stripe_s700";
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersParametersQueryDeviceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bbpos_chipper2x" -> GetTerminalReadersParametersQueryDeviceType'EnumBbposChipper2x
                                             ...
                                             | val GHC.Classes.== "mobile_phone_reader" -> GetTerminalReadersParametersQueryDeviceType'EnumMobilePhoneReader
                                             | val GHC.Classes.== "simulated_stripe_s700" -> GetTerminalReadersParametersQueryDeviceType'EnumSimulatedStripeS700
                                             ...
                                             | val GHC.Classes.== "stripe_s700" -> GetTerminalReadersParametersQueryDeviceType'EnumStripeS700
