...
getTerminalReadersReader :: forall m . StripeAPI.Common.MonadHTTP m => GetTerminalReadersReaderParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTerminalReadersReaderResponse) -- ^ Monadic computation which returns the result of the operation
getTerminalReadersReader parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTerminalReadersReaderResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalReadersReaderResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          GetTerminalReadersReaderResponseBody200)
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTerminalReadersReaderResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
...
data GetTerminalReadersReaderParameters = GetTerminalReadersReaderParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathReader" Data.Aeson.Types.ToJSON..= getTerminalReadersReaderParametersPathReader obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalReadersReaderParameters" (\obj -> (GHC.Base.pure GetTerminalReadersReaderParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathReader")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetTerminalReadersReaderParameters' with all required fields.
mkGetTerminalReadersReaderParameters :: Data.Text.Internal.Text -- ^ 'getTerminalReadersReaderParametersPathReader'
  -> GetTerminalReadersReaderParameters
mkGetTerminalReadersReaderParameters getTerminalReadersReaderParametersPathReader = GetTerminalReadersReaderParameters{getTerminalReadersReaderParametersPathReader = getTerminalReadersReaderParametersPathReader,
...
data GetTerminalReadersReaderResponse =
  ...
  | GetTerminalReadersReaderResponse200 GetTerminalReadersReaderResponseBody200 -- ^ Successful response.
...
data GetTerminalReadersReaderResponseBody200 = GetTerminalReadersReaderResponseBody200 {
  ...
  , getTerminalReadersReaderResponseBody200Status :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GetTerminalReadersReaderResponseBody200Status'NonNullable))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalReadersReaderResponseBody200" (\obj -> ((((((((((((GHC.Base.pure GetTerminalReadersReaderResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "action")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "deleted")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "device_sw_version")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "device_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "label")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "serial_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))}
...
mkGetTerminalReadersReaderResponseBody200 = GetTerminalReadersReaderResponseBody200{getTerminalReadersReaderResponseBody200Action = GHC.Maybe.Nothing,
...
data GetTerminalReadersReaderResponseBody200Action'NonNullable = GetTerminalReadersReaderResponseBody200Action'NonNullable {
  ...
  getTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs :: (GHC.Maybe.Maybe TerminalReaderReaderResourceCollectInputsAction)
  -- | collect_payment_method: Represents a reader action to collect a payment method
  , getTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod :: (GHC.Maybe.Maybe TerminalReaderReaderResourceCollectPaymentMethodAction)
  -- | confirm_payment_intent: Represents a reader action to confirm a payment
  , getTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent :: (GHC.Maybe.Maybe TerminalReaderReaderResourceConfirmPaymentIntentAction)
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Action'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_inputs" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_payment_method" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("confirm_payment_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_code" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableFailureCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_message" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableFailureMessage obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_payment_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableProcessPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_setup_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableProcessSetupIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_payment" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableRefundPayment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("set_reader_display" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableSetReaderDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_inputs" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_payment_method" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("confirm_payment_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_code" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableFailureCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_message" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableFailureMessage obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_payment_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableProcessPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_setup_intent" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableProcessSetupIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_payment" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableRefundPayment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("set_reader_display" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableSetReaderDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (getTerminalReadersReaderResponseBody200Action'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Action'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTerminalReadersReaderResponseBody200Action'NonNullable" (\obj -> ((((((((((GHC.Base.pure GetTerminalReadersReaderResponseBody200Action'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "collect_inputs")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "collect_payment_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "confirm_payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_message")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_setup_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_payment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "set_reader_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkGetTerminalReadersReaderResponseBody200Action'NonNullable = GetTerminalReadersReaderResponseBody200Action'NonNullable{getTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs = GHC.Maybe.Nothing,
                                                                                                                        getTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod = GHC.Maybe.Nothing,
                                                                                                                        getTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent = GHC.Maybe.Nothing,
...
data GetTerminalReadersReaderResponseBody200Action'NonNullableStatus' =
   GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumInProgress -- ^ Represents the JSON value @"in_progress"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'
    where {toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> GetTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumFailed
...
data GetTerminalReadersReaderResponseBody200Action'NonNullableType' =
   GetTerminalReadersReaderResponseBody200Action'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs -- ^ Represents the JSON value @"collect_inputs"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod -- ^ Represents the JSON value @"collect_payment_method"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent -- ^ Represents the JSON value @"confirm_payment_intent"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumProcessPaymentIntent -- ^ Represents the JSON value @"process_payment_intent"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumProcessSetupIntent -- ^ Represents the JSON value @"process_setup_intent"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumRefundPayment -- ^ Represents the JSON value @"refund_payment"@
  | GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumSetReaderDisplay -- ^ Represents the JSON value @"set_reader_display"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Action'NonNullableType'
    where {toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableType'Other val) = val;
           toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs) = "collect_inputs";
           toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod) = "collect_payment_method";
           toJSON (GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent) = "confirm_payment_intent";
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Action'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "collect_inputs" -> GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs
                                             | val GHC.Classes.== "collect_payment_method" -> GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod
                                             | val GHC.Classes.== "confirm_payment_intent" -> GetTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent
...
data GetTerminalReadersReaderResponseBody200Deleted' =
   GetTerminalReadersReaderResponseBody200Deleted'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200Deleted'Typed GHC.Types.Bool -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200Deleted'EnumTrue -- ^ Represents the JSON value @true@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Deleted'
    where {toJSON (GetTerminalReadersReaderResponseBody200Deleted'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Deleted'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== Data.Aeson.Types.Internal.Bool GHC.Types.True -> GetTerminalReadersReaderResponseBody200Deleted'EnumTrue
...
data GetTerminalReadersReaderResponseBody200DeviceType' =
   GetTerminalReadersReaderResponseBody200DeviceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200DeviceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumBbposChipper2x -- ^ Represents the JSON value @"bbpos_chipper2x"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumBbposWisepad3 -- ^ Represents the JSON value @"bbpos_wisepad3"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumBbposWiseposE -- ^ Represents the JSON value @"bbpos_wisepos_e"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader -- ^ Represents the JSON value @"mobile_phone_reader"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700 -- ^ Represents the JSON value @"simulated_stripe_s700"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedWiseposE -- ^ Represents the JSON value @"simulated_wisepos_e"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumStripeM2 -- ^ Represents the JSON value @"stripe_m2"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700 -- ^ Represents the JSON value @"stripe_s700"@
  | GetTerminalReadersReaderResponseBody200DeviceType'EnumVerifoneP400 -- ^ Represents the JSON value @"verifone_P400"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200DeviceType'
    where {toJSON (GetTerminalReadersReaderResponseBody200DeviceType'Other val) = val;
           ...
           toJSON (GetTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader) = "mobile_phone_reader";
           toJSON (GetTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700) = "simulated_stripe_s700";
           ...
           toJSON (GetTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700) = "stripe_s700";
           toJSON (GetTerminalReadersReaderResponseBody200DeviceType'EnumVerifoneP400) = "verifone_P400"}
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200DeviceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bbpos_chipper2x" -> GetTerminalReadersReaderResponseBody200DeviceType'EnumBbposChipper2x
                                             ...
                                             | val GHC.Classes.== "mobile_phone_reader" -> GetTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader
                                             | val GHC.Classes.== "simulated_stripe_s700" -> GetTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700
                                             ...
                                             | val GHC.Classes.== "stripe_s700" -> GetTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700
...
data GetTerminalReadersReaderResponseBody200Location'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Location'NonNullableVariants
    where {toJSON (GetTerminalReadersReaderResponseBody200Location'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetTerminalReadersReaderResponseBody200Location'NonNullableTerminal'location a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Location'NonNullableVariants
    where {parseJSON val = case (GetTerminalReadersReaderResponseBody200Location'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetTerminalReadersReaderResponseBody200Location'NonNullableTerminal'location Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetTerminalReadersReaderResponseBody200Object' =
   GetTerminalReadersReaderResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200Object'EnumTerminal'reader -- ^ Represents the JSON value @"terminal.reader"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Object'
    where {toJSON (GetTerminalReadersReaderResponseBody200Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "terminal.reader" -> GetTerminalReadersReaderResponseBody200Object'EnumTerminal'reader
                                             | GHC.Base.otherwise -> GetTerminalReadersReaderResponseBody200Object'Other val)}
-- | Defines the enum schema located at @paths.\/v1\/terminal\/readers\/{reader}.GET.responses.200.content.application\/json.schema.anyOf.properties.status@ in the specification.
-- 
-- The networking status of the reader. We do not recommend using this field in flows that may block taking payments.
data GetTerminalReadersReaderResponseBody200Status'NonNullable =
   GetTerminalReadersReaderResponseBody200Status'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTerminalReadersReaderResponseBody200Status'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline -- ^ Represents the JSON value @"offline"@
  | GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline -- ^ Represents the JSON value @"online"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTerminalReadersReaderResponseBody200Status'NonNullable
    where {toJSON (GetTerminalReadersReaderResponseBody200Status'NonNullableOther val) = val;
           toJSON (GetTerminalReadersReaderResponseBody200Status'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline) = "offline";
           toJSON (GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline) = "online"}
instance Data.Aeson.Types.FromJSON.FromJSON GetTerminalReadersReaderResponseBody200Status'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "offline" -> GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline
                                             | val GHC.Classes.== "online" -> GetTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline
                                             | GHC.Base.otherwise -> GetTerminalReadersReaderResponseBody200Status'NonNullableOther val)}
