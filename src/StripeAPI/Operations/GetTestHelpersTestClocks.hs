...
getTestHelpersTestClocks :: forall m . StripeAPI.Common.MonadHTTP m => GetTestHelpersTestClocksParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTestHelpersTestClocksResponse) -- ^ Monadic computation which returns the result of the operation
getTestHelpersTestClocks parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTestHelpersTestClocksResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTestHelpersTestClocksResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          GetTestHelpersTestClocksResponseBody200)
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTestHelpersTestClocksResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/test_helpers/test_clocks" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTestHelpersTestClocksParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetTestHelpersTestClocksParameters = GetTestHelpersTestClocksParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTestHelpersTestClocksParameters
...
mkGetTestHelpersTestClocksParameters = GetTestHelpersTestClocksParameters{getTestHelpersTestClocksParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
data GetTestHelpersTestClocksResponse =
   GetTestHelpersTestClocksResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetTestHelpersTestClocksResponse200 GetTestHelpersTestClocksResponseBody200 -- ^ Successful response.
  | GetTestHelpersTestClocksResponseDefault Error -- ^ Error response.
...
data GetTestHelpersTestClocksResponseBody200 = GetTestHelpersTestClocksResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTestHelpersTestClocksResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getTestHelpersTestClocksResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getTestHelpersTestClocksResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getTestHelpersTestClocksResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTestHelpersTestClocksResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTestHelpersTestClocksResponseBody200" (\obj -> ((GHC.Base.pure GetTestHelpersTestClocksResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetTestHelpersTestClocksResponseBody200' with all required fields.
mkGetTestHelpersTestClocksResponseBody200 :: [TestHelpers'testClock] -- ^ 'getTestHelpersTestClocksResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getTestHelpersTestClocksResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getTestHelpersTestClocksResponseBody200Url'
  -> GetTestHelpersTestClocksResponseBody200
mkGetTestHelpersTestClocksResponseBody200 getTestHelpersTestClocksResponseBody200Data getTestHelpersTestClocksResponseBody200HasMore getTestHelpersTestClocksResponseBody200Url = GetTestHelpersTestClocksResponseBody200{getTestHelpersTestClocksResponseBody200Data = getTestHelpersTestClocksResponseBody200Data,
