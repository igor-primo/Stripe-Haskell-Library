...
getTreasuryReceivedCredits parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTreasuryReceivedCreditsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryReceivedCreditsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                GetTreasuryReceivedCreditsResponseBody200)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryReceivedCreditsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/treasury/received_credits" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "expand") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryExpand parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "financial_account") (GHC.Maybe.Just GHC.Base.$ Data.Aeson.Types.ToJSON.toJSON (getTreasuryReceivedCreditsParametersQueryFinancialAccount parameters)) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "limit") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryLimit parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "linked_flows") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryLinkedFlows parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "starting_after") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryStartingAfter parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
                                                                                                                                                                                                                                                                                                                                                                                                                                      StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "status") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedCreditsParametersQueryStatus parameters) (Data.Text.Internal.pack "form") GHC.Types.True])
...
data GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType' =
  ...
  | GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'EnumOutboundTransfer -- ^ Represents the JSON value @"outbound_transfer"@
...
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'
    where {toJSON (GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'Other val) = val;
           ...
           toJSON (GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'EnumOutboundTransfer) = "outbound_transfer";
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_reversal" -> GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'EnumCreditReversal
                                             ...
                                             | val GHC.Classes.== "outbound_transfer" -> GetTreasuryReceivedCreditsParametersQueryLinkedFlows'SourceFlowType'EnumOutboundTransfer
