...
getTreasuryReceivedDebits :: forall m . StripeAPI.Common.MonadHTTP m => GetTreasuryReceivedDebitsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTreasuryReceivedDebitsResponse) -- ^ Monadic computation which returns the result of the operation
getTreasuryReceivedDebits parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTreasuryReceivedDebitsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryReceivedDebitsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                             GetTreasuryReceivedDebitsResponseBody200)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryReceivedDebitsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/treasury/received_debits" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryReceivedDebitsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetTreasuryReceivedDebitsParameters = GetTreasuryReceivedDebitsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryReceivedDebitsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryReceivedDebitsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryReceivedDebitsParameters" (\obj -> (((((GHC.Base.pure GetTreasuryReceivedDebitsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryFinancial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStatus"))}
-- | Create a new 'GetTreasuryReceivedDebitsParameters' with all required fields.
mkGetTreasuryReceivedDebitsParameters :: Data.Text.Internal.Text -- ^ 'getTreasuryReceivedDebitsParametersQueryFinancialAccount'
  -> GetTreasuryReceivedDebitsParameters
mkGetTreasuryReceivedDebitsParameters getTreasuryReceivedDebitsParametersQueryFinancialAccount = GetTreasuryReceivedDebitsParameters{getTreasuryReceivedDebitsParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
data GetTreasuryReceivedDebitsParametersQueryStatus' =
   GetTreasuryReceivedDebitsParametersQueryStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTreasuryReceivedDebitsParametersQueryStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTreasuryReceivedDebitsParametersQueryStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | GetTreasuryReceivedDebitsParametersQueryStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryReceivedDebitsParametersQueryStatus'
    where {toJSON (GetTreasuryReceivedDebitsParametersQueryStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryReceivedDebitsParametersQueryStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> GetTreasuryReceivedDebitsParametersQueryStatus'EnumFailed
...
data GetTreasuryReceivedDebitsResponse =
   GetTreasuryReceivedDebitsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetTreasuryReceivedDebitsResponse200 GetTreasuryReceivedDebitsResponseBody200 -- ^ Successful response.
  | GetTreasuryReceivedDebitsResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetTreasuryReceivedDebitsResponseBody200 = GetTreasuryReceivedDebitsResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryReceivedDebitsResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getTreasuryReceivedDebitsResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getTreasuryReceivedDebitsResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getTreasuryReceivedDebitsResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryReceivedDebitsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryReceivedDebitsResponseBody200" (\obj -> ((GHC.Base.pure GetTreasuryReceivedDebitsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetTreasuryReceivedDebitsResponseBody200' with all required fields.
mkGetTreasuryReceivedDebitsResponseBody200 :: [Treasury'receivedDebit] -- ^ 'getTreasuryReceivedDebitsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getTreasuryReceivedDebitsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getTreasuryReceivedDebitsResponseBody200Url'
  -> GetTreasuryReceivedDebitsResponseBody200
mkGetTreasuryReceivedDebitsResponseBody200 getTreasuryReceivedDebitsResponseBody200Data getTreasuryReceivedDebitsResponseBody200HasMore getTreasuryReceivedDebitsResponseBody200Url = GetTreasuryReceivedDebitsResponseBody200{getTreasuryReceivedDebitsResponseBody200Data = getTreasuryReceivedDebitsResponseBody200Data,
