...
getTreasuryTransactionEntries :: forall m . StripeAPI.Common.MonadHTTP m => GetTreasuryTransactionEntriesParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetTreasuryTransactionEntriesResponse) -- ^ Monadic computation which returns the result of the operation
getTreasuryTransactionEntries parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetTreasuryTransactionEntriesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryTransactionEntriesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         GetTreasuryTransactionEntriesResponseBody200)
                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetTreasuryTransactionEntriesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                                                   | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/treasury/transaction_entries" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "created") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getTreasuryTransactionEntriesParametersQueryCreated parameters) (Data.Text.Internal.pack "deepObject") GHC.Types.True,
...
data GetTreasuryTransactionEntriesParameters = GetTreasuryTransactionEntriesParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryTransactionEntriesParameters" (\obj -> ((((((((GHC.Base.pure GetTreasuryTransactionEntriesParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryCreated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEffective_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "queryFinancial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryOrder_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryTransaction"))}
-- | Create a new 'GetTreasuryTransactionEntriesParameters' with all required fields.
mkGetTreasuryTransactionEntriesParameters :: Data.Text.Internal.Text -- ^ 'getTreasuryTransactionEntriesParametersQueryFinancialAccount'
  -> GetTreasuryTransactionEntriesParameters
mkGetTreasuryTransactionEntriesParameters getTreasuryTransactionEntriesParametersQueryFinancialAccount = GetTreasuryTransactionEntriesParameters{getTreasuryTransactionEntriesParametersQueryCreated = GHC.Maybe.Nothing,
...
data GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 = GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1" (\obj -> (((GHC.Base.pure GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 = GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1{getTreasuryTransactionEntriesParametersQueryCreated'OneOf1Gt = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParametersQueryCreated'Variants
    where {toJSON (GetTreasuryTransactionEntriesParametersQueryCreated'GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetTreasuryTransactionEntriesParametersQueryCreated'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParametersQueryCreated'Variants
    where {parseJSON val = case (GetTreasuryTransactionEntriesParametersQueryCreated'GetTreasuryTransactionEntriesParametersQueryCreated'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetTreasuryTransactionEntriesParametersQueryCreated'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 = GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Lte obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Gt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Gte obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lt" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Lt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lte" Data.Aeson.Types.ToJSON..=)) (getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Lte obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1" (\obj -> (((GHC.Base.pure GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "gte")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lt")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lte"))}
...
mkGetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 = GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1{getTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1Gt = GHC.Maybe.Nothing,
...
data GetTreasuryTransactionEntriesParametersQueryEffectiveAt'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParametersQueryEffectiveAt'Variants
    where {toJSON (GetTreasuryTransactionEntriesParametersQueryEffectiveAt'GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (GetTreasuryTransactionEntriesParametersQueryEffectiveAt'Int a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParametersQueryEffectiveAt'Variants
    where {parseJSON val = case (GetTreasuryTransactionEntriesParametersQueryEffectiveAt'GetTreasuryTransactionEntriesParametersQueryEffectiveAt'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((GetTreasuryTransactionEntriesParametersQueryEffectiveAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data GetTreasuryTransactionEntriesParametersQueryOrderBy' =
   GetTreasuryTransactionEntriesParametersQueryOrderBy'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GetTreasuryTransactionEntriesParametersQueryOrderBy'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GetTreasuryTransactionEntriesParametersQueryOrderBy'EnumCreated -- ^ Represents the JSON value @"created"@
  | GetTreasuryTransactionEntriesParametersQueryOrderBy'EnumEffectiveAt -- ^ Represents the JSON value @"effective_at"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesParametersQueryOrderBy'
    where {toJSON (GetTreasuryTransactionEntriesParametersQueryOrderBy'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesParametersQueryOrderBy'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "created" -> GetTreasuryTransactionEntriesParametersQueryOrderBy'EnumCreated
...
data GetTreasuryTransactionEntriesResponse =
   GetTreasuryTransactionEntriesResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | GetTreasuryTransactionEntriesResponse200 GetTreasuryTransactionEntriesResponseBody200 -- ^ Successful response.
  | GetTreasuryTransactionEntriesResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data GetTreasuryTransactionEntriesResponseBody200 = GetTreasuryTransactionEntriesResponseBody200 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetTreasuryTransactionEntriesResponseBody200
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= getTreasuryTransactionEntriesResponseBody200Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= getTreasuryTransactionEntriesResponseBody200HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= getTreasuryTransactionEntriesResponseBody200Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetTreasuryTransactionEntriesResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetTreasuryTransactionEntriesResponseBody200" (\obj -> ((GHC.Base.pure GetTreasuryTransactionEntriesResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetTreasuryTransactionEntriesResponseBody200' with all required fields.
mkGetTreasuryTransactionEntriesResponseBody200 :: [Treasury'transactionEntry] -- ^ 'getTreasuryTransactionEntriesResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getTreasuryTransactionEntriesResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getTreasuryTransactionEntriesResponseBody200Url'
  -> GetTreasuryTransactionEntriesResponseBody200
mkGetTreasuryTransactionEntriesResponseBody200 getTreasuryTransactionEntriesResponseBody200Data getTreasuryTransactionEntriesResponseBody200HasMore getTreasuryTransactionEntriesResponseBody200Url = GetTreasuryTransactionEntriesResponseBody200{getTreasuryTransactionEntriesResponseBody200Data = getTreasuryTransactionEntriesResponseBody200Data,
