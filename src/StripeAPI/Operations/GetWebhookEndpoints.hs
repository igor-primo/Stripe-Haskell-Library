...
getWebhookEndpoints :: forall m . StripeAPI.Common.MonadHTTP m => GetWebhookEndpointsParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetWebhookEndpointsResponse) -- ^ Monadic computation which returns the result of the operation
getWebhookEndpoints parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetWebhookEndpointsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetWebhookEndpointsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                           GetWebhookEndpointsResponseBody200)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetWebhookEndpointsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                             Error)
                                                                                                                                                                               | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "GET") "/v1/webhook_endpoints" [StripeAPI.Common.QueryParameter (Data.Text.Internal.pack "ending_before") (Data.Aeson.Types.ToJSON.toJSON Data.Functor.<$> getWebhookEndpointsParametersQueryEndingBefore parameters) (Data.Text.Internal.pack "form") GHC.Types.True,
...
data GetWebhookEndpointsParameters = GetWebhookEndpointsParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetWebhookEndpointsParameters
...
instance Data.Aeson.Types.FromJSON.FromJSON GetWebhookEndpointsParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetWebhookEndpointsParameters" (\obj -> (((GHC.Base.pure GetWebhookEndpointsParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryEnding_before")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryLimit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryStarting_after"))}
...
mkGetWebhookEndpointsParameters = GetWebhookEndpointsParameters{getWebhookEndpointsParametersQueryEndingBefore = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON GetWebhookEndpointsResponseBody200
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetWebhookEndpointsResponseBody200" (\obj -> ((GHC.Base.pure GetWebhookEndpointsResponseBody200 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'GetWebhookEndpointsResponseBody200' with all required fields.
mkGetWebhookEndpointsResponseBody200 :: [WebhookEndpoint] -- ^ 'getWebhookEndpointsResponseBody200Data'
  -> GHC.Types.Bool -- ^ 'getWebhookEndpointsResponseBody200HasMore'
  -> Data.Text.Internal.Text -- ^ 'getWebhookEndpointsResponseBody200Url'
  -> GetWebhookEndpointsResponseBody200
mkGetWebhookEndpointsResponseBody200 getWebhookEndpointsResponseBody200Data getWebhookEndpointsResponseBody200HasMore getWebhookEndpointsResponseBody200Url = GetWebhookEndpointsResponseBody200{getWebhookEndpointsResponseBody200Data = getWebhookEndpointsResponseBody200Data,
