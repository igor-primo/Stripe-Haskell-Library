...
getWebhookEndpointsWebhookEndpoint :: forall m . StripeAPI.Common.MonadHTTP m => GetWebhookEndpointsWebhookEndpointParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response GetWebhookEndpointsWebhookEndpointResponse) -- ^ Monadic computation which returns the result of the operation
getWebhookEndpointsWebhookEndpoint parameters = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either GetWebhookEndpointsWebhookEndpointResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> GetWebhookEndpointsWebhookEndpointResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        WebhookEndpoint)
                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> GetWebhookEndpointsWebhookEndpointResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                          Error)
...
data GetWebhookEndpointsWebhookEndpointParameters = GetWebhookEndpointsWebhookEndpointParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GetWebhookEndpointsWebhookEndpointParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathWebhook_endpoint" Data.Aeson.Types.ToJSON..= getWebhookEndpointsWebhookEndpointParametersPathWebhookEndpoint obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("queryExpand" Data.Aeson.Types.ToJSON..=)) (getWebhookEndpointsWebhookEndpointParametersQueryExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON GetWebhookEndpointsWebhookEndpointParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GetWebhookEndpointsWebhookEndpointParameters" (\obj -> (GHC.Base.pure GetWebhookEndpointsWebhookEndpointParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathWebhook_endpoint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "queryExpand"))}
-- | Create a new 'GetWebhookEndpointsWebhookEndpointParameters' with all required fields.
mkGetWebhookEndpointsWebhookEndpointParameters :: Data.Text.Internal.Text -- ^ 'getWebhookEndpointsWebhookEndpointParametersPathWebhookEndpoint'
  -> GetWebhookEndpointsWebhookEndpointParameters
mkGetWebhookEndpointsWebhookEndpointParameters getWebhookEndpointsWebhookEndpointParametersPathWebhookEndpoint = GetWebhookEndpointsWebhookEndpointParameters{getWebhookEndpointsWebhookEndpointParametersPathWebhookEndpoint = getWebhookEndpointsWebhookEndpointParametersPathWebhookEndpoint,
...
data GetWebhookEndpointsWebhookEndpointResponse =
   GetWebhookEndpointsWebhookEndpointResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
