...
postAccountLinks body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountLinksResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountLinksResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                            AccountLink)
                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountLinksResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                              Error)
...
data PostAccountLinksRequestBodyCollectionOptions' = PostAccountLinksRequestBodyCollectionOptions' {
  -- | fields
  postAccountLinksRequestBodyCollectionOptions'Fields :: (GHC.Maybe.Maybe PostAccountLinksRequestBodyCollectionOptions'Fields')
  -- | future_requirements
...
mkPostAccountLinksRequestBodyCollectionOptions' :: PostAccountLinksRequestBodyCollectionOptions'
mkPostAccountLinksRequestBodyCollectionOptions' = PostAccountLinksRequestBodyCollectionOptions'{postAccountLinksRequestBodyCollectionOptions'Fields = GHC.Maybe.Nothing,
