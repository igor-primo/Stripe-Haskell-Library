...
postAccountsAccountBankAccountsId :: forall m . StripeAPI.Common.MonadHTTP m => PostAccountsAccountBankAccountsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> GHC.Maybe.Maybe PostAccountsAccountBankAccountsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountsAccountBankAccountsIdResponse) -- ^ Monadic computation which returns the result of the operation
postAccountsAccountBankAccountsId parameters
                                  body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountsAccountBankAccountsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountBankAccountsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               ExternalAccount)
                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountBankAccountsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                 Error)
...
data PostAccountsAccountBankAccountsIdParameters = PostAccountsAccountBankAccountsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathAccount" Data.Aeson.Types.ToJSON..= postAccountsAccountBankAccountsIdParametersPathAccount obj] : ["pathId" Data.Aeson.Types.ToJSON..= postAccountsAccountBankAccountsIdParametersPathId obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountsAccountBankAccountsIdParameters" (\obj -> (GHC.Base.pure PostAccountsAccountBankAccountsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId"))}
-- | Create a new 'PostAccountsAccountBankAccountsIdParameters' with all required fields.
mkPostAccountsAccountBankAccountsIdParameters :: Data.Text.Internal.Text -- ^ 'postAccountsAccountBankAccountsIdParametersPathAccount'
  -> Data.Text.Internal.Text -- ^ 'postAccountsAccountBankAccountsIdParametersPathId'
  -> PostAccountsAccountBankAccountsIdParameters
mkPostAccountsAccountBankAccountsIdParameters postAccountsAccountBankAccountsIdParametersPathAccount postAccountsAccountBankAccountsIdParametersPathId = PostAccountsAccountBankAccountsIdParameters{postAccountsAccountBankAccountsIdParametersPathAccount = postAccountsAccountBankAccountsIdParametersPathAccount,
...
data PostAccountsAccountBankAccountsIdRequestBody = PostAccountsAccountBankAccountsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBody
...
mkPostAccountsAccountBankAccountsIdRequestBody = PostAccountsAccountBankAccountsIdRequestBody{postAccountsAccountBankAccountsIdRequestBodyAccountHolderName = GHC.Maybe.Nothing,
...
data PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType' =
   PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'
    where {toJSON (PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostAccountsAccountBankAccountsIdRequestBodyAccountHolderType'EnumEmptyString
...
data PostAccountsAccountBankAccountsIdRequestBodyAccountType' =
   PostAccountsAccountBankAccountsIdRequestBodyAccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostAccountsAccountBankAccountsIdRequestBodyAccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostAccountsAccountBankAccountsIdRequestBodyAccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostAccountsAccountBankAccountsIdRequestBodyAccountType'EnumFutsu -- ^ Represents the JSON value @"futsu"@
  | PostAccountsAccountBankAccountsIdRequestBodyAccountType'EnumSavings -- ^ Represents the JSON value @"savings"@
  | PostAccountsAccountBankAccountsIdRequestBodyAccountType'EnumToza -- ^ Represents the JSON value @"toza"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBodyAccountType'
    where {toJSON (PostAccountsAccountBankAccountsIdRequestBodyAccountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdRequestBodyAccountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostAccountsAccountBankAccountsIdRequestBodyAccountType'EnumChecking
...
data PostAccountsAccountBankAccountsIdRequestBodyDocuments' = PostAccountsAccountBankAccountsIdRequestBodyDocuments' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBodyDocuments'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_account_ownership_verification" Data.Aeson.Types.ToJSON..=)) (postAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdRequestBodyDocuments'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountsAccountBankAccountsIdRequestBodyDocuments'" (\obj -> GHC.Base.pure PostAccountsAccountBankAccountsIdRequestBodyDocuments' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_account_ownership_verification"))}
...
data PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification' = PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification'Files obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification'" (\obj -> GHC.Base.pure PostAccountsAccountBankAccountsIdRequestBodyDocuments'BankAccountOwnershipVerification' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))}
...
data PostAccountsAccountBankAccountsIdRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountBankAccountsIdRequestBodyMetadata'Variants
    where {toJSON (PostAccountsAccountBankAccountsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostAccountsAccountBankAccountsIdRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountBankAccountsIdRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostAccountsAccountBankAccountsIdRequestBodyMetadata'EmptyString
