...
postAccountsAccountCapabilitiesCapability :: forall m . StripeAPI.Common.MonadHTTP m => PostAccountsAccountCapabilitiesCapabilityParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> GHC.Maybe.Maybe PostAccountsAccountCapabilitiesCapabilityRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountsAccountCapabilitiesCapabilityResponse) -- ^ Monadic computation which returns the result of the operation
postAccountsAccountCapabilitiesCapability parameters
                                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountsAccountCapabilitiesCapabilityResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountCapabilitiesCapabilityResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Capability)
                                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountCapabilitiesCapabilityResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostAccountsAccountCapabilitiesCapabilityParameters = PostAccountsAccountCapabilitiesCapabilityParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountCapabilitiesCapabilityParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathAccount" Data.Aeson.Types.ToJSON..= postAccountsAccountCapabilitiesCapabilityParametersPathAccount obj] : ["pathCapability" Data.Aeson.Types.ToJSON..= postAccountsAccountCapabilitiesCapabilityParametersPathCapability obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostAccountsAccountCapabilitiesCapabilityParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostAccountsAccountCapabilitiesCapabilityParameters" (\obj -> (GHC.Base.pure PostAccountsAccountCapabilitiesCapabilityParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathAccount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCapability"))}
-- | Create a new 'PostAccountsAccountCapabilitiesCapabilityParameters' with all required fields.
mkPostAccountsAccountCapabilitiesCapabilityParameters :: Data.Text.Internal.Text -- ^ 'postAccountsAccountCapabilitiesCapabilityParametersPathAccount'
  -> Data.Text.Internal.Text -- ^ 'postAccountsAccountCapabilitiesCapabilityParametersPathCapability'
  -> PostAccountsAccountCapabilitiesCapabilityParameters
mkPostAccountsAccountCapabilitiesCapabilityParameters postAccountsAccountCapabilitiesCapabilityParametersPathAccount postAccountsAccountCapabilitiesCapabilityParametersPathCapability = PostAccountsAccountCapabilitiesCapabilityParameters{postAccountsAccountCapabilitiesCapabilityParametersPathAccount = postAccountsAccountCapabilitiesCapabilityParametersPathAccount,
...
data PostAccountsAccountCapabilitiesCapabilityRequestBody = PostAccountsAccountCapabilitiesCapabilityRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountCapabilitiesCapabilityRequestBody
...
mkPostAccountsAccountCapabilitiesCapabilityRequestBody = PostAccountsAccountCapabilitiesCapabilityRequestBody{postAccountsAccountCapabilitiesCapabilityRequestBodyExpand = GHC.Maybe.Nothing,
