...
postAccountsAccountReject :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ account | Constraints: Maximum length of 5000
  -> PostAccountsAccountRejectRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostAccountsAccountRejectResponse) -- ^ Monadic computation which returns the result of the operation
postAccountsAccountReject account
                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostAccountsAccountRejectResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountRejectResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       Account)
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostAccountsAccountRejectResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostAccountsAccountRejectRequestBody = PostAccountsAccountRejectRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostAccountsAccountRejectRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postAccountsAccountRejectRequestBodyExpand obj) : ["reason" Data.Aeson.Types.ToJSON..= postAccountsAccountRejectRequestBodyReason obj] : GHC.Base.mempty));
...
mkPostAccountsAccountRejectRequestBody :: Data.Text.Internal.Text -- ^ 'postAccountsAccountRejectRequestBodyReason'
  -> PostAccountsAccountRejectRequestBody
mkPostAccountsAccountRejectRequestBody postAccountsAccountRejectRequestBodyReason = PostAccountsAccountRejectRequestBody{postAccountsAccountRejectRequestBodyExpand = GHC.Maybe.Nothing,
