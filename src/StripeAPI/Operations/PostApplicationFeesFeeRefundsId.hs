...
postApplicationFeesFeeRefundsId :: forall m . StripeAPI.Common.MonadHTTP m => PostApplicationFeesFeeRefundsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> GHC.Maybe.Maybe PostApplicationFeesFeeRefundsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostApplicationFeesFeeRefundsIdResponse) -- ^ Monadic computation which returns the result of the operation
postApplicationFeesFeeRefundsId parameters
                                body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostApplicationFeesFeeRefundsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesFeeRefundsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         FeeRefund)
                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesFeeRefundsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/v1/application_fees/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (postApplicationFeesFeeRefundsIdParametersPathFee parameters))) GHC.Base.<> ("/refunds/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel (postApplicationFeesFeeRefundsIdParametersPathId parameters))) GHC.Base.<> "")))) GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostApplicationFeesFeeRefundsIdParameters = PostApplicationFeesFeeRefundsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostApplicationFeesFeeRefundsIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathFee" Data.Aeson.Types.ToJSON..= postApplicationFeesFeeRefundsIdParametersPathFee obj] : ["pathId" Data.Aeson.Types.ToJSON..= postApplicationFeesFeeRefundsIdParametersPathId obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["pathFee" Data.Aeson.Types.ToJSON..= postApplicationFeesFeeRefundsIdParametersPathFee obj] : ["pathId" Data.Aeson.Types.ToJSON..= postApplicationFeesFeeRefundsIdParametersPathId obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostApplicationFeesFeeRefundsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostApplicationFeesFeeRefundsIdParameters" (\obj -> (GHC.Base.pure PostApplicationFeesFeeRefundsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathFee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId"))}
-- | Create a new 'PostApplicationFeesFeeRefundsIdParameters' with all required fields.
mkPostApplicationFeesFeeRefundsIdParameters :: Data.Text.Internal.Text -- ^ 'postApplicationFeesFeeRefundsIdParametersPathFee'
  -> Data.Text.Internal.Text -- ^ 'postApplicationFeesFeeRefundsIdParametersPathId'
  -> PostApplicationFeesFeeRefundsIdParameters
mkPostApplicationFeesFeeRefundsIdParameters postApplicationFeesFeeRefundsIdParametersPathFee postApplicationFeesFeeRefundsIdParametersPathId = PostApplicationFeesFeeRefundsIdParameters{postApplicationFeesFeeRefundsIdParametersPathFee = postApplicationFeesFeeRefundsIdParametersPathFee,
...
data PostApplicationFeesFeeRefundsIdRequestBody = PostApplicationFeesFeeRefundsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostApplicationFeesFeeRefundsIdRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postApplicationFeesFeeRefundsIdRequestBodyExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postApplicationFeesFeeRefundsIdRequestBodyMetadata obj) : GHC.Base.mempty));
...
mkPostApplicationFeesFeeRefundsIdRequestBody = PostApplicationFeesFeeRefundsIdRequestBody{postApplicationFeesFeeRefundsIdRequestBodyExpand = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostApplicationFeesFeeRefundsIdRequestBodyMetadata'Variants
    where {toJSON (PostApplicationFeesFeeRefundsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostApplicationFeesFeeRefundsIdRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostApplicationFeesFeeRefundsIdRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostApplicationFeesFeeRefundsIdRequestBodyMetadata'EmptyString
