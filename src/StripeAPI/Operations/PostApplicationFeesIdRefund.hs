...
-- 
-- 
postApplicationFeesIdRefund :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostApplicationFeesIdRefundRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostApplicationFeesIdRefundResponse) -- ^ Monadic computation which returns the result of the operation
postApplicationFeesIdRefund id
                            body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostApplicationFeesIdRefundResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesIdRefundResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                             ApplicationFee)
                                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesIdRefundResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/v1/application_fees/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel id)) GHC.Base.<> "/refund")) GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostApplicationFeesIdRefundRequestBody = PostApplicationFeesIdRefundRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostApplicationFeesIdRefundRequestBody
...
mkPostApplicationFeesIdRefundRequestBody = PostApplicationFeesIdRefundRequestBody{postApplicationFeesIdRefundRequestBodyAmount = GHC.Maybe.Nothing,
...
data PostApplicationFeesIdRefundResponse =
   PostApplicationFeesIdRefundResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
