...
postApplicationFeesIdRefunds :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostApplicationFeesIdRefundsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostApplicationFeesIdRefundsResponse) -- ^ Monadic computation which returns the result of the operation
postApplicationFeesIdRefunds id
                             body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostApplicationFeesIdRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesIdRefundsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                FeeRefund)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostApplicationFeesIdRefundsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data PostApplicationFeesIdRefundsRequestBody = PostApplicationFeesIdRefundsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostApplicationFeesIdRefundsRequestBody
...
mkPostApplicationFeesIdRefundsRequestBody = PostApplicationFeesIdRefundsRequestBody{postApplicationFeesIdRefundsRequestBodyAmount = GHC.Maybe.Nothing,
...
data PostApplicationFeesIdRefundsResponse =
   PostApplicationFeesIdRefundsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
