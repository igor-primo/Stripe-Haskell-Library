...
postCharges :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostChargesRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostChargesResponse) -- ^ Monadic computation which returns the result of the operation
postCharges body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostChargesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostChargesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                             Charge)
                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostChargesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/charges" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostChargesRequestBody = PostChargesRequestBody {
  ...
  , postChargesRequestBodyRadarOptions :: (GHC.Maybe.Maybe PostChargesRequestBodyRadarOptions')
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostChargesRequestBody" (\obj -> (((((((((((((((((((GHC.Base.pure PostChargesRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "application_fee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "application_fee_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "capture")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "destination")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "on_behalf_of")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "radar_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "receipt_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "source")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor_suffix")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transfer_data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transfer_group"))}
-- | Create a new 'PostChargesRequestBody' with all required fields.
mkPostChargesRequestBody :: PostChargesRequestBody
mkPostChargesRequestBody = PostChargesRequestBody{postChargesRequestBodyAmount = GHC.Maybe.Nothing,
                                                  ...
                                                  postChargesRequestBodyRadarOptions = GHC.Maybe.Nothing,
...
data PostChargesRequestBodyCard'OneOf1Object' =
   PostChargesRequestBodyCard'OneOf1Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostChargesRequestBodyCard'OneOf1Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostChargesRequestBodyCard'OneOf1Object'EnumCard -- ^ Represents the JSON value @"card"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyCard'OneOf1Object'
    where {toJSON (PostChargesRequestBodyCard'OneOf1Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyCard'OneOf1Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card" -> PostChargesRequestBodyCard'OneOf1Object'EnumCard
...
data PostChargesRequestBodyCard'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyCard'Variants
    where {toJSON (PostChargesRequestBodyCard'PostChargesRequestBodyCard'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostChargesRequestBodyCard'Text a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyCard'Variants
    where {parseJSON val = case (PostChargesRequestBodyCard'PostChargesRequestBodyCard'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostChargesRequestBodyCard'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PostChargesRequestBodyDestination'OneOf1 = PostChargesRequestBodyDestination'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyDestination'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["account" Data.Aeson.Types.ToJSON..= postChargesRequestBodyDestination'OneOf1Account obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyDestination'OneOf1Amount obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["account" Data.Aeson.Types.ToJSON..= postChargesRequestBodyDestination'OneOf1Account obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyDestination'OneOf1Amount obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyDestination'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostChargesRequestBodyDestination'OneOf1" (\obj -> (GHC.Base.pure PostChargesRequestBodyDestination'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount"))}
-- | Create a new 'PostChargesRequestBodyDestination'OneOf1' with all required fields.
mkPostChargesRequestBodyDestination'OneOf1 :: Data.Text.Internal.Text -- ^ 'postChargesRequestBodyDestination'OneOf1Account'
  -> PostChargesRequestBodyDestination'OneOf1
mkPostChargesRequestBodyDestination'OneOf1 postChargesRequestBodyDestination'OneOf1Account = PostChargesRequestBodyDestination'OneOf1{postChargesRequestBodyDestination'OneOf1Account = postChargesRequestBodyDestination'OneOf1Account,
...
data PostChargesRequestBodyDestination'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyDestination'Variants
    where {toJSON (PostChargesRequestBodyDestination'PostChargesRequestBodyDestination'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostChargesRequestBodyDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyDestination'Variants
    where {parseJSON val = case (PostChargesRequestBodyDestination'PostChargesRequestBodyDestination'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostChargesRequestBodyDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostChargesRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyMetadata'Variants
    where {toJSON (PostChargesRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostChargesRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostChargesRequestBodyMetadata'EmptyString
                              | GHC.Base.otherwise -> case (PostChargesRequestBodyMetadata'Object Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/charges.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.radar_options@ in the specification.
-- 
-- Options to configure Radar. See [Radar Session](https:\/\/stripe.com\/docs\/radar\/radar-session) for more information.
data PostChargesRequestBodyRadarOptions' = PostChargesRequestBodyRadarOptions' {
  -- | session
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postChargesRequestBodyRadarOptions'Session :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyRadarOptions'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("session" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyRadarOptions'Session obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("session" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyRadarOptions'Session obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesRequestBodyRadarOptions'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostChargesRequestBodyRadarOptions'" (\obj -> GHC.Base.pure PostChargesRequestBodyRadarOptions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "session"))}
-- | Create a new 'PostChargesRequestBodyRadarOptions'' with all required fields.
mkPostChargesRequestBodyRadarOptions' :: PostChargesRequestBodyRadarOptions'
mkPostChargesRequestBodyRadarOptions' = PostChargesRequestBodyRadarOptions'{postChargesRequestBodyRadarOptions'Session = GHC.Maybe.Nothing}
...
data PostChargesRequestBodyShipping' = PostChargesRequestBodyShipping' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyShipping'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["address" Data.Aeson.Types.ToJSON..= postChargesRequestBodyShipping'Address obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("carrier" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'Carrier obj) : ["name" Data.Aeson.Types.ToJSON..= postChargesRequestBodyShipping'Name obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'Phone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tracking_number" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'TrackingNumber obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["address" Data.Aeson.Types.ToJSON..= postChargesRequestBodyShipping'Address obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("carrier" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'Carrier obj) : ["name" Data.Aeson.Types.ToJSON..= postChargesRequestBodyShipping'Name obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'Phone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tracking_number" Data.Aeson.Types.ToJSON..=)) (postChargesRequestBodyShipping'TrackingNumber obj) : GHC.Base.mempty)))}
...
mkPostChargesRequestBodyShipping' :: PostChargesRequestBodyShipping'Address' -- ^ 'postChargesRequestBodyShipping'Address'
  -> Data.Text.Internal.Text -- ^ 'postChargesRequestBodyShipping'Name'
  -> PostChargesRequestBodyShipping'
mkPostChargesRequestBodyShipping' postChargesRequestBodyShipping'Address postChargesRequestBodyShipping'Name = PostChargesRequestBodyShipping'{postChargesRequestBodyShipping'Address = postChargesRequestBodyShipping'Address,
...
mkPostChargesRequestBodyShipping'Address' = PostChargesRequestBodyShipping'Address'{postChargesRequestBodyShipping'Address'City = GHC.Maybe.Nothing,
...
data PostChargesRequestBodyTransferData' = PostChargesRequestBodyTransferData' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesRequestBodyTransferData'
...
mkPostChargesRequestBodyTransferData' :: Data.Text.Internal.Text -- ^ 'postChargesRequestBodyTransferData'Destination'
  -> PostChargesRequestBodyTransferData'
mkPostChargesRequestBodyTransferData' postChargesRequestBodyTransferData'Destination = PostChargesRequestBodyTransferData'{postChargesRequestBodyTransferData'Amount = GHC.Maybe.Nothing,
