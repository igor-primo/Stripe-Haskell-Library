...
postChargesCharge :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ charge | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostChargesChargeRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostChargesChargeResponse) -- ^ Monadic computation which returns the result of the operation
postChargesCharge charge
                  body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostChargesChargeResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               Charge)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
...
data PostChargesChargeRequestBody = PostChargesChargeRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRequestBody
...
mkPostChargesChargeRequestBody = PostChargesChargeRequestBody{postChargesChargeRequestBodyCustomer = GHC.Maybe.Nothing,
...
data PostChargesChargeRequestBodyFraudDetails' = PostChargesChargeRequestBodyFraudDetails' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRequestBodyFraudDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["user_report" Data.Aeson.Types.ToJSON..= postChargesChargeRequestBodyFraudDetails'UserReport obj] : GHC.Base.mempty));
...
mkPostChargesChargeRequestBodyFraudDetails' :: PostChargesChargeRequestBodyFraudDetails'UserReport' -- ^ 'postChargesChargeRequestBodyFraudDetails'UserReport'
...
data PostChargesChargeRequestBodyFraudDetails'UserReport' =
   PostChargesChargeRequestBodyFraudDetails'UserReport'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostChargesChargeRequestBodyFraudDetails'UserReport'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostChargesChargeRequestBodyFraudDetails'UserReport'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostChargesChargeRequestBodyFraudDetails'UserReport'EnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | PostChargesChargeRequestBodyFraudDetails'UserReport'EnumSafe -- ^ Represents the JSON value @"safe"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRequestBodyFraudDetails'UserReport'
    where {toJSON (PostChargesChargeRequestBodyFraudDetails'UserReport'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRequestBodyFraudDetails'UserReport'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostChargesChargeRequestBodyFraudDetails'UserReport'EnumEmptyString
...
data PostChargesChargeRequestBodyMetadata'Variants =
   PostChargesChargeRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostChargesChargeRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRequestBodyMetadata'Variants
    where {toJSON (PostChargesChargeRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostChargesChargeRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostChargesChargeRequestBodyMetadata'EmptyString
...
mkPostChargesChargeRequestBodyShipping' :: PostChargesChargeRequestBodyShipping'Address' -- ^ 'postChargesChargeRequestBodyShipping'Address'
  -> Data.Text.Internal.Text -- ^ 'postChargesChargeRequestBodyShipping'Name'
  -> PostChargesChargeRequestBodyShipping'
mkPostChargesChargeRequestBodyShipping' postChargesChargeRequestBodyShipping'Address postChargesChargeRequestBodyShipping'Name = PostChargesChargeRequestBodyShipping'{postChargesChargeRequestBodyShipping'Address = postChargesChargeRequestBodyShipping'Address,
...
data PostChargesChargeRequestBodyShipping'Address' = PostChargesChargeRequestBodyShipping'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRequestBodyShipping'Address'
...
mkPostChargesChargeRequestBodyShipping'Address' = PostChargesChargeRequestBodyShipping'Address'{postChargesChargeRequestBodyShipping'Address'City = GHC.Maybe.Nothing,
