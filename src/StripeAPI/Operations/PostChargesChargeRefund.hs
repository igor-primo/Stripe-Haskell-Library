...
postChargesChargeRefund :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ charge: The identifier of the charge to refund. | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostChargesChargeRefundRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostChargesChargeRefundResponse) -- ^ Monadic computation which returns the result of the operation
postChargesChargeRefund charge
                        body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostChargesChargeRefundResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeRefundResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                 Charge)
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeRefundResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                   Error)
...
data PostChargesChargeRefundRequestBody = PostChargesChargeRefundRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRefundRequestBody
...
mkPostChargesChargeRefundRequestBody = PostChargesChargeRefundRequestBody{postChargesChargeRefundRequestBodyAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRefundRequestBodyMetadata'Variants
    where {toJSON (PostChargesChargeRefundRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostChargesChargeRefundRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRefundRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostChargesChargeRefundRequestBodyMetadata'EmptyString
...
data PostChargesChargeRefundRequestBodyReason' =
   PostChargesChargeRefundRequestBodyReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostChargesChargeRefundRequestBodyReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostChargesChargeRefundRequestBodyReason'EnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | PostChargesChargeRefundRequestBodyReason'EnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | PostChargesChargeRefundRequestBodyReason'EnumRequestedByCustomer -- ^ Represents the JSON value @"requested_by_customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRefundRequestBodyReason'
    where {toJSON (PostChargesChargeRefundRequestBodyReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRefundRequestBodyReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "duplicate" -> PostChargesChargeRefundRequestBodyReason'EnumDuplicate
