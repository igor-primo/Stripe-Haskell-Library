...
postChargesChargeRefunds :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ charge: The identifier of the charge to refund. | Constraints: Maximum length of 5000
...
postChargesChargeRefunds charge
                         body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostChargesChargeRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeRefundsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                    Refund)
                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostChargesChargeRefundsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRefundsRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostChargesChargeRefundsRequestBody" (\obj -> ((((((((((GHC.Base.pure PostChargesChargeRefundsRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "instructions_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "origin")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_application_fee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reverse_transfer"))}
...
data PostChargesChargeRefundsRequestBodyOrigin' =
   PostChargesChargeRefundsRequestBodyOrigin'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostChargesChargeRefundsRequestBodyOrigin'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostChargesChargeRefundsRequestBodyOrigin'EnumCustomerBalance -- ^ Represents the JSON value @"customer_balance"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostChargesChargeRefundsRequestBodyOrigin'
    where {toJSON (PostChargesChargeRefundsRequestBodyOrigin'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostChargesChargeRefundsRequestBodyOrigin'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_balance" -> PostChargesChargeRefundsRequestBodyOrigin'EnumCustomerBalance
