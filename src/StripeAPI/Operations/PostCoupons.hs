...
postCoupons :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostCouponsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCouponsResponse) -- ^ Monadic computation which returns the result of the operation
postCoupons body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCouponsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCouponsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                             Coupon)
                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCouponsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/coupons" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostCouponsRequestBody = PostCouponsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCouponsRequestBody
...
mkPostCouponsRequestBody = PostCouponsRequestBody{postCouponsRequestBodyAmountOff = GHC.Maybe.Nothing,
...
data PostCouponsRequestBodyAppliesTo' = PostCouponsRequestBodyAppliesTo' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCouponsRequestBodyAppliesTo'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("products" Data.Aeson.Types.ToJSON..=)) (postCouponsRequestBodyAppliesTo'Products obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("products" Data.Aeson.Types.ToJSON..=)) (postCouponsRequestBodyAppliesTo'Products obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCouponsRequestBodyAppliesTo'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCouponsRequestBodyAppliesTo'" (\obj -> GHC.Base.pure PostCouponsRequestBodyAppliesTo' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "products"))}
...
data PostCouponsRequestBodyDuration' =
   PostCouponsRequestBodyDuration'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCouponsRequestBodyDuration'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCouponsRequestBodyDuration'EnumForever -- ^ Represents the JSON value @"forever"@
  | PostCouponsRequestBodyDuration'EnumOnce -- ^ Represents the JSON value @"once"@
  | PostCouponsRequestBodyDuration'EnumRepeating -- ^ Represents the JSON value @"repeating"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCouponsRequestBodyDuration'
    where {toJSON (PostCouponsRequestBodyDuration'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCouponsRequestBodyDuration'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "forever" -> PostCouponsRequestBodyDuration'EnumForever
...
data PostCouponsRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCouponsRequestBodyMetadata'Variants
    where {toJSON (PostCouponsRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCouponsRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostCouponsRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostCouponsRequestBodyMetadata'EmptyString
