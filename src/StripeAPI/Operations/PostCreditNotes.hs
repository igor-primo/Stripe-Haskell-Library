...
postCreditNotes body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCreditNotesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCreditNotesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                         CreditNote)
                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCreditNotesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/credit_notes" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostCreditNotesRequestBody = PostCreditNotesRequestBody {
  ...
  , postCreditNotesRequestBodyEffectiveAt :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | email_type: Type of email to send to the customer, one of \`credit_note\` or \`none\` and the default is \`credit_note\`.
  , postCreditNotesRequestBodyEmailType :: (GHC.Maybe.Maybe PostCreditNotesRequestBodyEmailType')
  ...
  , postCreditNotesRequestBodyRefunds :: (GHC.Maybe.Maybe [PostCreditNotesRequestBodyRefunds'])
  ...
  , postCreditNotesRequestBodyShippingCost :: (GHC.Maybe.Maybe PostCreditNotesRequestBodyShippingCost')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyCreditAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("effective_at" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyEffectiveAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email_type" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyEmailType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyExpand obj) : ["invoice" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyInvoice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lines" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyLines obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("memo" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyMemo obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("out_of_band_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyOutOfBandAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reason" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyReason obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefundAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refunds" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_cost" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyShippingCost obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyCreditAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("effective_at" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyEffectiveAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email_type" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyEmailType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyExpand obj) : ["invoice" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyInvoice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("lines" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyLines obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("memo" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyMemo obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("out_of_band_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyOutOfBandAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reason" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyReason obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_amount" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefundAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refunds" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_cost" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyShippingCost obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCreditNotesRequestBody" (\obj -> (((((((((((((GHC.Base.pure PostCreditNotesRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "effective_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "email_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lines")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "memo")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "out_of_band_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refunds")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_cost"))}
...
mkPostCreditNotesRequestBody postCreditNotesRequestBodyInvoice = PostCreditNotesRequestBody{postCreditNotesRequestBodyAmount = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCreditNotesRequestBodyEffectiveAt = GHC.Maybe.Nothing,
                                                                                            postCreditNotesRequestBodyEmailType = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCreditNotesRequestBodyRefunds = GHC.Maybe.Nothing,
                                                                                            postCreditNotesRequestBodyShippingCost = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/credit_notes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.email_type@ in the specification.
-- 
-- Type of email to send to the customer, one of \`credit_note\` or \`none\` and the default is \`credit_note\`.
data PostCreditNotesRequestBodyEmailType' =
   PostCreditNotesRequestBodyEmailType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCreditNotesRequestBodyEmailType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCreditNotesRequestBodyEmailType'EnumCreditNote -- ^ Represents the JSON value @"credit_note"@
  | PostCreditNotesRequestBodyEmailType'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBodyEmailType'
    where {toJSON (PostCreditNotesRequestBodyEmailType'Other val) = val;
           toJSON (PostCreditNotesRequestBodyEmailType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostCreditNotesRequestBodyEmailType'EnumCreditNote) = "credit_note";
           toJSON (PostCreditNotesRequestBodyEmailType'EnumNone) = "none"}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBodyEmailType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_note" -> PostCreditNotesRequestBodyEmailType'EnumCreditNote
                                             | val GHC.Classes.== "none" -> PostCreditNotesRequestBodyEmailType'EnumNone
                                             | GHC.Base.otherwise -> PostCreditNotesRequestBodyEmailType'Other val)}
...
data PostCreditNotesRequestBodyLines' = PostCreditNotesRequestBodyLines' {
  ...
  -- | tax_amounts
  , postCreditNotesRequestBodyLines'TaxAmounts :: (GHC.Maybe.Maybe PostCreditNotesRequestBodyLines'TaxAmounts'Variants)
  -- | tax_rates
...
mkPostCreditNotesRequestBodyLines' postCreditNotesRequestBodyLines'Type = PostCreditNotesRequestBodyLines'{postCreditNotesRequestBodyLines'Amount = GHC.Maybe.Nothing,
                                                                                                           ...
                                                                                                           postCreditNotesRequestBodyLines'TaxAmounts = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/credit_notes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.lines.items.properties.tax_amounts.anyOf.items@ in the specification.
-- 
-- 
data PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 = PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 {
  -- | amount
  postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount :: GHC.Types.Int
  -- | tax_rate
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate :: Data.Text.Internal.Text
  -- | taxable_amount
  , postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount :: GHC.Types.Int
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount obj] : ["tax_rate" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate obj] : ["taxable_amount" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount obj] : ["tax_rate" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate obj] : ["taxable_amount" Data.Aeson.Types.ToJSON..= postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1" (\obj -> ((GHC.Base.pure PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxable_amount"))}
-- | Create a new 'PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1' with all required fields.
mkPostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 :: GHC.Types.Int -- ^ 'postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount'
  -> Data.Text.Internal.Text -- ^ 'postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate'
  -> GHC.Types.Int -- ^ 'postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount'
  -> PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1
mkPostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount = PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1{postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount = postCreditNotesRequestBodyLines'TaxAmounts'OneOf1Amount,
                                                                                                                                                                                                                                                                                        postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate = postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxRate,
                                                                                                                                                                                                                                                                                        postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount = postCreditNotesRequestBodyLines'TaxAmounts'OneOf1TaxableAmount}
-- | Defines the oneOf schema located at @paths.\/v1\/credit_notes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.lines.items.properties.tax_amounts.anyOf@ in the specification.
-- 
-- 
data PostCreditNotesRequestBodyLines'TaxAmounts'Variants =
   PostCreditNotesRequestBodyLines'TaxAmounts'EmptyString -- ^ Represents the JSON value @""@
  | PostCreditNotesRequestBodyLines'TaxAmounts'ListTPostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 [PostCreditNotesRequestBodyLines'TaxAmounts'OneOf1]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBodyLines'TaxAmounts'Variants
    where {toJSON (PostCreditNotesRequestBodyLines'TaxAmounts'ListTPostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCreditNotesRequestBodyLines'TaxAmounts'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBodyLines'TaxAmounts'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostCreditNotesRequestBodyLines'TaxAmounts'EmptyString
                              | GHC.Base.otherwise -> case (PostCreditNotesRequestBodyLines'TaxAmounts'ListTPostCreditNotesRequestBodyLines'TaxAmounts'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
...
-- | Defines the object schema located at @paths.\/v1\/credit_notes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.refunds.items@ in the specification.
-- 
-- 
data PostCreditNotesRequestBodyRefunds' = PostCreditNotesRequestBodyRefunds' {
  -- | amount_refunded
  postCreditNotesRequestBodyRefunds'AmountRefunded :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | refund
  , postCreditNotesRequestBodyRefunds'Refund :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBodyRefunds'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_refunded" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds'AmountRefunded obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds'Refund obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_refunded" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds'AmountRefunded obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyRefunds'Refund obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBodyRefunds'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCreditNotesRequestBodyRefunds'" (\obj -> (GHC.Base.pure PostCreditNotesRequestBodyRefunds' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_refunded")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund"))}
-- | Create a new 'PostCreditNotesRequestBodyRefunds'' with all required fields.
mkPostCreditNotesRequestBodyRefunds' :: PostCreditNotesRequestBodyRefunds'
mkPostCreditNotesRequestBodyRefunds' = PostCreditNotesRequestBodyRefunds'{postCreditNotesRequestBodyRefunds'AmountRefunded = GHC.Maybe.Nothing,
                                                                          postCreditNotesRequestBodyRefunds'Refund = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/credit_notes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.shipping_cost@ in the specification.
-- 
-- When shipping_cost contains the shipping_rate from the invoice, the shipping_cost is included in the credit note. One of \`amount\`, \`lines\`, or \`shipping_cost\` must be provided.
data PostCreditNotesRequestBodyShippingCost' = PostCreditNotesRequestBodyShippingCost' {
  -- | shipping_rate
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postCreditNotesRequestBodyShippingCost'ShippingRate :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCreditNotesRequestBodyShippingCost'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyShippingCost'ShippingRate obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (postCreditNotesRequestBodyShippingCost'ShippingRate obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCreditNotesRequestBodyShippingCost'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCreditNotesRequestBodyShippingCost'" (\obj -> GHC.Base.pure PostCreditNotesRequestBodyShippingCost' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate"))}
-- | Create a new 'PostCreditNotesRequestBodyShippingCost'' with all required fields.
mkPostCreditNotesRequestBodyShippingCost' :: PostCreditNotesRequestBodyShippingCost'
mkPostCreditNotesRequestBodyShippingCost' = PostCreditNotesRequestBodyShippingCost'{postCreditNotesRequestBodyShippingCost'ShippingRate = GHC.Maybe.Nothing}
