...
postCustomersCustomerBalanceTransactions :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ customer | Constraints: Maximum length of 5000
  -> PostCustomersCustomerBalanceTransactionsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCustomersCustomerBalanceTransactionsResponse) -- ^ Monadic computation which returns the result of the operation
postCustomersCustomerBalanceTransactions customer
                                         body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCustomersCustomerBalanceTransactionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerBalanceTransactionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    CustomerBalanceTransaction)
                                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerBalanceTransactionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
mkPostCustomersCustomerBalanceTransactionsRequestBody :: GHC.Types.Int -- ^ 'postCustomersCustomerBalanceTransactionsRequestBodyAmount'
  -> Data.Text.Internal.Text -- ^ 'postCustomersCustomerBalanceTransactionsRequestBodyCurrency'
  -> PostCustomersCustomerBalanceTransactionsRequestBody
mkPostCustomersCustomerBalanceTransactionsRequestBody postCustomersCustomerBalanceTransactionsRequestBodyAmount postCustomersCustomerBalanceTransactionsRequestBodyCurrency = PostCustomersCustomerBalanceTransactionsRequestBody{postCustomersCustomerBalanceTransactionsRequestBodyAmount = postCustomersCustomerBalanceTransactionsRequestBodyAmount,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerBalanceTransactionsRequestBodyMetadata'Variants
    where {toJSON (PostCustomersCustomerBalanceTransactionsRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCustomersCustomerBalanceTransactionsRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerBalanceTransactionsRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostCustomersCustomerBalanceTransactionsRequestBodyMetadata'EmptyString
