...
postCustomersCustomerCardsId :: forall m . StripeAPI.Common.MonadHTTP m => PostCustomersCustomerCardsIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> GHC.Maybe.Maybe PostCustomersCustomerCardsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCustomersCustomerCardsIdResponse) -- ^ Monadic computation which returns the result of the operation
postCustomersCustomerCardsId parameters
                             body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCustomersCustomerCardsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerCardsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                PostCustomersCustomerCardsIdResponseBody200)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerCardsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data PostCustomersCustomerCardsIdParameters = PostCustomersCustomerCardsIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathCustomer" Data.Aeson.Types.ToJSON..= postCustomersCustomerCardsIdParametersPathCustomer obj] : ["pathId" Data.Aeson.Types.ToJSON..= postCustomersCustomerCardsIdParametersPathId obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerCardsIdParameters" (\obj -> (GHC.Base.pure PostCustomersCustomerCardsIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId"))}
-- | Create a new 'PostCustomersCustomerCardsIdParameters' with all required fields.
mkPostCustomersCustomerCardsIdParameters :: Data.Text.Internal.Text -- ^ 'postCustomersCustomerCardsIdParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'postCustomersCustomerCardsIdParametersPathId'
  -> PostCustomersCustomerCardsIdParameters
mkPostCustomersCustomerCardsIdParameters postCustomersCustomerCardsIdParametersPathCustomer postCustomersCustomerCardsIdParametersPathId = PostCustomersCustomerCardsIdParameters{postCustomersCustomerCardsIdParametersPathCustomer = postCustomersCustomerCardsIdParametersPathCustomer,
...
data PostCustomersCustomerCardsIdRequestBody = PostCustomersCustomerCardsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdRequestBody
...
mkPostCustomersCustomerCardsIdRequestBody = PostCustomersCustomerCardsIdRequestBody{postCustomersCustomerCardsIdRequestBodyAccountHolderName = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdRequestBodyAccountHolderType' =
   PostCustomersCustomerCardsIdRequestBodyAccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdRequestBodyAccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdRequestBodyAccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostCustomersCustomerCardsIdRequestBodyAccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdRequestBodyAccountHolderType'
    where {toJSON (PostCustomersCustomerCardsIdRequestBodyAccountHolderType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdRequestBodyAccountHolderType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "company" -> PostCustomersCustomerCardsIdRequestBodyAccountHolderType'EnumCompany
...
data PostCustomersCustomerCardsIdRequestBodyMetadata'Variants =
   PostCustomersCustomerCardsIdRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostCustomersCustomerCardsIdRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdRequestBodyMetadata'Variants
    where {toJSON (PostCustomersCustomerCardsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCustomersCustomerCardsIdRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostCustomersCustomerCardsIdRequestBodyMetadata'EmptyString
...
data PostCustomersCustomerCardsIdRequestBodyOwner' = PostCustomersCustomerCardsIdRequestBodyOwner' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdRequestBodyOwner'
...
mkPostCustomersCustomerCardsIdRequestBodyOwner' = PostCustomersCustomerCardsIdRequestBodyOwner'{postCustomersCustomerCardsIdRequestBodyOwner'Address = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdRequestBodyOwner'Address' = PostCustomersCustomerCardsIdRequestBodyOwner'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdRequestBodyOwner'Address'
...
mkPostCustomersCustomerCardsIdRequestBodyOwner'Address' = PostCustomersCustomerCardsIdRequestBodyOwner'Address'{postCustomersCustomerCardsIdRequestBodyOwner'Address'City = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdResponseBody200 = PostCustomersCustomerCardsIdResponseBody200 {
  ...
  , postCustomersCustomerCardsIdResponseBody200AllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullable))
  ...
  , postCustomersCustomerCardsIdResponseBody200FutureRequirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable))
  -- | giropay
  ...
  -- 
  -- * Maximum length of 5000
  , postCustomersCustomerCardsIdResponseBody200Iin :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | klarna
  ...
  -- | networks: 
  , postCustomersCustomerCardsIdResponseBody200Networks :: (GHC.Maybe.Maybe TokenCardNetworks)
  ...
  , postCustomersCustomerCardsIdResponseBody200RegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullable))
  -- | requirements: Information about the requirements for the bank account, including what information needs to be collected.
  , postCustomersCustomerCardsIdResponseBody200Requirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable))
...
mkPostCustomersCustomerCardsIdResponseBody200 = PostCustomersCustomerCardsIdResponseBody200{postCustomersCustomerCardsIdResponseBody200Account = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCustomersCustomerCardsIdResponseBody200AllowRedisplay = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCustomersCustomerCardsIdResponseBody200FutureRequirements = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCustomersCustomerCardsIdResponseBody200Iin = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCustomersCustomerCardsIdResponseBody200Networks = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postCustomersCustomerCardsIdResponseBody200RegulatedStatus = GHC.Maybe.Nothing,
                                                                                            postCustomersCustomerCardsIdResponseBody200Requirements = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdResponseBody200Account'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Account'NonNullableVariants
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200Account'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCustomersCustomerCardsIdResponseBody200Account'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Account'NonNullableVariants
    where {parseJSON val = case (PostCustomersCustomerCardsIdResponseBody200Account'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerCardsIdResponseBody200Account'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the enum schema located at @paths.\/v1\/customers\/{customer}\/cards\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
data PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullable =
   PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullable
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableOther val) = val;
           toJSON (PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumAlways) = "always";
           toJSON (PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumLimited) = "limited";
           toJSON (PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumAlways
                                             | val GHC.Classes.== "limited" -> PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumLimited
                                             | val GHC.Classes.== "unspecified" -> PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified
                                             | GHC.Base.otherwise -> PostCustomersCustomerCardsIdResponseBody200AllowRedisplay'NonNullableOther val)}
...
data PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullable =
   PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullable
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> PostCustomersCustomerCardsIdResponseBody200AvailablePayoutMethods'NonNullableEnumInstant
...
data PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableVariants
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableVariants
    where {parseJSON val = case (PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerCardsIdResponseBody200Customer'NonNullableDeletedCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/customers\/{customer}\/cards\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.future_requirements.anyOf@ in the specification.
-- 
-- Information about the [upcoming new requirements for the bank account](https:\\\/\\\/stripe.com\\\/docs\\\/connect\\\/custom-accounts\\\/future-requirements), including what information needs to be collected, and by when.
data PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable = PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable {
  ...
  postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  ...
  , postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  ...
  , postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable" (\obj -> (((GHC.Base.pure PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable' with all required fields.
mkPostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable :: PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable
mkPostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable = PostCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullable{postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                                                                                        postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                                                                                        postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                                                                                        postCustomersCustomerCardsIdResponseBody200FutureRequirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
...
data PostCustomersCustomerCardsIdResponseBody200Object' =
   PostCustomersCustomerCardsIdResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdResponseBody200Object'EnumCard -- ^ Represents the JSON value @"card"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Object'
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card" -> PostCustomersCustomerCardsIdResponseBody200Object'EnumCard
...
data PostCustomersCustomerCardsIdResponseBody200Owner'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullable
...
mkPostCustomersCustomerCardsIdResponseBody200Owner'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullable{postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable
...
mkPostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullable{postCustomersCustomerCardsIdResponseBody200Owner'NonNullableAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable
...
mkPostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable = PostCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable{postCustomersCustomerCardsIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @paths.\/v1\/customers\/{customer}\/cards\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.regulated_status@ in the specification.
-- 
-- Status of a card based on the card issuer.
data PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullable =
   PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullable
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableOther val) = val;
           toJSON (PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumRegulated) = "regulated";
           toJSON (PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated) = "unregulated"}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumRegulated
                                             | val GHC.Classes.== "unregulated" -> PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated
                                             | GHC.Base.otherwise -> PostCustomersCustomerCardsIdResponseBody200RegulatedStatus'NonNullableOther val)}
-- | Defines the object schema located at @paths.\/v1\/customers\/{customer}\/cards\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.requirements.anyOf@ in the specification.
-- 
-- Information about the requirements for the bank account, including what information needs to be collected.
data PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable = PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable {
  -- | currently_due: Fields that need to be collected to keep the external account enabled. If not collected by \`current_deadline\`, these fields appear in \`past_due\` as well, and the account is disabled.
  postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  -- | past_due: Fields that weren\'t collected by \`current_deadline\`. These fields need to be collected to enable the external account.
  , postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | pending_verification: Fields that might become required depending on the results of verification or review. It\'s an empty array unless an asynchronous verification is pending. If verification fails, these fields move to \`eventually_due\`, \`currently_due\`, or \`past_due\`. Fields might appear in \`eventually_due\`, \`currently_due\`, or \`past_due\` and in \`pending_verification\` if verification fails but another verification is still pending.
  , postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable" (\obj -> (((GHC.Base.pure PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable' with all required fields.
mkPostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable :: PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable
mkPostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable = PostCustomersCustomerCardsIdResponseBody200Requirements'NonNullable{postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                                                                            postCustomersCustomerCardsIdResponseBody200Requirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                                                                            postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                                                                            postCustomersCustomerCardsIdResponseBody200Requirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
...
data PostCustomersCustomerCardsIdResponseBody200Type' =
   PostCustomersCustomerCardsIdResponseBody200Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerCardsIdResponseBody200Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumAchCreditTransfer -- ^ Represents the JSON value @"ach_credit_transfer"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumAchDebit -- ^ Represents the JSON value @"ach_debit"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumAcssDebit -- ^ Represents the JSON value @"acss_debit"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumAlipay -- ^ Represents the JSON value @"alipay"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumAuBecsDebit -- ^ Represents the JSON value @"au_becs_debit"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumBancontact -- ^ Represents the JSON value @"bancontact"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumCard -- ^ Represents the JSON value @"card"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumCardPresent -- ^ Represents the JSON value @"card_present"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumEps -- ^ Represents the JSON value @"eps"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumGiropay -- ^ Represents the JSON value @"giropay"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumIdeal -- ^ Represents the JSON value @"ideal"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumKlarna -- ^ Represents the JSON value @"klarna"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumMultibanco -- ^ Represents the JSON value @"multibanco"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumP24 -- ^ Represents the JSON value @"p24"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumSepaDebit -- ^ Represents the JSON value @"sepa_debit"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumSofort -- ^ Represents the JSON value @"sofort"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumThreeDSecure -- ^ Represents the JSON value @"three_d_secure"@
  | PostCustomersCustomerCardsIdResponseBody200Type'EnumWechat -- ^ Represents the JSON value @"wechat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerCardsIdResponseBody200Type'
    where {toJSON (PostCustomersCustomerCardsIdResponseBody200Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerCardsIdResponseBody200Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach_credit_transfer" -> PostCustomersCustomerCardsIdResponseBody200Type'EnumAchCreditTransfer
