...
postCustomersCustomerFundingInstructions :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ customer | Constraints: Maximum length of 5000
  -> PostCustomersCustomerFundingInstructionsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCustomersCustomerFundingInstructionsResponse) -- ^ Monadic computation which returns the result of the operation
postCustomersCustomerFundingInstructions customer
                                         body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCustomersCustomerFundingInstructionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerFundingInstructionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    FundingInstructions)
                                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerFundingInstructionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
data PostCustomersCustomerFundingInstructionsRequestBody = PostCustomersCustomerFundingInstructionsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerFundingInstructionsRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["bank_transfer" Data.Aeson.Types.ToJSON..= postCustomersCustomerFundingInstructionsRequestBodyBankTransfer obj] : ["currency" Data.Aeson.Types.ToJSON..= postCustomersCustomerFundingInstructionsRequestBodyCurrency obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerFundingInstructionsRequestBodyExpand obj) : ["funding_type" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "bank_transfer"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerFundingInstructionsRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerFundingInstructionsRequestBody" (\obj -> ((GHC.Base.pure PostCustomersCustomerFundingInstructionsRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))}
-- | Create a new 'PostCustomersCustomerFundingInstructionsRequestBody' with all required fields.
mkPostCustomersCustomerFundingInstructionsRequestBody :: PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' -- ^ 'postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'
  -> Data.Text.Internal.Text -- ^ 'postCustomersCustomerFundingInstructionsRequestBodyCurrency'
  -> PostCustomersCustomerFundingInstructionsRequestBody
mkPostCustomersCustomerFundingInstructionsRequestBody postCustomersCustomerFundingInstructionsRequestBodyBankTransfer postCustomersCustomerFundingInstructionsRequestBodyCurrency = PostCustomersCustomerFundingInstructionsRequestBody{postCustomersCustomerFundingInstructionsRequestBodyBankTransfer = postCustomersCustomerFundingInstructionsRequestBodyBankTransfer,
...
data PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' = PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'" (\obj -> ((GHC.Base.pure PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "eu_bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "requested_address_types")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'' with all required fields.
mkPostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' :: PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type' -- ^ 'postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'
  -> PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'
mkPostCustomersCustomerFundingInstructionsRequestBodyBankTransfer' postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type = PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'{postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer = GHC.Maybe.Nothing,
...
data PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer' = PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["country" Data.Aeson.Types.ToJSON..= postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'Country obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'" (\obj -> GHC.Base.pure PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country"))}
-- | Create a new 'PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'' with all required fields.
mkPostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer' :: Data.Text.Internal.Text -- ^ 'postCustomersCustomerFundingInstructionsRequestBodyBankTransfer'EuBankTransfer'Country'
...
data PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes' =
   PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'EnumIban -- ^ Represents the JSON value @"iban"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'EnumSortCode -- ^ Represents the JSON value @"sort_code"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'EnumSpei -- ^ Represents the JSON value @"spei"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'EnumZengin -- ^ Represents the JSON value @"zengin"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'
    where {toJSON (PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "iban" -> PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'RequestedAddressTypes'EnumIban
...
data PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type' =
   PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumEuBankTransfer -- ^ Represents the JSON value @"eu_bank_transfer"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumGbBankTransfer -- ^ Represents the JSON value @"gb_bank_transfer"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumJpBankTransfer -- ^ Represents the JSON value @"jp_bank_transfer"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumMxBankTransfer -- ^ Represents the JSON value @"mx_bank_transfer"@
  | PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumUsBankTransfer -- ^ Represents the JSON value @"us_bank_transfer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'
    where {toJSON (PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "eu_bank_transfer" -> PostCustomersCustomerFundingInstructionsRequestBodyBankTransfer'Type'EnumEuBankTransfer
...
data PostCustomersCustomerFundingInstructionsResponse =
   PostCustomersCustomerFundingInstructionsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostCustomersCustomerFundingInstructionsResponse200 FundingInstructions -- ^ Successful response.
  | PostCustomersCustomerFundingInstructionsResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
