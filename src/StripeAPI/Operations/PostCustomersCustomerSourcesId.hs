...
postCustomersCustomerSourcesId :: forall m . StripeAPI.Common.MonadHTTP m => PostCustomersCustomerSourcesIdParameters -- ^ Contains all available parameters of this operation (query and path parameters)
  -> GHC.Maybe.Maybe PostCustomersCustomerSourcesIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostCustomersCustomerSourcesIdResponse) -- ^ Monadic computation which returns the result of the operation
postCustomersCustomerSourcesId parameters
                               body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostCustomersCustomerSourcesIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerSourcesIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                      PostCustomersCustomerSourcesIdResponseBody200)
                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostCustomersCustomerSourcesIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                        Error)
...
data PostCustomersCustomerSourcesIdParameters = PostCustomersCustomerSourcesIdParameters {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdParameters
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["pathCustomer" Data.Aeson.Types.ToJSON..= postCustomersCustomerSourcesIdParametersPathCustomer obj] : ["pathId" Data.Aeson.Types.ToJSON..= postCustomersCustomerSourcesIdParametersPathId obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdParameters
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdParameters" (\obj -> (GHC.Base.pure PostCustomersCustomerSourcesIdParameters GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathCustomer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "pathId"))}
-- | Create a new 'PostCustomersCustomerSourcesIdParameters' with all required fields.
mkPostCustomersCustomerSourcesIdParameters :: Data.Text.Internal.Text -- ^ 'postCustomersCustomerSourcesIdParametersPathCustomer'
  -> Data.Text.Internal.Text -- ^ 'postCustomersCustomerSourcesIdParametersPathId'
  -> PostCustomersCustomerSourcesIdParameters
mkPostCustomersCustomerSourcesIdParameters postCustomersCustomerSourcesIdParametersPathCustomer postCustomersCustomerSourcesIdParametersPathId = PostCustomersCustomerSourcesIdParameters{postCustomersCustomerSourcesIdParametersPathCustomer = postCustomersCustomerSourcesIdParametersPathCustomer,
...
data PostCustomersCustomerSourcesIdRequestBody = PostCustomersCustomerSourcesIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdRequestBody
...
mkPostCustomersCustomerSourcesIdRequestBody = PostCustomersCustomerSourcesIdRequestBody{postCustomersCustomerSourcesIdRequestBodyAccountHolderName = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdRequestBodyAccountHolderType' =
   PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'
    where {toJSON (PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "company" -> PostCustomersCustomerSourcesIdRequestBodyAccountHolderType'EnumCompany
...
data PostCustomersCustomerSourcesIdRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdRequestBodyMetadata'Variants
    where {toJSON (PostCustomersCustomerSourcesIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCustomersCustomerSourcesIdRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostCustomersCustomerSourcesIdRequestBodyMetadata'EmptyString
...
data PostCustomersCustomerSourcesIdRequestBodyOwner' = PostCustomersCustomerSourcesIdRequestBodyOwner' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdRequestBodyOwner'
...
mkPostCustomersCustomerSourcesIdRequestBodyOwner' = PostCustomersCustomerSourcesIdRequestBodyOwner'{postCustomersCustomerSourcesIdRequestBodyOwner'Address = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdRequestBodyOwner'Address' = PostCustomersCustomerSourcesIdRequestBodyOwner'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdRequestBodyOwner'Address'
...
mkPostCustomersCustomerSourcesIdRequestBodyOwner'Address' = PostCustomersCustomerSourcesIdRequestBodyOwner'Address'{postCustomersCustomerSourcesIdRequestBodyOwner'Address'City = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdResponseBody200 = PostCustomersCustomerSourcesIdResponseBody200 {
  ...
  , postCustomersCustomerSourcesIdResponseBody200AllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullable))
  ...
  , postCustomersCustomerSourcesIdResponseBody200FutureRequirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable))
  -- | giropay
  ...
  -- 
  -- * Maximum length of 5000
  , postCustomersCustomerSourcesIdResponseBody200Iin :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | klarna
  ...
  -- | networks: 
  , postCustomersCustomerSourcesIdResponseBody200Networks :: (GHC.Maybe.Maybe TokenCardNetworks)
  ...
  , postCustomersCustomerSourcesIdResponseBody200RegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullable))
  -- | requirements: Information about the requirements for the bank account, including what information needs to be collected.
  , postCustomersCustomerSourcesIdResponseBody200Requirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable))
...
mkPostCustomersCustomerSourcesIdResponseBody200 = PostCustomersCustomerSourcesIdResponseBody200{postCustomersCustomerSourcesIdResponseBody200Account = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postCustomersCustomerSourcesIdResponseBody200AllowRedisplay = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postCustomersCustomerSourcesIdResponseBody200FutureRequirements = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postCustomersCustomerSourcesIdResponseBody200Iin = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postCustomersCustomerSourcesIdResponseBody200Networks = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postCustomersCustomerSourcesIdResponseBody200RegulatedStatus = GHC.Maybe.Nothing,
                                                                                                postCustomersCustomerSourcesIdResponseBody200Requirements = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableVariants
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableVariants
    where {parseJSON val = case (PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerSourcesIdResponseBody200Account'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the enum schema located at @paths.\/v1\/customers\/{customer}\/sources\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
data PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullable =
   PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullable
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableOther val) = val;
           toJSON (PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumAlways) = "always";
           toJSON (PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumLimited) = "limited";
           toJSON (PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumAlways
                                             | val GHC.Classes.== "limited" -> PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumLimited
                                             | val GHC.Classes.== "unspecified" -> PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableEnumUnspecified
                                             | GHC.Base.otherwise -> PostCustomersCustomerSourcesIdResponseBody200AllowRedisplay'NonNullableOther val)}
...
data PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullable =
   PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullable
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> PostCustomersCustomerSourcesIdResponseBody200AvailablePayoutMethods'NonNullableEnumInstant
...
data PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableVariants
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableVariants
    where {parseJSON val = case (PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostCustomersCustomerSourcesIdResponseBody200Customer'NonNullableDeletedCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/customers\/{customer}\/sources\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.future_requirements.anyOf@ in the specification.
-- 
-- Information about the [upcoming new requirements for the bank account](https:\\\/\\\/stripe.com\\\/docs\\\/connect\\\/custom-accounts\\\/future-requirements), including what information needs to be collected, and by when.
data PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable = PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable {
  ...
  postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  ...
  , postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  ...
  , postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable" (\obj -> (((GHC.Base.pure PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable' with all required fields.
mkPostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable :: PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable
mkPostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable = PostCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullable{postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                                                                                            postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                                                                                            postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                                                                                            postCustomersCustomerSourcesIdResponseBody200FutureRequirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
...
data PostCustomersCustomerSourcesIdResponseBody200Object' =
   PostCustomersCustomerSourcesIdResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdResponseBody200Object'EnumCard -- ^ Represents the JSON value @"card"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Object'
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card" -> PostCustomersCustomerSourcesIdResponseBody200Object'EnumCard
...
data PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable" (\obj -> (((((((GHC.Base.pure PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "phone")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_phone"))}
...
mkPostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullable{postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable" (\obj -> (((((GHC.Base.pure PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullable{postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable" (\obj -> (((((GHC.Base.pure PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullable{postCustomersCustomerSourcesIdResponseBody200Owner'NonNullableVerifiedAddress'NonNullableCity = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @paths.\/v1\/customers\/{customer}\/sources\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.regulated_status@ in the specification.
-- 
-- Status of a card based on the card issuer.
data PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullable =
   PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullable
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableOther val) = val;
           toJSON (PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumRegulated) = "regulated";
           toJSON (PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated) = "unregulated"}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumRegulated
                                             | val GHC.Classes.== "unregulated" -> PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableEnumUnregulated
                                             | GHC.Base.otherwise -> PostCustomersCustomerSourcesIdResponseBody200RegulatedStatus'NonNullableOther val)}
-- | Defines the object schema located at @paths.\/v1\/customers\/{customer}\/sources\/{id}.POST.responses.200.content.application\/json.schema.anyOf.properties.requirements.anyOf@ in the specification.
-- 
-- Information about the requirements for the bank account, including what information needs to be collected.
data PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable {
  -- | currently_due: Fields that need to be collected to keep the external account enabled. If not collected by \`current_deadline\`, these fields appear in \`past_due\` as well, and the account is disabled.
  postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  -- | past_due: Fields that weren\'t collected by \`current_deadline\`. These fields need to be collected to enable the external account.
  , postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | pending_verification: Fields that might become required depending on the results of verification or review. It\'s an empty array unless an asynchronous verification is pending. If verification fails, these fields move to \`eventually_due\`, \`currently_due\`, or \`past_due\`. Fields might appear in \`eventually_due\`, \`currently_due\`, or \`past_due\` and in \`pending_verification\` if verification fails but another verification is still pending.
  , postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable" (\obj -> (((GHC.Base.pure PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable' with all required fields.
mkPostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable :: PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable
mkPostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable = PostCustomersCustomerSourcesIdResponseBody200Requirements'NonNullable{postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                                                                                postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                                                                                postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                                                                                postCustomersCustomerSourcesIdResponseBody200Requirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
...
data PostCustomersCustomerSourcesIdResponseBody200Type' =
   PostCustomersCustomerSourcesIdResponseBody200Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostCustomersCustomerSourcesIdResponseBody200Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumAchCreditTransfer -- ^ Represents the JSON value @"ach_credit_transfer"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumAchDebit -- ^ Represents the JSON value @"ach_debit"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumAcssDebit -- ^ Represents the JSON value @"acss_debit"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumAlipay -- ^ Represents the JSON value @"alipay"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumAuBecsDebit -- ^ Represents the JSON value @"au_becs_debit"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumBancontact -- ^ Represents the JSON value @"bancontact"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumCard -- ^ Represents the JSON value @"card"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumCardPresent -- ^ Represents the JSON value @"card_present"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumEps -- ^ Represents the JSON value @"eps"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumGiropay -- ^ Represents the JSON value @"giropay"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumIdeal -- ^ Represents the JSON value @"ideal"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumKlarna -- ^ Represents the JSON value @"klarna"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumMultibanco -- ^ Represents the JSON value @"multibanco"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumP24 -- ^ Represents the JSON value @"p24"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumSepaDebit -- ^ Represents the JSON value @"sepa_debit"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumSofort -- ^ Represents the JSON value @"sofort"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumThreeDSecure -- ^ Represents the JSON value @"three_d_secure"@
  | PostCustomersCustomerSourcesIdResponseBody200Type'EnumWechat -- ^ Represents the JSON value @"wechat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostCustomersCustomerSourcesIdResponseBody200Type'
    where {toJSON (PostCustomersCustomerSourcesIdResponseBody200Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostCustomersCustomerSourcesIdResponseBody200Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach_credit_transfer" -> PostCustomersCustomerSourcesIdResponseBody200Type'EnumAchCreditTransfer
