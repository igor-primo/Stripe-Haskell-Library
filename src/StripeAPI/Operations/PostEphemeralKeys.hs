...
postEphemeralKeys :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostEphemeralKeysRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostEphemeralKeysResponse) -- ^ Monadic computation which returns the result of the operation
postEphemeralKeys body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostEphemeralKeysResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostEphemeralKeysResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               EphemeralKey)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostEphemeralKeysResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/ephemeral_keys" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostEphemeralKeysRequestBody = PostEphemeralKeysRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostEphemeralKeysRequestBody
...
mkPostEphemeralKeysRequestBody = PostEphemeralKeysRequestBody{postEphemeralKeysRequestBodyCustomer = GHC.Maybe.Nothing,
