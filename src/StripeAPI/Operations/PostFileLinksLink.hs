...
postFileLinksLink :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ link
  -> GHC.Maybe.Maybe PostFileLinksLinkRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostFileLinksLinkResponse) -- ^ Monadic computation which returns the result of the operation
postFileLinksLink link
                  body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostFileLinksLinkResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostFileLinksLinkResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               FileLink)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostFileLinksLinkResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
...
data PostFileLinksLinkRequestBody = PostFileLinksLinkRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostFileLinksLinkRequestBody
...
mkPostFileLinksLinkRequestBody = PostFileLinksLinkRequestBody{postFileLinksLinkRequestBodyExpand = GHC.Maybe.Nothing,
...
data PostFileLinksLinkRequestBodyExpiresAt'Variants =
   PostFileLinksLinkRequestBodyExpiresAt'Now -- ^ Represents the JSON value @"now"@
  | PostFileLinksLinkRequestBodyExpiresAt'EmptyString -- ^ Represents the JSON value @""@
  | PostFileLinksLinkRequestBodyExpiresAt'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostFileLinksLinkRequestBodyExpiresAt'Variants
    where {toJSON (PostFileLinksLinkRequestBodyExpiresAt'Int a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostFileLinksLinkRequestBodyExpiresAt'Now) = "now";
           toJSON (PostFileLinksLinkRequestBodyExpiresAt'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostFileLinksLinkRequestBodyExpiresAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "now" -> GHC.Base.pure PostFileLinksLinkRequestBodyExpiresAt'Now
...
data PostFileLinksLinkRequestBodyMetadata'Variants =
   PostFileLinksLinkRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostFileLinksLinkRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostFileLinksLinkRequestBodyMetadata'Variants
    where {toJSON (PostFileLinksLinkRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostFileLinksLinkRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostFileLinksLinkRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostFileLinksLinkRequestBodyMetadata'EmptyString
...
data PostFileLinksLinkResponse =
   PostFileLinksLinkResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
