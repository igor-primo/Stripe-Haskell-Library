...
postIdentityVerificationSessionsSessionRedact :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ session | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostIdentityVerificationSessionsSessionRedactRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostIdentityVerificationSessionsSessionRedactResponse) -- ^ Monadic computation which returns the result of the operation
postIdentityVerificationSessionsSessionRedact session
                                              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostIdentityVerificationSessionsSessionRedactResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostIdentityVerificationSessionsSessionRedactResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Identity'verificationSession)
                                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostIdentityVerificationSessionsSessionRedactResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
...
data PostIdentityVerificationSessionsSessionRedactRequestBody = PostIdentityVerificationSessionsSessionRedactRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIdentityVerificationSessionsSessionRedactRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postIdentityVerificationSessionsSessionRedactRequestBodyExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIdentityVerificationSessionsSessionRedactRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostIdentityVerificationSessionsSessionRedactRequestBody" (\obj -> GHC.Base.pure PostIdentityVerificationSessionsSessionRedactRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))}
...
data PostIdentityVerificationSessionsSessionRedactResponse =
   PostIdentityVerificationSessionsSessionRedactResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
