...
postInvoiceitems body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostInvoiceitemsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostInvoiceitemsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                            Invoiceitem)
                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostInvoiceitemsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                              Error)
                                                                                                                                                                   | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/invoiceitems" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostInvoiceitemsRequestBody = PostInvoiceitemsRequestBody {
  ...
  , postInvoiceitemsRequestBodyPricing :: (GHC.Maybe.Maybe PostInvoiceitemsRequestBodyPricing')
  ...
  , postInvoiceitemsRequestBodyTaxBehavior :: (GHC.Maybe.Maybe PostInvoiceitemsRequestBodyTaxBehavior')
  -- | tax_code: A [tax code](https:\/\/stripe.com\/docs\/tax\/tax-categories) ID.
  , postInvoiceitemsRequestBodyTaxCode :: (GHC.Maybe.Maybe PostInvoiceitemsRequestBodyTaxCode'Variants)
...
mkPostInvoiceitemsRequestBody postInvoiceitemsRequestBodyCustomer = PostInvoiceitemsRequestBody{postInvoiceitemsRequestBodyAmount = GHC.Maybe.Nothing,
                                                                                                ...
                                                                                                postInvoiceitemsRequestBodyPricing = GHC.Maybe.Nothing,
                                                                                                postInvoiceitemsRequestBodyQuantity = GHC.Maybe.Nothing,
                                                                                                postInvoiceitemsRequestBodySubscription = GHC.Maybe.Nothing,
                                                                                                postInvoiceitemsRequestBodyTaxBehavior = GHC.Maybe.Nothing,
                                                                                                postInvoiceitemsRequestBodyTaxCode = GHC.Maybe.Nothing,
...
mkPostInvoiceitemsRequestBodyDiscounts'OneOf1 = PostInvoiceitemsRequestBodyDiscounts'OneOf1{postInvoiceitemsRequestBodyDiscounts'OneOf1Coupon = GHC.Maybe.Nothing,
                                                                                            ...
                                                                                            postInvoiceitemsRequestBodyDiscounts'OneOf1PromotionCode = GHC.Maybe.Nothing}
...
-- | Defines the object schema located at @paths.\/v1\/invoiceitems.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.pricing@ in the specification.
-- 
-- The pricing information for the invoice item.
data PostInvoiceitemsRequestBodyPricing' = PostInvoiceitemsRequestBodyPricing' {
  -- | price
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postInvoiceitemsRequestBodyPricing'Price :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostInvoiceitemsRequestBodyPricing'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("price" Data.Aeson.Types.ToJSON..=)) (postInvoiceitemsRequestBodyPricing'Price obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("price" Data.Aeson.Types.ToJSON..=)) (postInvoiceitemsRequestBodyPricing'Price obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoiceitemsRequestBodyPricing'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostInvoiceitemsRequestBodyPricing'" (\obj -> GHC.Base.pure PostInvoiceitemsRequestBodyPricing' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price"))}
-- | Create a new 'PostInvoiceitemsRequestBodyPricing'' with all required fields.
mkPostInvoiceitemsRequestBodyPricing' :: PostInvoiceitemsRequestBodyPricing'
mkPostInvoiceitemsRequestBodyPricing' = PostInvoiceitemsRequestBodyPricing'{postInvoiceitemsRequestBodyPricing'Price = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/invoiceitems.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.tax_behavior@ in the specification.
-- 
-- Only required if a [default tax behavior](https:\/\/stripe.com\/docs\/tax\/products-prices-tax-categories-tax-behavior\#setting-a-default-tax-behavior-(recommended)) was not provided in the Stripe Tax settings. Specifies whether the price is considered inclusive of taxes or exclusive of taxes. One of \`inclusive\`, \`exclusive\`, or \`unspecified\`. Once specified as either \`inclusive\` or \`exclusive\`, it cannot be changed.
data PostInvoiceitemsRequestBodyTaxBehavior' =
   PostInvoiceitemsRequestBodyTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostInvoiceitemsRequestBodyTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostInvoiceitemsRequestBodyTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | PostInvoiceitemsRequestBodyTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | PostInvoiceitemsRequestBodyTaxBehavior'EnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostInvoiceitemsRequestBodyTaxBehavior'
    where {toJSON (PostInvoiceitemsRequestBodyTaxBehavior'Other val) = val;
           toJSON (PostInvoiceitemsRequestBodyTaxBehavior'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostInvoiceitemsRequestBodyTaxBehavior'EnumExclusive) = "exclusive";
           toJSON (PostInvoiceitemsRequestBodyTaxBehavior'EnumInclusive) = "inclusive";
           toJSON (PostInvoiceitemsRequestBodyTaxBehavior'EnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoiceitemsRequestBodyTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> PostInvoiceitemsRequestBodyTaxBehavior'EnumExclusive
                                             | val GHC.Classes.== "inclusive" -> PostInvoiceitemsRequestBodyTaxBehavior'EnumInclusive
                                             | val GHC.Classes.== "unspecified" -> PostInvoiceitemsRequestBodyTaxBehavior'EnumUnspecified
                                             | GHC.Base.otherwise -> PostInvoiceitemsRequestBodyTaxBehavior'Other val)}
-- | Defines the oneOf schema located at @paths.\/v1\/invoiceitems.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.tax_code.anyOf@ in the specification.
-- 
-- A [tax code](https:\/\/stripe.com\/docs\/tax\/tax-categories) ID.
data PostInvoiceitemsRequestBodyTaxCode'Variants =
   PostInvoiceitemsRequestBodyTaxCode'EmptyString -- ^ Represents the JSON value @""@
  | PostInvoiceitemsRequestBodyTaxCode'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostInvoiceitemsRequestBodyTaxCode'Variants
    where {toJSON (PostInvoiceitemsRequestBodyTaxCode'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostInvoiceitemsRequestBodyTaxCode'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoiceitemsRequestBodyTaxCode'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostInvoiceitemsRequestBodyTaxCode'EmptyString
                              | GHC.Base.otherwise -> case (PostInvoiceitemsRequestBodyTaxCode'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
