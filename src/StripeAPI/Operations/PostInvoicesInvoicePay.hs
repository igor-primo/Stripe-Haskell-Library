...
postInvoicesInvoicePay invoice
                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostInvoicesInvoicePayResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostInvoicesInvoicePayResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              Invoice)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostInvoicesInvoicePayResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoicesInvoicePayRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostInvoicesInvoicePayRequestBody" (\obj -> ((((((GHC.Base.pure PostInvoicesInvoicePayRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "forgive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "off_session")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "paid_out_of_band")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "source"))}
...
data PostInvoicesInvoicePayRequestBodyMandate'Variants =
   PostInvoicesInvoicePayRequestBodyMandate'EmptyString -- ^ Represents the JSON value @""@
  | PostInvoicesInvoicePayRequestBodyMandate'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostInvoicesInvoicePayRequestBodyMandate'Variants
    where {toJSON (PostInvoicesInvoicePayRequestBodyMandate'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostInvoicesInvoicePayRequestBodyMandate'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostInvoicesInvoicePayRequestBodyMandate'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostInvoicesInvoicePayRequestBodyMandate'EmptyString
