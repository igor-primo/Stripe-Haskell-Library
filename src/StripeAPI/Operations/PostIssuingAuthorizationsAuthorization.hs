...
postIssuingAuthorizationsAuthorization :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ authorization | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostIssuingAuthorizationsAuthorizationRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostIssuingAuthorizationsAuthorizationResponse) -- ^ Monadic computation which returns the result of the operation
postIssuingAuthorizationsAuthorization authorization
                                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostIssuingAuthorizationsAuthorizationResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingAuthorizationsAuthorizationResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Issuing'authorization)
                                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingAuthorizationsAuthorizationResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                Error)
...
data PostIssuingAuthorizationsAuthorizationRequestBody = PostIssuingAuthorizationsAuthorizationRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingAuthorizationsAuthorizationRequestBody
...
mkPostIssuingAuthorizationsAuthorizationRequestBody = PostIssuingAuthorizationsAuthorizationRequestBody{postIssuingAuthorizationsAuthorizationRequestBodyExpand = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingAuthorizationsAuthorizationRequestBodyMetadata'Variants
    where {toJSON (PostIssuingAuthorizationsAuthorizationRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingAuthorizationsAuthorizationRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingAuthorizationsAuthorizationRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingAuthorizationsAuthorizationRequestBodyMetadata'EmptyString
