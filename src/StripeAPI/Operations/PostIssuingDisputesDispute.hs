...
postIssuingDisputesDispute dispute
                           body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostIssuingDisputesDisputeResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingDisputesDisputeResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                          Issuing'dispute)
                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingDisputesDisputeResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                            Error)
...
data PostIssuingDisputesDisputeRequestBody = PostIssuingDisputesDisputeRequestBody {
  ...
  postIssuingDisputesDisputeRequestBodyAmount :: (GHC.Maybe.Maybe GHC.Types.Int)
...
mkPostIssuingDisputesDisputeRequestBody = PostIssuingDisputesDisputeRequestBody{postIssuingDisputesDisputeRequestBodyAmount = GHC.Maybe.Nothing,
                                                                                postIssuingDisputesDisputeRequestBodyEvidence = GHC.Maybe.Nothing,
...
data PostIssuingDisputesDisputeRequestBodyEvidence' = PostIssuingDisputesDisputeRequestBodyEvidence' {
  ...
  , postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'Variants)
  -- | not_received
...
mkPostIssuingDisputesDisputeRequestBodyEvidence' = PostIssuingDisputesDisputeRequestBodyEvidence'{postIssuingDisputesDisputeRequestBodyEvidence'Canceled = GHC.Maybe.Nothing,
                                                                                                  ...
                                                                                                  postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization = GHC.Maybe.Nothing,
...
data PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1 {
  ...
  -- | cancellation_reason
  , postIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Variants)
  -- | expected_at
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Variants)
  -- | product_description
  , postIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Variants)
  -- | product_type
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationPolicyProvided'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationPolicyProvided'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationPolicyProvided'Bool Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.canceled.anyOf.properties.cancellation_reason.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1CancellationReason'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ExpectedAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ExpectedAt'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ExpectedAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.canceled.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.canceled.anyOf.properties.product_description.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Canceled'OneOf1ProductDescription'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1 {
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Variants)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1CheckImage'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1CheckImage'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1CheckImage'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.duplicate.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Duplicate'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1 {
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Variants)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1AdditionalDocumentation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1AdditionalDocumentation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1AdditionalDocumentation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.fraudulent.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Fraudulent'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1 {
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Variants)
  -- | received_at
  ...
  -- | return_description
  , postIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Variants)
  -- | return_status
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1AdditionalDocumentation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1AdditionalDocumentation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1AdditionalDocumentation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.merchandise_not_as_described.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReceivedAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReceivedAt'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReceivedAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.merchandise_not_as_described.anyOf.properties.return_description.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1ReturnDescription'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'PostIssuingDisputesDisputeRequestBodyEvidence'MerchandiseNotAsDescribed'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.no_valid_authorization.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 {
  -- | additional_documentation
  postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Variants)
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Variants)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("additional_documentation" Data.Aeson.Types.ToJSON..=)) (postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("explanation" Data.Aeson.Types.ToJSON..=)) (postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("additional_documentation" Data.Aeson.Types.ToJSON..=)) (postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("explanation" Data.Aeson.Types.ToJSON..=)) (postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1" (\obj -> (GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "additional_documentation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "explanation"))}
-- | Create a new 'PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1' with all required fields.
mkPostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 :: PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1
mkPostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1{postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation = GHC.Maybe.Nothing,
                                                                                                                                                        postIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.no_valid_authorization.anyOf.properties.additional_documentation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1AdditionalDocumentation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.no_valid_authorization.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.no_valid_authorization.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'PostIssuingDisputesDisputeRequestBodyEvidence'NoValidAuthorization'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1 {
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Variants)
  -- | product_description
  , postIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Variants)
  -- | product_type
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ExpectedAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ExpectedAt'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ExpectedAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.not_received.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.not_received.anyOf.properties.product_description.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'NotReceived'OneOf1ProductDescription'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1 {
  ...
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Variants)
  -- | product_description
  , postIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Variants)
  -- | product_type
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1AdditionalDocumentation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1AdditionalDocumentation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1AdditionalDocumentation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.other.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.other.anyOf.properties.product_description.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'Other'OneOf1ProductDescription'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostIssuingDisputesDisputeRequestBodyEvidence'Reason' =
  ...
  | PostIssuingDisputesDisputeRequestBodyEvidence'Reason'EnumNoValidAuthorization -- ^ Represents the JSON value @"no_valid_authorization"@
...
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'Reason'
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Reason'Other val) = val;
           ...
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'Reason'EnumNoValidAuthorization) = "no_valid_authorization";
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'Reason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "canceled" -> PostIssuingDisputesDisputeRequestBodyEvidence'Reason'EnumCanceled
                                             ...
                                             | val GHC.Classes.== "no_valid_authorization" -> PostIssuingDisputesDisputeRequestBodyEvidence'Reason'EnumNoValidAuthorization
...
data PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1 = PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1 {
  ...
  -- | cancellation_reason
  , postIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Variants)
  -- | explanation
  , postIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation :: (GHC.Maybe.Maybe PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Variants)
  -- | received_at
...
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CanceledAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CanceledAt'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CanceledAt'Int Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.service_not_as_described.anyOf.properties.cancellation_reason.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1CancellationReason'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/issuing\/disputes\/{dispute}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.evidence.properties.service_not_as_described.anyOf.properties.explanation.anyOf@ in the specification.
-- 
-- 
data PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Variants =
   PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'EmptyString -- ^ Represents the JSON value @""@
  | PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Variants
    where {toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'EmptyString
                              | GHC.Base.otherwise -> case (PostIssuingDisputesDisputeRequestBodyEvidence'ServiceNotAsDescribed'OneOf1Explanation'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
