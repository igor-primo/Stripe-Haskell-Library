...
postIssuingSettlementsSettlement :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ settlement | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostIssuingSettlementsSettlementRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostIssuingSettlementsSettlementResponse) -- ^ Monadic computation which returns the result of the operation
postIssuingSettlementsSettlement settlement
                                 body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostIssuingSettlementsSettlementResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingSettlementsSettlementResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Issuing'settlement)
                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostIssuingSettlementsSettlementResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                              Error)
                                                                                                                                                                                                   | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/v1/issuing/settlements/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel settlement)) GHC.Base.<> "")) GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostIssuingSettlementsSettlementRequestBody = PostIssuingSettlementsSettlementRequestBody {
  ...
  , postIssuingSettlementsSettlementRequestBodyMetadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostIssuingSettlementsSettlementRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postIssuingSettlementsSettlementRequestBodyExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postIssuingSettlementsSettlementRequestBodyMetadata obj) : GHC.Base.mempty));
...
mkPostIssuingSettlementsSettlementRequestBody = PostIssuingSettlementsSettlementRequestBody{postIssuingSettlementsSettlementRequestBodyExpand = GHC.Maybe.Nothing,
