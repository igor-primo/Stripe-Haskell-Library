...
postLinkAccountSessions body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostLinkAccountSessionsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostLinkAccountSessionsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                 ...
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostLinkAccountSessionsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                   Error)
                                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/link_account_sessions" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostLinkAccountSessionsRequestBodyFilters' = PostLinkAccountSessionsRequestBodyFilters' {
  ...
  postLinkAccountSessionsRequestBodyFilters'AccountSubcategories :: (GHC.Maybe.Maybe [PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'])
  -- | countries
  , postLinkAccountSessionsRequestBodyFilters'Countries :: (GHC.Maybe.Maybe [Data.Text.Internal.Text])
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyFilters'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_subcategories" Data.Aeson.Types.ToJSON..=)) (postLinkAccountSessionsRequestBodyFilters'AccountSubcategories obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("countries" Data.Aeson.Types.ToJSON..=)) (postLinkAccountSessionsRequestBodyFilters'Countries obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_subcategories" Data.Aeson.Types.ToJSON..=)) (postLinkAccountSessionsRequestBodyFilters'AccountSubcategories obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("countries" Data.Aeson.Types.ToJSON..=)) (postLinkAccountSessionsRequestBodyFilters'Countries obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyFilters'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostLinkAccountSessionsRequestBodyFilters'" (\obj -> (GHC.Base.pure PostLinkAccountSessionsRequestBodyFilters' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_subcategories")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "countries"))}
-- | Create a new 'PostLinkAccountSessionsRequestBodyFilters'' with all required fields.
mkPostLinkAccountSessionsRequestBodyFilters' :: PostLinkAccountSessionsRequestBodyFilters'
mkPostLinkAccountSessionsRequestBodyFilters' = PostLinkAccountSessionsRequestBodyFilters'{postLinkAccountSessionsRequestBodyFilters'AccountSubcategories = GHC.Maybe.Nothing,
                                                                                          postLinkAccountSessionsRequestBodyFilters'Countries = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/link_account_sessions.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.filters.properties.account_subcategories.items@ in the specification.
-- 
-- 
data PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories' =
   PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumCreditCard -- ^ Represents the JSON value @"credit_card"@
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumLineOfCredit -- ^ Represents the JSON value @"line_of_credit"@
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumMortgage -- ^ Represents the JSON value @"mortgage"@
  | PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumSavings -- ^ Represents the JSON value @"savings"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'
    where {toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'Other val) = val;
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumChecking) = "checking";
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumCreditCard) = "credit_card";
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumLineOfCredit) = "line_of_credit";
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumMortgage) = "mortgage";
           toJSON (PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumSavings) = "savings"}
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumChecking
                                             | val GHC.Classes.== "credit_card" -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumCreditCard
                                             | val GHC.Classes.== "line_of_credit" -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumLineOfCredit
                                             | val GHC.Classes.== "mortgage" -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumMortgage
                                             | val GHC.Classes.== "savings" -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'EnumSavings
                                             | GHC.Base.otherwise -> PostLinkAccountSessionsRequestBodyFilters'AccountSubcategories'Other val)}
...
data PostLinkAccountSessionsRequestBodyPrefetch' =
   PostLinkAccountSessionsRequestBodyPrefetch'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostLinkAccountSessionsRequestBodyPrefetch'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostLinkAccountSessionsRequestBodyPrefetch'EnumBalances -- ^ Represents the JSON value @"balances"@
  | PostLinkAccountSessionsRequestBodyPrefetch'EnumOwnership -- ^ Represents the JSON value @"ownership"@
  | PostLinkAccountSessionsRequestBodyPrefetch'EnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostLinkAccountSessionsRequestBodyPrefetch'
    where {toJSON (PostLinkAccountSessionsRequestBodyPrefetch'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostLinkAccountSessionsRequestBodyPrefetch'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> PostLinkAccountSessionsRequestBodyPrefetch'EnumBalances
