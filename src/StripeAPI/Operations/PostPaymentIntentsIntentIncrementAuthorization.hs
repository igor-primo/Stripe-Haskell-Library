...
postPaymentIntentsIntentIncrementAuthorization :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ intent | Constraints: Maximum length of 5000
  -> PostPaymentIntentsIntentIncrementAuthorizationRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPaymentIntentsIntentIncrementAuthorizationResponse) -- ^ Monadic computation which returns the result of the operation
postPaymentIntentsIntentIncrementAuthorization intent
                                               body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPaymentIntentsIntentIncrementAuthorizationResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentIntentsIntentIncrementAuthorizationResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      PaymentIntent)
                                                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentIntentsIntentIncrementAuthorizationResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                        Error)
...
data PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData' = PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (postPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData'Amount obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData'" (\obj -> GHC.Base.pure PostPaymentIntentsIntentIncrementAuthorizationRequestBodyTransferData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount"))}
...
data PostPaymentIntentsIntentIncrementAuthorizationResponse =
   PostPaymentIntentsIntentIncrementAuthorizationResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostPaymentIntentsIntentIncrementAuthorizationResponse200 PaymentIntent -- ^ Successful response.
  | PostPaymentIntentsIntentIncrementAuthorizationResponseDefault Error -- ^ Error response.
