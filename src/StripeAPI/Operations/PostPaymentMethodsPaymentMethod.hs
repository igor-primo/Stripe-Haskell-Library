...
postPaymentMethodsPaymentMethod paymentMethod
                                body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPaymentMethodsPaymentMethodResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentMethodsPaymentMethodResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         PaymentMethod)
                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentMethodsPaymentMethodResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                           Error)
...
data PostPaymentMethodsPaymentMethodRequestBody = PostPaymentMethodsPaymentMethodRequestBody {
  ...
  postPaymentMethodsPaymentMethodRequestBodyAllowRedisplay :: (GHC.Maybe.Maybe PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay')
  ...
  , postPaymentMethodsPaymentMethodRequestBodyPayByBank :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
...
mkPostPaymentMethodsPaymentMethodRequestBody = PostPaymentMethodsPaymentMethodRequestBody{postPaymentMethodsPaymentMethodRequestBodyAllowRedisplay = GHC.Maybe.Nothing,
                                                                                          ...
                                                                                          postPaymentMethodsPaymentMethodRequestBodyPayByBank = GHC.Maybe.Nothing,
                                                                                          postPaymentMethodsPaymentMethodRequestBodyUsBankAccount = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/payment_methods\/{payment_method}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to \`unspecified\`.
data PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay' =
   PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumAlways -- ^ Represents the JSON value @"always"@
  | PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumLimited -- ^ Represents the JSON value @"limited"@
  | PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'
    where {toJSON (PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'Other val) = val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumAlways) = "always";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumLimited) = "limited";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumAlways
                                             | val GHC.Classes.== "limited" -> PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumLimited
                                             | val GHC.Classes.== "unspecified" -> PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'EnumUnspecified
                                             | GHC.Base.otherwise -> PostPaymentMethodsPaymentMethodRequestBodyAllowRedisplay'Other val)}
...
mkPostPaymentMethodsPaymentMethodRequestBodyBillingDetails' = PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'{postPaymentMethodsPaymentMethodRequestBodyBillingDetails'Address = GHC.Maybe.Nothing,
                                                                                                                        ...
                                                                                                                        postPaymentMethodsPaymentMethodRequestBodyBillingDetails'TaxId = GHC.Maybe.Nothing}
...
data PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'Variants =
   PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'EmptyString -- ^ Represents the JSON value @""@
  | PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'Variants
    where {toJSON (PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Name'EmptyString
...
data PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'Variants =
   PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'EmptyString -- ^ Represents the JSON value @""@
  | PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'Variants
    where {toJSON (PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostPaymentMethodsPaymentMethodRequestBodyBillingDetails'Phone'EmptyString
...
data PostPaymentMethodsPaymentMethodRequestBodyCard' = PostPaymentMethodsPaymentMethodRequestBodyCard' {
  ...
  -- | networks
  , postPaymentMethodsPaymentMethodRequestBodyCard'Networks :: (GHC.Maybe.Maybe PostPaymentMethodsPaymentMethodRequestBodyCard'Networks')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyCard'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("exp_month" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'ExpMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("exp_year" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'ExpYear obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("networks" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'Networks obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("exp_month" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'ExpMonth obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("exp_year" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'ExpYear obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("networks" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'Networks obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyCard'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPaymentMethodsPaymentMethodRequestBodyCard'" (\obj -> ((GHC.Base.pure PostPaymentMethodsPaymentMethodRequestBodyCard' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_year")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "networks"))}
...
mkPostPaymentMethodsPaymentMethodRequestBodyCard' = PostPaymentMethodsPaymentMethodRequestBodyCard'{postPaymentMethodsPaymentMethodRequestBodyCard'ExpMonth = GHC.Maybe.Nothing,
                                                                                                    ...
                                                                                                    postPaymentMethodsPaymentMethodRequestBodyCard'Networks = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/payment_methods\/{payment_method}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.card.properties.networks@ in the specification.
-- 
-- 
data PostPaymentMethodsPaymentMethodRequestBodyCard'Networks' = PostPaymentMethodsPaymentMethodRequestBodyCard'Networks' {
  -- | preferred
  postPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred :: (GHC.Maybe.Maybe PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'" (\obj -> GHC.Base.pure PostPaymentMethodsPaymentMethodRequestBodyCard'Networks' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred"))}
-- | Create a new 'PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'' with all required fields.
mkPostPaymentMethodsPaymentMethodRequestBodyCard'Networks' :: PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'
mkPostPaymentMethodsPaymentMethodRequestBodyCard'Networks' = PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'{postPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/payment_methods\/{payment_method}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.card.properties.networks.properties.preferred@ in the specification.
-- 
-- 
data PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred' =
   PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'
    where {toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'Other val) = val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumEmptyString) = "";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumCartesBancaires) = "cartes_bancaires";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumMastercard) = "mastercard";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumVisa) = "visa"}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumEmptyString
                                             | val GHC.Classes.== "cartes_bancaires" -> PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumCartesBancaires
                                             | val GHC.Classes.== "mastercard" -> PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumMastercard
                                             | val GHC.Classes.== "visa" -> PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'EnumVisa
                                             | GHC.Base.otherwise -> PostPaymentMethodsPaymentMethodRequestBodyCard'Networks'Preferred'Other val)}
...
data PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount' = PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount' {
  ...
  -- | account_type
  , postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType :: (GHC.Maybe.Maybe PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountHolderType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountHolderType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'" (\obj -> (GHC.Base.pure PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_type"))}
...
mkPostPaymentMethodsPaymentMethodRequestBodyUsBankAccount' = PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'{postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountHolderType = GHC.Maybe.Nothing,
                                                                                                                      postPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType = GHC.Maybe.Nothing}
...
-- | Defines the enum schema located at @paths.\/v1\/payment_methods\/{payment_method}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.us_bank_account.properties.account_type@ in the specification.
-- 
-- 
data PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType' =
   PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumSavings -- ^ Represents the JSON value @"savings"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'
    where {toJSON (PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'Other val) = val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumChecking) = "checking";
           toJSON (PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumSavings) = "savings"}
instance Data.Aeson.Types.FromJSON.FromJSON PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumChecking
                                             | val GHC.Classes.== "savings" -> PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'EnumSavings
                                             | GHC.Base.otherwise -> PostPaymentMethodsPaymentMethodRequestBodyUsBankAccount'AccountType'Other val)}
