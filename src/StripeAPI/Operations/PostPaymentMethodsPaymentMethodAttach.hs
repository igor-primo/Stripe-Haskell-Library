...
postPaymentMethodsPaymentMethodAttach :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ payment_method | Constraints: Maximum length of 5000
  -> PostPaymentMethodsPaymentMethodAttachRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPaymentMethodsPaymentMethodAttachResponse) -- ^ Monadic computation which returns the result of the operation
postPaymentMethodsPaymentMethodAttach paymentMethod
                                      body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPaymentMethodsPaymentMethodAttachResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentMethodsPaymentMethodAttachResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           PaymentMethod)
                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPaymentMethodsPaymentMethodAttachResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                             Error)
...
data PostPaymentMethodsPaymentMethodAttachRequestBody = PostPaymentMethodsPaymentMethodAttachRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPaymentMethodsPaymentMethodAttachRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["customer" Data.Aeson.Types.ToJSON..= postPaymentMethodsPaymentMethodAttachRequestBodyCustomer obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postPaymentMethodsPaymentMethodAttachRequestBodyExpand obj) : GHC.Base.mempty));
...
mkPostPaymentMethodsPaymentMethodAttachRequestBody :: Data.Text.Internal.Text -- ^ 'postPaymentMethodsPaymentMethodAttachRequestBodyCustomer'
  -> PostPaymentMethodsPaymentMethodAttachRequestBody
mkPostPaymentMethodsPaymentMethodAttachRequestBody postPaymentMethodsPaymentMethodAttachRequestBodyCustomer = PostPaymentMethodsPaymentMethodAttachRequestBody{postPaymentMethodsPaymentMethodAttachRequestBodyCustomer = postPaymentMethodsPaymentMethodAttachRequestBodyCustomer,
