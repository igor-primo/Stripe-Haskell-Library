...
postPayoutsPayoutCancel :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ payout | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostPayoutsPayoutCancelRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPayoutsPayoutCancelResponse) -- ^ Monadic computation which returns the result of the operation
postPayoutsPayoutCancel payout
                        body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPayoutsPayoutCancelResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPayoutsPayoutCancelResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                 Payout)
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPayoutsPayoutCancelResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                   Error)
...
data PostPayoutsPayoutCancelRequestBody = PostPayoutsPayoutCancelRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPayoutsPayoutCancelRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postPayoutsPayoutCancelRequestBodyExpand obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postPayoutsPayoutCancelRequestBodyExpand obj) : GHC.Base.mempty)))}
