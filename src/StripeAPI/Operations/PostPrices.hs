...
postPrices :: forall m . StripeAPI.Common.MonadHTTP m => PostPricesRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPricesResponse) -- ^ Monadic computation which returns the result of the operation
postPrices body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPricesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPricesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                          Price)
                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPricesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/prices" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostPricesRequestBody = PostPricesRequestBody {
  ...
  , postPricesRequestBodyCurrencyOptions :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
...
data PostPricesRequestBodyBillingScheme' =
   PostPricesRequestBodyBillingScheme'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyBillingScheme'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyBillingScheme'EnumPerUnit -- ^ Represents the JSON value @"per_unit"@
  | PostPricesRequestBodyBillingScheme'EnumTiered -- ^ Represents the JSON value @"tiered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyBillingScheme'
    where {toJSON (PostPricesRequestBodyBillingScheme'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyBillingScheme'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "per_unit" -> PostPricesRequestBodyBillingScheme'EnumPerUnit
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyCustomUnitAmount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyCustomUnitAmount'" (\obj -> (((GHC.Base.pure PostPricesRequestBodyCustomUnitAmount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preset"))}
-- | Create a new 'PostPricesRequestBodyCustomUnitAmount'' with all required fields.
mkPostPricesRequestBodyCustomUnitAmount' :: GHC.Types.Bool -- ^ 'postPricesRequestBodyCustomUnitAmount'Enabled'
  -> PostPricesRequestBodyCustomUnitAmount'
mkPostPricesRequestBodyCustomUnitAmount' postPricesRequestBodyCustomUnitAmount'Enabled = PostPricesRequestBodyCustomUnitAmount'{postPricesRequestBodyCustomUnitAmount'Enabled = postPricesRequestBodyCustomUnitAmount'Enabled,
...
data PostPricesRequestBodyProductData' = PostPricesRequestBodyProductData' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyProductData'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("active" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Active obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Id obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Metadata obj) : ["name" Data.Aeson.Types.ToJSON..= postPricesRequestBodyProductData'Name obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("statement_descriptor" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'StatementDescriptor obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_code" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'TaxCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_label" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'UnitLabel obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("active" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Active obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Id obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'Metadata obj) : ["name" Data.Aeson.Types.ToJSON..= postPricesRequestBodyProductData'Name obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("statement_descriptor" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'StatementDescriptor obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_code" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'TaxCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_label" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyProductData'UnitLabel obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyProductData'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyProductData'" (\obj -> ((((((GHC.Base.pure PostPricesRequestBodyProductData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_label"))}
-- | Create a new 'PostPricesRequestBodyProductData'' with all required fields.
mkPostPricesRequestBodyProductData' :: Data.Text.Internal.Text -- ^ 'postPricesRequestBodyProductData'Name'
  -> PostPricesRequestBodyProductData'
mkPostPricesRequestBodyProductData' postPricesRequestBodyProductData'Name = PostPricesRequestBodyProductData'{postPricesRequestBodyProductData'Active = GHC.Maybe.Nothing,
...
data PostPricesRequestBodyRecurring' = PostPricesRequestBodyRecurring' {
  ...
  -- 
  -- * Maximum length of 5000
  , postPricesRequestBodyRecurring'Meter :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | usage_type
  , postPricesRequestBodyRecurring'UsageType :: (GHC.Maybe.Maybe PostPricesRequestBodyRecurring'UsageType')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyRecurring'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= postPricesRequestBodyRecurring'Interval obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'IntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'Meter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'UsageType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= postPricesRequestBodyRecurring'Interval obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'IntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'Meter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyRecurring'UsageType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyRecurring'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyRecurring'" (\obj -> (((GHC.Base.pure PostPricesRequestBodyRecurring' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "meter")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_type"))}
-- | Create a new 'PostPricesRequestBodyRecurring'' with all required fields.
mkPostPricesRequestBodyRecurring' :: PostPricesRequestBodyRecurring'Interval' -- ^ 'postPricesRequestBodyRecurring'Interval'
  -> PostPricesRequestBodyRecurring'
mkPostPricesRequestBodyRecurring' postPricesRequestBodyRecurring'Interval = PostPricesRequestBodyRecurring'{postPricesRequestBodyRecurring'Interval = postPricesRequestBodyRecurring'Interval,
                                                                                                            postPricesRequestBodyRecurring'IntervalCount = GHC.Maybe.Nothing,
                                                                                                            postPricesRequestBodyRecurring'Meter = GHC.Maybe.Nothing,
...
data PostPricesRequestBodyRecurring'Interval' =
   PostPricesRequestBodyRecurring'Interval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyRecurring'Interval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyRecurring'Interval'EnumDay -- ^ Represents the JSON value @"day"@
  | PostPricesRequestBodyRecurring'Interval'EnumMonth -- ^ Represents the JSON value @"month"@
  | PostPricesRequestBodyRecurring'Interval'EnumWeek -- ^ Represents the JSON value @"week"@
  | PostPricesRequestBodyRecurring'Interval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyRecurring'Interval'
    where {toJSON (PostPricesRequestBodyRecurring'Interval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyRecurring'Interval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> PostPricesRequestBodyRecurring'Interval'EnumDay
...
data PostPricesRequestBodyRecurring'UsageType' =
   PostPricesRequestBodyRecurring'UsageType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyRecurring'UsageType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyRecurring'UsageType'EnumLicensed -- ^ Represents the JSON value @"licensed"@
  | PostPricesRequestBodyRecurring'UsageType'EnumMetered -- ^ Represents the JSON value @"metered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyRecurring'UsageType'
    where {toJSON (PostPricesRequestBodyRecurring'UsageType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyRecurring'UsageType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "licensed" -> PostPricesRequestBodyRecurring'UsageType'EnumLicensed
...
data PostPricesRequestBodyTaxBehavior' =
   PostPricesRequestBodyTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | PostPricesRequestBodyTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | PostPricesRequestBodyTaxBehavior'EnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTaxBehavior'
    where {toJSON (PostPricesRequestBodyTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> PostPricesRequestBodyTaxBehavior'EnumExclusive
...
data PostPricesRequestBodyTiers' = PostPricesRequestBodyTiers' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTiers'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("flat_amount" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'FlatAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("flat_amount_decimal" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'FlatAmountDecimal obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_amount" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'UnitAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_amount_decimal" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'UnitAmountDecimal obj) : ["up_to" Data.Aeson.Types.ToJSON..= postPricesRequestBodyTiers'UpTo obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("flat_amount" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'FlatAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("flat_amount_decimal" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'FlatAmountDecimal obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_amount" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'UnitAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("unit_amount_decimal" Data.Aeson.Types.ToJSON..=)) (postPricesRequestBodyTiers'UnitAmountDecimal obj) : ["up_to" Data.Aeson.Types.ToJSON..= postPricesRequestBodyTiers'UpTo obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTiers'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyTiers'" (\obj -> ((((GHC.Base.pure PostPricesRequestBodyTiers' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "flat_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "flat_amount_decimal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "up_to"))}
-- | Create a new 'PostPricesRequestBodyTiers'' with all required fields.
mkPostPricesRequestBodyTiers' :: PostPricesRequestBodyTiers'UpTo'Variants -- ^ 'postPricesRequestBodyTiers'UpTo'
  -> PostPricesRequestBodyTiers'
mkPostPricesRequestBodyTiers' postPricesRequestBodyTiers'UpTo = PostPricesRequestBodyTiers'{postPricesRequestBodyTiers'FlatAmount = GHC.Maybe.Nothing,
...
data PostPricesRequestBodyTiers'UpTo'Variants =
   PostPricesRequestBodyTiers'UpTo'Inf -- ^ Represents the JSON value @"inf"@
  | PostPricesRequestBodyTiers'UpTo'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTiers'UpTo'Variants
    where {toJSON (PostPricesRequestBodyTiers'UpTo'Int a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostPricesRequestBodyTiers'UpTo'Inf) = "inf"}
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTiers'UpTo'Variants
    where {parseJSON val = if | val GHC.Classes.== "inf" -> GHC.Base.pure PostPricesRequestBodyTiers'UpTo'Inf
...
data PostPricesRequestBodyTiersMode' =
   PostPricesRequestBodyTiersMode'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyTiersMode'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyTiersMode'EnumGraduated -- ^ Represents the JSON value @"graduated"@
  | PostPricesRequestBodyTiersMode'EnumVolume -- ^ Represents the JSON value @"volume"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTiersMode'
    where {toJSON (PostPricesRequestBodyTiersMode'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTiersMode'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "graduated" -> PostPricesRequestBodyTiersMode'EnumGraduated
...
data PostPricesRequestBodyTransformQuantity' = PostPricesRequestBodyTransformQuantity' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTransformQuantity'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["divide_by" Data.Aeson.Types.ToJSON..= postPricesRequestBodyTransformQuantity'DivideBy obj] : ["round" Data.Aeson.Types.ToJSON..= postPricesRequestBodyTransformQuantity'Round obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTransformQuantity'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPricesRequestBodyTransformQuantity'" (\obj -> (GHC.Base.pure PostPricesRequestBodyTransformQuantity' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "divide_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "round"))}
-- | Create a new 'PostPricesRequestBodyTransformQuantity'' with all required fields.
mkPostPricesRequestBodyTransformQuantity' :: GHC.Types.Int -- ^ 'postPricesRequestBodyTransformQuantity'DivideBy'
  -> PostPricesRequestBodyTransformQuantity'Round' -- ^ 'postPricesRequestBodyTransformQuantity'Round'
  -> PostPricesRequestBodyTransformQuantity'
mkPostPricesRequestBodyTransformQuantity' postPricesRequestBodyTransformQuantity'DivideBy postPricesRequestBodyTransformQuantity'Round = PostPricesRequestBodyTransformQuantity'{postPricesRequestBodyTransformQuantity'DivideBy = postPricesRequestBodyTransformQuantity'DivideBy,
                                                                                                                                                                                 postPricesRequestBodyTransformQuantity'Round = postPricesRequestBodyTransformQuantity'Round}
...
data PostPricesRequestBodyTransformQuantity'Round' =
   PostPricesRequestBodyTransformQuantity'Round'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostPricesRequestBodyTransformQuantity'Round'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostPricesRequestBodyTransformQuantity'Round'EnumDown -- ^ Represents the JSON value @"down"@
  | PostPricesRequestBodyTransformQuantity'Round'EnumUp -- ^ Represents the JSON value @"up"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesRequestBodyTransformQuantity'Round'
    where {toJSON (PostPricesRequestBodyTransformQuantity'Round'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesRequestBodyTransformQuantity'Round'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "down" -> PostPricesRequestBodyTransformQuantity'Round'EnumDown
...
data PostPricesResponse =
   PostPricesResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
