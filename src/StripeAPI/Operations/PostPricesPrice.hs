...
postPricesPrice price
                body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPricesPriceResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPricesPriceResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                         Price)
                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPricesPriceResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                           Error)
...
data PostPricesPriceRequestBodyCurrencyOptions'Variants =
   PostPricesPriceRequestBodyCurrencyOptions'EmptyString -- ^ Represents the JSON value @""@
  | PostPricesPriceRequestBodyCurrencyOptions'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPricesPriceRequestBodyCurrencyOptions'Variants
    where {toJSON (PostPricesPriceRequestBodyCurrencyOptions'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostPricesPriceRequestBodyCurrencyOptions'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostPricesPriceRequestBodyCurrencyOptions'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostPricesPriceRequestBodyCurrencyOptions'EmptyString
