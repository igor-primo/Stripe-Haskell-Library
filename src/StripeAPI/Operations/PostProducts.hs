...
postProducts body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostProductsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostProductsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                Product)
                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostProductsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/products" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostProductsRequestBody = PostProductsRequestBody {
  ...
  , postProductsRequestBodyMarketingFeatures :: (GHC.Maybe.Maybe [PostProductsRequestBodyMarketingFeatures'])
...
mkPostProductsRequestBody postProductsRequestBodyName = PostProductsRequestBody{postProductsRequestBodyActive = GHC.Maybe.Nothing,
                                                                                ...
                                                                                postProductsRequestBodyMarketingFeatures = GHC.Maybe.Nothing,
...
data PostProductsRequestBodyDefaultPriceData' = PostProductsRequestBodyDefaultPriceData' {
  ...
  -- | custom_unit_amount
  , postProductsRequestBodyDefaultPriceData'CustomUnitAmount :: (GHC.Maybe.Maybe PostProductsRequestBodyDefaultPriceData'CustomUnitAmount')
  -- | metadata
  , postProductsRequestBodyDefaultPriceData'Metadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
  -- | recurring
...
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsRequestBodyDefaultPriceData'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsRequestBodyDefaultPriceData'" (\obj -> (((((((GHC.Base.pure PostProductsRequestBodyDefaultPriceData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "custom_unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal"))}
...
mkPostProductsRequestBodyDefaultPriceData' postProductsRequestBodyDefaultPriceData'Currency = PostProductsRequestBodyDefaultPriceData'{postProductsRequestBodyDefaultPriceData'Currency = postProductsRequestBodyDefaultPriceData'Currency,
                                                                                                                                       ...
                                                                                                                                       postProductsRequestBodyDefaultPriceData'CustomUnitAmount = GHC.Maybe.Nothing,
                                                                                                                                       postProductsRequestBodyDefaultPriceData'Metadata = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/products.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.default_price_data.properties.custom_unit_amount@ in the specification.
-- 
-- 
data PostProductsRequestBodyDefaultPriceData'CustomUnitAmount' = PostProductsRequestBodyDefaultPriceData'CustomUnitAmount' {
  -- | enabled
  postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled :: GHC.Types.Bool
  -- | maximum
  , postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Maximum :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | minimum
  , postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Minimum :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | preset
  , postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Preset :: (GHC.Maybe.Maybe GHC.Types.Int)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Maximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Minimum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preset" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Preset obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Maximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Minimum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preset" Data.Aeson.Types.ToJSON..=)) (postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Preset obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'" (\obj -> (((GHC.Base.pure PostProductsRequestBodyDefaultPriceData'CustomUnitAmount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preset"))}
-- | Create a new 'PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'' with all required fields.
mkPostProductsRequestBodyDefaultPriceData'CustomUnitAmount' :: GHC.Types.Bool -- ^ 'postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled'
  -> PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'
mkPostProductsRequestBodyDefaultPriceData'CustomUnitAmount' postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled = PostProductsRequestBodyDefaultPriceData'CustomUnitAmount'{postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled = postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Enabled,
                                                                                                                                                                                         postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Maximum = GHC.Maybe.Nothing,
                                                                                                                                                                                         postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Minimum = GHC.Maybe.Nothing,
                                                                                                                                                                                         postProductsRequestBodyDefaultPriceData'CustomUnitAmount'Preset = GHC.Maybe.Nothing}
...
-- | Defines the object schema located at @paths.\/v1\/products.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.marketing_features.items@ in the specification.
-- 
-- 
data PostProductsRequestBodyMarketingFeatures' = PostProductsRequestBodyMarketingFeatures' {
  -- | name
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postProductsRequestBodyMarketingFeatures'Name :: Data.Text.Internal.Text
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsRequestBodyMarketingFeatures'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsRequestBodyMarketingFeatures'Name obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsRequestBodyMarketingFeatures'Name obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsRequestBodyMarketingFeatures'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsRequestBodyMarketingFeatures'" (\obj -> GHC.Base.pure PostProductsRequestBodyMarketingFeatures' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name"))}
-- | Create a new 'PostProductsRequestBodyMarketingFeatures'' with all required fields.
mkPostProductsRequestBodyMarketingFeatures' :: Data.Text.Internal.Text -- ^ 'postProductsRequestBodyMarketingFeatures'Name'
  -> PostProductsRequestBodyMarketingFeatures'
mkPostProductsRequestBodyMarketingFeatures' postProductsRequestBodyMarketingFeatures'Name = PostProductsRequestBodyMarketingFeatures'{postProductsRequestBodyMarketingFeatures'Name = postProductsRequestBodyMarketingFeatures'Name}
