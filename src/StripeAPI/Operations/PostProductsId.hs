...
postProductsId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostProductsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostProductsIdResponse) -- ^ Monadic computation which returns the result of the operation
postProductsId id
               body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostProductsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostProductsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                      Product)
                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostProductsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                        Error)
...
data PostProductsIdRequestBody = PostProductsIdRequestBody {
  ...
  , postProductsIdRequestBodyMarketingFeatures :: (GHC.Maybe.Maybe PostProductsIdRequestBodyMarketingFeatures'Variants)
...
mkPostProductsIdRequestBody = PostProductsIdRequestBody{postProductsIdRequestBodyActive = GHC.Maybe.Nothing,
                                                        ...
                                                        postProductsIdRequestBodyMarketingFeatures = GHC.Maybe.Nothing,
...
data PostProductsIdRequestBodyDescription'Variants =
   PostProductsIdRequestBodyDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostProductsIdRequestBodyDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyDescription'Variants
    where {toJSON (PostProductsIdRequestBodyDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyDescription'EmptyString
...
data PostProductsIdRequestBodyImages'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyImages'Variants
    where {toJSON (PostProductsIdRequestBodyImages'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyImages'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyImages'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyImages'EmptyString
                              | GHC.Base.otherwise -> case (PostProductsIdRequestBodyImages'ListTText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/products\/{id}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.marketing_features.anyOf.items@ in the specification.
-- 
-- 
data PostProductsIdRequestBodyMarketingFeatures'OneOf1 = PostProductsIdRequestBodyMarketingFeatures'OneOf1 {
  -- | name
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postProductsIdRequestBodyMarketingFeatures'OneOf1Name :: Data.Text.Internal.Text
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyMarketingFeatures'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyMarketingFeatures'OneOf1Name obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["name" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyMarketingFeatures'OneOf1Name obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyMarketingFeatures'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostProductsIdRequestBodyMarketingFeatures'OneOf1" (\obj -> GHC.Base.pure PostProductsIdRequestBodyMarketingFeatures'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name"))}
-- | Create a new 'PostProductsIdRequestBodyMarketingFeatures'OneOf1' with all required fields.
mkPostProductsIdRequestBodyMarketingFeatures'OneOf1 :: Data.Text.Internal.Text -- ^ 'postProductsIdRequestBodyMarketingFeatures'OneOf1Name'
  -> PostProductsIdRequestBodyMarketingFeatures'OneOf1
mkPostProductsIdRequestBodyMarketingFeatures'OneOf1 postProductsIdRequestBodyMarketingFeatures'OneOf1Name = PostProductsIdRequestBodyMarketingFeatures'OneOf1{postProductsIdRequestBodyMarketingFeatures'OneOf1Name = postProductsIdRequestBodyMarketingFeatures'OneOf1Name}
-- | Defines the oneOf schema located at @paths.\/v1\/products\/{id}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.marketing_features.anyOf@ in the specification.
-- 
-- A list of up to 15 marketing features for this product. These are displayed in [pricing tables](https:\/\/stripe.com\/docs\/payments\/checkout\/pricing-table).
data PostProductsIdRequestBodyMarketingFeatures'Variants =
   PostProductsIdRequestBodyMarketingFeatures'EmptyString -- ^ Represents the JSON value @""@
  | PostProductsIdRequestBodyMarketingFeatures'ListTPostProductsIdRequestBodyMarketingFeatures'OneOf1 [PostProductsIdRequestBodyMarketingFeatures'OneOf1]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyMarketingFeatures'Variants
    where {toJSON (PostProductsIdRequestBodyMarketingFeatures'ListTPostProductsIdRequestBodyMarketingFeatures'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyMarketingFeatures'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyMarketingFeatures'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyMarketingFeatures'EmptyString
                              | GHC.Base.otherwise -> case (PostProductsIdRequestBodyMarketingFeatures'ListTPostProductsIdRequestBodyMarketingFeatures'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostProductsIdRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyMetadata'Variants
    where {toJSON (PostProductsIdRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyMetadata'EmptyString
...
data PostProductsIdRequestBodyPackageDimensions'OneOf1 = PostProductsIdRequestBodyPackageDimensions'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyPackageDimensions'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["height" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyPackageDimensions'OneOf1Height obj] : ["length" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyPackageDimensions'OneOf1Length obj] : ["weight" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyPackageDimensions'OneOf1Weight obj] : ["width" Data.Aeson.Types.ToJSON..= postProductsIdRequestBodyPackageDimensions'OneOf1Width obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyPackageDimensions'OneOf1
...
mkPostProductsIdRequestBodyPackageDimensions'OneOf1 :: GHC.Types.Double -- ^ 'postProductsIdRequestBodyPackageDimensions'OneOf1Height'
  -> GHC.Types.Double -- ^ 'postProductsIdRequestBodyPackageDimensions'OneOf1Length'
  -> GHC.Types.Double -- ^ 'postProductsIdRequestBodyPackageDimensions'OneOf1Weight'
  -> GHC.Types.Double -- ^ 'postProductsIdRequestBodyPackageDimensions'OneOf1Width'
  -> PostProductsIdRequestBodyPackageDimensions'OneOf1
mkPostProductsIdRequestBodyPackageDimensions'OneOf1 postProductsIdRequestBodyPackageDimensions'OneOf1Height postProductsIdRequestBodyPackageDimensions'OneOf1Length postProductsIdRequestBodyPackageDimensions'OneOf1Weight postProductsIdRequestBodyPackageDimensions'OneOf1Width = PostProductsIdRequestBodyPackageDimensions'OneOf1{postProductsIdRequestBodyPackageDimensions'OneOf1Height = postProductsIdRequestBodyPackageDimensions'OneOf1Height,
...
data PostProductsIdRequestBodyPackageDimensions'Variants =
   PostProductsIdRequestBodyPackageDimensions'EmptyString -- ^ Represents the JSON value @""@
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyPackageDimensions'Variants
    where {toJSON (PostProductsIdRequestBodyPackageDimensions'PostProductsIdRequestBodyPackageDimensions'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyPackageDimensions'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyPackageDimensions'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyPackageDimensions'EmptyString
...
data PostProductsIdRequestBodyTaxCode'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyTaxCode'Variants
    where {toJSON (PostProductsIdRequestBodyTaxCode'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyTaxCode'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyTaxCode'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyTaxCode'EmptyString
...
data PostProductsIdRequestBodyUnitLabel'Variants =
   PostProductsIdRequestBodyUnitLabel'EmptyString -- ^ Represents the JSON value @""@
  | PostProductsIdRequestBodyUnitLabel'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyUnitLabel'Variants
    where {toJSON (PostProductsIdRequestBodyUnitLabel'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyUnitLabel'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyUnitLabel'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyUnitLabel'EmptyString
...
data PostProductsIdRequestBodyUrl'Variants =
   PostProductsIdRequestBodyUrl'EmptyString -- ^ Represents the JSON value @""@
  | PostProductsIdRequestBodyUrl'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostProductsIdRequestBodyUrl'Variants
    where {toJSON (PostProductsIdRequestBodyUrl'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostProductsIdRequestBodyUrl'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostProductsIdRequestBodyUrl'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostProductsIdRequestBodyUrl'EmptyString
