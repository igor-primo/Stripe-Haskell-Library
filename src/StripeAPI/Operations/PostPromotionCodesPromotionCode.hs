...
postPromotionCodesPromotionCode :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ promotion_code | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostPromotionCodesPromotionCodeRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostPromotionCodesPromotionCodeResponse) -- ^ Monadic computation which returns the result of the operation
postPromotionCodesPromotionCode promotionCode
                                body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostPromotionCodesPromotionCodeResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostPromotionCodesPromotionCodeResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                         PromotionCode)
                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostPromotionCodesPromotionCodeResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                           Error)
...
data PostPromotionCodesPromotionCodeRequestBody = PostPromotionCodesPromotionCodeRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPromotionCodesPromotionCodeRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPromotionCodesPromotionCodeRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPromotionCodesPromotionCodeRequestBody" (\obj -> (((GHC.Base.pure PostPromotionCodesPromotionCodeRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "restrictions"))}
...
mkPostPromotionCodesPromotionCodeRequestBody = PostPromotionCodesPromotionCodeRequestBody{postPromotionCodesPromotionCodeRequestBodyActive = GHC.Maybe.Nothing,
...
data PostPromotionCodesPromotionCodeRequestBodyMetadata'Variants =
   PostPromotionCodesPromotionCodeRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostPromotionCodesPromotionCodeRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPromotionCodesPromotionCodeRequestBodyMetadata'Variants
    where {toJSON (PostPromotionCodesPromotionCodeRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostPromotionCodesPromotionCodeRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostPromotionCodesPromotionCodeRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostPromotionCodesPromotionCodeRequestBodyMetadata'EmptyString
...
data PostPromotionCodesPromotionCodeRequestBodyRestrictions' = PostPromotionCodesPromotionCodeRequestBodyRestrictions' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostPromotionCodesPromotionCodeRequestBodyRestrictions'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency_options" Data.Aeson.Types.ToJSON..=)) (postPromotionCodesPromotionCodeRequestBodyRestrictions'CurrencyOptions obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostPromotionCodesPromotionCodeRequestBodyRestrictions'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostPromotionCodesPromotionCodeRequestBodyRestrictions'" (\obj -> GHC.Base.pure PostPromotionCodesPromotionCodeRequestBodyRestrictions' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options"))}
...
data PostPromotionCodesPromotionCodeResponse =
   PostPromotionCodesPromotionCodeResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostPromotionCodesPromotionCodeResponse200 PromotionCode -- ^ Successful response.
  | PostPromotionCodesPromotionCodeResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
