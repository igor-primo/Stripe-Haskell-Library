...
postQuotes body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostQuotesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostQuotesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                          Quote)
                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostQuotesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/quotes" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostQuotesRequestBodyAutomaticTax' = PostQuotesRequestBodyAutomaticTax' {
  ...
  -- | liability
  , postQuotesRequestBodyAutomaticTax'Liability :: (GHC.Maybe.Maybe PostQuotesRequestBodyAutomaticTax'Liability')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyAutomaticTax'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyAutomaticTax'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyAutomaticTax'Liability obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyAutomaticTax'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyAutomaticTax'Liability obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyAutomaticTax'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyAutomaticTax'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyAutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability"))}
...
mkPostQuotesRequestBodyAutomaticTax' postQuotesRequestBodyAutomaticTax'Enabled = PostQuotesRequestBodyAutomaticTax'{postQuotesRequestBodyAutomaticTax'Enabled = postQuotesRequestBodyAutomaticTax'Enabled,
                                                                                                                    postQuotesRequestBodyAutomaticTax'Liability = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.automatic_tax.properties.liability@ in the specification.
-- 
-- 
data PostQuotesRequestBodyAutomaticTax'Liability' = PostQuotesRequestBodyAutomaticTax'Liability' {
  -- | account
  postQuotesRequestBodyAutomaticTax'Liability'Account :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | type
  , postQuotesRequestBodyAutomaticTax'Liability'Type :: PostQuotesRequestBodyAutomaticTax'Liability'Type'
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyAutomaticTax'Liability'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyAutomaticTax'Liability'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyAutomaticTax'Liability'Type obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyAutomaticTax'Liability'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyAutomaticTax'Liability'Type obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyAutomaticTax'Liability'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyAutomaticTax'Liability'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyAutomaticTax'Liability' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostQuotesRequestBodyAutomaticTax'Liability'' with all required fields.
mkPostQuotesRequestBodyAutomaticTax'Liability' :: PostQuotesRequestBodyAutomaticTax'Liability'Type' -- ^ 'postQuotesRequestBodyAutomaticTax'Liability'Type'
  -> PostQuotesRequestBodyAutomaticTax'Liability'
mkPostQuotesRequestBodyAutomaticTax'Liability' postQuotesRequestBodyAutomaticTax'Liability'Type = PostQuotesRequestBodyAutomaticTax'Liability'{postQuotesRequestBodyAutomaticTax'Liability'Account = GHC.Maybe.Nothing,
                                                                                                                                               postQuotesRequestBodyAutomaticTax'Liability'Type = postQuotesRequestBodyAutomaticTax'Liability'Type}
-- | Defines the enum schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.automatic_tax.properties.liability.properties.type@ in the specification.
-- 
-- 
data PostQuotesRequestBodyAutomaticTax'Liability'Type' =
   PostQuotesRequestBodyAutomaticTax'Liability'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostQuotesRequestBodyAutomaticTax'Liability'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumAccount -- ^ Represents the JSON value @"account"@
  | PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumSelf -- ^ Represents the JSON value @"self"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyAutomaticTax'Liability'Type'
    where {toJSON (PostQuotesRequestBodyAutomaticTax'Liability'Type'Other val) = val;
           toJSON (PostQuotesRequestBodyAutomaticTax'Liability'Type'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumAccount) = "account";
           toJSON (PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumSelf) = "self"}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyAutomaticTax'Liability'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumAccount
                                             | val GHC.Classes.== "self" -> PostQuotesRequestBodyAutomaticTax'Liability'Type'EnumSelf
                                             | GHC.Base.otherwise -> PostQuotesRequestBodyAutomaticTax'Liability'Type'Other val)}
...
data PostQuotesRequestBodyDescription'Variants =
   PostQuotesRequestBodyDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesRequestBodyDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyDescription'Variants
    where {toJSON (PostQuotesRequestBodyDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesRequestBodyDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesRequestBodyDescription'EmptyString
...
data PostQuotesRequestBodyDiscounts'OneOf1 = PostQuotesRequestBodyDiscounts'OneOf1 {
  ...
  -- 
  -- * Maximum length of 5000
  , postQuotesRequestBodyDiscounts'OneOf1PromotionCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyDiscounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1PromotionCode obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyDiscounts'OneOf1PromotionCode obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyDiscounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyDiscounts'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesRequestBodyDiscounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
...
mkPostQuotesRequestBodyDiscounts'OneOf1 = PostQuotesRequestBodyDiscounts'OneOf1{postQuotesRequestBodyDiscounts'OneOf1Coupon = GHC.Maybe.Nothing,
                                                                                ...
                                                                                postQuotesRequestBodyDiscounts'OneOf1PromotionCode = GHC.Maybe.Nothing}
...
data PostQuotesRequestBodyFooter'Variants =
   PostQuotesRequestBodyFooter'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesRequestBodyFooter'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyFooter'Variants
    where {toJSON (PostQuotesRequestBodyFooter'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesRequestBodyFooter'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyFooter'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesRequestBodyFooter'EmptyString
...
data PostQuotesRequestBodyHeader'Variants =
   PostQuotesRequestBodyHeader'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesRequestBodyHeader'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyHeader'Variants
    where {toJSON (PostQuotesRequestBodyHeader'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesRequestBodyHeader'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyHeader'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesRequestBodyHeader'EmptyString
...
data PostQuotesRequestBodyInvoiceSettings' = PostQuotesRequestBodyInvoiceSettings' {
  ...
  -- | issuer
  , postQuotesRequestBodyInvoiceSettings'Issuer :: (GHC.Maybe.Maybe PostQuotesRequestBodyInvoiceSettings'Issuer')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyInvoiceSettings'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'DaysUntilDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'DaysUntilDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyInvoiceSettings'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyInvoiceSettings'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyInvoiceSettings' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "days_until_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "issuer"))}
...
mkPostQuotesRequestBodyInvoiceSettings' = PostQuotesRequestBodyInvoiceSettings'{postQuotesRequestBodyInvoiceSettings'DaysUntilDue = GHC.Maybe.Nothing,
                                                                                postQuotesRequestBodyInvoiceSettings'Issuer = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.invoice_settings.properties.issuer@ in the specification.
-- 
-- 
data PostQuotesRequestBodyInvoiceSettings'Issuer' = PostQuotesRequestBodyInvoiceSettings'Issuer' {
  -- | account
  postQuotesRequestBodyInvoiceSettings'Issuer'Account :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | type
  , postQuotesRequestBodyInvoiceSettings'Issuer'Type :: PostQuotesRequestBodyInvoiceSettings'Issuer'Type'
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyInvoiceSettings'Issuer'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'Issuer'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyInvoiceSettings'Issuer'Type obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyInvoiceSettings'Issuer'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodyInvoiceSettings'Issuer'Type obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyInvoiceSettings'Issuer'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyInvoiceSettings'Issuer'" (\obj -> (GHC.Base.pure PostQuotesRequestBodyInvoiceSettings'Issuer' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostQuotesRequestBodyInvoiceSettings'Issuer'' with all required fields.
mkPostQuotesRequestBodyInvoiceSettings'Issuer' :: PostQuotesRequestBodyInvoiceSettings'Issuer'Type' -- ^ 'postQuotesRequestBodyInvoiceSettings'Issuer'Type'
  -> PostQuotesRequestBodyInvoiceSettings'Issuer'
mkPostQuotesRequestBodyInvoiceSettings'Issuer' postQuotesRequestBodyInvoiceSettings'Issuer'Type = PostQuotesRequestBodyInvoiceSettings'Issuer'{postQuotesRequestBodyInvoiceSettings'Issuer'Account = GHC.Maybe.Nothing,
                                                                                                                                               postQuotesRequestBodyInvoiceSettings'Issuer'Type = postQuotesRequestBodyInvoiceSettings'Issuer'Type}
-- | Defines the enum schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.invoice_settings.properties.issuer.properties.type@ in the specification.
-- 
-- 
data PostQuotesRequestBodyInvoiceSettings'Issuer'Type' =
   PostQuotesRequestBodyInvoiceSettings'Issuer'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostQuotesRequestBodyInvoiceSettings'Issuer'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumAccount -- ^ Represents the JSON value @"account"@
  | PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumSelf -- ^ Represents the JSON value @"self"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyInvoiceSettings'Issuer'Type'
    where {toJSON (PostQuotesRequestBodyInvoiceSettings'Issuer'Type'Other val) = val;
           toJSON (PostQuotesRequestBodyInvoiceSettings'Issuer'Type'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumAccount) = "account";
           toJSON (PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumSelf) = "self"}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyInvoiceSettings'Issuer'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumAccount
                                             | val GHC.Classes.== "self" -> PostQuotesRequestBodyInvoiceSettings'Issuer'Type'EnumSelf
                                             | GHC.Base.otherwise -> PostQuotesRequestBodyInvoiceSettings'Issuer'Type'Other val)}
...
data PostQuotesRequestBodyLineItems' = PostQuotesRequestBodyLineItems' {
  -- | discounts
  postQuotesRequestBodyLineItems'Discounts :: (GHC.Maybe.Maybe PostQuotesRequestBodyLineItems'Discounts'Variants)
  -- | price
  -- 
  -- Constraints:
  -- 
...
mkPostQuotesRequestBodyLineItems' = PostQuotesRequestBodyLineItems'{postQuotesRequestBodyLineItems'Discounts = GHC.Maybe.Nothing,
                                                                    postQuotesRequestBodyLineItems'Price = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.line_items.items.properties.discounts.anyOf.items@ in the specification.
-- 
-- 
data PostQuotesRequestBodyLineItems'Discounts'OneOf1 = PostQuotesRequestBodyLineItems'Discounts'OneOf1 {
  -- | coupon
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postQuotesRequestBodyLineItems'Discounts'OneOf1Coupon :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | discount
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postQuotesRequestBodyLineItems'Discounts'OneOf1Discount :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | promotion_code
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postQuotesRequestBodyLineItems'Discounts'OneOf1PromotionCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'Discounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1PromotionCode obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesRequestBodyLineItems'Discounts'OneOf1PromotionCode obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'Discounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodyLineItems'Discounts'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesRequestBodyLineItems'Discounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
-- | Create a new 'PostQuotesRequestBodyLineItems'Discounts'OneOf1' with all required fields.
mkPostQuotesRequestBodyLineItems'Discounts'OneOf1 :: PostQuotesRequestBodyLineItems'Discounts'OneOf1
mkPostQuotesRequestBodyLineItems'Discounts'OneOf1 = PostQuotesRequestBodyLineItems'Discounts'OneOf1{postQuotesRequestBodyLineItems'Discounts'OneOf1Coupon = GHC.Maybe.Nothing,
                                                                                                    postQuotesRequestBodyLineItems'Discounts'OneOf1Discount = GHC.Maybe.Nothing,
                                                                                                    postQuotesRequestBodyLineItems'Discounts'OneOf1PromotionCode = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.line_items.items.properties.discounts.anyOf@ in the specification.
-- 
-- 
data PostQuotesRequestBodyLineItems'Discounts'Variants =
   PostQuotesRequestBodyLineItems'Discounts'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesRequestBodyLineItems'Discounts'ListTPostQuotesRequestBodyLineItems'Discounts'OneOf1 [PostQuotesRequestBodyLineItems'Discounts'OneOf1]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodyLineItems'Discounts'Variants
    where {toJSON (PostQuotesRequestBodyLineItems'Discounts'ListTPostQuotesRequestBodyLineItems'Discounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesRequestBodyLineItems'Discounts'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodyLineItems'Discounts'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesRequestBodyLineItems'Discounts'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesRequestBodyLineItems'Discounts'ListTPostQuotesRequestBodyLineItems'Discounts'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostQuotesRequestBodySubscriptionData' = PostQuotesRequestBodySubscriptionData' {
  -- | billing_mode
  postQuotesRequestBodySubscriptionData'BillingMode :: (GHC.Maybe.Maybe PostQuotesRequestBodySubscriptionData'BillingMode')
  -- | description
  -- 
  -- Constraints:
  -- 
...
mkPostQuotesRequestBodySubscriptionData' = PostQuotesRequestBodySubscriptionData'{postQuotesRequestBodySubscriptionData'BillingMode = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.subscription_data.properties.billing_mode@ in the specification.
-- 
-- 
data PostQuotesRequestBodySubscriptionData'BillingMode' = PostQuotesRequestBodySubscriptionData'BillingMode' {
  -- | type
  postQuotesRequestBodySubscriptionData'BillingMode'Type :: PostQuotesRequestBodySubscriptionData'BillingMode'Type'
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodySubscriptionData'BillingMode'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodySubscriptionData'BillingMode'Type obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["type" Data.Aeson.Types.ToJSON..= postQuotesRequestBodySubscriptionData'BillingMode'Type obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodySubscriptionData'BillingMode'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesRequestBodySubscriptionData'BillingMode'" (\obj -> GHC.Base.pure PostQuotesRequestBodySubscriptionData'BillingMode' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostQuotesRequestBodySubscriptionData'BillingMode'' with all required fields.
mkPostQuotesRequestBodySubscriptionData'BillingMode' :: PostQuotesRequestBodySubscriptionData'BillingMode'Type' -- ^ 'postQuotesRequestBodySubscriptionData'BillingMode'Type'
  -> PostQuotesRequestBodySubscriptionData'BillingMode'
mkPostQuotesRequestBodySubscriptionData'BillingMode' postQuotesRequestBodySubscriptionData'BillingMode'Type = PostQuotesRequestBodySubscriptionData'BillingMode'{postQuotesRequestBodySubscriptionData'BillingMode'Type = postQuotesRequestBodySubscriptionData'BillingMode'Type}
-- | Defines the enum schema located at @paths.\/v1\/quotes.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.subscription_data.properties.billing_mode.properties.type@ in the specification.
-- 
-- 
data PostQuotesRequestBodySubscriptionData'BillingMode'Type' =
   PostQuotesRequestBodySubscriptionData'BillingMode'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostQuotesRequestBodySubscriptionData'BillingMode'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumClassic -- ^ Represents the JSON value @"classic"@
  | PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumFlexible -- ^ Represents the JSON value @"flexible"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesRequestBodySubscriptionData'BillingMode'Type'
    where {toJSON (PostQuotesRequestBodySubscriptionData'BillingMode'Type'Other val) = val;
           toJSON (PostQuotesRequestBodySubscriptionData'BillingMode'Type'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumClassic) = "classic";
           toJSON (PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumFlexible) = "flexible"}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesRequestBodySubscriptionData'BillingMode'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "classic" -> PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumClassic
                                             | val GHC.Classes.== "flexible" -> PostQuotesRequestBodySubscriptionData'BillingMode'Type'EnumFlexible
                                             | GHC.Base.otherwise -> PostQuotesRequestBodySubscriptionData'BillingMode'Type'Other val)}
