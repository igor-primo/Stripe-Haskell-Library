...
postQuotesQuote quote
                body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostQuotesQuoteResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostQuotesQuoteResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                         Quote)
                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostQuotesQuoteResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") ("/v1/quotes/" GHC.Base.<> (StripeAPI.Common.byteToText (Network.HTTP.Types.URI.urlEncode GHC.Types.True GHC.Base.$ (StripeAPI.Common.textToByte GHC.Base.$ StripeAPI.Common.stringifyModel quote)) GHC.Base.<> "")) GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostQuotesQuoteRequestBody = PostQuotesQuoteRequestBody {
  ...
  , postQuotesQuoteRequestBodyDescription :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyDescription'Variants)
  ...
  , postQuotesQuoteRequestBodyFooter :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyFooter'Variants)
  -- | header: A header that will be displayed on the quote PDF.
  , postQuotesQuoteRequestBodyHeader :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyHeader'Variants)
...
data PostQuotesQuoteRequestBodyAutomaticTax' = PostQuotesQuoteRequestBodyAutomaticTax' {
  ...
  -- | liability
  , postQuotesQuoteRequestBodyAutomaticTax'Liability :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyAutomaticTax'Liability')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyAutomaticTax'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyAutomaticTax'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyAutomaticTax'Liability obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyAutomaticTax'Enabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("liability" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyAutomaticTax'Liability obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyAutomaticTax'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyAutomaticTax'" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyAutomaticTax' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability"))}
...
mkPostQuotesQuoteRequestBodyAutomaticTax' postQuotesQuoteRequestBodyAutomaticTax'Enabled = PostQuotesQuoteRequestBodyAutomaticTax'{postQuotesQuoteRequestBodyAutomaticTax'Enabled = postQuotesQuoteRequestBodyAutomaticTax'Enabled,
                                                                                                                                   postQuotesQuoteRequestBodyAutomaticTax'Liability = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.automatic_tax.properties.liability@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyAutomaticTax'Liability' = PostQuotesQuoteRequestBodyAutomaticTax'Liability' {
  -- | account
  postQuotesQuoteRequestBodyAutomaticTax'Liability'Account :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | type
  , postQuotesQuoteRequestBodyAutomaticTax'Liability'Type :: PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyAutomaticTax'Liability'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyAutomaticTax'Liability'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyAutomaticTax'Liability'Type obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyAutomaticTax'Liability'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyAutomaticTax'Liability'Type obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyAutomaticTax'Liability'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyAutomaticTax'Liability'" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyAutomaticTax'Liability' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostQuotesQuoteRequestBodyAutomaticTax'Liability'' with all required fields.
mkPostQuotesQuoteRequestBodyAutomaticTax'Liability' :: PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type' -- ^ 'postQuotesQuoteRequestBodyAutomaticTax'Liability'Type'
  -> PostQuotesQuoteRequestBodyAutomaticTax'Liability'
mkPostQuotesQuoteRequestBodyAutomaticTax'Liability' postQuotesQuoteRequestBodyAutomaticTax'Liability'Type = PostQuotesQuoteRequestBodyAutomaticTax'Liability'{postQuotesQuoteRequestBodyAutomaticTax'Liability'Account = GHC.Maybe.Nothing,
                                                                                                                                                              postQuotesQuoteRequestBodyAutomaticTax'Liability'Type = postQuotesQuoteRequestBodyAutomaticTax'Liability'Type}
-- | Defines the enum schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.automatic_tax.properties.liability.properties.type@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type' =
   PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumAccount -- ^ Represents the JSON value @"account"@
  | PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumSelf -- ^ Represents the JSON value @"self"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'
    where {toJSON (PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'Other val) = val;
           toJSON (PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumAccount) = "account";
           toJSON (PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumSelf) = "self"}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumAccount
                                             | val GHC.Classes.== "self" -> PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'EnumSelf
                                             | GHC.Base.otherwise -> PostQuotesQuoteRequestBodyAutomaticTax'Liability'Type'Other val)}
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDefaultTaxRates'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyDefaultTaxRates'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyDefaultTaxRates'ListTText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.description.anyOf@ in the specification.
-- 
-- A description that will be displayed on the quote PDF.
data PostQuotesQuoteRequestBodyDescription'Variants =
   PostQuotesQuoteRequestBodyDescription'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesQuoteRequestBodyDescription'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDescription'Variants
    where {toJSON (PostQuotesQuoteRequestBodyDescription'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesQuoteRequestBodyDescription'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDescription'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyDescription'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyDescription'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostQuotesQuoteRequestBodyDiscounts'OneOf1 = PostQuotesQuoteRequestBodyDiscounts'OneOf1 {
  ...
  -- 
  -- * Maximum length of 5000
  , postQuotesQuoteRequestBodyDiscounts'OneOf1PromotionCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyDiscounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1PromotionCode obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyDiscounts'OneOf1PromotionCode obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDiscounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyDiscounts'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesQuoteRequestBodyDiscounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
...
mkPostQuotesQuoteRequestBodyDiscounts'OneOf1 = PostQuotesQuoteRequestBodyDiscounts'OneOf1{postQuotesQuoteRequestBodyDiscounts'OneOf1Coupon = GHC.Maybe.Nothing,
                                                                                          ...
                                                                                          postQuotesQuoteRequestBodyDiscounts'OneOf1PromotionCode = GHC.Maybe.Nothing}
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyDiscounts'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyDiscounts'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyDiscounts'ListTPostQuotesQuoteRequestBodyDiscounts'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.footer.anyOf@ in the specification.
-- 
-- A footer that will be displayed on the quote PDF.
data PostQuotesQuoteRequestBodyFooter'Variants =
   PostQuotesQuoteRequestBodyFooter'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesQuoteRequestBodyFooter'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyFooter'Variants
    where {toJSON (PostQuotesQuoteRequestBodyFooter'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesQuoteRequestBodyFooter'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyFooter'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyFooter'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyFooter'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.header.anyOf@ in the specification.
-- 
-- A header that will be displayed on the quote PDF.
data PostQuotesQuoteRequestBodyHeader'Variants =
   PostQuotesQuoteRequestBodyHeader'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesQuoteRequestBodyHeader'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyHeader'Variants
    where {toJSON (PostQuotesQuoteRequestBodyHeader'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesQuoteRequestBodyHeader'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyHeader'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyHeader'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyHeader'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostQuotesQuoteRequestBodyInvoiceSettings' = PostQuotesQuoteRequestBodyInvoiceSettings' {
  ...
  -- | issuer
  , postQuotesQuoteRequestBodyInvoiceSettings'Issuer :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyInvoiceSettings'Issuer')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyInvoiceSettings'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'DaysUntilDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("days_until_due" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'DaysUntilDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuer" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'Issuer obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyInvoiceSettings'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyInvoiceSettings'" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyInvoiceSettings' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "days_until_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "issuer"))}
...
mkPostQuotesQuoteRequestBodyInvoiceSettings' = PostQuotesQuoteRequestBodyInvoiceSettings'{postQuotesQuoteRequestBodyInvoiceSettings'DaysUntilDue = GHC.Maybe.Nothing,
                                                                                          postQuotesQuoteRequestBodyInvoiceSettings'Issuer = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.invoice_settings.properties.issuer@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyInvoiceSettings'Issuer' = PostQuotesQuoteRequestBodyInvoiceSettings'Issuer' {
  -- | account
  postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Account :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | type
  , postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type :: PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Account obj) : ["type" Data.Aeson.Types.ToJSON..= postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'" (\obj -> (GHC.Base.pure PostQuotesQuoteRequestBodyInvoiceSettings'Issuer' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'' with all required fields.
mkPostQuotesQuoteRequestBodyInvoiceSettings'Issuer' :: PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type' -- ^ 'postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'
  -> PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'
mkPostQuotesQuoteRequestBodyInvoiceSettings'Issuer' postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type = PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'{postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Account = GHC.Maybe.Nothing,
                                                                                                                                                              postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type = postQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type}
-- | Defines the enum schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.invoice_settings.properties.issuer.properties.type@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type' =
   PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumAccount -- ^ Represents the JSON value @"account"@
  | PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumSelf -- ^ Represents the JSON value @"self"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'
    where {toJSON (PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'Other val) = val;
           toJSON (PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumAccount) = "account";
           toJSON (PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumSelf) = "self"}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumAccount
                                             | val GHC.Classes.== "self" -> PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'EnumSelf
                                             | GHC.Base.otherwise -> PostQuotesQuoteRequestBodyInvoiceSettings'Issuer'Type'Other val)}
...
data PostQuotesQuoteRequestBodyLineItems' = PostQuotesQuoteRequestBodyLineItems' {
  -- | discounts
  postQuotesQuoteRequestBodyLineItems'Discounts :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodyLineItems'Discounts'Variants)
  -- | id
  -- 
  -- Constraints:
  -- 
...
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyLineItems'" (\obj -> (((((GHC.Base.pure PostQuotesQuoteRequestBodyLineItems' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price_data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rates"))}
...
mkPostQuotesQuoteRequestBodyLineItems' = PostQuotesQuoteRequestBodyLineItems'{postQuotesQuoteRequestBodyLineItems'Discounts = GHC.Maybe.Nothing,
                                                                              postQuotesQuoteRequestBodyLineItems'Id = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.line_items.items.properties.discounts.anyOf.items@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 = PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 {
  -- | coupon
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Coupon :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | discount
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Discount :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | promotion_code
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1PromotionCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1PromotionCode obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Coupon obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("discount" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Discount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("promotion_code" Data.Aeson.Types.ToJSON..=)) (postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1PromotionCode obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1" (\obj -> ((GHC.Base.pure PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
-- | Create a new 'PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1' with all required fields.
mkPostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 :: PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1
mkPostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 = PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1{postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Coupon = GHC.Maybe.Nothing,
                                                                                                              postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1Discount = GHC.Maybe.Nothing,
                                                                                                              postQuotesQuoteRequestBodyLineItems'Discounts'OneOf1PromotionCode = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.line_items.items.properties.discounts.anyOf@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodyLineItems'Discounts'Variants =
   PostQuotesQuoteRequestBodyLineItems'Discounts'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesQuoteRequestBodyLineItems'Discounts'ListTPostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 [PostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodyLineItems'Discounts'Variants
    where {toJSON (PostQuotesQuoteRequestBodyLineItems'Discounts'ListTPostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesQuoteRequestBodyLineItems'Discounts'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodyLineItems'Discounts'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodyLineItems'Discounts'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodyLineItems'Discounts'ListTPostQuotesQuoteRequestBodyLineItems'Discounts'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostQuotesQuoteRequestBodySubscriptionData' = PostQuotesQuoteRequestBodySubscriptionData' {
  -- | description
  postQuotesQuoteRequestBodySubscriptionData'Description :: (GHC.Maybe.Maybe PostQuotesQuoteRequestBodySubscriptionData'Description'Variants)
  -- | effective_date
  ...
  -- | metadata
  , postQuotesQuoteRequestBodySubscriptionData'Metadata :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
  -- | trial_period_days
...
mkPostQuotesQuoteRequestBodySubscriptionData' = PostQuotesQuoteRequestBodySubscriptionData'{postQuotesQuoteRequestBodySubscriptionData'Description = GHC.Maybe.Nothing,
                                                                                            postQuotesQuoteRequestBodySubscriptionData'EffectiveDate = GHC.Maybe.Nothing,
                                                                                            postQuotesQuoteRequestBodySubscriptionData'Metadata = GHC.Maybe.Nothing,
                                                                                            postQuotesQuoteRequestBodySubscriptionData'TrialPeriodDays = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/quotes\/{quote}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.subscription_data.properties.description.anyOf@ in the specification.
-- 
-- 
data PostQuotesQuoteRequestBodySubscriptionData'Description'Variants =
   PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString -- ^ Represents the JSON value @""@
  | PostQuotesQuoteRequestBodySubscriptionData'Description'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostQuotesQuoteRequestBodySubscriptionData'Description'Variants
    where {toJSON (PostQuotesQuoteRequestBodySubscriptionData'Description'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostQuotesQuoteRequestBodySubscriptionData'Description'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostQuotesQuoteRequestBodySubscriptionData'Description'EmptyString
                              | GHC.Base.otherwise -> case (PostQuotesQuoteRequestBodySubscriptionData'Description'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
