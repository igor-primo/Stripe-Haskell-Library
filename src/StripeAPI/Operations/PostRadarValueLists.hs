...
postRadarValueLists body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostRadarValueListsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostRadarValueListsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                     Radar'valueList)
                                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostRadarValueListsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                       Error)
                                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/radar/value_lists" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostRadarValueListsRequestBody = PostRadarValueListsRequestBody {
  ...
  -- | item_type: Type of the items in the value list. One of \`card_fingerprint\`, \`card_bin\`, \`email\`, \`ip_address\`, \`country\`, \`string\`, \`case_sensitive_string\`, \`customer_id\`, \`sepa_debit_fingerprint\`, or \`us_bank_account_fingerprint\`. Use \`string\` if the item type is unknown or mixed.
  -- 
  -- Constraints:
  -- 
...
data PostRadarValueListsRequestBodyItemType' =
  ...
  | PostRadarValueListsRequestBodyItemType'EnumSepaDebitFingerprint -- ^ Represents the JSON value @"sepa_debit_fingerprint"@
  | PostRadarValueListsRequestBodyItemType'EnumString -- ^ Represents the JSON value @"string"@
  | PostRadarValueListsRequestBodyItemType'EnumUsBankAccountFingerprint -- ^ Represents the JSON value @"us_bank_account_fingerprint"@
