...
postRadarValueListsValueList :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ value_list | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostRadarValueListsValueListRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostRadarValueListsValueListResponse) -- ^ Monadic computation which returns the result of the operation
postRadarValueListsValueList valueList
                             body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostRadarValueListsValueListResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostRadarValueListsValueListResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                Radar'valueList)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostRadarValueListsValueListResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data PostRadarValueListsValueListRequestBody = PostRadarValueListsValueListRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRadarValueListsValueListRequestBody
...
mkPostRadarValueListsValueListRequestBody = PostRadarValueListsValueListRequestBody{postRadarValueListsValueListRequestBodyAlias = GHC.Maybe.Nothing,
