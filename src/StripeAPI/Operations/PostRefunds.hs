...
postRefunds :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostRefundsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostRefundsResponse) -- ^ Monadic computation which returns the result of the operation
postRefunds body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostRefundsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostRefundsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                             Refund)
                                                                                                                                                         | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostRefundsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                               Error)
                                                                                                                                                         | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/refunds" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostRefundsRequestBody = PostRefundsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostRefundsRequestBody" (\obj -> (((((((((((GHC.Base.pure PostRefundsRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "charge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "instructions_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "origin")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_application_fee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reverse_transfer"))}
-- | Create a new 'PostRefundsRequestBody' with all required fields.
mkPostRefundsRequestBody :: PostRefundsRequestBody
mkPostRefundsRequestBody = PostRefundsRequestBody{postRefundsRequestBodyAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRequestBodyMetadata'Variants
    where {toJSON (PostRefundsRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostRefundsRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostRefundsRequestBodyMetadata'EmptyString
...
data PostRefundsRequestBodyOrigin' =
   PostRefundsRequestBodyOrigin'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostRefundsRequestBodyOrigin'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostRefundsRequestBodyOrigin'EnumCustomerBalance -- ^ Represents the JSON value @"customer_balance"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRequestBodyOrigin'
    where {toJSON (PostRefundsRequestBodyOrigin'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRequestBodyOrigin'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_balance" -> PostRefundsRequestBodyOrigin'EnumCustomerBalance
...
data PostRefundsRequestBodyReason' =
   PostRefundsRequestBodyReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostRefundsRequestBodyReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostRefundsRequestBodyReason'EnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | PostRefundsRequestBodyReason'EnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | PostRefundsRequestBodyReason'EnumRequestedByCustomer -- ^ Represents the JSON value @"requested_by_customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRequestBodyReason'
    where {toJSON (PostRefundsRequestBodyReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRequestBodyReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "duplicate" -> PostRefundsRequestBodyReason'EnumDuplicate
