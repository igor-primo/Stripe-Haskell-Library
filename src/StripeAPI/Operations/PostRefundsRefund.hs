...
postRefundsRefund :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ refund
  -> GHC.Maybe.Maybe PostRefundsRefundRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostRefundsRefundResponse) -- ^ Monadic computation which returns the result of the operation
postRefundsRefund refund
                  body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostRefundsRefundResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostRefundsRefundResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               Refund)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostRefundsRefundResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
...
data PostRefundsRefundRequestBody = PostRefundsRefundRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRefundRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRefundRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostRefundsRefundRequestBody" (\obj -> (GHC.Base.pure PostRefundsRefundRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata"))}
...
mkPostRefundsRefundRequestBody = PostRefundsRefundRequestBody{postRefundsRefundRequestBodyExpand = GHC.Maybe.Nothing,
...
data PostRefundsRefundRequestBodyMetadata'Variants =
   PostRefundsRefundRequestBodyMetadata'EmptyString -- ^ Represents the JSON value @""@
  | PostRefundsRefundRequestBodyMetadata'Object Data.Aeson.Types.Internal.Object
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostRefundsRefundRequestBodyMetadata'Variants
    where {toJSON (PostRefundsRefundRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostRefundsRefundRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostRefundsRefundRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostRefundsRefundRequestBodyMetadata'EmptyString
...
data PostRefundsRefundResponse =
   PostRefundsRefundResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
