...
postSetupIntentsIntentCancel :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ intent | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostSetupIntentsIntentCancelRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSetupIntentsIntentCancelResponse) -- ^ Monadic computation which returns the result of the operation
postSetupIntentsIntentCancel intent
                             body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetupIntentsIntentCancelResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetupIntentsIntentCancelResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                SetupIntent)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetupIntentsIntentCancelResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
...
data PostSetupIntentsIntentCancelRequestBody = PostSetupIntentsIntentCancelRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetupIntentsIntentCancelRequestBody
...
mkPostSetupIntentsIntentCancelRequestBody = PostSetupIntentsIntentCancelRequestBody{postSetupIntentsIntentCancelRequestBodyCancellationReason = GHC.Maybe.Nothing,
...
data PostSetupIntentsIntentCancelRequestBodyCancellationReason' =
   PostSetupIntentsIntentCancelRequestBodyCancellationReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostSetupIntentsIntentCancelRequestBodyCancellationReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostSetupIntentsIntentCancelRequestBodyCancellationReason'EnumAbandoned -- ^ Represents the JSON value @"abandoned"@
  | PostSetupIntentsIntentCancelRequestBodyCancellationReason'EnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | PostSetupIntentsIntentCancelRequestBodyCancellationReason'EnumRequestedByCustomer -- ^ Represents the JSON value @"requested_by_customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetupIntentsIntentCancelRequestBodyCancellationReason'
    where {toJSON (PostSetupIntentsIntentCancelRequestBodyCancellationReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostSetupIntentsIntentCancelRequestBodyCancellationReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "abandoned" -> PostSetupIntentsIntentCancelRequestBodyCancellationReason'EnumAbandoned
