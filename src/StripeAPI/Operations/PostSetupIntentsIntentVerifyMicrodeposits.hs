...
postSetupIntentsIntentVerifyMicrodeposits :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ intent | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostSetupIntentsIntentVerifyMicrodepositsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSetupIntentsIntentVerifyMicrodepositsResponse) -- ^ Monadic computation which returns the result of the operation
postSetupIntentsIntentVerifyMicrodeposits intent
                                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSetupIntentsIntentVerifyMicrodepositsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSetupIntentsIntentVerifyMicrodepositsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       SetupIntent)
                                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSetupIntentsIntentVerifyMicrodepositsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostSetupIntentsIntentVerifyMicrodepositsRequestBody = PostSetupIntentsIntentVerifyMicrodepositsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSetupIntentsIntentVerifyMicrodepositsRequestBody
...
mkPostSetupIntentsIntentVerifyMicrodepositsRequestBody = PostSetupIntentsIntentVerifyMicrodepositsRequestBody{postSetupIntentsIntentVerifyMicrodepositsRequestBodyAmounts = GHC.Maybe.Nothing,
...
data PostSetupIntentsIntentVerifyMicrodepositsResponse =
   PostSetupIntentsIntentVerifyMicrodepositsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostSetupIntentsIntentVerifyMicrodepositsResponse200 SetupIntent -- ^ Successful response.
  | PostSetupIntentsIntentVerifyMicrodepositsResponseDefault Error -- ^ Error response.
