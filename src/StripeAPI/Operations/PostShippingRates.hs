...
postShippingRates body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostShippingRatesResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostShippingRatesResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                               ShippingRate)
                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostShippingRatesResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                 Error)
                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/shipping_rates" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostShippingRatesRequestBodyFixedAmount' = PostShippingRatesRequestBodyFixedAmount' {
  ...
  -- | currency_options
  , postShippingRatesRequestBodyFixedAmount'CurrencyOptions :: (GHC.Maybe.Maybe Data.Aeson.Types.Internal.Object)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostShippingRatesRequestBodyFixedAmount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postShippingRatesRequestBodyFixedAmount'Amount obj] : ["currency" Data.Aeson.Types.ToJSON..= postShippingRatesRequestBodyFixedAmount'Currency obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency_options" Data.Aeson.Types.ToJSON..=)) (postShippingRatesRequestBodyFixedAmount'CurrencyOptions obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postShippingRatesRequestBodyFixedAmount'Amount obj] : ["currency" Data.Aeson.Types.ToJSON..= postShippingRatesRequestBodyFixedAmount'Currency obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency_options" Data.Aeson.Types.ToJSON..=)) (postShippingRatesRequestBodyFixedAmount'CurrencyOptions obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostShippingRatesRequestBodyFixedAmount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostShippingRatesRequestBodyFixedAmount'" (\obj -> ((GHC.Base.pure PostShippingRatesRequestBodyFixedAmount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options"))}
...
mkPostShippingRatesRequestBodyFixedAmount' postShippingRatesRequestBodyFixedAmount'Amount postShippingRatesRequestBodyFixedAmount'Currency = PostShippingRatesRequestBodyFixedAmount'{postShippingRatesRequestBodyFixedAmount'Amount = postShippingRatesRequestBodyFixedAmount'Amount,
                                                                                                                                                                                      ...
                                                                                                                                                                                      postShippingRatesRequestBodyFixedAmount'CurrencyOptions = GHC.Maybe.Nothing}
