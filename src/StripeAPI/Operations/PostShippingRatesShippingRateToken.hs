...
postShippingRatesShippingRateToken shippingRateToken
                                   body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostShippingRatesShippingRateTokenResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostShippingRatesShippingRateTokenResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  ShippingRate)
                                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostShippingRatesShippingRateTokenResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                    Error)
...
data PostShippingRatesShippingRateTokenRequestBodyFixedAmount' = PostShippingRatesShippingRateTokenRequestBodyFixedAmount' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostShippingRatesShippingRateTokenRequestBodyFixedAmount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency_options" Data.Aeson.Types.ToJSON..=)) (postShippingRatesShippingRateTokenRequestBodyFixedAmount'CurrencyOptions obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostShippingRatesShippingRateTokenRequestBodyFixedAmount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostShippingRatesShippingRateTokenRequestBodyFixedAmount'" (\obj -> GHC.Base.pure PostShippingRatesShippingRateTokenRequestBodyFixedAmount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options"))}
...
data PostShippingRatesShippingRateTokenRequestBodyTaxBehavior' =
   PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'EnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'
    where {toJSON (PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> PostShippingRatesShippingRateTokenRequestBodyTaxBehavior'EnumExclusive
