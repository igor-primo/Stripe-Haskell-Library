...
postSourcesSourceVerify :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ source | Constraints: Maximum length of 5000
  -> PostSourcesSourceVerifyRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostSourcesSourceVerifyResponse) -- ^ Monadic computation which returns the result of the operation
postSourcesSourceVerify source
                        body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostSourcesSourceVerifyResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostSourcesSourceVerifyResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                 Source)
                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostSourcesSourceVerifyResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                   Error)
...
data PostSourcesSourceVerifyRequestBody = PostSourcesSourceVerifyRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostSourcesSourceVerifyRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postSourcesSourceVerifyRequestBodyExpand obj) : ["values" Data.Aeson.Types.ToJSON..= postSourcesSourceVerifyRequestBodyValues obj] : GHC.Base.mempty));
...
mkPostSourcesSourceVerifyRequestBody :: [Data.Text.Internal.Text] -- ^ 'postSourcesSourceVerifyRequestBodyValues'
  -> PostSourcesSourceVerifyRequestBody
mkPostSourcesSourceVerifyRequestBody postSourcesSourceVerifyRequestBodyValues = PostSourcesSourceVerifyRequestBody{postSourcesSourceVerifyRequestBodyExpand = GHC.Maybe.Nothing,
