...
postTaxRegistrationsId :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostTaxRegistrationsIdRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTaxRegistrationsIdResponse) -- ^ Monadic computation which returns the result of the operation
postTaxRegistrationsId id
                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTaxRegistrationsIdResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTaxRegistrationsIdResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                              Tax'registration)
                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTaxRegistrationsIdResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                Error)
...
data PostTaxRegistrationsIdRequestBody = PostTaxRegistrationsIdRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxRegistrationsIdRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxRegistrationsIdRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxRegistrationsIdRequestBody" (\obj -> ((GHC.Base.pure PostTaxRegistrationsIdRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "active_from")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at"))}
...
mkPostTaxRegistrationsIdRequestBody = PostTaxRegistrationsIdRequestBody{postTaxRegistrationsIdRequestBodyActiveFrom = GHC.Maybe.Nothing,
...
data PostTaxRegistrationsIdRequestBodyActiveFrom'Variants =
   PostTaxRegistrationsIdRequestBodyActiveFrom'Now -- ^ Represents the JSON value @"now"@
  | PostTaxRegistrationsIdRequestBodyActiveFrom'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxRegistrationsIdRequestBodyActiveFrom'Variants
    where {toJSON (PostTaxRegistrationsIdRequestBodyActiveFrom'Int a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTaxRegistrationsIdRequestBodyActiveFrom'Now) = "now"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxRegistrationsIdRequestBodyActiveFrom'Variants
    where {parseJSON val = if | val GHC.Classes.== "now" -> GHC.Base.pure PostTaxRegistrationsIdRequestBodyActiveFrom'Now
...
data PostTaxRegistrationsIdRequestBodyExpiresAt'Variants =
   PostTaxRegistrationsIdRequestBodyExpiresAt'Now -- ^ Represents the JSON value @"now"@
  | PostTaxRegistrationsIdRequestBodyExpiresAt'EmptyString -- ^ Represents the JSON value @""@
  | PostTaxRegistrationsIdRequestBodyExpiresAt'Int GHC.Types.Int
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxRegistrationsIdRequestBodyExpiresAt'Variants
    where {toJSON (PostTaxRegistrationsIdRequestBodyExpiresAt'Int a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTaxRegistrationsIdRequestBodyExpiresAt'Now) = "now";
           toJSON (PostTaxRegistrationsIdRequestBodyExpiresAt'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxRegistrationsIdRequestBodyExpiresAt'Variants
    where {parseJSON val = if | val GHC.Classes.== "now" -> GHC.Base.pure PostTaxRegistrationsIdRequestBodyExpiresAt'Now
...
data PostTaxRegistrationsIdResponse =
   PostTaxRegistrationsIdResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTaxRegistrationsIdResponse200 Tax'registration -- ^ Successful response.
  | PostTaxRegistrationsIdResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
