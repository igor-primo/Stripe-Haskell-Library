...
postTaxSettings :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostTaxSettingsRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTaxSettingsResponse) -- ^ Monadic computation which returns the result of the operation
postTaxSettings body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTaxSettingsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTaxSettingsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                         Tax'settings)
                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTaxSettingsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                           Error)
                                                                                                                                                                 | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/tax/settings" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTaxSettingsRequestBody = PostTaxSettingsRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxSettingsRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxSettingsRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxSettingsRequestBody" (\obj -> ((GHC.Base.pure PostTaxSettingsRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "defaults")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "head_office"))}
-- | Create a new 'PostTaxSettingsRequestBody' with all required fields.
mkPostTaxSettingsRequestBody :: PostTaxSettingsRequestBody
mkPostTaxSettingsRequestBody = PostTaxSettingsRequestBody{postTaxSettingsRequestBodyDefaults = GHC.Maybe.Nothing,
...
data PostTaxSettingsRequestBodyDefaults' = PostTaxSettingsRequestBodyDefaults' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxSettingsRequestBodyDefaults'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_behavior" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyDefaults'TaxBehavior obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_code" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyDefaults'TaxCode obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_behavior" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyDefaults'TaxBehavior obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_code" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyDefaults'TaxCode obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxSettingsRequestBodyDefaults'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxSettingsRequestBodyDefaults'" (\obj -> (GHC.Base.pure PostTaxSettingsRequestBodyDefaults' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_code"))}
...
mkPostTaxSettingsRequestBodyDefaults' = PostTaxSettingsRequestBodyDefaults'{postTaxSettingsRequestBodyDefaults'TaxBehavior = GHC.Maybe.Nothing,
...
data PostTaxSettingsRequestBodyDefaults'TaxBehavior' =
   PostTaxSettingsRequestBodyDefaults'TaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTaxSettingsRequestBodyDefaults'TaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTaxSettingsRequestBodyDefaults'TaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | PostTaxSettingsRequestBodyDefaults'TaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | PostTaxSettingsRequestBodyDefaults'TaxBehavior'EnumInferredByCurrency -- ^ Represents the JSON value @"inferred_by_currency"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxSettingsRequestBodyDefaults'TaxBehavior'
    where {toJSON (PostTaxSettingsRequestBodyDefaults'TaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxSettingsRequestBodyDefaults'TaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> PostTaxSettingsRequestBodyDefaults'TaxBehavior'EnumExclusive
...
data PostTaxSettingsRequestBodyHeadOffice' = PostTaxSettingsRequestBodyHeadOffice' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxSettingsRequestBodyHeadOffice'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["address" Data.Aeson.Types.ToJSON..= postTaxSettingsRequestBodyHeadOffice'Address obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxSettingsRequestBodyHeadOffice'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxSettingsRequestBodyHeadOffice'" (\obj -> GHC.Base.pure PostTaxSettingsRequestBodyHeadOffice' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "address"))}
-- | Create a new 'PostTaxSettingsRequestBodyHeadOffice'' with all required fields.
mkPostTaxSettingsRequestBodyHeadOffice' :: PostTaxSettingsRequestBodyHeadOffice'Address' -- ^ 'postTaxSettingsRequestBodyHeadOffice'Address'
...
data PostTaxSettingsRequestBodyHeadOffice'Address' = PostTaxSettingsRequestBodyHeadOffice'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxSettingsRequestBodyHeadOffice'Address'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'State obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTaxSettingsRequestBodyHeadOffice'Address'State obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxSettingsRequestBodyHeadOffice'Address'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxSettingsRequestBodyHeadOffice'Address'" (\obj -> (((((GHC.Base.pure PostTaxSettingsRequestBodyHeadOffice'Address' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPostTaxSettingsRequestBodyHeadOffice'Address' = PostTaxSettingsRequestBodyHeadOffice'Address'{postTaxSettingsRequestBodyHeadOffice'Address'City = GHC.Maybe.Nothing,
...
data PostTaxSettingsResponse =
   PostTaxSettingsResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTaxSettingsResponse200 Tax'settings -- ^ Successful response.
  | PostTaxSettingsResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
