...
postTaxTransactionsCreateReversal :: forall m . StripeAPI.Common.MonadHTTP m => PostTaxTransactionsCreateReversalRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTaxTransactionsCreateReversalResponse) -- ^ Monadic computation which returns the result of the operation
postTaxTransactionsCreateReversal body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTaxTransactionsCreateReversalResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTaxTransactionsCreateReversalResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                               Tax'transaction)
                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTaxTransactionsCreateReversalResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                 Error)
                                                                                                                                                                                                     | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/tax/transactions/create_reversal" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTaxTransactionsCreateReversalRequestBody = PostTaxTransactionsCreateReversalRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxTransactionsCreateReversalRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxTransactionsCreateReversalRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxTransactionsCreateReversalRequestBody" (\obj -> (((((((GHC.Base.pure PostTaxTransactionsCreateReversalRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "flat_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "original_transaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_cost"))}
-- | Create a new 'PostTaxTransactionsCreateReversalRequestBody' with all required fields.
mkPostTaxTransactionsCreateReversalRequestBody :: PostTaxTransactionsCreateReversalRequestBodyMode' -- ^ 'postTaxTransactionsCreateReversalRequestBodyMode'
  -> Data.Text.Internal.Text -- ^ 'postTaxTransactionsCreateReversalRequestBodyOriginalTransaction'
  -> Data.Text.Internal.Text -- ^ 'postTaxTransactionsCreateReversalRequestBodyReference'
  -> PostTaxTransactionsCreateReversalRequestBody
mkPostTaxTransactionsCreateReversalRequestBody postTaxTransactionsCreateReversalRequestBodyMode postTaxTransactionsCreateReversalRequestBodyOriginalTransaction postTaxTransactionsCreateReversalRequestBodyReference = PostTaxTransactionsCreateReversalRequestBody{postTaxTransactionsCreateReversalRequestBodyExpand = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxTransactionsCreateReversalRequestBodyLineItems'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxTransactionsCreateReversalRequestBodyLineItems'" (\obj -> (((((GHC.Base.pure PostTaxTransactionsCreateReversalRequestBodyLineItems' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "original_line_item")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference"))}
-- | Create a new 'PostTaxTransactionsCreateReversalRequestBodyLineItems'' with all required fields.
mkPostTaxTransactionsCreateReversalRequestBodyLineItems' :: GHC.Types.Int -- ^ 'postTaxTransactionsCreateReversalRequestBodyLineItems'Amount'
  -> GHC.Types.Int -- ^ 'postTaxTransactionsCreateReversalRequestBodyLineItems'AmountTax'
  -> Data.Text.Internal.Text -- ^ 'postTaxTransactionsCreateReversalRequestBodyLineItems'OriginalLineItem'
  -> Data.Text.Internal.Text -- ^ 'postTaxTransactionsCreateReversalRequestBodyLineItems'Reference'
  -> PostTaxTransactionsCreateReversalRequestBodyLineItems'
mkPostTaxTransactionsCreateReversalRequestBodyLineItems' postTaxTransactionsCreateReversalRequestBodyLineItems'Amount postTaxTransactionsCreateReversalRequestBodyLineItems'AmountTax postTaxTransactionsCreateReversalRequestBodyLineItems'OriginalLineItem postTaxTransactionsCreateReversalRequestBodyLineItems'Reference = PostTaxTransactionsCreateReversalRequestBodyLineItems'{postTaxTransactionsCreateReversalRequestBodyLineItems'Amount = postTaxTransactionsCreateReversalRequestBodyLineItems'Amount,
...
data PostTaxTransactionsCreateReversalRequestBodyMode' =
   PostTaxTransactionsCreateReversalRequestBodyMode'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTaxTransactionsCreateReversalRequestBodyMode'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTaxTransactionsCreateReversalRequestBodyMode'EnumFull -- ^ Represents the JSON value @"full"@
  | PostTaxTransactionsCreateReversalRequestBodyMode'EnumPartial -- ^ Represents the JSON value @"partial"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxTransactionsCreateReversalRequestBodyMode'
    where {toJSON (PostTaxTransactionsCreateReversalRequestBodyMode'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxTransactionsCreateReversalRequestBodyMode'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "full" -> PostTaxTransactionsCreateReversalRequestBodyMode'EnumFull
...
data PostTaxTransactionsCreateReversalRequestBodyShippingCost' = PostTaxTransactionsCreateReversalRequestBodyShippingCost' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTaxTransactionsCreateReversalRequestBodyShippingCost'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= postTaxTransactionsCreateReversalRequestBodyShippingCost'Amount obj] : ["amount_tax" Data.Aeson.Types.ToJSON..= postTaxTransactionsCreateReversalRequestBodyShippingCost'AmountTax obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTaxTransactionsCreateReversalRequestBodyShippingCost'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTaxTransactionsCreateReversalRequestBodyShippingCost'" (\obj -> (GHC.Base.pure PostTaxTransactionsCreateReversalRequestBodyShippingCost' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax"))}
-- | Create a new 'PostTaxTransactionsCreateReversalRequestBodyShippingCost'' with all required fields.
mkPostTaxTransactionsCreateReversalRequestBodyShippingCost' :: GHC.Types.Int -- ^ 'postTaxTransactionsCreateReversalRequestBodyShippingCost'Amount'
  -> GHC.Types.Int -- ^ 'postTaxTransactionsCreateReversalRequestBodyShippingCost'AmountTax'
  -> PostTaxTransactionsCreateReversalRequestBodyShippingCost'
mkPostTaxTransactionsCreateReversalRequestBodyShippingCost' postTaxTransactionsCreateReversalRequestBodyShippingCost'Amount postTaxTransactionsCreateReversalRequestBodyShippingCost'AmountTax = PostTaxTransactionsCreateReversalRequestBodyShippingCost'{postTaxTransactionsCreateReversalRequestBodyShippingCost'Amount = postTaxTransactionsCreateReversalRequestBodyShippingCost'Amount,
...
data PostTaxTransactionsCreateReversalResponse =
   PostTaxTransactionsCreateReversalResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTaxTransactionsCreateReversalResponse200 Tax'transaction -- ^ Successful response.
  | PostTaxTransactionsCreateReversalResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
