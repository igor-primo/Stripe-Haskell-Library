...
postTerminalConnectionTokens :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostTerminalConnectionTokensRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTerminalConnectionTokensResponse) -- ^ Monadic computation which returns the result of the operation
postTerminalConnectionTokens body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalConnectionTokensResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalConnectionTokensResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                Terminal'connectionToken)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalConnectionTokensResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/terminal/connection_tokens" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTerminalConnectionTokensRequestBody = PostTerminalConnectionTokensRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalConnectionTokensRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postTerminalConnectionTokensRequestBodyExpand obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("location" Data.Aeson.Types.ToJSON..=)) (postTerminalConnectionTokensRequestBodyLocation obj) : GHC.Base.mempty));
...
mkPostTerminalConnectionTokensRequestBody = PostTerminalConnectionTokensRequestBody{postTerminalConnectionTokensRequestBodyExpand = GHC.Maybe.Nothing,
