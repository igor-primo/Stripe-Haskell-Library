...
postTerminalLocationsLocation location
                              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalLocationsLocationResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalLocationsLocationResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   PostTerminalLocationsLocationResponseBody200)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalLocationsLocationResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
...
data PostTerminalLocationsLocationRequestBody = PostTerminalLocationsLocationRequestBody {
  ...
  , postTerminalLocationsLocationRequestBodyDisplayName :: (GHC.Maybe.Maybe PostTerminalLocationsLocationRequestBodyDisplayName'Variants)
...
data PostTerminalLocationsLocationRequestBodyConfigurationOverrides'Variants =
   PostTerminalLocationsLocationRequestBodyConfigurationOverrides'EmptyString -- ^ Represents the JSON value @""@
  | PostTerminalLocationsLocationRequestBodyConfigurationOverrides'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalLocationsLocationRequestBodyConfigurationOverrides'Variants
    where {toJSON (PostTerminalLocationsLocationRequestBodyConfigurationOverrides'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTerminalLocationsLocationRequestBodyConfigurationOverrides'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalLocationsLocationRequestBodyConfigurationOverrides'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTerminalLocationsLocationRequestBodyConfigurationOverrides'EmptyString
...
-- | Defines the oneOf schema located at @paths.\/v1\/terminal\/locations\/{location}.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.display_name.anyOf@ in the specification.
-- 
-- A name for the location.
data PostTerminalLocationsLocationRequestBodyDisplayName'Variants =
   PostTerminalLocationsLocationRequestBodyDisplayName'EmptyString -- ^ Represents the JSON value @""@
  | PostTerminalLocationsLocationRequestBodyDisplayName'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalLocationsLocationRequestBodyDisplayName'Variants
    where {toJSON (PostTerminalLocationsLocationRequestBodyDisplayName'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTerminalLocationsLocationRequestBodyDisplayName'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalLocationsLocationRequestBodyDisplayName'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTerminalLocationsLocationRequestBodyDisplayName'EmptyString
                              | GHC.Base.otherwise -> case (PostTerminalLocationsLocationRequestBodyDisplayName'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
