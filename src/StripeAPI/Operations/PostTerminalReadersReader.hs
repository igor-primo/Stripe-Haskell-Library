...
postTerminalReadersReader :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ reader | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostTerminalReadersReaderRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTerminalReadersReaderResponse) -- ^ Monadic computation which returns the result of the operation
postTerminalReadersReader reader
                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalReadersReaderResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                       PostTerminalReadersReaderResponseBody200)
                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostTerminalReadersReaderRequestBody = PostTerminalReadersReaderRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderRequestBody
...
mkPostTerminalReadersReaderRequestBody = PostTerminalReadersReaderRequestBody{postTerminalReadersReaderRequestBodyExpand = GHC.Maybe.Nothing,
...
data PostTerminalReadersReaderRequestBodyLabel'Variants =
   PostTerminalReadersReaderRequestBodyLabel'EmptyString -- ^ Represents the JSON value @""@
  | PostTerminalReadersReaderRequestBodyLabel'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderRequestBodyLabel'Variants
    where {toJSON (PostTerminalReadersReaderRequestBodyLabel'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTerminalReadersReaderRequestBodyLabel'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderRequestBodyLabel'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTerminalReadersReaderRequestBodyLabel'EmptyString
...
data PostTerminalReadersReaderRequestBodyMetadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderRequestBodyMetadata'Variants
    where {toJSON (PostTerminalReadersReaderRequestBodyMetadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTerminalReadersReaderRequestBodyMetadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderRequestBodyMetadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTerminalReadersReaderRequestBodyMetadata'EmptyString
...
data PostTerminalReadersReaderResponse =
  ...
  | PostTerminalReadersReaderResponse200 PostTerminalReadersReaderResponseBody200 -- ^ Successful response.
...
data PostTerminalReadersReaderResponseBody200 = PostTerminalReadersReaderResponseBody200 {
  ...
  , postTerminalReadersReaderResponseBody200Status :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PostTerminalReadersReaderResponseBody200Status'NonNullable))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200
...
mkPostTerminalReadersReaderResponseBody200 = PostTerminalReadersReaderResponseBody200{postTerminalReadersReaderResponseBody200Action = GHC.Maybe.Nothing,
...
data PostTerminalReadersReaderResponseBody200Action'NonNullable = PostTerminalReadersReaderResponseBody200Action'NonNullable {
  ...
  postTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs :: (GHC.Maybe.Maybe TerminalReaderReaderResourceCollectInputsAction)
  -- | collect_payment_method: Represents a reader action to collect a payment method
  , postTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod :: (GHC.Maybe.Maybe TerminalReaderReaderResourceCollectPaymentMethodAction)
  -- | confirm_payment_intent: Represents a reader action to confirm a payment
  , postTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent :: (GHC.Maybe.Maybe TerminalReaderReaderResourceConfirmPaymentIntentAction)
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Action'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_inputs" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_payment_method" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("confirm_payment_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_code" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableFailureCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_message" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableFailureMessage obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_payment_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableProcessPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_setup_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableProcessSetupIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_payment" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableRefundPayment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("set_reader_display" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableSetReaderDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_inputs" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("collect_payment_method" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("confirm_payment_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_code" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableFailureCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_message" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableFailureMessage obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_payment_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableProcessPaymentIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("process_setup_intent" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableProcessSetupIntent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("refund_payment" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableRefundPayment obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("set_reader_display" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableSetReaderDisplay obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableStatus obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderResponseBody200Action'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Action'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderResponseBody200Action'NonNullable" (\obj -> ((((((((((GHC.Base.pure PostTerminalReadersReaderResponseBody200Action'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "collect_inputs")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "collect_payment_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "confirm_payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_message")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "process_setup_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "refund_payment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "set_reader_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPostTerminalReadersReaderResponseBody200Action'NonNullable = PostTerminalReadersReaderResponseBody200Action'NonNullable{postTerminalReadersReaderResponseBody200Action'NonNullableCollectInputs = GHC.Maybe.Nothing,
                                                                                                                          postTerminalReadersReaderResponseBody200Action'NonNullableCollectPaymentMethod = GHC.Maybe.Nothing,
                                                                                                                          postTerminalReadersReaderResponseBody200Action'NonNullableConfirmPaymentIntent = GHC.Maybe.Nothing,
...
data PostTerminalReadersReaderResponseBody200Action'NonNullableStatus' =
   PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumInProgress -- ^ Represents the JSON value @"in_progress"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'
    where {toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> PostTerminalReadersReaderResponseBody200Action'NonNullableStatus'EnumFailed
...
data PostTerminalReadersReaderResponseBody200Action'NonNullableType' =
   PostTerminalReadersReaderResponseBody200Action'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs -- ^ Represents the JSON value @"collect_inputs"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod -- ^ Represents the JSON value @"collect_payment_method"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent -- ^ Represents the JSON value @"confirm_payment_intent"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumProcessPaymentIntent -- ^ Represents the JSON value @"process_payment_intent"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumProcessSetupIntent -- ^ Represents the JSON value @"process_setup_intent"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumRefundPayment -- ^ Represents the JSON value @"refund_payment"@
  | PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumSetReaderDisplay -- ^ Represents the JSON value @"set_reader_display"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Action'NonNullableType'
    where {toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableType'Other val) = val;
           toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs) = "collect_inputs";
           toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod) = "collect_payment_method";
           toJSON (PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent) = "confirm_payment_intent";
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Action'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "collect_inputs" -> PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectInputs
                                             | val GHC.Classes.== "collect_payment_method" -> PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumCollectPaymentMethod
                                             | val GHC.Classes.== "confirm_payment_intent" -> PostTerminalReadersReaderResponseBody200Action'NonNullableType'EnumConfirmPaymentIntent
...
data PostTerminalReadersReaderResponseBody200Deleted' =
   PostTerminalReadersReaderResponseBody200Deleted'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200Deleted'Typed GHC.Types.Bool -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200Deleted'EnumTrue -- ^ Represents the JSON value @true@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Deleted'
    where {toJSON (PostTerminalReadersReaderResponseBody200Deleted'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Deleted'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== Data.Aeson.Types.Internal.Bool GHC.Types.True -> PostTerminalReadersReaderResponseBody200Deleted'EnumTrue
...
data PostTerminalReadersReaderResponseBody200DeviceType' =
   PostTerminalReadersReaderResponseBody200DeviceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200DeviceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumBbposChipper2x -- ^ Represents the JSON value @"bbpos_chipper2x"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumBbposWisepad3 -- ^ Represents the JSON value @"bbpos_wisepad3"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumBbposWiseposE -- ^ Represents the JSON value @"bbpos_wisepos_e"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader -- ^ Represents the JSON value @"mobile_phone_reader"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700 -- ^ Represents the JSON value @"simulated_stripe_s700"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedWiseposE -- ^ Represents the JSON value @"simulated_wisepos_e"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumStripeM2 -- ^ Represents the JSON value @"stripe_m2"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700 -- ^ Represents the JSON value @"stripe_s700"@
  | PostTerminalReadersReaderResponseBody200DeviceType'EnumVerifoneP400 -- ^ Represents the JSON value @"verifone_P400"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200DeviceType'
    where {toJSON (PostTerminalReadersReaderResponseBody200DeviceType'Other val) = val;
           ...
           toJSON (PostTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader) = "mobile_phone_reader";
           toJSON (PostTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700) = "simulated_stripe_s700";
           ...
           toJSON (PostTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700) = "stripe_s700";
           toJSON (PostTerminalReadersReaderResponseBody200DeviceType'EnumVerifoneP400) = "verifone_P400"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200DeviceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bbpos_chipper2x" -> PostTerminalReadersReaderResponseBody200DeviceType'EnumBbposChipper2x
                                             ...
                                             | val GHC.Classes.== "mobile_phone_reader" -> PostTerminalReadersReaderResponseBody200DeviceType'EnumMobilePhoneReader
                                             | val GHC.Classes.== "simulated_stripe_s700" -> PostTerminalReadersReaderResponseBody200DeviceType'EnumSimulatedStripeS700
                                             ...
                                             | val GHC.Classes.== "stripe_s700" -> PostTerminalReadersReaderResponseBody200DeviceType'EnumStripeS700
...
data PostTerminalReadersReaderResponseBody200Location'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Location'NonNullableVariants
    where {toJSON (PostTerminalReadersReaderResponseBody200Location'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTerminalReadersReaderResponseBody200Location'NonNullableTerminal'location a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Location'NonNullableVariants
    where {parseJSON val = case (PostTerminalReadersReaderResponseBody200Location'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostTerminalReadersReaderResponseBody200Location'NonNullableTerminal'location Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTerminalReadersReaderResponseBody200Object' =
   PostTerminalReadersReaderResponseBody200Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200Object'EnumTerminal'reader -- ^ Represents the JSON value @"terminal.reader"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Object'
    where {toJSON (PostTerminalReadersReaderResponseBody200Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "terminal.reader" -> PostTerminalReadersReaderResponseBody200Object'EnumTerminal'reader
                                             | GHC.Base.otherwise -> PostTerminalReadersReaderResponseBody200Object'Other val)}
-- | Defines the enum schema located at @paths.\/v1\/terminal\/readers\/{reader}.POST.responses.200.content.application\/json.schema.anyOf.properties.status@ in the specification.
-- 
-- The networking status of the reader. We do not recommend using this field in flows that may block taking payments.
data PostTerminalReadersReaderResponseBody200Status'NonNullable =
   PostTerminalReadersReaderResponseBody200Status'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTerminalReadersReaderResponseBody200Status'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline -- ^ Represents the JSON value @"offline"@
  | PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline -- ^ Represents the JSON value @"online"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderResponseBody200Status'NonNullable
    where {toJSON (PostTerminalReadersReaderResponseBody200Status'NonNullableOther val) = val;
           toJSON (PostTerminalReadersReaderResponseBody200Status'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline) = "offline";
           toJSON (PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline) = "online"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderResponseBody200Status'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "offline" -> PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOffline
                                             | val GHC.Classes.== "online" -> PostTerminalReadersReaderResponseBody200Status'NonNullableEnumOnline
                                             | GHC.Base.otherwise -> PostTerminalReadersReaderResponseBody200Status'NonNullableOther val)}
