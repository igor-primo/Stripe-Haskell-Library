...
postTerminalReadersReaderRefundPayment reader
                                       body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalReadersReaderRefundPaymentResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderRefundPaymentResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              Terminal'reader)
                                                                                                                                                                                                               | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderRefundPaymentResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                Error)
...
data PostTerminalReadersReaderRefundPaymentRequestBody = PostTerminalReadersReaderRefundPaymentRequestBody {
  ...
  , postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig :: (GHC.Maybe.Maybe PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig')
...
mkPostTerminalReadersReaderRefundPaymentRequestBody = PostTerminalReadersReaderRefundPaymentRequestBody{postTerminalReadersReaderRefundPaymentRequestBodyAmount = GHC.Maybe.Nothing,
                                                                                                        ...
                                                                                                        postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig = GHC.Maybe.Nothing,
                                                                                                        postTerminalReadersReaderRefundPaymentRequestBodyReverseTransfer = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/terminal\/readers\/{reader}\/refund_payment.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.refund_payment_config@ in the specification.
-- 
-- Configuration overrides
data PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig' = PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig' {
  -- | enable_customer_cancellation
  postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'EnableCustomerCancellation :: (GHC.Maybe.Maybe GHC.Types.Bool)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enable_customer_cancellation" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'EnableCustomerCancellation obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enable_customer_cancellation" Data.Aeson.Types.ToJSON..=)) (postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'EnableCustomerCancellation obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'" (\obj -> GHC.Base.pure PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "enable_customer_cancellation"))}
-- | Create a new 'PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'' with all required fields.
mkPostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig' :: PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'
mkPostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig' = PostTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'{postTerminalReadersReaderRefundPaymentRequestBodyRefundPaymentConfig'EnableCustomerCancellation = GHC.Maybe.Nothing}
