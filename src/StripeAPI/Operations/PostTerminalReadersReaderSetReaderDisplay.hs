...
postTerminalReadersReaderSetReaderDisplay :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ reader | Constraints: Maximum length of 5000
  -> PostTerminalReadersReaderSetReaderDisplayRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTerminalReadersReaderSetReaderDisplayResponse) -- ^ Monadic computation which returns the result of the operation
postTerminalReadersReaderSetReaderDisplay reader
                                          body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTerminalReadersReaderSetReaderDisplayResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderSetReaderDisplayResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       Terminal'reader)
                                                                                                                                                                                                                     | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTerminalReadersReaderSetReaderDisplayResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                         Error)
...
data PostTerminalReadersReaderSetReaderDisplayRequestBody = PostTerminalReadersReaderSetReaderDisplayRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTerminalReadersReaderSetReaderDisplayRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderSetReaderDisplayRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderSetReaderDisplayRequestBody" (\obj -> (GHC.Base.pure PostTerminalReadersReaderSetReaderDisplayRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cart")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))}
...
mkPostTerminalReadersReaderSetReaderDisplayRequestBody = PostTerminalReadersReaderSetReaderDisplayRequestBody{postTerminalReadersReaderSetReaderDisplayRequestBodyCart = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'" (\obj -> (((GHC.Base.pure PostTerminalReadersReaderSetReaderDisplayRequestBodyCart' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "total"))}
-- | Create a new 'PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'' with all required fields.
mkPostTerminalReadersReaderSetReaderDisplayRequestBodyCart' :: Data.Text.Internal.Text -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Currency'
  -> [PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'] -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'
  -> GHC.Types.Int -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Total'
  -> PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'
mkPostTerminalReadersReaderSetReaderDisplayRequestBodyCart' postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Currency postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Total = PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'{postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Currency = postTerminalReadersReaderSetReaderDisplayRequestBodyCart'Currency,
                                                                                                                                                                                                                                                                                                                            postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems = postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems,
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'
...
mkPostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems' :: GHC.Types.Int -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Amount'
  -> Data.Text.Internal.Text -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Description'
  -> GHC.Types.Int -- ^ 'postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Quantity'
  -> PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'
mkPostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems' postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Amount postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Description postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Quantity = PostTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'{postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Amount = postTerminalReadersReaderSetReaderDisplayRequestBodyCart'LineItems'Amount,
...
data PostTerminalReadersReaderSetReaderDisplayResponse =
   PostTerminalReadersReaderSetReaderDisplayResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTerminalReadersReaderSetReaderDisplayResponse200 Terminal'reader -- ^ Successful response.
  | PostTerminalReadersReaderSetReaderDisplayResponseDefault Error -- ^ Error response.
