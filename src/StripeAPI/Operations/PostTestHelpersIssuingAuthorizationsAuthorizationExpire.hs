...
postTestHelpersIssuingAuthorizationsAuthorizationExpire :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ authorization | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponse) -- ^ Monadic computation which returns the result of the operation
postTestHelpersIssuingAuthorizationsAuthorizationExpire authorization
                                                        body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 Issuing'authorization)
                                                                                                                                                                                                                                                 | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Error)
...
data PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody = PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("expand" Data.Aeson.Types.ToJSON..=)) (postTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBodyExpand obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody" (\obj -> GHC.Base.pure PostTestHelpersIssuingAuthorizationsAuthorizationExpireRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand"))}
...
data PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponse =
   PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponse200 Issuing'authorization -- ^ Successful response.
  | PostTestHelpersIssuingAuthorizationsAuthorizationExpireResponseDefault Error -- ^ Error response.
