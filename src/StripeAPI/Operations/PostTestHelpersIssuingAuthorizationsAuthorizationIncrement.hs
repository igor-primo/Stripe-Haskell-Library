...
postTestHelpersIssuingAuthorizationsAuthorizationIncrement :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ authorization | Constraints: Maximum length of 5000
  -> PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponse) -- ^ Monadic computation which returns the result of the operation
postTestHelpersIssuingAuthorizationsAuthorizationIncrement authorization
                                                           body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          Issuing'authorization)
                                                                                                                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            Error)
...
data PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequestBody = PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersIssuingAuthorizationsAuthorizationIncrementRequestBody
...
data PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponse =
   PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponse200 Issuing'authorization -- ^ Successful response.
  | PostTestHelpersIssuingAuthorizationsAuthorizationIncrementResponseDefault Error -- ^ Error response.
