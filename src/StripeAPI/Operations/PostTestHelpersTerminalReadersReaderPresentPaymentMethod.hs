...
postTestHelpersTerminalReadersReaderPresentPaymentMethod :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ reader | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponse) -- ^ Monadic computation which returns the result of the operation
postTestHelpersTerminalReadersReaderPresentPaymentMethod reader
                                                         body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    Terminal'reader)
                                                                                                                                                                                                                                                   | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      Error)
...
data PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody = PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody" (\obj -> ((((GHC.Base.pure PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_present")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interac_present")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody = PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBody{postTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyAmountTip = GHC.Maybe.Nothing,
...
data PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent' = PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("number" Data.Aeson.Types.ToJSON..=)) (postTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent'Number obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent'" (\obj -> GHC.Base.pure PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyCardPresent' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "number"))}
...
data PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent' = PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("number" Data.Aeson.Types.ToJSON..=)) (postTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent'Number obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent'" (\obj -> GHC.Base.pure PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyInteracPresent' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "number"))}
...
data PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType' =
   PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'EnumCardPresent -- ^ Represents the JSON value @"card_present"@
  | PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'EnumInteracPresent -- ^ Represents the JSON value @"interac_present"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'
    where {toJSON (PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card_present" -> PostTestHelpersTerminalReadersReaderPresentPaymentMethodRequestBodyType'EnumCardPresent
...
data PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponse =
   PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponse200 Terminal'reader -- ^ Successful response.
  | PostTestHelpersTerminalReadersReaderPresentPaymentMethodResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
