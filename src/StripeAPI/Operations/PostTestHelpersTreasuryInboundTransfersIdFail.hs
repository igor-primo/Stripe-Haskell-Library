...
postTestHelpersTreasuryInboundTransfersIdFail :: forall m . StripeAPI.Common.MonadHTTP m => Data.Text.Internal.Text -- ^ id | Constraints: Maximum length of 5000
  -> GHC.Maybe.Maybe PostTestHelpersTreasuryInboundTransfersIdFailRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTestHelpersTreasuryInboundTransfersIdFailResponse) -- ^ Monadic computation which returns the result of the operation
postTestHelpersTreasuryInboundTransfersIdFail id
                                              body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTestHelpersTreasuryInboundTransfersIdFailResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersTreasuryInboundTransfersIdFailResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Treasury'inboundTransfer)
                                                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTestHelpersTreasuryInboundTransfersIdFailResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
...
data PostTestHelpersTreasuryInboundTransfersIdFailRequestBody = PostTestHelpersTreasuryInboundTransfersIdFailRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBody
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTreasuryInboundTransfersIdFailRequestBody" (\obj -> (GHC.Base.pure PostTestHelpersTreasuryInboundTransfersIdFailRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_details"))}
...
mkPostTestHelpersTreasuryInboundTransfersIdFailRequestBody = PostTestHelpersTreasuryInboundTransfersIdFailRequestBody{postTestHelpersTreasuryInboundTransfersIdFailRequestBodyExpand = GHC.Maybe.Nothing,
...
data PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails' = PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("code" Data.Aeson.Types.ToJSON..=)) (postTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'" (\obj -> GHC.Base.pure PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "code"))}
...
data PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code' =
   PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumAccountClosed -- ^ Represents the JSON value @"account_closed"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumAccountFrozen -- ^ Represents the JSON value @"account_frozen"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumBankAccountRestricted -- ^ Represents the JSON value @"bank_account_restricted"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumBankOwnershipChanged -- ^ Represents the JSON value @"bank_ownership_changed"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumDebitNotAuthorized -- ^ Represents the JSON value @"debit_not_authorized"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumIncorrectAccountHolderAddress -- ^ Represents the JSON value @"incorrect_account_holder_address"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumIncorrectAccountHolderName -- ^ Represents the JSON value @"incorrect_account_holder_name"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumIncorrectAccountHolderTaxId -- ^ Represents the JSON value @"incorrect_account_holder_tax_id"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumInsufficientFunds -- ^ Represents the JSON value @"insufficient_funds"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumInvalidAccountNumber -- ^ Represents the JSON value @"invalid_account_number"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumInvalidCurrency -- ^ Represents the JSON value @"invalid_currency"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumNoAccount -- ^ Represents the JSON value @"no_account"@
  | PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'
    where {toJSON (PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_closed" -> PostTestHelpersTreasuryInboundTransfersIdFailRequestBodyFailureDetails'Code'EnumAccountClosed
...
data PostTestHelpersTreasuryInboundTransfersIdFailResponse =
   PostTestHelpersTreasuryInboundTransfersIdFailResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTestHelpersTreasuryInboundTransfersIdFailResponse200 Treasury'inboundTransfer -- ^ Successful response.
  | PostTestHelpersTreasuryInboundTransfersIdFailResponseDefault Error -- ^ Error response.
  deriving (GHC.Show.Show, GHC.Classes.Eq)
