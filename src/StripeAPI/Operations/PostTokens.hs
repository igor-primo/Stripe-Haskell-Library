...
postTokens :: forall m . StripeAPI.Common.MonadHTTP m => GHC.Maybe.Maybe PostTokensRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTokensResponse) -- ^ Monadic computation which returns the result of the operation
postTokens body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTokensResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTokensResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                          Token)
                                                                                                                                                       | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTokensResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                            Error)
                                                                                                                                                       | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/tokens" GHC.Base.mempty body StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTokensRequestBody = PostTokensRequestBody {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBody
...
mkPostTokensRequestBody = PostTokensRequestBody{postTokensRequestBodyAccount = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount' = PostTokensRequestBodyAccount' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'
...
mkPostTokensRequestBodyAccount' = PostTokensRequestBodyAccount'{postTokensRequestBodyAccount'BusinessType = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'BusinessType' =
   PostTokensRequestBodyAccount'BusinessType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyAccount'BusinessType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyAccount'BusinessType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostTokensRequestBodyAccount'BusinessType'EnumGovernmentEntity -- ^ Represents the JSON value @"government_entity"@
  | PostTokensRequestBodyAccount'BusinessType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  | PostTokensRequestBodyAccount'BusinessType'EnumNonProfit -- ^ Represents the JSON value @"non_profit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'BusinessType'
    where {toJSON (PostTokensRequestBodyAccount'BusinessType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'BusinessType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "company" -> PostTokensRequestBodyAccount'BusinessType'EnumCompany
...
data PostTokensRequestBodyAccount'Company' = PostTokensRequestBodyAccount'Company' {
  ...
  , postTokensRequestBodyAccount'Company'DirectorshipDeclaration :: (GHC.Maybe.Maybe PostTokensRequestBodyAccount'Company'DirectorshipDeclaration')
  -- | executives_provided
  ...
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyAccount'Company'ExportLicenseId :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | export_purpose_code
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyAccount'Company'ExportPurposeCode :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | name
  -- 
  -- Constraints:
  -- 
  ...
  , postTokensRequestBodyAccount'Company'OwnershipExemptionReason :: (GHC.Maybe.Maybe PostTokensRequestBodyAccount'Company'OwnershipExemptionReason')
  -- | phone
  -- 
  -- Constraints:
  -- 
  ...
  -- | registration_date
  , postTokensRequestBodyAccount'Company'RegistrationDate :: (GHC.Maybe.Maybe PostTokensRequestBodyAccount'Company'RegistrationDate'Variants)
  -- | registration_number
  -- 
  -- Constraints:
  -- 
...
mkPostTokensRequestBodyAccount'Company' = PostTokensRequestBodyAccount'Company'{postTokensRequestBodyAccount'Company'Address = GHC.Maybe.Nothing,
                                                                                ...
                                                                                postTokensRequestBodyAccount'Company'DirectorshipDeclaration = GHC.Maybe.Nothing,
                                                                                postTokensRequestBodyAccount'Company'ExecutivesProvided = GHC.Maybe.Nothing,
                                                                                postTokensRequestBodyAccount'Company'ExportLicenseId = GHC.Maybe.Nothing,
                                                                                postTokensRequestBodyAccount'Company'ExportPurposeCode = GHC.Maybe.Nothing,
                                                                                ...
                                                                                postTokensRequestBodyAccount'Company'OwnershipExemptionReason = GHC.Maybe.Nothing,
                                                                                postTokensRequestBodyAccount'Company'Phone = GHC.Maybe.Nothing,
                                                                                postTokensRequestBodyAccount'Company'RegistrationDate = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Company'Address' = PostTokensRequestBodyAccount'Company'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'Address'
...
mkPostTokensRequestBodyAccount'Company'Address' = PostTokensRequestBodyAccount'Company'Address'{postTokensRequestBodyAccount'Company'Address'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Company'AddressKana' = PostTokensRequestBodyAccount'Company'AddressKana' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'AddressKana'
...
mkPostTokensRequestBodyAccount'Company'AddressKana' = PostTokensRequestBodyAccount'Company'AddressKana'{postTokensRequestBodyAccount'Company'AddressKana'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Company'AddressKanji' = PostTokensRequestBodyAccount'Company'AddressKanji' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'AddressKanji'
...
mkPostTokensRequestBodyAccount'Company'AddressKanji' = PostTokensRequestBodyAccount'Company'AddressKanji'{postTokensRequestBodyAccount'Company'AddressKanji'City = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.company.properties.directorship_declaration@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Company'DirectorshipDeclaration' = PostTokensRequestBodyAccount'Company'DirectorshipDeclaration' {
  -- | date
  postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Date :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | ip
  , postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Ip :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | user_agent
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyAccount'Company'DirectorshipDeclaration'UserAgent :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'UserAgent obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'DirectorshipDeclaration'UserAgent obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'" (\obj -> ((GHC.Base.pure PostTokensRequestBodyAccount'Company'DirectorshipDeclaration' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
-- | Create a new 'PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'' with all required fields.
mkPostTokensRequestBodyAccount'Company'DirectorshipDeclaration' :: PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'
mkPostTokensRequestBodyAccount'Company'DirectorshipDeclaration' = PostTokensRequestBodyAccount'Company'DirectorshipDeclaration'{postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Date = GHC.Maybe.Nothing,
                                                                                                                                postTokensRequestBodyAccount'Company'DirectorshipDeclaration'Ip = GHC.Maybe.Nothing,
                                                                                                                                postTokensRequestBodyAccount'Company'DirectorshipDeclaration'UserAgent = GHC.Maybe.Nothing}
...
data PostTokensRequestBodyAccount'Company'OwnershipDeclaration' = PostTokensRequestBodyAccount'Company'OwnershipDeclaration' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'OwnershipDeclaration'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'UserAgent obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'OwnershipDeclaration'UserAgent obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'OwnershipDeclaration'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Company'OwnershipDeclaration'" (\obj -> ((GHC.Base.pure PostTokensRequestBodyAccount'Company'OwnershipDeclaration' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
...
mkPostTokensRequestBodyAccount'Company'OwnershipDeclaration' = PostTokensRequestBodyAccount'Company'OwnershipDeclaration'{postTokensRequestBodyAccount'Company'OwnershipDeclaration'Date = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.company.properties.ownership_exemption_reason@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Company'OwnershipExemptionReason' =
   PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold -- ^ Represents the JSON value @"qualified_entity_exceeds_ownership_threshold"@
  | PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiesAsFinancialInstitution -- ^ Represents the JSON value @"qualifies_as_financial_institution"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'
    where {toJSON (PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'Other val) = val;
           toJSON (PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumEmptyString) = "";
           toJSON (PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold) = "qualified_entity_exceeds_ownership_threshold";
           toJSON (PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiesAsFinancialInstitution) = "qualifies_as_financial_institution"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumEmptyString
                                             | val GHC.Classes.== "qualified_entity_exceeds_ownership_threshold" -> PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiedEntityExceedsOwnershipThreshold
                                             | val GHC.Classes.== "qualifies_as_financial_institution" -> PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'EnumQualifiesAsFinancialInstitution
                                             | GHC.Base.otherwise -> PostTokensRequestBodyAccount'Company'OwnershipExemptionReason'Other val)}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.company.properties.registration_date.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 = PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 {
  -- | day
  postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day :: GHC.Types.Int
  -- | month
  , postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month :: GHC.Types.Int
  -- | year
  , postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year :: GHC.Types.Int
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["day" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day obj] : ["month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month obj] : ["year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["day" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day obj] : ["month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month obj] : ["year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1" (\obj -> ((GHC.Base.pure PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "day")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "year"))}
-- | Create a new 'PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1' with all required fields.
mkPostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 :: GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year'
  -> PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1
mkPostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year = PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1{postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day = postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Day,
                                                                                                                                                                                                                                                                                                                                 postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month = postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Month,
                                                                                                                                                                                                                                                                                                                                 postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year = postTokensRequestBodyAccount'Company'RegistrationDate'OneOf1Year}
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.company.properties.registration_date.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Company'RegistrationDate'Variants =
   PostTokensRequestBodyAccount'Company'RegistrationDate'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyAccount'Company'RegistrationDate'PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'RegistrationDate'Variants
    where {toJSON (PostTokensRequestBodyAccount'Company'RegistrationDate'PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyAccount'Company'RegistrationDate'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'RegistrationDate'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyAccount'Company'RegistrationDate'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyAccount'Company'RegistrationDate'PostTokensRequestBodyAccount'Company'RegistrationDate'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
...
data PostTokensRequestBodyAccount'Company'Structure' =
   PostTokensRequestBodyAccount'Company'Structure'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyAccount'Company'Structure'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyAccount'Company'Structure'EnumEmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyAccount'Company'Structure'EnumFreeZoneEstablishment -- ^ Represents the JSON value @"free_zone_establishment"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumFreeZoneLlc -- ^ Represents the JSON value @"free_zone_llc"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumGovernmentInstrumentality -- ^ Represents the JSON value @"government_instrumentality"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumGovernmentalUnit -- ^ Represents the JSON value @"governmental_unit"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumIncorporatedNonProfit -- ^ Represents the JSON value @"incorporated_non_profit"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumIncorporatedPartnership -- ^ Represents the JSON value @"incorporated_partnership"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumLimitedLiabilityPartnership -- ^ Represents the JSON value @"limited_liability_partnership"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumLlc -- ^ Represents the JSON value @"llc"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumMultiMemberLlc -- ^ Represents the JSON value @"multi_member_llc"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPrivateCompany -- ^ Represents the JSON value @"private_company"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPrivateCorporation -- ^ Represents the JSON value @"private_corporation"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPrivatePartnership -- ^ Represents the JSON value @"private_partnership"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPublicCompany -- ^ Represents the JSON value @"public_company"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPublicCorporation -- ^ Represents the JSON value @"public_corporation"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumPublicPartnership -- ^ Represents the JSON value @"public_partnership"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumRegisteredCharity -- ^ Represents the JSON value @"registered_charity"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumSingleMemberLlc -- ^ Represents the JSON value @"single_member_llc"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumSoleEstablishment -- ^ Represents the JSON value @"sole_establishment"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumSoleProprietorship -- ^ Represents the JSON value @"sole_proprietorship"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumTaxExemptGovernmentInstrumentality -- ^ Represents the JSON value @"tax_exempt_government_instrumentality"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumUnincorporatedAssociation -- ^ Represents the JSON value @"unincorporated_association"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumUnincorporatedNonProfit -- ^ Represents the JSON value @"unincorporated_non_profit"@
  | PostTokensRequestBodyAccount'Company'Structure'EnumUnincorporatedPartnership -- ^ Represents the JSON value @"unincorporated_partnership"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'Structure'
    where {toJSON (PostTokensRequestBodyAccount'Company'Structure'Other val) = val;
           ...
           toJSON (PostTokensRequestBodyAccount'Company'Structure'EnumIncorporatedPartnership) = "incorporated_partnership";
           ...
           toJSON (PostTokensRequestBodyAccount'Company'Structure'EnumRegisteredCharity) = "registered_charity";
           ...
           toJSON (PostTokensRequestBodyAccount'Company'Structure'EnumUnincorporatedPartnership) = "unincorporated_partnership"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Company'Structure'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "" -> PostTokensRequestBodyAccount'Company'Structure'EnumEmptyString
                                             ...
                                             | val GHC.Classes.== "incorporated_partnership" -> PostTokensRequestBodyAccount'Company'Structure'EnumIncorporatedPartnership
                                             ...
                                             | val GHC.Classes.== "registered_charity" -> PostTokensRequestBodyAccount'Company'Structure'EnumRegisteredCharity
                                             ...
                                             | val GHC.Classes.== "unincorporated_partnership" -> PostTokensRequestBodyAccount'Company'Structure'EnumUnincorporatedPartnership
...
data PostTokensRequestBodyAccount'Company'Verification' = PostTokensRequestBodyAccount'Company'Verification' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'Verification'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("document" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Company'Verification'Document obj) : GHC.Base.mempty));
...
data PostTokensRequestBodyAccount'Company'Verification'Document' = PostTokensRequestBodyAccount'Company'Verification'Document' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Company'Verification'Document'
...
mkPostTokensRequestBodyAccount'Company'Verification'Document' = PostTokensRequestBodyAccount'Company'Verification'Document'{postTokensRequestBodyAccount'Company'Verification'Document'Back = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual' = PostTokensRequestBodyAccount'Individual' {
  ...
  -- | relationship
  , postTokensRequestBodyAccount'Individual'Relationship :: (GHC.Maybe.Maybe PostTokensRequestBodyAccount'Individual'Relationship')
  -- | ssn_last_4
  -- 
  -- Constraints:
  -- 
...
mkPostTokensRequestBodyAccount'Individual' = PostTokensRequestBodyAccount'Individual'{postTokensRequestBodyAccount'Individual'Address = GHC.Maybe.Nothing,
                                                                                      ...
                                                                                      postTokensRequestBodyAccount'Individual'Relationship = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'Address' = PostTokensRequestBodyAccount'Individual'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Address'
...
mkPostTokensRequestBodyAccount'Individual'Address' = PostTokensRequestBodyAccount'Individual'Address'{postTokensRequestBodyAccount'Individual'Address'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'AddressKana' = PostTokensRequestBodyAccount'Individual'AddressKana' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'AddressKana'
...
mkPostTokensRequestBodyAccount'Individual'AddressKana' = PostTokensRequestBodyAccount'Individual'AddressKana'{postTokensRequestBodyAccount'Individual'AddressKana'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'AddressKanji' = PostTokensRequestBodyAccount'Individual'AddressKanji' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'AddressKanji'
...
mkPostTokensRequestBodyAccount'Individual'AddressKanji' = PostTokensRequestBodyAccount'Individual'AddressKanji'{postTokensRequestBodyAccount'Individual'AddressKanji'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'Dob'OneOf1 = PostTokensRequestBodyAccount'Individual'Dob'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Dob'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["day" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Individual'Dob'OneOf1Day obj] : ["month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Individual'Dob'OneOf1Month obj] : ["year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyAccount'Individual'Dob'OneOf1Year obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'Dob'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Individual'Dob'OneOf1" (\obj -> ((GHC.Base.pure PostTokensRequestBodyAccount'Individual'Dob'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "day")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "year"))}
-- | Create a new 'PostTokensRequestBodyAccount'Individual'Dob'OneOf1' with all required fields.
mkPostTokensRequestBodyAccount'Individual'Dob'OneOf1 :: GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Individual'Dob'OneOf1Day'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Individual'Dob'OneOf1Month'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyAccount'Individual'Dob'OneOf1Year'
  -> PostTokensRequestBodyAccount'Individual'Dob'OneOf1
mkPostTokensRequestBodyAccount'Individual'Dob'OneOf1 postTokensRequestBodyAccount'Individual'Dob'OneOf1Day postTokensRequestBodyAccount'Individual'Dob'OneOf1Month postTokensRequestBodyAccount'Individual'Dob'OneOf1Year = PostTokensRequestBodyAccount'Individual'Dob'OneOf1{postTokensRequestBodyAccount'Individual'Dob'OneOf1Day = postTokensRequestBodyAccount'Individual'Dob'OneOf1Day,
...
data PostTokensRequestBodyAccount'Individual'Dob'Variants =
   PostTokensRequestBodyAccount'Individual'Dob'EmptyString -- ^ Represents the JSON value @""@
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Dob'Variants
    where {toJSON (PostTokensRequestBodyAccount'Individual'Dob'PostTokensRequestBodyAccount'Individual'Dob'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyAccount'Individual'Dob'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'Dob'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyAccount'Individual'Dob'EmptyString
...
data PostTokensRequestBodyAccount'Individual'FullNameAliases'Variants =
   PostTokensRequestBodyAccount'Individual'FullNameAliases'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyAccount'Individual'FullNameAliases'ListTText [Data.Text.Internal.Text]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'FullNameAliases'Variants
    where {toJSON (PostTokensRequestBodyAccount'Individual'FullNameAliases'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyAccount'Individual'FullNameAliases'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'FullNameAliases'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyAccount'Individual'FullNameAliases'EmptyString
...
data PostTokensRequestBodyAccount'Individual'Metadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Metadata'Variants
    where {toJSON (PostTokensRequestBodyAccount'Individual'Metadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyAccount'Individual'Metadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'Metadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyAccount'Individual'Metadata'EmptyString
...
data PostTokensRequestBodyAccount'Individual'PoliticalExposure' =
   PostTokensRequestBodyAccount'Individual'PoliticalExposure'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyAccount'Individual'PoliticalExposure'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyAccount'Individual'PoliticalExposure'EnumExisting -- ^ Represents the JSON value @"existing"@
  | PostTokensRequestBodyAccount'Individual'PoliticalExposure'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'PoliticalExposure'
    where {toJSON (PostTokensRequestBodyAccount'Individual'PoliticalExposure'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'PoliticalExposure'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "existing" -> PostTokensRequestBodyAccount'Individual'PoliticalExposure'EnumExisting
...
data PostTokensRequestBodyAccount'Individual'RegisteredAddress' = PostTokensRequestBodyAccount'Individual'RegisteredAddress' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'RegisteredAddress'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'State obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'RegisteredAddress'State obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'RegisteredAddress'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Individual'RegisteredAddress'" (\obj -> (((((GHC.Base.pure PostTokensRequestBodyAccount'Individual'RegisteredAddress' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPostTokensRequestBodyAccount'Individual'RegisteredAddress' = PostTokensRequestBodyAccount'Individual'RegisteredAddress'{postTokensRequestBodyAccount'Individual'RegisteredAddress'City = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.individual.properties.relationship@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Individual'Relationship' = PostTokensRequestBodyAccount'Individual'Relationship' {
  -- | director
  postTokensRequestBodyAccount'Individual'Relationship'Director :: (GHC.Maybe.Maybe GHC.Types.Bool)
  -- | executive
  , postTokensRequestBodyAccount'Individual'Relationship'Executive :: (GHC.Maybe.Maybe GHC.Types.Bool)
  -- | owner
  , postTokensRequestBodyAccount'Individual'Relationship'Owner :: (GHC.Maybe.Maybe GHC.Types.Bool)
  -- | percent_ownership
  , postTokensRequestBodyAccount'Individual'Relationship'PercentOwnership :: (GHC.Maybe.Maybe PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Variants)
  -- | title
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyAccount'Individual'Relationship'Title :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Relationship'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("director" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Director obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("executive" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Executive obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("owner" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Owner obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("percent_ownership" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'PercentOwnership obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("title" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Title obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("director" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Director obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("executive" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Executive obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("owner" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Owner obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("percent_ownership" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'PercentOwnership obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("title" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyAccount'Individual'Relationship'Title obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'Relationship'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyAccount'Individual'Relationship'" (\obj -> ((((GHC.Base.pure PostTokensRequestBodyAccount'Individual'Relationship' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "director")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "executive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "owner")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "percent_ownership")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "title"))}
-- | Create a new 'PostTokensRequestBodyAccount'Individual'Relationship'' with all required fields.
mkPostTokensRequestBodyAccount'Individual'Relationship' :: PostTokensRequestBodyAccount'Individual'Relationship'
mkPostTokensRequestBodyAccount'Individual'Relationship' = PostTokensRequestBodyAccount'Individual'Relationship'{postTokensRequestBodyAccount'Individual'Relationship'Director = GHC.Maybe.Nothing,
                                                                                                                postTokensRequestBodyAccount'Individual'Relationship'Executive = GHC.Maybe.Nothing,
                                                                                                                postTokensRequestBodyAccount'Individual'Relationship'Owner = GHC.Maybe.Nothing,
                                                                                                                postTokensRequestBodyAccount'Individual'Relationship'PercentOwnership = GHC.Maybe.Nothing,
                                                                                                                postTokensRequestBodyAccount'Individual'Relationship'Title = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.account.properties.individual.properties.relationship.properties.percent_ownership.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Variants =
   PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Double GHC.Types.Double
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Variants
    where {toJSON (PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Double a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyAccount'Individual'Relationship'PercentOwnership'Double Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyAccount'Individual'Verification' = PostTokensRequestBodyAccount'Individual'Verification' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Verification'
...
mkPostTokensRequestBodyAccount'Individual'Verification' = PostTokensRequestBodyAccount'Individual'Verification'{postTokensRequestBodyAccount'Individual'Verification'AdditionalDocument = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'Verification'AdditionalDocument' = PostTokensRequestBodyAccount'Individual'Verification'AdditionalDocument' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Verification'AdditionalDocument'
...
mkPostTokensRequestBodyAccount'Individual'Verification'AdditionalDocument' = PostTokensRequestBodyAccount'Individual'Verification'AdditionalDocument'{postTokensRequestBodyAccount'Individual'Verification'AdditionalDocument'Back = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyAccount'Individual'Verification'Document' = PostTokensRequestBodyAccount'Individual'Verification'Document' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyAccount'Individual'Verification'Document'
...
mkPostTokensRequestBodyAccount'Individual'Verification'Document' = PostTokensRequestBodyAccount'Individual'Verification'Document'{postTokensRequestBodyAccount'Individual'Verification'Document'Back = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyBankAccount' = PostTokensRequestBodyBankAccount' {
  ...
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyBankAccount'PaymentMethod :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | routing_number
  -- 
  -- Constraints:
  -- 
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyBankAccount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_name" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountHolderName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountHolderType obj) : ["account_number" Data.Aeson.Types.ToJSON..= postTokensRequestBodyBankAccount'AccountNumber obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountType obj) : ["country" Data.Aeson.Types.ToJSON..= postTokensRequestBodyBankAccount'Country obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'PaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("routing_number" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'RoutingNumber obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_name" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountHolderName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_holder_type" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountHolderType obj) : ["account_number" Data.Aeson.Types.ToJSON..= postTokensRequestBodyBankAccount'AccountNumber obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_type" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'AccountType obj) : ["country" Data.Aeson.Types.ToJSON..= postTokensRequestBodyBankAccount'Country obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payment_method" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'PaymentMethod obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("routing_number" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyBankAccount'RoutingNumber obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyBankAccount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyBankAccount'" (\obj -> (((((((GHC.Base.pure PostTokensRequestBodyBankAccount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "routing_number"))}
-- | Create a new 'PostTokensRequestBodyBankAccount'' with all required fields.
mkPostTokensRequestBodyBankAccount' :: Data.Text.Internal.Text -- ^ 'postTokensRequestBodyBankAccount'AccountNumber'
  -> Data.Text.Internal.Text -- ^ 'postTokensRequestBodyBankAccount'Country'
  -> PostTokensRequestBodyBankAccount'
mkPostTokensRequestBodyBankAccount' postTokensRequestBodyBankAccount'AccountNumber postTokensRequestBodyBankAccount'Country = PostTokensRequestBodyBankAccount'{postTokensRequestBodyBankAccount'AccountHolderName = GHC.Maybe.Nothing,
                                                                                                                                                                ...
                                                                                                                                                                postTokensRequestBodyBankAccount'PaymentMethod = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyBankAccount'AccountHolderType' =
   PostTokensRequestBodyBankAccount'AccountHolderType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyBankAccount'AccountHolderType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyBankAccount'AccountHolderType'EnumCompany -- ^ Represents the JSON value @"company"@
  | PostTokensRequestBodyBankAccount'AccountHolderType'EnumIndividual -- ^ Represents the JSON value @"individual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyBankAccount'AccountHolderType'
    where {toJSON (PostTokensRequestBodyBankAccount'AccountHolderType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyBankAccount'AccountHolderType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "company" -> PostTokensRequestBodyBankAccount'AccountHolderType'EnumCompany
...
data PostTokensRequestBodyBankAccount'AccountType' =
   PostTokensRequestBodyBankAccount'AccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyBankAccount'AccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyBankAccount'AccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PostTokensRequestBodyBankAccount'AccountType'EnumFutsu -- ^ Represents the JSON value @"futsu"@
  | PostTokensRequestBodyBankAccount'AccountType'EnumSavings -- ^ Represents the JSON value @"savings"@
  | PostTokensRequestBodyBankAccount'AccountType'EnumToza -- ^ Represents the JSON value @"toza"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyBankAccount'AccountType'
    where {toJSON (PostTokensRequestBodyBankAccount'AccountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyBankAccount'AccountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PostTokensRequestBodyBankAccount'AccountType'EnumChecking
...
data PostTokensRequestBodyCard'OneOf1 = PostTokensRequestBodyCard'OneOf1 {
  ...
  -- | networks
  , postTokensRequestBodyCard'OneOf1Networks :: (GHC.Maybe.Maybe PostTokensRequestBodyCard'OneOf1Networks')
  -- | number
  -- 
  -- Constraints:
  -- 
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyCard'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressState obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_zip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressZip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cvc" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Cvc obj) : ["exp_month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1ExpMonth obj] : ["exp_year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1ExpYear obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Name obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("networks" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Networks obj) : ["number" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1Number obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressState obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_zip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1AddressZip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cvc" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Cvc obj) : ["exp_month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1ExpMonth obj] : ["exp_year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1ExpYear obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Name obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("networks" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Networks obj) : ["number" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCard'OneOf1Number obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyCard'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyCard'OneOf1" (\obj -> ((((((((((((GHC.Base.pure PostTokensRequestBodyCard'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_state")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_zip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cvc")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "exp_month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "exp_year")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "networks")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "number"))}
-- | Create a new 'PostTokensRequestBodyCard'OneOf1' with all required fields.
mkPostTokensRequestBodyCard'OneOf1 :: Data.Text.Internal.Text -- ^ 'postTokensRequestBodyCard'OneOf1ExpMonth'
  -> Data.Text.Internal.Text -- ^ 'postTokensRequestBodyCard'OneOf1ExpYear'
  -> Data.Text.Internal.Text -- ^ 'postTokensRequestBodyCard'OneOf1Number'
  -> PostTokensRequestBodyCard'OneOf1
mkPostTokensRequestBodyCard'OneOf1 postTokensRequestBodyCard'OneOf1ExpMonth postTokensRequestBodyCard'OneOf1ExpYear postTokensRequestBodyCard'OneOf1Number = PostTokensRequestBodyCard'OneOf1{postTokensRequestBodyCard'OneOf1AddressCity = GHC.Maybe.Nothing,
                                                                                                                                                                                              ...
                                                                                                                                                                                              postTokensRequestBodyCard'OneOf1Networks = GHC.Maybe.Nothing,
                                                                                                                                                                                              postTokensRequestBodyCard'OneOf1Number = postTokensRequestBodyCard'OneOf1Number}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.card.anyOf.properties.networks@ in the specification.
-- 
-- 
data PostTokensRequestBodyCard'OneOf1Networks' = PostTokensRequestBodyCard'OneOf1Networks' {
  -- | preferred
  postTokensRequestBodyCard'OneOf1Networks'Preferred :: (GHC.Maybe.Maybe PostTokensRequestBodyCard'OneOf1Networks'Preferred')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyCard'OneOf1Networks'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Networks'Preferred obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyCard'OneOf1Networks'Preferred obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyCard'OneOf1Networks'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyCard'OneOf1Networks'" (\obj -> GHC.Base.pure PostTokensRequestBodyCard'OneOf1Networks' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred"))}
-- | Create a new 'PostTokensRequestBodyCard'OneOf1Networks'' with all required fields.
mkPostTokensRequestBodyCard'OneOf1Networks' :: PostTokensRequestBodyCard'OneOf1Networks'
mkPostTokensRequestBodyCard'OneOf1Networks' = PostTokensRequestBodyCard'OneOf1Networks'{postTokensRequestBodyCard'OneOf1Networks'Preferred = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.card.anyOf.properties.networks.properties.preferred@ in the specification.
-- 
-- 
data PostTokensRequestBodyCard'OneOf1Networks'Preferred' =
   PostTokensRequestBodyCard'OneOf1Networks'Preferred'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyCard'OneOf1Networks'Preferred'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyCard'OneOf1Networks'Preferred'
    where {toJSON (PostTokensRequestBodyCard'OneOf1Networks'Preferred'Other val) = val;
           toJSON (PostTokensRequestBodyCard'OneOf1Networks'Preferred'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumCartesBancaires) = "cartes_bancaires";
           toJSON (PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumMastercard) = "mastercard";
           toJSON (PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumVisa) = "visa"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyCard'OneOf1Networks'Preferred'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cartes_bancaires" -> PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumCartesBancaires
                                             | val GHC.Classes.== "mastercard" -> PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumMastercard
                                             | val GHC.Classes.== "visa" -> PostTokensRequestBodyCard'OneOf1Networks'Preferred'EnumVisa
                                             | GHC.Base.otherwise -> PostTokensRequestBodyCard'OneOf1Networks'Preferred'Other val)}
...
data PostTokensRequestBodyCard'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyCard'Variants
    where {toJSON (PostTokensRequestBodyCard'PostTokensRequestBodyCard'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyCard'Text a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyCard'Variants
    where {parseJSON val = case (PostTokensRequestBodyCard'PostTokensRequestBodyCard'OneOf1 Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PostTokensRequestBodyCard'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyCvcUpdate' = PostTokensRequestBodyCvcUpdate' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyCvcUpdate'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["cvc" Data.Aeson.Types.ToJSON..= postTokensRequestBodyCvcUpdate'Cvc obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyCvcUpdate'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyCvcUpdate'" (\obj -> GHC.Base.pure PostTokensRequestBodyCvcUpdate' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "cvc"))}
-- | Create a new 'PostTokensRequestBodyCvcUpdate'' with all required fields.
mkPostTokensRequestBodyCvcUpdate' :: Data.Text.Internal.Text -- ^ 'postTokensRequestBodyCvcUpdate'Cvc'
...
data PostTokensRequestBodyPerson' = PostTokensRequestBodyPerson' {
  ...
  postTokensRequestBodyPerson'AdditionalTosAcceptances :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'AdditionalTosAcceptances')
  -- | address
  ...
  -- | political_exposure
  , postTokensRequestBodyPerson'PoliticalExposure :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'PoliticalExposure')
  -- | registered_address
...
mkPostTokensRequestBodyPerson' = PostTokensRequestBodyPerson'{postTokensRequestBodyPerson'AdditionalTosAcceptances = GHC.Maybe.Nothing,
                                                              ...
                                                              postTokensRequestBodyPerson'UsCfpbData = GHC.Maybe.Nothing,
                                                              postTokensRequestBodyPerson'Verification = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.additional_tos_acceptances@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'AdditionalTosAcceptances' = PostTokensRequestBodyPerson'AdditionalTosAcceptances' {
  -- | account
  postTokensRequestBodyPerson'AdditionalTosAcceptances'Account :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'AdditionalTosAcceptances'" (\obj -> GHC.Base.pure PostTokensRequestBodyPerson'AdditionalTosAcceptances' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account"))}
-- | Create a new 'PostTokensRequestBodyPerson'AdditionalTosAcceptances'' with all required fields.
mkPostTokensRequestBodyPerson'AdditionalTosAcceptances' :: PostTokensRequestBodyPerson'AdditionalTosAcceptances'
mkPostTokensRequestBodyPerson'AdditionalTosAcceptances' = PostTokensRequestBodyPerson'AdditionalTosAcceptances'{postTokensRequestBodyPerson'AdditionalTosAcceptances'Account = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.additional_tos_acceptances.properties.account@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account' = PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account' {
  -- | date
  postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Date :: (GHC.Maybe.Maybe GHC.Types.Int)
  -- | ip
  , postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Ip :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | user_agent
  , postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Variants)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("date" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Date obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Ip obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_agent" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'" (\obj -> ((GHC.Base.pure PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
-- | Create a new 'PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'' with all required fields.
mkPostTokensRequestBodyPerson'AdditionalTosAcceptances'Account' :: PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'
mkPostTokensRequestBodyPerson'AdditionalTosAcceptances'Account' = PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'{postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Date = GHC.Maybe.Nothing,
                                                                                                                                postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'Ip = GHC.Maybe.Nothing,
                                                                                                                                postTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent = GHC.Maybe.Nothing}
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.additional_tos_acceptances.properties.account.properties.user_agent.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Variants =
   PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Variants
    where {toJSON (PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'AdditionalTosAcceptances'Account'UserAgent'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyPerson'Address' = PostTokensRequestBodyPerson'Address' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Address'
...
mkPostTokensRequestBodyPerson'Address' = PostTokensRequestBodyPerson'Address'{postTokensRequestBodyPerson'Address'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'AddressKana' = PostTokensRequestBodyPerson'AddressKana' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'AddressKana'
...
mkPostTokensRequestBodyPerson'AddressKana' = PostTokensRequestBodyPerson'AddressKana'{postTokensRequestBodyPerson'AddressKana'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'AddressKanji' = PostTokensRequestBodyPerson'AddressKanji' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'AddressKanji'
...
mkPostTokensRequestBodyPerson'AddressKanji' = PostTokensRequestBodyPerson'AddressKanji'{postTokensRequestBodyPerson'AddressKanji'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Dob'OneOf1 = PostTokensRequestBodyPerson'Dob'OneOf1 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Dob'OneOf1
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["day" Data.Aeson.Types.ToJSON..= postTokensRequestBodyPerson'Dob'OneOf1Day obj] : ["month" Data.Aeson.Types.ToJSON..= postTokensRequestBodyPerson'Dob'OneOf1Month obj] : ["year" Data.Aeson.Types.ToJSON..= postTokensRequestBodyPerson'Dob'OneOf1Year obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Dob'OneOf1
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Dob'OneOf1" (\obj -> ((GHC.Base.pure PostTokensRequestBodyPerson'Dob'OneOf1 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "day")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "year"))}
-- | Create a new 'PostTokensRequestBodyPerson'Dob'OneOf1' with all required fields.
mkPostTokensRequestBodyPerson'Dob'OneOf1 :: GHC.Types.Int -- ^ 'postTokensRequestBodyPerson'Dob'OneOf1Day'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyPerson'Dob'OneOf1Month'
  -> GHC.Types.Int -- ^ 'postTokensRequestBodyPerson'Dob'OneOf1Year'
  -> PostTokensRequestBodyPerson'Dob'OneOf1
mkPostTokensRequestBodyPerson'Dob'OneOf1 postTokensRequestBodyPerson'Dob'OneOf1Day postTokensRequestBodyPerson'Dob'OneOf1Month postTokensRequestBodyPerson'Dob'OneOf1Year = PostTokensRequestBodyPerson'Dob'OneOf1{postTokensRequestBodyPerson'Dob'OneOf1Day = postTokensRequestBodyPerson'Dob'OneOf1Day,
...
data PostTokensRequestBodyPerson'Dob'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Dob'Variants
    where {toJSON (PostTokensRequestBodyPerson'Dob'PostTokensRequestBodyPerson'Dob'OneOf1 a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Dob'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Dob'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Dob'EmptyString
...
data PostTokensRequestBodyPerson'Documents' = PostTokensRequestBodyPerson'Documents' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("company_authorization" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'CompanyAuthorization obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("passport" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Passport obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("visa" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Visa obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("company_authorization" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'CompanyAuthorization obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("passport" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Passport obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("visa" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Visa obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Documents'" (\obj -> ((GHC.Base.pure PostTokensRequestBodyPerson'Documents' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "company_authorization")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "passport")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "visa"))}
...
mkPostTokensRequestBodyPerson'Documents' = PostTokensRequestBodyPerson'Documents'{postTokensRequestBodyPerson'Documents'CompanyAuthorization = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Documents'CompanyAuthorization' = PostTokensRequestBodyPerson'Documents'CompanyAuthorization' {
  -- | files
  postTokensRequestBodyPerson'Documents'CompanyAuthorization'Files :: (GHC.Maybe.Maybe [PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Variants])
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'CompanyAuthorization'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'CompanyAuthorization'Files obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'CompanyAuthorization'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Documents'CompanyAuthorization'" (\obj -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'CompanyAuthorization' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))}
...
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.documents.properties.company_authorization.properties.files.items.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Variants =
   PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Variants
    where {toJSON (PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'Documents'CompanyAuthorization'Files'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyPerson'Documents'Passport' = PostTokensRequestBodyPerson'Documents'Passport' {
  -- | files
  postTokensRequestBodyPerson'Documents'Passport'Files :: (GHC.Maybe.Maybe [PostTokensRequestBodyPerson'Documents'Passport'Files'Variants])
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'Passport'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Passport'Files obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'Passport'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Documents'Passport'" (\obj -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'Passport' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))}
...
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.documents.properties.passport.properties.files.items.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'Documents'Passport'Files'Variants =
   PostTokensRequestBodyPerson'Documents'Passport'Files'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyPerson'Documents'Passport'Files'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'Passport'Files'Variants
    where {toJSON (PostTokensRequestBodyPerson'Documents'Passport'Files'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Documents'Passport'Files'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'Passport'Files'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'Passport'Files'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'Documents'Passport'Files'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyPerson'Documents'Visa' = PostTokensRequestBodyPerson'Documents'Visa' {
  -- | files
  postTokensRequestBodyPerson'Documents'Visa'Files :: (GHC.Maybe.Maybe [PostTokensRequestBodyPerson'Documents'Visa'Files'Variants])
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'Visa'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("files" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Documents'Visa'Files obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'Visa'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Documents'Visa'" (\obj -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'Visa' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "files"))}
...
-- | Defines the oneOf schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.documents.properties.visa.properties.files.items.anyOf@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'Documents'Visa'Files'Variants =
   PostTokensRequestBodyPerson'Documents'Visa'Files'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyPerson'Documents'Visa'Files'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Documents'Visa'Files'Variants
    where {toJSON (PostTokensRequestBodyPerson'Documents'Visa'Files'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Documents'Visa'Files'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Documents'Visa'Files'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Documents'Visa'Files'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'Documents'Visa'Files'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PostTokensRequestBodyPerson'FullNameAliases'Variants =
   PostTokensRequestBodyPerson'FullNameAliases'EmptyString -- ^ Represents the JSON value @""@
  | PostTokensRequestBodyPerson'FullNameAliases'ListTText [Data.Text.Internal.Text]
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'FullNameAliases'Variants
    where {toJSON (PostTokensRequestBodyPerson'FullNameAliases'ListTText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'FullNameAliases'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'FullNameAliases'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'FullNameAliases'EmptyString
...
data PostTokensRequestBodyPerson'Metadata'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Metadata'Variants
    where {toJSON (PostTokensRequestBodyPerson'Metadata'Object a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Metadata'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Metadata'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Metadata'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'Metadata'Object Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the enum schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.political_exposure@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'PoliticalExposure' =
   PostTokensRequestBodyPerson'PoliticalExposure'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyPerson'PoliticalExposure'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyPerson'PoliticalExposure'EnumExisting -- ^ Represents the JSON value @"existing"@
  | PostTokensRequestBodyPerson'PoliticalExposure'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'PoliticalExposure'
    where {toJSON (PostTokensRequestBodyPerson'PoliticalExposure'Other val) = val;
           toJSON (PostTokensRequestBodyPerson'PoliticalExposure'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTokensRequestBodyPerson'PoliticalExposure'EnumExisting) = "existing";
           toJSON (PostTokensRequestBodyPerson'PoliticalExposure'EnumNone) = "none"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'PoliticalExposure'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "existing" -> PostTokensRequestBodyPerson'PoliticalExposure'EnumExisting
                                             | val GHC.Classes.== "none" -> PostTokensRequestBodyPerson'PoliticalExposure'EnumNone
                                             | GHC.Base.otherwise -> PostTokensRequestBodyPerson'PoliticalExposure'Other val)}
...
data PostTokensRequestBodyPerson'RegisteredAddress' = PostTokensRequestBodyPerson'RegisteredAddress' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'RegisteredAddress'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'State obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'City obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Country obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Line1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'Line2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'PostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'RegisteredAddress'State obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'RegisteredAddress'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'RegisteredAddress'" (\obj -> (((((GHC.Base.pure PostTokensRequestBodyPerson'RegisteredAddress' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPostTokensRequestBodyPerson'RegisteredAddress' = PostTokensRequestBodyPerson'RegisteredAddress'{postTokensRequestBodyPerson'RegisteredAddress'City = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Relationship' = PostTokensRequestBodyPerson'Relationship' {
  -- | authorizer
  postTokensRequestBodyPerson'Relationship'Authorizer :: (GHC.Maybe.Maybe GHC.Types.Bool)
  -- | director
  ...
  -- | legal_guardian
  , postTokensRequestBodyPerson'Relationship'LegalGuardian :: (GHC.Maybe.Maybe GHC.Types.Bool)
  -- | owner
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Relationship'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("authorizer" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Authorizer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("director" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Director obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("executive" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Executive obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("legal_guardian" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'LegalGuardian obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("owner" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Owner obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("percent_ownership" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'PercentOwnership obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("representative" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Representative obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("title" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Title obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("authorizer" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Authorizer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("director" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Director obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("executive" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Executive obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("legal_guardian" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'LegalGuardian obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("owner" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Owner obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("percent_ownership" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'PercentOwnership obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("representative" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Representative obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("title" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'Relationship'Title obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Relationship'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'Relationship'" (\obj -> (((((((GHC.Base.pure PostTokensRequestBodyPerson'Relationship' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "authorizer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "director")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "executive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "legal_guardian")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "owner")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "percent_ownership")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "representative")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "title"))}
...
mkPostTokensRequestBodyPerson'Relationship' = PostTokensRequestBodyPerson'Relationship'{postTokensRequestBodyPerson'Relationship'Authorizer = GHC.Maybe.Nothing,
                                                                                        ...
                                                                                        postTokensRequestBodyPerson'Relationship'LegalGuardian = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Relationship'PercentOwnership'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Relationship'PercentOwnership'Variants
    where {toJSON (PostTokensRequestBodyPerson'Relationship'PercentOwnership'Double a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTokensRequestBodyPerson'Relationship'PercentOwnership'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'Relationship'PercentOwnership'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTokensRequestBodyPerson'Relationship'PercentOwnership'EmptyString
                              | GHC.Base.otherwise -> case (PostTokensRequestBodyPerson'Relationship'PercentOwnership'Double Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.us_cfpb_data@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'UsCfpbData' = PostTokensRequestBodyPerson'UsCfpbData' {
  -- | ethnicity_details
  postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails')
  -- | race_details
  , postTokensRequestBodyPerson'UsCfpbData'RaceDetails :: (GHC.Maybe.Maybe PostTokensRequestBodyPerson'UsCfpbData'RaceDetails')
  -- | self_identified_gender
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyPerson'UsCfpbData'SelfIdentifiedGender :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'UsCfpbData'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_details" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_details" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("self_identified_gender" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'SelfIdentifiedGender obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_details" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_details" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("self_identified_gender" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'SelfIdentifiedGender obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'UsCfpbData'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'UsCfpbData'" (\obj -> ((GHC.Base.pure PostTokensRequestBodyPerson'UsCfpbData' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "self_identified_gender"))}
-- | Create a new 'PostTokensRequestBodyPerson'UsCfpbData'' with all required fields.
mkPostTokensRequestBodyPerson'UsCfpbData' :: PostTokensRequestBodyPerson'UsCfpbData'
mkPostTokensRequestBodyPerson'UsCfpbData' = PostTokensRequestBodyPerson'UsCfpbData'{postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails = GHC.Maybe.Nothing,
                                                                                    postTokensRequestBodyPerson'UsCfpbData'RaceDetails = GHC.Maybe.Nothing,
                                                                                    postTokensRequestBodyPerson'UsCfpbData'SelfIdentifiedGender = GHC.Maybe.Nothing}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.us_cfpb_data.properties.ethnicity_details@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails' = PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails' {
  -- | ethnicity
  postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity :: (GHC.Maybe.Maybe [PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'])
  -- | ethnicity_other
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'EthnicityOther :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_other" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'EthnicityOther obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_other" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'EthnicityOther obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'" (\obj -> (GHC.Base.pure PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity_other"))}
-- | Create a new 'PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'' with all required fields.
mkPostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails' :: PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'
mkPostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails' = PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'{postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity = GHC.Maybe.Nothing,
                                                                                                                      postTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'EthnicityOther = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.us_cfpb_data.properties.ethnicity_details.properties.ethnicity.items@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity' =
   PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumCuban -- ^ Represents the JSON value @"cuban"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumHispanicOrLatino -- ^ Represents the JSON value @"hispanic_or_latino"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumMexican -- ^ Represents the JSON value @"mexican"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumNotHispanicOrLatino -- ^ Represents the JSON value @"not_hispanic_or_latino"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumOtherHispanicOrLatino -- ^ Represents the JSON value @"other_hispanic_or_latino"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPreferNotToAnswer -- ^ Represents the JSON value @"prefer_not_to_answer"@
  | PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPuertoRican -- ^ Represents the JSON value @"puerto_rican"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'
    where {toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'Other val) = val;
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumCuban) = "cuban";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumHispanicOrLatino) = "hispanic_or_latino";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumMexican) = "mexican";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumNotHispanicOrLatino) = "not_hispanic_or_latino";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumOtherHispanicOrLatino) = "other_hispanic_or_latino";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPreferNotToAnswer) = "prefer_not_to_answer";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPuertoRican) = "puerto_rican"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cuban" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumCuban
                                             | val GHC.Classes.== "hispanic_or_latino" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumHispanicOrLatino
                                             | val GHC.Classes.== "mexican" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumMexican
                                             | val GHC.Classes.== "not_hispanic_or_latino" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumNotHispanicOrLatino
                                             | val GHC.Classes.== "other_hispanic_or_latino" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumOtherHispanicOrLatino
                                             | val GHC.Classes.== "prefer_not_to_answer" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPreferNotToAnswer
                                             | val GHC.Classes.== "puerto_rican" -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'EnumPuertoRican
                                             | GHC.Base.otherwise -> PostTokensRequestBodyPerson'UsCfpbData'EthnicityDetails'Ethnicity'Other val)}
-- | Defines the object schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.us_cfpb_data.properties.race_details@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'UsCfpbData'RaceDetails' = PostTokensRequestBodyPerson'UsCfpbData'RaceDetails' {
  -- | race
  postTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race :: (GHC.Maybe.Maybe [PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'])
  -- | race_other
  -- 
  -- Constraints:
  -- 
  -- * Maximum length of 5000
  , postTokensRequestBodyPerson'UsCfpbData'RaceDetails'RaceOther :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_other" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails'RaceOther obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_other" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPerson'UsCfpbData'RaceDetails'RaceOther obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'" (\obj -> (GHC.Base.pure PostTokensRequestBodyPerson'UsCfpbData'RaceDetails' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race_other"))}
-- | Create a new 'PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'' with all required fields.
mkPostTokensRequestBodyPerson'UsCfpbData'RaceDetails' :: PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'
mkPostTokensRequestBodyPerson'UsCfpbData'RaceDetails' = PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'{postTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race = GHC.Maybe.Nothing,
                                                                                                            postTokensRequestBodyPerson'UsCfpbData'RaceDetails'RaceOther = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @paths.\/v1\/tokens.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.person.properties.us_cfpb_data.properties.race_details.properties.race.items@ in the specification.
-- 
-- 
data PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race' =
   PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAfricanAmerican -- ^ Represents the JSON value @"african_american"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAmericanIndianOrAlaskaNative -- ^ Represents the JSON value @"american_indian_or_alaska_native"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsian -- ^ Represents the JSON value @"asian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsianIndian -- ^ Represents the JSON value @"asian_indian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumBlackOrAfricanAmerican -- ^ Represents the JSON value @"black_or_african_american"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumChinese -- ^ Represents the JSON value @"chinese"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumEthiopian -- ^ Represents the JSON value @"ethiopian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumFilipino -- ^ Represents the JSON value @"filipino"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumGuamanianOrChamorro -- ^ Represents the JSON value @"guamanian_or_chamorro"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumHaitian -- ^ Represents the JSON value @"haitian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJamaican -- ^ Represents the JSON value @"jamaican"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJapanese -- ^ Represents the JSON value @"japanese"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumKorean -- ^ Represents the JSON value @"korean"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiian -- ^ Represents the JSON value @"native_hawaiian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiianOrOtherPacificIslander -- ^ Represents the JSON value @"native_hawaiian_or_other_pacific_islander"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNigerian -- ^ Represents the JSON value @"nigerian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherAsian -- ^ Represents the JSON value @"other_asian"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherBlackOrAfricanAmerican -- ^ Represents the JSON value @"other_black_or_african_american"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherPacificIslander -- ^ Represents the JSON value @"other_pacific_islander"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumPreferNotToAnswer -- ^ Represents the JSON value @"prefer_not_to_answer"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSamoan -- ^ Represents the JSON value @"samoan"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSomali -- ^ Represents the JSON value @"somali"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumVietnamese -- ^ Represents the JSON value @"vietnamese"@
  | PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumWhite -- ^ Represents the JSON value @"white"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'
    where {toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'Other val) = val;
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAfricanAmerican) = "african_american";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAmericanIndianOrAlaskaNative) = "american_indian_or_alaska_native";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsian) = "asian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsianIndian) = "asian_indian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumBlackOrAfricanAmerican) = "black_or_african_american";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumChinese) = "chinese";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumEthiopian) = "ethiopian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumFilipino) = "filipino";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumGuamanianOrChamorro) = "guamanian_or_chamorro";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumHaitian) = "haitian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJamaican) = "jamaican";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJapanese) = "japanese";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumKorean) = "korean";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiian) = "native_hawaiian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiianOrOtherPacificIslander) = "native_hawaiian_or_other_pacific_islander";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNigerian) = "nigerian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherAsian) = "other_asian";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherBlackOrAfricanAmerican) = "other_black_or_african_american";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherPacificIslander) = "other_pacific_islander";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumPreferNotToAnswer) = "prefer_not_to_answer";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSamoan) = "samoan";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSomali) = "somali";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumVietnamese) = "vietnamese";
           toJSON (PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumWhite) = "white"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "african_american" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAfricanAmerican
                                             | val GHC.Classes.== "american_indian_or_alaska_native" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAmericanIndianOrAlaskaNative
                                             | val GHC.Classes.== "asian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsian
                                             | val GHC.Classes.== "asian_indian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumAsianIndian
                                             | val GHC.Classes.== "black_or_african_american" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumBlackOrAfricanAmerican
                                             | val GHC.Classes.== "chinese" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumChinese
                                             | val GHC.Classes.== "ethiopian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumEthiopian
                                             | val GHC.Classes.== "filipino" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumFilipino
                                             | val GHC.Classes.== "guamanian_or_chamorro" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumGuamanianOrChamorro
                                             | val GHC.Classes.== "haitian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumHaitian
                                             | val GHC.Classes.== "jamaican" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJamaican
                                             | val GHC.Classes.== "japanese" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumJapanese
                                             | val GHC.Classes.== "korean" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumKorean
                                             | val GHC.Classes.== "native_hawaiian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiian
                                             | val GHC.Classes.== "native_hawaiian_or_other_pacific_islander" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNativeHawaiianOrOtherPacificIslander
                                             | val GHC.Classes.== "nigerian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumNigerian
                                             | val GHC.Classes.== "other_asian" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherAsian
                                             | val GHC.Classes.== "other_black_or_african_american" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherBlackOrAfricanAmerican
                                             | val GHC.Classes.== "other_pacific_islander" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumOtherPacificIslander
                                             | val GHC.Classes.== "prefer_not_to_answer" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumPreferNotToAnswer
                                             | val GHC.Classes.== "samoan" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSamoan
                                             | val GHC.Classes.== "somali" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumSomali
                                             | val GHC.Classes.== "vietnamese" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumVietnamese
                                             | val GHC.Classes.== "white" -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'EnumWhite
                                             | GHC.Base.otherwise -> PostTokensRequestBodyPerson'UsCfpbData'RaceDetails'Race'Other val)}
...
data PostTokensRequestBodyPerson'Verification' = PostTokensRequestBodyPerson'Verification' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Verification'
...
mkPostTokensRequestBodyPerson'Verification' = PostTokensRequestBodyPerson'Verification'{postTokensRequestBodyPerson'Verification'AdditionalDocument = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Verification'AdditionalDocument' = PostTokensRequestBodyPerson'Verification'AdditionalDocument' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Verification'AdditionalDocument'
...
mkPostTokensRequestBodyPerson'Verification'AdditionalDocument' = PostTokensRequestBodyPerson'Verification'AdditionalDocument'{postTokensRequestBodyPerson'Verification'AdditionalDocument'Back = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPerson'Verification'Document' = PostTokensRequestBodyPerson'Verification'Document' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPerson'Verification'Document'
...
mkPostTokensRequestBodyPerson'Verification'Document' = PostTokensRequestBodyPerson'Verification'Document'{postTokensRequestBodyPerson'Verification'Document'Back = GHC.Maybe.Nothing,
...
data PostTokensRequestBodyPii' = PostTokensRequestBodyPii' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTokensRequestBodyPii'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id_number" Data.Aeson.Types.ToJSON..=)) (postTokensRequestBodyPii'IdNumber obj) : GHC.Base.mempty));
