...
postTreasuryFinancialAccounts body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTreasuryFinancialAccountsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryFinancialAccountsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                   Treasury'financialAccount)
                                                                                                                                                                                             | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryFinancialAccountsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                     Error)
                                                                                                                                                                                             | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/treasury/financial_accounts" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTreasuryFinancialAccountsRequestBody = PostTreasuryFinancialAccountsRequestBody {
  ...
  , postTreasuryFinancialAccountsRequestBodyNickname :: (GHC.Maybe.Maybe PostTreasuryFinancialAccountsRequestBodyNickname'Variants)
...
mkPostTreasuryFinancialAccountsRequestBody postTreasuryFinancialAccountsRequestBodySupportedCurrencies = PostTreasuryFinancialAccountsRequestBody{postTreasuryFinancialAccountsRequestBodyExpand = GHC.Maybe.Nothing,
                                                                                                                                                  ...
                                                                                                                                                  postTreasuryFinancialAccountsRequestBodyNickname = GHC.Maybe.Nothing,
...
-- | Defines the oneOf schema located at @paths.\/v1\/treasury\/financial_accounts.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.nickname.anyOf@ in the specification.
-- 
-- The nickname for the FinancialAccount.
data PostTreasuryFinancialAccountsRequestBodyNickname'Variants =
   PostTreasuryFinancialAccountsRequestBodyNickname'EmptyString -- ^ Represents the JSON value @""@
  | PostTreasuryFinancialAccountsRequestBodyNickname'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryFinancialAccountsRequestBodyNickname'Variants
    where {toJSON (PostTreasuryFinancialAccountsRequestBodyNickname'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTreasuryFinancialAccountsRequestBodyNickname'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryFinancialAccountsRequestBodyNickname'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTreasuryFinancialAccountsRequestBodyNickname'EmptyString
                              | GHC.Base.otherwise -> case (PostTreasuryFinancialAccountsRequestBodyNickname'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
