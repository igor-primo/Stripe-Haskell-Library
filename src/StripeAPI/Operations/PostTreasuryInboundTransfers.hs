...
postTreasuryInboundTransfers :: forall m . StripeAPI.Common.MonadHTTP m => PostTreasuryInboundTransfersRequestBody -- ^ The request body to send
  -> StripeAPI.Common.ClientT m (Network.HTTP.Client.Types.Response PostTreasuryInboundTransfersResponse) -- ^ Monadic computation which returns the result of the operation
postTreasuryInboundTransfers body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTreasuryInboundTransfersResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryInboundTransfersResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                                                                Treasury'inboundTransfer)
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryInboundTransfersResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/treasury/inbound_transfers" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryInboundTransfersRequestBody
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTreasuryInboundTransfersRequestBody" (\obj -> (((((((GHC.Base.pure PostTreasuryInboundTransfersRequestBody GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "financial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "origin_payment_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor"))}
-- | Create a new 'PostTreasuryInboundTransfersRequestBody' with all required fields.
mkPostTreasuryInboundTransfersRequestBody :: GHC.Types.Int -- ^ 'postTreasuryInboundTransfersRequestBodyAmount'
  -> Data.Text.Internal.Text -- ^ 'postTreasuryInboundTransfersRequestBodyCurrency'
  -> Data.Text.Internal.Text -- ^ 'postTreasuryInboundTransfersRequestBodyFinancialAccount'
  -> Data.Text.Internal.Text -- ^ 'postTreasuryInboundTransfersRequestBodyOriginPaymentMethod'
  -> PostTreasuryInboundTransfersRequestBody
mkPostTreasuryInboundTransfersRequestBody postTreasuryInboundTransfersRequestBodyAmount postTreasuryInboundTransfersRequestBodyCurrency postTreasuryInboundTransfersRequestBodyFinancialAccount postTreasuryInboundTransfersRequestBodyOriginPaymentMethod = PostTreasuryInboundTransfersRequestBody{postTreasuryInboundTransfersRequestBodyAmount = postTreasuryInboundTransfersRequestBodyAmount,
...
data PostTreasuryInboundTransfersResponse =
   PostTreasuryInboundTransfersResponseError GHC.Base.String -- ^ Means either no matching case available or a parse error
  | PostTreasuryInboundTransfersResponse200 Treasury'inboundTransfer -- ^ Successful response.
  | PostTreasuryInboundTransfersResponseDefault Error -- ^ Error response.
