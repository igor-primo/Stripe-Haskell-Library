...
postTreasuryOutboundPayments body = GHC.Base.fmap (\response_0 -> GHC.Base.fmap (Data.Either.either PostTreasuryOutboundPaymentsResponseError GHC.Base.id GHC.Base.. (\response body -> if | (\status_1 -> Network.HTTP.Types.Status.statusCode status_1 GHC.Classes.== 200) (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryOutboundPaymentsResponse200 Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                           ...
                                                                                                                                                                                           | GHC.Base.const GHC.Types.True (Network.HTTP.Client.Types.responseStatus response) -> PostTreasuryOutboundPaymentsResponseDefault Data.Functor.<$> (Data.Aeson.Decoding.eitherDecodeStrict body :: Data.Either.Either GHC.Base.String
                                                                                                                                                                                                                                                                                                                                                                                                                  Error)
                                                                                                                                                                                           | GHC.Base.otherwise -> Data.Either.Left "Missing default response type") response_0) response_0) (StripeAPI.Common.doBodyCallWithConfigurationM (Data.Text.toUpper GHC.Base.$ Data.Text.Internal.pack "POST") "/v1/treasury/outbound_payments" GHC.Base.mempty (GHC.Maybe.Just body) StripeAPI.Common.RequestBodyEncodingFormData)
...
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails' = PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails' {
  ...
  -- | name
  , postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name :: (GHC.Maybe.Maybe PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Variants)
  -- | phone
  , postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone :: (GHC.Maybe.Maybe PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Variants)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Email'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Email'EmptyString
                              | GHC.Base.otherwise -> case (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Email'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/treasury\/outbound_payments.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.destination_payment_method_data.properties.billing_details.properties.name.anyOf@ in the specification.
-- 
-- 
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Variants =
   PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'EmptyString -- ^ Represents the JSON value @""@
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Variants
    where {toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'EmptyString
                              | GHC.Base.otherwise -> case (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Name'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the oneOf schema located at @paths.\/v1\/treasury\/outbound_payments.POST.requestBody.content.application\/x-www-form-urlencoded.schema.properties.destination_payment_method_data.properties.billing_details.properties.phone.anyOf@ in the specification.
-- 
-- 
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Variants =
   PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'EmptyString -- ^ Represents the JSON value @""@
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Text Data.Text.Internal.Text
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Variants
    where {toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'EmptyString) = ""}
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'EmptyString
                              | GHC.Base.otherwise -> case (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodData'BillingDetails'Phone'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
-- 
-- 
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network = PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network {
  -- | network
  postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork :: (GHC.Maybe.Maybe PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork')
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network" (\obj -> GHC.Base.pure PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network"))}
-- | Create a new 'PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network' with all required fields.
mkPostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network :: PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network
mkPostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network = PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network{postTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork = GHC.Maybe.Nothing}
...
-- 
-- 
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork' =
   PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumAch -- ^ Represents the JSON value @"ach"@
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumUsDomesticWire -- ^ Represents the JSON value @"us_domestic_wire"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'
    where {toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'Other val) = val;
           toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumAch) = "ach";
           toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumUsDomesticWire) = "us_domestic_wire"}
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumAch
                                             | val GHC.Classes.== "us_domestic_wire" -> PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'EnumUsDomesticWire
                                             | GHC.Base.otherwise -> PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'NetworkNetwork'Other val)}
...
data PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Variants =
  ...
  | PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Variants
    where {toJSON (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Variants
    where {parseJSON val = if | val GHC.Classes.== "" -> GHC.Base.pure PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'EmptyString
                              | GHC.Base.otherwise -> case (PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'PostTreasuryOutboundPaymentsRequestBodyDestinationPaymentMethodOptions'UsBankAccount'Network Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched" of
                                                      {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                                                       Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
