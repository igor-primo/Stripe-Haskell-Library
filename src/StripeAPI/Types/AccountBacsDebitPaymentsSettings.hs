...
data AccountBacsDebitPaymentsSettings = AccountBacsDebitPaymentsSettings {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountBacsDebitPaymentsSettings
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountBacsDebitPaymentsSettings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountBacsDebitPaymentsSettings" (\obj -> (GHC.Base.pure AccountBacsDebitPaymentsSettings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "display_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "service_user_number"))}
