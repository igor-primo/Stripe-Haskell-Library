...
data AccountBrandingSettings = AccountBrandingSettings {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountBrandingSettings
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountBrandingSettings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountBrandingSettings" (\obj -> (((GHC.Base.pure AccountBrandingSettings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "icon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "logo")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "primary_color")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "secondary_color"))}
-- | Create a new 'AccountBrandingSettings' with all required fields.
mkAccountBrandingSettings :: AccountBrandingSettings
mkAccountBrandingSettings = AccountBrandingSettings{accountBrandingSettingsIcon = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON AccountBrandingSettingsIcon'NonNullableVariants
    where {toJSON (AccountBrandingSettingsIcon'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (AccountBrandingSettingsIcon'NonNullableFile a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON AccountBrandingSettingsIcon'NonNullableVariants
    where {parseJSON val = case (AccountBrandingSettingsIcon'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((AccountBrandingSettingsIcon'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data AccountBrandingSettingsLogo'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountBrandingSettingsLogo'NonNullableVariants
    where {toJSON (AccountBrandingSettingsLogo'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (AccountBrandingSettingsLogo'NonNullableFile a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON AccountBrandingSettingsLogo'NonNullableVariants
    where {parseJSON val = case (AccountBrandingSettingsLogo'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((AccountBrandingSettingsLogo'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
