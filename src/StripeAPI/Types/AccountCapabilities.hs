...
data AccountCapabilitiesAlmaPayments' =
   AccountCapabilitiesAlmaPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesAlmaPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesAlmaPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesAlmaPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesAlmaPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesAlmaPayments'
    where {toJSON (AccountCapabilitiesAlmaPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesAlmaPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesAlmaPayments'EnumActive
...
data AccountCapabilitiesAmazonPayPayments' =
   AccountCapabilitiesAmazonPayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesAmazonPayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesAmazonPayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesAmazonPayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesAmazonPayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesAmazonPayPayments'
    where {toJSON (AccountCapabilitiesAmazonPayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesAmazonPayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesAmazonPayPayments'EnumActive
...
data AccountCapabilitiesBilliePayments' =
   AccountCapabilitiesBilliePayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesBilliePayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesBilliePayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesBilliePayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesBilliePayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesBilliePayments'
    where {toJSON (AccountCapabilitiesBilliePayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesBilliePayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesBilliePayments'EnumActive
...
data AccountCapabilitiesBlikPayments' =
   AccountCapabilitiesBlikPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesBlikPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesBlikPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesBlikPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesBlikPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesBlikPayments'
    where {toJSON (AccountCapabilitiesBlikPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesBlikPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesBlikPayments'EnumActive
...
data AccountCapabilitiesCashappPayments' =
   AccountCapabilitiesCashappPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesCashappPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesCashappPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesCashappPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesCashappPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesCashappPayments'
    where {toJSON (AccountCapabilitiesCashappPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesCashappPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesCashappPayments'EnumActive
...
data AccountCapabilitiesCryptoPayments' =
   AccountCapabilitiesCryptoPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesCryptoPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesCryptoPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesCryptoPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesCryptoPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesCryptoPayments'
    where {toJSON (AccountCapabilitiesCryptoPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesCryptoPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesCryptoPayments'EnumActive
...
data AccountCapabilitiesGbBankTransferPayments' =
   AccountCapabilitiesGbBankTransferPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesGbBankTransferPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesGbBankTransferPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesGbBankTransferPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesGbBankTransferPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesGbBankTransferPayments'
    where {toJSON (AccountCapabilitiesGbBankTransferPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesGbBankTransferPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesGbBankTransferPayments'EnumActive
...
data AccountCapabilitiesIndiaInternationalPayments' =
   AccountCapabilitiesIndiaInternationalPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesIndiaInternationalPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesIndiaInternationalPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesIndiaInternationalPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesIndiaInternationalPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesIndiaInternationalPayments'
    where {toJSON (AccountCapabilitiesIndiaInternationalPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesIndiaInternationalPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesIndiaInternationalPayments'EnumActive
...
data AccountCapabilitiesJpBankTransferPayments' =
   AccountCapabilitiesJpBankTransferPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesJpBankTransferPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesJpBankTransferPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesJpBankTransferPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesJpBankTransferPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesJpBankTransferPayments'
    where {toJSON (AccountCapabilitiesJpBankTransferPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesJpBankTransferPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesJpBankTransferPayments'EnumActive
...
data AccountCapabilitiesKakaoPayPayments' =
   AccountCapabilitiesKakaoPayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesKakaoPayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesKakaoPayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesKakaoPayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesKakaoPayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesKakaoPayPayments'
    where {toJSON (AccountCapabilitiesKakaoPayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesKakaoPayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesKakaoPayPayments'EnumActive
...
data AccountCapabilitiesKrCardPayments' =
   AccountCapabilitiesKrCardPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesKrCardPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesKrCardPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesKrCardPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesKrCardPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesKrCardPayments'
    where {toJSON (AccountCapabilitiesKrCardPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesKrCardPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesKrCardPayments'EnumActive
...
data AccountCapabilitiesMobilepayPayments' =
   AccountCapabilitiesMobilepayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesMobilepayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesMobilepayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesMobilepayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesMobilepayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesMobilepayPayments'
    where {toJSON (AccountCapabilitiesMobilepayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesMobilepayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesMobilepayPayments'EnumActive
...
data AccountCapabilitiesMultibancoPayments' =
   AccountCapabilitiesMultibancoPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesMultibancoPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesMultibancoPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesMultibancoPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesMultibancoPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesMultibancoPayments'
    where {toJSON (AccountCapabilitiesMultibancoPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesMultibancoPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesMultibancoPayments'EnumActive
...
data AccountCapabilitiesMxBankTransferPayments' =
   AccountCapabilitiesMxBankTransferPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesMxBankTransferPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesMxBankTransferPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesMxBankTransferPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesMxBankTransferPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesMxBankTransferPayments'
    where {toJSON (AccountCapabilitiesMxBankTransferPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesMxBankTransferPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesMxBankTransferPayments'EnumActive
...
data AccountCapabilitiesNaverPayPayments' =
   AccountCapabilitiesNaverPayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesNaverPayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesNaverPayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesNaverPayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesNaverPayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesNaverPayPayments'
    where {toJSON (AccountCapabilitiesNaverPayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesNaverPayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesNaverPayPayments'EnumActive
...
data AccountCapabilitiesNzBankAccountBecsDebitPayments' =
   AccountCapabilitiesNzBankAccountBecsDebitPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesNzBankAccountBecsDebitPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesNzBankAccountBecsDebitPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesNzBankAccountBecsDebitPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesNzBankAccountBecsDebitPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesNzBankAccountBecsDebitPayments'
    where {toJSON (AccountCapabilitiesNzBankAccountBecsDebitPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesNzBankAccountBecsDebitPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesNzBankAccountBecsDebitPayments'EnumActive
...
data AccountCapabilitiesPayByBankPayments' =
   AccountCapabilitiesPayByBankPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesPayByBankPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesPayByBankPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesPayByBankPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesPayByBankPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesPayByBankPayments'
    where {toJSON (AccountCapabilitiesPayByBankPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesPayByBankPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesPayByBankPayments'EnumActive
...
data AccountCapabilitiesPaycoPayments' =
   AccountCapabilitiesPaycoPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesPaycoPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesPaycoPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesPaycoPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesPaycoPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesPaycoPayments'
    where {toJSON (AccountCapabilitiesPaycoPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesPaycoPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesPaycoPayments'EnumActive
...
data AccountCapabilitiesPixPayments' =
   AccountCapabilitiesPixPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesPixPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesPixPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesPixPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesPixPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesPixPayments'
    where {toJSON (AccountCapabilitiesPixPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesPixPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesPixPayments'EnumActive
...
data AccountCapabilitiesRevolutPayPayments' =
   AccountCapabilitiesRevolutPayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesRevolutPayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesRevolutPayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesRevolutPayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesRevolutPayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesRevolutPayPayments'
    where {toJSON (AccountCapabilitiesRevolutPayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesRevolutPayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesRevolutPayPayments'EnumActive
...
data AccountCapabilitiesSamsungPayPayments' =
   AccountCapabilitiesSamsungPayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesSamsungPayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesSamsungPayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesSamsungPayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesSamsungPayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesSamsungPayPayments'
    where {toJSON (AccountCapabilitiesSamsungPayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesSamsungPayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesSamsungPayPayments'EnumActive
...
data AccountCapabilitiesSatispayPayments' =
   AccountCapabilitiesSatispayPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesSatispayPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesSatispayPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesSatispayPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesSatispayPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesSatispayPayments'
    where {toJSON (AccountCapabilitiesSatispayPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesSatispayPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesSatispayPayments'EnumActive
...
data AccountCapabilitiesSepaBankTransferPayments' =
   AccountCapabilitiesSepaBankTransferPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesSepaBankTransferPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesSepaBankTransferPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesSepaBankTransferPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesSepaBankTransferPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesSepaBankTransferPayments'
    where {toJSON (AccountCapabilitiesSepaBankTransferPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesSepaBankTransferPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesSepaBankTransferPayments'EnumActive
...
data AccountCapabilitiesSwishPayments' =
   AccountCapabilitiesSwishPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesSwishPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesSwishPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesSwishPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesSwishPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesSwishPayments'
    where {toJSON (AccountCapabilitiesSwishPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesSwishPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesSwishPayments'EnumActive
...
data AccountCapabilitiesTwintPayments' =
   AccountCapabilitiesTwintPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesTwintPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesTwintPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesTwintPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesTwintPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesTwintPayments'
    where {toJSON (AccountCapabilitiesTwintPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesTwintPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesTwintPayments'EnumActive
...
data AccountCapabilitiesUsBankTransferPayments' =
   AccountCapabilitiesUsBankTransferPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesUsBankTransferPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesUsBankTransferPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesUsBankTransferPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesUsBankTransferPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesUsBankTransferPayments'
    where {toJSON (AccountCapabilitiesUsBankTransferPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesUsBankTransferPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesUsBankTransferPayments'EnumActive
...
data AccountCapabilitiesZipPayments' =
   AccountCapabilitiesZipPayments'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountCapabilitiesZipPayments'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountCapabilitiesZipPayments'EnumActive -- ^ Represents the JSON value @"active"@
  | AccountCapabilitiesZipPayments'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | AccountCapabilitiesZipPayments'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCapabilitiesZipPayments'
    where {toJSON (AccountCapabilitiesZipPayments'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCapabilitiesZipPayments'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> AccountCapabilitiesZipPayments'EnumActive
