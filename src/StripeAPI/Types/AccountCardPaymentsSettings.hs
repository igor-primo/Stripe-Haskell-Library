...
data AccountCardPaymentsSettings = AccountCardPaymentsSettings {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountCardPaymentsSettings
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountCardPaymentsSettings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountCardPaymentsSettings" (\obj -> (((GHC.Base.pure AccountCardPaymentsSettings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "decline_on")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor_prefix")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor_prefix_kana")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "statement_descriptor_prefix_kanji"))}
...
mkAccountCardPaymentsSettings = AccountCardPaymentsSettings{accountCardPaymentsSettingsDeclineOn = GHC.Maybe.Nothing,
