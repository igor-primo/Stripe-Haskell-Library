...
data AccountRequirements = AccountRequirements {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountRequirements
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountRequirements
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountRequirements" (\obj -> (((((((GHC.Base.pure AccountRequirements GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "alternatives")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "current_deadline")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "disabled_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "eventually_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'AccountRequirements' with all required fields.
mkAccountRequirements :: AccountRequirements
mkAccountRequirements = AccountRequirements{accountRequirementsAlternatives = GHC.Maybe.Nothing,
...
data AccountRequirementsDisabledReason'NonNullable =
   AccountRequirementsDisabledReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountRequirementsDisabledReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountRequirementsDisabledReason'NonNullableEnumActionRequired'requestedCapabilities -- ^ Represents the JSON value @"action_required.requested_capabilities"@
  | AccountRequirementsDisabledReason'NonNullableEnumListed -- ^ Represents the JSON value @"listed"@
  | AccountRequirementsDisabledReason'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  | AccountRequirementsDisabledReason'NonNullableEnumPlatformPaused -- ^ Represents the JSON value @"platform_paused"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'fraud -- ^ Represents the JSON value @"rejected.fraud"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'incompleteVerification -- ^ Represents the JSON value @"rejected.incomplete_verification"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'listed -- ^ Represents the JSON value @"rejected.listed"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'other -- ^ Represents the JSON value @"rejected.other"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'platformFraud -- ^ Represents the JSON value @"rejected.platform_fraud"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'platformOther -- ^ Represents the JSON value @"rejected.platform_other"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'platformTermsOfService -- ^ Represents the JSON value @"rejected.platform_terms_of_service"@
  | AccountRequirementsDisabledReason'NonNullableEnumRejected'termsOfService -- ^ Represents the JSON value @"rejected.terms_of_service"@
  | AccountRequirementsDisabledReason'NonNullableEnumRequirements'pastDue -- ^ Represents the JSON value @"requirements.past_due"@
  | AccountRequirementsDisabledReason'NonNullableEnumRequirements'pendingVerification -- ^ Represents the JSON value @"requirements.pending_verification"@
  | AccountRequirementsDisabledReason'NonNullableEnumUnderReview -- ^ Represents the JSON value @"under_review"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountRequirementsDisabledReason'NonNullable
    where {toJSON (AccountRequirementsDisabledReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountRequirementsDisabledReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "action_required.requested_capabilities" -> AccountRequirementsDisabledReason'NonNullableEnumActionRequired'requestedCapabilities
