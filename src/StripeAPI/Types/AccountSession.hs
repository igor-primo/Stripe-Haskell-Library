...
data AccountSession = AccountSession {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountSession
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountSession
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountSession" (\obj -> ((((GHC.Base.pure AccountSession GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "client_secret")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "components")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode"))}
-- | Create a new 'AccountSession' with all required fields.
mkAccountSession :: Data.Text.Internal.Text -- ^ 'accountSessionAccount'
  -> Data.Text.Internal.Text -- ^ 'accountSessionClientSecret'
  -> ConnectEmbeddedAccountSessionCreateComponents -- ^ 'accountSessionComponents'
  -> GHC.Types.Int -- ^ 'accountSessionExpiresAt'
  -> GHC.Types.Bool -- ^ 'accountSessionLivemode'
  -> AccountSession
mkAccountSession accountSessionAccount accountSessionClientSecret accountSessionComponents accountSessionExpiresAt accountSessionLivemode = AccountSession{accountSessionAccount = accountSessionAccount,
