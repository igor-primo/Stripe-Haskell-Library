...
data AccountTosAcceptance = AccountTosAcceptance {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountTosAcceptance
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountTosAcceptance
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountTosAcceptance" (\obj -> (((GHC.Base.pure AccountTosAcceptance GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "service_agreement")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
-- | Create a new 'AccountTosAcceptance' with all required fields.
mkAccountTosAcceptance :: AccountTosAcceptance
mkAccountTosAcceptance = AccountTosAcceptance{accountTosAcceptanceDate = GHC.Maybe.Nothing,
