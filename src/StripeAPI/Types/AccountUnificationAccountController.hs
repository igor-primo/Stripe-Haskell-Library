...
data AccountUnificationAccountController = AccountUnificationAccountController {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountUnificationAccountController
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountUnificationAccountController
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "AccountUnificationAccountController" (\obj -> (((((GHC.Base.pure AccountUnificationAccountController GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fees")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "is_controller")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "losses")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "requirement_collection")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "stripe_dashboard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'AccountUnificationAccountController' with all required fields.
mkAccountUnificationAccountController :: AccountUnificationAccountControllerType' -- ^ 'accountUnificationAccountControllerType'
  -> AccountUnificationAccountController
mkAccountUnificationAccountController accountUnificationAccountControllerType = AccountUnificationAccountController{accountUnificationAccountControllerFees = GHC.Maybe.Nothing,
...
data AccountUnificationAccountControllerRequirementCollection' =
   AccountUnificationAccountControllerRequirementCollection'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountUnificationAccountControllerRequirementCollection'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountUnificationAccountControllerRequirementCollection'EnumApplication -- ^ Represents the JSON value @"application"@
  | AccountUnificationAccountControllerRequirementCollection'EnumStripe -- ^ Represents the JSON value @"stripe"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountUnificationAccountControllerRequirementCollection'
    where {toJSON (AccountUnificationAccountControllerRequirementCollection'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountUnificationAccountControllerRequirementCollection'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "application" -> AccountUnificationAccountControllerRequirementCollection'EnumApplication
...
data AccountUnificationAccountControllerType' =
   AccountUnificationAccountControllerType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AccountUnificationAccountControllerType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AccountUnificationAccountControllerType'EnumAccount -- ^ Represents the JSON value @"account"@
  | AccountUnificationAccountControllerType'EnumApplication -- ^ Represents the JSON value @"application"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AccountUnificationAccountControllerType'
    where {toJSON (AccountUnificationAccountControllerType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AccountUnificationAccountControllerType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> AccountUnificationAccountControllerType'EnumAccount
