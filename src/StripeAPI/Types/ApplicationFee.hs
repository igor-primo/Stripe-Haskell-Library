...
data ApplicationFeeFeeSource'NonNullable = ApplicationFeeFeeSource'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ApplicationFeeFeeSource'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON ApplicationFeeFeeSource'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ApplicationFeeFeeSource'NonNullable" (\obj -> ((GHC.Base.pure ApplicationFeeFeeSource'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "charge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payout")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkApplicationFeeFeeSource'NonNullable = ApplicationFeeFeeSource'NonNullable{applicationFeeFeeSource'NonNullableCharge = GHC.Maybe.Nothing,
...
data ApplicationFeeFeeSource'NonNullableType' =
   ApplicationFeeFeeSource'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ApplicationFeeFeeSource'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ApplicationFeeFeeSource'NonNullableType'EnumCharge -- ^ Represents the JSON value @"charge"@
  | ApplicationFeeFeeSource'NonNullableType'EnumPayout -- ^ Represents the JSON value @"payout"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ApplicationFeeFeeSource'NonNullableType'
    where {toJSON (ApplicationFeeFeeSource'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ApplicationFeeFeeSource'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "charge" -> ApplicationFeeFeeSource'NonNullableType'EnumCharge
