...
instance Data.Aeson.Types.FromJSON.FromJSON Apps'secret
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Apps'secret" (\obj -> (((((((GHC.Base.pure Apps'secret GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "deleted")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payload")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "scope"))}
-- | Create a new 'Apps'secret' with all required fields.
mkApps'secret :: GHC.Types.Int -- ^ 'apps'secretCreated'
  -> Data.Text.Internal.Text -- ^ 'apps'secretId'
  -> GHC.Types.Bool -- ^ 'apps'secretLivemode'
  -> Data.Text.Internal.Text -- ^ 'apps'secretName'
  -> SecretServiceResourceScope -- ^ 'apps'secretScope'
  -> Apps'secret
mkApps'secret apps'secretCreated apps'secretId apps'secretLivemode apps'secretName apps'secretScope = Apps'secret{apps'secretCreated = apps'secretCreated,
