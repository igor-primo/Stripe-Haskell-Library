...
data AutomaticTaxDisabledReason'NonNullable =
   AutomaticTaxDisabledReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | AutomaticTaxDisabledReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | AutomaticTaxDisabledReason'NonNullableEnumFinalizationRequiresLocationInputs -- ^ Represents the JSON value @"finalization_requires_location_inputs"@
  | AutomaticTaxDisabledReason'NonNullableEnumFinalizationSystemError -- ^ Represents the JSON value @"finalization_system_error"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON AutomaticTaxDisabledReason'NonNullable
    where {toJSON (AutomaticTaxDisabledReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON AutomaticTaxDisabledReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "finalization_requires_location_inputs" -> AutomaticTaxDisabledReason'NonNullableEnumFinalizationRequiresLocationInputs
