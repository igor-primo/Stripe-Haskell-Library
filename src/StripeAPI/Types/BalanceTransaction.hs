...
instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BalanceTransaction" (\obj -> ((((((((((((((GHC.Base.pure BalanceTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "available_on")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exchange_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fee")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fee_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "net")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reporting_category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "source")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'BalanceTransaction' with all required fields.
mkBalanceTransaction :: GHC.Types.Int -- ^ 'balanceTransactionAmount'
  -> GHC.Types.Int -- ^ 'balanceTransactionAvailableOn'
  -> GHC.Types.Int -- ^ 'balanceTransactionCreated'
  -> Data.Text.Internal.Text -- ^ 'balanceTransactionCurrency'
  -> GHC.Types.Int -- ^ 'balanceTransactionFee'
  -> [Fee] -- ^ 'balanceTransactionFeeDetails'
  -> Data.Text.Internal.Text -- ^ 'balanceTransactionId'
  -> GHC.Types.Int -- ^ 'balanceTransactionNet'
  -> Data.Text.Internal.Text -- ^ 'balanceTransactionReportingCategory'
  -> Data.Text.Internal.Text -- ^ 'balanceTransactionStatus'
  -> BalanceTransactionType' -- ^ 'balanceTransactionType'
  -> BalanceTransaction
mkBalanceTransaction balanceTransactionAmount balanceTransactionAvailableOn balanceTransactionCreated balanceTransactionCurrency balanceTransactionFee balanceTransactionFeeDetails balanceTransactionId balanceTransactionNet balanceTransactionReportingCategory balanceTransactionStatus balanceTransactionType = BalanceTransaction{balanceTransactionAmount = balanceTransactionAmount,
...
data BalanceTransactionBalanceType' =
   BalanceTransactionBalanceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BalanceTransactionBalanceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BalanceTransactionBalanceType'EnumIssuing -- ^ Represents the JSON value @"issuing"@
  | BalanceTransactionBalanceType'EnumPayments -- ^ Represents the JSON value @"payments"@
  | BalanceTransactionBalanceType'EnumRefundAndDisputePrefunding -- ^ Represents the JSON value @"refund_and_dispute_prefunding"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BalanceTransactionBalanceType'
    where {toJSON (BalanceTransactionBalanceType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransactionBalanceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "issuing" -> BalanceTransactionBalanceType'EnumIssuing
...
data BalanceTransactionSource'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BalanceTransactionSource'NonNullableVariants
    where {toJSON (BalanceTransactionSource'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data BalanceTransactionType' =
   BalanceTransactionType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BalanceTransactionType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BalanceTransactionType'EnumAdjustment -- ^ Represents the JSON value @"adjustment"@
  | BalanceTransactionType'EnumAdvance -- ^ Represents the JSON value @"advance"@
  | BalanceTransactionType'EnumAdvanceFunding -- ^ Represents the JSON value @"advance_funding"@
  | BalanceTransactionType'EnumAnticipationRepayment -- ^ Represents the JSON value @"anticipation_repayment"@
  | BalanceTransactionType'EnumApplicationFee -- ^ Represents the JSON value @"application_fee"@
  | BalanceTransactionType'EnumApplicationFeeRefund -- ^ Represents the JSON value @"application_fee_refund"@
  | BalanceTransactionType'EnumCharge -- ^ Represents the JSON value @"charge"@
  | BalanceTransactionType'EnumClimateOrderPurchase -- ^ Represents the JSON value @"climate_order_purchase"@
  | BalanceTransactionType'EnumClimateOrderRefund -- ^ Represents the JSON value @"climate_order_refund"@
  | BalanceTransactionType'EnumConnectCollectionTransfer -- ^ Represents the JSON value @"connect_collection_transfer"@
  | BalanceTransactionType'EnumContribution -- ^ Represents the JSON value @"contribution"@
  | BalanceTransactionType'EnumIssuingAuthorizationHold -- ^ Represents the JSON value @"issuing_authorization_hold"@
  | BalanceTransactionType'EnumIssuingAuthorizationRelease -- ^ Represents the JSON value @"issuing_authorization_release"@
  | BalanceTransactionType'EnumIssuingDispute -- ^ Represents the JSON value @"issuing_dispute"@
  | BalanceTransactionType'EnumIssuingTransaction -- ^ Represents the JSON value @"issuing_transaction"@
  | BalanceTransactionType'EnumObligationOutbound -- ^ Represents the JSON value @"obligation_outbound"@
  | BalanceTransactionType'EnumObligationReversalInbound -- ^ Represents the JSON value @"obligation_reversal_inbound"@
  | BalanceTransactionType'EnumPayment -- ^ Represents the JSON value @"payment"@
  | BalanceTransactionType'EnumPaymentFailureRefund -- ^ Represents the JSON value @"payment_failure_refund"@
  | BalanceTransactionType'EnumPaymentNetworkReserveHold -- ^ Represents the JSON value @"payment_network_reserve_hold"@
  | BalanceTransactionType'EnumPaymentNetworkReserveRelease -- ^ Represents the JSON value @"payment_network_reserve_release"@
  | BalanceTransactionType'EnumPaymentRefund -- ^ Represents the JSON value @"payment_refund"@
  | BalanceTransactionType'EnumPaymentReversal -- ^ Represents the JSON value @"payment_reversal"@
  | BalanceTransactionType'EnumPaymentUnreconciled -- ^ Represents the JSON value @"payment_unreconciled"@
  | BalanceTransactionType'EnumPayout -- ^ Represents the JSON value @"payout"@
  | BalanceTransactionType'EnumPayoutCancel -- ^ Represents the JSON value @"payout_cancel"@
  | BalanceTransactionType'EnumPayoutFailure -- ^ Represents the JSON value @"payout_failure"@
  | BalanceTransactionType'EnumPayoutMinimumBalanceHold -- ^ Represents the JSON value @"payout_minimum_balance_hold"@
  | BalanceTransactionType'EnumPayoutMinimumBalanceRelease -- ^ Represents the JSON value @"payout_minimum_balance_release"@
  | BalanceTransactionType'EnumRefund -- ^ Represents the JSON value @"refund"@
  | BalanceTransactionType'EnumRefundFailure -- ^ Represents the JSON value @"refund_failure"@
  | BalanceTransactionType'EnumReserveTransaction -- ^ Represents the JSON value @"reserve_transaction"@
  | BalanceTransactionType'EnumReservedFunds -- ^ Represents the JSON value @"reserved_funds"@
  | BalanceTransactionType'EnumStripeBalancePaymentDebit -- ^ Represents the JSON value @"stripe_balance_payment_debit"@
  | BalanceTransactionType'EnumStripeBalancePaymentDebitReversal -- ^ Represents the JSON value @"stripe_balance_payment_debit_reversal"@
  | BalanceTransactionType'EnumStripeFee -- ^ Represents the JSON value @"stripe_fee"@
  | BalanceTransactionType'EnumStripeFxFee -- ^ Represents the JSON value @"stripe_fx_fee"@
  | BalanceTransactionType'EnumTaxFee -- ^ Represents the JSON value @"tax_fee"@
  | BalanceTransactionType'EnumTopup -- ^ Represents the JSON value @"topup"@
  | BalanceTransactionType'EnumTopupReversal -- ^ Represents the JSON value @"topup_reversal"@
  | BalanceTransactionType'EnumTransfer -- ^ Represents the JSON value @"transfer"@
  | BalanceTransactionType'EnumTransferCancel -- ^ Represents the JSON value @"transfer_cancel"@
  | BalanceTransactionType'EnumTransferFailure -- ^ Represents the JSON value @"transfer_failure"@
  | BalanceTransactionType'EnumTransferRefund -- ^ Represents the JSON value @"transfer_refund"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BalanceTransactionType'
    where {toJSON (BalanceTransactionType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BalanceTransactionType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "adjustment" -> BalanceTransactionType'EnumAdjustment
