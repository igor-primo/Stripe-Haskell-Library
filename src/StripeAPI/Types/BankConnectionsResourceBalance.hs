...
instance Data.Aeson.Types.FromJSON.FromJSON BankConnectionsResourceBalance
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BankConnectionsResourceBalance" (\obj -> ((((GHC.Base.pure BankConnectionsResourceBalance GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "as_of")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cash")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "current")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'BankConnectionsResourceBalance' with all required fields.
mkBankConnectionsResourceBalance :: GHC.Types.Int -- ^ 'bankConnectionsResourceBalanceAsOf'
  -> Data.Aeson.Types.Internal.Object -- ^ 'bankConnectionsResourceBalanceCurrent'
  -> BankConnectionsResourceBalanceType' -- ^ 'bankConnectionsResourceBalanceType'
  -> BankConnectionsResourceBalance
mkBankConnectionsResourceBalance bankConnectionsResourceBalanceAsOf bankConnectionsResourceBalanceCurrent bankConnectionsResourceBalanceType = BankConnectionsResourceBalance{bankConnectionsResourceBalanceAsOf = bankConnectionsResourceBalanceAsOf,
...
data BankConnectionsResourceBalanceType' =
   BankConnectionsResourceBalanceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BankConnectionsResourceBalanceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BankConnectionsResourceBalanceType'EnumCash -- ^ Represents the JSON value @"cash"@
  | BankConnectionsResourceBalanceType'EnumCredit -- ^ Represents the JSON value @"credit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BankConnectionsResourceBalanceType'
    where {toJSON (BankConnectionsResourceBalanceType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BankConnectionsResourceBalanceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cash" -> BankConnectionsResourceBalanceType'EnumCash
