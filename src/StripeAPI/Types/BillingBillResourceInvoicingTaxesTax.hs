...
instance Data.Aeson.Types.FromJSON.FromJSON BillingBillResourceInvoicingTaxesTax
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BillingBillResourceInvoicingTaxesTax" (\obj -> ((((GHC.Base.pure BillingBillResourceInvoicingTaxesTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rate_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxability_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "taxable_amount"))}
-- | Create a new 'BillingBillResourceInvoicingTaxesTax' with all required fields.
mkBillingBillResourceInvoicingTaxesTax :: GHC.Types.Int -- ^ 'billingBillResourceInvoicingTaxesTaxAmount'
  -> BillingBillResourceInvoicingTaxesTaxTaxBehavior' -- ^ 'billingBillResourceInvoicingTaxesTaxTaxBehavior'
  -> BillingBillResourceInvoicingTaxesTaxTaxabilityReason' -- ^ 'billingBillResourceInvoicingTaxesTaxTaxabilityReason'
  -> BillingBillResourceInvoicingTaxesTax
mkBillingBillResourceInvoicingTaxesTax billingBillResourceInvoicingTaxesTaxAmount billingBillResourceInvoicingTaxesTaxTaxBehavior billingBillResourceInvoicingTaxesTaxTaxabilityReason = BillingBillResourceInvoicingTaxesTax{billingBillResourceInvoicingTaxesTaxAmount = billingBillResourceInvoicingTaxesTaxAmount,
                                                                                                                                                                                                                              billingBillResourceInvoicingTaxesTaxTaxBehavior = billingBillResourceInvoicingTaxesTaxTaxBehavior,
...
data BillingBillResourceInvoicingTaxesTaxTaxBehavior' =
   BillingBillResourceInvoicingTaxesTaxTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BillingBillResourceInvoicingTaxesTaxTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BillingBillResourceInvoicingTaxesTaxTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | BillingBillResourceInvoicingTaxesTaxTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingBillResourceInvoicingTaxesTaxTaxBehavior'
    where {toJSON (BillingBillResourceInvoicingTaxesTaxTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingBillResourceInvoicingTaxesTaxTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> BillingBillResourceInvoicingTaxesTaxTaxBehavior'EnumExclusive
...
data BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable = BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rate" Data.Aeson.Types.ToJSON..=)) (billingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullableTaxRate obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable" (\obj -> GHC.Base.pure BillingBillResourceInvoicingTaxesTaxTaxRateDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rate"))}
...
data BillingBillResourceInvoicingTaxesTaxTaxabilityReason' =
   BillingBillResourceInvoicingTaxesTaxTaxabilityReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumCustomerExempt -- ^ Represents the JSON value @"customer_exempt"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumNotAvailable -- ^ Represents the JSON value @"not_available"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumNotCollecting -- ^ Represents the JSON value @"not_collecting"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumNotSubjectToTax -- ^ Represents the JSON value @"not_subject_to_tax"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumNotSupported -- ^ Represents the JSON value @"not_supported"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumPortionProductExempt -- ^ Represents the JSON value @"portion_product_exempt"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumPortionReducedRated -- ^ Represents the JSON value @"portion_reduced_rated"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumPortionStandardRated -- ^ Represents the JSON value @"portion_standard_rated"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumProductExempt -- ^ Represents the JSON value @"product_exempt"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumProductExemptHoliday -- ^ Represents the JSON value @"product_exempt_holiday"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumProportionallyRated -- ^ Represents the JSON value @"proportionally_rated"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumReducedRated -- ^ Represents the JSON value @"reduced_rated"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumReverseCharge -- ^ Represents the JSON value @"reverse_charge"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumStandardRated -- ^ Represents the JSON value @"standard_rated"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumTaxableBasisReduced -- ^ Represents the JSON value @"taxable_basis_reduced"@
  | BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumZeroRated -- ^ Represents the JSON value @"zero_rated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingBillResourceInvoicingTaxesTaxTaxabilityReason'
    where {toJSON (BillingBillResourceInvoicingTaxesTaxTaxabilityReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingBillResourceInvoicingTaxesTaxTaxabilityReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_exempt" -> BillingBillResourceInvoicingTaxesTaxTaxabilityReason'EnumCustomerExempt
