...
data BillingCreditGrantsResourceBalanceDebit = BillingCreditGrantsResourceBalanceDebit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingCreditGrantsResourceBalanceDebit
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= billingCreditGrantsResourceBalanceDebitAmount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credits_applied" Data.Aeson.Types.ToJSON..=)) (billingCreditGrantsResourceBalanceDebitCreditsApplied obj) : ["type" Data.Aeson.Types.ToJSON..= billingCreditGrantsResourceBalanceDebitType obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingCreditGrantsResourceBalanceDebit
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BillingCreditGrantsResourceBalanceDebit" (\obj -> ((GHC.Base.pure BillingCreditGrantsResourceBalanceDebit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credits_applied")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'BillingCreditGrantsResourceBalanceDebit' with all required fields.
mkBillingCreditGrantsResourceBalanceDebit :: BillingCreditGrantsResourceAmount -- ^ 'billingCreditGrantsResourceBalanceDebitAmount'
  -> BillingCreditGrantsResourceBalanceDebitType' -- ^ 'billingCreditGrantsResourceBalanceDebitType'
  -> BillingCreditGrantsResourceBalanceDebit
mkBillingCreditGrantsResourceBalanceDebit billingCreditGrantsResourceBalanceDebitAmount billingCreditGrantsResourceBalanceDebitType = BillingCreditGrantsResourceBalanceDebit{billingCreditGrantsResourceBalanceDebitAmount = billingCreditGrantsResourceBalanceDebitAmount,
...
data BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable = BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable" (\obj -> (GHC.Base.pure BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice_line_item"))}
...
mkBillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable = BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullable{billingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullableInvoice = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullableInvoice'Variants
    where {toJSON (BillingCreditGrantsResourceBalanceDebitCreditsApplied'NonNullableInvoice'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data BillingCreditGrantsResourceBalanceDebitType' =
   BillingCreditGrantsResourceBalanceDebitType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | BillingCreditGrantsResourceBalanceDebitType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | BillingCreditGrantsResourceBalanceDebitType'EnumCreditsApplied -- ^ Represents the JSON value @"credits_applied"@
  | BillingCreditGrantsResourceBalanceDebitType'EnumCreditsExpired -- ^ Represents the JSON value @"credits_expired"@
  | BillingCreditGrantsResourceBalanceDebitType'EnumCreditsVoided -- ^ Represents the JSON value @"credits_voided"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingCreditGrantsResourceBalanceDebitType'
    where {toJSON (BillingCreditGrantsResourceBalanceDebitType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON BillingCreditGrantsResourceBalanceDebitType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credits_applied" -> BillingCreditGrantsResourceBalanceDebitType'EnumCreditsApplied
