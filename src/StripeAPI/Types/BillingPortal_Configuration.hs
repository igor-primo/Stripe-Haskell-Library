...
data BillingPortal'configuration = BillingPortal'configuration {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON BillingPortal'configuration
...
instance Data.Aeson.Types.ToJSON.ToJSON BillingPortal'configurationApplication'NonNullableVariants
    where {toJSON (BillingPortal'configurationApplication'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
