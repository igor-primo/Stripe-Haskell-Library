...
instance Data.Aeson.Types.FromJSON.FromJSON Billing'creditGrant
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Billing'creditGrant" (\obj -> ((((((((((((((GHC.Base.pure Billing'creditGrant GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "applicability_config")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "effective_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "priority")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "test_clock")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "updated")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "voided_at"))}
-- | Create a new 'Billing'creditGrant' with all required fields.
mkBilling'creditGrant :: BillingCreditGrantsResourceAmount -- ^ 'billing'creditGrantAmount'
  -> BillingCreditGrantsResourceApplicabilityConfig -- ^ 'billing'creditGrantApplicabilityConfig'
  -> Billing'creditGrantCategory' -- ^ 'billing'creditGrantCategory'
  -> GHC.Types.Int -- ^ 'billing'creditGrantCreated'
  -> Billing'creditGrantCustomer'Variants -- ^ 'billing'creditGrantCustomer'
  -> Data.Text.Internal.Text -- ^ 'billing'creditGrantId'
  -> GHC.Types.Bool -- ^ 'billing'creditGrantLivemode'
  -> Data.Aeson.Types.Internal.Object -- ^ 'billing'creditGrantMetadata'
  -> GHC.Types.Int -- ^ 'billing'creditGrantUpdated'
  -> Billing'creditGrant
mkBilling'creditGrant billing'creditGrantAmount billing'creditGrantApplicabilityConfig billing'creditGrantCategory billing'creditGrantCreated billing'creditGrantCustomer billing'creditGrantId billing'creditGrantLivemode billing'creditGrantMetadata billing'creditGrantUpdated = Billing'creditGrant{billing'creditGrantAmount = billing'creditGrantAmount,
...
data Billing'creditGrantCategory' =
   Billing'creditGrantCategory'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Billing'creditGrantCategory'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Billing'creditGrantCategory'EnumPaid -- ^ Represents the JSON value @"paid"@
  | Billing'creditGrantCategory'EnumPromotional -- ^ Represents the JSON value @"promotional"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Billing'creditGrantCategory'
    where {toJSON (Billing'creditGrantCategory'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Billing'creditGrantCategory'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "paid" -> Billing'creditGrantCategory'EnumPaid
...
data Billing'creditGrantCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Billing'creditGrantCustomer'Variants
    where {toJSON (Billing'creditGrantCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON Billing'creditGrantCustomer'Variants
...
data Billing'creditGrantTestClock'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Billing'creditGrantTestClock'NonNullableVariants
    where {toJSON (Billing'creditGrantTestClock'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Billing'creditGrantTestClock'NonNullableTestHelpers'testClock a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Billing'creditGrantTestClock'NonNullableVariants
