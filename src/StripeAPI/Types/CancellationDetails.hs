...
data CancellationDetails = CancellationDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CancellationDetails
...
instance Data.Aeson.Types.FromJSON.FromJSON CancellationDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CancellationDetails" (\obj -> ((GHC.Base.pure CancellationDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "comment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "feedback")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason"))}
-- | Create a new 'CancellationDetails' with all required fields.
mkCancellationDetails :: CancellationDetails
mkCancellationDetails = CancellationDetails{cancellationDetailsComment = GHC.Maybe.Nothing,
...
data CancellationDetailsFeedback'NonNullable =
   CancellationDetailsFeedback'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CancellationDetailsFeedback'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CancellationDetailsFeedback'NonNullableEnumCustomerService -- ^ Represents the JSON value @"customer_service"@
  | CancellationDetailsFeedback'NonNullableEnumLowQuality -- ^ Represents the JSON value @"low_quality"@
  | CancellationDetailsFeedback'NonNullableEnumMissingFeatures -- ^ Represents the JSON value @"missing_features"@
  | CancellationDetailsFeedback'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  | CancellationDetailsFeedback'NonNullableEnumSwitchedService -- ^ Represents the JSON value @"switched_service"@
  | CancellationDetailsFeedback'NonNullableEnumTooComplex -- ^ Represents the JSON value @"too_complex"@
  | CancellationDetailsFeedback'NonNullableEnumTooExpensive -- ^ Represents the JSON value @"too_expensive"@
  | CancellationDetailsFeedback'NonNullableEnumUnused -- ^ Represents the JSON value @"unused"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CancellationDetailsFeedback'NonNullable
    where {toJSON (CancellationDetailsFeedback'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CancellationDetailsFeedback'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_service" -> CancellationDetailsFeedback'NonNullableEnumCustomerService
...
data CancellationDetailsReason'NonNullable =
   CancellationDetailsReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CancellationDetailsReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CancellationDetailsReason'NonNullableEnumCancellationRequested -- ^ Represents the JSON value @"cancellation_requested"@
  | CancellationDetailsReason'NonNullableEnumPaymentDisputed -- ^ Represents the JSON value @"payment_disputed"@
  | CancellationDetailsReason'NonNullableEnumPaymentFailed -- ^ Represents the JSON value @"payment_failed"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CancellationDetailsReason'NonNullable
    where {toJSON (CancellationDetailsReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CancellationDetailsReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cancellation_requested" -> CancellationDetailsReason'NonNullableEnumCancellationRequested
