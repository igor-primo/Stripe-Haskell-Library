...
data CardAllowRedisplay'NonNullable =
   CardAllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CardAllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CardAllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | CardAllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | CardAllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CardAllowRedisplay'NonNullable
    where {toJSON (CardAllowRedisplay'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CardAllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> CardAllowRedisplay'NonNullableEnumAlways
...
data CardRegulatedStatus'NonNullable =
   CardRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CardRegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CardRegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | CardRegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CardRegulatedStatus'NonNullable
    where {toJSON (CardRegulatedStatus'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CardRegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> CardRegulatedStatus'NonNullableEnumRegulated
