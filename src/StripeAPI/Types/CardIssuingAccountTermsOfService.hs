...
data CardIssuingAccountTermsOfService = CardIssuingAccountTermsOfService {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CardIssuingAccountTermsOfService
...
instance Data.Aeson.Types.FromJSON.FromJSON CardIssuingAccountTermsOfService
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CardIssuingAccountTermsOfService" (\obj -> ((GHC.Base.pure CardIssuingAccountTermsOfService GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
...
mkCardIssuingAccountTermsOfService = CardIssuingAccountTermsOfService{cardIssuingAccountTermsOfServiceDate = GHC.Maybe.Nothing,
