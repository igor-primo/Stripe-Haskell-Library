...
mkChargeOutcome :: Data.Text.Internal.Text -- ^ 'chargeOutcomeType'
  -> ChargeOutcome
mkChargeOutcome chargeOutcomeType = ChargeOutcome{chargeOutcomeAdviceCode = GHC.Maybe.Nothing,
...
data ChargeOutcomeAdviceCode'NonNullable =
   ChargeOutcomeAdviceCode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ChargeOutcomeAdviceCode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ChargeOutcomeAdviceCode'NonNullableEnumConfirmCardData -- ^ Represents the JSON value @"confirm_card_data"@
  | ChargeOutcomeAdviceCode'NonNullableEnumDoNotTryAgain -- ^ Represents the JSON value @"do_not_try_again"@
  | ChargeOutcomeAdviceCode'NonNullableEnumTryAgainLater -- ^ Represents the JSON value @"try_again_later"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ChargeOutcomeAdviceCode'NonNullable
    where {toJSON (ChargeOutcomeAdviceCode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ChargeOutcomeAdviceCode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "confirm_card_data" -> ChargeOutcomeAdviceCode'NonNullableEnumConfirmCardData
...
data ChargeOutcomeRule'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ChargeOutcomeRule'Variants
    where {toJSON (ChargeOutcomeRule'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (ChargeOutcomeRule'Rule a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON ChargeOutcomeRule'Variants
    where {parseJSON val = case (ChargeOutcomeRule'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ChargeOutcomeRule'Rule Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
