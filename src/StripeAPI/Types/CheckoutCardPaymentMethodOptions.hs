...
data CheckoutCardPaymentMethodOptions = CheckoutCardPaymentMethodOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptions
...
data CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization' =
   CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'
    where {toJSON (CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> CheckoutCardPaymentMethodOptionsRequestExtendedAuthorization'EnumIfAvailable
...
data CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization' =
   CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'
    where {toJSON (CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> CheckoutCardPaymentMethodOptionsRequestIncrementalAuthorization'EnumIfAvailable
...
data CheckoutCardPaymentMethodOptionsRequestMulticapture' =
   CheckoutCardPaymentMethodOptionsRequestMulticapture'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsRequestMulticapture'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsRequestMulticapture'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | CheckoutCardPaymentMethodOptionsRequestMulticapture'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsRequestMulticapture'
    where {toJSON (CheckoutCardPaymentMethodOptionsRequestMulticapture'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsRequestMulticapture'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> CheckoutCardPaymentMethodOptionsRequestMulticapture'EnumIfAvailable
...
data CheckoutCardPaymentMethodOptionsRequestOvercapture' =
   CheckoutCardPaymentMethodOptionsRequestOvercapture'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsRequestOvercapture'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsRequestOvercapture'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | CheckoutCardPaymentMethodOptionsRequestOvercapture'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsRequestOvercapture'
    where {toJSON (CheckoutCardPaymentMethodOptionsRequestOvercapture'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsRequestOvercapture'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> CheckoutCardPaymentMethodOptionsRequestOvercapture'EnumIfAvailable
...
data CheckoutCardPaymentMethodOptionsRequestThreeDSecure' =
   CheckoutCardPaymentMethodOptionsRequestThreeDSecure'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsRequestThreeDSecure'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsRequestThreeDSecure'EnumAny -- ^ Represents the JSON value @"any"@
  | CheckoutCardPaymentMethodOptionsRequestThreeDSecure'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | CheckoutCardPaymentMethodOptionsRequestThreeDSecure'EnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsRequestThreeDSecure'
    where {toJSON (CheckoutCardPaymentMethodOptionsRequestThreeDSecure'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsRequestThreeDSecure'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> CheckoutCardPaymentMethodOptionsRequestThreeDSecure'EnumAny
...
data CheckoutCardPaymentMethodOptionsSetupFutureUsage' =
   CheckoutCardPaymentMethodOptionsSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCardPaymentMethodOptionsSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCardPaymentMethodOptionsSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | CheckoutCardPaymentMethodOptionsSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | CheckoutCardPaymentMethodOptionsSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCardPaymentMethodOptionsSetupFutureUsage'
    where {toJSON (CheckoutCardPaymentMethodOptionsSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCardPaymentMethodOptionsSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> CheckoutCardPaymentMethodOptionsSetupFutureUsage'EnumNone
