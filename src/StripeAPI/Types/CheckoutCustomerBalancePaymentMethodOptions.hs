...
data CheckoutCustomerBalancePaymentMethodOptions = CheckoutCustomerBalancePaymentMethodOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCustomerBalancePaymentMethodOptions
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCustomerBalancePaymentMethodOptions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CheckoutCustomerBalancePaymentMethodOptions" (\obj -> ((GHC.Base.pure CheckoutCustomerBalancePaymentMethodOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "funding_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))}
...
mkCheckoutCustomerBalancePaymentMethodOptions = CheckoutCustomerBalancePaymentMethodOptions{checkoutCustomerBalancePaymentMethodOptionsBankTransfer = GHC.Maybe.Nothing,
...
data CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullable =
   CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullableEnumBankTransfer -- ^ Represents the JSON value @"bank_transfer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullable
    where {toJSON (CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_transfer" -> CheckoutCustomerBalancePaymentMethodOptionsFundingType'NonNullableEnumBankTransfer
...
data CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage' =
   CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'
    where {toJSON (CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> CheckoutCustomerBalancePaymentMethodOptionsSetupFutureUsage'EnumNone
