...
data ClimateRemovalsBeneficiary = ClimateRemovalsBeneficiary {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ClimateRemovalsBeneficiary
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["public_name" Data.Aeson.Types.ToJSON..= climateRemovalsBeneficiaryPublicName obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON ClimateRemovalsBeneficiary
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ClimateRemovalsBeneficiary" (\obj -> GHC.Base.pure ClimateRemovalsBeneficiary GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "public_name"))}
-- | Create a new 'ClimateRemovalsBeneficiary' with all required fields.
mkClimateRemovalsBeneficiary :: Data.Text.Internal.Text -- ^ 'climateRemovalsBeneficiaryPublicName'
