...
instance Data.Aeson.Types.FromJSON.FromJSON ClimateRemovalsOrderDeliveries
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ClimateRemovalsOrderDeliveries" (\obj -> ((((GHC.Base.pure ClimateRemovalsOrderDeliveries GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "delivered_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metric_tons")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "registry_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "supplier"))}
-- | Create a new 'ClimateRemovalsOrderDeliveries' with all required fields.
mkClimateRemovalsOrderDeliveries :: GHC.Types.Int -- ^ 'climateRemovalsOrderDeliveriesDeliveredAt'
  -> Data.Text.Internal.Text -- ^ 'climateRemovalsOrderDeliveriesMetricTons'
  -> Climate'supplier -- ^ 'climateRemovalsOrderDeliveriesSupplier'
  -> ClimateRemovalsOrderDeliveries
mkClimateRemovalsOrderDeliveries climateRemovalsOrderDeliveriesDeliveredAt climateRemovalsOrderDeliveriesMetricTons climateRemovalsOrderDeliveriesSupplier = ClimateRemovalsOrderDeliveries{climateRemovalsOrderDeliveriesDeliveredAt = climateRemovalsOrderDeliveriesDeliveredAt,
...
data ClimateRemovalsOrderDeliveriesLocation'NonNullable = ClimateRemovalsOrderDeliveriesLocation'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ClimateRemovalsOrderDeliveriesLocation'NonNullable
...
mkClimateRemovalsOrderDeliveriesLocation'NonNullable = ClimateRemovalsOrderDeliveriesLocation'NonNullable{climateRemovalsOrderDeliveriesLocation'NonNullableCity = GHC.Maybe.Nothing,
