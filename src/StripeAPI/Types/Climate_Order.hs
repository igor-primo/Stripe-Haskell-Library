...
data Climate'orderCancellationReason'NonNullable =
   Climate'orderCancellationReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Climate'orderCancellationReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Climate'orderCancellationReason'NonNullableEnumExpired -- ^ Represents the JSON value @"expired"@
  | Climate'orderCancellationReason'NonNullableEnumProductUnavailable -- ^ Represents the JSON value @"product_unavailable"@
  | Climate'orderCancellationReason'NonNullableEnumRequested -- ^ Represents the JSON value @"requested"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Climate'orderCancellationReason'NonNullable
    where {toJSON (Climate'orderCancellationReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Climate'orderCancellationReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "expired" -> Climate'orderCancellationReason'NonNullableEnumExpired
...
data Climate'orderProduct'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Climate'orderProduct'Variants
    where {toJSON (Climate'orderProduct'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Climate'orderProduct'Climate'product a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Climate'orderProduct'Variants
    where {parseJSON val = case (Climate'orderProduct'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Climate'orderProduct'Climate'product Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data Climate'orderStatus' =
   Climate'orderStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Climate'orderStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Climate'orderStatus'EnumAwaitingFunds -- ^ Represents the JSON value @"awaiting_funds"@
  | Climate'orderStatus'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | Climate'orderStatus'EnumConfirmed -- ^ Represents the JSON value @"confirmed"@
  | Climate'orderStatus'EnumDelivered -- ^ Represents the JSON value @"delivered"@
  | Climate'orderStatus'EnumOpen -- ^ Represents the JSON value @"open"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Climate'orderStatus'
    where {toJSON (Climate'orderStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Climate'orderStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "awaiting_funds" -> Climate'orderStatus'EnumAwaitingFunds
