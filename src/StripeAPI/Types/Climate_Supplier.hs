...
instance Data.Aeson.Types.FromJSON.FromJSON Climate'supplier
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Climate'supplier" (\obj -> (((((GHC.Base.pure Climate'supplier GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "info_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "locations")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "removal_pathway"))}
-- | Create a new 'Climate'supplier' with all required fields.
mkClimate'supplier :: Data.Text.Internal.Text -- ^ 'climate'supplierId'
  -> Data.Text.Internal.Text -- ^ 'climate'supplierInfoUrl'
  -> GHC.Types.Bool -- ^ 'climate'supplierLivemode'
  -> [ClimateRemovalsLocation] -- ^ 'climate'supplierLocations'
  -> Data.Text.Internal.Text -- ^ 'climate'supplierName'
  -> Climate'supplierRemovalPathway' -- ^ 'climate'supplierRemovalPathway'
  -> Climate'supplier
mkClimate'supplier climate'supplierId climate'supplierInfoUrl climate'supplierLivemode climate'supplierLocations climate'supplierName climate'supplierRemovalPathway = Climate'supplier{climate'supplierId = climate'supplierId,
...
data Climate'supplierRemovalPathway' =
   Climate'supplierRemovalPathway'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Climate'supplierRemovalPathway'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Climate'supplierRemovalPathway'EnumBiomassCarbonRemovalAndStorage -- ^ Represents the JSON value @"biomass_carbon_removal_and_storage"@
  | Climate'supplierRemovalPathway'EnumDirectAirCapture -- ^ Represents the JSON value @"direct_air_capture"@
  | Climate'supplierRemovalPathway'EnumEnhancedWeathering -- ^ Represents the JSON value @"enhanced_weathering"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Climate'supplierRemovalPathway'
    where {toJSON (Climate'supplierRemovalPathway'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Climate'supplierRemovalPathway'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "biomass_carbon_removal_and_storage" -> Climate'supplierRemovalPathway'EnumBiomassCarbonRemovalAndStorage
