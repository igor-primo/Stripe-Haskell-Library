...
data CountrySpecVerificationFieldDetails = CountrySpecVerificationFieldDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CountrySpecVerificationFieldDetails
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["additional" Data.Aeson.Types.ToJSON..= countrySpecVerificationFieldDetailsAdditional obj] : ["minimum" Data.Aeson.Types.ToJSON..= countrySpecVerificationFieldDetailsMinimum obj] : GHC.Base.mempty));
...
mkCountrySpecVerificationFieldDetails :: [Data.Text.Internal.Text] -- ^ 'countrySpecVerificationFieldDetailsAdditional'
  -> [Data.Text.Internal.Text] -- ^ 'countrySpecVerificationFieldDetailsMinimum'
  -> CountrySpecVerificationFieldDetails
mkCountrySpecVerificationFieldDetails countrySpecVerificationFieldDetailsAdditional countrySpecVerificationFieldDetailsMinimum = CountrySpecVerificationFieldDetails{countrySpecVerificationFieldDetailsAdditional = countrySpecVerificationFieldDetailsAdditional,
