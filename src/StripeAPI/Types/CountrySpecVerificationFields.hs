...
data CountrySpecVerificationFields = CountrySpecVerificationFields {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CountrySpecVerificationFields
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["company" Data.Aeson.Types.ToJSON..= countrySpecVerificationFieldsCompany obj] : ["individual" Data.Aeson.Types.ToJSON..= countrySpecVerificationFieldsIndividual obj] : GHC.Base.mempty));
...
mkCountrySpecVerificationFields :: CountrySpecVerificationFieldDetails -- ^ 'countrySpecVerificationFieldsCompany'
  -> CountrySpecVerificationFieldDetails -- ^ 'countrySpecVerificationFieldsIndividual'
  -> CountrySpecVerificationFields
mkCountrySpecVerificationFields countrySpecVerificationFieldsCompany countrySpecVerificationFieldsIndividual = CountrySpecVerificationFields{countrySpecVerificationFieldsCompany = countrySpecVerificationFieldsCompany,
