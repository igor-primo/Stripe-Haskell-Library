...
instance Data.Aeson.Types.FromJSON.FromJSON Coupon
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Coupon" (\obj -> (((((((((((((((GHC.Base.pure Coupon GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_off")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "applies_to")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "duration")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "duration_in_months")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "max_redemptions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "percent_off")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "redeem_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "times_redeemed")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "valid"))}
...
mkCoupon :: GHC.Types.Int -- ^ 'couponCreated'
  ...
  -> GHC.Types.Int -- ^ 'couponTimesRedeemed'
  -> GHC.Types.Bool -- ^ 'couponValid'
  -> Coupon
mkCoupon couponCreated couponDuration couponId couponLivemode couponTimesRedeemed couponValid = Coupon{couponAmountOff = GHC.Maybe.Nothing,
...
data CouponDuration' =
   CouponDuration'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CouponDuration'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CouponDuration'EnumForever -- ^ Represents the JSON value @"forever"@
  | CouponDuration'EnumOnce -- ^ Represents the JSON value @"once"@
  | CouponDuration'EnumRepeating -- ^ Represents the JSON value @"repeating"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CouponDuration'
    where {toJSON (CouponDuration'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CouponDuration'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "forever" -> CouponDuration'EnumForever
