...
data CustomerAcceptance = CustomerAcceptance {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerAcceptance
...
mkCustomerAcceptance :: CustomerAcceptanceType' -- ^ 'customerAcceptanceType'
  -> CustomerAcceptance
mkCustomerAcceptance customerAcceptanceType = CustomerAcceptance{customerAcceptanceAcceptedAt = GHC.Maybe.Nothing,
...
data CustomerAcceptanceType' =
   CustomerAcceptanceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CustomerAcceptanceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CustomerAcceptanceType'EnumOffline -- ^ Represents the JSON value @"offline"@
  | CustomerAcceptanceType'EnumOnline -- ^ Represents the JSON value @"online"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerAcceptanceType'
    where {toJSON (CustomerAcceptanceType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerAcceptanceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "offline" -> CustomerAcceptanceType'EnumOffline
