...
data CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction = CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["bank_transfer" Data.Aeson.Types.ToJSON..= customerBalanceResourceCashBalanceTransactionResourceFundedTransactionBankTransfer obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction" (\obj -> GHC.Base.pure CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_transfer"))}
-- | Create a new 'CustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction' with all required fields.
mkCustomerBalanceResourceCashBalanceTransactionResourceFundedTransaction :: CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer -- ^ 'customerBalanceResourceCashBalanceTransactionResourceFundedTransactionBankTransfer'
