...
data CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer = CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer
...
mkCustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer :: CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType' -- ^ 'customerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'
  -> CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer
mkCustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer customerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType = CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransfer{customerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferEuBankTransfer = GHC.Maybe.Nothing,
...
data CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType' =
   CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumEuBankTransfer -- ^ Represents the JSON value @"eu_bank_transfer"@
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumGbBankTransfer -- ^ Represents the JSON value @"gb_bank_transfer"@
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumJpBankTransfer -- ^ Represents the JSON value @"jp_bank_transfer"@
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumMxBankTransfer -- ^ Represents the JSON value @"mx_bank_transfer"@
  | CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumUsBankTransfer -- ^ Represents the JSON value @"us_bank_transfer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'
    where {toJSON (CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "eu_bank_transfer" -> CustomerBalanceResourceCashBalanceTransactionResourceFundedTransactionResourceBankTransferType'EnumEuBankTransfer
