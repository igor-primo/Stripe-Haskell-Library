...
data CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction = CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["refund" Data.Aeson.Types.ToJSON..= customerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionRefund obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction" (\obj -> GHC.Base.pure CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "refund"))}
...
mkCustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransaction :: CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionRefund'Variants -- ^ 'customerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionRefund'
...
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionRefund'Variants
    where {toJSON (CustomerBalanceResourceCashBalanceTransactionResourceRefundedFromPaymentTransactionRefund'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
