...
data CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction = CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["payment_intent" Data.Aeson.Types.ToJSON..= customerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionPaymentIntent obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction" (\obj -> GHC.Base.pure CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "payment_intent"))}
...
mkCustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransaction :: CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionPaymentIntent'Variants -- ^ 'customerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionPaymentIntent'
...
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionPaymentIntent'Variants
    where {toJSON (CustomerBalanceResourceCashBalanceTransactionResourceUnappliedFromPaymentTransactionPaymentIntent'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
