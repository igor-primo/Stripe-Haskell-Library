...
import {-# SOURCE #-} StripeAPI.Types.Checkout_Session
...
data CustomerBalanceTransaction = CustomerBalanceTransaction {
  ...
  , customerBalanceTransactionCheckoutSession :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable CustomerBalanceTransactionCheckoutSession'NonNullableVariants))
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransaction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= customerBalanceTransactionAmount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("checkout_session" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionCheckoutSession obj) : ["created" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCreated obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit_note" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionCreditNote obj) : ["currency" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCurrency obj] : ["customer" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCustomer obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionDescription obj) : ["ending_balance" Data.Aeson.Types.ToJSON..= customerBalanceTransactionEndingBalance obj] : ["id" Data.Aeson.Types.ToJSON..= customerBalanceTransactionId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("invoice" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionInvoice obj) : ["livemode" Data.Aeson.Types.ToJSON..= customerBalanceTransactionLivemode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionMetadata obj) : ["type" Data.Aeson.Types.ToJSON..= customerBalanceTransactionType obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "customer_balance_transaction"] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= customerBalanceTransactionAmount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("checkout_session" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionCheckoutSession obj) : ["created" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCreated obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit_note" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionCreditNote obj) : ["currency" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCurrency obj] : ["customer" Data.Aeson.Types.ToJSON..= customerBalanceTransactionCustomer obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionDescription obj) : ["ending_balance" Data.Aeson.Types.ToJSON..= customerBalanceTransactionEndingBalance obj] : ["id" Data.Aeson.Types.ToJSON..= customerBalanceTransactionId obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("invoice" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionInvoice obj) : ["livemode" Data.Aeson.Types.ToJSON..= customerBalanceTransactionLivemode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (customerBalanceTransactionMetadata obj) : ["type" Data.Aeson.Types.ToJSON..= customerBalanceTransactionType obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "customer_balance_transaction"] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerBalanceTransaction" (\obj -> ((((((((((((GHC.Base.pure CustomerBalanceTransaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "checkout_session")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credit_note")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "ending_balance")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'CustomerBalanceTransaction' with all required fields.
mkCustomerBalanceTransaction :: GHC.Types.Int -- ^ 'customerBalanceTransactionAmount'
  -> GHC.Types.Int -- ^ 'customerBalanceTransactionCreated'
  -> Data.Text.Internal.Text -- ^ 'customerBalanceTransactionCurrency'
  -> CustomerBalanceTransactionCustomer'Variants -- ^ 'customerBalanceTransactionCustomer'
  -> GHC.Types.Int -- ^ 'customerBalanceTransactionEndingBalance'
  -> Data.Text.Internal.Text -- ^ 'customerBalanceTransactionId'
  -> GHC.Types.Bool -- ^ 'customerBalanceTransactionLivemode'
  -> CustomerBalanceTransactionType' -- ^ 'customerBalanceTransactionType'
  -> CustomerBalanceTransaction
mkCustomerBalanceTransaction customerBalanceTransactionAmount customerBalanceTransactionCreated customerBalanceTransactionCurrency customerBalanceTransactionCustomer customerBalanceTransactionEndingBalance customerBalanceTransactionId customerBalanceTransactionLivemode customerBalanceTransactionType = CustomerBalanceTransaction{customerBalanceTransactionAmount = customerBalanceTransactionAmount,
                                                                                                                                                                                                                                                                                                                                          customerBalanceTransactionCheckoutSession = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                                                                                                                          customerBalanceTransactionType = customerBalanceTransactionType}
-- | Defines the oneOf schema located at @components.schemas.customer_balance_transaction.properties.checkout_session.anyOf@ in the specification.
-- 
-- The ID of the checkout session (if any) that created the transaction.
data CustomerBalanceTransactionCheckoutSession'NonNullableVariants =
   CustomerBalanceTransactionCheckoutSession'NonNullableText Data.Text.Internal.Text
  | CustomerBalanceTransactionCheckoutSession'NonNullableCheckout'session Checkout'session
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransactionCheckoutSession'NonNullableVariants
    where {toJSON (CustomerBalanceTransactionCheckoutSession'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (CustomerBalanceTransactionCheckoutSession'NonNullableCheckout'session a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransactionCheckoutSession'NonNullableVariants
    where {parseJSON val = case (CustomerBalanceTransactionCheckoutSession'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((CustomerBalanceTransactionCheckoutSession'NonNullableCheckout'session Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data CustomerBalanceTransactionCreditNote'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransactionCreditNote'NonNullableVariants
    where {toJSON (CustomerBalanceTransactionCreditNote'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (CustomerBalanceTransactionCreditNote'NonNullableCreditNote a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransactionCreditNote'NonNullableVariants
    where {parseJSON val = case (CustomerBalanceTransactionCreditNote'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((CustomerBalanceTransactionCreditNote'NonNullableCreditNote Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data CustomerBalanceTransactionCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransactionCustomer'Variants
    where {toJSON (CustomerBalanceTransactionCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (CustomerBalanceTransactionCustomer'Customer a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransactionCustomer'Variants
    where {parseJSON val = case (CustomerBalanceTransactionCustomer'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((CustomerBalanceTransactionCustomer'Customer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data CustomerBalanceTransactionInvoice'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransactionInvoice'NonNullableVariants
    where {toJSON (CustomerBalanceTransactionInvoice'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (CustomerBalanceTransactionInvoice'NonNullableInvoice a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransactionInvoice'NonNullableVariants
    where {parseJSON val = case (CustomerBalanceTransactionInvoice'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((CustomerBalanceTransactionInvoice'NonNullableInvoice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data CustomerBalanceTransactionType' =
   CustomerBalanceTransactionType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CustomerBalanceTransactionType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CustomerBalanceTransactionType'EnumAdjustment -- ^ Represents the JSON value @"adjustment"@
  | CustomerBalanceTransactionType'EnumAppliedToInvoice -- ^ Represents the JSON value @"applied_to_invoice"@
  | CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPayment -- ^ Represents the JSON value @"checkout_session_subscription_payment"@
  | CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPaymentCanceled -- ^ Represents the JSON value @"checkout_session_subscription_payment_canceled"@
  | CustomerBalanceTransactionType'EnumCreditNote -- ^ Represents the JSON value @"credit_note"@
  | CustomerBalanceTransactionType'EnumInitial -- ^ Represents the JSON value @"initial"@
  | CustomerBalanceTransactionType'EnumInvoiceOverpaid -- ^ Represents the JSON value @"invoice_overpaid"@
  | CustomerBalanceTransactionType'EnumInvoiceTooLarge -- ^ Represents the JSON value @"invoice_too_large"@
  | CustomerBalanceTransactionType'EnumInvoiceTooSmall -- ^ Represents the JSON value @"invoice_too_small"@
  | CustomerBalanceTransactionType'EnumMigration -- ^ Represents the JSON value @"migration"@
  | CustomerBalanceTransactionType'EnumUnappliedFromInvoice -- ^ Represents the JSON value @"unapplied_from_invoice"@
  | CustomerBalanceTransactionType'EnumUnspentReceiverCredit -- ^ Represents the JSON value @"unspent_receiver_credit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerBalanceTransactionType'
    where {toJSON (CustomerBalanceTransactionType'Other val) = val;
           ...
           toJSON (CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPayment) = "checkout_session_subscription_payment";
           toJSON (CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPaymentCanceled) = "checkout_session_subscription_payment_canceled";
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerBalanceTransactionType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "adjustment" -> CustomerBalanceTransactionType'EnumAdjustment
                                             | val GHC.Classes.== "applied_to_invoice" -> CustomerBalanceTransactionType'EnumAppliedToInvoice
                                             | val GHC.Classes.== "checkout_session_subscription_payment" -> CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPayment
                                             | val GHC.Classes.== "checkout_session_subscription_payment_canceled" -> CustomerBalanceTransactionType'EnumCheckoutSessionSubscriptionPaymentCanceled
