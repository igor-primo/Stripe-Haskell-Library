...
data CustomerTax = CustomerTax {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerTax
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["automatic_tax" Data.Aeson.Types.ToJSON..= customerTaxAutomaticTax obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip_address" Data.Aeson.Types.ToJSON..=)) (customerTaxIpAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("location" Data.Aeson.Types.ToJSON..=)) (customerTaxLocation obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerTax
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerTax" (\obj -> ((GHC.Base.pure CustomerTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "automatic_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location"))}
-- | Create a new 'CustomerTax' with all required fields.
mkCustomerTax :: CustomerTaxAutomaticTax' -- ^ 'customerTaxAutomaticTax'
  -> CustomerTax
mkCustomerTax customerTaxAutomaticTax = CustomerTax{customerTaxAutomaticTax = customerTaxAutomaticTax,
...
data CustomerTaxAutomaticTax' =
   CustomerTaxAutomaticTax'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CustomerTaxAutomaticTax'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CustomerTaxAutomaticTax'EnumFailed -- ^ Represents the JSON value @"failed"@
  | CustomerTaxAutomaticTax'EnumNotCollecting -- ^ Represents the JSON value @"not_collecting"@
  | CustomerTaxAutomaticTax'EnumSupported -- ^ Represents the JSON value @"supported"@
  | CustomerTaxAutomaticTax'EnumUnrecognizedLocation -- ^ Represents the JSON value @"unrecognized_location"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerTaxAutomaticTax'
    where {toJSON (CustomerTaxAutomaticTax'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerTaxAutomaticTax'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> CustomerTaxAutomaticTax'EnumFailed
...
data CustomerTaxLocation'NonNullable = CustomerTaxLocation'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerTaxLocation'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerTaxLocation'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "CustomerTaxLocation'NonNullable" (\obj -> ((GHC.Base.pure CustomerTaxLocation'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "source")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkCustomerTaxLocation'NonNullable = CustomerTaxLocation'NonNullable{customerTaxLocation'NonNullableCountry = GHC.Maybe.Nothing,
...
data CustomerTaxLocation'NonNullableSource' =
   CustomerTaxLocation'NonNullableSource'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | CustomerTaxLocation'NonNullableSource'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | CustomerTaxLocation'NonNullableSource'EnumBillingAddress -- ^ Represents the JSON value @"billing_address"@
  | CustomerTaxLocation'NonNullableSource'EnumIpAddress -- ^ Represents the JSON value @"ip_address"@
  | CustomerTaxLocation'NonNullableSource'EnumPaymentMethod -- ^ Represents the JSON value @"payment_method"@
  | CustomerTaxLocation'NonNullableSource'EnumShippingDestination -- ^ Represents the JSON value @"shipping_destination"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON CustomerTaxLocation'NonNullableSource'
    where {toJSON (CustomerTaxLocation'NonNullableSource'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON CustomerTaxLocation'NonNullableSource'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "billing_address" -> CustomerTaxLocation'NonNullableSource'EnumBillingAddress
