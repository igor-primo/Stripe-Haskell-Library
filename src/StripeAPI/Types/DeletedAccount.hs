...
data DeletedAccount = DeletedAccount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeletedAccount
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= deletedAccountId obj] : ["deleted" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.Bool GHC.Types.True] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "account"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DeletedAccount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeletedAccount" (\obj -> GHC.Base.pure DeletedAccount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id"))}
-- | Create a new 'DeletedAccount' with all required fields.
mkDeletedAccount :: Data.Text.Internal.Text -- ^ 'deletedAccountId'
  -> DeletedAccount
