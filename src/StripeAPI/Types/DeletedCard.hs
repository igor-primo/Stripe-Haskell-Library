...
data DeletedCard = DeletedCard {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeletedCard
...
instance Data.Aeson.Types.FromJSON.FromJSON DeletedCard
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeletedCard" (\obj -> (GHC.Base.pure DeletedCard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id"))}
-- | Create a new 'DeletedCard' with all required fields.
mkDeletedCard :: Data.Text.Internal.Text -- ^ 'deletedCardId'
  -> DeletedCard
mkDeletedCard deletedCardId = DeletedCard{deletedCardCurrency = GHC.Maybe.Nothing,
