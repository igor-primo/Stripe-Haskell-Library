...
data DeletedPaymentSourceObject' =
  ...
  | DeletedPaymentSourceObject'EnumBankAccount -- ^ Represents the JSON value @"bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON DeletedPaymentSourceObject'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_account" -> DeletedPaymentSourceObject'EnumBankAccount
