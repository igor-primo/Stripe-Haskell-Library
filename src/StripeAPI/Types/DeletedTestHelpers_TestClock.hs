...
data DeletedTestHelpers'testClock = DeletedTestHelpers'testClock {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DeletedTestHelpers'testClock
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= deletedTestHelpers'testClockId obj] : ["deleted" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.Bool GHC.Types.True] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "test_helpers.test_clock"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DeletedTestHelpers'testClock
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DeletedTestHelpers'testClock" (\obj -> GHC.Base.pure DeletedTestHelpers'testClock GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id"))}
-- | Create a new 'DeletedTestHelpers'testClock' with all required fields.
mkDeletedTestHelpers'testClock :: Data.Text.Internal.Text -- ^ 'deletedTestHelpers'testClockId'
