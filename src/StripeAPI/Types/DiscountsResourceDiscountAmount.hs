...
data DiscountsResourceDiscountAmount = DiscountsResourceDiscountAmount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceDiscountAmount
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= discountsResourceDiscountAmountAmount obj] : ["discount" Data.Aeson.Types.ToJSON..= discountsResourceDiscountAmountDiscount obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DiscountsResourceDiscountAmount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DiscountsResourceDiscountAmount" (\obj -> (GHC.Base.pure DiscountsResourceDiscountAmount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discount"))}
-- | Create a new 'DiscountsResourceDiscountAmount' with all required fields.
mkDiscountsResourceDiscountAmount :: GHC.Types.Int -- ^ 'discountsResourceDiscountAmountAmount'
  -> DiscountsResourceDiscountAmountDiscount'Variants -- ^ 'discountsResourceDiscountAmountDiscount'
  -> DiscountsResourceDiscountAmount
mkDiscountsResourceDiscountAmount discountsResourceDiscountAmountAmount discountsResourceDiscountAmountDiscount = DiscountsResourceDiscountAmount{discountsResourceDiscountAmountAmount = discountsResourceDiscountAmountAmount,
...
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceDiscountAmountDiscount'Variants
    where {toJSON (DiscountsResourceDiscountAmountDiscount'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
