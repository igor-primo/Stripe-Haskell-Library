...
data DiscountsResourceStackableDiscount = DiscountsResourceStackableDiscount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceStackableDiscount
...
instance Data.Aeson.Types.FromJSON.FromJSON DiscountsResourceStackableDiscount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DiscountsResourceStackableDiscount" (\obj -> ((GHC.Base.pure DiscountsResourceStackableDiscount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
...
mkDiscountsResourceStackableDiscount = DiscountsResourceStackableDiscount{discountsResourceStackableDiscountCoupon = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceStackableDiscountCoupon'NonNullableVariants
    where {toJSON (DiscountsResourceStackableDiscountCoupon'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (DiscountsResourceStackableDiscountCoupon'NonNullableCoupon a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON DiscountsResourceStackableDiscountCoupon'NonNullableVariants
    where {parseJSON val = case (DiscountsResourceStackableDiscountCoupon'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((DiscountsResourceStackableDiscountCoupon'NonNullableCoupon Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data DiscountsResourceStackableDiscountDiscount'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceStackableDiscountDiscount'NonNullableVariants
    where {toJSON (DiscountsResourceStackableDiscountDiscount'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (DiscountsResourceStackableDiscountDiscount'NonNullableDiscount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON DiscountsResourceStackableDiscountDiscount'NonNullableVariants
    where {parseJSON val = case (DiscountsResourceStackableDiscountDiscount'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((DiscountsResourceStackableDiscountDiscount'NonNullableDiscount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data DiscountsResourceStackableDiscountPromotionCode'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DiscountsResourceStackableDiscountPromotionCode'NonNullableVariants
    where {toJSON (DiscountsResourceStackableDiscountPromotionCode'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (DiscountsResourceStackableDiscountPromotionCode'NonNullablePromotionCode a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON DiscountsResourceStackableDiscountPromotionCode'NonNullableVariants
    where {parseJSON val = case (DiscountsResourceStackableDiscountPromotionCode'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((DiscountsResourceStackableDiscountPromotionCode'NonNullablePromotionCode Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
