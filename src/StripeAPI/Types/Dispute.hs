...
mkDispute :: GHC.Types.Int -- ^ 'disputeAmount'
  ...
  -> DisputeStatus' -- ^ 'disputeStatus'
  -> Dispute
mkDispute disputeAmount disputeBalanceTransactions disputeCharge disputeCreated disputeCurrency disputeEnhancedEligibilityTypes disputeEvidence disputeEvidenceDetails disputeId disputeIsChargeRefundable disputeLivemode disputeMetadata disputeReason disputeStatus = Dispute{disputeAmount = disputeAmount,
...
data DisputeEnhancedEligibilityTypes' =
   DisputeEnhancedEligibilityTypes'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | DisputeEnhancedEligibilityTypes'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | DisputeEnhancedEligibilityTypes'EnumVisaCompellingEvidence_3 -- ^ Represents the JSON value @"visa_compelling_evidence_3"@
  | DisputeEnhancedEligibilityTypes'EnumVisaCompliance -- ^ Represents the JSON value @"visa_compliance"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEligibilityTypes'
    where {toJSON (DisputeEnhancedEligibilityTypes'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEligibilityTypes'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "visa_compelling_evidence_3" -> DisputeEnhancedEligibilityTypes'EnumVisaCompellingEvidence_3
