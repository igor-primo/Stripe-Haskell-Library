...
data DisputeEnhancedEligibilityVisaCompellingEvidence3 = DisputeEnhancedEligibilityVisaCompellingEvidence3 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEligibilityVisaCompellingEvidence3
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["required_actions" Data.Aeson.Types.ToJSON..= disputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions obj] : ["status" Data.Aeson.Types.ToJSON..= disputeEnhancedEligibilityVisaCompellingEvidence3Status obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEligibilityVisaCompellingEvidence3
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputeEnhancedEligibilityVisaCompellingEvidence3" (\obj -> (GHC.Base.pure DisputeEnhancedEligibilityVisaCompellingEvidence3 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "required_actions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status"))}
-- | Create a new 'DisputeEnhancedEligibilityVisaCompellingEvidence3' with all required fields.
mkDisputeEnhancedEligibilityVisaCompellingEvidence3 :: [DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'] -- ^ 'disputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'
  -> DisputeEnhancedEligibilityVisaCompellingEvidence3Status' -- ^ 'disputeEnhancedEligibilityVisaCompellingEvidence3Status'
  -> DisputeEnhancedEligibilityVisaCompellingEvidence3
mkDisputeEnhancedEligibilityVisaCompellingEvidence3 disputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions disputeEnhancedEligibilityVisaCompellingEvidence3Status = DisputeEnhancedEligibilityVisaCompellingEvidence3{disputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions = disputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions,
                                                                                                                                                                                                                                 disputeEnhancedEligibilityVisaCompellingEvidence3Status = disputeEnhancedEligibilityVisaCompellingEvidence3Status}
...
data DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions' =
   DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingCustomerIdentifiers -- ^ Represents the JSON value @"missing_customer_identifiers"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingDisputedTransactionDescription -- ^ Represents the JSON value @"missing_disputed_transaction_description"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingMerchandiseOrServices -- ^ Represents the JSON value @"missing_merchandise_or_services"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingPriorUndisputedTransactionDescription -- ^ Represents the JSON value @"missing_prior_undisputed_transaction_description"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingPriorUndisputedTransactions -- ^ Represents the JSON value @"missing_prior_undisputed_transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'
    where {toJSON (DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "missing_customer_identifiers" -> DisputeEnhancedEligibilityVisaCompellingEvidence3RequiredActions'EnumMissingCustomerIdentifiers
...
data DisputeEnhancedEligibilityVisaCompellingEvidence3Status' =
   DisputeEnhancedEligibilityVisaCompellingEvidence3Status'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | DisputeEnhancedEligibilityVisaCompellingEvidence3Status'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | DisputeEnhancedEligibilityVisaCompellingEvidence3Status'EnumNotQualified -- ^ Represents the JSON value @"not_qualified"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3Status'EnumQualified -- ^ Represents the JSON value @"qualified"@
  | DisputeEnhancedEligibilityVisaCompellingEvidence3Status'EnumRequiresAction -- ^ Represents the JSON value @"requires_action"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEligibilityVisaCompellingEvidence3Status'
    where {toJSON (DisputeEnhancedEligibilityVisaCompellingEvidence3Status'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEligibilityVisaCompellingEvidence3Status'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "not_qualified" -> DisputeEnhancedEligibilityVisaCompellingEvidence3Status'EnumNotQualified
