...
data DisputeEnhancedEvidence = DisputeEnhancedEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEvidence
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEvidence
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputeEnhancedEvidence" (\obj -> (GHC.Base.pure DisputeEnhancedEvidence GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "visa_compelling_evidence_3")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "visa_compliance"))}
-- | Create a new 'DisputeEnhancedEvidence' with all required fields.
mkDisputeEnhancedEvidence :: DisputeEnhancedEvidence
mkDisputeEnhancedEvidence = DisputeEnhancedEvidence{disputeEnhancedEvidenceVisaCompellingEvidence_3 = GHC.Maybe.Nothing,
