...
data DisputeEnhancedEvidenceVisaCompliance = DisputeEnhancedEvidenceVisaCompliance {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputeEnhancedEvidenceVisaCompliance
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["fee_acknowledged" Data.Aeson.Types.ToJSON..= disputeEnhancedEvidenceVisaComplianceFeeAcknowledged obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputeEnhancedEvidenceVisaCompliance
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputeEnhancedEvidenceVisaCompliance" (\obj -> GHC.Base.pure DisputeEnhancedEvidenceVisaCompliance GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fee_acknowledged"))}
-- | Create a new 'DisputeEnhancedEvidenceVisaCompliance' with all required fields.
mkDisputeEnhancedEvidenceVisaCompliance :: GHC.Types.Bool -- ^ 'disputeEnhancedEvidenceVisaComplianceFeeAcknowledged'
