...
mkDisputeEvidenceDetails :: DisputeEnhancedEligibility -- ^ 'disputeEvidenceDetailsEnhancedEligibility'
  -> GHC.Types.Bool -- ^ 'disputeEvidenceDetailsHasEvidence'
  -> GHC.Types.Bool -- ^ 'disputeEvidenceDetailsPastDue'
  -> GHC.Types.Int -- ^ 'disputeEvidenceDetailsSubmissionCount'
  -> DisputeEvidenceDetails
mkDisputeEvidenceDetails disputeEvidenceDetailsEnhancedEligibility disputeEvidenceDetailsHasEvidence disputeEvidenceDetailsPastDue disputeEvidenceDetailsSubmissionCount = DisputeEvidenceDetails{disputeEvidenceDetailsDueBy = GHC.Maybe.Nothing,
