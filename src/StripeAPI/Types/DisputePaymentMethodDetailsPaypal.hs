...
data DisputePaymentMethodDetailsPaypal = DisputePaymentMethodDetailsPaypal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON DisputePaymentMethodDetailsPaypal
...
instance Data.Aeson.Types.FromJSON.FromJSON DisputePaymentMethodDetailsPaypal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "DisputePaymentMethodDetailsPaypal" (\obj -> (GHC.Base.pure DisputePaymentMethodDetailsPaypal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "case_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason_code"))}
...
mkDisputePaymentMethodDetailsPaypal = DisputePaymentMethodDetailsPaypal{disputePaymentMethodDetailsPaypalCaseId = GHC.Maybe.Nothing,
