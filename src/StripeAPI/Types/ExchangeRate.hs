...
data ExchangeRate = ExchangeRate {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ExchangeRate
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["id" Data.Aeson.Types.ToJSON..= exchangeRateId obj] : ["rates" Data.Aeson.Types.ToJSON..= exchangeRateRates obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "exchange_rate"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON ExchangeRate
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ExchangeRate" (\obj -> (GHC.Base.pure ExchangeRate GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "rates"))}
-- | Create a new 'ExchangeRate' with all required fields.
mkExchangeRate :: Data.Text.Internal.Text -- ^ 'exchangeRateId'
  -> Data.Aeson.Types.Internal.Object -- ^ 'exchangeRateRates'
  -> ExchangeRate
mkExchangeRate exchangeRateId exchangeRateRates = ExchangeRate{exchangeRateId = exchangeRateId,
