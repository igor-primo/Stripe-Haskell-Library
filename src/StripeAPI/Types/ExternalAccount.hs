...
data ExternalAccount = ExternalAccount {
  ...
  , externalAccountAllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ExternalAccountAllowRedisplay'NonNullable))
  ...
  , externalAccountFutureRequirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ExternalAccountFutureRequirements'NonNullable))
  ...
  -- 
  -- * Maximum length of 5000
  , externalAccountIin :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  ...
  -- | networks: 
  , externalAccountNetworks :: (GHC.Maybe.Maybe TokenCardNetworks)
  ...
  , externalAccountRegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ExternalAccountRegulatedStatus'NonNullable))
  -- | requirements: Information about the requirements for the bank account, including what information needs to be collected.
  , externalAccountRequirements :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable ExternalAccountRequirements'NonNullable))
...
mkExternalAccount = ExternalAccount{externalAccountAccount = GHC.Maybe.Nothing,
                                    ...
                                    externalAccountAllowRedisplay = GHC.Maybe.Nothing,
                                    ...
                                    externalAccountFutureRequirements = GHC.Maybe.Nothing,
                                    externalAccountId = GHC.Maybe.Nothing,
                                    externalAccountIin = GHC.Maybe.Nothing,
                                    externalAccountLast4 = GHC.Maybe.Nothing,
                                    externalAccountMetadata = GHC.Maybe.Nothing,
                                    externalAccountName = GHC.Maybe.Nothing,
                                    externalAccountNetworks = GHC.Maybe.Nothing,
                                    externalAccountObject = GHC.Maybe.Nothing,
                                    externalAccountRegulatedStatus = GHC.Maybe.Nothing,
                                    externalAccountRequirements = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @components.schemas.external_account.anyOf.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
data ExternalAccountAllowRedisplay'NonNullable =
   ExternalAccountAllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ExternalAccountAllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ExternalAccountAllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | ExternalAccountAllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | ExternalAccountAllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ExternalAccountAllowRedisplay'NonNullable
    where {toJSON (ExternalAccountAllowRedisplay'NonNullableOther val) = val;
           toJSON (ExternalAccountAllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (ExternalAccountAllowRedisplay'NonNullableEnumAlways) = "always";
           toJSON (ExternalAccountAllowRedisplay'NonNullableEnumLimited) = "limited";
           toJSON (ExternalAccountAllowRedisplay'NonNullableEnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON ExternalAccountAllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> ExternalAccountAllowRedisplay'NonNullableEnumAlways
                                             | val GHC.Classes.== "limited" -> ExternalAccountAllowRedisplay'NonNullableEnumLimited
                                             | val GHC.Classes.== "unspecified" -> ExternalAccountAllowRedisplay'NonNullableEnumUnspecified
                                             | GHC.Base.otherwise -> ExternalAccountAllowRedisplay'NonNullableOther val)}
...
instance Data.Aeson.Types.FromJSON.FromJSON ExternalAccountCustomer'NonNullableVariants
    where {parseJSON val = case (ExternalAccountCustomer'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ExternalAccountCustomer'NonNullableCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ExternalAccountCustomer'NonNullableDeletedCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the object schema located at @components.schemas.external_account.anyOf.properties.future_requirements.anyOf@ in the specification.
-- 
-- Information about the [upcoming new requirements for the bank account](https:\\\/\\\/stripe.com\\\/docs\\\/connect\\\/custom-accounts\\\/future-requirements), including what information needs to be collected, and by when.
data ExternalAccountFutureRequirements'NonNullable = ExternalAccountFutureRequirements'NonNullable {
  ...
  externalAccountFutureRequirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , externalAccountFutureRequirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  ...
  , externalAccountFutureRequirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  ...
  , externalAccountFutureRequirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ExternalAccountFutureRequirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (externalAccountFutureRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON ExternalAccountFutureRequirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ExternalAccountFutureRequirements'NonNullable" (\obj -> (((GHC.Base.pure ExternalAccountFutureRequirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'ExternalAccountFutureRequirements'NonNullable' with all required fields.
mkExternalAccountFutureRequirements'NonNullable :: ExternalAccountFutureRequirements'NonNullable
mkExternalAccountFutureRequirements'NonNullable = ExternalAccountFutureRequirements'NonNullable{externalAccountFutureRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                                externalAccountFutureRequirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                                externalAccountFutureRequirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                                externalAccountFutureRequirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
...
-- | Defines the enum schema located at @components.schemas.external_account.anyOf.properties.regulated_status@ in the specification.
-- 
-- Status of a card based on the card issuer.
data ExternalAccountRegulatedStatus'NonNullable =
   ExternalAccountRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ExternalAccountRegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ExternalAccountRegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | ExternalAccountRegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ExternalAccountRegulatedStatus'NonNullable
    where {toJSON (ExternalAccountRegulatedStatus'NonNullableOther val) = val;
           toJSON (ExternalAccountRegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (ExternalAccountRegulatedStatus'NonNullableEnumRegulated) = "regulated";
           toJSON (ExternalAccountRegulatedStatus'NonNullableEnumUnregulated) = "unregulated"}
instance Data.Aeson.Types.FromJSON.FromJSON ExternalAccountRegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> ExternalAccountRegulatedStatus'NonNullableEnumRegulated
                                             | val GHC.Classes.== "unregulated" -> ExternalAccountRegulatedStatus'NonNullableEnumUnregulated
                                             | GHC.Base.otherwise -> ExternalAccountRegulatedStatus'NonNullableOther val)}
-- | Defines the object schema located at @components.schemas.external_account.anyOf.properties.requirements.anyOf@ in the specification.
-- 
-- Information about the requirements for the bank account, including what information needs to be collected.
data ExternalAccountRequirements'NonNullable = ExternalAccountRequirements'NonNullable {
  -- | currently_due: Fields that need to be collected to keep the external account enabled. If not collected by \`current_deadline\`, these fields appear in \`past_due\` as well, and the account is disabled.
  externalAccountRequirements'NonNullableCurrentlyDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | errors: Fields that are \`currently_due\` and need to be collected again because validation or verification failed.
  , externalAccountRequirements'NonNullableErrors :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [AccountRequirementsError]))
  -- | past_due: Fields that weren\'t collected by \`current_deadline\`. These fields need to be collected to enable the external account.
  , externalAccountRequirements'NonNullablePastDue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  -- | pending_verification: Fields that might become required depending on the results of verification or review. It\'s an empty array unless an asynchronous verification is pending. If verification fails, these fields move to \`eventually_due\`, \`currently_due\`, or \`past_due\`. Fields might appear in \`eventually_due\`, \`currently_due\`, or \`past_due\` and in \`pending_verification\` if verification fails but another verification is still pending.
  , externalAccountRequirements'NonNullablePendingVerification :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [Data.Text.Internal.Text]))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ExternalAccountRequirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (externalAccountRequirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON ExternalAccountRequirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ExternalAccountRequirements'NonNullable" (\obj -> (((GHC.Base.pure ExternalAccountRequirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
-- | Create a new 'ExternalAccountRequirements'NonNullable' with all required fields.
mkExternalAccountRequirements'NonNullable :: ExternalAccountRequirements'NonNullable
mkExternalAccountRequirements'NonNullable = ExternalAccountRequirements'NonNullable{externalAccountRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
                                                                                    externalAccountRequirements'NonNullableErrors = GHC.Maybe.Nothing,
                                                                                    externalAccountRequirements'NonNullablePastDue = GHC.Maybe.Nothing,
                                                                                    externalAccountRequirements'NonNullablePendingVerification = GHC.Maybe.Nothing}
