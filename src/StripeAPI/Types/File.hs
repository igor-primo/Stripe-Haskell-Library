...
data FilePurpose' =
  ...
  | FilePurpose'EnumFinancialAccountStatement -- ^ Represents the JSON value @"financial_account_statement"@
  ...
  | FilePurpose'EnumIssuingRegulatoryReporting -- ^ Represents the JSON value @"issuing_regulatory_reporting"@
