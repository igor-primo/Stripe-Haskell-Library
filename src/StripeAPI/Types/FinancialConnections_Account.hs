...
data FinancialConnections'account = FinancialConnections'account {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'account
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'account
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'account" (\obj -> (((((((((((((((((GHC.Base.pure FinancialConnections'account GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance_refresh")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "display_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "institution_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ownership")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ownership_refresh")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "permissions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subcategory")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "subscriptions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "supported_payment_method_types")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_refresh"))}
-- | Create a new 'FinancialConnections'account' with all required fields.
mkFinancialConnections'account :: FinancialConnections'accountCategory' -- ^ 'financialConnections'accountCategory'
  -> GHC.Types.Int -- ^ 'financialConnections'accountCreated'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'accountId'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'accountInstitutionName'
  -> GHC.Types.Bool -- ^ 'financialConnections'accountLivemode'
  -> FinancialConnections'accountStatus' -- ^ 'financialConnections'accountStatus'
  -> FinancialConnections'accountSubcategory' -- ^ 'financialConnections'accountSubcategory'
  -> [FinancialConnections'accountSupportedPaymentMethodTypes'] -- ^ 'financialConnections'accountSupportedPaymentMethodTypes'
  -> FinancialConnections'account
mkFinancialConnections'account financialConnections'accountCategory financialConnections'accountCreated financialConnections'accountId financialConnections'accountInstitutionName financialConnections'accountLivemode financialConnections'accountStatus financialConnections'accountSubcategory financialConnections'accountSupportedPaymentMethodTypes = FinancialConnections'account{financialConnections'accountAccountHolder = GHC.Maybe.Nothing,
...
data FinancialConnections'accountAccountHolder'NonNullable = FinancialConnections'accountAccountHolder'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountAccountHolder'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountAccountHolder'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountAccountHolder'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'accountAccountHolder'NonNullable" (\obj -> ((GHC.Base.pure FinancialConnections'accountAccountHolder'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkFinancialConnections'accountAccountHolder'NonNullable = FinancialConnections'accountAccountHolder'NonNullable{financialConnections'accountAccountHolder'NonNullableAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountAccountHolder'NonNullableAccount'Variants
    where {toJSON (FinancialConnections'accountAccountHolder'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (FinancialConnections'accountAccountHolder'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountAccountHolder'NonNullableAccount'Variants
    where {parseJSON val = case (FinancialConnections'accountAccountHolder'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((FinancialConnections'accountAccountHolder'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data FinancialConnections'accountAccountHolder'NonNullableCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountAccountHolder'NonNullableCustomer'Variants
    where {toJSON (FinancialConnections'accountAccountHolder'NonNullableCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (FinancialConnections'accountAccountHolder'NonNullableCustomer'Customer a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountAccountHolder'NonNullableCustomer'Variants
    where {parseJSON val = case (FinancialConnections'accountAccountHolder'NonNullableCustomer'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((FinancialConnections'accountAccountHolder'NonNullableCustomer'Customer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data FinancialConnections'accountAccountHolder'NonNullableType' =
   FinancialConnections'accountAccountHolder'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountAccountHolder'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountAccountHolder'NonNullableType'EnumAccount -- ^ Represents the JSON value @"account"@
  | FinancialConnections'accountAccountHolder'NonNullableType'EnumCustomer -- ^ Represents the JSON value @"customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountAccountHolder'NonNullableType'
    where {toJSON (FinancialConnections'accountAccountHolder'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountAccountHolder'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> FinancialConnections'accountAccountHolder'NonNullableType'EnumAccount
...
data FinancialConnections'accountBalance'NonNullable = FinancialConnections'accountBalance'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountBalance'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("as_of" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableAsOf obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cash" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCash obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCredit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("current" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCurrent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("as_of" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableAsOf obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cash" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCash obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("credit" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCredit obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("current" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableCurrent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountBalance'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountBalance'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'accountBalance'NonNullable" (\obj -> ((((GHC.Base.pure FinancialConnections'accountBalance'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "as_of")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cash")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "current")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkFinancialConnections'accountBalance'NonNullable = FinancialConnections'accountBalance'NonNullable{financialConnections'accountBalance'NonNullableAsOf = GHC.Maybe.Nothing,
...
data FinancialConnections'accountBalance'NonNullableType' =
   FinancialConnections'accountBalance'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountBalance'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountBalance'NonNullableType'EnumCash -- ^ Represents the JSON value @"cash"@
  | FinancialConnections'accountBalance'NonNullableType'EnumCredit -- ^ Represents the JSON value @"credit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountBalance'NonNullableType'
    where {toJSON (FinancialConnections'accountBalance'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountBalance'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cash" -> FinancialConnections'accountBalance'NonNullableType'EnumCash
...
data FinancialConnections'accountBalanceRefresh'NonNullable = FinancialConnections'accountBalanceRefresh'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountBalanceRefresh'NonNullable
...
mkFinancialConnections'accountBalanceRefresh'NonNullable = FinancialConnections'accountBalanceRefresh'NonNullable{financialConnections'accountBalanceRefresh'NonNullableLastAttemptedAt = GHC.Maybe.Nothing,
...
data FinancialConnections'accountBalanceRefresh'NonNullableStatus' =
   FinancialConnections'accountBalanceRefresh'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountBalanceRefresh'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountBalanceRefresh'NonNullableStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | FinancialConnections'accountBalanceRefresh'NonNullableStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  | FinancialConnections'accountBalanceRefresh'NonNullableStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountBalanceRefresh'NonNullableStatus'
    where {toJSON (FinancialConnections'accountBalanceRefresh'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountBalanceRefresh'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> FinancialConnections'accountBalanceRefresh'NonNullableStatus'EnumFailed
...
data FinancialConnections'accountCategory' =
   FinancialConnections'accountCategory'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountCategory'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountCategory'EnumCash -- ^ Represents the JSON value @"cash"@
  | FinancialConnections'accountCategory'EnumCredit -- ^ Represents the JSON value @"credit"@
  | FinancialConnections'accountCategory'EnumInvestment -- ^ Represents the JSON value @"investment"@
  | FinancialConnections'accountCategory'EnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountCategory'
    where {toJSON (FinancialConnections'accountCategory'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountCategory'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cash" -> FinancialConnections'accountCategory'EnumCash
...
data FinancialConnections'accountOwnership'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountOwnership'NonNullableVariants
    where {toJSON (FinancialConnections'accountOwnership'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data FinancialConnections'accountOwnershipRefresh'NonNullable = FinancialConnections'accountOwnershipRefresh'NonNullable {
  ...
  -- | next_refresh_available_at: Time at which the next ownership refresh can be initiated. This value will be \`null\` when \`status\` is \`pending\`. Measured in seconds since the Unix epoch.
  , financialConnections'accountOwnershipRefresh'NonNullableNextRefreshAvailableAt :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int))
  -- | status: The status of the last refresh attempt.
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountOwnershipRefresh'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("last_attempted_at" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableLastAttemptedAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("next_refresh_available_at" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableNextRefreshAvailableAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableStatus obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("last_attempted_at" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableLastAttemptedAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("next_refresh_available_at" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableNextRefreshAvailableAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (financialConnections'accountOwnershipRefresh'NonNullableStatus obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountOwnershipRefresh'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'accountOwnershipRefresh'NonNullable" (\obj -> ((GHC.Base.pure FinancialConnections'accountOwnershipRefresh'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last_attempted_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "next_refresh_available_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))}
...
mkFinancialConnections'accountOwnershipRefresh'NonNullable = FinancialConnections'accountOwnershipRefresh'NonNullable{financialConnections'accountOwnershipRefresh'NonNullableLastAttemptedAt = GHC.Maybe.Nothing,
                                                                                                                      financialConnections'accountOwnershipRefresh'NonNullableNextRefreshAvailableAt = GHC.Maybe.Nothing,
...
data FinancialConnections'accountOwnershipRefresh'NonNullableStatus' =
   FinancialConnections'accountOwnershipRefresh'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountOwnershipRefresh'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountOwnershipRefresh'NonNullableStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | FinancialConnections'accountOwnershipRefresh'NonNullableStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  | FinancialConnections'accountOwnershipRefresh'NonNullableStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountOwnershipRefresh'NonNullableStatus'
    where {toJSON (FinancialConnections'accountOwnershipRefresh'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountOwnershipRefresh'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> FinancialConnections'accountOwnershipRefresh'NonNullableStatus'EnumFailed
...
data FinancialConnections'accountPermissions'NonNullable =
   FinancialConnections'accountPermissions'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountPermissions'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountPermissions'NonNullableEnumBalances -- ^ Represents the JSON value @"balances"@
  | FinancialConnections'accountPermissions'NonNullableEnumOwnership -- ^ Represents the JSON value @"ownership"@
  | FinancialConnections'accountPermissions'NonNullableEnumPaymentMethod -- ^ Represents the JSON value @"payment_method"@
  | FinancialConnections'accountPermissions'NonNullableEnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountPermissions'NonNullable
    where {toJSON (FinancialConnections'accountPermissions'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountPermissions'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> FinancialConnections'accountPermissions'NonNullableEnumBalances
...
data FinancialConnections'accountStatus' =
   FinancialConnections'accountStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | FinancialConnections'accountStatus'EnumDisconnected -- ^ Represents the JSON value @"disconnected"@
  | FinancialConnections'accountStatus'EnumInactive -- ^ Represents the JSON value @"inactive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountStatus'
    where {toJSON (FinancialConnections'accountStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> FinancialConnections'accountStatus'EnumActive
...
data FinancialConnections'accountSubcategory' =
   FinancialConnections'accountSubcategory'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountSubcategory'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountSubcategory'EnumChecking -- ^ Represents the JSON value @"checking"@
  | FinancialConnections'accountSubcategory'EnumCreditCard -- ^ Represents the JSON value @"credit_card"@
  | FinancialConnections'accountSubcategory'EnumLineOfCredit -- ^ Represents the JSON value @"line_of_credit"@
  | FinancialConnections'accountSubcategory'EnumMortgage -- ^ Represents the JSON value @"mortgage"@
  | FinancialConnections'accountSubcategory'EnumOther -- ^ Represents the JSON value @"other"@
  | FinancialConnections'accountSubcategory'EnumSavings -- ^ Represents the JSON value @"savings"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountSubcategory'
    where {toJSON (FinancialConnections'accountSubcategory'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountSubcategory'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> FinancialConnections'accountSubcategory'EnumChecking
...
data FinancialConnections'accountSubscriptions'NonNullable =
   FinancialConnections'accountSubscriptions'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountSubscriptions'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountSubscriptions'NonNullableEnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountSubscriptions'NonNullable
    where {toJSON (FinancialConnections'accountSubscriptions'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountSubscriptions'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "transactions" -> FinancialConnections'accountSubscriptions'NonNullableEnumTransactions
...
data FinancialConnections'accountSupportedPaymentMethodTypes' =
   FinancialConnections'accountSupportedPaymentMethodTypes'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountSupportedPaymentMethodTypes'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountSupportedPaymentMethodTypes'EnumLink -- ^ Represents the JSON value @"link"@
  | FinancialConnections'accountSupportedPaymentMethodTypes'EnumUsBankAccount -- ^ Represents the JSON value @"us_bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountSupportedPaymentMethodTypes'
    where {toJSON (FinancialConnections'accountSupportedPaymentMethodTypes'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountSupportedPaymentMethodTypes'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "link" -> FinancialConnections'accountSupportedPaymentMethodTypes'EnumLink
...
data FinancialConnections'accountTransactionRefresh'NonNullable = FinancialConnections'accountTransactionRefresh'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountTransactionRefresh'NonNullable
...
mkFinancialConnections'accountTransactionRefresh'NonNullable = FinancialConnections'accountTransactionRefresh'NonNullable{financialConnections'accountTransactionRefresh'NonNullableId = GHC.Maybe.Nothing,
...
data FinancialConnections'accountTransactionRefresh'NonNullableStatus' =
   FinancialConnections'accountTransactionRefresh'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'accountTransactionRefresh'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'accountTransactionRefresh'NonNullableStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | FinancialConnections'accountTransactionRefresh'NonNullableStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  | FinancialConnections'accountTransactionRefresh'NonNullableStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountTransactionRefresh'NonNullableStatus'
    where {toJSON (FinancialConnections'accountTransactionRefresh'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountTransactionRefresh'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> FinancialConnections'accountTransactionRefresh'NonNullableStatus'EnumFailed
