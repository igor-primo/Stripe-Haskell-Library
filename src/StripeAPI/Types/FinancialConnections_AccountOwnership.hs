...
data FinancialConnections'accountOwnership = FinancialConnections'accountOwnership {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'accountOwnership
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["created" Data.Aeson.Types.ToJSON..= financialConnections'accountOwnershipCreated obj] : ["id" Data.Aeson.Types.ToJSON..= financialConnections'accountOwnershipId obj] : ["owners" Data.Aeson.Types.ToJSON..= financialConnections'accountOwnershipOwners obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "financial_connections.account_ownership"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountOwnership
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'accountOwnership" (\obj -> ((GHC.Base.pure FinancialConnections'accountOwnership GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "owners"))}
-- | Create a new 'FinancialConnections'accountOwnership' with all required fields.
mkFinancialConnections'accountOwnership :: GHC.Types.Int -- ^ 'financialConnections'accountOwnershipCreated'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'accountOwnershipId'
  -> FinancialConnections'accountOwnershipOwners' -- ^ 'financialConnections'accountOwnershipOwners'
  -> FinancialConnections'accountOwnership
mkFinancialConnections'accountOwnership financialConnections'accountOwnershipCreated financialConnections'accountOwnershipId financialConnections'accountOwnershipOwners = FinancialConnections'accountOwnership{financialConnections'accountOwnershipCreated = financialConnections'accountOwnershipCreated,
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'accountOwnershipOwners'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'accountOwnershipOwners'" (\obj -> ((GHC.Base.pure FinancialConnections'accountOwnershipOwners' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'FinancialConnections'accountOwnershipOwners'' with all required fields.
mkFinancialConnections'accountOwnershipOwners' :: [FinancialConnections'accountOwner] -- ^ 'financialConnections'accountOwnershipOwners'Data'
  -> GHC.Types.Bool -- ^ 'financialConnections'accountOwnershipOwners'HasMore'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'accountOwnershipOwners'Url'
  -> FinancialConnections'accountOwnershipOwners'
mkFinancialConnections'accountOwnershipOwners' financialConnections'accountOwnershipOwners'Data financialConnections'accountOwnershipOwners'HasMore financialConnections'accountOwnershipOwners'Url = FinancialConnections'accountOwnershipOwners'{financialConnections'accountOwnershipOwners'Data = financialConnections'accountOwnershipOwners'Data,
