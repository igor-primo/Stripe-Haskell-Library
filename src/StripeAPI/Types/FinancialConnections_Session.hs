...
data FinancialConnections'session = FinancialConnections'session {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'session
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'session
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'session" (\obj -> ((((((((GHC.Base.pure FinancialConnections'session GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "accounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "client_secret")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "filters")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "permissions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "prefetch")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "return_url"))}
-- | Create a new 'FinancialConnections'session' with all required fields.
mkFinancialConnections'session :: FinancialConnections'sessionAccounts' -- ^ 'financialConnections'sessionAccounts'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'sessionClientSecret'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'sessionId'
  -> GHC.Types.Bool -- ^ 'financialConnections'sessionLivemode'
  -> [FinancialConnections'sessionPermissions'] -- ^ 'financialConnections'sessionPermissions'
  -> FinancialConnections'session
mkFinancialConnections'session financialConnections'sessionAccounts financialConnections'sessionClientSecret financialConnections'sessionId financialConnections'sessionLivemode financialConnections'sessionPermissions = FinancialConnections'session{financialConnections'sessionAccountHolder = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                        financialConnections'sessionAccounts = financialConnections'sessionAccounts,
...
data FinancialConnections'sessionAccountHolder'NonNullable = FinancialConnections'sessionAccountHolder'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionAccountHolder'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (financialConnections'sessionAccountHolder'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionAccountHolder'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'sessionAccountHolder'NonNullable" (\obj -> ((GHC.Base.pure FinancialConnections'sessionAccountHolder'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkFinancialConnections'sessionAccountHolder'NonNullable = FinancialConnections'sessionAccountHolder'NonNullable{financialConnections'sessionAccountHolder'NonNullableAccount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionAccountHolder'NonNullableAccount'Variants
    where {toJSON (FinancialConnections'sessionAccountHolder'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (FinancialConnections'sessionAccountHolder'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionAccountHolder'NonNullableAccount'Variants
    where {parseJSON val = case (FinancialConnections'sessionAccountHolder'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((FinancialConnections'sessionAccountHolder'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data FinancialConnections'sessionAccountHolder'NonNullableCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionAccountHolder'NonNullableCustomer'Variants
    where {toJSON (FinancialConnections'sessionAccountHolder'NonNullableCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (FinancialConnections'sessionAccountHolder'NonNullableCustomer'Customer a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionAccountHolder'NonNullableCustomer'Variants
    where {parseJSON val = case (FinancialConnections'sessionAccountHolder'NonNullableCustomer'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((FinancialConnections'sessionAccountHolder'NonNullableCustomer'Customer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data FinancialConnections'sessionAccountHolder'NonNullableType' =
   FinancialConnections'sessionAccountHolder'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'sessionAccountHolder'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'sessionAccountHolder'NonNullableType'EnumAccount -- ^ Represents the JSON value @"account"@
  | FinancialConnections'sessionAccountHolder'NonNullableType'EnumCustomer -- ^ Represents the JSON value @"customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionAccountHolder'NonNullableType'
    where {toJSON (FinancialConnections'sessionAccountHolder'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionAccountHolder'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> FinancialConnections'sessionAccountHolder'NonNullableType'EnumAccount
...
data FinancialConnections'sessionAccounts' = FinancialConnections'sessionAccounts' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionAccounts'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= financialConnections'sessionAccounts'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= financialConnections'sessionAccounts'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= financialConnections'sessionAccounts'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionAccounts'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FinancialConnections'sessionAccounts'" (\obj -> ((GHC.Base.pure FinancialConnections'sessionAccounts' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'FinancialConnections'sessionAccounts'' with all required fields.
mkFinancialConnections'sessionAccounts' :: [FinancialConnections'account] -- ^ 'financialConnections'sessionAccounts'Data'
  -> GHC.Types.Bool -- ^ 'financialConnections'sessionAccounts'HasMore'
  -> Data.Text.Internal.Text -- ^ 'financialConnections'sessionAccounts'Url'
  -> FinancialConnections'sessionAccounts'
mkFinancialConnections'sessionAccounts' financialConnections'sessionAccounts'Data financialConnections'sessionAccounts'HasMore financialConnections'sessionAccounts'Url = FinancialConnections'sessionAccounts'{financialConnections'sessionAccounts'Data = financialConnections'sessionAccounts'Data,
...
data FinancialConnections'sessionPermissions' =
   FinancialConnections'sessionPermissions'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'sessionPermissions'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'sessionPermissions'EnumBalances -- ^ Represents the JSON value @"balances"@
  | FinancialConnections'sessionPermissions'EnumOwnership -- ^ Represents the JSON value @"ownership"@
  | FinancialConnections'sessionPermissions'EnumPaymentMethod -- ^ Represents the JSON value @"payment_method"@
  | FinancialConnections'sessionPermissions'EnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionPermissions'
    where {toJSON (FinancialConnections'sessionPermissions'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionPermissions'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> FinancialConnections'sessionPermissions'EnumBalances
...
data FinancialConnections'sessionPrefetch'NonNullable =
   FinancialConnections'sessionPrefetch'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FinancialConnections'sessionPrefetch'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FinancialConnections'sessionPrefetch'NonNullableEnumBalances -- ^ Represents the JSON value @"balances"@
  | FinancialConnections'sessionPrefetch'NonNullableEnumOwnership -- ^ Represents the JSON value @"ownership"@
  | FinancialConnections'sessionPrefetch'NonNullableEnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FinancialConnections'sessionPrefetch'NonNullable
    where {toJSON (FinancialConnections'sessionPrefetch'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FinancialConnections'sessionPrefetch'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> FinancialConnections'sessionPrefetch'NonNullableEnumBalances
