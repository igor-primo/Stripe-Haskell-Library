...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FundingInstructions" (\obj -> ((GHC.Base.pure FundingInstructions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode"))}
-- | Create a new 'FundingInstructions' with all required fields.
mkFundingInstructions :: FundingInstructionsBankTransfer -- ^ 'fundingInstructionsBankTransfer'
  -> Data.Text.Internal.Text -- ^ 'fundingInstructionsCurrency'
  -> GHC.Types.Bool -- ^ 'fundingInstructionsLivemode'
  -> FundingInstructions
mkFundingInstructions fundingInstructionsBankTransfer fundingInstructionsCurrency fundingInstructionsLivemode = FundingInstructions{fundingInstructionsBankTransfer = fundingInstructionsBankTransfer,
