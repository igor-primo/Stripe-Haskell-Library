...
data FundingInstructionsBankTransferFinancialAddress = FundingInstructionsBankTransferFinancialAddress {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FundingInstructionsBankTransferFinancialAddress
...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructionsBankTransferFinancialAddress
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "FundingInstructionsBankTransferFinancialAddress" (\obj -> (((((((GHC.Base.pure FundingInstructionsBankTransferFinancialAddress GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "aba")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "iban")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "sort_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "spei")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "supported_networks")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "swift")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "zengin"))}
-- | Create a new 'FundingInstructionsBankTransferFinancialAddress' with all required fields.
mkFundingInstructionsBankTransferFinancialAddress :: FundingInstructionsBankTransferFinancialAddressType' -- ^ 'fundingInstructionsBankTransferFinancialAddressType'
  -> FundingInstructionsBankTransferFinancialAddress
mkFundingInstructionsBankTransferFinancialAddress fundingInstructionsBankTransferFinancialAddressType = FundingInstructionsBankTransferFinancialAddress{fundingInstructionsBankTransferFinancialAddressAba = GHC.Maybe.Nothing,
...
data FundingInstructionsBankTransferFinancialAddressSupportedNetworks' =
   FundingInstructionsBankTransferFinancialAddressSupportedNetworks'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumAch -- ^ Represents the JSON value @"ach"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumBacs -- ^ Represents the JSON value @"bacs"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumDomesticWireUs -- ^ Represents the JSON value @"domestic_wire_us"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumFps -- ^ Represents the JSON value @"fps"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumSepa -- ^ Represents the JSON value @"sepa"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumSpei -- ^ Represents the JSON value @"spei"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumSwift -- ^ Represents the JSON value @"swift"@
  | FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumZengin -- ^ Represents the JSON value @"zengin"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FundingInstructionsBankTransferFinancialAddressSupportedNetworks'
    where {toJSON (FundingInstructionsBankTransferFinancialAddressSupportedNetworks'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructionsBankTransferFinancialAddressSupportedNetworks'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> FundingInstructionsBankTransferFinancialAddressSupportedNetworks'EnumAch
...
data FundingInstructionsBankTransferFinancialAddressType' =
   FundingInstructionsBankTransferFinancialAddressType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | FundingInstructionsBankTransferFinancialAddressType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | FundingInstructionsBankTransferFinancialAddressType'EnumAba -- ^ Represents the JSON value @"aba"@
  | FundingInstructionsBankTransferFinancialAddressType'EnumIban -- ^ Represents the JSON value @"iban"@
  | FundingInstructionsBankTransferFinancialAddressType'EnumSortCode -- ^ Represents the JSON value @"sort_code"@
  | FundingInstructionsBankTransferFinancialAddressType'EnumSpei -- ^ Represents the JSON value @"spei"@
  | FundingInstructionsBankTransferFinancialAddressType'EnumSwift -- ^ Represents the JSON value @"swift"@
  | FundingInstructionsBankTransferFinancialAddressType'EnumZengin -- ^ Represents the JSON value @"zengin"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FundingInstructionsBankTransferFinancialAddressType'
    where {toJSON (FundingInstructionsBankTransferFinancialAddressType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON FundingInstructionsBankTransferFinancialAddressType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "aba" -> FundingInstructionsBankTransferFinancialAddressType'EnumAba
