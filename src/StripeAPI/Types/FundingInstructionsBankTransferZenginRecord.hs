...
data FundingInstructionsBankTransferZenginRecord = FundingInstructionsBankTransferZenginRecord {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON FundingInstructionsBankTransferZenginRecord
