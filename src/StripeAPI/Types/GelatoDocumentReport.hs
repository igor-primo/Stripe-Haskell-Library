...
data GelatoDocumentReport = GelatoDocumentReport {
  ...
  , gelatoDocumentReportSex :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GelatoDocumentReportSex'NonNullable))
...
mkGelatoDocumentReport gelatoDocumentReportStatus = GelatoDocumentReport{gelatoDocumentReportAddress = GHC.Maybe.Nothing,
                                                                         ...
                                                                         gelatoDocumentReportSex = GHC.Maybe.Nothing,
                                                                         gelatoDocumentReportStatus = gelatoDocumentReportStatus,
                                                                         gelatoDocumentReportType = GHC.Maybe.Nothing,
                                                                         gelatoDocumentReportUnparsedPlaceOfBirth = GHC.Maybe.Nothing,
                                                                         gelatoDocumentReportUnparsedSex = GHC.Maybe.Nothing}
...
-- | Defines the enum schema located at @components.schemas.gelato_document_report.properties.sex@ in the specification.
-- 
-- Sex of the person in the document.
data GelatoDocumentReportSex'NonNullable =
   GelatoDocumentReportSex'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoDocumentReportSex'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoDocumentReportSex'NonNullableEnumRedacted_ -- ^ Represents the JSON value @"[redacted]"@
  | GelatoDocumentReportSex'NonNullableEnumFemale -- ^ Represents the JSON value @"female"@
  | GelatoDocumentReportSex'NonNullableEnumMale -- ^ Represents the JSON value @"male"@
  | GelatoDocumentReportSex'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoDocumentReportSex'NonNullable
    where {toJSON (GelatoDocumentReportSex'NonNullableOther val) = val;
           toJSON (GelatoDocumentReportSex'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (GelatoDocumentReportSex'NonNullableEnumRedacted_) = "[redacted]";
           toJSON (GelatoDocumentReportSex'NonNullableEnumFemale) = "female";
           toJSON (GelatoDocumentReportSex'NonNullableEnumMale) = "male";
           toJSON (GelatoDocumentReportSex'NonNullableEnumUnknown) = "unknown"}
instance Data.Aeson.Types.FromJSON.FromJSON GelatoDocumentReportSex'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "[redacted]" -> GelatoDocumentReportSex'NonNullableEnumRedacted_
                                             | val GHC.Classes.== "female" -> GelatoDocumentReportSex'NonNullableEnumFemale
                                             | val GHC.Classes.== "male" -> GelatoDocumentReportSex'NonNullableEnumMale
                                             | val GHC.Classes.== "unknown" -> GelatoDocumentReportSex'NonNullableEnumUnknown
                                             | GHC.Base.otherwise -> GelatoDocumentReportSex'NonNullableOther val)}
