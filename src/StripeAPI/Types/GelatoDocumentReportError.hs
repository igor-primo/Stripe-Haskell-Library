...
data GelatoDocumentReportError = GelatoDocumentReportError {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoDocumentReportError
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoDocumentReportError
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoDocumentReportError" (\obj -> (GHC.Base.pure GelatoDocumentReportError GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason"))}
-- | Create a new 'GelatoDocumentReportError' with all required fields.
mkGelatoDocumentReportError :: GelatoDocumentReportError
mkGelatoDocumentReportError = GelatoDocumentReportError{gelatoDocumentReportErrorCode = GHC.Maybe.Nothing,
...
data GelatoDocumentReportErrorCode'NonNullable =
   GelatoDocumentReportErrorCode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoDocumentReportErrorCode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoDocumentReportErrorCode'NonNullableEnumDocumentExpired -- ^ Represents the JSON value @"document_expired"@
  | GelatoDocumentReportErrorCode'NonNullableEnumDocumentTypeNotSupported -- ^ Represents the JSON value @"document_type_not_supported"@
  | GelatoDocumentReportErrorCode'NonNullableEnumDocumentUnverifiedOther -- ^ Represents the JSON value @"document_unverified_other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoDocumentReportErrorCode'NonNullable
    where {toJSON (GelatoDocumentReportErrorCode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoDocumentReportErrorCode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "document_expired" -> GelatoDocumentReportErrorCode'NonNullableEnumDocumentExpired
