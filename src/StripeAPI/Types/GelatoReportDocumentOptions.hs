...
data GelatoReportDocumentOptions = GelatoReportDocumentOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoReportDocumentOptions
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoReportDocumentOptions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoReportDocumentOptions" (\obj -> (((GHC.Base.pure GelatoReportDocumentOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "allowed_types")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_id_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_live_capture")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_matching_selfie"))}
...
mkGelatoReportDocumentOptions = GelatoReportDocumentOptions{gelatoReportDocumentOptionsAllowedTypes = GHC.Maybe.Nothing,
...
data GelatoReportDocumentOptionsAllowedTypes' =
   GelatoReportDocumentOptionsAllowedTypes'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoReportDocumentOptionsAllowedTypes'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoReportDocumentOptionsAllowedTypes'EnumDrivingLicense -- ^ Represents the JSON value @"driving_license"@
  | GelatoReportDocumentOptionsAllowedTypes'EnumIdCard -- ^ Represents the JSON value @"id_card"@
  | GelatoReportDocumentOptionsAllowedTypes'EnumPassport -- ^ Represents the JSON value @"passport"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoReportDocumentOptionsAllowedTypes'
    where {toJSON (GelatoReportDocumentOptionsAllowedTypes'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoReportDocumentOptionsAllowedTypes'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "driving_license" -> GelatoReportDocumentOptionsAllowedTypes'EnumDrivingLicense
