...
data GelatoSelfieReport = GelatoSelfieReport {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReport
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReport
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoSelfieReport" (\obj -> (((GHC.Base.pure GelatoSelfieReport GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "document")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "error")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "selfie")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status"))}
-- | Create a new 'GelatoSelfieReport' with all required fields.
mkGelatoSelfieReport :: GelatoSelfieReportStatus' -- ^ 'gelatoSelfieReportStatus'
  -> GelatoSelfieReport
mkGelatoSelfieReport gelatoSelfieReportStatus = GelatoSelfieReport{gelatoSelfieReportDocument = GHC.Maybe.Nothing,
...
data GelatoSelfieReportError'NonNullable = GelatoSelfieReportError'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReportError'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("code" Data.Aeson.Types.ToJSON..=)) (gelatoSelfieReportError'NonNullableCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reason" Data.Aeson.Types.ToJSON..=)) (gelatoSelfieReportError'NonNullableReason obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("code" Data.Aeson.Types.ToJSON..=)) (gelatoSelfieReportError'NonNullableCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reason" Data.Aeson.Types.ToJSON..=)) (gelatoSelfieReportError'NonNullableReason obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReportError'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoSelfieReportError'NonNullable" (\obj -> (GHC.Base.pure GelatoSelfieReportError'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason"))}
...
mkGelatoSelfieReportError'NonNullable = GelatoSelfieReportError'NonNullable{gelatoSelfieReportError'NonNullableCode = GHC.Maybe.Nothing,
...
data GelatoSelfieReportError'NonNullableCode'NonNullable =
   GelatoSelfieReportError'NonNullableCode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoSelfieReportError'NonNullableCode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoSelfieReportError'NonNullableCode'NonNullableEnumSelfieDocumentMissingPhoto -- ^ Represents the JSON value @"selfie_document_missing_photo"@
  | GelatoSelfieReportError'NonNullableCode'NonNullableEnumSelfieFaceMismatch -- ^ Represents the JSON value @"selfie_face_mismatch"@
  | GelatoSelfieReportError'NonNullableCode'NonNullableEnumSelfieManipulated -- ^ Represents the JSON value @"selfie_manipulated"@
  | GelatoSelfieReportError'NonNullableCode'NonNullableEnumSelfieUnverifiedOther -- ^ Represents the JSON value @"selfie_unverified_other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReportError'NonNullableCode'NonNullable
    where {toJSON (GelatoSelfieReportError'NonNullableCode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReportError'NonNullableCode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "selfie_document_missing_photo" -> GelatoSelfieReportError'NonNullableCode'NonNullableEnumSelfieDocumentMissingPhoto
...
data GelatoSelfieReportStatus' =
   GelatoSelfieReportStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoSelfieReportStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoSelfieReportStatus'EnumUnverified -- ^ Represents the JSON value @"unverified"@
  | GelatoSelfieReportStatus'EnumVerified -- ^ Represents the JSON value @"verified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReportStatus'
    where {toJSON (GelatoSelfieReportStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReportStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "unverified" -> GelatoSelfieReportStatus'EnumUnverified
