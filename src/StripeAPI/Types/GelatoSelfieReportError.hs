...
data GelatoSelfieReportError = GelatoSelfieReportError {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReportError
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReportError
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoSelfieReportError" (\obj -> (GHC.Base.pure GelatoSelfieReportError GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reason"))}
-- | Create a new 'GelatoSelfieReportError' with all required fields.
mkGelatoSelfieReportError :: GelatoSelfieReportError
mkGelatoSelfieReportError = GelatoSelfieReportError{gelatoSelfieReportErrorCode = GHC.Maybe.Nothing,
...
data GelatoSelfieReportErrorCode'NonNullable =
   GelatoSelfieReportErrorCode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoSelfieReportErrorCode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoSelfieReportErrorCode'NonNullableEnumSelfieDocumentMissingPhoto -- ^ Represents the JSON value @"selfie_document_missing_photo"@
  | GelatoSelfieReportErrorCode'NonNullableEnumSelfieFaceMismatch -- ^ Represents the JSON value @"selfie_face_mismatch"@
  | GelatoSelfieReportErrorCode'NonNullableEnumSelfieManipulated -- ^ Represents the JSON value @"selfie_manipulated"@
  | GelatoSelfieReportErrorCode'NonNullableEnumSelfieUnverifiedOther -- ^ Represents the JSON value @"selfie_unverified_other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSelfieReportErrorCode'NonNullable
    where {toJSON (GelatoSelfieReportErrorCode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSelfieReportErrorCode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "selfie_document_missing_photo" -> GelatoSelfieReportErrorCode'NonNullableEnumSelfieDocumentMissingPhoto
