...
data GelatoSessionDocumentOptions = GelatoSessionDocumentOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSessionDocumentOptions
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSessionDocumentOptions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "GelatoSessionDocumentOptions" (\obj -> (((GHC.Base.pure GelatoSessionDocumentOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "allowed_types")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_id_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_live_capture")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "require_matching_selfie"))}
...
mkGelatoSessionDocumentOptions = GelatoSessionDocumentOptions{gelatoSessionDocumentOptionsAllowedTypes = GHC.Maybe.Nothing,
...
data GelatoSessionDocumentOptionsAllowedTypes' =
   GelatoSessionDocumentOptionsAllowedTypes'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | GelatoSessionDocumentOptionsAllowedTypes'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | GelatoSessionDocumentOptionsAllowedTypes'EnumDrivingLicense -- ^ Represents the JSON value @"driving_license"@
  | GelatoSessionDocumentOptionsAllowedTypes'EnumIdCard -- ^ Represents the JSON value @"id_card"@
  | GelatoSessionDocumentOptionsAllowedTypes'EnumPassport -- ^ Represents the JSON value @"passport"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON GelatoSessionDocumentOptionsAllowedTypes'
    where {toJSON (GelatoSessionDocumentOptionsAllowedTypes'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON GelatoSessionDocumentOptionsAllowedTypes'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "driving_license" -> GelatoSessionDocumentOptionsAllowedTypes'EnumDrivingLicense
