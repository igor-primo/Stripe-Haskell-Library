...
data InboundTransfers = InboundTransfers {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InboundTransfers
...
instance Data.Aeson.Types.FromJSON.FromJSON InboundTransfers
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InboundTransfers" (\obj -> (GHC.Base.pure InboundTransfers GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "billing_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "us_bank_account"))}
-- | Create a new 'InboundTransfers' with all required fields.
mkInboundTransfers :: TreasurySharedResourceBillingDetails -- ^ 'inboundTransfersBillingDetails'
  -> InboundTransfers
mkInboundTransfers inboundTransfersBillingDetails = InboundTransfers{inboundTransfersBillingDetails = inboundTransfersBillingDetails,
