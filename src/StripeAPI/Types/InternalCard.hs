...
data InternalCard = InternalCard {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InternalCard
...
instance Data.Aeson.Types.FromJSON.FromJSON InternalCard
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InternalCard" (\obj -> ((((GHC.Base.pure InternalCard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "brand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_year")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4"))}
-- | Create a new 'InternalCard' with all required fields.
mkInternalCard :: InternalCard
mkInternalCard = InternalCard{internalCardBrand = GHC.Maybe.Nothing,
