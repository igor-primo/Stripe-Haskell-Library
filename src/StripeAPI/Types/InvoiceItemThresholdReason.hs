...
data InvoiceItemThresholdReason = InvoiceItemThresholdReason {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceItemThresholdReason
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["line_item_ids" Data.Aeson.Types.ToJSON..= invoiceItemThresholdReasonLineItemIds obj] : ["usage_gte" Data.Aeson.Types.ToJSON..= invoiceItemThresholdReasonUsageGte obj] : GHC.Base.mempty));
...
mkInvoiceItemThresholdReason :: [Data.Text.Internal.Text] -- ^ 'invoiceItemThresholdReasonLineItemIds'
  -> GHC.Types.Int -- ^ 'invoiceItemThresholdReasonUsageGte'
  -> InvoiceItemThresholdReason
mkInvoiceItemThresholdReason invoiceItemThresholdReasonLineItemIds invoiceItemThresholdReasonUsageGte = InvoiceItemThresholdReason{invoiceItemThresholdReasonLineItemIds = invoiceItemThresholdReasonLineItemIds,
