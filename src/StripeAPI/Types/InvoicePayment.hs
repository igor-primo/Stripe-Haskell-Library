...
data InvoicePayment = InvoicePayment {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePayment
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicePayment
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicePayment" (\obj -> ((((((((((GHC.Base.pure InvoicePayment GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_paid")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_requested")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "invoice")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "is_default")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "payment")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status_transitions"))}
-- | Create a new 'InvoicePayment' with all required fields.
mkInvoicePayment :: GHC.Types.Int -- ^ 'invoicePaymentAmountRequested'
  -> GHC.Types.Int -- ^ 'invoicePaymentCreated'
  -> Data.Text.Internal.Text -- ^ 'invoicePaymentCurrency'
  -> Data.Text.Internal.Text -- ^ 'invoicePaymentId'
  -> InvoicePaymentInvoice'Variants -- ^ 'invoicePaymentInvoice'
  -> GHC.Types.Bool -- ^ 'invoicePaymentIsDefault'
  -> GHC.Types.Bool -- ^ 'invoicePaymentLivemode'
  -> InvoicesPaymentsInvoicePaymentAssociatedPayment -- ^ 'invoicePaymentPayment'
  -> Data.Text.Internal.Text -- ^ 'invoicePaymentStatus'
  -> InvoicesPaymentsInvoicePaymentStatusTransitions -- ^ 'invoicePaymentStatusTransitions'
  -> InvoicePayment
mkInvoicePayment invoicePaymentAmountRequested invoicePaymentCreated invoicePaymentCurrency invoicePaymentId invoicePaymentInvoice invoicePaymentIsDefault invoicePaymentLivemode invoicePaymentPayment invoicePaymentStatus invoicePaymentStatusTransitions = InvoicePayment{invoicePaymentAmountPaid = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicePaymentInvoice'Variants
    where {toJSON (InvoicePaymentInvoice'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicePaymentInvoice'Variants
    where {parseJSON val = case (InvoicePaymentInvoice'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoicePaymentInvoice'Invoice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoicePaymentInvoice'DeletedInvoice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
