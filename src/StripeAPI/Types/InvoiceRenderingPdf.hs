...
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceRenderingPdf
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("page_size" Data.Aeson.Types.ToJSON..=)) (invoiceRenderingPdfPageSize obj) : GHC.Base.mempty));
...
data InvoiceRenderingPdfPageSize'NonNullable =
   InvoiceRenderingPdfPageSize'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoiceRenderingPdfPageSize'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoiceRenderingPdfPageSize'NonNullableEnumA4 -- ^ Represents the JSON value @"a4"@
  | InvoiceRenderingPdfPageSize'NonNullableEnumAuto -- ^ Represents the JSON value @"auto"@
  | InvoiceRenderingPdfPageSize'NonNullableEnumLetter -- ^ Represents the JSON value @"letter"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceRenderingPdfPageSize'NonNullable
    where {toJSON (InvoiceRenderingPdfPageSize'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceRenderingPdfPageSize'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "a4" -> InvoiceRenderingPdfPageSize'NonNullableEnumA4
