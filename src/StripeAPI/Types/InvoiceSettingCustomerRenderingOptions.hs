...
data InvoiceSettingCustomerRenderingOptions = InvoiceSettingCustomerRenderingOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoiceSettingCustomerRenderingOptions
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceSettingCustomerRenderingOptions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceSettingCustomerRenderingOptions" (\obj -> (GHC.Base.pure InvoiceSettingCustomerRenderingOptions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "template"))}
...
mkInvoiceSettingCustomerRenderingOptions = InvoiceSettingCustomerRenderingOptions{invoiceSettingCustomerRenderingOptionsAmountTaxDisplay = GHC.Maybe.Nothing,
