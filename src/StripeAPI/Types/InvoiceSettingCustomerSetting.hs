...
instance Data.Aeson.Types.FromJSON.FromJSON InvoiceSettingCustomerSettingRenderingOptions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoiceSettingCustomerSettingRenderingOptions'NonNullable" (\obj -> (GHC.Base.pure InvoiceSettingCustomerSettingRenderingOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax_display")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "template"))}
