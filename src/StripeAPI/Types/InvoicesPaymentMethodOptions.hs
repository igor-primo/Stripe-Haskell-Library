...
data InvoicesPaymentMethodOptions = InvoicesPaymentMethodOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptions
...
mkInvoicesPaymentMethodOptions = InvoicesPaymentMethodOptions{invoicesPaymentMethodOptionsAcssDebit = GHC.Maybe.Nothing,
...
data InvoicesPaymentMethodOptionsAcssDebit'NonNullable = InvoicesPaymentMethodOptionsAcssDebit'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsAcssDebit'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsAcssDebit'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsAcssDebit'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsAcssDebit'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentMethodOptionsAcssDebit'NonNullable" (\obj -> (GHC.Base.pure InvoicesPaymentMethodOptionsAcssDebit'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkInvoicesPaymentMethodOptionsAcssDebit'NonNullable = InvoicesPaymentMethodOptionsAcssDebit'NonNullable{invoicesPaymentMethodOptionsAcssDebit'NonNullableMandateOptions = GHC.Maybe.Nothing,
...
data InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod' =
   InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'
    where {toJSON (InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> InvoicesPaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumAutomatic
...
data InvoicesPaymentMethodOptionsBancontact'NonNullable = InvoicesPaymentMethodOptionsBancontact'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsBancontact'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_language" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsBancontact'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentMethodOptionsBancontact'NonNullable" (\obj -> GHC.Base.pure InvoicesPaymentMethodOptionsBancontact'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_language"))}
...
data InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage' =
   InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumDe -- ^ Represents the JSON value @"de"@
  | InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumEn -- ^ Represents the JSON value @"en"@
  | InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumFr -- ^ Represents the JSON value @"fr"@
  | InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumNl -- ^ Represents the JSON value @"nl"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'
    where {toJSON (InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "de" -> InvoicesPaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumDe
...
data InvoicesPaymentMethodOptionsCard'NonNullable = InvoicesPaymentMethodOptionsCard'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsCard'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("installments" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCard'NonNullableInstallments obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("installments" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCard'NonNullableInstallments obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsCard'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentMethodOptionsCard'NonNullable" (\obj -> (GHC.Base.pure InvoicesPaymentMethodOptionsCard'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "installments")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure"))}
...
mkInvoicesPaymentMethodOptionsCard'NonNullable = InvoicesPaymentMethodOptionsCard'NonNullable{invoicesPaymentMethodOptionsCard'NonNullableInstallments = GHC.Maybe.Nothing,
...
data InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable =
   InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAny -- ^ Represents the JSON value @"any"@
  | InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable
    where {toJSON (InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> InvoicesPaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAny
...
data InvoicesPaymentMethodOptionsCustomerBalance'NonNullable = InvoicesPaymentMethodOptionsCustomerBalance'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsCustomerBalance'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_transfer" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCustomerBalance'NonNullableBankTransfer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("funding_type" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_transfer" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCustomerBalance'NonNullableBankTransfer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("funding_type" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsCustomerBalance'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentMethodOptionsCustomerBalance'NonNullable" (\obj -> (GHC.Base.pure InvoicesPaymentMethodOptionsCustomerBalance'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "funding_type"))}
...
mkInvoicesPaymentMethodOptionsCustomerBalance'NonNullable = InvoicesPaymentMethodOptionsCustomerBalance'NonNullable{invoicesPaymentMethodOptionsCustomerBalance'NonNullableBankTransfer = GHC.Maybe.Nothing,
...
data InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable =
   InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableEnumBankTransfer -- ^ Represents the JSON value @"bank_transfer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable
    where {toJSON (InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_transfer" -> InvoicesPaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableEnumBankTransfer
...
data InvoicesPaymentMethodOptionsUsBankAccount'NonNullable = InvoicesPaymentMethodOptionsUsBankAccount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsUsBankAccount'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (invoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsUsBankAccount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentMethodOptionsUsBankAccount'NonNullable" (\obj -> (GHC.Base.pure InvoicesPaymentMethodOptionsUsBankAccount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_connections")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkInvoicesPaymentMethodOptionsUsBankAccount'NonNullable = InvoicesPaymentMethodOptionsUsBankAccount'NonNullable{invoicesPaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections = GHC.Maybe.Nothing,
...
data InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod' =
   InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'
    where {toJSON (InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> InvoicesPaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumAutomatic
