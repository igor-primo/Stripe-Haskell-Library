...
data InvoicesPaymentsInvoicePaymentAssociatedPayment = InvoicesPaymentsInvoicePaymentAssociatedPayment {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentsInvoicePaymentAssociatedPayment
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentsInvoicePaymentAssociatedPayment
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesPaymentsInvoicePaymentAssociatedPayment" (\obj -> ((GHC.Base.pure InvoicesPaymentsInvoicePaymentAssociatedPayment GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "charge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_intent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'InvoicesPaymentsInvoicePaymentAssociatedPayment' with all required fields.
mkInvoicesPaymentsInvoicePaymentAssociatedPayment :: InvoicesPaymentsInvoicePaymentAssociatedPaymentType' -- ^ 'invoicesPaymentsInvoicePaymentAssociatedPaymentType'
  -> InvoicesPaymentsInvoicePaymentAssociatedPayment
mkInvoicesPaymentsInvoicePaymentAssociatedPayment invoicesPaymentsInvoicePaymentAssociatedPaymentType = InvoicesPaymentsInvoicePaymentAssociatedPayment{invoicesPaymentsInvoicePaymentAssociatedPaymentCharge = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Variants
    where {toJSON (InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Charge a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Variants
    where {parseJSON val = case (InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoicesPaymentsInvoicePaymentAssociatedPaymentCharge'Charge Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'Variants
    where {toJSON (InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'PaymentIntent a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'Variants
    where {parseJSON val = case (InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoicesPaymentsInvoicePaymentAssociatedPaymentPaymentIntent'PaymentIntent Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data InvoicesPaymentsInvoicePaymentAssociatedPaymentType' =
   InvoicesPaymentsInvoicePaymentAssociatedPaymentType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesPaymentsInvoicePaymentAssociatedPaymentType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesPaymentsInvoicePaymentAssociatedPaymentType'EnumCharge -- ^ Represents the JSON value @"charge"@
  | InvoicesPaymentsInvoicePaymentAssociatedPaymentType'EnumPaymentIntent -- ^ Represents the JSON value @"payment_intent"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentType'
    where {toJSON (InvoicesPaymentsInvoicePaymentAssociatedPaymentType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesPaymentsInvoicePaymentAssociatedPaymentType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "charge" -> InvoicesPaymentsInvoicePaymentAssociatedPaymentType'EnumCharge
