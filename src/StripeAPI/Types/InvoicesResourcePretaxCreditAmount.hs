...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesResourcePretaxCreditAmount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesResourcePretaxCreditAmount" (\obj -> (((GHC.Base.pure InvoicesResourcePretaxCreditAmount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "credit_balance_transaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'InvoicesResourcePretaxCreditAmount' with all required fields.
mkInvoicesResourcePretaxCreditAmount :: GHC.Types.Int -- ^ 'invoicesResourcePretaxCreditAmountAmount'
  -> InvoicesResourcePretaxCreditAmountType' -- ^ 'invoicesResourcePretaxCreditAmountType'
  -> InvoicesResourcePretaxCreditAmount
mkInvoicesResourcePretaxCreditAmount invoicesResourcePretaxCreditAmountAmount invoicesResourcePretaxCreditAmountType = InvoicesResourcePretaxCreditAmount{invoicesResourcePretaxCreditAmountAmount = invoicesResourcePretaxCreditAmountAmount,
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesResourcePretaxCreditAmountCreditBalanceTransaction'NonNullableVariants
    where {toJSON (InvoicesResourcePretaxCreditAmountCreditBalanceTransaction'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data InvoicesResourcePretaxCreditAmountDiscount'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesResourcePretaxCreditAmountDiscount'Variants
    where {toJSON (InvoicesResourcePretaxCreditAmountDiscount'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data InvoicesResourcePretaxCreditAmountType' =
   InvoicesResourcePretaxCreditAmountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | InvoicesResourcePretaxCreditAmountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | InvoicesResourcePretaxCreditAmountType'EnumCreditBalanceTransaction -- ^ Represents the JSON value @"credit_balance_transaction"@
  | InvoicesResourcePretaxCreditAmountType'EnumDiscount -- ^ Represents the JSON value @"discount"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesResourcePretaxCreditAmountType'
    where {toJSON (InvoicesResourcePretaxCreditAmountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesResourcePretaxCreditAmountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_balance_transaction" -> InvoicesResourcePretaxCreditAmountType'EnumCreditBalanceTransaction
