...
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesResourceShippingCost
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "InvoicesResourceShippingCost" (\obj -> ((((GHC.Base.pure InvoicesResourceShippingCost GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "taxes"))}
-- | Create a new 'InvoicesResourceShippingCost' with all required fields.
mkInvoicesResourceShippingCost :: GHC.Types.Int -- ^ 'invoicesResourceShippingCostAmountSubtotal'
  -> GHC.Types.Int -- ^ 'invoicesResourceShippingCostAmountTax'
  -> GHC.Types.Int -- ^ 'invoicesResourceShippingCostAmountTotal'
  -> InvoicesResourceShippingCost
mkInvoicesResourceShippingCost invoicesResourceShippingCostAmountSubtotal invoicesResourceShippingCostAmountTax invoicesResourceShippingCostAmountTotal = InvoicesResourceShippingCost{invoicesResourceShippingCostAmountSubtotal = invoicesResourceShippingCostAmountSubtotal,
...
instance Data.Aeson.Types.ToJSON.ToJSON InvoicesResourceShippingCostShippingRate'NonNullableVariants
    where {toJSON (InvoicesResourceShippingCostShippingRate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (InvoicesResourceShippingCostShippingRate'NonNullableShippingRate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON InvoicesResourceShippingCostShippingRate'NonNullableVariants
    where {parseJSON val = case (InvoicesResourceShippingCostShippingRate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((InvoicesResourceShippingCostShippingRate'NonNullableShippingRate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
