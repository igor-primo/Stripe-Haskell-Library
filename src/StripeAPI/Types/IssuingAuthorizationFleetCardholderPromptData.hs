...
data IssuingAuthorizationFleetCardholderPromptData = IssuingAuthorizationFleetCardholderPromptData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationFleetCardholderPromptData
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationFleetCardholderPromptData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingAuthorizationFleetCardholderPromptData" (\obj -> (((((GHC.Base.pure IssuingAuthorizationFleetCardholderPromptData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "alphanumeric_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "driver_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "odometer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unspecified_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "vehicle_number"))}
...
mkIssuingAuthorizationFleetCardholderPromptData = IssuingAuthorizationFleetCardholderPromptData{issuingAuthorizationFleetCardholderPromptDataAlphanumericId = GHC.Maybe.Nothing,
