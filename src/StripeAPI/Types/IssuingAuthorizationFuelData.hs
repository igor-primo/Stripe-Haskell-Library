...
data IssuingAuthorizationFuelData = IssuingAuthorizationFuelData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationFuelData
...
mkIssuingAuthorizationFuelData = IssuingAuthorizationFuelData{issuingAuthorizationFuelDataIndustryProductCode = GHC.Maybe.Nothing,
...
data IssuingAuthorizationFuelDataType'NonNullable =
   IssuingAuthorizationFuelDataType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationFuelDataType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationFuelDataType'NonNullableEnumDiesel -- ^ Represents the JSON value @"diesel"@
  | IssuingAuthorizationFuelDataType'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  | IssuingAuthorizationFuelDataType'NonNullableEnumUnleadedPlus -- ^ Represents the JSON value @"unleaded_plus"@
  | IssuingAuthorizationFuelDataType'NonNullableEnumUnleadedRegular -- ^ Represents the JSON value @"unleaded_regular"@
  | IssuingAuthorizationFuelDataType'NonNullableEnumUnleadedSuper -- ^ Represents the JSON value @"unleaded_super"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationFuelDataType'NonNullable
    where {toJSON (IssuingAuthorizationFuelDataType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationFuelDataType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "diesel" -> IssuingAuthorizationFuelDataType'NonNullableEnumDiesel
...
data IssuingAuthorizationFuelDataUnit'NonNullable =
   IssuingAuthorizationFuelDataUnit'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationFuelDataUnit'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumChargingMinute -- ^ Represents the JSON value @"charging_minute"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumImperialGallon -- ^ Represents the JSON value @"imperial_gallon"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumKilogram -- ^ Represents the JSON value @"kilogram"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumKilowattHour -- ^ Represents the JSON value @"kilowatt_hour"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumLiter -- ^ Represents the JSON value @"liter"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumPound -- ^ Represents the JSON value @"pound"@
  | IssuingAuthorizationFuelDataUnit'NonNullableEnumUsGallon -- ^ Represents the JSON value @"us_gallon"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationFuelDataUnit'NonNullable
    where {toJSON (IssuingAuthorizationFuelDataUnit'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationFuelDataUnit'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "charging_minute" -> IssuingAuthorizationFuelDataUnit'NonNullableEnumChargingMinute
