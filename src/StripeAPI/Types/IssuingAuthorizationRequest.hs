...
data IssuingAuthorizationRequestReason' =
  ...
  | IssuingAuthorizationRequestReason'EnumCardCanceled -- ^ Represents the JSON value @"card_canceled"@
  | IssuingAuthorizationRequestReason'EnumCardExpired -- ^ Represents the JSON value @"card_expired"@
  | IssuingAuthorizationRequestReason'EnumCardInactive -- ^ Represents the JSON value @"card_inactive"@
  | IssuingAuthorizationRequestReason'EnumCardholderBlocked -- ^ Represents the JSON value @"cardholder_blocked"@
  ...
  | IssuingAuthorizationRequestReason'EnumInsecureAuthorizationMethod -- ^ Represents the JSON value @"insecure_authorization_method"@
  | IssuingAuthorizationRequestReason'EnumInsufficientFunds -- ^ Represents the JSON value @"insufficient_funds"@
  | IssuingAuthorizationRequestReason'EnumNetworkFallback -- ^ Represents the JSON value @"network_fallback"@
  | IssuingAuthorizationRequestReason'EnumNotAllowed -- ^ Represents the JSON value @"not_allowed"@
  | IssuingAuthorizationRequestReason'EnumPinBlocked -- ^ Represents the JSON value @"pin_blocked"@
