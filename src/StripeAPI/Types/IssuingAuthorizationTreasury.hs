...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationTreasury
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingAuthorizationTreasury" (\obj -> ((GHC.Base.pure IssuingAuthorizationTreasury GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "received_credits")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "received_debits")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction"))}
-- | Create a new 'IssuingAuthorizationTreasury' with all required fields.
mkIssuingAuthorizationTreasury :: [Data.Text.Internal.Text] -- ^ 'issuingAuthorizationTreasuryReceivedCredits'
  -> [Data.Text.Internal.Text] -- ^ 'issuingAuthorizationTreasuryReceivedDebits'
  -> IssuingAuthorizationTreasury
mkIssuingAuthorizationTreasury issuingAuthorizationTreasuryReceivedCredits issuingAuthorizationTreasuryReceivedDebits = IssuingAuthorizationTreasury{issuingAuthorizationTreasuryReceivedCredits = issuingAuthorizationTreasuryReceivedCredits,
