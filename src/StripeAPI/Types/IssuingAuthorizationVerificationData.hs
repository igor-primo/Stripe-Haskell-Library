...
mkIssuingAuthorizationVerificationData :: IssuingAuthorizationVerificationDataAddressLine1Check' -- ^ 'issuingAuthorizationVerificationDataAddressLine1Check'
  -> IssuingAuthorizationVerificationDataAddressPostalCodeCheck' -- ^ 'issuingAuthorizationVerificationDataAddressPostalCodeCheck'
  -> IssuingAuthorizationVerificationDataCvcCheck' -- ^ 'issuingAuthorizationVerificationDataCvcCheck'
  -> IssuingAuthorizationVerificationDataExpiryCheck' -- ^ 'issuingAuthorizationVerificationDataExpiryCheck'
  -> IssuingAuthorizationVerificationData
mkIssuingAuthorizationVerificationData issuingAuthorizationVerificationDataAddressLine1Check issuingAuthorizationVerificationDataAddressPostalCodeCheck issuingAuthorizationVerificationDataCvcCheck issuingAuthorizationVerificationDataExpiryCheck = IssuingAuthorizationVerificationData{issuingAuthorizationVerificationDataAddressLine1Check = issuingAuthorizationVerificationDataAddressLine1Check,
                                                                                                                                                                                                                                                                                            issuingAuthorizationVerificationDataAddressPostalCodeCheck = issuingAuthorizationVerificationDataAddressPostalCodeCheck,
...
data IssuingAuthorizationVerificationDataAddressLine1Check' =
   IssuingAuthorizationVerificationDataAddressLine1Check'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataAddressLine1Check'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataAddressLine1Check'EnumMatch -- ^ Represents the JSON value @"match"@
  | IssuingAuthorizationVerificationDataAddressLine1Check'EnumMismatch -- ^ Represents the JSON value @"mismatch"@
  | IssuingAuthorizationVerificationDataAddressLine1Check'EnumNotProvided -- ^ Represents the JSON value @"not_provided"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataAddressLine1Check'
    where {toJSON (IssuingAuthorizationVerificationDataAddressLine1Check'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataAddressLine1Check'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "match" -> IssuingAuthorizationVerificationDataAddressLine1Check'EnumMatch
...
data IssuingAuthorizationVerificationDataAddressPostalCodeCheck' =
   IssuingAuthorizationVerificationDataAddressPostalCodeCheck'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataAddressPostalCodeCheck'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataAddressPostalCodeCheck'EnumMatch -- ^ Represents the JSON value @"match"@
  | IssuingAuthorizationVerificationDataAddressPostalCodeCheck'EnumMismatch -- ^ Represents the JSON value @"mismatch"@
  | IssuingAuthorizationVerificationDataAddressPostalCodeCheck'EnumNotProvided -- ^ Represents the JSON value @"not_provided"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataAddressPostalCodeCheck'
    where {toJSON (IssuingAuthorizationVerificationDataAddressPostalCodeCheck'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataAddressPostalCodeCheck'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "match" -> IssuingAuthorizationVerificationDataAddressPostalCodeCheck'EnumMatch
...
data IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable = IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable" (\obj -> (GHC.Base.pure IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "claimed_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkIssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable = IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullable{issuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy = GHC.Maybe.Nothing,
...
data IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy' =
   IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'EnumAcquirer -- ^ Represents the JSON value @"acquirer"@
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'EnumIssuer -- ^ Represents the JSON value @"issuer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'
    where {toJSON (IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "acquirer" -> IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableClaimedBy'EnumAcquirer
...
data IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType' =
   IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'EnumLowValueTransaction -- ^ Represents the JSON value @"low_value_transaction"@
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'EnumTransactionRiskAnalysis -- ^ Represents the JSON value @"transaction_risk_analysis"@
  | IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'EnumUnknown -- ^ Represents the JSON value @"unknown"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'
    where {toJSON (IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "low_value_transaction" -> IssuingAuthorizationVerificationDataAuthenticationExemption'NonNullableType'EnumLowValueTransaction
...
data IssuingAuthorizationVerificationDataCvcCheck' =
   IssuingAuthorizationVerificationDataCvcCheck'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataCvcCheck'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataCvcCheck'EnumMatch -- ^ Represents the JSON value @"match"@
  | IssuingAuthorizationVerificationDataCvcCheck'EnumMismatch -- ^ Represents the JSON value @"mismatch"@
  | IssuingAuthorizationVerificationDataCvcCheck'EnumNotProvided -- ^ Represents the JSON value @"not_provided"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataCvcCheck'
    where {toJSON (IssuingAuthorizationVerificationDataCvcCheck'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataCvcCheck'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "match" -> IssuingAuthorizationVerificationDataCvcCheck'EnumMatch
...
data IssuingAuthorizationVerificationDataExpiryCheck' =
   IssuingAuthorizationVerificationDataExpiryCheck'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataExpiryCheck'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataExpiryCheck'EnumMatch -- ^ Represents the JSON value @"match"@
  | IssuingAuthorizationVerificationDataExpiryCheck'EnumMismatch -- ^ Represents the JSON value @"mismatch"@
  | IssuingAuthorizationVerificationDataExpiryCheck'EnumNotProvided -- ^ Represents the JSON value @"not_provided"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataExpiryCheck'
    where {toJSON (IssuingAuthorizationVerificationDataExpiryCheck'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataExpiryCheck'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "match" -> IssuingAuthorizationVerificationDataExpiryCheck'EnumMatch
...
data IssuingAuthorizationVerificationDataThreeDSecure'NonNullable = IssuingAuthorizationVerificationDataThreeDSecure'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataThreeDSecure'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("result" Data.Aeson.Types.ToJSON..=)) (issuingAuthorizationVerificationDataThreeDSecure'NonNullableResult obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataThreeDSecure'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingAuthorizationVerificationDataThreeDSecure'NonNullable" (\obj -> GHC.Base.pure IssuingAuthorizationVerificationDataThreeDSecure'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "result"))}
...
data IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult' =
   IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'EnumAttemptAcknowledged -- ^ Represents the JSON value @"attempt_acknowledged"@
  | IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'EnumAuthenticated -- ^ Represents the JSON value @"authenticated"@
  | IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'EnumFailed -- ^ Represents the JSON value @"failed"@
  | IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'EnumRequired -- ^ Represents the JSON value @"required"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'
    where {toJSON (IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "attempt_acknowledged" -> IssuingAuthorizationVerificationDataThreeDSecure'NonNullableResult'EnumAttemptAcknowledged
