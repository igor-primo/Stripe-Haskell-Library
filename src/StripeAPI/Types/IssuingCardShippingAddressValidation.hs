...
data IssuingCardShippingAddressValidation = IssuingCardShippingAddressValidation {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardShippingAddressValidation
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["mode" Data.Aeson.Types.ToJSON..= issuingCardShippingAddressValidationMode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("normalized_address" Data.Aeson.Types.ToJSON..=)) (issuingCardShippingAddressValidationNormalizedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("result" Data.Aeson.Types.ToJSON..=)) (issuingCardShippingAddressValidationResult obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardShippingAddressValidation
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingCardShippingAddressValidation" (\obj -> ((GHC.Base.pure IssuingCardShippingAddressValidation GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "normalized_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "result"))}
-- | Create a new 'IssuingCardShippingAddressValidation' with all required fields.
mkIssuingCardShippingAddressValidation :: IssuingCardShippingAddressValidationMode' -- ^ 'issuingCardShippingAddressValidationMode'
  -> IssuingCardShippingAddressValidation
mkIssuingCardShippingAddressValidation issuingCardShippingAddressValidationMode = IssuingCardShippingAddressValidation{issuingCardShippingAddressValidationMode = issuingCardShippingAddressValidationMode,
...
data IssuingCardShippingAddressValidationMode' =
   IssuingCardShippingAddressValidationMode'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingCardShippingAddressValidationMode'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingCardShippingAddressValidationMode'EnumDisabled -- ^ Represents the JSON value @"disabled"@
  | IssuingCardShippingAddressValidationMode'EnumNormalizationOnly -- ^ Represents the JSON value @"normalization_only"@
  | IssuingCardShippingAddressValidationMode'EnumValidationAndNormalization -- ^ Represents the JSON value @"validation_and_normalization"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardShippingAddressValidationMode'
    where {toJSON (IssuingCardShippingAddressValidationMode'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardShippingAddressValidationMode'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "disabled" -> IssuingCardShippingAddressValidationMode'EnumDisabled
...
data IssuingCardShippingAddressValidationNormalizedAddress'NonNullable = IssuingCardShippingAddressValidationNormalizedAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardShippingAddressValidationNormalizedAddress'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardShippingAddressValidationNormalizedAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingCardShippingAddressValidationNormalizedAddress'NonNullable" (\obj -> (((((GHC.Base.pure IssuingCardShippingAddressValidationNormalizedAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkIssuingCardShippingAddressValidationNormalizedAddress'NonNullable = IssuingCardShippingAddressValidationNormalizedAddress'NonNullable{issuingCardShippingAddressValidationNormalizedAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data IssuingCardShippingAddressValidationResult'NonNullable =
   IssuingCardShippingAddressValidationResult'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingCardShippingAddressValidationResult'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingCardShippingAddressValidationResult'NonNullableEnumIndeterminate -- ^ Represents the JSON value @"indeterminate"@
  | IssuingCardShippingAddressValidationResult'NonNullableEnumLikelyDeliverable -- ^ Represents the JSON value @"likely_deliverable"@
  | IssuingCardShippingAddressValidationResult'NonNullableEnumLikelyUndeliverable -- ^ Represents the JSON value @"likely_undeliverable"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardShippingAddressValidationResult'NonNullable
    where {toJSON (IssuingCardShippingAddressValidationResult'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardShippingAddressValidationResult'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "indeterminate" -> IssuingCardShippingAddressValidationResult'NonNullableEnumIndeterminate
