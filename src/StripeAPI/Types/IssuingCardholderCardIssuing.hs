...
data IssuingCardholderCardIssuing = IssuingCardholderCardIssuing {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardholderCardIssuing
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("user_terms_acceptance" Data.Aeson.Types.ToJSON..=)) (issuingCardholderCardIssuingUserTermsAcceptance obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardholderCardIssuing
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingCardholderCardIssuing" (\obj -> GHC.Base.pure IssuingCardholderCardIssuing GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_terms_acceptance"))}
...
data IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable = IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable" (\obj -> ((GHC.Base.pure IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
...
mkIssuingCardholderCardIssuingUserTermsAcceptance'NonNullable = IssuingCardholderCardIssuingUserTermsAcceptance'NonNullable{issuingCardholderCardIssuingUserTermsAcceptance'NonNullableDate = GHC.Maybe.Nothing,
