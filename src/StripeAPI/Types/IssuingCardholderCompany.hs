...
data IssuingCardholderCompany = IssuingCardholderCompany {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardholderCompany
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["tax_id_provided" Data.Aeson.Types.ToJSON..= issuingCardholderCompanyTaxIdProvided obj] : GHC.Base.mempty));
...
mkIssuingCardholderCompany :: GHC.Types.Bool -- ^ 'issuingCardholderCompanyTaxIdProvided'
