...
data IssuingCardholderIndividualDob = IssuingCardholderIndividualDob {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardholderIndividualDob
...
mkIssuingCardholderIndividualDob = IssuingCardholderIndividualDob{issuingCardholderIndividualDobDay = GHC.Maybe.Nothing,
