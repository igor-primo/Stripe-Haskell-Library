...
data IssuingCardholderRequirementsDisabledReason'NonNullable =
  ...
  | IssuingCardholderRequirementsDisabledReason'NonNullableEnumRequirements'pastDue -- ^ Represents the JSON value @"requirements.past_due"@
...
data IssuingCardholderRequirementsPastDue'NonNullable =
  ...
  | IssuingCardholderRequirementsPastDue'NonNullableEnumIndividual'cardIssuing'userTermsAcceptance'date -- ^ Represents the JSON value @"individual.card_issuing.user_terms_acceptance.date"@
  | IssuingCardholderRequirementsPastDue'NonNullableEnumIndividual'cardIssuing'userTermsAcceptance'ip -- ^ Represents the JSON value @"individual.card_issuing.user_terms_acceptance.ip"@
