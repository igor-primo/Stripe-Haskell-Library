...
data IssuingCardholderUserTermsAcceptance = IssuingCardholderUserTermsAcceptance {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingCardholderUserTermsAcceptance
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingCardholderUserTermsAcceptance
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingCardholderUserTermsAcceptance" (\obj -> ((GHC.Base.pure IssuingCardholderUserTermsAcceptance GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
...
mkIssuingCardholderUserTermsAcceptance = IssuingCardholderUserTermsAcceptance{issuingCardholderUserTermsAcceptanceDate = GHC.Maybe.Nothing,
