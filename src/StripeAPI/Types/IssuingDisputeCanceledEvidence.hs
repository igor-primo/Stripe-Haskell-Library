...
data IssuingDisputeCanceledEvidence = IssuingDisputeCanceledEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeCanceledEvidence
...
mkIssuingDisputeCanceledEvidence = IssuingDisputeCanceledEvidence{issuingDisputeCanceledEvidenceAdditionalDocumentation = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableVariants
    where {toJSON (IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableFile a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableVariants
    where {parseJSON val = case (IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((IssuingDisputeCanceledEvidenceAdditionalDocumentation'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data IssuingDisputeCanceledEvidenceProductType'NonNullable =
   IssuingDisputeCanceledEvidenceProductType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingDisputeCanceledEvidenceProductType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingDisputeCanceledEvidenceProductType'NonNullableEnumMerchandise -- ^ Represents the JSON value @"merchandise"@
  | IssuingDisputeCanceledEvidenceProductType'NonNullableEnumService -- ^ Represents the JSON value @"service"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeCanceledEvidenceProductType'NonNullable
    where {toJSON (IssuingDisputeCanceledEvidenceProductType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeCanceledEvidenceProductType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "merchandise" -> IssuingDisputeCanceledEvidenceProductType'NonNullableEnumMerchandise
...
data IssuingDisputeCanceledEvidenceReturnStatus'NonNullable =
   IssuingDisputeCanceledEvidenceReturnStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingDisputeCanceledEvidenceReturnStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingDisputeCanceledEvidenceReturnStatus'NonNullableEnumMerchantRejected -- ^ Represents the JSON value @"merchant_rejected"@
  | IssuingDisputeCanceledEvidenceReturnStatus'NonNullableEnumSuccessful -- ^ Represents the JSON value @"successful"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeCanceledEvidenceReturnStatus'NonNullable
    where {toJSON (IssuingDisputeCanceledEvidenceReturnStatus'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeCanceledEvidenceReturnStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "merchant_rejected" -> IssuingDisputeCanceledEvidenceReturnStatus'NonNullableEnumMerchantRejected
