...
data IssuingDisputeEvidence = IssuingDisputeEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeEvidence
...
mkIssuingDisputeEvidence :: IssuingDisputeEvidenceReason' -- ^ 'issuingDisputeEvidenceReason'
  -> IssuingDisputeEvidence
mkIssuingDisputeEvidence issuingDisputeEvidenceReason = IssuingDisputeEvidence{issuingDisputeEvidenceCanceled = GHC.Maybe.Nothing,
...
data IssuingDisputeEvidenceReason' =
   IssuingDisputeEvidenceReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingDisputeEvidenceReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingDisputeEvidenceReason'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | IssuingDisputeEvidenceReason'EnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | IssuingDisputeEvidenceReason'EnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | IssuingDisputeEvidenceReason'EnumMerchandiseNotAsDescribed -- ^ Represents the JSON value @"merchandise_not_as_described"@
  | IssuingDisputeEvidenceReason'EnumNoValidAuthorization -- ^ Represents the JSON value @"no_valid_authorization"@
  | IssuingDisputeEvidenceReason'EnumNotReceived -- ^ Represents the JSON value @"not_received"@
  | IssuingDisputeEvidenceReason'EnumOther -- ^ Represents the JSON value @"other"@
  | IssuingDisputeEvidenceReason'EnumServiceNotAsDescribed -- ^ Represents the JSON value @"service_not_as_described"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeEvidenceReason'
    where {toJSON (IssuingDisputeEvidenceReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeEvidenceReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "canceled" -> IssuingDisputeEvidenceReason'EnumCanceled
