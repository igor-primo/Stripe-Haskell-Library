...
data IssuingDisputeMerchandiseNotAsDescribedEvidence = IssuingDisputeMerchandiseNotAsDescribedEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeMerchandiseNotAsDescribedEvidence
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeMerchandiseNotAsDescribedEvidence
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingDisputeMerchandiseNotAsDescribedEvidence" (\obj -> (((((GHC.Base.pure IssuingDisputeMerchandiseNotAsDescribedEvidence GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "additional_documentation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "explanation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "received_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "return_description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "return_status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "returned_at"))}
...
mkIssuingDisputeMerchandiseNotAsDescribedEvidence = IssuingDisputeMerchandiseNotAsDescribedEvidence{issuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation'NonNullableVariants
    where {toJSON (IssuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation'NonNullableVariants
    where {parseJSON val = case (IssuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((IssuingDisputeMerchandiseNotAsDescribedEvidenceAdditionalDocumentation'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullable =
   IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableEnumMerchantRejected -- ^ Represents the JSON value @"merchant_rejected"@
  | IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableEnumSuccessful -- ^ Represents the JSON value @"successful"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullable
    where {toJSON (IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "merchant_rejected" -> IssuingDisputeMerchandiseNotAsDescribedEvidenceReturnStatus'NonNullableEnumMerchantRejected
