...
data IssuingDisputeNoValidAuthorizationEvidence = IssuingDisputeNoValidAuthorizationEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeNoValidAuthorizationEvidence
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeNoValidAuthorizationEvidence
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingDisputeNoValidAuthorizationEvidence" (\obj -> (GHC.Base.pure IssuingDisputeNoValidAuthorizationEvidence GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "additional_documentation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "explanation"))}
...
mkIssuingDisputeNoValidAuthorizationEvidence = IssuingDisputeNoValidAuthorizationEvidence{issuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentation = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentation'NonNullableVariants
    where {toJSON (IssuingDisputeNoValidAuthorizationEvidenceAdditionalDocumentation'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
