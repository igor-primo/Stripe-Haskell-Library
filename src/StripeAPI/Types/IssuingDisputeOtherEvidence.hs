...
data IssuingDisputeOtherEvidence = IssuingDisputeOtherEvidence {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidence
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeOtherEvidence
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingDisputeOtherEvidence" (\obj -> (((GHC.Base.pure IssuingDisputeOtherEvidence GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "additional_documentation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "explanation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product_description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product_type"))}
...
mkIssuingDisputeOtherEvidence = IssuingDisputeOtherEvidence{issuingDisputeOtherEvidenceAdditionalDocumentation = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableVariants
    where {toJSON (IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableFile a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableVariants
    where {parseJSON val = case (IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((IssuingDisputeOtherEvidenceAdditionalDocumentation'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data IssuingDisputeOtherEvidenceProductType'NonNullable =
   IssuingDisputeOtherEvidenceProductType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingDisputeOtherEvidenceProductType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingDisputeOtherEvidenceProductType'NonNullableEnumMerchandise -- ^ Represents the JSON value @"merchandise"@
  | IssuingDisputeOtherEvidenceProductType'NonNullableEnumService -- ^ Represents the JSON value @"service"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingDisputeOtherEvidenceProductType'NonNullable
    where {toJSON (IssuingDisputeOtherEvidenceProductType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingDisputeOtherEvidenceProductType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "merchandise" -> IssuingDisputeOtherEvidenceProductType'NonNullableEnumMerchandise
