...
data IssuingNetworkTokenDevice = IssuingNetworkTokenDevice {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingNetworkTokenDevice
...
data IssuingNetworkTokenDeviceType' =
   IssuingNetworkTokenDeviceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingNetworkTokenDeviceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingNetworkTokenDeviceType'EnumOther -- ^ Represents the JSON value @"other"@
  | IssuingNetworkTokenDeviceType'EnumPhone -- ^ Represents the JSON value @"phone"@
  | IssuingNetworkTokenDeviceType'EnumWatch -- ^ Represents the JSON value @"watch"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingNetworkTokenDeviceType'
    where {toJSON (IssuingNetworkTokenDeviceType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingNetworkTokenDeviceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "other" -> IssuingNetworkTokenDeviceType'EnumOther
