...
data IssuingNetworkTokenMastercard = IssuingNetworkTokenMastercard {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingNetworkTokenMastercard
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingNetworkTokenMastercard
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingNetworkTokenMastercard" (\obj -> (((GHC.Base.pure IssuingNetworkTokenMastercard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_reference_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "token_reference_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "token_requestor_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "token_requestor_name"))}
-- | Create a new 'IssuingNetworkTokenMastercard' with all required fields.
mkIssuingNetworkTokenMastercard :: Data.Text.Internal.Text -- ^ 'issuingNetworkTokenMastercardTokenReferenceId'
  -> Data.Text.Internal.Text -- ^ 'issuingNetworkTokenMastercardTokenRequestorId'
  -> IssuingNetworkTokenMastercard
mkIssuingNetworkTokenMastercard issuingNetworkTokenMastercardTokenReferenceId issuingNetworkTokenMastercardTokenRequestorId = IssuingNetworkTokenMastercard{issuingNetworkTokenMastercardCardReferenceId = GHC.Maybe.Nothing,
