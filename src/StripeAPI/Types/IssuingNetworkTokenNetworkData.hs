...
data IssuingNetworkTokenNetworkData = IssuingNetworkTokenNetworkData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingNetworkTokenNetworkData
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingNetworkTokenNetworkData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingNetworkTokenNetworkData" (\obj -> ((((GHC.Base.pure IssuingNetworkTokenNetworkData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "device")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mastercard")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "visa")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "wallet_provider"))}
-- | Create a new 'IssuingNetworkTokenNetworkData' with all required fields.
mkIssuingNetworkTokenNetworkData :: IssuingNetworkTokenNetworkDataType' -- ^ 'issuingNetworkTokenNetworkDataType'
  -> IssuingNetworkTokenNetworkData
mkIssuingNetworkTokenNetworkData issuingNetworkTokenNetworkDataType = IssuingNetworkTokenNetworkData{issuingNetworkTokenNetworkDataDevice = GHC.Maybe.Nothing,
...
data IssuingNetworkTokenNetworkDataType' =
   IssuingNetworkTokenNetworkDataType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | IssuingNetworkTokenNetworkDataType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | IssuingNetworkTokenNetworkDataType'EnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | IssuingNetworkTokenNetworkDataType'EnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingNetworkTokenNetworkDataType'
    where {toJSON (IssuingNetworkTokenNetworkDataType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingNetworkTokenNetworkDataType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "mastercard" -> IssuingNetworkTokenNetworkDataType'EnumMastercard
