...
data IssuingPersonalizationDesignPreferences = IssuingPersonalizationDesignPreferences {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingPersonalizationDesignPreferences
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["is_default" Data.Aeson.Types.ToJSON..= issuingPersonalizationDesignPreferencesIsDefault obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("is_platform_default" Data.Aeson.Types.ToJSON..=)) (issuingPersonalizationDesignPreferencesIsPlatformDefault obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingPersonalizationDesignPreferences
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingPersonalizationDesignPreferences" (\obj -> (GHC.Base.pure IssuingPersonalizationDesignPreferences GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "is_default")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "is_platform_default"))}
-- | Create a new 'IssuingPersonalizationDesignPreferences' with all required fields.
mkIssuingPersonalizationDesignPreferences :: GHC.Types.Bool -- ^ 'issuingPersonalizationDesignPreferencesIsDefault'
  -> IssuingPersonalizationDesignPreferences
mkIssuingPersonalizationDesignPreferences issuingPersonalizationDesignPreferencesIsDefault = IssuingPersonalizationDesignPreferences{issuingPersonalizationDesignPreferencesIsDefault = issuingPersonalizationDesignPreferencesIsDefault,
