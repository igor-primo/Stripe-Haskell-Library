...
data IssuingTransactionFlightData = IssuingTransactionFlightData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingTransactionFlightData
...
mkIssuingTransactionFlightData = IssuingTransactionFlightData{issuingTransactionFlightDataDepartureAt = GHC.Maybe.Nothing,
