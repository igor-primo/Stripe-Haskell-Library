...
data IssuingTransactionFlightDataLeg = IssuingTransactionFlightDataLeg {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingTransactionFlightDataLeg
...
mkIssuingTransactionFlightDataLeg = IssuingTransactionFlightDataLeg{issuingTransactionFlightDataLegArrivalAirportCode = GHC.Maybe.Nothing,
