...
data IssuingTransactionNetworkData = IssuingTransactionNetworkData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingTransactionNetworkData
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingTransactionNetworkData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingTransactionNetworkData" (\obj -> ((GHC.Base.pure IssuingTransactionNetworkData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "authorization_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "processing_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_id"))}
...
mkIssuingTransactionNetworkData = IssuingTransactionNetworkData{issuingTransactionNetworkDataAuthorizationCode = GHC.Maybe.Nothing,
