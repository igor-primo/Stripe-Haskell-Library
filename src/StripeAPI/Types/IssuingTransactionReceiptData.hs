...
data IssuingTransactionReceiptData = IssuingTransactionReceiptData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON IssuingTransactionReceiptData
...
instance Data.Aeson.Types.FromJSON.FromJSON IssuingTransactionReceiptData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "IssuingTransactionReceiptData" (\obj -> (((GHC.Base.pure IssuingTransactionReceiptData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_cost"))}
...
mkIssuingTransactionReceiptData = IssuingTransactionReceiptData{issuingTransactionReceiptDataDescription = GHC.Maybe.Nothing,
