...
data Issuing'disputeLossReason' =
   Issuing'disputeLossReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Issuing'disputeLossReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Issuing'disputeLossReason'EnumCardholderAuthenticationIssuerLiability -- ^ Represents the JSON value @"cardholder_authentication_issuer_liability"@
  | Issuing'disputeLossReason'EnumEci5TokenTransactionWithTavv -- ^ Represents the JSON value @"eci5_token_transaction_with_tavv"@
  | Issuing'disputeLossReason'EnumExcessDisputesInTimeframe -- ^ Represents the JSON value @"excess_disputes_in_timeframe"@
  | Issuing'disputeLossReason'EnumHasNotMetTheMinimumDisputeAmountRequirements -- ^ Represents the JSON value @"has_not_met_the_minimum_dispute_amount_requirements"@
  | Issuing'disputeLossReason'EnumInvalidDuplicateDispute -- ^ Represents the JSON value @"invalid_duplicate_dispute"@
  | Issuing'disputeLossReason'EnumInvalidIncorrectAmountDispute -- ^ Represents the JSON value @"invalid_incorrect_amount_dispute"@
  | Issuing'disputeLossReason'EnumInvalidNoAuthorization -- ^ Represents the JSON value @"invalid_no_authorization"@
  | Issuing'disputeLossReason'EnumInvalidUseOfDisputes -- ^ Represents the JSON value @"invalid_use_of_disputes"@
  | Issuing'disputeLossReason'EnumMerchandiseDeliveredOrShipped -- ^ Represents the JSON value @"merchandise_delivered_or_shipped"@
  | Issuing'disputeLossReason'EnumMerchandiseOrServiceAsDescribed -- ^ Represents the JSON value @"merchandise_or_service_as_described"@
  | Issuing'disputeLossReason'EnumNotCancelled -- ^ Represents the JSON value @"not_cancelled"@
  | Issuing'disputeLossReason'EnumOther -- ^ Represents the JSON value @"other"@
  | Issuing'disputeLossReason'EnumRefundIssued -- ^ Represents the JSON value @"refund_issued"@
  | Issuing'disputeLossReason'EnumSubmittedBeyondAllowableTimeLimit -- ^ Represents the JSON value @"submitted_beyond_allowable_time_limit"@
  | Issuing'disputeLossReason'EnumTransaction_3dsRequired -- ^ Represents the JSON value @"transaction_3ds_required"@
  | Issuing'disputeLossReason'EnumTransactionApprovedAfterPriorFraudDispute -- ^ Represents the JSON value @"transaction_approved_after_prior_fraud_dispute"@
  | Issuing'disputeLossReason'EnumTransactionAuthorized -- ^ Represents the JSON value @"transaction_authorized"@
  | Issuing'disputeLossReason'EnumTransactionElectronicallyRead -- ^ Represents the JSON value @"transaction_electronically_read"@
  | Issuing'disputeLossReason'EnumTransactionQualifiesForVisaEasyPaymentService -- ^ Represents the JSON value @"transaction_qualifies_for_visa_easy_payment_service"@
  | Issuing'disputeLossReason'EnumTransactionUnattended -- ^ Represents the JSON value @"transaction_unattended"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'disputeLossReason'
    where {toJSON (Issuing'disputeLossReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'disputeLossReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cardholder_authentication_issuer_liability" -> Issuing'disputeLossReason'EnumCardholderAuthenticationIssuerLiability
