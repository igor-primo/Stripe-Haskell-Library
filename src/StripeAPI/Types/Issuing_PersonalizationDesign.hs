...
data Issuing'personalizationDesign = Issuing'personalizationDesign {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'personalizationDesign
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'personalizationDesign
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Issuing'personalizationDesign" (\obj -> (((((((((((GHC.Base.pure Issuing'personalizationDesign GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_logo")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "carrier_text")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lookup_key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "physical_bundle")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "preferences")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "rejection_reasons")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status"))}
-- | Create a new 'Issuing'personalizationDesign' with all required fields.
mkIssuing'personalizationDesign :: GHC.Types.Int -- ^ 'issuing'personalizationDesignCreated'
  -> Data.Text.Internal.Text -- ^ 'issuing'personalizationDesignId'
  -> GHC.Types.Bool -- ^ 'issuing'personalizationDesignLivemode'
  -> Data.Aeson.Types.Internal.Object -- ^ 'issuing'personalizationDesignMetadata'
  -> Issuing'personalizationDesignPhysicalBundle'Variants -- ^ 'issuing'personalizationDesignPhysicalBundle'
  -> IssuingPersonalizationDesignPreferences -- ^ 'issuing'personalizationDesignPreferences'
  -> IssuingPersonalizationDesignRejectionReasons -- ^ 'issuing'personalizationDesignRejectionReasons'
  -> Issuing'personalizationDesignStatus' -- ^ 'issuing'personalizationDesignStatus'
  -> Issuing'personalizationDesign
mkIssuing'personalizationDesign issuing'personalizationDesignCreated issuing'personalizationDesignId issuing'personalizationDesignLivemode issuing'personalizationDesignMetadata issuing'personalizationDesignPhysicalBundle issuing'personalizationDesignPreferences issuing'personalizationDesignRejectionReasons issuing'personalizationDesignStatus = Issuing'personalizationDesign{issuing'personalizationDesignCardLogo = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'personalizationDesignCardLogo'NonNullableVariants
    where {toJSON (Issuing'personalizationDesignCardLogo'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Issuing'personalizationDesignCardLogo'NonNullableFile a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'personalizationDesignCardLogo'NonNullableVariants
    where {parseJSON val = case (Issuing'personalizationDesignCardLogo'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Issuing'personalizationDesignCardLogo'NonNullableFile Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data Issuing'personalizationDesignCarrierText'NonNullable = Issuing'personalizationDesignCarrierText'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'personalizationDesignCarrierText'NonNullable
...
mkIssuing'personalizationDesignCarrierText'NonNullable = Issuing'personalizationDesignCarrierText'NonNullable{issuing'personalizationDesignCarrierText'NonNullableFooterBody = GHC.Maybe.Nothing,
...
data Issuing'personalizationDesignPhysicalBundle'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'personalizationDesignPhysicalBundle'Variants
    where {toJSON (Issuing'personalizationDesignPhysicalBundle'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Issuing'personalizationDesignPhysicalBundle'Issuing'physicalBundle a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'personalizationDesignPhysicalBundle'Variants
    where {parseJSON val = case (Issuing'personalizationDesignPhysicalBundle'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Issuing'personalizationDesignPhysicalBundle'Issuing'physicalBundle Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data Issuing'personalizationDesignStatus' =
   Issuing'personalizationDesignStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Issuing'personalizationDesignStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Issuing'personalizationDesignStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | Issuing'personalizationDesignStatus'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | Issuing'personalizationDesignStatus'EnumRejected -- ^ Represents the JSON value @"rejected"@
  | Issuing'personalizationDesignStatus'EnumReview -- ^ Represents the JSON value @"review"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'personalizationDesignStatus'
    where {toJSON (Issuing'personalizationDesignStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'personalizationDesignStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> Issuing'personalizationDesignStatus'EnumActive
