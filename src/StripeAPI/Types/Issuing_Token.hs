...
mkIssuing'token :: Issuing'tokenCard'Variants -- ^ 'issuing'tokenCard'
  -> GHC.Types.Int -- ^ 'issuing'tokenCreated'
  -> Data.Text.Internal.Text -- ^ 'issuing'tokenId'
  -> GHC.Types.Bool -- ^ 'issuing'tokenLivemode'
  -> Issuing'tokenNetwork' -- ^ 'issuing'tokenNetwork'
  -> GHC.Types.Int -- ^ 'issuing'tokenNetworkUpdatedAt'
  -> Issuing'tokenStatus' -- ^ 'issuing'tokenStatus'
  -> Issuing'token
mkIssuing'token issuing'tokenCard issuing'tokenCreated issuing'tokenId issuing'tokenLivemode issuing'tokenNetwork issuing'tokenNetworkUpdatedAt issuing'tokenStatus = Issuing'token{issuing'tokenCard = issuing'tokenCard,
...
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'tokenCard'Variants
    where {toJSON (Issuing'tokenCard'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Issuing'tokenCard'Issuing'card a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'tokenCard'Variants
    where {parseJSON val = case (Issuing'tokenCard'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Issuing'tokenCard'Issuing'card Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data Issuing'tokenNetwork' =
   Issuing'tokenNetwork'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Issuing'tokenNetwork'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Issuing'tokenNetwork'EnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | Issuing'tokenNetwork'EnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'tokenNetwork'
    where {toJSON (Issuing'tokenNetwork'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'tokenNetwork'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "mastercard" -> Issuing'tokenNetwork'EnumMastercard
...
data Issuing'tokenStatus' =
   Issuing'tokenStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Issuing'tokenStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Issuing'tokenStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | Issuing'tokenStatus'EnumDeleted -- ^ Represents the JSON value @"deleted"@
  | Issuing'tokenStatus'EnumRequested -- ^ Represents the JSON value @"requested"@
  | Issuing'tokenStatus'EnumSuspended -- ^ Represents the JSON value @"suspended"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'tokenStatus'
    where {toJSON (Issuing'tokenStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'tokenStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> Issuing'tokenStatus'EnumActive
...
data Issuing'tokenWalletProvider' =
   Issuing'tokenWalletProvider'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Issuing'tokenWalletProvider'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Issuing'tokenWalletProvider'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | Issuing'tokenWalletProvider'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | Issuing'tokenWalletProvider'EnumSamsungPay -- ^ Represents the JSON value @"samsung_pay"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Issuing'tokenWalletProvider'
    where {toJSON (Issuing'tokenWalletProvider'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Issuing'tokenWalletProvider'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "apple_pay" -> Issuing'tokenWalletProvider'EnumApplePay
