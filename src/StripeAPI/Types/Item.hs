...
instance Data.Aeson.Types.FromJSON.FromJSON Item
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Item" (\obj -> ((((((((((GHC.Base.pure Item GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "discounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "taxes"))}
-- | Create a new 'Item' with all required fields.
mkItem :: GHC.Types.Int -- ^ 'itemAmountDiscount'
  -> GHC.Types.Int -- ^ 'itemAmountSubtotal'
  -> GHC.Types.Int -- ^ 'itemAmountTax'
  -> GHC.Types.Int -- ^ 'itemAmountTotal'
  -> Data.Text.Internal.Text -- ^ 'itemCurrency'
  -> Data.Text.Internal.Text -- ^ 'itemId'
  -> Item
mkItem itemAmountDiscount itemAmountSubtotal itemAmountTax itemAmountTotal itemCurrency itemId = Item{itemAmountDiscount = itemAmountDiscount,
...
data ItemPrice'NonNullable = ItemPrice'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ItemPrice'NonNullable" (\obj -> ((((((((((((((((((((GHC.Base.pure ItemPrice'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_scheme")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "custom_unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "lookup_key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "nickname")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "object")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers_mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transform_quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "unit_amount_decimal"))}
-- | Create a new 'ItemPrice'NonNullable' with all required fields.
mkItemPrice'NonNullable :: ItemPrice'NonNullable
mkItemPrice'NonNullable = ItemPrice'NonNullable{itemPrice'NonNullableActive = GHC.Maybe.Nothing,
...
data ItemPrice'NonNullableBillingScheme' =
   ItemPrice'NonNullableBillingScheme'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableBillingScheme'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableBillingScheme'EnumPerUnit -- ^ Represents the JSON value @"per_unit"@
  | ItemPrice'NonNullableBillingScheme'EnumTiered -- ^ Represents the JSON value @"tiered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableBillingScheme'
    where {toJSON (ItemPrice'NonNullableBillingScheme'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableBillingScheme'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "per_unit" -> ItemPrice'NonNullableBillingScheme'EnumPerUnit
...
data ItemPrice'NonNullableCustomUnitAmount'NonNullable = ItemPrice'NonNullableCustomUnitAmount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableCustomUnitAmount'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullableMaximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullableMinimum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preset" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullablePreset obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullableMaximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullableMinimum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preset" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableCustomUnitAmount'NonNullablePreset obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableCustomUnitAmount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ItemPrice'NonNullableCustomUnitAmount'NonNullable" (\obj -> ((GHC.Base.pure ItemPrice'NonNullableCustomUnitAmount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preset"))}
...
mkItemPrice'NonNullableCustomUnitAmount'NonNullable = ItemPrice'NonNullableCustomUnitAmount'NonNullable{itemPrice'NonNullableCustomUnitAmount'NonNullableMaximum = GHC.Maybe.Nothing,
...
data ItemPrice'NonNullableObject' =
   ItemPrice'NonNullableObject'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableObject'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableObject'EnumPrice -- ^ Represents the JSON value @"price"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableObject'
    where {toJSON (ItemPrice'NonNullableObject'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableObject'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "price" -> ItemPrice'NonNullableObject'EnumPrice
...
data ItemPrice'NonNullableProduct'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableProduct'Variants
    where {toJSON (ItemPrice'NonNullableProduct'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableProduct'Variants
    where {parseJSON val = case (ItemPrice'NonNullableProduct'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ItemPrice'NonNullableProduct'Product Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ItemPrice'NonNullableProduct'DeletedProduct Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
...
data ItemPrice'NonNullableRecurring'NonNullable = ItemPrice'NonNullableRecurring'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableRecurring'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableMeter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableUsageType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableMeter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableRecurring'NonNullableUsageType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableRecurring'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ItemPrice'NonNullableRecurring'NonNullable" (\obj -> (((GHC.Base.pure ItemPrice'NonNullableRecurring'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "meter")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_type"))}
...
mkItemPrice'NonNullableRecurring'NonNullable = ItemPrice'NonNullableRecurring'NonNullable{itemPrice'NonNullableRecurring'NonNullableInterval = GHC.Maybe.Nothing,
...
data ItemPrice'NonNullableRecurring'NonNullableInterval' =
   ItemPrice'NonNullableRecurring'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableRecurring'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableRecurring'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | ItemPrice'NonNullableRecurring'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | ItemPrice'NonNullableRecurring'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | ItemPrice'NonNullableRecurring'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableRecurring'NonNullableInterval'
    where {toJSON (ItemPrice'NonNullableRecurring'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableRecurring'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> ItemPrice'NonNullableRecurring'NonNullableInterval'EnumDay
...
data ItemPrice'NonNullableRecurring'NonNullableUsageType' =
   ItemPrice'NonNullableRecurring'NonNullableUsageType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableRecurring'NonNullableUsageType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableRecurring'NonNullableUsageType'EnumLicensed -- ^ Represents the JSON value @"licensed"@
  | ItemPrice'NonNullableRecurring'NonNullableUsageType'EnumMetered -- ^ Represents the JSON value @"metered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableRecurring'NonNullableUsageType'
    where {toJSON (ItemPrice'NonNullableRecurring'NonNullableUsageType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableRecurring'NonNullableUsageType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "licensed" -> ItemPrice'NonNullableRecurring'NonNullableUsageType'EnumLicensed
...
data ItemPrice'NonNullableTaxBehavior'NonNullable =
   ItemPrice'NonNullableTaxBehavior'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableTaxBehavior'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableTaxBehavior'NonNullableEnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | ItemPrice'NonNullableTaxBehavior'NonNullableEnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | ItemPrice'NonNullableTaxBehavior'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableTaxBehavior'NonNullable
    where {toJSON (ItemPrice'NonNullableTaxBehavior'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableTaxBehavior'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> ItemPrice'NonNullableTaxBehavior'NonNullableEnumExclusive
...
data ItemPrice'NonNullableTiersMode'NonNullable =
   ItemPrice'NonNullableTiersMode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableTiersMode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableTiersMode'NonNullableEnumGraduated -- ^ Represents the JSON value @"graduated"@
  | ItemPrice'NonNullableTiersMode'NonNullableEnumVolume -- ^ Represents the JSON value @"volume"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableTiersMode'NonNullable
    where {toJSON (ItemPrice'NonNullableTiersMode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableTiersMode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "graduated" -> ItemPrice'NonNullableTiersMode'NonNullableEnumGraduated
...
data ItemPrice'NonNullableTransformQuantity'NonNullable = ItemPrice'NonNullableTransformQuantity'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableTransformQuantity'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("divide_by" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableTransformQuantity'NonNullableDivideBy obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("round" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableTransformQuantity'NonNullableRound obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("divide_by" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableTransformQuantity'NonNullableDivideBy obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("round" Data.Aeson.Types.ToJSON..=)) (itemPrice'NonNullableTransformQuantity'NonNullableRound obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableTransformQuantity'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ItemPrice'NonNullableTransformQuantity'NonNullable" (\obj -> (GHC.Base.pure ItemPrice'NonNullableTransformQuantity'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "divide_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "round"))}
...
mkItemPrice'NonNullableTransformQuantity'NonNullable = ItemPrice'NonNullableTransformQuantity'NonNullable{itemPrice'NonNullableTransformQuantity'NonNullableDivideBy = GHC.Maybe.Nothing,
...
data ItemPrice'NonNullableTransformQuantity'NonNullableRound' =
   ItemPrice'NonNullableTransformQuantity'NonNullableRound'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableTransformQuantity'NonNullableRound'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableTransformQuantity'NonNullableRound'EnumDown -- ^ Represents the JSON value @"down"@
  | ItemPrice'NonNullableTransformQuantity'NonNullableRound'EnumUp -- ^ Represents the JSON value @"up"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableTransformQuantity'NonNullableRound'
    where {toJSON (ItemPrice'NonNullableTransformQuantity'NonNullableRound'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableTransformQuantity'NonNullableRound'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "down" -> ItemPrice'NonNullableTransformQuantity'NonNullableRound'EnumDown
...
data ItemPrice'NonNullableType' =
   ItemPrice'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ItemPrice'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ItemPrice'NonNullableType'EnumOneTime -- ^ Represents the JSON value @"one_time"@
  | ItemPrice'NonNullableType'EnumRecurring -- ^ Represents the JSON value @"recurring"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ItemPrice'NonNullableType'
    where {toJSON (ItemPrice'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ItemPrice'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "one_time" -> ItemPrice'NonNullableType'EnumOneTime
