...
data KlarnaPayerDetails = KlarnaPayerDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON KlarnaPayerDetails
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (klarnaPayerDetailsAddress obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON KlarnaPayerDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "KlarnaPayerDetails" (\obj -> GHC.Base.pure KlarnaPayerDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address"))}
...
data KlarnaPayerDetailsAddress'NonNullable = KlarnaPayerDetailsAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON KlarnaPayerDetailsAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (klarnaPayerDetailsAddress'NonNullableCountry obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON KlarnaPayerDetailsAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "KlarnaPayerDetailsAddress'NonNullable" (\obj -> GHC.Base.pure KlarnaPayerDetailsAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country"))}
