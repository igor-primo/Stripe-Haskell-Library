...
data LegalEntityJapanAddress = LegalEntityJapanAddress {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LegalEntityJapanAddress
...
mkLegalEntityJapanAddress = LegalEntityJapanAddress{legalEntityJapanAddressCity = GHC.Maybe.Nothing,
