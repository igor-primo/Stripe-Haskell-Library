...
data LegalEntityRegistrationDate = LegalEntityRegistrationDate {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LegalEntityRegistrationDate
...
instance Data.Aeson.Types.FromJSON.FromJSON LegalEntityRegistrationDate
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "LegalEntityRegistrationDate" (\obj -> ((GHC.Base.pure LegalEntityRegistrationDate GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "day")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "year"))}
...
mkLegalEntityRegistrationDate = LegalEntityRegistrationDate{legalEntityRegistrationDateDay = GHC.Maybe.Nothing,
