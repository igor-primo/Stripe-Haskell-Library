...
data LinkedAccountOptionsCommon = LinkedAccountOptionsCommon {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LinkedAccountOptionsCommon
...
data LinkedAccountOptionsCommonPermissions' =
   LinkedAccountOptionsCommonPermissions'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | LinkedAccountOptionsCommonPermissions'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | LinkedAccountOptionsCommonPermissions'EnumBalances -- ^ Represents the JSON value @"balances"@
  | LinkedAccountOptionsCommonPermissions'EnumOwnership -- ^ Represents the JSON value @"ownership"@
  | LinkedAccountOptionsCommonPermissions'EnumPaymentMethod -- ^ Represents the JSON value @"payment_method"@
  | LinkedAccountOptionsCommonPermissions'EnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LinkedAccountOptionsCommonPermissions'
    where {toJSON (LinkedAccountOptionsCommonPermissions'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON LinkedAccountOptionsCommonPermissions'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> LinkedAccountOptionsCommonPermissions'EnumBalances
...
data LinkedAccountOptionsCommonPrefetch'NonNullable =
   LinkedAccountOptionsCommonPrefetch'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | LinkedAccountOptionsCommonPrefetch'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | LinkedAccountOptionsCommonPrefetch'NonNullableEnumBalances -- ^ Represents the JSON value @"balances"@
  | LinkedAccountOptionsCommonPrefetch'NonNullableEnumOwnership -- ^ Represents the JSON value @"ownership"@
  | LinkedAccountOptionsCommonPrefetch'NonNullableEnumTransactions -- ^ Represents the JSON value @"transactions"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON LinkedAccountOptionsCommonPrefetch'NonNullable
    where {toJSON (LinkedAccountOptionsCommonPrefetch'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON LinkedAccountOptionsCommonPrefetch'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balances" -> LinkedAccountOptionsCommonPrefetch'NonNullableEnumBalances
