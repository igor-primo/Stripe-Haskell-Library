...
mkMandate :: CustomerAcceptance -- ^ 'mandateCustomerAcceptance'
  -> Data.Text.Internal.Text -- ^ 'mandateId'
  -> GHC.Types.Bool -- ^ 'mandateLivemode'
  -> MandatePaymentMethod'Variants -- ^ 'mandatePaymentMethod'
  -> MandatePaymentMethodDetails -- ^ 'mandatePaymentMethodDetails'
  -> MandateStatus' -- ^ 'mandateStatus'
  -> MandateType' -- ^ 'mandateType'
  -> Mandate
mkMandate mandateCustomerAcceptance mandateId mandateLivemode mandatePaymentMethod mandatePaymentMethodDetails mandateStatus mandateType = Mandate{mandateCustomerAcceptance = mandateCustomerAcceptance,
                                                                                                                                                   mandateId = mandateId,
...
instance Data.Aeson.Types.ToJSON.ToJSON MandatePaymentMethod'Variants
    where {toJSON (MandatePaymentMethod'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (MandatePaymentMethod'PaymentMethod a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON MandatePaymentMethod'Variants
    where {parseJSON val = case (MandatePaymentMethod'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((MandatePaymentMethod'PaymentMethod Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data MandateStatus' =
   MandateStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | MandateStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | MandateStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | MandateStatus'EnumInactive -- ^ Represents the JSON value @"inactive"@
  | MandateStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON MandateStatus'
    where {toJSON (MandateStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON MandateStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> MandateStatus'EnumActive
...
data MandateType' =
   MandateType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | MandateType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | MandateType'EnumMultiUse -- ^ Represents the JSON value @"multi_use"@
  | MandateType'EnumSingleUse -- ^ Represents the JSON value @"single_use"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON MandateType'
    where {toJSON (MandateType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON MandateType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "multi_use" -> MandateType'EnumMultiUse
