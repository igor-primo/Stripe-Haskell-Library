...
data MandatePaypal = MandatePaypal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON MandatePaypal
...
instance Data.Aeson.Types.FromJSON.FromJSON MandatePaypal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "MandatePaypal" (\obj -> (GHC.Base.pure MandatePaypal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_agreement_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payer_id"))}
-- | Create a new 'MandatePaypal' with all required fields.
mkMandatePaypal :: MandatePaypal
mkMandatePaypal = MandatePaypal{mandatePaypalBillingAgreementId = GHC.Maybe.Nothing,
