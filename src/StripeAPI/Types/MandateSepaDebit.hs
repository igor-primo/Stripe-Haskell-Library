...
data MandateSepaDebit = MandateSepaDebit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON MandateSepaDebit
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["reference" Data.Aeson.Types.ToJSON..= mandateSepaDebitReference obj] : ["url" Data.Aeson.Types.ToJSON..= mandateSepaDebitUrl obj] : GHC.Base.mempty));
...
mkMandateSepaDebit :: Data.Text.Internal.Text -- ^ 'mandateSepaDebitReference'
  -> Data.Text.Internal.Text -- ^ 'mandateSepaDebitUrl'
  -> MandateSepaDebit
mkMandateSepaDebit mandateSepaDebitReference mandateSepaDebitUrl = MandateSepaDebit{mandateSepaDebitReference = mandateSepaDebitReference,
