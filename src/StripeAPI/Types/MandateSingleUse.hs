...
data MandateSingleUse = MandateSingleUse {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON MandateSingleUse
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= mandateSingleUseAmount obj] : ["currency" Data.Aeson.Types.ToJSON..= mandateSingleUseCurrency obj] : GHC.Base.mempty));
...
mkMandateSingleUse :: GHC.Types.Int -- ^ 'mandateSingleUseAmount'
  -> Data.Text.Internal.Text -- ^ 'mandateSingleUseCurrency'
  -> MandateSingleUse
mkMandateSingleUse mandateSingleUseAmount mandateSingleUseCurrency = MandateSingleUse{mandateSingleUseAmount = mandateSingleUseAmount,
