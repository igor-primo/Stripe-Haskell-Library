...
data NotificationEventRequest = NotificationEventRequest {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON NotificationEventRequest
...
mkNotificationEventRequest = NotificationEventRequest{notificationEventRequestId = GHC.Maybe.Nothing,
