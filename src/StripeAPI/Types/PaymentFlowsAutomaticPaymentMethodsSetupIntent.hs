...
data PaymentFlowsAutomaticPaymentMethodsSetupIntent = PaymentFlowsAutomaticPaymentMethodsSetupIntent {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentFlowsAutomaticPaymentMethodsSetupIntent
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentFlowsAutomaticPaymentMethodsSetupIntent
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentFlowsAutomaticPaymentMethodsSetupIntent" (\obj -> (GHC.Base.pure PaymentFlowsAutomaticPaymentMethodsSetupIntent GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "allow_redirects")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "enabled"))}
...
mkPaymentFlowsAutomaticPaymentMethodsSetupIntent = PaymentFlowsAutomaticPaymentMethodsSetupIntent{paymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects = GHC.Maybe.Nothing,
...
data PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects' =
   PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'EnumAlways -- ^ Represents the JSON value @"always"@
  | PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'
    where {toJSON (PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PaymentFlowsAutomaticPaymentMethodsSetupIntentAllowRedirects'EnumAlways
