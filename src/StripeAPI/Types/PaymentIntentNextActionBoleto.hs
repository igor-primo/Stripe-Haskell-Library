...
data PaymentIntentNextActionBoleto = PaymentIntentNextActionBoleto {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentNextActionBoleto
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionBoleto
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionBoleto" (\obj -> (((GHC.Base.pure PaymentIntentNextActionBoleto GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_voucher_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pdf"))}
...
mkPaymentIntentNextActionBoleto = PaymentIntentNextActionBoleto{paymentIntentNextActionBoletoExpiresAt = GHC.Maybe.Nothing,
