...
data PaymentIntentNextActionCardAwaitNotification = PaymentIntentNextActionCardAwaitNotification {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentNextActionCardAwaitNotification
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionCardAwaitNotification
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionCardAwaitNotification" (\obj -> (GHC.Base.pure PaymentIntentNextActionCardAwaitNotification GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "charge_attempt_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer_approval_required"))}
...
mkPaymentIntentNextActionCardAwaitNotification = PaymentIntentNextActionCardAwaitNotification{paymentIntentNextActionCardAwaitNotificationChargeAttemptAt = GHC.Maybe.Nothing,
