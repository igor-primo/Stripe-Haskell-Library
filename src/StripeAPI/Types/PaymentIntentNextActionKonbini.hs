...
data PaymentIntentNextActionKonbini = PaymentIntentNextActionKonbini {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentNextActionKonbini
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["expires_at" Data.Aeson.Types.ToJSON..= paymentIntentNextActionKonbiniExpiresAt obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("hosted_voucher_url" Data.Aeson.Types.ToJSON..=)) (paymentIntentNextActionKonbiniHostedVoucherUrl obj) : ["stores" Data.Aeson.Types.ToJSON..= paymentIntentNextActionKonbiniStores obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionKonbini
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionKonbini" (\obj -> ((GHC.Base.pure PaymentIntentNextActionKonbini GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_voucher_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "stores"))}
-- | Create a new 'PaymentIntentNextActionKonbini' with all required fields.
mkPaymentIntentNextActionKonbini :: GHC.Types.Int -- ^ 'paymentIntentNextActionKonbiniExpiresAt'
  -> PaymentIntentNextActionKonbiniStores -- ^ 'paymentIntentNextActionKonbiniStores'
  -> PaymentIntentNextActionKonbini
mkPaymentIntentNextActionKonbini paymentIntentNextActionKonbiniExpiresAt paymentIntentNextActionKonbiniStores = PaymentIntentNextActionKonbini{paymentIntentNextActionKonbiniExpiresAt = paymentIntentNextActionKonbiniExpiresAt,
