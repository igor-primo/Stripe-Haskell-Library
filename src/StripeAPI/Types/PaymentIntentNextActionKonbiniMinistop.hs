...
data PaymentIntentNextActionKonbiniMinistop = PaymentIntentNextActionKonbiniMinistop {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentNextActionKonbiniMinistop
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionKonbiniMinistop
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionKonbiniMinistop" (\obj -> (GHC.Base.pure PaymentIntentNextActionKonbiniMinistop GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "confirmation_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "payment_code"))}
-- | Create a new 'PaymentIntentNextActionKonbiniMinistop' with all required fields.
mkPaymentIntentNextActionKonbiniMinistop :: Data.Text.Internal.Text -- ^ 'paymentIntentNextActionKonbiniMinistopPaymentCode'
  -> PaymentIntentNextActionKonbiniMinistop
mkPaymentIntentNextActionKonbiniMinistop paymentIntentNextActionKonbiniMinistopPaymentCode = PaymentIntentNextActionKonbiniMinistop{paymentIntentNextActionKonbiniMinistopConfirmationNumber = GHC.Maybe.Nothing,
