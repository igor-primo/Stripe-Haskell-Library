...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionPaynowDisplayQrCode
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionPaynowDisplayQrCode" (\obj -> (((GHC.Base.pure PaymentIntentNextActionPaynowDisplayQrCode GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_instructions_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "image_url_png")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "image_url_svg"))}
-- | Create a new 'PaymentIntentNextActionPaynowDisplayQrCode' with all required fields.
mkPaymentIntentNextActionPaynowDisplayQrCode :: Data.Text.Internal.Text -- ^ 'paymentIntentNextActionPaynowDisplayQrCodeData'
  -> Data.Text.Internal.Text -- ^ 'paymentIntentNextActionPaynowDisplayQrCodeImageUrlPng'
  -> Data.Text.Internal.Text -- ^ 'paymentIntentNextActionPaynowDisplayQrCodeImageUrlSvg'
  -> PaymentIntentNextActionPaynowDisplayQrCode
mkPaymentIntentNextActionPaynowDisplayQrCode paymentIntentNextActionPaynowDisplayQrCodeData paymentIntentNextActionPaynowDisplayQrCodeImageUrlPng paymentIntentNextActionPaynowDisplayQrCodeImageUrlSvg = PaymentIntentNextActionPaynowDisplayQrCode{paymentIntentNextActionPaynowDisplayQrCodeData = paymentIntentNextActionPaynowDisplayQrCodeData,
