...
data PaymentIntentNextActionPixDisplayQrCode = PaymentIntentNextActionPixDisplayQrCode {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentNextActionPixDisplayQrCode
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentNextActionPixDisplayQrCode
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentNextActionPixDisplayQrCode" (\obj -> ((((GHC.Base.pure PaymentIntentNextActionPixDisplayQrCode GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_instructions_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "image_url_png")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "image_url_svg"))}
...
mkPaymentIntentNextActionPixDisplayQrCode = PaymentIntentNextActionPixDisplayQrCode{paymentIntentNextActionPixDisplayQrCodeData = GHC.Maybe.Nothing,
