...
mkPaymentIntentPaymentMethodOptionsAcssDebit = PaymentIntentPaymentMethodOptionsAcssDebit{paymentIntentPaymentMethodOptionsAcssDebitMandateOptions = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage' =
   PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'
    where {toJSON (PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentIntentPaymentMethodOptionsAcssDebitSetupFutureUsage'EnumNone
...
data PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod' =
   PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'
    where {toJSON (PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> PaymentIntentPaymentMethodOptionsAcssDebitVerificationMethod'EnumAutomatic
