...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsBacsDebit
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentIntentPaymentMethodOptionsBacsDebit" (\obj -> ((GHC.Base.pure PaymentIntentPaymentMethodOptionsBacsDebit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "target_date"))}
...
mkPaymentIntentPaymentMethodOptionsBacsDebit = PaymentIntentPaymentMethodOptionsBacsDebit{paymentIntentPaymentMethodOptionsBacsDebitMandateOptions = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage' =
   PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'
    where {toJSON (PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentIntentPaymentMethodOptionsBacsDebitSetupFutureUsage'EnumNone
