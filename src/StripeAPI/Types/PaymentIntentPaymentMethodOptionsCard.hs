...
mkPaymentIntentPaymentMethodOptionsCard = PaymentIntentPaymentMethodOptionsCard{paymentIntentPaymentMethodOptionsCardCaptureMethod = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsCardCaptureMethod' =
   PaymentIntentPaymentMethodOptionsCardCaptureMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardCaptureMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardCaptureMethod'EnumManual -- ^ Represents the JSON value @"manual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardCaptureMethod'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardCaptureMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardCaptureMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "manual" -> PaymentIntentPaymentMethodOptionsCardCaptureMethod'EnumManual
...
data PaymentIntentPaymentMethodOptionsCardInstallments'NonNullable = PaymentIntentPaymentMethodOptionsCardInstallments'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available_plans" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullableAvailablePlans obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullableEnabled obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("plan" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available_plans" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullableAvailablePlans obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullableEnabled obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("plan" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullable
...
mkPaymentIntentPaymentMethodOptionsCardInstallments'NonNullable = PaymentIntentPaymentMethodOptionsCardInstallments'NonNullable{paymentIntentPaymentMethodOptionsCardInstallments'NonNullableAvailablePlans = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable = PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("count" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("count" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable
...
mkPaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable = PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullable{paymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableCount = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullable =
   PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullableEnumMonth -- ^ Represents the JSON value @"month"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullable
    where {toJSON (PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "month" -> PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableInterval'NonNullableEnumMonth
...
data PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType' =
   PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus -- ^ Represents the JSON value @"bonus"@
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumFixedCount -- ^ Represents the JSON value @"fixed_count"@
  | PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumRevolving -- ^ Represents the JSON value @"revolving"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bonus" -> PaymentIntentPaymentMethodOptionsCardInstallments'NonNullablePlan'NonNullableType'EnumBonus
...
data PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullable = PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullable
...
mkPaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullable = PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullable{paymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmount = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType' =
   PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'EnumFixed -- ^ Represents the JSON value @"fixed"@
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'EnumMaximum -- ^ Represents the JSON value @"maximum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fixed" -> PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableAmountType'EnumFixed
...
data PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval' =
   PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumSporadic -- ^ Represents the JSON value @"sporadic"@
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableInterval'EnumDay
...
data PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullable =
   PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia -- ^ Represents the JSON value @"india"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullable
    where {toJSON (PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "india" -> PaymentIntentPaymentMethodOptionsCardMandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia
...
data PaymentIntentPaymentMethodOptionsCardNetwork'NonNullable =
   PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumAmex -- ^ Represents the JSON value @"amex"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumDiners -- ^ Represents the JSON value @"diners"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumDiscover -- ^ Represents the JSON value @"discover"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumEftposAu -- ^ Represents the JSON value @"eftpos_au"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumInterac -- ^ Represents the JSON value @"interac"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumJcb -- ^ Represents the JSON value @"jcb"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumUnionpay -- ^ Represents the JSON value @"unionpay"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  | PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardNetwork'NonNullable
    where {toJSON (PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardNetwork'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex" -> PaymentIntentPaymentMethodOptionsCardNetwork'NonNullableEnumAmex
...
data PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization' =
   PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> PaymentIntentPaymentMethodOptionsCardRequestExtendedAuthorization'EnumIfAvailable
...
data PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization' =
   PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> PaymentIntentPaymentMethodOptionsCardRequestIncrementalAuthorization'EnumIfAvailable
...
data PaymentIntentPaymentMethodOptionsCardRequestMulticapture' =
   PaymentIntentPaymentMethodOptionsCardRequestMulticapture'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardRequestMulticapture'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardRequestMulticapture'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | PaymentIntentPaymentMethodOptionsCardRequestMulticapture'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardRequestMulticapture'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardRequestMulticapture'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardRequestMulticapture'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> PaymentIntentPaymentMethodOptionsCardRequestMulticapture'EnumIfAvailable
...
data PaymentIntentPaymentMethodOptionsCardRequestOvercapture' =
   PaymentIntentPaymentMethodOptionsCardRequestOvercapture'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardRequestOvercapture'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardRequestOvercapture'EnumIfAvailable -- ^ Represents the JSON value @"if_available"@
  | PaymentIntentPaymentMethodOptionsCardRequestOvercapture'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardRequestOvercapture'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardRequestOvercapture'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardRequestOvercapture'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "if_available" -> PaymentIntentPaymentMethodOptionsCardRequestOvercapture'EnumIfAvailable
...
data PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullable =
   PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumAny -- ^ Represents the JSON value @"any"@
  | PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullable
    where {toJSON (PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> PaymentIntentPaymentMethodOptionsCardRequestThreeDSecure'NonNullableEnumAny
...
data PaymentIntentPaymentMethodOptionsCardSetupFutureUsage' =
   PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'
    where {toJSON (PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentIntentPaymentMethodOptionsCardSetupFutureUsage'EnumNone
