...
mkPaymentIntentPaymentMethodOptionsUsBankAccount = PaymentIntentPaymentMethodOptionsUsBankAccount{paymentIntentPaymentMethodOptionsUsBankAccountFinancialConnections = GHC.Maybe.Nothing,
...
data PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed' =
   PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'EnumFastest -- ^ Represents the JSON value @"fastest"@
  | PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'EnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'
    where {toJSON (PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fastest" -> PaymentIntentPaymentMethodOptionsUsBankAccountPreferredSettlementSpeed'EnumFastest
...
data PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage' =
   PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'
    where {toJSON (PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentIntentPaymentMethodOptionsUsBankAccountSetupFutureUsage'EnumNone
...
data PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod' =
   PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'
    where {toJSON (PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> PaymentIntentPaymentMethodOptionsUsBankAccountVerificationMethod'EnumAutomatic
