...
data PaymentIntentTypeSpecificPaymentMethodOptionsClient = PaymentIntentTypeSpecificPaymentMethodOptionsClient {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentTypeSpecificPaymentMethodOptionsClient
...
mkPaymentIntentTypeSpecificPaymentMethodOptionsClient = PaymentIntentTypeSpecificPaymentMethodOptionsClient{paymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod = GHC.Maybe.Nothing,
...
data PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod' =
   PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'EnumManual -- ^ Represents the JSON value @"manual"@
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'EnumManualPreferred -- ^ Represents the JSON value @"manual_preferred"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'
    where {toJSON (PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "manual" -> PaymentIntentTypeSpecificPaymentMethodOptionsClientCaptureMethod'EnumManual
...
data PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage' =
   PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'
    where {toJSON (PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentIntentTypeSpecificPaymentMethodOptionsClientSetupFutureUsage'EnumNone
...
data PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod' =
   PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'
    where {toJSON (PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> PaymentIntentTypeSpecificPaymentMethodOptionsClientVerificationMethod'EnumAutomatic
