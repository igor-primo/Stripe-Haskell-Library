...
data PaymentLinksResourceCompletedSessions = PaymentLinksResourceCompletedSessions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceCompletedSessions
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["count" Data.Aeson.Types.ToJSON..= paymentLinksResourceCompletedSessionsCount obj] : ["limit" Data.Aeson.Types.ToJSON..= paymentLinksResourceCompletedSessionsLimit obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceCompletedSessions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceCompletedSessions" (\obj -> (GHC.Base.pure PaymentLinksResourceCompletedSessions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "limit"))}
-- | Create a new 'PaymentLinksResourceCompletedSessions' with all required fields.
mkPaymentLinksResourceCompletedSessions :: GHC.Types.Int -- ^ 'paymentLinksResourceCompletedSessionsCount'
  -> GHC.Types.Int -- ^ 'paymentLinksResourceCompletedSessionsLimit'
  -> PaymentLinksResourceCompletedSessions
mkPaymentLinksResourceCompletedSessions paymentLinksResourceCompletedSessionsCount paymentLinksResourceCompletedSessionsLimit = PaymentLinksResourceCompletedSessions{paymentLinksResourceCompletedSessionsCount = paymentLinksResourceCompletedSessionsCount,
