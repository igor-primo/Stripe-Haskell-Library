...
data PaymentLinksResourceConsentCollection = PaymentLinksResourceConsentCollection {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceConsentCollection
...
mkPaymentLinksResourceConsentCollection = PaymentLinksResourceConsentCollection{paymentLinksResourceConsentCollectionPaymentMethodReuseAgreement = GHC.Maybe.Nothing,
...
data PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable = PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("position" Data.Aeson.Types.ToJSON..=)) (paymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable" (\obj -> GHC.Base.pure PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "position"))}
...
data PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition' =
   PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumAuto -- ^ Represents the JSON value @"auto"@
  | PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumHidden -- ^ Represents the JSON value @"hidden"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'
    where {toJSON (PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "auto" -> PaymentLinksResourceConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumAuto
...
data PaymentLinksResourceConsentCollectionPromotions'NonNullable =
   PaymentLinksResourceConsentCollectionPromotions'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentLinksResourceConsentCollectionPromotions'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentLinksResourceConsentCollectionPromotions'NonNullableEnumAuto -- ^ Represents the JSON value @"auto"@
  | PaymentLinksResourceConsentCollectionPromotions'NonNullableEnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceConsentCollectionPromotions'NonNullable
    where {toJSON (PaymentLinksResourceConsentCollectionPromotions'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceConsentCollectionPromotions'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "auto" -> PaymentLinksResourceConsentCollectionPromotions'NonNullableEnumAuto
...
data PaymentLinksResourceConsentCollectionTermsOfService'NonNullable =
   PaymentLinksResourceConsentCollectionTermsOfService'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentLinksResourceConsentCollectionTermsOfService'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentLinksResourceConsentCollectionTermsOfService'NonNullableEnumNone -- ^ Represents the JSON value @"none"@
  | PaymentLinksResourceConsentCollectionTermsOfService'NonNullableEnumRequired -- ^ Represents the JSON value @"required"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceConsentCollectionTermsOfService'NonNullable
    where {toJSON (PaymentLinksResourceConsentCollectionTermsOfService'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceConsentCollectionTermsOfService'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentLinksResourceConsentCollectionTermsOfService'NonNullableEnumNone
