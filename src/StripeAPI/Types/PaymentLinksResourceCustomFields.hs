...
data PaymentLinksResourceCustomFields = PaymentLinksResourceCustomFields {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceCustomFields
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceCustomFields
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceCustomFields" (\obj -> ((((((GHC.Base.pure PaymentLinksResourceCustomFields GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "dropdown")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "label")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "numeric")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "optional")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "text")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PaymentLinksResourceCustomFields' with all required fields.
mkPaymentLinksResourceCustomFields :: Data.Text.Internal.Text -- ^ 'paymentLinksResourceCustomFieldsKey'
  -> PaymentLinksResourceCustomFieldsLabel -- ^ 'paymentLinksResourceCustomFieldsLabel'
  -> GHC.Types.Bool -- ^ 'paymentLinksResourceCustomFieldsOptional'
  -> PaymentLinksResourceCustomFieldsType' -- ^ 'paymentLinksResourceCustomFieldsType'
  -> PaymentLinksResourceCustomFields
mkPaymentLinksResourceCustomFields paymentLinksResourceCustomFieldsKey paymentLinksResourceCustomFieldsLabel paymentLinksResourceCustomFieldsOptional paymentLinksResourceCustomFieldsType = PaymentLinksResourceCustomFields{paymentLinksResourceCustomFieldsDropdown = GHC.Maybe.Nothing,
...
data PaymentLinksResourceCustomFieldsType' =
   PaymentLinksResourceCustomFieldsType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentLinksResourceCustomFieldsType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentLinksResourceCustomFieldsType'EnumDropdown -- ^ Represents the JSON value @"dropdown"@
  | PaymentLinksResourceCustomFieldsType'EnumNumeric -- ^ Represents the JSON value @"numeric"@
  | PaymentLinksResourceCustomFieldsType'EnumText -- ^ Represents the JSON value @"text"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceCustomFieldsType'
    where {toJSON (PaymentLinksResourceCustomFieldsType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceCustomFieldsType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "dropdown" -> PaymentLinksResourceCustomFieldsType'EnumDropdown
