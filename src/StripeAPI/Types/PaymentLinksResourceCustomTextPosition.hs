...
data PaymentLinksResourceCustomTextPosition = PaymentLinksResourceCustomTextPosition {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceCustomTextPosition
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["message" Data.Aeson.Types.ToJSON..= paymentLinksResourceCustomTextPositionMessage obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceCustomTextPosition
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceCustomTextPosition" (\obj -> GHC.Base.pure PaymentLinksResourceCustomTextPosition GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "message"))}
-- | Create a new 'PaymentLinksResourceCustomTextPosition' with all required fields.
mkPaymentLinksResourceCustomTextPosition :: Data.Text.Internal.Text -- ^ 'paymentLinksResourceCustomTextPositionMessage'
