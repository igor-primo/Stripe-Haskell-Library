...
data PaymentLinksResourcePaymentIntentDataCaptureMethod'NonNullable =
  ...
  | PaymentLinksResourcePaymentIntentDataCaptureMethod'NonNullableEnumAutomaticAsync -- ^ Represents the JSON value @"automatic_async"@
