...
data PaymentLinksResourcePaymentMethodReuseAgreement = PaymentLinksResourcePaymentMethodReuseAgreement {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourcePaymentMethodReuseAgreement
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["position" Data.Aeson.Types.ToJSON..= paymentLinksResourcePaymentMethodReuseAgreementPosition obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourcePaymentMethodReuseAgreement
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourcePaymentMethodReuseAgreement" (\obj -> GHC.Base.pure PaymentLinksResourcePaymentMethodReuseAgreement GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "position"))}
-- | Create a new 'PaymentLinksResourcePaymentMethodReuseAgreement' with all required fields.
mkPaymentLinksResourcePaymentMethodReuseAgreement :: PaymentLinksResourcePaymentMethodReuseAgreementPosition' -- ^ 'paymentLinksResourcePaymentMethodReuseAgreementPosition'
...
data PaymentLinksResourcePaymentMethodReuseAgreementPosition' =
   PaymentLinksResourcePaymentMethodReuseAgreementPosition'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentLinksResourcePaymentMethodReuseAgreementPosition'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentLinksResourcePaymentMethodReuseAgreementPosition'EnumAuto -- ^ Represents the JSON value @"auto"@
  | PaymentLinksResourcePaymentMethodReuseAgreementPosition'EnumHidden -- ^ Represents the JSON value @"hidden"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourcePaymentMethodReuseAgreementPosition'
    where {toJSON (PaymentLinksResourcePaymentMethodReuseAgreementPosition'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourcePaymentMethodReuseAgreementPosition'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "auto" -> PaymentLinksResourcePaymentMethodReuseAgreementPosition'EnumAuto
