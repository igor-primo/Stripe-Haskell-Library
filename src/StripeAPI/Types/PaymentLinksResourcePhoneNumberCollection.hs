...
data PaymentLinksResourcePhoneNumberCollection = PaymentLinksResourcePhoneNumberCollection {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourcePhoneNumberCollection
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= paymentLinksResourcePhoneNumberCollectionEnabled obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourcePhoneNumberCollection
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourcePhoneNumberCollection" (\obj -> GHC.Base.pure PaymentLinksResourcePhoneNumberCollection GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled"))}
-- | Create a new 'PaymentLinksResourcePhoneNumberCollection' with all required fields.
mkPaymentLinksResourcePhoneNumberCollection :: GHC.Types.Bool -- ^ 'paymentLinksResourcePhoneNumberCollectionEnabled'
