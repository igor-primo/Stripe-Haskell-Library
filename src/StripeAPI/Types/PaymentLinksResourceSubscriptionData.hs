...
data PaymentLinksResourceSubscriptionData = PaymentLinksResourceSubscriptionData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceSubscriptionData
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceSubscriptionData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceSubscriptionData" (\obj -> ((((GHC.Base.pure PaymentLinksResourceSubscriptionData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "invoice_settings")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_period_days")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_settings"))}
-- | Create a new 'PaymentLinksResourceSubscriptionData' with all required fields.
mkPaymentLinksResourceSubscriptionData :: PaymentLinksResourceSubscriptionDataInvoiceSettings -- ^ 'paymentLinksResourceSubscriptionDataInvoiceSettings'
  -> Data.Aeson.Types.Internal.Object -- ^ 'paymentLinksResourceSubscriptionDataMetadata'
  -> PaymentLinksResourceSubscriptionData
mkPaymentLinksResourceSubscriptionData paymentLinksResourceSubscriptionDataInvoiceSettings paymentLinksResourceSubscriptionDataMetadata = PaymentLinksResourceSubscriptionData{paymentLinksResourceSubscriptionDataDescription = GHC.Maybe.Nothing,
                                                                                                                                                                               paymentLinksResourceSubscriptionDataInvoiceSettings = paymentLinksResourceSubscriptionDataInvoiceSettings,
...
data PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable = PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_behavior" Data.Aeson.Types.ToJSON..=)) (paymentLinksResourceSubscriptionDataTrialSettings'NonNullableEndBehavior obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable" (\obj -> GHC.Base.pure PaymentLinksResourceSubscriptionDataTrialSettings'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end_behavior"))}
