...
data PaymentLinksResourceTransferData = PaymentLinksResourceTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceTransferData
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (paymentLinksResourceTransferDataAmount obj) : ["destination" Data.Aeson.Types.ToJSON..= paymentLinksResourceTransferDataDestination obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceTransferData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentLinksResourceTransferData" (\obj -> (GHC.Base.pure PaymentLinksResourceTransferData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))}
-- | Create a new 'PaymentLinksResourceTransferData' with all required fields.
mkPaymentLinksResourceTransferData :: PaymentLinksResourceTransferDataDestination'Variants -- ^ 'paymentLinksResourceTransferDataDestination'
  -> PaymentLinksResourceTransferData
mkPaymentLinksResourceTransferData paymentLinksResourceTransferDataDestination = PaymentLinksResourceTransferData{paymentLinksResourceTransferDataAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentLinksResourceTransferDataDestination'Variants
    where {toJSON (PaymentLinksResourceTransferDataDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentLinksResourceTransferDataDestination'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentLinksResourceTransferDataDestination'Variants
    where {parseJSON val = case (PaymentLinksResourceTransferDataDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentLinksResourceTransferDataDestination'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
