...
data PaymentMethodBacsDebit = PaymentMethodBacsDebit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodBacsDebit
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodBacsDebit
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodBacsDebit" (\obj -> ((GHC.Base.pure PaymentMethodBacsDebit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "sort_code"))}
-- | Create a new 'PaymentMethodBacsDebit' with all required fields.
mkPaymentMethodBacsDebit :: PaymentMethodBacsDebit
mkPaymentMethodBacsDebit = PaymentMethodBacsDebit{paymentMethodBacsDebitFingerprint = GHC.Maybe.Nothing,
