...
mkPaymentMethodCard :: Data.Text.Internal.Text -- ^ 'paymentMethodCardBrand'
  -> GHC.Types.Int -- ^ 'paymentMethodCardExpMonth'
  -> GHC.Types.Int -- ^ 'paymentMethodCardExpYear'
  -> Data.Text.Internal.Text -- ^ 'paymentMethodCardFunding'
  -> Data.Text.Internal.Text -- ^ 'paymentMethodCardLast4'
  -> PaymentMethodCard
mkPaymentMethodCard paymentMethodCardBrand paymentMethodCardExpMonth paymentMethodCardExpYear paymentMethodCardFunding paymentMethodCardLast4 = PaymentMethodCard{paymentMethodCardBrand = paymentMethodCardBrand,
...
data PaymentMethodCardChecks'NonNullable = PaymentMethodCardChecks'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardChecks'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardChecks'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardChecks'NonNullable" (\obj -> ((GHC.Base.pure PaymentMethodCardChecks'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_line1_check")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_postal_code_check")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cvc_check"))}
...
mkPaymentMethodCardChecks'NonNullable = PaymentMethodCardChecks'NonNullable{paymentMethodCardChecks'NonNullableAddressLine1Check = GHC.Maybe.Nothing,
...
data PaymentMethodCardGeneratedFrom'NonNullable = PaymentMethodCardGeneratedFrom'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedFrom'NonNullable
...
mkPaymentMethodCardGeneratedFrom'NonNullable = PaymentMethodCardGeneratedFrom'NonNullable{paymentMethodCardGeneratedFrom'NonNullableCharge = GHC.Maybe.Nothing,
...
data PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable = PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card_present" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullableCardPresent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card_present" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullableCardPresent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_present")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable = PaymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullable{paymentMethodCardGeneratedFrom'NonNullablePaymentMethodDetails'NonNullableCardPresent = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedFrom'NonNullableSetupAttempt'NonNullableVariants
    where {toJSON (PaymentMethodCardGeneratedFrom'NonNullableSetupAttempt'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentMethodCardGeneratedFrom'NonNullableSetupAttempt'NonNullableSetupAttempt a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardGeneratedFrom'NonNullableSetupAttempt'NonNullableVariants
...
data PaymentMethodCardNetworks'NonNullable = PaymentMethodCardNetworks'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardNetworks'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardNetworks'NonNullableAvailable obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardNetworks'NonNullablePreferred obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardNetworks'NonNullableAvailable obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardNetworks'NonNullablePreferred obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardNetworks'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardNetworks'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodCardNetworks'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "available")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred"))}
...
mkPaymentMethodCardNetworks'NonNullable = PaymentMethodCardNetworks'NonNullable{paymentMethodCardNetworks'NonNullableAvailable = GHC.Maybe.Nothing,
...
data PaymentMethodCardRegulatedStatus'NonNullable =
   PaymentMethodCardRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodCardRegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodCardRegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | PaymentMethodCardRegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardRegulatedStatus'NonNullable
    where {toJSON (PaymentMethodCardRegulatedStatus'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardRegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> PaymentMethodCardRegulatedStatus'NonNullableEnumRegulated
...
data PaymentMethodCardThreeDSecureUsage'NonNullable = PaymentMethodCardThreeDSecureUsage'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardThreeDSecureUsage'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardThreeDSecureUsage'NonNullableSupported obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardThreeDSecureUsage'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardThreeDSecureUsage'NonNullable" (\obj -> GHC.Base.pure PaymentMethodCardThreeDSecureUsage'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "supported"))}
...
data PaymentMethodCardWallet'NonNullable = PaymentMethodCardWallet'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardWallet'NonNullable
...
mkPaymentMethodCardWallet'NonNullable = PaymentMethodCardWallet'NonNullable{paymentMethodCardWallet'NonNullableAmexExpressCheckout = GHC.Maybe.Nothing,
...
data PaymentMethodCardWallet'NonNullableType' =
   PaymentMethodCardWallet'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodCardWallet'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodCardWallet'NonNullableType'EnumAmexExpressCheckout -- ^ Represents the JSON value @"amex_express_checkout"@
  | PaymentMethodCardWallet'NonNullableType'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | PaymentMethodCardWallet'NonNullableType'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | PaymentMethodCardWallet'NonNullableType'EnumLink -- ^ Represents the JSON value @"link"@
  | PaymentMethodCardWallet'NonNullableType'EnumMasterpass -- ^ Represents the JSON value @"masterpass"@
  | PaymentMethodCardWallet'NonNullableType'EnumSamsungPay -- ^ Represents the JSON value @"samsung_pay"@
  | PaymentMethodCardWallet'NonNullableType'EnumVisaCheckout -- ^ Represents the JSON value @"visa_checkout"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardWallet'NonNullableType'
    where {toJSON (PaymentMethodCardWallet'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardWallet'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex_express_checkout" -> PaymentMethodCardWallet'NonNullableType'EnumAmexExpressCheckout
