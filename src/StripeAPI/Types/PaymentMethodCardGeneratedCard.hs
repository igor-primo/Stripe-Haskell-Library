...
data PaymentMethodCardGeneratedCard = PaymentMethodCardGeneratedCard {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedCard
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardGeneratedCard
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardGeneratedCard" (\obj -> ((GHC.Base.pure PaymentMethodCardGeneratedCard GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "charge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_attempt"))}
...
mkPaymentMethodCardGeneratedCard = PaymentMethodCardGeneratedCard{paymentMethodCardGeneratedCardCharge = GHC.Maybe.Nothing,
...
data PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable = PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card_present" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedCardPaymentMethodDetails'NonNullableCardPresent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedCardPaymentMethodDetails'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card_present" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedCardPaymentMethodDetails'NonNullableCardPresent obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardGeneratedCardPaymentMethodDetails'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card_present")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable = PaymentMethodCardGeneratedCardPaymentMethodDetails'NonNullable{paymentMethodCardGeneratedCardPaymentMethodDetails'NonNullableCardPresent = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardGeneratedCardSetupAttempt'NonNullableVariants
    where {toJSON (PaymentMethodCardGeneratedCardSetupAttempt'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentMethodCardGeneratedCardSetupAttempt'NonNullableSetupAttempt a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardGeneratedCardSetupAttempt'NonNullableVariants
    where {parseJSON val = case (PaymentMethodCardGeneratedCardSetupAttempt'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodCardGeneratedCardSetupAttempt'NonNullableSetupAttempt Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
