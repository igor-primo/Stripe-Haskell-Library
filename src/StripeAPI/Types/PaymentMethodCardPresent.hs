...
data PaymentMethodCardPresent = PaymentMethodCardPresent {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardPresent
...
data PaymentMethodCardPresentNetworks'NonNullable = PaymentMethodCardPresentNetworks'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardPresentNetworks'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentNetworks'NonNullableAvailable obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentNetworks'NonNullablePreferred obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("available" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentNetworks'NonNullableAvailable obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentNetworks'NonNullablePreferred obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardPresentNetworks'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardPresentNetworks'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodCardPresentNetworks'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "available")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred"))}
...
mkPaymentMethodCardPresentNetworks'NonNullable = PaymentMethodCardPresentNetworks'NonNullable{paymentMethodCardPresentNetworks'NonNullableAvailable = GHC.Maybe.Nothing,
...
data PaymentMethodCardPresentOffline'NonNullable = PaymentMethodCardPresentOffline'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardPresentOffline'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentOffline'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodCardPresentOffline'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardPresentOffline'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodCardPresentOffline'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodCardPresentOffline'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "stored_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPaymentMethodCardPresentOffline'NonNullable = PaymentMethodCardPresentOffline'NonNullable{paymentMethodCardPresentOffline'NonNullableStoredAt = GHC.Maybe.Nothing,
...
data PaymentMethodCardPresentOffline'NonNullableType'NonNullable =
   PaymentMethodCardPresentOffline'NonNullableType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodCardPresentOffline'NonNullableType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodCardPresentOffline'NonNullableType'NonNullableEnumDeferred -- ^ Represents the JSON value @"deferred"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardPresentOffline'NonNullableType'NonNullable
    where {toJSON (PaymentMethodCardPresentOffline'NonNullableType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardPresentOffline'NonNullableType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "deferred" -> PaymentMethodCardPresentOffline'NonNullableType'NonNullableEnumDeferred
...
data PaymentMethodCardPresentReadMethod'NonNullable =
   PaymentMethodCardPresentReadMethod'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodCardPresentReadMethod'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodCardPresentReadMethod'NonNullableEnumContactEmv -- ^ Represents the JSON value @"contact_emv"@
  | PaymentMethodCardPresentReadMethod'NonNullableEnumContactlessEmv -- ^ Represents the JSON value @"contactless_emv"@
  | PaymentMethodCardPresentReadMethod'NonNullableEnumContactlessMagstripeMode -- ^ Represents the JSON value @"contactless_magstripe_mode"@
  | PaymentMethodCardPresentReadMethod'NonNullableEnumMagneticStripeFallback -- ^ Represents the JSON value @"magnetic_stripe_fallback"@
  | PaymentMethodCardPresentReadMethod'NonNullableEnumMagneticStripeTrack2 -- ^ Represents the JSON value @"magnetic_stripe_track2"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardPresentReadMethod'NonNullable
    where {toJSON (PaymentMethodCardPresentReadMethod'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardPresentReadMethod'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "contact_emv" -> PaymentMethodCardPresentReadMethod'NonNullableEnumContactEmv
