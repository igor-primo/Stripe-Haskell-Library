...
data PaymentMethodCardWallet = PaymentMethodCardWallet {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardWallet
...
mkPaymentMethodCardWallet :: PaymentMethodCardWalletType' -- ^ 'paymentMethodCardWalletType'
  -> PaymentMethodCardWallet
mkPaymentMethodCardWallet paymentMethodCardWalletType = PaymentMethodCardWallet{paymentMethodCardWalletAmexExpressCheckout = GHC.Maybe.Nothing,
...
data PaymentMethodCardWalletType' =
   PaymentMethodCardWalletType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodCardWalletType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodCardWalletType'EnumAmexExpressCheckout -- ^ Represents the JSON value @"amex_express_checkout"@
  | PaymentMethodCardWalletType'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | PaymentMethodCardWalletType'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | PaymentMethodCardWalletType'EnumLink -- ^ Represents the JSON value @"link"@
  | PaymentMethodCardWalletType'EnumMasterpass -- ^ Represents the JSON value @"masterpass"@
  | PaymentMethodCardWalletType'EnumSamsungPay -- ^ Represents the JSON value @"samsung_pay"@
  | PaymentMethodCardWalletType'EnumVisaCheckout -- ^ Represents the JSON value @"visa_checkout"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodCardWalletType'
    where {toJSON (PaymentMethodCardWalletType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodCardWalletType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex_express_checkout" -> PaymentMethodCardWalletType'EnumAmexExpressCheckout
