...
data PaymentMethodDetailsAffirm = PaymentMethodDetailsAffirm {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsAffirm
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsAffirm
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsAffirm" (\obj -> ((GHC.Base.pure PaymentMethodDetailsAffirm GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reader")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_id"))}
-- | Create a new 'PaymentMethodDetailsAffirm' with all required fields.
mkPaymentMethodDetailsAffirm :: PaymentMethodDetailsAffirm
mkPaymentMethodDetailsAffirm = PaymentMethodDetailsAffirm{paymentMethodDetailsAffirmLocation = GHC.Maybe.Nothing,
