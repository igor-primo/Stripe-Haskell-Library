...
-- | Contains the types generated from the schema PaymentMethodDetailsAfterpayClearpay
...
data PaymentMethodDetailsAfterpayClearpay = PaymentMethodDetailsAfterpayClearpay {
  ...
  -- 
  -- * Maximum length of 5000
  , paymentMethodDetailsAfterpayClearpayReference :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsAfterpayClearpay
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsAfterpayClearpay
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsAfterpayClearpay" (\obj -> (GHC.Base.pure PaymentMethodDetailsAfterpayClearpay GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "order_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference"))}
...
mkPaymentMethodDetailsAfterpayClearpay = PaymentMethodDetailsAfterpayClearpay{paymentMethodDetailsAfterpayClearpayOrderId = GHC.Maybe.Nothing,
