...
-- 
-- 
data PaymentMethodDetailsBacsDebit = PaymentMethodDetailsBacsDebit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsBacsDebit
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsBacsDebit
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsBacsDebit" (\obj -> (((GHC.Base.pure PaymentMethodDetailsBacsDebit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "sort_code"))}
...
mkPaymentMethodDetailsBacsDebit = PaymentMethodDetailsBacsDebit{paymentMethodDetailsBacsDebitFingerprint = GHC.Maybe.Nothing,
                                                                paymentMethodDetailsBacsDebitLast4 = GHC.Maybe.Nothing,
                                                                paymentMethodDetailsBacsDebitMandate = GHC.Maybe.Nothing,
                                                                paymentMethodDetailsBacsDebitSortCode = GHC.Maybe.Nothing}
