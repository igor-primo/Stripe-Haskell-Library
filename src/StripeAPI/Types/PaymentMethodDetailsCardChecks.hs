...
data PaymentMethodDetailsCardChecks = PaymentMethodDetailsCardChecks {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardChecks
...
mkPaymentMethodDetailsCardChecks = PaymentMethodDetailsCardChecks{paymentMethodDetailsCardChecksAddressLine1Check = GHC.Maybe.Nothing,
