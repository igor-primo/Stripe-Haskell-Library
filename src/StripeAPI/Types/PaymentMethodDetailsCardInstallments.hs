...
data PaymentMethodDetailsCardInstallments = PaymentMethodDetailsCardInstallments {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallments
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("plan" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsCardInstallmentsPlan obj) : GHC.Base.mempty));
...
data PaymentMethodDetailsCardInstallmentsPlan'NonNullable = PaymentMethodDetailsCardInstallmentsPlan'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullable
...
mkPaymentMethodDetailsCardInstallmentsPlan'NonNullable = PaymentMethodDetailsCardInstallmentsPlan'NonNullable{paymentMethodDetailsCardInstallmentsPlan'NonNullableCount = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullable =
   PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullableEnumMonth -- ^ Represents the JSON value @"month"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullable
    where {toJSON (PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "month" -> PaymentMethodDetailsCardInstallmentsPlan'NonNullableInterval'NonNullableEnumMonth
...
data PaymentMethodDetailsCardInstallmentsPlan'NonNullableType' =
   PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumBonus -- ^ Represents the JSON value @"bonus"@
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumFixedCount -- ^ Represents the JSON value @"fixed_count"@
  | PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumRevolving -- ^ Represents the JSON value @"revolving"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'
    where {toJSON (PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bonus" -> PaymentMethodDetailsCardInstallmentsPlan'NonNullableType'EnumBonus
