...
mkPaymentMethodDetailsCardInstallmentsPlan :: PaymentMethodDetailsCardInstallmentsPlanType' -- ^ 'paymentMethodDetailsCardInstallmentsPlanType'
  -> PaymentMethodDetailsCardInstallmentsPlan
mkPaymentMethodDetailsCardInstallmentsPlan paymentMethodDetailsCardInstallmentsPlanType = PaymentMethodDetailsCardInstallmentsPlan{paymentMethodDetailsCardInstallmentsPlanCount = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardInstallmentsPlanType' =
   PaymentMethodDetailsCardInstallmentsPlanType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardInstallmentsPlanType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardInstallmentsPlanType'EnumBonus -- ^ Represents the JSON value @"bonus"@
  | PaymentMethodDetailsCardInstallmentsPlanType'EnumFixedCount -- ^ Represents the JSON value @"fixed_count"@
  | PaymentMethodDetailsCardInstallmentsPlanType'EnumRevolving -- ^ Represents the JSON value @"revolving"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardInstallmentsPlanType'
    where {toJSON (PaymentMethodDetailsCardInstallmentsPlanType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardInstallmentsPlanType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bonus" -> PaymentMethodDetailsCardInstallmentsPlanType'EnumBonus
