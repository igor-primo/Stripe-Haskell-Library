...
data PaymentMethodDetailsCardPresent = PaymentMethodDetailsCardPresent {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresent
...
mkPaymentMethodDetailsCardPresent :: GHC.Types.Int -- ^ 'paymentMethodDetailsCardPresentExpMonth'
  -> GHC.Types.Int -- ^ 'paymentMethodDetailsCardPresentExpYear'
  -> GHC.Types.Bool -- ^ 'paymentMethodDetailsCardPresentIncrementalAuthorizationSupported'
  -> GHC.Types.Bool -- ^ 'paymentMethodDetailsCardPresentOvercaptureSupported'
  -> PaymentMethodDetailsCardPresent
mkPaymentMethodDetailsCardPresent paymentMethodDetailsCardPresentExpMonth paymentMethodDetailsCardPresentExpYear paymentMethodDetailsCardPresentIncrementalAuthorizationSupported paymentMethodDetailsCardPresentOvercaptureSupported = PaymentMethodDetailsCardPresent{paymentMethodDetailsCardPresentAmountAuthorized = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardPresentOffline'NonNullable = PaymentMethodDetailsCardPresentOffline'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentOffline'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsCardPresentOffline'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsCardPresentOffline'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentOffline'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsCardPresentOffline'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodDetailsCardPresentOffline'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "stored_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
data PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable =
   PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableEnumDeferred -- ^ Represents the JSON value @"deferred"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable
    where {toJSON (PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "deferred" -> PaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableEnumDeferred
...
data PaymentMethodDetailsCardPresentReadMethod'NonNullable =
   PaymentMethodDetailsCardPresentReadMethod'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumContactEmv -- ^ Represents the JSON value @"contact_emv"@
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumContactlessEmv -- ^ Represents the JSON value @"contactless_emv"@
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumContactlessMagstripeMode -- ^ Represents the JSON value @"contactless_magstripe_mode"@
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumMagneticStripeFallback -- ^ Represents the JSON value @"magnetic_stripe_fallback"@
  | PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumMagneticStripeTrack2 -- ^ Represents the JSON value @"magnetic_stripe_track2"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentReadMethod'NonNullable
    where {toJSON (PaymentMethodDetailsCardPresentReadMethod'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentReadMethod'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "contact_emv" -> PaymentMethodDetailsCardPresentReadMethod'NonNullableEnumContactEmv
...
data PaymentMethodDetailsCardPresentReceipt'NonNullable = PaymentMethodDetailsCardPresentReceipt'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentReceipt'NonNullable
...
mkPaymentMethodDetailsCardPresentReceipt'NonNullable = PaymentMethodDetailsCardPresentReceipt'NonNullable{paymentMethodDetailsCardPresentReceipt'NonNullableAccountType = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType' =
   PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'EnumChecking -- ^ Represents the JSON value @"checking"@
  | PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'EnumCredit -- ^ Represents the JSON value @"credit"@
  | PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'EnumPrepaid -- ^ Represents the JSON value @"prepaid"@
  | PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'EnumUnknown -- ^ Represents the JSON value @"unknown"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'
    where {toJSON (PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "checking" -> PaymentMethodDetailsCardPresentReceipt'NonNullableAccountType'EnumChecking
