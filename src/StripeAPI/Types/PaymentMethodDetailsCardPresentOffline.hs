...
data PaymentMethodDetailsCardPresentOffline = PaymentMethodDetailsCardPresentOffline {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentOffline
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentOffline
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsCardPresentOffline" (\obj -> (GHC.Base.pure PaymentMethodDetailsCardPresentOffline GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "stored_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPaymentMethodDetailsCardPresentOffline = PaymentMethodDetailsCardPresentOffline{paymentMethodDetailsCardPresentOfflineStoredAt = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardPresentOfflineType'NonNullable =
   PaymentMethodDetailsCardPresentOfflineType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardPresentOfflineType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardPresentOfflineType'NonNullableEnumDeferred -- ^ Represents the JSON value @"deferred"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardPresentOfflineType'NonNullable
    where {toJSON (PaymentMethodDetailsCardPresentOfflineType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardPresentOfflineType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "deferred" -> PaymentMethodDetailsCardPresentOfflineType'NonNullableEnumDeferred
