...
data PaymentMethodDetailsCardWallet = PaymentMethodDetailsCardWallet {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardWallet
...
mkPaymentMethodDetailsCardWallet :: PaymentMethodDetailsCardWalletType' -- ^ 'paymentMethodDetailsCardWalletType'
  -> PaymentMethodDetailsCardWallet
mkPaymentMethodDetailsCardWallet paymentMethodDetailsCardWalletType = PaymentMethodDetailsCardWallet{paymentMethodDetailsCardWalletAmexExpressCheckout = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsCardWalletType' =
   PaymentMethodDetailsCardWalletType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCardWalletType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCardWalletType'EnumAmexExpressCheckout -- ^ Represents the JSON value @"amex_express_checkout"@
  | PaymentMethodDetailsCardWalletType'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | PaymentMethodDetailsCardWalletType'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | PaymentMethodDetailsCardWalletType'EnumLink -- ^ Represents the JSON value @"link"@
  | PaymentMethodDetailsCardWalletType'EnumMasterpass -- ^ Represents the JSON value @"masterpass"@
  | PaymentMethodDetailsCardWalletType'EnumSamsungPay -- ^ Represents the JSON value @"samsung_pay"@
  | PaymentMethodDetailsCardWalletType'EnumVisaCheckout -- ^ Represents the JSON value @"visa_checkout"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCardWalletType'
    where {toJSON (PaymentMethodDetailsCardWalletType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCardWalletType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex_express_checkout" -> PaymentMethodDetailsCardWalletType'EnumAmexExpressCheckout
