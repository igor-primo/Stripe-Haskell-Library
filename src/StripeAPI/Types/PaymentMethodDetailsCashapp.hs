...
data PaymentMethodDetailsCashapp = PaymentMethodDetailsCashapp {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCashapp
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCashapp
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsCashapp" (\obj -> ((GHC.Base.pure PaymentMethodDetailsCashapp GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "buyer_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cashtag")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction_id"))}
...
mkPaymentMethodDetailsCashapp = PaymentMethodDetailsCashapp{paymentMethodDetailsCashappBuyerId = GHC.Maybe.Nothing,
