...
data PaymentMethodDetailsCrypto = PaymentMethodDetailsCrypto {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCrypto
...
data PaymentMethodDetailsCryptoNetwork' =
   PaymentMethodDetailsCryptoNetwork'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCryptoNetwork'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCryptoNetwork'EnumBase -- ^ Represents the JSON value @"base"@
  | PaymentMethodDetailsCryptoNetwork'EnumEthereum -- ^ Represents the JSON value @"ethereum"@
  | PaymentMethodDetailsCryptoNetwork'EnumPolygon -- ^ Represents the JSON value @"polygon"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCryptoNetwork'
    where {toJSON (PaymentMethodDetailsCryptoNetwork'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCryptoNetwork'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "base" -> PaymentMethodDetailsCryptoNetwork'EnumBase
...
data PaymentMethodDetailsCryptoTokenCurrency' =
   PaymentMethodDetailsCryptoTokenCurrency'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsCryptoTokenCurrency'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsCryptoTokenCurrency'EnumUsdc -- ^ Represents the JSON value @"usdc"@
  | PaymentMethodDetailsCryptoTokenCurrency'EnumUsdg -- ^ Represents the JSON value @"usdg"@
  | PaymentMethodDetailsCryptoTokenCurrency'EnumUsdp -- ^ Represents the JSON value @"usdp"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsCryptoTokenCurrency'
    where {toJSON (PaymentMethodDetailsCryptoTokenCurrency'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsCryptoTokenCurrency'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "usdc" -> PaymentMethodDetailsCryptoTokenCurrency'EnumUsdc
