...
data PaymentMethodDetailsEps = PaymentMethodDetailsEps {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsEps
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsEps
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsEps" (\obj -> (GHC.Base.pure PaymentMethodDetailsEps GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name"))}
-- | Create a new 'PaymentMethodDetailsEps' with all required fields.
mkPaymentMethodDetailsEps :: PaymentMethodDetailsEps
mkPaymentMethodDetailsEps = PaymentMethodDetailsEps{paymentMethodDetailsEpsBank = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsEpsBank'NonNullable =
   PaymentMethodDetailsEpsBank'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsEpsBank'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsEpsBank'NonNullableEnumArzteUndApothekerBank -- ^ Represents the JSON value @"arzte_und_apotheker_bank"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumAustrianAnadiBankAg -- ^ Represents the JSON value @"austrian_anadi_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBankAustria -- ^ Represents the JSON value @"bank_austria"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBankhausCarlSpangler -- ^ Represents the JSON value @"bankhaus_carl_spangler"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBankhausSchelhammerUndSchatteraAg -- ^ Represents the JSON value @"bankhaus_schelhammer_und_schattera_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBawagPskAg -- ^ Represents the JSON value @"bawag_psk_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBksBankAg -- ^ Represents the JSON value @"bks_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBrullKallmusBankAg -- ^ Represents the JSON value @"brull_kallmus_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumBtvVierLanderBank -- ^ Represents the JSON value @"btv_vier_lander_bank"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumCapitalBankGraweGruppeAg -- ^ Represents the JSON value @"capital_bank_grawe_gruppe_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumDeutscheBankAg -- ^ Represents the JSON value @"deutsche_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumDolomitenbank -- ^ Represents the JSON value @"dolomitenbank"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumEasybankAg -- ^ Represents the JSON value @"easybank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumErsteBankUndSparkassen -- ^ Represents the JSON value @"erste_bank_und_sparkassen"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoAlpeadriabankInternationalAg -- ^ Represents the JSON value @"hypo_alpeadriabank_international_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoBankBurgenlandAktiengesellschaft -- ^ Represents the JSON value @"hypo_bank_burgenland_aktiengesellschaft"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoNoeLbFurNiederosterreichUWien -- ^ Represents the JSON value @"hypo_noe_lb_fur_niederosterreich_u_wien"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoOberosterreichSalzburgSteiermark -- ^ Represents the JSON value @"hypo_oberosterreich_salzburg_steiermark"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoTirolBankAg -- ^ Represents the JSON value @"hypo_tirol_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumHypoVorarlbergBankAg -- ^ Represents the JSON value @"hypo_vorarlberg_bank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumMarchfelderBank -- ^ Represents the JSON value @"marchfelder_bank"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumOberbankAg -- ^ Represents the JSON value @"oberbank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumRaiffeisenBankengruppeOsterreich -- ^ Represents the JSON value @"raiffeisen_bankengruppe_osterreich"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumSchoellerbankAg -- ^ Represents the JSON value @"schoellerbank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumSpardaBankWien -- ^ Represents the JSON value @"sparda_bank_wien"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumVolksbankGruppe -- ^ Represents the JSON value @"volksbank_gruppe"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumVolkskreditbankAg -- ^ Represents the JSON value @"volkskreditbank_ag"@
  | PaymentMethodDetailsEpsBank'NonNullableEnumVrBankBraunau -- ^ Represents the JSON value @"vr_bank_braunau"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsEpsBank'NonNullable
    where {toJSON (PaymentMethodDetailsEpsBank'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsEpsBank'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "arzte_und_apotheker_bank" -> PaymentMethodDetailsEpsBank'NonNullableEnumArzteUndApothekerBank
