...
data PaymentMethodDetailsGiropay = PaymentMethodDetailsGiropay {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsGiropay
...
mkPaymentMethodDetailsGiropay = PaymentMethodDetailsGiropay{paymentMethodDetailsGiropayBankCode = GHC.Maybe.Nothing,
