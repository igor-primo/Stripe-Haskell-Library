...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsKlarna
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsKlarna" (\obj -> ((GHC.Base.pure PaymentMethodDetailsKlarna GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payer_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method_category")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_locale"))}
-- | Create a new 'PaymentMethodDetailsKlarna' with all required fields.
mkPaymentMethodDetailsKlarna :: PaymentMethodDetailsKlarna
mkPaymentMethodDetailsKlarna = PaymentMethodDetailsKlarna{paymentMethodDetailsKlarnaPayerDetails = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsKlarnaPayerDetails'NonNullable = PaymentMethodDetailsKlarnaPayerDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsKlarnaPayerDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsKlarnaPayerDetails'NonNullableAddress obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsKlarnaPayerDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsKlarnaPayerDetails'NonNullable" (\obj -> GHC.Base.pure PaymentMethodDetailsKlarnaPayerDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address"))}
...
data PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable = PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullableCountry obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable" (\obj -> GHC.Base.pure PaymentMethodDetailsKlarnaPayerDetails'NonNullableAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country"))}
