...
data PaymentMethodDetailsLink = PaymentMethodDetailsLink {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsLink
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsLinkCountry obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsLink
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsLink" (\obj -> GHC.Base.pure PaymentMethodDetailsLink GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country"))}
