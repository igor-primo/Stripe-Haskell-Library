...
data PaymentMethodDetailsMobilepay = PaymentMethodDetailsMobilepay {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsMobilepay
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("card" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsMobilepayCard obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsMobilepay
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsMobilepay" (\obj -> GHC.Base.pure PaymentMethodDetailsMobilepay GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card"))}
...
data PaymentMethodDetailsMobilepayCard'NonNullable = PaymentMethodDetailsMobilepayCard'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsMobilepayCard'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsMobilepayCard'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsMobilepayCard'NonNullable" (\obj -> ((((GHC.Base.pure PaymentMethodDetailsMobilepayCard'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "brand")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_month")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "exp_year")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4"))}
...
mkPaymentMethodDetailsMobilepayCard'NonNullable = PaymentMethodDetailsMobilepayCard'NonNullable{paymentMethodDetailsMobilepayCard'NonNullableBrand = GHC.Maybe.Nothing,
