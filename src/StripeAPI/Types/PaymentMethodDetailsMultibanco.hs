...
data PaymentMethodDetailsMultibanco = PaymentMethodDetailsMultibanco {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsMultibanco
...
mkPaymentMethodDetailsMultibanco = PaymentMethodDetailsMultibanco{paymentMethodDetailsMultibancoEntity = GHC.Maybe.Nothing,
