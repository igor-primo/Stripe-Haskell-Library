...
data PaymentMethodDetailsP24 = PaymentMethodDetailsP24 {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsP24
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsP24
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsP24" (\obj -> ((GHC.Base.pure PaymentMethodDetailsP24 GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name"))}
-- | Create a new 'PaymentMethodDetailsP24' with all required fields.
mkPaymentMethodDetailsP24 :: PaymentMethodDetailsP24
mkPaymentMethodDetailsP24 = PaymentMethodDetailsP24{paymentMethodDetailsP24Bank = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsP24Bank'NonNullable =
   PaymentMethodDetailsP24Bank'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsP24Bank'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsP24Bank'NonNullableEnumAliorBank -- ^ Represents the JSON value @"alior_bank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBankMillennium -- ^ Represents the JSON value @"bank_millennium"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBankNowyBfgSa -- ^ Represents the JSON value @"bank_nowy_bfg_sa"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBankPekaoSa -- ^ Represents the JSON value @"bank_pekao_sa"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBankiSpbdzielcze -- ^ Represents the JSON value @"banki_spbdzielcze"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBlik -- ^ Represents the JSON value @"blik"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBnpParibas -- ^ Represents the JSON value @"bnp_paribas"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumBoz -- ^ Represents the JSON value @"boz"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumCitiHandlowy -- ^ Represents the JSON value @"citi_handlowy"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumCreditAgricole -- ^ Represents the JSON value @"credit_agricole"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumEnvelobank -- ^ Represents the JSON value @"envelobank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumEtransferPocztowy24 -- ^ Represents the JSON value @"etransfer_pocztowy24"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumGetinBank -- ^ Represents the JSON value @"getin_bank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumIdeabank -- ^ Represents the JSON value @"ideabank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumIng -- ^ Represents the JSON value @"ing"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumInteligo -- ^ Represents the JSON value @"inteligo"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumMbankMtransfer -- ^ Represents the JSON value @"mbank_mtransfer"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumNestPrzelew -- ^ Represents the JSON value @"nest_przelew"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumNoblePay -- ^ Represents the JSON value @"noble_pay"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumPbacZIpko -- ^ Represents the JSON value @"pbac_z_ipko"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumPlusBank -- ^ Represents the JSON value @"plus_bank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumSantanderPrzelew24 -- ^ Represents the JSON value @"santander_przelew24"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumTmobileUsbugiBankowe -- ^ Represents the JSON value @"tmobile_usbugi_bankowe"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumToyotaBank -- ^ Represents the JSON value @"toyota_bank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumVelobank -- ^ Represents the JSON value @"velobank"@
  | PaymentMethodDetailsP24Bank'NonNullableEnumVolkswagenBank -- ^ Represents the JSON value @"volkswagen_bank"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsP24Bank'NonNullable
    where {toJSON (PaymentMethodDetailsP24Bank'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsP24Bank'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "alior_bank" -> PaymentMethodDetailsP24Bank'NonNullableEnumAliorBank
