...
data PaymentMethodDetailsPassthroughCard = PaymentMethodDetailsPassthroughCard {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsPassthroughCard
...
mkPaymentMethodDetailsPassthroughCard = PaymentMethodDetailsPassthroughCard{paymentMethodDetailsPassthroughCardBrand = GHC.Maybe.Nothing,
