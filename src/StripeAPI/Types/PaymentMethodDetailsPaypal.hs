...
data PaymentMethodDetailsPaypal = PaymentMethodDetailsPaypal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsPaypal
...
data PaymentMethodDetailsPaypalSellerProtection'NonNullable = PaymentMethodDetailsPaypalSellerProtection'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsPaypalSellerProtection'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("dispute_categories" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsPaypalSellerProtection'NonNullableStatus obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("dispute_categories" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("status" Data.Aeson.Types.ToJSON..=)) (paymentMethodDetailsPaypalSellerProtection'NonNullableStatus obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsPaypalSellerProtection'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsPaypalSellerProtection'NonNullable" (\obj -> (GHC.Base.pure PaymentMethodDetailsPaypalSellerProtection'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "dispute_categories")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status"))}
...
mkPaymentMethodDetailsPaypalSellerProtection'NonNullable = PaymentMethodDetailsPaypalSellerProtection'NonNullable{paymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories = GHC.Maybe.Nothing,
...
data PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullable =
   PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableEnumFraudulent -- ^ Represents the JSON value @"fraudulent"@
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableEnumProductNotReceived -- ^ Represents the JSON value @"product_not_received"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullable
    where {toJSON (PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fraudulent" -> PaymentMethodDetailsPaypalSellerProtection'NonNullableDisputeCategories'NonNullableEnumFraudulent
...
data PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus' =
   PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'EnumEligible -- ^ Represents the JSON value @"eligible"@
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'EnumNotEligible -- ^ Represents the JSON value @"not_eligible"@
  | PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'EnumPartiallyEligible -- ^ Represents the JSON value @"partially_eligible"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'
    where {toJSON (PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "eligible" -> PaymentMethodDetailsPaypalSellerProtection'NonNullableStatus'EnumEligible
