...
data PaymentMethodDetailsSofort = PaymentMethodDetailsSofort {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofort
...
mkPaymentMethodDetailsSofort = PaymentMethodDetailsSofort{paymentMethodDetailsSofortBankCode = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableVariants
    where {toJSON (PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullablePaymentMethod a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableVariants
    where {parseJSON val = case (PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodDetailsSofortGeneratedSepaDebit'NonNullablePaymentMethod Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableVariants
    where {toJSON (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableMandate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableVariants
    where {parseJSON val = case (PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableMandate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PaymentMethodDetailsSofortPreferredLanguage'NonNullable =
   PaymentMethodDetailsSofortPreferredLanguage'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumDe -- ^ Represents the JSON value @"de"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumEn -- ^ Represents the JSON value @"en"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumEs -- ^ Represents the JSON value @"es"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumFr -- ^ Represents the JSON value @"fr"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumIt -- ^ Represents the JSON value @"it"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumNl -- ^ Represents the JSON value @"nl"@
  | PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumPl -- ^ Represents the JSON value @"pl"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSofortPreferredLanguage'NonNullable
    where {toJSON (PaymentMethodDetailsSofortPreferredLanguage'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSofortPreferredLanguage'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "de" -> PaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumDe
