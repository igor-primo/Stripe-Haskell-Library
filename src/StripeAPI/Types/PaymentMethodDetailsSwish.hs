...
data PaymentMethodDetailsSwish = PaymentMethodDetailsSwish {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsSwish
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsSwish
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsSwish" (\obj -> ((GHC.Base.pure PaymentMethodDetailsSwish GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_phone_last4"))}
-- | Create a new 'PaymentMethodDetailsSwish' with all required fields.
mkPaymentMethodDetailsSwish :: PaymentMethodDetailsSwish
mkPaymentMethodDetailsSwish = PaymentMethodDetailsSwish{paymentMethodDetailsSwishFingerprint = GHC.Maybe.Nothing,
