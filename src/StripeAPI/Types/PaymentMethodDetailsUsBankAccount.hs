...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsUsBankAccount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodDetailsUsBankAccount" (\obj -> (((((((GHC.Base.pure PaymentMethodDetailsUsBankAccount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fingerprint")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "routing_number"))}
...
data PaymentMethodDetailsUsBankAccountMandate'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodDetailsUsBankAccountMandate'Variants
    where {toJSON (PaymentMethodDetailsUsBankAccountMandate'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentMethodDetailsUsBankAccountMandate'Mandate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodDetailsUsBankAccountMandate'Variants
    where {parseJSON val = case (PaymentMethodDetailsUsBankAccountMandate'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentMethodDetailsUsBankAccountMandate'Mandate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
