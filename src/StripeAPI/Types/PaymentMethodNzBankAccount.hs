...
data PaymentMethodNzBankAccount = PaymentMethodNzBankAccount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodNzBankAccount
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodNzBankAccount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodNzBankAccount" (\obj -> (((((GHC.Base.pure PaymentMethodNzBankAccount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_holder_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "branch_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "suffix"))}
-- | Create a new 'PaymentMethodNzBankAccount' with all required fields.
mkPaymentMethodNzBankAccount :: Data.Text.Internal.Text -- ^ 'paymentMethodNzBankAccountBankCode'
  -> Data.Text.Internal.Text -- ^ 'paymentMethodNzBankAccountBankName'
  -> Data.Text.Internal.Text -- ^ 'paymentMethodNzBankAccountBranchCode'
  -> Data.Text.Internal.Text -- ^ 'paymentMethodNzBankAccountLast4'
  -> PaymentMethodNzBankAccount
mkPaymentMethodNzBankAccount paymentMethodNzBankAccountBankCode paymentMethodNzBankAccountBankName paymentMethodNzBankAccountBranchCode paymentMethodNzBankAccountLast4 = PaymentMethodNzBankAccount{paymentMethodNzBankAccountAccountHolderName = GHC.Maybe.Nothing,
