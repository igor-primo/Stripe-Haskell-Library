...
data PaymentMethodOptionsAfterpayClearpay = PaymentMethodOptionsAfterpayClearpay {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsAfterpayClearpay
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsAfterpayClearpay
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodOptionsAfterpayClearpay" (\obj -> ((GHC.Base.pure PaymentMethodOptionsAfterpayClearpay GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "capture_method")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))}
...
mkPaymentMethodOptionsAfterpayClearpay = PaymentMethodOptionsAfterpayClearpay{paymentMethodOptionsAfterpayClearpayCaptureMethod = GHC.Maybe.Nothing,
...
data PaymentMethodOptionsAfterpayClearpayCaptureMethod' =
   PaymentMethodOptionsAfterpayClearpayCaptureMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsAfterpayClearpayCaptureMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsAfterpayClearpayCaptureMethod'EnumManual -- ^ Represents the JSON value @"manual"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsAfterpayClearpayCaptureMethod'
    where {toJSON (PaymentMethodOptionsAfterpayClearpayCaptureMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsAfterpayClearpayCaptureMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "manual" -> PaymentMethodOptionsAfterpayClearpayCaptureMethod'EnumManual
...
data PaymentMethodOptionsAfterpayClearpaySetupFutureUsage' =
   PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'
    where {toJSON (PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsAfterpayClearpaySetupFutureUsage'EnumNone
