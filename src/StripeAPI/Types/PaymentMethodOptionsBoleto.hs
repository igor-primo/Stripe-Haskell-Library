...
data PaymentMethodOptionsBoleto = PaymentMethodOptionsBoleto {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsBoleto
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["expires_after_days" Data.Aeson.Types.ToJSON..= paymentMethodOptionsBoletoExpiresAfterDays obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("setup_future_usage" Data.Aeson.Types.ToJSON..=)) (paymentMethodOptionsBoletoSetupFutureUsage obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsBoleto
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodOptionsBoleto" (\obj -> (GHC.Base.pure PaymentMethodOptionsBoleto GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "expires_after_days")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))}
-- | Create a new 'PaymentMethodOptionsBoleto' with all required fields.
mkPaymentMethodOptionsBoleto :: GHC.Types.Int -- ^ 'paymentMethodOptionsBoletoExpiresAfterDays'
...
data PaymentMethodOptionsBoletoSetupFutureUsage' =
   PaymentMethodOptionsBoletoSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsBoletoSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsBoletoSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentMethodOptionsBoletoSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  | PaymentMethodOptionsBoletoSetupFutureUsage'EnumOnSession -- ^ Represents the JSON value @"on_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsBoletoSetupFutureUsage'
    where {toJSON (PaymentMethodOptionsBoletoSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsBoletoSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsBoletoSetupFutureUsage'EnumNone
