...
data PaymentMethodOptionsCardInstallmentsPlan'NonNullableType' =
  ...
  | PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumBonus -- ^ Represents the JSON value @"bonus"@
  | PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumFixedCount -- ^ Represents the JSON value @"fixed_count"@
  | PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumRevolving -- ^ Represents the JSON value @"revolving"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bonus" -> PaymentMethodOptionsCardInstallmentsPlan'NonNullableType'EnumBonus
