...
data PaymentMethodOptionsKonbini = PaymentMethodOptionsKonbini {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsKonbini
...
mkPaymentMethodOptionsKonbini = PaymentMethodOptionsKonbini{paymentMethodOptionsKonbiniConfirmationNumber = GHC.Maybe.Nothing,
...
data PaymentMethodOptionsKonbiniSetupFutureUsage' =
   PaymentMethodOptionsKonbiniSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsKonbiniSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsKonbiniSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsKonbiniSetupFutureUsage'
    where {toJSON (PaymentMethodOptionsKonbiniSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsKonbiniSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsKonbiniSetupFutureUsage'EnumNone
