...
data PaymentMethodOptionsPaypalSetupFutureUsage' =
   PaymentMethodOptionsPaypalSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsPaypalSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsPaypalSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentMethodOptionsPaypalSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsPaypalSetupFutureUsage'
    where {toJSON (PaymentMethodOptionsPaypalSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsPaypalSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsPaypalSetupFutureUsage'EnumNone
