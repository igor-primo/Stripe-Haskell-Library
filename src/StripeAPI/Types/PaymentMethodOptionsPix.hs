...
data PaymentMethodOptionsPix = PaymentMethodOptionsPix {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsPix
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsPix
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodOptionsPix" (\obj -> ((GHC.Base.pure PaymentMethodOptionsPix GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_after_seconds")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))}
-- | Create a new 'PaymentMethodOptionsPix' with all required fields.
mkPaymentMethodOptionsPix :: PaymentMethodOptionsPix
mkPaymentMethodOptionsPix = PaymentMethodOptionsPix{paymentMethodOptionsPixExpiresAfterSeconds = GHC.Maybe.Nothing,
...
data PaymentMethodOptionsPixSetupFutureUsage' =
   PaymentMethodOptionsPixSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsPixSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsPixSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsPixSetupFutureUsage'
    where {toJSON (PaymentMethodOptionsPixSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsPixSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsPixSetupFutureUsage'EnumNone
