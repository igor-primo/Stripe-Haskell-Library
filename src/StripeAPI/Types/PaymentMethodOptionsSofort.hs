...
data PaymentMethodOptionsSofort = PaymentMethodOptionsSofort {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsSofort
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsSofort
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodOptionsSofort" (\obj -> (GHC.Base.pure PaymentMethodOptionsSofort GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_language")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "setup_future_usage"))}
...
data PaymentMethodOptionsSofortPreferredLanguage'NonNullable =
   PaymentMethodOptionsSofortPreferredLanguage'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumDe -- ^ Represents the JSON value @"de"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumEn -- ^ Represents the JSON value @"en"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumEs -- ^ Represents the JSON value @"es"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumFr -- ^ Represents the JSON value @"fr"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumIt -- ^ Represents the JSON value @"it"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumNl -- ^ Represents the JSON value @"nl"@
  | PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumPl -- ^ Represents the JSON value @"pl"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsSofortPreferredLanguage'NonNullable
    where {toJSON (PaymentMethodOptionsSofortPreferredLanguage'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsSofortPreferredLanguage'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "de" -> PaymentMethodOptionsSofortPreferredLanguage'NonNullableEnumDe
...
data PaymentMethodOptionsSofortSetupFutureUsage' =
   PaymentMethodOptionsSofortSetupFutureUsage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentMethodOptionsSofortSetupFutureUsage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentMethodOptionsSofortSetupFutureUsage'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentMethodOptionsSofortSetupFutureUsage'EnumOffSession -- ^ Represents the JSON value @"off_session"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodOptionsSofortSetupFutureUsage'
    where {toJSON (PaymentMethodOptionsSofortSetupFutureUsage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodOptionsSofortSetupFutureUsage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentMethodOptionsSofortSetupFutureUsage'EnumNone
