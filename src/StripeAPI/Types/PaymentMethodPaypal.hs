...
data PaymentMethodPaypal = PaymentMethodPaypal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodPaypal
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodPaypal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodPaypal" (\obj -> ((GHC.Base.pure PaymentMethodPaypal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payer_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payer_id"))}
-- | Create a new 'PaymentMethodPaypal' with all required fields.
mkPaymentMethodPaypal :: PaymentMethodPaypal
mkPaymentMethodPaypal = PaymentMethodPaypal{paymentMethodPaypalCountry = GHC.Maybe.Nothing,
