...
data PaymentMethodUsBankAccountStatusDetails'NonNullable = PaymentMethodUsBankAccountStatusDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentMethodUsBankAccountStatusDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("blocked" Data.Aeson.Types.ToJSON..=)) (paymentMethodUsBankAccountStatusDetails'NonNullableBlocked obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentMethodUsBankAccountStatusDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentMethodUsBankAccountStatusDetails'NonNullable" (\obj -> GHC.Base.pure PaymentMethodUsBankAccountStatusDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "blocked"))}
