...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionConsentCollection
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionConsentCollection" (\obj -> ((GHC.Base.pure PaymentPagesCheckoutSessionConsentCollection GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_method_reuse_agreement")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "terms_of_service"))}
...
mkPaymentPagesCheckoutSessionConsentCollection = PaymentPagesCheckoutSessionConsentCollection{paymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement = GHC.Maybe.Nothing,
...
data PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable = PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("position" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable" (\obj -> GHC.Base.pure PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "position"))}
...
data PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition' =
   PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumAuto -- ^ Represents the JSON value @"auto"@
  | PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumHidden -- ^ Represents the JSON value @"hidden"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'
    where {toJSON (PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "auto" -> PaymentPagesCheckoutSessionConsentCollectionPaymentMethodReuseAgreement'NonNullablePosition'EnumAuto
...
data PaymentPagesCheckoutSessionConsentCollectionPromotions'NonNullable =
  ...
  | PaymentPagesCheckoutSessionConsentCollectionPromotions'NonNullableEnumNone -- ^ Represents the JSON value @"none"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullable =
   PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableEnumNone -- ^ Represents the JSON value @"none"@
  | PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableEnumRequired -- ^ Represents the JSON value @"required"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullable
    where {toJSON (PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "none" -> PaymentPagesCheckoutSessionConsentCollectionTermsOfService'NonNullableEnumNone
