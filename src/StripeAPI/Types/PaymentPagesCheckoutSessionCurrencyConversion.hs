...
data PaymentPagesCheckoutSessionCurrencyConversion = PaymentPagesCheckoutSessionCurrencyConversion {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionCurrencyConversion
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount_subtotal" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionCurrencyConversionAmountSubtotal obj] : ["amount_total" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionCurrencyConversionAmountTotal obj] : ["fx_rate" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionCurrencyConversionFxRate obj] : ["source_currency" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionCurrencyConversionSourceCurrency obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionCurrencyConversion
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionCurrencyConversion" (\obj -> (((GHC.Base.pure PaymentPagesCheckoutSessionCurrencyConversion GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fx_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "source_currency"))}
-- | Create a new 'PaymentPagesCheckoutSessionCurrencyConversion' with all required fields.
mkPaymentPagesCheckoutSessionCurrencyConversion :: GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionCurrencyConversionAmountSubtotal'
  -> GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionCurrencyConversionAmountTotal'
  -> Data.Text.Internal.Text -- ^ 'paymentPagesCheckoutSessionCurrencyConversionFxRate'
  -> Data.Text.Internal.Text -- ^ 'paymentPagesCheckoutSessionCurrencyConversionSourceCurrency'
  -> PaymentPagesCheckoutSessionCurrencyConversion
mkPaymentPagesCheckoutSessionCurrencyConversion paymentPagesCheckoutSessionCurrencyConversionAmountSubtotal paymentPagesCheckoutSessionCurrencyConversionAmountTotal paymentPagesCheckoutSessionCurrencyConversionFxRate paymentPagesCheckoutSessionCurrencyConversionSourceCurrency = PaymentPagesCheckoutSessionCurrencyConversion{paymentPagesCheckoutSessionCurrencyConversionAmountSubtotal = paymentPagesCheckoutSessionCurrencyConversionAmountSubtotal,
