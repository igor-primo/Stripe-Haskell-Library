...
data PaymentPagesCheckoutSessionCustomFields = PaymentPagesCheckoutSessionCustomFields {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionCustomFields
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionCustomFields
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionCustomFields" (\obj -> ((((((GHC.Base.pure PaymentPagesCheckoutSessionCustomFields GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "dropdown")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "key")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "label")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "numeric")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "optional")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "text")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'PaymentPagesCheckoutSessionCustomFields' with all required fields.
mkPaymentPagesCheckoutSessionCustomFields :: Data.Text.Internal.Text -- ^ 'paymentPagesCheckoutSessionCustomFieldsKey'
  -> PaymentPagesCheckoutSessionCustomFieldsLabel -- ^ 'paymentPagesCheckoutSessionCustomFieldsLabel'
  -> GHC.Types.Bool -- ^ 'paymentPagesCheckoutSessionCustomFieldsOptional'
  -> PaymentPagesCheckoutSessionCustomFieldsType' -- ^ 'paymentPagesCheckoutSessionCustomFieldsType'
  -> PaymentPagesCheckoutSessionCustomFields
mkPaymentPagesCheckoutSessionCustomFields paymentPagesCheckoutSessionCustomFieldsKey paymentPagesCheckoutSessionCustomFieldsLabel paymentPagesCheckoutSessionCustomFieldsOptional paymentPagesCheckoutSessionCustomFieldsType = PaymentPagesCheckoutSessionCustomFields{paymentPagesCheckoutSessionCustomFieldsDropdown = GHC.Maybe.Nothing,
...
data PaymentPagesCheckoutSessionCustomFieldsType' =
   PaymentPagesCheckoutSessionCustomFieldsType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentPagesCheckoutSessionCustomFieldsType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentPagesCheckoutSessionCustomFieldsType'EnumDropdown -- ^ Represents the JSON value @"dropdown"@
  | PaymentPagesCheckoutSessionCustomFieldsType'EnumNumeric -- ^ Represents the JSON value @"numeric"@
  | PaymentPagesCheckoutSessionCustomFieldsType'EnumText -- ^ Represents the JSON value @"text"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionCustomFieldsType'
    where {toJSON (PaymentPagesCheckoutSessionCustomFieldsType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionCustomFieldsType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "dropdown" -> PaymentPagesCheckoutSessionCustomFieldsType'EnumDropdown
