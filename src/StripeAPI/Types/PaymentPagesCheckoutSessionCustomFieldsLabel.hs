...
data PaymentPagesCheckoutSessionCustomFieldsLabel = PaymentPagesCheckoutSessionCustomFieldsLabel {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionCustomFieldsLabel
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("custom" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionCustomFieldsLabelCustom obj) : ["type" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "custom"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionCustomFieldsLabel
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionCustomFieldsLabel" (\obj -> GHC.Base.pure PaymentPagesCheckoutSessionCustomFieldsLabel GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "custom"))}
