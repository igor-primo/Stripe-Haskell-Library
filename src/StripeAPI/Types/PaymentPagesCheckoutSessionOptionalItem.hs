...
data PaymentPagesCheckoutSessionOptionalItem = PaymentPagesCheckoutSessionOptionalItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionOptionalItem
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionOptionalItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionOptionalItem" (\obj -> ((GHC.Base.pure PaymentPagesCheckoutSessionOptionalItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "adjustable_quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "quantity"))}
-- | Create a new 'PaymentPagesCheckoutSessionOptionalItem' with all required fields.
mkPaymentPagesCheckoutSessionOptionalItem :: Data.Text.Internal.Text -- ^ 'paymentPagesCheckoutSessionOptionalItemPrice'
  -> GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionOptionalItemQuantity'
  -> PaymentPagesCheckoutSessionOptionalItem
mkPaymentPagesCheckoutSessionOptionalItem paymentPagesCheckoutSessionOptionalItemPrice paymentPagesCheckoutSessionOptionalItemQuantity = PaymentPagesCheckoutSessionOptionalItem{paymentPagesCheckoutSessionOptionalItemAdjustableQuantity = GHC.Maybe.Nothing,
...
data PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable = PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableEnabled obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableMaximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableMinimum obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableEnabled obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableMaximum obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minimum" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableMinimum obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable" (\obj -> ((GHC.Base.pure PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum"))}
...
mkPaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable = PaymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullable{paymentPagesCheckoutSessionOptionalItemAdjustableQuantity'NonNullableEnabled = GHC.Maybe.Nothing,
