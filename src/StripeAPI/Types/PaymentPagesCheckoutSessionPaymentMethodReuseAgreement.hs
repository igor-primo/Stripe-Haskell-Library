...
data PaymentPagesCheckoutSessionPaymentMethodReuseAgreement = PaymentPagesCheckoutSessionPaymentMethodReuseAgreement {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionPaymentMethodReuseAgreement
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["position" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionPaymentMethodReuseAgreement
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionPaymentMethodReuseAgreement" (\obj -> GHC.Base.pure PaymentPagesCheckoutSessionPaymentMethodReuseAgreement GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "position"))}
-- | Create a new 'PaymentPagesCheckoutSessionPaymentMethodReuseAgreement' with all required fields.
mkPaymentPagesCheckoutSessionPaymentMethodReuseAgreement :: PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition' -- ^ 'paymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'
...
data PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition' =
   PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'EnumAuto -- ^ Represents the JSON value @"auto"@
  | PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'EnumHidden -- ^ Represents the JSON value @"hidden"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'
    where {toJSON (PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "auto" -> PaymentPagesCheckoutSessionPaymentMethodReuseAgreementPosition'EnumAuto
