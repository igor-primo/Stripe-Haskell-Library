...
data PaymentPagesCheckoutSessionShippingCost = PaymentPagesCheckoutSessionShippingCost {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionShippingCost
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount_subtotal" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionShippingCostAmountSubtotal obj] : ["amount_tax" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionShippingCostAmountTax obj] : ["amount_total" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionShippingCostAmountTotal obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionShippingCostShippingRate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("taxes" Data.Aeson.Types.ToJSON..=)) (paymentPagesCheckoutSessionShippingCostTaxes obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionShippingCost
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionShippingCost" (\obj -> ((((GHC.Base.pure PaymentPagesCheckoutSessionShippingCost GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "taxes"))}
-- | Create a new 'PaymentPagesCheckoutSessionShippingCost' with all required fields.
mkPaymentPagesCheckoutSessionShippingCost :: GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionShippingCostAmountSubtotal'
  -> GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionShippingCostAmountTax'
  -> GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionShippingCostAmountTotal'
  -> PaymentPagesCheckoutSessionShippingCost
mkPaymentPagesCheckoutSessionShippingCost paymentPagesCheckoutSessionShippingCostAmountSubtotal paymentPagesCheckoutSessionShippingCostAmountTax paymentPagesCheckoutSessionShippingCostAmountTotal = PaymentPagesCheckoutSessionShippingCost{paymentPagesCheckoutSessionShippingCostAmountSubtotal = paymentPagesCheckoutSessionShippingCostAmountSubtotal,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableVariants
    where {toJSON (PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableShippingRate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableVariants
    where {parseJSON val = case (PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentPagesCheckoutSessionShippingCostShippingRate'NonNullableShippingRate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
