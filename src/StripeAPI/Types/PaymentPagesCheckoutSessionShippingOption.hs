...
data PaymentPagesCheckoutSessionShippingOption = PaymentPagesCheckoutSessionShippingOption {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionShippingOption
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["shipping_amount" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionShippingOptionShippingAmount obj] : ["shipping_rate" Data.Aeson.Types.ToJSON..= paymentPagesCheckoutSessionShippingOptionShippingRate obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionShippingOption
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionShippingOption" (\obj -> (GHC.Base.pure PaymentPagesCheckoutSessionShippingOption GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "shipping_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "shipping_rate"))}
-- | Create a new 'PaymentPagesCheckoutSessionShippingOption' with all required fields.
mkPaymentPagesCheckoutSessionShippingOption :: GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionShippingOptionShippingAmount'
  -> PaymentPagesCheckoutSessionShippingOptionShippingRate'Variants -- ^ 'paymentPagesCheckoutSessionShippingOptionShippingRate'
  -> PaymentPagesCheckoutSessionShippingOption
mkPaymentPagesCheckoutSessionShippingOption paymentPagesCheckoutSessionShippingOptionShippingAmount paymentPagesCheckoutSessionShippingOptionShippingRate = PaymentPagesCheckoutSessionShippingOption{paymentPagesCheckoutSessionShippingOptionShippingAmount = paymentPagesCheckoutSessionShippingOptionShippingAmount,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentPagesCheckoutSessionShippingOptionShippingRate'Variants
    where {toJSON (PaymentPagesCheckoutSessionShippingOptionShippingRate'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentPagesCheckoutSessionShippingOptionShippingRate'ShippingRate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionShippingOptionShippingRate'Variants
    where {parseJSON val = case (PaymentPagesCheckoutSessionShippingOptionShippingRate'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentPagesCheckoutSessionShippingOptionShippingRate'ShippingRate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
