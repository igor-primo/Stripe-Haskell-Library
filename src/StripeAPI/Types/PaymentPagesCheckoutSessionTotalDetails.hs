...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentPagesCheckoutSessionTotalDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentPagesCheckoutSessionTotalDetails" (\obj -> (((GHC.Base.pure PaymentPagesCheckoutSessionTotalDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_shipping")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "breakdown"))}
-- | Create a new 'PaymentPagesCheckoutSessionTotalDetails' with all required fields.
mkPaymentPagesCheckoutSessionTotalDetails :: GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionTotalDetailsAmountDiscount'
  -> GHC.Types.Int -- ^ 'paymentPagesCheckoutSessionTotalDetailsAmountTax'
  -> PaymentPagesCheckoutSessionTotalDetails
mkPaymentPagesCheckoutSessionTotalDetails paymentPagesCheckoutSessionTotalDetailsAmountDiscount paymentPagesCheckoutSessionTotalDetailsAmountTax = PaymentPagesCheckoutSessionTotalDetails{paymentPagesCheckoutSessionTotalDetailsAmountDiscount = paymentPagesCheckoutSessionTotalDetailsAmountDiscount,
