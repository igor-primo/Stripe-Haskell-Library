...
data PaymentSource = PaymentSource {
  ...
  , paymentSourceAllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceAllowRedisplay'NonNullable))
  ...
  , paymentSourceGroups :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceGroups'NonNullable))
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourceIin :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  ...
  -- | networks: 
  , paymentSourceNetworks :: (GHC.Maybe.Maybe TokenCardNetworks)
  ...
  , paymentSourceRegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceRegulatedStatus'NonNullable))
  -- | requirements: 
...
mkPaymentSource = PaymentSource{paymentSourceAccount = GHC.Maybe.Nothing,
                                ...
                                paymentSourceAllowRedisplay = GHC.Maybe.Nothing,
                                ...
                                paymentSourceGroups = GHC.Maybe.Nothing,
                                paymentSourceId = GHC.Maybe.Nothing,
                                paymentSourceIdeal = GHC.Maybe.Nothing,
                                paymentSourceIin = GHC.Maybe.Nothing,
                                ...
                                paymentSourceNetworks = GHC.Maybe.Nothing,
                                ...
                                paymentSourceRegulatedStatus = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceAccount'NonNullableVariants
    where {toJSON (PaymentSourceAccount'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentSourceAccount'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceAccount'NonNullableVariants
    where {parseJSON val = case (PaymentSourceAccount'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentSourceAccount'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the enum schema located at @components.schemas.payment_source.anyOf.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
data PaymentSourceAllowRedisplay'NonNullable =
   PaymentSourceAllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceAllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceAllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | PaymentSourceAllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | PaymentSourceAllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceAllowRedisplay'NonNullable
    where {toJSON (PaymentSourceAllowRedisplay'NonNullableOther val) = val;
           toJSON (PaymentSourceAllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceAllowRedisplay'NonNullableEnumAlways) = "always";
           toJSON (PaymentSourceAllowRedisplay'NonNullableEnumLimited) = "limited";
           toJSON (PaymentSourceAllowRedisplay'NonNullableEnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceAllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PaymentSourceAllowRedisplay'NonNullableEnumAlways
                                             | val GHC.Classes.== "limited" -> PaymentSourceAllowRedisplay'NonNullableEnumLimited
                                             | val GHC.Classes.== "unspecified" -> PaymentSourceAllowRedisplay'NonNullableEnumUnspecified
                                             | GHC.Base.otherwise -> PaymentSourceAllowRedisplay'NonNullableOther val)}
...
data PaymentSourceAvailablePayoutMethods'NonNullable =
   PaymentSourceAvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceAvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceAvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | PaymentSourceAvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceAvailablePayoutMethods'NonNullable
    where {toJSON (PaymentSourceAvailablePayoutMethods'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceAvailablePayoutMethods'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> PaymentSourceAvailablePayoutMethods'NonNullableEnumInstant
...
data PaymentSourceBusinessProfile'NonNullable = PaymentSourceBusinessProfile'NonNullable {
  ...
  paymentSourceBusinessProfile'NonNullableAnnualRevenue :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable))
  -- | estimated_worker_count: An estimated upper bound of employees, contractors, vendors, etc. currently working for the business.
  , paymentSourceBusinessProfile'NonNullableEstimatedWorkerCount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int))
  ...
  , paymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable [PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullable]))
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceBusinessProfile'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("annual_revenue" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("estimated_worker_count" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableEstimatedWorkerCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mcc" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMcc obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minority_owned_business_designation" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("monthly_estimated_revenue" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMonthlyEstimatedRevenue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("product_description" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableProductDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_address" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_email" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportPhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_url" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportUrl obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("url" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableUrl obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("annual_revenue" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("estimated_worker_count" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableEstimatedWorkerCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mcc" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMcc obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("minority_owned_business_designation" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("monthly_estimated_revenue" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableMonthlyEstimatedRevenue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("product_description" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableProductDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_address" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_email" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportPhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("support_url" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportUrl obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("url" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableUrl obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessProfile'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceBusinessProfile'NonNullable" (\obj -> (((((((((((GHC.Base.pure PaymentSourceBusinessProfile'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "annual_revenue")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "estimated_worker_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mcc")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minority_owned_business_designation")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "monthly_estimated_revenue")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product_description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_phone")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "support_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "url"))}
...
mkPaymentSourceBusinessProfile'NonNullable = PaymentSourceBusinessProfile'NonNullable{paymentSourceBusinessProfile'NonNullableAnnualRevenue = GHC.Maybe.Nothing,
                                                                                      paymentSourceBusinessProfile'NonNullableEstimatedWorkerCount = GHC.Maybe.Nothing,
                                                                                      paymentSourceBusinessProfile'NonNullableMcc = GHC.Maybe.Nothing,
                                                                                      paymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @components.schemas.payment_source.anyOf.properties.business_profile.anyOf.properties.annual_revenue.anyOf@ in the specification.
-- 
-- The applicant\\\'s gross annual revenue for its preceding fiscal year.
data PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable = PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable {
  -- | amount: A non-negative integer representing the amount in the [smallest currency unit](\/currencies\#zero-decimal).
  paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableAmount :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable GHC.Types.Int))
  -- | currency: Three-letter [ISO currency code](https:\/\/www.iso.org\/iso-4217-currency-codes.html), in lowercase. Must be a [supported currency](https:\/\/stripe.com\/docs\/currencies).
  , paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableCurrency :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableFiscalYearEnd :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fiscal_year_end" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableFiscalYearEnd obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("fiscal_year_end" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableFiscalYearEnd obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable" (\obj -> ((GHC.Base.pure PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "fiscal_year_end"))}
-- | Create a new 'PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable' with all required fields.
mkPaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable :: PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable
mkPaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable = PaymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullable{paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableAmount = GHC.Maybe.Nothing,
                                                                                                                                        paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableCurrency = GHC.Maybe.Nothing,
                                                                                                                                        paymentSourceBusinessProfile'NonNullableAnnualRevenue'NonNullableFiscalYearEnd = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @components.schemas.payment_source.anyOf.properties.business_profile.anyOf.properties.minority_owned_business_designation.items@ in the specification.
-- 
-- 
data PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullable =
   PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness -- ^ Represents the JSON value @"lgbtqi_owned_business"@
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness -- ^ Represents the JSON value @"minority_owned_business"@
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply -- ^ Represents the JSON value @"none_of_these_apply"@
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer -- ^ Represents the JSON value @"prefer_not_to_answer"@
  | PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness -- ^ Represents the JSON value @"women_owned_business"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullable
    where {toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableOther val) = val;
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness) = "lgbtqi_owned_business";
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness) = "minority_owned_business";
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply) = "none_of_these_apply";
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer) = "prefer_not_to_answer";
           toJSON (PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness) = "women_owned_business"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "lgbtqi_owned_business" -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumLgbtqiOwnedBusiness
                                             | val GHC.Classes.== "minority_owned_business" -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumMinorityOwnedBusiness
                                             | val GHC.Classes.== "none_of_these_apply" -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumNoneOfTheseApply
                                             | val GHC.Classes.== "prefer_not_to_answer" -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumPreferNotToAnswer
                                             | val GHC.Classes.== "women_owned_business" -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableEnumWomenOwnedBusiness
                                             | GHC.Base.otherwise -> PaymentSourceBusinessProfile'NonNullableMinorityOwnedBusinessDesignation'NonNullableOther val)}
...
data PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable = PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable" (\obj -> (((((GHC.Base.pure PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable = PaymentSourceBusinessProfile'NonNullableSupportAddress'NonNullable{paymentSourceBusinessProfile'NonNullableSupportAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data PaymentSourceBusinessType'NonNullable =
   PaymentSourceBusinessType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceBusinessType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceBusinessType'NonNullableEnumCompany -- ^ Represents the JSON value @"company"@
  | PaymentSourceBusinessType'NonNullableEnumGovernmentEntity -- ^ Represents the JSON value @"government_entity"@
  | PaymentSourceBusinessType'NonNullableEnumIndividual -- ^ Represents the JSON value @"individual"@
  | PaymentSourceBusinessType'NonNullableEnumNonProfit -- ^ Represents the JSON value @"non_profit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceBusinessType'NonNullable
    where {toJSON (PaymentSourceBusinessType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceBusinessType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "company" -> PaymentSourceBusinessType'NonNullableEnumCompany
...
data PaymentSourceCustomer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceCustomer'NonNullableVariants
    where {toJSON (PaymentSourceCustomer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data PaymentSourceExternalAccounts' = PaymentSourceExternalAccounts' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= paymentSourceExternalAccounts'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= paymentSourceExternalAccounts'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= paymentSourceExternalAccounts'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceExternalAccounts'" (\obj -> ((GHC.Base.pure PaymentSourceExternalAccounts' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'PaymentSourceExternalAccounts'' with all required fields.
mkPaymentSourceExternalAccounts' :: [PaymentSourceExternalAccounts'Data'] -- ^ 'paymentSourceExternalAccounts'Data'
  -> GHC.Types.Bool -- ^ 'paymentSourceExternalAccounts'HasMore'
  -> Data.Text.Internal.Text -- ^ 'paymentSourceExternalAccounts'Url'
  -> PaymentSourceExternalAccounts'
mkPaymentSourceExternalAccounts' paymentSourceExternalAccounts'Data paymentSourceExternalAccounts'HasMore paymentSourceExternalAccounts'Url = PaymentSourceExternalAccounts'{paymentSourceExternalAccounts'Data = paymentSourceExternalAccounts'Data,
...
data PaymentSourceExternalAccounts'Data' = PaymentSourceExternalAccounts'Data' {
  ...
  -- | allow_redisplay: This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
  , paymentSourceExternalAccounts'Data'AllowRedisplay :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullable))
  -- | available_payout_methods: A set of available payout methods for this bank account. Only values from this set should be passed as the \`method\` when creating a payout.
  ...
  -- 
  -- * Maximum length of 5000
  , paymentSourceExternalAccounts'Data'Iin :: (GHC.Maybe.Maybe Data.Text.Internal.Text)
  -- | last4: The last four digits of the bank account number.
  -- 
  -- Constraints:
  -- 
  ...
  -- | networks: 
  , paymentSourceExternalAccounts'Data'Networks :: (GHC.Maybe.Maybe TokenCardNetworks)
  -- | object: String representing the object\'s type. Objects of the same type share the same value.
  , paymentSourceExternalAccounts'Data'Object :: (GHC.Maybe.Maybe PaymentSourceExternalAccounts'Data'Object')
  -- | regulated_status: Status of a card based on the card issuer.
  , paymentSourceExternalAccounts'Data'RegulatedStatus :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullable))
...
mkPaymentSourceExternalAccounts'Data' = PaymentSourceExternalAccounts'Data'{paymentSourceExternalAccounts'Data'Account = GHC.Maybe.Nothing,
                                                                            ...
                                                                            paymentSourceExternalAccounts'Data'AllowRedisplay = GHC.Maybe.Nothing,
                                                                            ...
                                                                            paymentSourceExternalAccounts'Data'Iin = GHC.Maybe.Nothing,
                                                                            ...
                                                                            paymentSourceExternalAccounts'Data'Networks = GHC.Maybe.Nothing,
                                                                            paymentSourceExternalAccounts'Data'Object = GHC.Maybe.Nothing,
                                                                            paymentSourceExternalAccounts'Data'RegulatedStatus = GHC.Maybe.Nothing,
...
data PaymentSourceExternalAccounts'Data'Account'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'Account'NonNullableVariants
    where {toJSON (PaymentSourceExternalAccounts'Data'Account'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PaymentSourceExternalAccounts'Data'Account'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'Account'NonNullableVariants
    where {parseJSON val = case (PaymentSourceExternalAccounts'Data'Account'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PaymentSourceExternalAccounts'Data'Account'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
-- | Defines the enum schema located at @components.schemas.payment_source.anyOf.properties.external_accounts.properties.data.items.anyOf.properties.allow_redisplay@ in the specification.
-- 
-- This field indicates whether this payment method can be shown again to its customer in a checkout flow. Stripe products such as Checkout and Elements use this field to determine whether a payment method can be shown as a saved payment method in a checkout flow. The field defaults to “unspecified”.
data PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullable =
   PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullable
    where {toJSON (PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableOther val) = val;
           toJSON (PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumAlways) = "always";
           toJSON (PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumLimited) = "limited";
           toJSON (PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumUnspecified) = "unspecified"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumAlways
                                             | val GHC.Classes.== "limited" -> PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumLimited
                                             | val GHC.Classes.== "unspecified" -> PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableEnumUnspecified
                                             | GHC.Base.otherwise -> PaymentSourceExternalAccounts'Data'AllowRedisplay'NonNullableOther val)}
...
data PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullable =
   PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullable
    where {toJSON (PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> PaymentSourceExternalAccounts'Data'AvailablePayoutMethods'NonNullableEnumInstant
...
data PaymentSourceExternalAccounts'Data'Customer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'Customer'NonNullableVariants
    where {toJSON (PaymentSourceExternalAccounts'Data'Customer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data PaymentSourceExternalAccounts'Data'FutureRequirements'NonNullable = PaymentSourceExternalAccounts'Data'FutureRequirements'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'FutureRequirements'NonNullable
...
mkPaymentSourceExternalAccounts'Data'FutureRequirements'NonNullable = PaymentSourceExternalAccounts'Data'FutureRequirements'NonNullable{paymentSourceExternalAccounts'Data'FutureRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
...
data PaymentSourceExternalAccounts'Data'Object' =
   PaymentSourceExternalAccounts'Data'Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceExternalAccounts'Data'Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceExternalAccounts'Data'Object'EnumBankAccount -- ^ Represents the JSON value @"bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'Object'
    where {toJSON (PaymentSourceExternalAccounts'Data'Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_account" -> PaymentSourceExternalAccounts'Data'Object'EnumBankAccount
                                             | GHC.Base.otherwise -> PaymentSourceExternalAccounts'Data'Object'Other val)}
-- | Defines the enum schema located at @components.schemas.payment_source.anyOf.properties.external_accounts.properties.data.items.anyOf.properties.regulated_status@ in the specification.
-- 
-- Status of a card based on the card issuer.
data PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullable =
   PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullable
    where {toJSON (PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableOther val) = val;
           toJSON (PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumRegulated) = "regulated";
           toJSON (PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumUnregulated) = "unregulated"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumRegulated
                                             | val GHC.Classes.== "unregulated" -> PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableEnumUnregulated
                                             | GHC.Base.otherwise -> PaymentSourceExternalAccounts'Data'RegulatedStatus'NonNullableOther val)}
...
data PaymentSourceExternalAccounts'Data'Requirements'NonNullable = PaymentSourceExternalAccounts'Data'Requirements'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceExternalAccounts'Data'Requirements'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currently_due" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullableCurrentlyDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("errors" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullableErrors obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("past_due" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullablePastDue obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("pending_verification" Data.Aeson.Types.ToJSON..=)) (paymentSourceExternalAccounts'Data'Requirements'NonNullablePendingVerification obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceExternalAccounts'Data'Requirements'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceExternalAccounts'Data'Requirements'NonNullable" (\obj -> (((GHC.Base.pure PaymentSourceExternalAccounts'Data'Requirements'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currently_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "errors")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "past_due")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "pending_verification"))}
...
mkPaymentSourceExternalAccounts'Data'Requirements'NonNullable = PaymentSourceExternalAccounts'Data'Requirements'NonNullable{paymentSourceExternalAccounts'Data'Requirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @components.schemas.payment_source.anyOf.properties.groups.anyOf@ in the specification.
-- 
-- The groups associated with the account.
data PaymentSourceGroups'NonNullable = PaymentSourceGroups'NonNullable {
  ...
  -- 
  -- * Maximum length of 5000
  paymentSourceGroups'NonNullablePaymentsPricing :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceGroups'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payments_pricing" Data.Aeson.Types.ToJSON..=)) (paymentSourceGroups'NonNullablePaymentsPricing obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("payments_pricing" Data.Aeson.Types.ToJSON..=)) (paymentSourceGroups'NonNullablePaymentsPricing obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceGroups'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceGroups'NonNullable" (\obj -> GHC.Base.pure PaymentSourceGroups'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payments_pricing"))}
-- | Create a new 'PaymentSourceGroups'NonNullable' with all required fields.
mkPaymentSourceGroups'NonNullable :: PaymentSourceGroups'NonNullable
mkPaymentSourceGroups'NonNullable = PaymentSourceGroups'NonNullable{paymentSourceGroups'NonNullablePaymentsPricing = GHC.Maybe.Nothing}
...
data PaymentSourceObject' =
   PaymentSourceObject'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceObject'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceObject'EnumAccount -- ^ Represents the JSON value @"account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceObject'
    where {toJSON (PaymentSourceObject'Other val) = val;
           toJSON (PaymentSourceObject'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceObject'EnumAccount) = "account"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceObject'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> PaymentSourceObject'EnumAccount
...
data PaymentSourceOwner'NonNullable = PaymentSourceOwner'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceOwner'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedPhone obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedPhone obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceOwner'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceOwner'NonNullable" (\obj -> (((((((GHC.Base.pure PaymentSourceOwner'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "phone")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_phone"))}
...
mkPaymentSourceOwner'NonNullable = PaymentSourceOwner'NonNullable{paymentSourceOwner'NonNullableAddress = GHC.Maybe.Nothing,
...
data PaymentSourceOwner'NonNullableAddress'NonNullable = PaymentSourceOwner'NonNullableAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceOwner'NonNullableAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceOwner'NonNullableAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceOwner'NonNullableAddress'NonNullable" (\obj -> (((((GHC.Base.pure PaymentSourceOwner'NonNullableAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPaymentSourceOwner'NonNullableAddress'NonNullable = PaymentSourceOwner'NonNullableAddress'NonNullable{paymentSourceOwner'NonNullableAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable = PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (paymentSourceOwner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable" (\obj -> (((((GHC.Base.pure PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkPaymentSourceOwner'NonNullableVerifiedAddress'NonNullable = PaymentSourceOwner'NonNullableVerifiedAddress'NonNullable{paymentSourceOwner'NonNullableVerifiedAddress'NonNullableCity = GHC.Maybe.Nothing,
...
-- | Defines the enum schema located at @components.schemas.payment_source.anyOf.properties.regulated_status@ in the specification.
-- 
-- Status of a card based on the card issuer.
data PaymentSourceRegulatedStatus'NonNullable =
   PaymentSourceRegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceRegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceRegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | PaymentSourceRegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceRegulatedStatus'NonNullable
    where {toJSON (PaymentSourceRegulatedStatus'NonNullableOther val) = val;
           toJSON (PaymentSourceRegulatedStatus'NonNullableTyped val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (PaymentSourceRegulatedStatus'NonNullableEnumRegulated) = "regulated";
           toJSON (PaymentSourceRegulatedStatus'NonNullableEnumUnregulated) = "unregulated"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceRegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> PaymentSourceRegulatedStatus'NonNullableEnumRegulated
                                             | val GHC.Classes.== "unregulated" -> PaymentSourceRegulatedStatus'NonNullableEnumUnregulated
                                             | GHC.Base.otherwise -> PaymentSourceRegulatedStatus'NonNullableOther val)}
...
data PaymentSourceSettings'NonNullable = PaymentSourceSettings'NonNullable {
  ...
  -- | invoices: 
  , paymentSourceSettings'NonNullableInvoices :: (GHC.Maybe.Maybe AccountInvoicesSettings)
  -- | payments: 
...
mkPaymentSourceSettings'NonNullable = PaymentSourceSettings'NonNullable{paymentSourceSettings'NonNullableBacsDebitPayments = GHC.Maybe.Nothing,
                                                                        ...
                                                                        paymentSourceSettings'NonNullableInvoices = GHC.Maybe.Nothing,
...
data PaymentSourceType' =
   PaymentSourceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PaymentSourceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PaymentSourceType'EnumCustom -- ^ Represents the JSON value @"custom"@
  | PaymentSourceType'EnumExpress -- ^ Represents the JSON value @"express"@
  | PaymentSourceType'EnumNone -- ^ Represents the JSON value @"none"@
  | PaymentSourceType'EnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PaymentSourceType'
    where {toJSON (PaymentSourceType'Other val) = val;
           ...
           toJSON (PaymentSourceType'EnumNone) = "none";
           toJSON (PaymentSourceType'EnumStandard) = "standard"}
instance Data.Aeson.Types.FromJSON.FromJSON PaymentSourceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "custom" -> PaymentSourceType'EnumCustom
                                             | val GHC.Classes.== "express" -> PaymentSourceType'EnumExpress
                                             | val GHC.Classes.== "none" -> PaymentSourceType'EnumNone
