...
mkPayout :: GHC.Types.Int -- ^ 'payoutAmount'
  -> GHC.Types.Int -- ^ 'payoutArrivalDate'
  ...
  -> PayoutReconciliationStatus' -- ^ 'payoutReconciliationStatus'
  -> Data.Text.Internal.Text -- ^ 'payoutSourceType'
  -> Data.Text.Internal.Text -- ^ 'payoutStatus'
  -> PayoutType' -- ^ 'payoutType'
  -> Payout
mkPayout payoutAmount payoutArrivalDate payoutAutomatic payoutCreated payoutCurrency payoutId payoutLivemode payoutMethod payoutReconciliationStatus payoutSourceType payoutStatus payoutType = Payout{payoutAmount = payoutAmount,
...
instance Data.Aeson.Types.ToJSON.ToJSON PayoutApplicationFee'NonNullableVariants
    where {toJSON (PayoutApplicationFee'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PayoutApplicationFee'NonNullableApplicationFee a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PayoutApplicationFee'NonNullableVariants
    where {parseJSON val = case (PayoutApplicationFee'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutApplicationFee'NonNullableApplicationFee Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data PayoutBalanceTransaction'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutBalanceTransaction'NonNullableVariants
    where {toJSON (PayoutBalanceTransaction'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PayoutBalanceTransaction'NonNullableBalanceTransaction a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PayoutBalanceTransaction'NonNullableVariants
    where {parseJSON val = case (PayoutBalanceTransaction'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutBalanceTransaction'NonNullableBalanceTransaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PayoutDestination'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutDestination'NonNullableVariants
    where {toJSON (PayoutDestination'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data PayoutFailureBalanceTransaction'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutFailureBalanceTransaction'NonNullableVariants
    where {toJSON (PayoutFailureBalanceTransaction'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PayoutFailureBalanceTransaction'NonNullableBalanceTransaction a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PayoutFailureBalanceTransaction'NonNullableVariants
    where {parseJSON val = case (PayoutFailureBalanceTransaction'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutFailureBalanceTransaction'NonNullableBalanceTransaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PayoutOriginalPayout'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutOriginalPayout'NonNullableVariants
    where {toJSON (PayoutOriginalPayout'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PayoutOriginalPayout'NonNullablePayout a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PayoutOriginalPayout'NonNullableVariants
    where {parseJSON val = case (PayoutOriginalPayout'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutOriginalPayout'NonNullablePayout Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PayoutReconciliationStatus' =
   PayoutReconciliationStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PayoutReconciliationStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PayoutReconciliationStatus'EnumCompleted -- ^ Represents the JSON value @"completed"@
  | PayoutReconciliationStatus'EnumInProgress -- ^ Represents the JSON value @"in_progress"@
  | PayoutReconciliationStatus'EnumNotApplicable -- ^ Represents the JSON value @"not_applicable"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutReconciliationStatus'
    where {toJSON (PayoutReconciliationStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PayoutReconciliationStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "completed" -> PayoutReconciliationStatus'EnumCompleted
...
data PayoutReversedBy'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutReversedBy'NonNullableVariants
    where {toJSON (PayoutReversedBy'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (PayoutReversedBy'NonNullablePayout a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON PayoutReversedBy'NonNullableVariants
    where {parseJSON val = case (PayoutReversedBy'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PayoutReversedBy'NonNullablePayout Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data PayoutTraceId'NonNullable = PayoutTraceId'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutTraceId'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PayoutTraceId'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PayoutTraceId'NonNullable" (\obj -> (GHC.Base.pure PayoutTraceId'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "value"))}
-- | Create a new 'PayoutTraceId'NonNullable' with all required fields.
mkPayoutTraceId'NonNullable :: PayoutTraceId'NonNullable
mkPayoutTraceId'NonNullable = PayoutTraceId'NonNullable{payoutTraceId'NonNullableStatus = GHC.Maybe.Nothing,
...
data PayoutType' =
   PayoutType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PayoutType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PayoutType'EnumBankAccount -- ^ Represents the JSON value @"bank_account"@
  | PayoutType'EnumCard -- ^ Represents the JSON value @"card"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PayoutType'
    where {toJSON (PayoutType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PayoutType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_account" -> PayoutType'EnumBankAccount
