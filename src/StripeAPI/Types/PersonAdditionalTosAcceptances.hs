...
data PersonAdditionalTosAcceptances = PersonAdditionalTosAcceptances {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonAdditionalTosAcceptances
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (personAdditionalTosAcceptancesAccount obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonAdditionalTosAcceptances
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PersonAdditionalTosAcceptances" (\obj -> GHC.Base.pure PersonAdditionalTosAcceptances GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account"))}
...
data PersonAdditionalTosAcceptancesAccount'NonNullable = PersonAdditionalTosAcceptancesAccount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonAdditionalTosAcceptancesAccount'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonAdditionalTosAcceptancesAccount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PersonAdditionalTosAcceptancesAccount'NonNullable" (\obj -> ((GHC.Base.pure PersonAdditionalTosAcceptancesAccount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "user_agent"))}
...
mkPersonAdditionalTosAcceptancesAccount'NonNullable = PersonAdditionalTosAcceptancesAccount'NonNullable{personAdditionalTosAcceptancesAccount'NonNullableDate = GHC.Maybe.Nothing,
