...
data PersonFutureRequirements = PersonFutureRequirements {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonFutureRequirements
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonFutureRequirements
...
mkPersonFutureRequirements :: [Data.Text.Internal.Text] -- ^ 'personFutureRequirementsCurrentlyDue'
  -> [AccountRequirementsError] -- ^ 'personFutureRequirementsErrors'
  -> [Data.Text.Internal.Text] -- ^ 'personFutureRequirementsEventuallyDue'
  -> [Data.Text.Internal.Text] -- ^ 'personFutureRequirementsPastDue'
  -> [Data.Text.Internal.Text] -- ^ 'personFutureRequirementsPendingVerification'
  -> PersonFutureRequirements
mkPersonFutureRequirements personFutureRequirementsCurrentlyDue personFutureRequirementsErrors personFutureRequirementsEventuallyDue personFutureRequirementsPastDue personFutureRequirementsPendingVerification = PersonFutureRequirements{personFutureRequirementsAlternatives = GHC.Maybe.Nothing,
