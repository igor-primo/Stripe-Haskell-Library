...
data PersonUsCfpbData = PersonUsCfpbData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonUsCfpbData
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonUsCfpbData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PersonUsCfpbData" (\obj -> ((GHC.Base.pure PersonUsCfpbData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "self_identified_gender"))}
-- | Create a new 'PersonUsCfpbData' with all required fields.
mkPersonUsCfpbData :: PersonUsCfpbData
mkPersonUsCfpbData = PersonUsCfpbData{personUsCfpbDataEthnicityDetails = GHC.Maybe.Nothing,
...
data PersonUsCfpbDataEthnicityDetails'NonNullable = PersonUsCfpbDataEthnicityDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonUsCfpbDataEthnicityDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataEthnicityDetails'NonNullableEthnicity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_other" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataEthnicityDetails'NonNullableEthnicityOther obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataEthnicityDetails'NonNullableEthnicity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ethnicity_other" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataEthnicityDetails'NonNullableEthnicityOther obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PersonUsCfpbDataEthnicityDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PersonUsCfpbDataEthnicityDetails'NonNullable" (\obj -> (GHC.Base.pure PersonUsCfpbDataEthnicityDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ethnicity_other"))}
...
mkPersonUsCfpbDataEthnicityDetails'NonNullable = PersonUsCfpbDataEthnicityDetails'NonNullable{personUsCfpbDataEthnicityDetails'NonNullableEthnicity = GHC.Maybe.Nothing,
...
data PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullable =
   PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumCuban -- ^ Represents the JSON value @"cuban"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumHispanicOrLatino -- ^ Represents the JSON value @"hispanic_or_latino"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumMexican -- ^ Represents the JSON value @"mexican"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumNotHispanicOrLatino -- ^ Represents the JSON value @"not_hispanic_or_latino"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumOtherHispanicOrLatino -- ^ Represents the JSON value @"other_hispanic_or_latino"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumPreferNotToAnswer -- ^ Represents the JSON value @"prefer_not_to_answer"@
  | PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumPuertoRican -- ^ Represents the JSON value @"puerto_rican"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullable
    where {toJSON (PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cuban" -> PersonUsCfpbDataEthnicityDetails'NonNullableEthnicity'NonNullableEnumCuban
...
data PersonUsCfpbDataRaceDetails'NonNullable = PersonUsCfpbDataRaceDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonUsCfpbDataRaceDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataRaceDetails'NonNullableRace obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_other" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataRaceDetails'NonNullableRaceOther obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataRaceDetails'NonNullableRace obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("race_other" Data.Aeson.Types.ToJSON..=)) (personUsCfpbDataRaceDetails'NonNullableRaceOther obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PersonUsCfpbDataRaceDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PersonUsCfpbDataRaceDetails'NonNullable" (\obj -> (GHC.Base.pure PersonUsCfpbDataRaceDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "race_other"))}
...
mkPersonUsCfpbDataRaceDetails'NonNullable = PersonUsCfpbDataRaceDetails'NonNullable{personUsCfpbDataRaceDetails'NonNullableRace = GHC.Maybe.Nothing,
...
data PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullable =
   PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumAfricanAmerican -- ^ Represents the JSON value @"african_american"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumAmericanIndianOrAlaskaNative -- ^ Represents the JSON value @"american_indian_or_alaska_native"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumAsian -- ^ Represents the JSON value @"asian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumAsianIndian -- ^ Represents the JSON value @"asian_indian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumBlackOrAfricanAmerican -- ^ Represents the JSON value @"black_or_african_american"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumChinese -- ^ Represents the JSON value @"chinese"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumEthiopian -- ^ Represents the JSON value @"ethiopian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumFilipino -- ^ Represents the JSON value @"filipino"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumGuamanianOrChamorro -- ^ Represents the JSON value @"guamanian_or_chamorro"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumHaitian -- ^ Represents the JSON value @"haitian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumJamaican -- ^ Represents the JSON value @"jamaican"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumJapanese -- ^ Represents the JSON value @"japanese"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumKorean -- ^ Represents the JSON value @"korean"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumNativeHawaiian -- ^ Represents the JSON value @"native_hawaiian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumNativeHawaiianOrOtherPacificIslander -- ^ Represents the JSON value @"native_hawaiian_or_other_pacific_islander"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumNigerian -- ^ Represents the JSON value @"nigerian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumOtherAsian -- ^ Represents the JSON value @"other_asian"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumOtherBlackOrAfricanAmerican -- ^ Represents the JSON value @"other_black_or_african_american"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumOtherPacificIslander -- ^ Represents the JSON value @"other_pacific_islander"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumPreferNotToAnswer -- ^ Represents the JSON value @"prefer_not_to_answer"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumSamoan -- ^ Represents the JSON value @"samoan"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumSomali -- ^ Represents the JSON value @"somali"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumVietnamese -- ^ Represents the JSON value @"vietnamese"@
  | PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumWhite -- ^ Represents the JSON value @"white"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullable
    where {toJSON (PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "african_american" -> PersonUsCfpbDataRaceDetails'NonNullableRace'NonNullableEnumAfricanAmerican
