...
data Plan = Plan {
  ...
  -- 
  -- * Maximum length of 5000
  , planMeter :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
...
instance Data.Aeson.Types.FromJSON.FromJSON Plan
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Plan" (\obj -> ((((((((((((((((((GHC.Base.pure Plan GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "active")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_decimal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "billing_scheme")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "meter")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "nickname")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tiers_mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transform_usage")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_period_days")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "usage_type"))}
-- | Create a new 'Plan' with all required fields.
mkPlan :: GHC.Types.Bool -- ^ 'planActive'
  -> PlanBillingScheme' -- ^ 'planBillingScheme'
  -> GHC.Types.Int -- ^ 'planCreated'
  -> Data.Text.Internal.Text -- ^ 'planCurrency'
  -> Data.Text.Internal.Text -- ^ 'planId'
  -> PlanInterval' -- ^ 'planInterval'
  -> GHC.Types.Int -- ^ 'planIntervalCount'
  -> GHC.Types.Bool -- ^ 'planLivemode'
  -> PlanUsageType' -- ^ 'planUsageType'
  -> Plan
mkPlan planActive planBillingScheme planCreated planCurrency planId planInterval planIntervalCount planLivemode planUsageType = Plan{planActive = planActive,
...
data PlanBillingScheme' =
   PlanBillingScheme'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanBillingScheme'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanBillingScheme'EnumPerUnit -- ^ Represents the JSON value @"per_unit"@
  | PlanBillingScheme'EnumTiered -- ^ Represents the JSON value @"tiered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanBillingScheme'
    where {toJSON (PlanBillingScheme'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanBillingScheme'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "per_unit" -> PlanBillingScheme'EnumPerUnit
...
data PlanInterval' =
   PlanInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | PlanInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | PlanInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | PlanInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanInterval'
    where {toJSON (PlanInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> PlanInterval'EnumDay
...
data PlanProduct'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanProduct'NonNullableVariants
    where {toJSON (PlanProduct'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data PlanTiersMode'NonNullable =
   PlanTiersMode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanTiersMode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanTiersMode'NonNullableEnumGraduated -- ^ Represents the JSON value @"graduated"@
  | PlanTiersMode'NonNullableEnumVolume -- ^ Represents the JSON value @"volume"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanTiersMode'NonNullable
    where {toJSON (PlanTiersMode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanTiersMode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "graduated" -> PlanTiersMode'NonNullableEnumGraduated
...
data PlanTransformUsage'NonNullable = PlanTransformUsage'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanTransformUsage'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanTransformUsage'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PlanTransformUsage'NonNullable" (\obj -> (GHC.Base.pure PlanTransformUsage'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "divide_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "round"))}
...
mkPlanTransformUsage'NonNullable = PlanTransformUsage'NonNullable{planTransformUsage'NonNullableDivideBy = GHC.Maybe.Nothing,
...
data PlanTransformUsage'NonNullableRound' =
   PlanTransformUsage'NonNullableRound'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanTransformUsage'NonNullableRound'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanTransformUsage'NonNullableRound'EnumDown -- ^ Represents the JSON value @"down"@
  | PlanTransformUsage'NonNullableRound'EnumUp -- ^ Represents the JSON value @"up"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanTransformUsage'NonNullableRound'
    where {toJSON (PlanTransformUsage'NonNullableRound'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanTransformUsage'NonNullableRound'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "down" -> PlanTransformUsage'NonNullableRound'EnumDown
...
data PlanUsageType' =
   PlanUsageType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PlanUsageType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PlanUsageType'EnumLicensed -- ^ Represents the JSON value @"licensed"@
  | PlanUsageType'EnumMetered -- ^ Represents the JSON value @"metered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PlanUsageType'
    where {toJSON (PlanUsageType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PlanUsageType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "licensed" -> PlanUsageType'EnumLicensed
