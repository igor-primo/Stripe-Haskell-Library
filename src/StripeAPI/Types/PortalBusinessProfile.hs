...
data PortalBusinessProfile = PortalBusinessProfile {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalBusinessProfile
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalBusinessProfile
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalBusinessProfile" (\obj -> ((GHC.Base.pure PortalBusinessProfile GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "headline")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "privacy_policy_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "terms_of_service_url"))}
-- | Create a new 'PortalBusinessProfile' with all required fields.
mkPortalBusinessProfile :: PortalBusinessProfile
mkPortalBusinessProfile = PortalBusinessProfile{portalBusinessProfileHeadline = GHC.Maybe.Nothing,
