...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFeatures
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFeatures" (\obj -> ((((GHC.Base.pure PortalFeatures GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer_update")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "invoice_history")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "payment_method_update")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription_cancel")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription_update"))}
...
mkPortalFeatures :: PortalCustomerUpdate -- ^ 'portalFeaturesCustomerUpdate'
  ...
  -> PortalFeatures
mkPortalFeatures portalFeaturesCustomerUpdate portalFeaturesInvoiceHistory portalFeaturesPaymentMethodUpdate portalFeaturesSubscriptionCancel portalFeaturesSubscriptionUpdate = PortalFeatures{portalFeaturesCustomerUpdate = portalFeaturesCustomerUpdate,
