...
data PortalFlowsCouponOffer = PortalFlowsCouponOffer {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsCouponOffer
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["coupon" Data.Aeson.Types.ToJSON..= portalFlowsCouponOfferCoupon obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsCouponOffer
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFlowsCouponOffer" (\obj -> GHC.Base.pure PortalFlowsCouponOffer GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "coupon"))}
-- | Create a new 'PortalFlowsCouponOffer' with all required fields.
mkPortalFlowsCouponOffer :: Data.Text.Internal.Text -- ^ 'portalFlowsCouponOfferCoupon'
