...
data PortalFlowsFlowSubscriptionCancel = PortalFlowsFlowSubscriptionCancel {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsFlowSubscriptionCancel
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsFlowSubscriptionCancel
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFlowsFlowSubscriptionCancel" (\obj -> (GHC.Base.pure PortalFlowsFlowSubscriptionCancel GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "retention")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "subscription"))}
-- | Create a new 'PortalFlowsFlowSubscriptionCancel' with all required fields.
mkPortalFlowsFlowSubscriptionCancel :: Data.Text.Internal.Text -- ^ 'portalFlowsFlowSubscriptionCancelSubscription'
  -> PortalFlowsFlowSubscriptionCancel
mkPortalFlowsFlowSubscriptionCancel portalFlowsFlowSubscriptionCancelSubscription = PortalFlowsFlowSubscriptionCancel{portalFlowsFlowSubscriptionCancelRetention = GHC.Maybe.Nothing,
...
data PortalFlowsFlowSubscriptionCancelRetention'NonNullable = PortalFlowsFlowSubscriptionCancelRetention'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon_offer" Data.Aeson.Types.ToJSON..=)) (portalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (portalFlowsFlowSubscriptionCancelRetention'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon_offer" Data.Aeson.Types.ToJSON..=)) (portalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (portalFlowsFlowSubscriptionCancelRetention'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFlowsFlowSubscriptionCancelRetention'NonNullable" (\obj -> (GHC.Base.pure PortalFlowsFlowSubscriptionCancelRetention'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon_offer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkPortalFlowsFlowSubscriptionCancelRetention'NonNullable = PortalFlowsFlowSubscriptionCancelRetention'NonNullable{portalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer = GHC.Maybe.Nothing,
...
data PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable = PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("coupon" Data.Aeson.Types.ToJSON..=)) (portalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullableCoupon obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable" (\obj -> GHC.Base.pure PortalFlowsFlowSubscriptionCancelRetention'NonNullableCouponOffer'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon"))}
...
data PortalFlowsFlowSubscriptionCancelRetention'NonNullableType' =
   PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'EnumCouponOffer -- ^ Represents the JSON value @"coupon_offer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'
    where {toJSON (PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "coupon_offer" -> PortalFlowsFlowSubscriptionCancelRetention'NonNullableType'EnumCouponOffer
