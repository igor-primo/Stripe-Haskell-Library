...
data PortalFlowsSubscriptionUpdateConfirmDiscount = PortalFlowsSubscriptionUpdateConfirmDiscount {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalFlowsSubscriptionUpdateConfirmDiscount
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalFlowsSubscriptionUpdateConfirmDiscount
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalFlowsSubscriptionUpdateConfirmDiscount" (\obj -> (GHC.Base.pure PortalFlowsSubscriptionUpdateConfirmDiscount GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "coupon")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "promotion_code"))}
...
mkPortalFlowsSubscriptionUpdateConfirmDiscount = PortalFlowsSubscriptionUpdateConfirmDiscount{portalFlowsSubscriptionUpdateConfirmDiscountCoupon = GHC.Maybe.Nothing,
