...
data PortalLoginPage = PortalLoginPage {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalLoginPage
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= portalLoginPageEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("url" Data.Aeson.Types.ToJSON..=)) (portalLoginPageUrl obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalLoginPage
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalLoginPage" (\obj -> (GHC.Base.pure PortalLoginPage GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "url"))}
-- | Create a new 'PortalLoginPage' with all required fields.
mkPortalLoginPage :: GHC.Types.Bool -- ^ 'portalLoginPageEnabled'
  -> PortalLoginPage
mkPortalLoginPage portalLoginPageEnabled = PortalLoginPage{portalLoginPageEnabled = portalLoginPageEnabled,
