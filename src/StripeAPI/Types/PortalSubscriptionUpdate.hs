...
instance Data.Aeson.Types.FromJSON.FromJSON PortalSubscriptionUpdate
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalSubscriptionUpdate" (\obj -> ((((GHC.Base.pure PortalSubscriptionUpdate GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "default_allowed_updates")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "products")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "proration_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "schedule_at_period_end"))}
...
mkPortalSubscriptionUpdate :: [PortalSubscriptionUpdateDefaultAllowedUpdates'] -- ^ 'portalSubscriptionUpdateDefaultAllowedUpdates'
  ...
  -> PortalSubscriptionUpdateProrationBehavior' -- ^ 'portalSubscriptionUpdateProrationBehavior'
  -> PortalResourceScheduleUpdateAtPeriodEnd -- ^ 'portalSubscriptionUpdateScheduleAtPeriodEnd'
  -> PortalSubscriptionUpdate
mkPortalSubscriptionUpdate portalSubscriptionUpdateDefaultAllowedUpdates portalSubscriptionUpdateEnabled portalSubscriptionUpdateProrationBehavior portalSubscriptionUpdateScheduleAtPeriodEnd = PortalSubscriptionUpdate{portalSubscriptionUpdateDefaultAllowedUpdates = portalSubscriptionUpdateDefaultAllowedUpdates,
