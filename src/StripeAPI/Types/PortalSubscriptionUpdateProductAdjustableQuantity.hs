...
data PortalSubscriptionUpdateProductAdjustableQuantity = PortalSubscriptionUpdateProductAdjustableQuantity {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PortalSubscriptionUpdateProductAdjustableQuantity
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["enabled" Data.Aeson.Types.ToJSON..= portalSubscriptionUpdateProductAdjustableQuantityEnabled obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("maximum" Data.Aeson.Types.ToJSON..=)) (portalSubscriptionUpdateProductAdjustableQuantityMaximum obj) : ["minimum" Data.Aeson.Types.ToJSON..= portalSubscriptionUpdateProductAdjustableQuantityMinimum obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON PortalSubscriptionUpdateProductAdjustableQuantity
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PortalSubscriptionUpdateProductAdjustableQuantity" (\obj -> ((GHC.Base.pure PortalSubscriptionUpdateProductAdjustableQuantity GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "minimum"))}
-- | Create a new 'PortalSubscriptionUpdateProductAdjustableQuantity' with all required fields.
mkPortalSubscriptionUpdateProductAdjustableQuantity :: GHC.Types.Bool -- ^ 'portalSubscriptionUpdateProductAdjustableQuantityEnabled'
  -> GHC.Types.Int -- ^ 'portalSubscriptionUpdateProductAdjustableQuantityMinimum'
  -> PortalSubscriptionUpdateProductAdjustableQuantity
mkPortalSubscriptionUpdateProductAdjustableQuantity portalSubscriptionUpdateProductAdjustableQuantityEnabled portalSubscriptionUpdateProductAdjustableQuantityMinimum = PortalSubscriptionUpdateProductAdjustableQuantity{portalSubscriptionUpdateProductAdjustableQuantityEnabled = portalSubscriptionUpdateProductAdjustableQuantityEnabled,
