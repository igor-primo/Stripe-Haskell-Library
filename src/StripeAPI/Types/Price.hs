...
mkPrice :: GHC.Types.Bool -- ^ 'priceActive'
  ...
  -> PriceProduct'Variants -- ^ 'priceProduct'
  -> PriceType' -- ^ 'priceType'
  -> Price
mkPrice priceActive priceBillingScheme priceCreated priceCurrency priceId priceLivemode priceMetadata priceProduct priceType = Price{priceActive = priceActive,
                                                                                                                                     priceBillingScheme = priceBillingScheme,
...
data PriceBillingScheme' =
   PriceBillingScheme'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceBillingScheme'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceBillingScheme'EnumPerUnit -- ^ Represents the JSON value @"per_unit"@
  | PriceBillingScheme'EnumTiered -- ^ Represents the JSON value @"tiered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceBillingScheme'
    where {toJSON (PriceBillingScheme'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceBillingScheme'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "per_unit" -> PriceBillingScheme'EnumPerUnit
...
data PriceCustomUnitAmount'NonNullable = PriceCustomUnitAmount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceCustomUnitAmount'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceCustomUnitAmount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PriceCustomUnitAmount'NonNullable" (\obj -> ((GHC.Base.pure PriceCustomUnitAmount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "maximum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preset"))}
...
mkPriceCustomUnitAmount'NonNullable = PriceCustomUnitAmount'NonNullable{priceCustomUnitAmount'NonNullableMaximum = GHC.Maybe.Nothing,
...
data PriceProduct'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceProduct'Variants
    where {toJSON (PriceProduct'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceProduct'Variants
    where {parseJSON val = case (PriceProduct'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PriceProduct'Product Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((PriceProduct'DeletedProduct Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
...
data PriceRecurring'NonNullable = PriceRecurring'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceRecurring'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableMeter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableUsageType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableMeter obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_type" Data.Aeson.Types.ToJSON..=)) (priceRecurring'NonNullableUsageType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PriceRecurring'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PriceRecurring'NonNullable" (\obj -> (((GHC.Base.pure PriceRecurring'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "meter")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_type"))}
-- | Create a new 'PriceRecurring'NonNullable' with all required fields.
mkPriceRecurring'NonNullable :: PriceRecurring'NonNullable
mkPriceRecurring'NonNullable = PriceRecurring'NonNullable{priceRecurring'NonNullableInterval = GHC.Maybe.Nothing,
...
data PriceRecurring'NonNullableInterval' =
   PriceRecurring'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceRecurring'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceRecurring'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | PriceRecurring'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | PriceRecurring'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | PriceRecurring'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceRecurring'NonNullableInterval'
    where {toJSON (PriceRecurring'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceRecurring'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> PriceRecurring'NonNullableInterval'EnumDay
...
data PriceRecurring'NonNullableUsageType' =
   PriceRecurring'NonNullableUsageType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceRecurring'NonNullableUsageType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceRecurring'NonNullableUsageType'EnumLicensed -- ^ Represents the JSON value @"licensed"@
  | PriceRecurring'NonNullableUsageType'EnumMetered -- ^ Represents the JSON value @"metered"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceRecurring'NonNullableUsageType'
    where {toJSON (PriceRecurring'NonNullableUsageType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceRecurring'NonNullableUsageType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "licensed" -> PriceRecurring'NonNullableUsageType'EnumLicensed
...
data PriceTaxBehavior'NonNullable =
   PriceTaxBehavior'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceTaxBehavior'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceTaxBehavior'NonNullableEnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | PriceTaxBehavior'NonNullableEnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | PriceTaxBehavior'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceTaxBehavior'NonNullable
    where {toJSON (PriceTaxBehavior'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceTaxBehavior'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> PriceTaxBehavior'NonNullableEnumExclusive
...
data PriceTiersMode'NonNullable =
   PriceTiersMode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceTiersMode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceTiersMode'NonNullableEnumGraduated -- ^ Represents the JSON value @"graduated"@
  | PriceTiersMode'NonNullableEnumVolume -- ^ Represents the JSON value @"volume"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceTiersMode'NonNullable
    where {toJSON (PriceTiersMode'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceTiersMode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "graduated" -> PriceTiersMode'NonNullableEnumGraduated
...
data PriceTransformQuantity'NonNullable = PriceTransformQuantity'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceTransformQuantity'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("divide_by" Data.Aeson.Types.ToJSON..=)) (priceTransformQuantity'NonNullableDivideBy obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("round" Data.Aeson.Types.ToJSON..=)) (priceTransformQuantity'NonNullableRound obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("divide_by" Data.Aeson.Types.ToJSON..=)) (priceTransformQuantity'NonNullableDivideBy obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("round" Data.Aeson.Types.ToJSON..=)) (priceTransformQuantity'NonNullableRound obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON PriceTransformQuantity'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PriceTransformQuantity'NonNullable" (\obj -> (GHC.Base.pure PriceTransformQuantity'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "divide_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "round"))}
...
mkPriceTransformQuantity'NonNullable = PriceTransformQuantity'NonNullable{priceTransformQuantity'NonNullableDivideBy = GHC.Maybe.Nothing,
...
data PriceTransformQuantity'NonNullableRound' =
   PriceTransformQuantity'NonNullableRound'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceTransformQuantity'NonNullableRound'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceTransformQuantity'NonNullableRound'EnumDown -- ^ Represents the JSON value @"down"@
  | PriceTransformQuantity'NonNullableRound'EnumUp -- ^ Represents the JSON value @"up"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceTransformQuantity'NonNullableRound'
    where {toJSON (PriceTransformQuantity'NonNullableRound'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceTransformQuantity'NonNullableRound'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "down" -> PriceTransformQuantity'NonNullableRound'EnumDown
...
data PriceType' =
   PriceType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | PriceType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | PriceType'EnumOneTime -- ^ Represents the JSON value @"one_time"@
  | PriceType'EnumRecurring -- ^ Represents the JSON value @"recurring"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PriceType'
    where {toJSON (PriceType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON PriceType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "one_time" -> PriceType'EnumOneTime
