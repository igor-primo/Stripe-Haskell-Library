...
mkProduct :: GHC.Types.Bool -- ^ 'productActive'
  ...
  -> [ProductMarketingFeature] -- ^ 'productMarketingFeatures'
  -> Data.Aeson.Types.Internal.Object -- ^ 'productMetadata'
  -> Data.Text.Internal.Text -- ^ 'productName'
  -> GHC.Types.Int -- ^ 'productUpdated'
  -> Product
mkProduct productActive productCreated productId productImages productLivemode productMarketingFeatures productMetadata productName productUpdated = Product{productActive = productActive,
...
instance Data.Aeson.Types.ToJSON.ToJSON ProductDefaultPrice'NonNullableVariants
    where {toJSON (ProductDefaultPrice'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (ProductDefaultPrice'NonNullablePrice a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON ProductDefaultPrice'NonNullableVariants
    where {parseJSON val = case (ProductDefaultPrice'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ProductDefaultPrice'NonNullablePrice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data ProductPackageDimensions'NonNullable = ProductPackageDimensions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ProductPackageDimensions'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON ProductPackageDimensions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "ProductPackageDimensions'NonNullable" (\obj -> (((GHC.Base.pure ProductPackageDimensions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "height")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "length")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "weight")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "width"))}
...
mkProductPackageDimensions'NonNullable = ProductPackageDimensions'NonNullable{productPackageDimensions'NonNullableHeight = GHC.Maybe.Nothing,
...
data ProductTaxCode'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ProductTaxCode'NonNullableVariants
    where {toJSON (ProductTaxCode'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (ProductTaxCode'NonNullableTaxCode a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON ProductTaxCode'NonNullableVariants
    where {parseJSON val = case (ProductTaxCode'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((ProductTaxCode'NonNullableTaxCode Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
