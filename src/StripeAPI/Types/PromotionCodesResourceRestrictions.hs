...
data PromotionCodesResourceRestrictions = PromotionCodesResourceRestrictions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON PromotionCodesResourceRestrictions
...
instance Data.Aeson.Types.FromJSON.FromJSON PromotionCodesResourceRestrictions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "PromotionCodesResourceRestrictions" (\obj -> (((GHC.Base.pure PromotionCodesResourceRestrictions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "first_time_transaction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum_amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "minimum_amount_currency"))}
-- | Create a new 'PromotionCodesResourceRestrictions' with all required fields.
mkPromotionCodesResourceRestrictions :: GHC.Types.Bool -- ^ 'promotionCodesResourceRestrictionsFirstTimeTransaction'
  -> PromotionCodesResourceRestrictions
mkPromotionCodesResourceRestrictions promotionCodesResourceRestrictionsFirstTimeTransaction = PromotionCodesResourceRestrictions{promotionCodesResourceRestrictionsCurrencyOptions = GHC.Maybe.Nothing,
