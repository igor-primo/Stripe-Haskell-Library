...
import {-# SOURCE #-} StripeAPI.Types.QuotesResourceSubscriptionDataSubscriptionData
...
data Quote = Quote {
  ...
  -- | invoice_settings: 
  , quoteInvoiceSettings :: InvoiceSettingQuoteSetting
  ...
  -- | subscription_data: 
  , quoteSubscriptionData :: QuotesResourceSubscriptionDataSubscriptionData
...
mkQuote :: GHC.Types.Int -- ^ 'quoteAmountSubtotal'
  ...
  -> InvoiceSettingQuoteSetting -- ^ 'quoteInvoiceSettings'
  ...
  -> QuotesResourceSubscriptionDataSubscriptionData -- ^ 'quoteSubscriptionData'
  -> QuotesResourceTotalDetails -- ^ 'quoteTotalDetails'
  -> Quote
mkQuote quoteAmountSubtotal quoteAmountTotal quoteAutomaticTax quoteCollectionMethod quoteComputed quoteCreated quoteDiscounts quoteExpiresAt quoteId quoteInvoiceSettings quoteLivemode quoteMetadata quoteStatus quoteStatusTransitions quoteSubscriptionData quoteTotalDetails = Quote{quoteAmountSubtotal = quoteAmountSubtotal,
