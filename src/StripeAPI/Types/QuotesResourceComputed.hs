...
data QuotesResourceComputed = QuotesResourceComputed {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceComputed
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("recurring" Data.Aeson.Types.ToJSON..=)) (quotesResourceComputedRecurring obj) : ["upfront" Data.Aeson.Types.ToJSON..= quotesResourceComputedUpfront obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceComputed
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceComputed" (\obj -> (GHC.Base.pure QuotesResourceComputed GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "recurring")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "upfront"))}
-- | Create a new 'QuotesResourceComputed' with all required fields.
mkQuotesResourceComputed :: QuotesResourceUpfront -- ^ 'quotesResourceComputedUpfront'
  -> QuotesResourceComputed
mkQuotesResourceComputed quotesResourceComputedUpfront = QuotesResourceComputed{quotesResourceComputedRecurring = GHC.Maybe.Nothing,
...
data QuotesResourceComputedRecurring'NonNullable = QuotesResourceComputedRecurring'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceComputedRecurring'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceComputedRecurring'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceComputedRecurring'NonNullable" (\obj -> ((((GHC.Base.pure QuotesResourceComputedRecurring'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "total_details"))}
...
mkQuotesResourceComputedRecurring'NonNullable = QuotesResourceComputedRecurring'NonNullable{quotesResourceComputedRecurring'NonNullableAmountSubtotal = GHC.Maybe.Nothing,
...
data QuotesResourceComputedRecurring'NonNullableInterval' =
   QuotesResourceComputedRecurring'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | QuotesResourceComputedRecurring'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | QuotesResourceComputedRecurring'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | QuotesResourceComputedRecurring'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | QuotesResourceComputedRecurring'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | QuotesResourceComputedRecurring'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceComputedRecurring'NonNullableInterval'
    where {toJSON (QuotesResourceComputedRecurring'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceComputedRecurring'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> QuotesResourceComputedRecurring'NonNullableInterval'EnumDay
