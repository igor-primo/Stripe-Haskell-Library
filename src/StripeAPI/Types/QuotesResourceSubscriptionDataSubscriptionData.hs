...
import {-# SOURCE #-} StripeAPI.Types.QuotesResourceSubscriptionDataBillingMode
...
data QuotesResourceSubscriptionDataSubscriptionData = QuotesResourceSubscriptionDataSubscriptionData {
  -- | billing_mode: The billing mode of the quote.
  quotesResourceSubscriptionDataSubscriptionDataBillingMode :: QuotesResourceSubscriptionDataBillingMode
...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceSubscriptionDataSubscriptionData
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["billing_mode" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataSubscriptionDataBillingMode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("effective_date" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataEffectiveDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("trial_period_days" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataTrialPeriodDays obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["billing_mode" Data.Aeson.Types.ToJSON..= quotesResourceSubscriptionDataSubscriptionDataBillingMode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("effective_date" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataEffectiveDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("metadata" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataMetadata obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("trial_period_days" Data.Aeson.Types.ToJSON..=)) (quotesResourceSubscriptionDataSubscriptionDataTrialPeriodDays obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceSubscriptionDataSubscriptionData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceSubscriptionDataSubscriptionData" (\obj -> ((((GHC.Base.pure QuotesResourceSubscriptionDataSubscriptionData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "billing_mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "effective_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "trial_period_days"))}
-- | Create a new 'QuotesResourceSubscriptionDataSubscriptionData' with all required fields.
mkQuotesResourceSubscriptionDataSubscriptionData :: QuotesResourceSubscriptionDataBillingMode -- ^ 'quotesResourceSubscriptionDataSubscriptionDataBillingMode'
  -> QuotesResourceSubscriptionDataSubscriptionData
mkQuotesResourceSubscriptionDataSubscriptionData quotesResourceSubscriptionDataSubscriptionDataBillingMode = QuotesResourceSubscriptionDataSubscriptionData{quotesResourceSubscriptionDataSubscriptionDataBillingMode = quotesResourceSubscriptionDataSubscriptionDataBillingMode,
