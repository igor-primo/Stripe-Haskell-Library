...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceTotalDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceTotalDetails" (\obj -> (((GHC.Base.pure QuotesResourceTotalDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_discount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_shipping")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "breakdown"))}
-- | Create a new 'QuotesResourceTotalDetails' with all required fields.
mkQuotesResourceTotalDetails :: GHC.Types.Int -- ^ 'quotesResourceTotalDetailsAmountDiscount'
  -> GHC.Types.Int -- ^ 'quotesResourceTotalDetailsAmountTax'
  -> QuotesResourceTotalDetails
mkQuotesResourceTotalDetails quotesResourceTotalDetailsAmountDiscount quotesResourceTotalDetailsAmountTax = QuotesResourceTotalDetails{quotesResourceTotalDetailsAmountDiscount = quotesResourceTotalDetailsAmountDiscount,
