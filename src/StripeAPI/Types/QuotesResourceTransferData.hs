...
data QuotesResourceTransferData = QuotesResourceTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceTransferData
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceTransferData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceTransferData" (\obj -> ((GHC.Base.pure QuotesResourceTransferData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_percent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))}
-- | Create a new 'QuotesResourceTransferData' with all required fields.
mkQuotesResourceTransferData :: QuotesResourceTransferDataDestination'Variants -- ^ 'quotesResourceTransferDataDestination'
  -> QuotesResourceTransferData
mkQuotesResourceTransferData quotesResourceTransferDataDestination = QuotesResourceTransferData{quotesResourceTransferDataAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceTransferDataDestination'Variants
    where {toJSON (QuotesResourceTransferDataDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (QuotesResourceTransferDataDestination'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceTransferDataDestination'Variants
    where {parseJSON val = case (QuotesResourceTransferDataDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((QuotesResourceTransferDataDestination'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
