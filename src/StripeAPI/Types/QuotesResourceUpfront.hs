...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceUpfront
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceUpfront" (\obj -> (((GHC.Base.pure QuotesResourceUpfront GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_subtotal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "total_details"))}
-- | Create a new 'QuotesResourceUpfront' with all required fields.
mkQuotesResourceUpfront :: GHC.Types.Int -- ^ 'quotesResourceUpfrontAmountSubtotal'
  -> GHC.Types.Int -- ^ 'quotesResourceUpfrontAmountTotal'
  -> QuotesResourceTotalDetails -- ^ 'quotesResourceUpfrontTotalDetails'
  -> QuotesResourceUpfront
mkQuotesResourceUpfront quotesResourceUpfrontAmountSubtotal quotesResourceUpfrontAmountTotal quotesResourceUpfrontTotalDetails = QuotesResourceUpfront{quotesResourceUpfrontAmountSubtotal = quotesResourceUpfrontAmountSubtotal,
...
data QuotesResourceUpfrontLineItems' = QuotesResourceUpfrontLineItems' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON QuotesResourceUpfrontLineItems'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Data obj] : ["has_more" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'HasMore obj] : ["url" Data.Aeson.Types.ToJSON..= quotesResourceUpfrontLineItems'Url obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON QuotesResourceUpfrontLineItems'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "QuotesResourceUpfrontLineItems'" (\obj -> ((GHC.Base.pure QuotesResourceUpfrontLineItems' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'QuotesResourceUpfrontLineItems'' with all required fields.
mkQuotesResourceUpfrontLineItems' :: [Item] -- ^ 'quotesResourceUpfrontLineItems'Data'
  -> GHC.Types.Bool -- ^ 'quotesResourceUpfrontLineItems'HasMore'
  -> Data.Text.Internal.Text -- ^ 'quotesResourceUpfrontLineItems'Url'
  -> QuotesResourceUpfrontLineItems'
mkQuotesResourceUpfrontLineItems' quotesResourceUpfrontLineItems'Data quotesResourceUpfrontLineItems'HasMore quotesResourceUpfrontLineItems'Url = QuotesResourceUpfrontLineItems'{quotesResourceUpfrontLineItems'Data = quotesResourceUpfrontLineItems'Data,
