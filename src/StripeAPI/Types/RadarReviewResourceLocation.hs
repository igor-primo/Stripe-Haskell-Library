...
data RadarReviewResourceLocation = RadarReviewResourceLocation {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON RadarReviewResourceLocation
...
mkRadarReviewResourceLocation = RadarReviewResourceLocation{radarReviewResourceLocationCity = GHC.Maybe.Nothing,
