...
instance Data.Aeson.Types.FromJSON.FromJSON Radar'earlyFraudWarning
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Radar'earlyFraudWarning" (\obj -> ((((((GHC.Base.pure Radar'earlyFraudWarning GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "actionable")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "charge")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "fraud_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "payment_intent"))}
-- | Create a new 'Radar'earlyFraudWarning' with all required fields.
mkRadar'earlyFraudWarning :: GHC.Types.Bool -- ^ 'radar'earlyFraudWarningActionable'
  -> Radar'earlyFraudWarningCharge'Variants -- ^ 'radar'earlyFraudWarningCharge'
  -> GHC.Types.Int -- ^ 'radar'earlyFraudWarningCreated'
  -> Data.Text.Internal.Text -- ^ 'radar'earlyFraudWarningFraudType'
  -> Data.Text.Internal.Text -- ^ 'radar'earlyFraudWarningId'
  -> GHC.Types.Bool -- ^ 'radar'earlyFraudWarningLivemode'
  -> Radar'earlyFraudWarning
mkRadar'earlyFraudWarning radar'earlyFraudWarningActionable radar'earlyFraudWarningCharge radar'earlyFraudWarningCreated radar'earlyFraudWarningFraudType radar'earlyFraudWarningId radar'earlyFraudWarningLivemode = Radar'earlyFraudWarning{radar'earlyFraudWarningActionable = radar'earlyFraudWarningActionable,
...
instance Data.Aeson.Types.ToJSON.ToJSON Radar'earlyFraudWarningCharge'Variants
    where {toJSON (Radar'earlyFraudWarningCharge'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Radar'earlyFraudWarningCharge'Charge a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Radar'earlyFraudWarningCharge'Variants
    where {parseJSON val = case (Radar'earlyFraudWarningCharge'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Radar'earlyFraudWarningCharge'Charge Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data Radar'earlyFraudWarningPaymentIntent'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Radar'earlyFraudWarningPaymentIntent'Variants
    where {toJSON (Radar'earlyFraudWarningPaymentIntent'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Radar'earlyFraudWarningPaymentIntent'PaymentIntent a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Radar'earlyFraudWarningPaymentIntent'Variants
    where {parseJSON val = case (Radar'earlyFraudWarningPaymentIntent'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Radar'earlyFraudWarningPaymentIntent'PaymentIntent Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
