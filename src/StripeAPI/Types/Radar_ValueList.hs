...
data Radar'valueListItemType' =
  ...
  | Radar'valueListItemType'EnumSepaDebitFingerprint -- ^ Represents the JSON value @"sepa_debit_fingerprint"@
  | Radar'valueListItemType'EnumString -- ^ Represents the JSON value @"string"@
  | Radar'valueListItemType'EnumUsBankAccountFingerprint -- ^ Represents the JSON value @"us_bank_account_fingerprint"@
