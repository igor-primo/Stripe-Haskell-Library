...
data Radar'valueListItem = Radar'valueListItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Radar'valueListItem
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["created" Data.Aeson.Types.ToJSON..= radar'valueListItemCreated obj] : ["created_by" Data.Aeson.Types.ToJSON..= radar'valueListItemCreatedBy obj] : ["id" Data.Aeson.Types.ToJSON..= radar'valueListItemId obj] : ["livemode" Data.Aeson.Types.ToJSON..= radar'valueListItemLivemode obj] : ["value" Data.Aeson.Types.ToJSON..= radar'valueListItemValue obj] : ["value_list" Data.Aeson.Types.ToJSON..= radar'valueListItemValueList obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "radar.value_list_item"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Radar'valueListItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Radar'valueListItem" (\obj -> (((((GHC.Base.pure Radar'valueListItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created_by")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "value")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "value_list"))}
-- | Create a new 'Radar'valueListItem' with all required fields.
mkRadar'valueListItem :: GHC.Types.Int -- ^ 'radar'valueListItemCreated'
  -> Data.Text.Internal.Text -- ^ 'radar'valueListItemCreatedBy'
  -> Data.Text.Internal.Text -- ^ 'radar'valueListItemId'
  -> GHC.Types.Bool -- ^ 'radar'valueListItemLivemode'
  -> Data.Text.Internal.Text -- ^ 'radar'valueListItemValue'
  -> Data.Text.Internal.Text -- ^ 'radar'valueListItemValueList'
  -> Radar'valueListItem
mkRadar'valueListItem radar'valueListItemCreated radar'valueListItemCreatedBy radar'valueListItemId radar'valueListItemLivemode radar'valueListItemValue radar'valueListItemValueList = Radar'valueListItem{radar'valueListItemCreated = radar'valueListItemCreated,
