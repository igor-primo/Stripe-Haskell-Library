...
instance Data.Aeson.Types.ToJSON.ToJSON Recurring
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["interval" Data.Aeson.Types.ToJSON..= recurringInterval obj] : ["interval_count" Data.Aeson.Types.ToJSON..= recurringIntervalCount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("meter" Data.Aeson.Types.ToJSON..=)) (recurringMeter obj) : ["usage_type" Data.Aeson.Types.ToJSON..= recurringUsageType obj] : GHC.Base.mempty));
...
mkRecurring :: RecurringInterval' -- ^ 'recurringInterval'
  ...
  -> RecurringUsageType' -- ^ 'recurringUsageType'
  -> Recurring
mkRecurring recurringInterval recurringIntervalCount recurringUsageType = Recurring{recurringInterval = recurringInterval,
