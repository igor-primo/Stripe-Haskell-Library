...
data RefundPendingReason' =
   RefundPendingReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | RefundPendingReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | RefundPendingReason'EnumChargePending -- ^ Represents the JSON value @"charge_pending"@
  | RefundPendingReason'EnumInsufficientFunds -- ^ Represents the JSON value @"insufficient_funds"@
  | RefundPendingReason'EnumProcessing -- ^ Represents the JSON value @"processing"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON RefundPendingReason'
    where {toJSON (RefundPendingReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON RefundPendingReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "charge_pending" -> RefundPendingReason'EnumChargePending
