...
data RefundDestinationDetailsPaypal = RefundDestinationDetailsPaypal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON RefundDestinationDetailsPaypal
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network_decline_code" Data.Aeson.Types.ToJSON..=)) (refundDestinationDetailsPaypalNetworkDeclineCode obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON RefundDestinationDetailsPaypal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "RefundDestinationDetailsPaypal" (\obj -> GHC.Base.pure RefundDestinationDetailsPaypal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network_decline_code"))}
