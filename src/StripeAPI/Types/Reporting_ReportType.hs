...
mkReporting'reportType :: GHC.Types.Int -- ^ 'reporting'reportTypeDataAvailableEnd'
  -> GHC.Types.Int -- ^ 'reporting'reportTypeDataAvailableStart'
  -> Data.Text.Internal.Text -- ^ 'reporting'reportTypeId'
  -> GHC.Types.Bool -- ^ 'reporting'reportTypeLivemode'
  -> Data.Text.Internal.Text -- ^ 'reporting'reportTypeName'
  -> GHC.Types.Int -- ^ 'reporting'reportTypeUpdated'
  -> GHC.Types.Int -- ^ 'reporting'reportTypeVersion'
  -> Reporting'reportType
mkReporting'reportType reporting'reportTypeDataAvailableEnd reporting'reportTypeDataAvailableStart reporting'reportTypeId reporting'reportTypeLivemode reporting'reportTypeName reporting'reportTypeUpdated reporting'reportTypeVersion = Reporting'reportType{reporting'reportTypeDataAvailableEnd = reporting'reportTypeDataAvailableEnd,
