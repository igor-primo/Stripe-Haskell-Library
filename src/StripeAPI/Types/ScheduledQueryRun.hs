...
data ScheduledQueryRunFile'NonNullablePurpose' =
  ...
  | ScheduledQueryRunFile'NonNullablePurpose'EnumFinancialAccountStatement -- ^ Represents the JSON value @"financial_account_statement"@
  ...
  | ScheduledQueryRunFile'NonNullablePurpose'EnumIssuingRegulatoryReporting -- ^ Represents the JSON value @"issuing_regulatory_reporting"@
  ...
  | ScheduledQueryRunFile'NonNullablePurpose'EnumTerminalReaderSplashscreen -- ^ Represents the JSON value @"terminal_reader_splashscreen"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ScheduledQueryRunFile'NonNullablePurpose'
    where {toJSON (ScheduledQueryRunFile'NonNullablePurpose'Other val) = val;
           ...
           toJSON (ScheduledQueryRunFile'NonNullablePurpose'EnumFinancialAccountStatement) = "financial_account_statement";
           ...
           toJSON (ScheduledQueryRunFile'NonNullablePurpose'EnumIssuingRegulatoryReporting) = "issuing_regulatory_reporting";
...
instance Data.Aeson.Types.FromJSON.FromJSON ScheduledQueryRunFile'NonNullablePurpose'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_requirement" -> ScheduledQueryRunFile'NonNullablePurpose'EnumAccountRequirement
                                             ...
                                             | val GHC.Classes.== "financial_account_statement" -> ScheduledQueryRunFile'NonNullablePurpose'EnumFinancialAccountStatement
                                             ...
                                             | val GHC.Classes.== "issuing_regulatory_reporting" -> ScheduledQueryRunFile'NonNullablePurpose'EnumIssuingRegulatoryReporting
