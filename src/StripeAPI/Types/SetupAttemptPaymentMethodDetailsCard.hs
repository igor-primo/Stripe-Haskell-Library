...
mkSetupAttemptPaymentMethodDetailsCard = SetupAttemptPaymentMethodDetailsCard{setupAttemptPaymentMethodDetailsCardBrand = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsCardChecks'NonNullable = SetupAttemptPaymentMethodDetailsCardChecks'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardChecks'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line1_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableAddressLine1Check obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_postal_code_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableAddressPostalCodeCheck obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cvc_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableCvcCheck obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_line1_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableAddressLine1Check obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address_postal_code_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableAddressPostalCodeCheck obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cvc_check" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardChecks'NonNullableCvcCheck obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardChecks'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsCardChecks'NonNullable" (\obj -> ((GHC.Base.pure SetupAttemptPaymentMethodDetailsCardChecks'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_line1_check")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address_postal_code_check")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cvc_check"))}
...
mkSetupAttemptPaymentMethodDetailsCardChecks'NonNullable = SetupAttemptPaymentMethodDetailsCardChecks'NonNullable{setupAttemptPaymentMethodDetailsCardChecks'NonNullableAddressLine1Check = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullable =
   SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum01 -- ^ Represents the JSON value @"01"@
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum02 -- ^ Represents the JSON value @"02"@
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum05 -- ^ Represents the JSON value @"05"@
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum06 -- ^ Represents the JSON value @"06"@
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum07 -- ^ Represents the JSON value @"07"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullable
    where {toJSON (SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "01" -> SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableElectronicCommerceIndicator'NonNullableEnum01
...
data SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableResult'NonNullable =
  ...
  | SetupAttemptPaymentMethodDetailsCardThreeDSecure'NonNullableResult'NonNullableEnumExempted -- ^ Represents the JSON value @"exempted"@
...
data SetupAttemptPaymentMethodDetailsCardWallet'NonNullable = SetupAttemptPaymentMethodDetailsCardWallet'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardWallet'NonNullable
...
mkSetupAttemptPaymentMethodDetailsCardWallet'NonNullable = SetupAttemptPaymentMethodDetailsCardWallet'NonNullable{setupAttemptPaymentMethodDetailsCardWallet'NonNullableApplePay = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType' =
   SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'EnumLink -- ^ Represents the JSON value @"link"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'
    where {toJSON (SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "apple_pay" -> SetupAttemptPaymentMethodDetailsCardWallet'NonNullableType'EnumApplePay
