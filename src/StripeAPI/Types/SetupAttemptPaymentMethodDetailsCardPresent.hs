...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardPresent
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsCardPresent" (\obj -> (GHC.Base.pure SetupAttemptPaymentMethodDetailsCardPresent GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "generated_card")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "offline"))}
...
data SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable = SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("stored_at" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableStoredAt obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (setupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable" (\obj -> (GHC.Base.pure SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "stored_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
...
mkSetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable = SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullable{setupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableStoredAt = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable =
   SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableEnumDeferred -- ^ Represents the JSON value @"deferred"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable
    where {toJSON (SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "deferred" -> SetupAttemptPaymentMethodDetailsCardPresentOffline'NonNullableType'NonNullableEnumDeferred
