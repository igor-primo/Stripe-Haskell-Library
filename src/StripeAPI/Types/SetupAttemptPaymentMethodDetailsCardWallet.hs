...
data SetupAttemptPaymentMethodDetailsCardWallet = SetupAttemptPaymentMethodDetailsCardWallet {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardWallet
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardWallet
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsCardWallet" (\obj -> ((GHC.Base.pure SetupAttemptPaymentMethodDetailsCardWallet GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "apple_pay")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "google_pay")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'SetupAttemptPaymentMethodDetailsCardWallet' with all required fields.
mkSetupAttemptPaymentMethodDetailsCardWallet :: SetupAttemptPaymentMethodDetailsCardWalletType' -- ^ 'setupAttemptPaymentMethodDetailsCardWalletType'
  -> SetupAttemptPaymentMethodDetailsCardWallet
mkSetupAttemptPaymentMethodDetailsCardWallet setupAttemptPaymentMethodDetailsCardWalletType = SetupAttemptPaymentMethodDetailsCardWallet{setupAttemptPaymentMethodDetailsCardWalletApplePay = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsCardWalletType' =
   SetupAttemptPaymentMethodDetailsCardWalletType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsCardWalletType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsCardWalletType'EnumApplePay -- ^ Represents the JSON value @"apple_pay"@
  | SetupAttemptPaymentMethodDetailsCardWalletType'EnumGooglePay -- ^ Represents the JSON value @"google_pay"@
  | SetupAttemptPaymentMethodDetailsCardWalletType'EnumLink -- ^ Represents the JSON value @"link"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsCardWalletType'
    where {toJSON (SetupAttemptPaymentMethodDetailsCardWalletType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsCardWalletType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "apple_pay" -> SetupAttemptPaymentMethodDetailsCardWalletType'EnumApplePay
