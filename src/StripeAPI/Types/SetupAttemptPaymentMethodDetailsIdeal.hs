...
data SetupAttemptPaymentMethodDetailsIdeal = SetupAttemptPaymentMethodDetailsIdeal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdeal
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsIdeal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsIdeal" (\obj -> (((((GHC.Base.pure SetupAttemptPaymentMethodDetailsIdeal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bic")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "generated_sepa_debit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "generated_sepa_debit_mandate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "iban_last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name"))}
...
mkSetupAttemptPaymentMethodDetailsIdeal = SetupAttemptPaymentMethodDetailsIdeal{setupAttemptPaymentMethodDetailsIdealBank = GHC.Maybe.Nothing,
...
data SetupAttemptPaymentMethodDetailsIdealBank'NonNullable =
   SetupAttemptPaymentMethodDetailsIdealBank'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumAbnAmro -- ^ Represents the JSON value @"abn_amro"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumAsnBank -- ^ Represents the JSON value @"asn_bank"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumBunq -- ^ Represents the JSON value @"bunq"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumBuut -- ^ Represents the JSON value @"buut"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumHandelsbanken -- ^ Represents the JSON value @"handelsbanken"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumIng -- ^ Represents the JSON value @"ing"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumKnab -- ^ Represents the JSON value @"knab"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumMoneyou -- ^ Represents the JSON value @"moneyou"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumN26 -- ^ Represents the JSON value @"n26"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumNn -- ^ Represents the JSON value @"nn"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumRabobank -- ^ Represents the JSON value @"rabobank"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumRegiobank -- ^ Represents the JSON value @"regiobank"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumRevolut -- ^ Represents the JSON value @"revolut"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumSnsBank -- ^ Represents the JSON value @"sns_bank"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumTriodosBank -- ^ Represents the JSON value @"triodos_bank"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumVanLanschot -- ^ Represents the JSON value @"van_lanschot"@
  | SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumYoursafe -- ^ Represents the JSON value @"yoursafe"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealBank'NonNullable
    where {toJSON (SetupAttemptPaymentMethodDetailsIdealBank'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsIdealBank'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "abn_amro" -> SetupAttemptPaymentMethodDetailsIdealBank'NonNullableEnumAbnAmro
...
data SetupAttemptPaymentMethodDetailsIdealBic'NonNullable =
   SetupAttemptPaymentMethodDetailsIdealBic'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumABNANL2A -- ^ Represents the JSON value @"ABNANL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumASNBNL21 -- ^ Represents the JSON value @"ASNBNL21"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBITSNL2A -- ^ Represents the JSON value @"BITSNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBUNQNL2A -- ^ Represents the JSON value @"BUNQNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumBUUTNL2A -- ^ Represents the JSON value @"BUUTNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumFVLBNL22 -- ^ Represents the JSON value @"FVLBNL22"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumHANDNL2A -- ^ Represents the JSON value @"HANDNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumINGBNL2A -- ^ Represents the JSON value @"INGBNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumKNABNL2H -- ^ Represents the JSON value @"KNABNL2H"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumMOYONL21 -- ^ Represents the JSON value @"MOYONL21"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumNNBANL2G -- ^ Represents the JSON value @"NNBANL2G"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumNTSBDEB1 -- ^ Represents the JSON value @"NTSBDEB1"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumRABONL2U -- ^ Represents the JSON value @"RABONL2U"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumRBRBNL21 -- ^ Represents the JSON value @"RBRBNL21"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumREVOIE23 -- ^ Represents the JSON value @"REVOIE23"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumREVOLT21 -- ^ Represents the JSON value @"REVOLT21"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumSNSBNL2A -- ^ Represents the JSON value @"SNSBNL2A"@
  | SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumTRIONL2U -- ^ Represents the JSON value @"TRIONL2U"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealBic'NonNullable
    where {toJSON (SetupAttemptPaymentMethodDetailsIdealBic'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsIdealBic'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ABNANL2A" -> SetupAttemptPaymentMethodDetailsIdealBic'NonNullableEnumABNANL2A
...
data SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebit'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebit'NonNullableVariants
    where {toJSON (SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebit'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebitMandate'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebitMandate'NonNullableVariants
    where {toJSON (SetupAttemptPaymentMethodDetailsIdealGeneratedSepaDebitMandate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
