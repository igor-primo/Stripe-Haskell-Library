...
data SetupAttemptPaymentMethodDetailsSofort = SetupAttemptPaymentMethodDetailsSofort {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsSofort
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsSofort
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupAttemptPaymentMethodDetailsSofort" (\obj -> (((((((GHC.Base.pure SetupAttemptPaymentMethodDetailsSofort GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bic")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "generated_sepa_debit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "generated_sepa_debit_mandate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "iban_last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_language")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name"))}
...
mkSetupAttemptPaymentMethodDetailsSofort = SetupAttemptPaymentMethodDetailsSofort{setupAttemptPaymentMethodDetailsSofortBankCode = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableVariants
    where {toJSON (SetupAttemptPaymentMethodDetailsSofortGeneratedSepaDebit'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data SetupAttemptPaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableVariants
    where {toJSON (SetupAttemptPaymentMethodDetailsSofortGeneratedSepaDebitMandate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullable =
   SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumDe -- ^ Represents the JSON value @"de"@
  | SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumEn -- ^ Represents the JSON value @"en"@
  | SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumFr -- ^ Represents the JSON value @"fr"@
  | SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumNl -- ^ Represents the JSON value @"nl"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullable
    where {toJSON (SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "de" -> SetupAttemptPaymentMethodDetailsSofortPreferredLanguage'NonNullableEnumDe
