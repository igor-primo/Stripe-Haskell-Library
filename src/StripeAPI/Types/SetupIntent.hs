...
data SetupIntent = SetupIntent {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntent
...
mkSetupIntent :: GHC.Types.Int -- ^ 'setupIntentCreated'
  -> Data.Text.Internal.Text -- ^ 'setupIntentId'
  -> GHC.Types.Bool -- ^ 'setupIntentLivemode'
  -> [Data.Text.Internal.Text] -- ^ 'setupIntentPaymentMethodTypes'
  -> SetupIntentStatus' -- ^ 'setupIntentStatus'
  -> Data.Text.Internal.Text -- ^ 'setupIntentUsage'
  -> SetupIntent
mkSetupIntent setupIntentCreated setupIntentId setupIntentLivemode setupIntentPaymentMethodTypes setupIntentStatus setupIntentUsage = SetupIntent{setupIntentApplication = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentApplication'NonNullableVariants
    where {toJSON (SetupIntentApplication'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentApplication'NonNullableApplication a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentApplication'NonNullableVariants
    where {parseJSON val = case (SetupIntentApplication'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentApplication'NonNullableApplication Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
...
data SetupIntentAutomaticPaymentMethods'NonNullable = SetupIntentAutomaticPaymentMethods'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentAutomaticPaymentMethods'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("allow_redirects" Data.Aeson.Types.ToJSON..=)) (setupIntentAutomaticPaymentMethods'NonNullableAllowRedirects obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (setupIntentAutomaticPaymentMethods'NonNullableEnabled obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("allow_redirects" Data.Aeson.Types.ToJSON..=)) (setupIntentAutomaticPaymentMethods'NonNullableAllowRedirects obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("enabled" Data.Aeson.Types.ToJSON..=)) (setupIntentAutomaticPaymentMethods'NonNullableEnabled obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentAutomaticPaymentMethods'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentAutomaticPaymentMethods'NonNullable" (\obj -> (GHC.Base.pure SetupIntentAutomaticPaymentMethods'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "allow_redirects")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "enabled"))}
...
mkSetupIntentAutomaticPaymentMethods'NonNullable = SetupIntentAutomaticPaymentMethods'NonNullable{setupIntentAutomaticPaymentMethods'NonNullableAllowRedirects = GHC.Maybe.Nothing,
...
data SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects' =
   SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'EnumAlways -- ^ Represents the JSON value @"always"@
  | SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'EnumNever -- ^ Represents the JSON value @"never"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'
    where {toJSON (SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> SetupIntentAutomaticPaymentMethods'NonNullableAllowRedirects'EnumAlways
...
data SetupIntentCancellationReason'NonNullable =
   SetupIntentCancellationReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentCancellationReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentCancellationReason'NonNullableEnumAbandoned -- ^ Represents the JSON value @"abandoned"@
  | SetupIntentCancellationReason'NonNullableEnumDuplicate -- ^ Represents the JSON value @"duplicate"@
  | SetupIntentCancellationReason'NonNullableEnumRequestedByCustomer -- ^ Represents the JSON value @"requested_by_customer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentCancellationReason'NonNullable
    where {toJSON (SetupIntentCancellationReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentCancellationReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "abandoned" -> SetupIntentCancellationReason'NonNullableEnumAbandoned
...
data SetupIntentCustomer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentCustomer'NonNullableVariants
    where {toJSON (SetupIntentCustomer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data SetupIntentFlowDirections'NonNullable =
   SetupIntentFlowDirections'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentFlowDirections'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentFlowDirections'NonNullableEnumInbound -- ^ Represents the JSON value @"inbound"@
  | SetupIntentFlowDirections'NonNullableEnumOutbound -- ^ Represents the JSON value @"outbound"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentFlowDirections'NonNullable
    where {toJSON (SetupIntentFlowDirections'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentFlowDirections'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "inbound" -> SetupIntentFlowDirections'NonNullableEnumInbound
...
data SetupIntentLastSetupError'NonNullable = SetupIntentLastSetupError'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullable
...
mkSetupIntentLastSetupError'NonNullable = SetupIntentLastSetupError'NonNullable{setupIntentLastSetupError'NonNullableAdviceCode = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource' = SetupIntentLastSetupError'NonNullableSource' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'
...
mkSetupIntentLastSetupError'NonNullableSource' = SetupIntentLastSetupError'NonNullableSource'{setupIntentLastSetupError'NonNullableSource'Account = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable =
   SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumAlways -- ^ Represents the JSON value @"always"@
  | SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumLimited -- ^ Represents the JSON value @"limited"@
  | SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumUnspecified -- ^ Represents the JSON value @"unspecified"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "always" -> SetupIntentLastSetupError'NonNullableSource'AllowRedisplay'NonNullableEnumAlways
...
data SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullable =
   SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableEnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableEnumStandard -- ^ Represents the JSON value @"standard"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullable
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "instant" -> SetupIntentLastSetupError'NonNullableSource'AvailablePayoutMethods'NonNullableEnumInstant
...
data SetupIntentLastSetupError'NonNullableSource'Customer'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Customer'NonNullableVariants
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'Customer'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Customer'NonNullableVariants
...
data SetupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullable = SetupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullable
...
mkSetupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullable = SetupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullable{setupIntentLastSetupError'NonNullableSource'FutureRequirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'Object' =
   SetupIntentLastSetupError'NonNullableSource'Object'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableSource'Object'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableSource'Object'EnumBankAccount -- ^ Represents the JSON value @"bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Object'
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'Object'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Object'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_account" -> SetupIntentLastSetupError'NonNullableSource'Object'EnumBankAccount
...
data SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("email" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("name" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("phone" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullablePhone obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_address" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_email" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedEmail obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_name" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedName obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verified_phone" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedPhone obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable" (\obj -> (((((((GHC.Base.pure SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "phone")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_email")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verified_phone"))}
...
mkSetupIntentLastSetupError'NonNullableSource'Owner'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullable{setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable" (\obj -> (((((GHC.Base.pure SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkSetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullable{setupIntentLastSetupError'NonNullableSource'Owner'NonNullableAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("city" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableCity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("country" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableCountry obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line1" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableLine1 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("line2" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableLine2 obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("postal_code" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullablePostalCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableState obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable" (\obj -> (((((GHC.Base.pure SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "city")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line1")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line2")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "postal_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
...
mkSetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable = SetupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullable{setupIntentLastSetupError'NonNullableSource'Owner'NonNullableVerifiedAddress'NonNullableCity = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable =
   SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumRegulated -- ^ Represents the JSON value @"regulated"@
  | SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumUnregulated -- ^ Represents the JSON value @"unregulated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "regulated" -> SetupIntentLastSetupError'NonNullableSource'RegulatedStatus'NonNullableEnumRegulated
...
data SetupIntentLastSetupError'NonNullableSource'Requirements'NonNullable = SetupIntentLastSetupError'NonNullableSource'Requirements'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Requirements'NonNullable
...
mkSetupIntentLastSetupError'NonNullableSource'Requirements'NonNullable = SetupIntentLastSetupError'NonNullableSource'Requirements'NonNullable{setupIntentLastSetupError'NonNullableSource'Requirements'NonNullableCurrentlyDue = GHC.Maybe.Nothing,
...
data SetupIntentLastSetupError'NonNullableSource'Type' =
   SetupIntentLastSetupError'NonNullableSource'Type'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableSource'Type'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumAchCreditTransfer -- ^ Represents the JSON value @"ach_credit_transfer"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumAchDebit -- ^ Represents the JSON value @"ach_debit"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumAcssDebit -- ^ Represents the JSON value @"acss_debit"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumAlipay -- ^ Represents the JSON value @"alipay"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumAuBecsDebit -- ^ Represents the JSON value @"au_becs_debit"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumBancontact -- ^ Represents the JSON value @"bancontact"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumCard -- ^ Represents the JSON value @"card"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumCardPresent -- ^ Represents the JSON value @"card_present"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumEps -- ^ Represents the JSON value @"eps"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumGiropay -- ^ Represents the JSON value @"giropay"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumIdeal -- ^ Represents the JSON value @"ideal"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumKlarna -- ^ Represents the JSON value @"klarna"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumMultibanco -- ^ Represents the JSON value @"multibanco"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumP24 -- ^ Represents the JSON value @"p24"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumSepaDebit -- ^ Represents the JSON value @"sepa_debit"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumSofort -- ^ Represents the JSON value @"sofort"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumThreeDSecure -- ^ Represents the JSON value @"three_d_secure"@
  | SetupIntentLastSetupError'NonNullableSource'Type'EnumWechat -- ^ Represents the JSON value @"wechat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableSource'Type'
    where {toJSON (SetupIntentLastSetupError'NonNullableSource'Type'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableSource'Type'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach_credit_transfer" -> SetupIntentLastSetupError'NonNullableSource'Type'EnumAchCreditTransfer
...
data SetupIntentLastSetupError'NonNullableType' =
   SetupIntentLastSetupError'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentLastSetupError'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentLastSetupError'NonNullableType'EnumApiError -- ^ Represents the JSON value @"api_error"@
  | SetupIntentLastSetupError'NonNullableType'EnumCardError -- ^ Represents the JSON value @"card_error"@
  | SetupIntentLastSetupError'NonNullableType'EnumIdempotencyError -- ^ Represents the JSON value @"idempotency_error"@
  | SetupIntentLastSetupError'NonNullableType'EnumInvalidRequestError -- ^ Represents the JSON value @"invalid_request_error"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLastSetupError'NonNullableType'
    where {toJSON (SetupIntentLastSetupError'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLastSetupError'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "api_error" -> SetupIntentLastSetupError'NonNullableType'EnumApiError
...
data SetupIntentLatestAttempt'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentLatestAttempt'NonNullableVariants
    where {toJSON (SetupIntentLatestAttempt'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentLatestAttempt'NonNullableSetupAttempt a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentLatestAttempt'NonNullableVariants
    where {parseJSON val = case (SetupIntentLatestAttempt'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentLatestAttempt'NonNullableSetupAttempt Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SetupIntentMandate'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentMandate'NonNullableVariants
    where {toJSON (SetupIntentMandate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentMandate'NonNullableMandate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentMandate'NonNullableVariants
    where {parseJSON val = case (SetupIntentMandate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentMandate'NonNullableMandate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SetupIntentNextAction'NonNullable = SetupIntentNextAction'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentNextAction'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cashapp_handle_redirect_or_display_qr_code" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableCashappHandleRedirectOrDisplayQrCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("redirect_to_url" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableRedirectToUrl obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("use_stripe_sdk" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableUseStripeSdk obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verify_with_microdeposits" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableVerifyWithMicrodeposits obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("cashapp_handle_redirect_or_display_qr_code" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableCashappHandleRedirectOrDisplayQrCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("redirect_to_url" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableRedirectToUrl obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("use_stripe_sdk" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableUseStripeSdk obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verify_with_microdeposits" Data.Aeson.Types.ToJSON..=)) (setupIntentNextAction'NonNullableVerifyWithMicrodeposits obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentNextAction'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentNextAction'NonNullable" (\obj -> ((((GHC.Base.pure SetupIntentNextAction'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "cashapp_handle_redirect_or_display_qr_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "redirect_to_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "use_stripe_sdk")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verify_with_microdeposits"))}
...
mkSetupIntentNextAction'NonNullable = SetupIntentNextAction'NonNullable{setupIntentNextAction'NonNullableCashappHandleRedirectOrDisplayQrCode = GHC.Maybe.Nothing,
...
data SetupIntentOnBehalfOf'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentOnBehalfOf'NonNullableVariants
    where {toJSON (SetupIntentOnBehalfOf'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentOnBehalfOf'NonNullableAccount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentOnBehalfOf'NonNullableVariants
    where {parseJSON val = case (SetupIntentOnBehalfOf'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentOnBehalfOf'NonNullableAccount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SetupIntentPaymentMethod'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethod'NonNullableVariants
    where {toJSON (SetupIntentPaymentMethod'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentPaymentMethod'NonNullablePaymentMethod a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethod'NonNullableVariants
    where {parseJSON val = case (SetupIntentPaymentMethod'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentPaymentMethod'NonNullablePaymentMethod Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SetupIntentPaymentMethodConfigurationDetails'NonNullable = SetupIntentPaymentMethodConfigurationDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodConfigurationDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodConfigurationDetails'NonNullableId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("parent" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodConfigurationDetails'NonNullableParent obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("id" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodConfigurationDetails'NonNullableId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("parent" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodConfigurationDetails'NonNullableParent obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodConfigurationDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodConfigurationDetails'NonNullable" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodConfigurationDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "parent"))}
...
mkSetupIntentPaymentMethodConfigurationDetails'NonNullable = SetupIntentPaymentMethodConfigurationDetails'NonNullable{setupIntentPaymentMethodConfigurationDetails'NonNullableId = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullable
...
mkSetupIntentPaymentMethodOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullable{setupIntentPaymentMethodOptions'NonNullableAcssDebit = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableAcssDebit' = SetupIntentPaymentMethodOptions'NonNullableAcssDebit' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableAcssDebit'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableAcssDebit' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableAcssDebit' = SetupIntentPaymentMethodOptions'NonNullableAcssDebit'{setupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullable =
   SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableEnumCad -- ^ Represents the JSON value @"cad"@
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableEnumUsd -- ^ Represents the JSON value @"usd"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cad" -> SetupIntentPaymentMethodOptions'NonNullableAcssDebit'Currency'NonNullableEnumCad
...
data SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableAcssDebit'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableAmazonPay' = SetupIntentPaymentMethodOptions'NonNullableAmazonPay' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableAmazonPay'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableAmazonPay' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
data SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableAmazonPay'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableBacsDebit' = SetupIntentPaymentMethodOptions'NonNullableBacsDebit' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableBacsDebit'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableBacsDebit' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableBacsDebit' = SetupIntentPaymentMethodOptions'NonNullableBacsDebit'{setupIntentPaymentMethodOptions'NonNullableBacsDebit'MandateOptions = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableBacsDebit'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableCard' = SetupIntentPaymentMethodOptions'NonNullableCard' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'Network obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'Network obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCard'" (\obj -> (((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCard' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableCard' = SetupIntentPaymentMethodOptions'NonNullableCard'{setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable" (\obj -> (((((((((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "supported_types"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable = SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullable{setupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmount = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType' =
   SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumFixed -- ^ Represents the JSON value @"fixed"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumMaximum -- ^ Represents the JSON value @"maximum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fixed" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableAmountType'EnumFixed
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval' =
   SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumSporadic -- ^ Represents the JSON value @"sporadic"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableInterval'EnumDay
...
data SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable =
   SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia -- ^ Represents the JSON value @"india"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "india" -> SetupIntentPaymentMethodOptions'NonNullableCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia
...
data SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable =
   SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumAmex -- ^ Represents the JSON value @"amex"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiners -- ^ Represents the JSON value @"diners"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumDiscover -- ^ Represents the JSON value @"discover"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumEftposAu -- ^ Represents the JSON value @"eftpos_au"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumInterac -- ^ Represents the JSON value @"interac"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumJcb -- ^ Represents the JSON value @"jcb"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnionpay -- ^ Represents the JSON value @"unionpay"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex" -> SetupIntentPaymentMethodOptions'NonNullableCard'Network'NonNullableEnumAmex
...
data SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable =
   SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAny -- ^ Represents the JSON value @"any"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> SetupIntentPaymentMethodOptions'NonNullableCard'RequestThreeDSecure'NonNullableEnumAny
...
data SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableCard'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableCardPresent' = SetupIntentPaymentMethodOptions'NonNullableCardPresent' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableCardPresent'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableCardPresent' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
data SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableCardPresent'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableKlarna' = SetupIntentPaymentMethodOptions'NonNullableKlarna' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableKlarna'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableKlarna' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_locale")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableKlarna' = SetupIntentPaymentMethodOptions'NonNullableKlarna'{setupIntentPaymentMethodOptions'NonNullableKlarna'Currency = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableKlarna'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableLink' = SetupIntentPaymentMethodOptions'NonNullableLink' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableLink'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableLink'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableLink'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableLink' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
data SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableLink'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullablePaypal' = SetupIntentPaymentMethodOptions'NonNullablePaypal' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullablePaypal'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("billing_agreement_id" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullablePaypal'BillingAgreementId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("billing_agreement_id" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullablePaypal'BillingAgreementId obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullablePaypal'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullablePaypal'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullablePaypal' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_agreement_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullablePaypal' = SetupIntentPaymentMethodOptions'NonNullablePaypal'{setupIntentPaymentMethodOptions'NonNullablePaypal'BillingAgreementId = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullablePaypal'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableSepaDebit' = SetupIntentPaymentMethodOptions'NonNullableSepaDebit' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableSepaDebit'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableSepaDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableSepaDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableSepaDebit'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableSepaDebit'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableSepaDebit' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableSepaDebit' = SetupIntentPaymentMethodOptions'NonNullableSepaDebit'{setupIntentPaymentMethodOptions'NonNullableSepaDebit'MandateOptions = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableSepaDebit'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptions'NonNullableUsBankAccount' = SetupIntentPaymentMethodOptions'NonNullableUsBankAccount' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'FinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'FinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptions'NonNullableUsBankAccount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_connections")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptions'NonNullableUsBankAccount' = SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'{setupIntentPaymentMethodOptions'NonNullableUsBankAccount'FinancialConnections = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod' =
   SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptions'NonNullableUsBankAccount'VerificationMethod'EnumAutomatic
...
data SetupIntentSingleUseMandate'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentSingleUseMandate'NonNullableVariants
    where {toJSON (SetupIntentSingleUseMandate'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SetupIntentSingleUseMandate'NonNullableMandate a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentSingleUseMandate'NonNullableVariants
    where {parseJSON val = case (SetupIntentSingleUseMandate'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SetupIntentSingleUseMandate'NonNullableMandate Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SetupIntentStatus' =
   SetupIntentStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentStatus'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | SetupIntentStatus'EnumProcessing -- ^ Represents the JSON value @"processing"@
  | SetupIntentStatus'EnumRequiresAction -- ^ Represents the JSON value @"requires_action"@
  | SetupIntentStatus'EnumRequiresConfirmation -- ^ Represents the JSON value @"requires_confirmation"@
  | SetupIntentStatus'EnumRequiresPaymentMethod -- ^ Represents the JSON value @"requires_payment_method"@
  | SetupIntentStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentStatus'
    where {toJSON (SetupIntentStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "canceled" -> SetupIntentStatus'EnumCanceled
