...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentNextActionVerifyWithMicrodeposits
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentNextActionVerifyWithMicrodeposits" (\obj -> ((GHC.Base.pure SetupIntentNextActionVerifyWithMicrodeposits GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "arrival_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "hosted_verification_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "microdeposit_type"))}
-- | Create a new 'SetupIntentNextActionVerifyWithMicrodeposits' with all required fields.
mkSetupIntentNextActionVerifyWithMicrodeposits :: GHC.Types.Int -- ^ 'setupIntentNextActionVerifyWithMicrodepositsArrivalDate'
  -> Data.Text.Internal.Text -- ^ 'setupIntentNextActionVerifyWithMicrodepositsHostedVerificationUrl'
  -> SetupIntentNextActionVerifyWithMicrodeposits
mkSetupIntentNextActionVerifyWithMicrodeposits setupIntentNextActionVerifyWithMicrodepositsArrivalDate setupIntentNextActionVerifyWithMicrodepositsHostedVerificationUrl = SetupIntentNextActionVerifyWithMicrodeposits{setupIntentNextActionVerifyWithMicrodepositsArrivalDate = setupIntentNextActionVerifyWithMicrodepositsArrivalDate,
...
data SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullable =
   SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableEnumAmounts -- ^ Represents the JSON value @"amounts"@
  | SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableEnumDescriptorCode -- ^ Represents the JSON value @"descriptor_code"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullable
    where {toJSON (SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amounts" -> SetupIntentNextActionVerifyWithMicrodepositsMicrodepositType'NonNullableEnumAmounts
