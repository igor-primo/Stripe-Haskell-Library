...
data SetupIntentPaymentMethodOptionsAmazonPay' = SetupIntentPaymentMethodOptionsAmazonPay' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsAmazonPay'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsAmazonPay'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsAmazonPay'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsAmazonPay'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptionsAmazonPay' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
data SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod' =
   SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsAmazonPay'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptionsBacsDebit' = SetupIntentPaymentMethodOptionsBacsDebit' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsBacsDebit'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsBacsDebit'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsBacsDebit'MandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsBacsDebit'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsBacsDebit'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsBacsDebit'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptionsBacsDebit' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptionsBacsDebit' = SetupIntentPaymentMethodOptionsBacsDebit'{setupIntentPaymentMethodOptionsBacsDebit'MandateOptions = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod' =
   SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsBacsDebit'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptionsCard' = SetupIntentPaymentMethodOptionsCard' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsCard'" (\obj -> (((GHC.Base.pure SetupIntentPaymentMethodOptionsCard' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptionsCard' = SetupIntentPaymentMethodOptionsCard'{setupIntentPaymentMethodOptionsCard'MandateOptions = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable = SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_type" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableCurrency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("description" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableDescription obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("interval_count" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableIntervalCount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("reference" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableReference obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableStartDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("supported_types" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable" (\obj -> (((((((((GHC.Base.pure SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "interval_count")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "supported_types"))}
...
mkSetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable = SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullable{setupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmount = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType' =
   SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'EnumFixed -- ^ Represents the JSON value @"fixed"@
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'EnumMaximum -- ^ Represents the JSON value @"maximum"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'
    where {toJSON (SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "fixed" -> SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableAmountType'EnumFixed
...
data SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval' =
   SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumDay -- ^ Represents the JSON value @"day"@
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumMonth -- ^ Represents the JSON value @"month"@
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumSporadic -- ^ Represents the JSON value @"sporadic"@
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumWeek -- ^ Represents the JSON value @"week"@
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumYear -- ^ Represents the JSON value @"year"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'
    where {toJSON (SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "day" -> SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableInterval'EnumDay
...
data SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullable =
   SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia -- ^ Represents the JSON value @"india"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "india" -> SetupIntentPaymentMethodOptionsCard'MandateOptions'NonNullableSupportedTypes'NonNullableEnumIndia
...
data SetupIntentPaymentMethodOptionsCard'Network'NonNullable =
   SetupIntentPaymentMethodOptionsCard'Network'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumAmex -- ^ Represents the JSON value @"amex"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumDiners -- ^ Represents the JSON value @"diners"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumDiscover -- ^ Represents the JSON value @"discover"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumEftposAu -- ^ Represents the JSON value @"eftpos_au"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumInterac -- ^ Represents the JSON value @"interac"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumJcb -- ^ Represents the JSON value @"jcb"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumUnionpay -- ^ Represents the JSON value @"unionpay"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  | SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'Network'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptionsCard'Network'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'Network'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex" -> SetupIntentPaymentMethodOptionsCard'Network'NonNullableEnumAmex
...
data SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullable =
   SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableEnumAny -- ^ Represents the JSON value @"any"@
  | SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableEnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> SetupIntentPaymentMethodOptionsCard'RequestThreeDSecure'NonNullableEnumAny
...
data SetupIntentPaymentMethodOptionsCard'VerificationMethod' =
   SetupIntentPaymentMethodOptionsCard'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCard'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCard'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsCard'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsCard'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCard'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsCard'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCard'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsCard'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptionsCardPresent' = SetupIntentPaymentMethodOptionsCardPresent' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCardPresent'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsCardPresent'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCardPresent'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsCardPresent'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptionsCardPresent' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
data SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod' =
   SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsCardPresent'VerificationMethod'EnumAutomatic
...
data SetupIntentPaymentMethodOptionsKlarna' = SetupIntentPaymentMethodOptionsKlarna' {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsKlarna'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'VerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("currency" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'Currency obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_locale" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'PreferredLocale obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsKlarna'VerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsKlarna'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsKlarna'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptionsKlarna' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_locale")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptionsKlarna' = SetupIntentPaymentMethodOptionsKlarna'{setupIntentPaymentMethodOptionsKlarna'Currency = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsKlarna'VerificationMethod' =
   SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsKlarna'VerificationMethod'EnumAutomatic
...
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsLink'
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (setupIntentPaymentMethodOptionsLink'VerificationMethod obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsLink'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsLink'" (\obj -> GHC.Base.pure SetupIntentPaymentMethodOptionsLink' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsPaypal'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsPaypal'" (\obj -> (GHC.Base.pure SetupIntentPaymentMethodOptionsPaypal' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "billing_agreement_id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSetupIntentPaymentMethodOptionsPaypal' = SetupIntentPaymentMethodOptionsPaypal'{setupIntentPaymentMethodOptionsPaypal'BillingAgreementId = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsPaypal'VerificationMethod' =
   SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'
    where {toJSON (SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SetupIntentPaymentMethodOptionsPaypal'VerificationMethod'EnumAutomatic
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsUsBankAccount'
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SetupIntentPaymentMethodOptionsUsBankAccount'" (\obj -> ((GHC.Base.pure SetupIntentPaymentMethodOptionsUsBankAccount' GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_connections")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
