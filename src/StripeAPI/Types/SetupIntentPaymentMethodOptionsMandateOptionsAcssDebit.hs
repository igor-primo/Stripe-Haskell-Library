...
data SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit = SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit
...
mkSetupIntentPaymentMethodOptionsMandateOptionsAcssDebit = SetupIntentPaymentMethodOptionsMandateOptionsAcssDebit{setupIntentPaymentMethodOptionsMandateOptionsAcssDebitCustomMandateUrl = GHC.Maybe.Nothing,
...
data SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor' =
   SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'EnumInvoice -- ^ Represents the JSON value @"invoice"@
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'EnumSubscription -- ^ Represents the JSON value @"subscription"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'
    where {toJSON (SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "invoice" -> SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitDefaultFor'EnumInvoice
...
data SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullable =
   SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableEnumCombined -- ^ Represents the JSON value @"combined"@
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableEnumInterval -- ^ Represents the JSON value @"interval"@
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableEnumSporadic -- ^ Represents the JSON value @"sporadic"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "combined" -> SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitPaymentSchedule'NonNullableEnumCombined
...
data SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullable =
   SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableEnumBusiness -- ^ Represents the JSON value @"business"@
  | SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableEnumPersonal -- ^ Represents the JSON value @"personal"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullable
    where {toJSON (SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "business" -> SetupIntentPaymentMethodOptionsMandateOptionsAcssDebitTransactionType'NonNullableEnumBusiness
