...
data SourceCodeVerificationFlow = SourceCodeVerificationFlow {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceCodeVerificationFlow
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["attempts_remaining" Data.Aeson.Types.ToJSON..= sourceCodeVerificationFlowAttemptsRemaining obj] : ["status" Data.Aeson.Types.ToJSON..= sourceCodeVerificationFlowStatus obj] : GHC.Base.mempty));
...
mkSourceCodeVerificationFlow :: GHC.Types.Int -- ^ 'sourceCodeVerificationFlowAttemptsRemaining'
  -> Data.Text.Internal.Text -- ^ 'sourceCodeVerificationFlowStatus'
  -> SourceCodeVerificationFlow
mkSourceCodeVerificationFlow sourceCodeVerificationFlowAttemptsRemaining sourceCodeVerificationFlowStatus = SourceCodeVerificationFlow{sourceCodeVerificationFlowAttemptsRemaining = sourceCodeVerificationFlowAttemptsRemaining,
