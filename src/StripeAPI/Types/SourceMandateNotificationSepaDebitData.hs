...
data SourceMandateNotificationSepaDebitData = SourceMandateNotificationSepaDebitData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceMandateNotificationSepaDebitData
...
mkSourceMandateNotificationSepaDebitData = SourceMandateNotificationSepaDebitData{sourceMandateNotificationSepaDebitDataCreditorIdentifier = GHC.Maybe.Nothing,
