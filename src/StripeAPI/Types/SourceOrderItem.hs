...
data SourceOrderItem = SourceOrderItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceOrderItem
...
instance Data.Aeson.Types.FromJSON.FromJSON SourceOrderItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SourceOrderItem" (\obj -> (((((GHC.Base.pure SourceOrderItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "parent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
-- | Create a new 'SourceOrderItem' with all required fields.
mkSourceOrderItem :: SourceOrderItem
mkSourceOrderItem = SourceOrderItem{sourceOrderItemAmount = GHC.Maybe.Nothing,
