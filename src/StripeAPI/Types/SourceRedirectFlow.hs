...
data SourceRedirectFlow = SourceRedirectFlow {
  ...
  sourceRedirectFlowFailureReason :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceRedirectFlow
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("failure_reason" Data.Aeson.Types.ToJSON..=)) (sourceRedirectFlowFailureReason obj) : ["return_url" Data.Aeson.Types.ToJSON..= sourceRedirectFlowReturnUrl obj] : ["status" Data.Aeson.Types.ToJSON..= sourceRedirectFlowStatus obj] : ["url" Data.Aeson.Types.ToJSON..= sourceRedirectFlowUrl obj] : GHC.Base.mempty));
...
mkSourceRedirectFlow :: Data.Text.Internal.Text -- ^ 'sourceRedirectFlowReturnUrl'
  -> Data.Text.Internal.Text -- ^ 'sourceRedirectFlowStatus'
  -> Data.Text.Internal.Text -- ^ 'sourceRedirectFlowUrl'
  -> SourceRedirectFlow
mkSourceRedirectFlow sourceRedirectFlowReturnUrl sourceRedirectFlowStatus sourceRedirectFlowUrl = SourceRedirectFlow{sourceRedirectFlowFailureReason = GHC.Maybe.Nothing,
