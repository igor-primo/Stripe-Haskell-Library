...
data SourceTransaction = SourceTransaction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTransaction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach_credit_transfer" Data.Aeson.Types.ToJSON..=)) (sourceTransactionAchCreditTransfer obj) : ["amount" Data.Aeson.Types.ToJSON..= sourceTransactionAmount obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("chf_credit_transfer" Data.Aeson.Types.ToJSON..=)) (sourceTransactionChfCreditTransfer obj) : ["created" Data.Aeson.Types.ToJSON..= sourceTransactionCreated obj] : ["currency" Data.Aeson.Types.ToJSON..= sourceTransactionCurrency obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("gbp_credit_transfer" Data.Aeson.Types.ToJSON..=)) (sourceTransactionGbpCreditTransfer obj) : ["id" Data.Aeson.Types.ToJSON..= sourceTransactionId obj] : ["livemode" Data.Aeson.Types.ToJSON..= sourceTransactionLivemode obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("paper_check" Data.Aeson.Types.ToJSON..=)) (sourceTransactionPaperCheck obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("sepa_credit_transfer" Data.Aeson.Types.ToJSON..=)) (sourceTransactionSepaCreditTransfer obj) : ["source" Data.Aeson.Types.ToJSON..= sourceTransactionSource obj] : ["status" Data.Aeson.Types.ToJSON..= sourceTransactionStatus obj] : ["type" Data.Aeson.Types.ToJSON..= sourceTransactionType obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "source_transaction"] : GHC.Base.mempty));
...
mkSourceTransaction :: GHC.Types.Int -- ^ 'sourceTransactionAmount'
  -> GHC.Types.Int -- ^ 'sourceTransactionCreated'
  -> Data.Text.Internal.Text -- ^ 'sourceTransactionCurrency'
  -> Data.Text.Internal.Text -- ^ 'sourceTransactionId'
  -> GHC.Types.Bool -- ^ 'sourceTransactionLivemode'
  -> Data.Text.Internal.Text -- ^ 'sourceTransactionSource'
  -> Data.Text.Internal.Text -- ^ 'sourceTransactionStatus'
  -> SourceTransactionType' -- ^ 'sourceTransactionType'
  -> SourceTransaction
mkSourceTransaction sourceTransactionAmount sourceTransactionCreated sourceTransactionCurrency sourceTransactionId sourceTransactionLivemode sourceTransactionSource sourceTransactionStatus sourceTransactionType = SourceTransaction{sourceTransactionAchCreditTransfer = GHC.Maybe.Nothing,
...
data SourceTransactionType' =
   SourceTransactionType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SourceTransactionType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SourceTransactionType'EnumAchCreditTransfer -- ^ Represents the JSON value @"ach_credit_transfer"@
  | SourceTransactionType'EnumAchDebit -- ^ Represents the JSON value @"ach_debit"@
  | SourceTransactionType'EnumAlipay -- ^ Represents the JSON value @"alipay"@
  | SourceTransactionType'EnumBancontact -- ^ Represents the JSON value @"bancontact"@
  | SourceTransactionType'EnumCard -- ^ Represents the JSON value @"card"@
  | SourceTransactionType'EnumCardPresent -- ^ Represents the JSON value @"card_present"@
  | SourceTransactionType'EnumEps -- ^ Represents the JSON value @"eps"@
  | SourceTransactionType'EnumGiropay -- ^ Represents the JSON value @"giropay"@
  | SourceTransactionType'EnumIdeal -- ^ Represents the JSON value @"ideal"@
  | SourceTransactionType'EnumKlarna -- ^ Represents the JSON value @"klarna"@
  | SourceTransactionType'EnumMultibanco -- ^ Represents the JSON value @"multibanco"@
  | SourceTransactionType'EnumP24 -- ^ Represents the JSON value @"p24"@
  | SourceTransactionType'EnumSepaDebit -- ^ Represents the JSON value @"sepa_debit"@
  | SourceTransactionType'EnumSofort -- ^ Represents the JSON value @"sofort"@
  | SourceTransactionType'EnumThreeDSecure -- ^ Represents the JSON value @"three_d_secure"@
  | SourceTransactionType'EnumWechat -- ^ Represents the JSON value @"wechat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTransactionType'
    where {toJSON (SourceTransactionType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SourceTransactionType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach_credit_transfer" -> SourceTransactionType'EnumAchCreditTransfer
