...
data SourceTransactionChfCreditTransferData = SourceTransactionChfCreditTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTransactionChfCreditTransferData
...
mkSourceTransactionChfCreditTransferData = SourceTransactionChfCreditTransferData{sourceTransactionChfCreditTransferDataReference = GHC.Maybe.Nothing,
