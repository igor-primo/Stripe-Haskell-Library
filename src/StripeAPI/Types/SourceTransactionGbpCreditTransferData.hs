...
data SourceTransactionGbpCreditTransferData = SourceTransactionGbpCreditTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTransactionGbpCreditTransferData
...
mkSourceTransactionGbpCreditTransferData = SourceTransactionGbpCreditTransferData{sourceTransactionGbpCreditTransferDataFingerprint = GHC.Maybe.Nothing,
