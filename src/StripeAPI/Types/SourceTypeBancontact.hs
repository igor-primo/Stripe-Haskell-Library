...
data SourceTypeBancontact = SourceTypeBancontact {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTypeBancontact
...
mkSourceTypeBancontact = SourceTypeBancontact{sourceTypeBancontactBankCode = GHC.Maybe.Nothing,
