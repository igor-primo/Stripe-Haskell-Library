...
data SourceTypeCardPresent = SourceTypeCardPresent {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SourceTypeCardPresent
...
mkSourceTypeCardPresent = SourceTypeCardPresent{sourceTypeCardPresentApplicationCryptogram = GHC.Maybe.Nothing,
