...
data SubscriptionItem = SubscriptionItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionItem
...
mkSubscriptionItem :: GHC.Types.Int -- ^ 'subscriptionItemCreated'
  -> GHC.Types.Int -- ^ 'subscriptionItemCurrentPeriodEnd'
  -> GHC.Types.Int -- ^ 'subscriptionItemCurrentPeriodStart'
  -> [SubscriptionItemDiscounts'Variants] -- ^ 'subscriptionItemDiscounts'
  -> Data.Text.Internal.Text -- ^ 'subscriptionItemId'
  -> Data.Aeson.Types.Internal.Object -- ^ 'subscriptionItemMetadata'
  -> Price -- ^ 'subscriptionItemPrice'
  -> Data.Text.Internal.Text -- ^ 'subscriptionItemSubscription'
  -> SubscriptionItem
mkSubscriptionItem subscriptionItemCreated subscriptionItemCurrentPeriodEnd subscriptionItemCurrentPeriodStart subscriptionItemDiscounts subscriptionItemId subscriptionItemMetadata subscriptionItemPrice subscriptionItemSubscription = SubscriptionItem{subscriptionItemBillingThresholds = GHC.Maybe.Nothing,
...
data SubscriptionItemBillingThresholds'NonNullable = SubscriptionItemBillingThresholds'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionItemBillingThresholds'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_gte" Data.Aeson.Types.ToJSON..=)) (subscriptionItemBillingThresholds'NonNullableUsageGte obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionItemBillingThresholds'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionItemBillingThresholds'NonNullable" (\obj -> GHC.Base.pure SubscriptionItemBillingThresholds'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_gte"))}
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionItemDiscounts'Variants
    where {toJSON (SubscriptionItemDiscounts'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SubscriptionItemDiscounts'Discount a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionItemDiscounts'Variants
    where {parseJSON val = case (SubscriptionItemDiscounts'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionItemDiscounts'Discount Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
