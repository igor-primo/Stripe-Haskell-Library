...
data SubscriptionPaymentMethodOptionsCardNetwork'NonNullable =
  ...
  | SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  ...
  | SubscriptionPaymentMethodOptionsCardNetwork'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
