...
data SubscriptionSchedule = SubscriptionSchedule {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionSchedule
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionSchedule
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionSchedule" (\obj -> (((((((((((((((((GHC.Base.pure SubscriptionSchedule GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "application")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "billing_mode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "canceled_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "completed_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "current_phase")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "default_settings")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "end_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "phases")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "released_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "released_subscription")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "subscription")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "test_clock"))}
-- | Create a new 'SubscriptionSchedule' with all required fields.
mkSubscriptionSchedule :: SubscriptionsResourceBillingMode -- ^ 'subscriptionScheduleBillingMode'
  -> GHC.Types.Int -- ^ 'subscriptionScheduleCreated'
  -> SubscriptionScheduleCustomer'Variants -- ^ 'subscriptionScheduleCustomer'
  -> SubscriptionSchedulesResourceDefaultSettings -- ^ 'subscriptionScheduleDefaultSettings'
  -> SubscriptionScheduleEndBehavior' -- ^ 'subscriptionScheduleEndBehavior'
  -> Data.Text.Internal.Text -- ^ 'subscriptionScheduleId'
  -> GHC.Types.Bool -- ^ 'subscriptionScheduleLivemode'
  -> [SubscriptionSchedulePhaseConfiguration] -- ^ 'subscriptionSchedulePhases'
  -> SubscriptionScheduleStatus' -- ^ 'subscriptionScheduleStatus'
  -> SubscriptionSchedule
mkSubscriptionSchedule subscriptionScheduleBillingMode subscriptionScheduleCreated subscriptionScheduleCustomer subscriptionScheduleDefaultSettings subscriptionScheduleEndBehavior subscriptionScheduleId subscriptionScheduleLivemode subscriptionSchedulePhases subscriptionScheduleStatus = SubscriptionSchedule{subscriptionScheduleApplication = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleApplication'NonNullableVariants
    where {toJSON (SubscriptionScheduleApplication'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data SubscriptionScheduleCurrentPhase'NonNullable = SubscriptionScheduleCurrentPhase'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleCurrentPhase'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleCurrentPhase'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleCurrentPhase'NonNullableStartDate obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("end_date" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleCurrentPhase'NonNullableEndDate obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("start_date" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleCurrentPhase'NonNullableStartDate obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleCurrentPhase'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionScheduleCurrentPhase'NonNullable" (\obj -> (GHC.Base.pure SubscriptionScheduleCurrentPhase'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "end_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "start_date"))}
...
mkSubscriptionScheduleCurrentPhase'NonNullable = SubscriptionScheduleCurrentPhase'NonNullable{subscriptionScheduleCurrentPhase'NonNullableEndDate = GHC.Maybe.Nothing,
...
data SubscriptionScheduleCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleCustomer'Variants
    where {toJSON (SubscriptionScheduleCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleCustomer'Variants
    where {parseJSON val = case (SubscriptionScheduleCustomer'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleCustomer'Customer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleCustomer'DeletedCustomer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SubscriptionScheduleEndBehavior' =
   SubscriptionScheduleEndBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionScheduleEndBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionScheduleEndBehavior'EnumCancel -- ^ Represents the JSON value @"cancel"@
  | SubscriptionScheduleEndBehavior'EnumNone -- ^ Represents the JSON value @"none"@
  | SubscriptionScheduleEndBehavior'EnumRelease -- ^ Represents the JSON value @"release"@
  | SubscriptionScheduleEndBehavior'EnumRenew -- ^ Represents the JSON value @"renew"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleEndBehavior'
    where {toJSON (SubscriptionScheduleEndBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleEndBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cancel" -> SubscriptionScheduleEndBehavior'EnumCancel
...
data SubscriptionScheduleStatus' =
   SubscriptionScheduleStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionScheduleStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionScheduleStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | SubscriptionScheduleStatus'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | SubscriptionScheduleStatus'EnumCompleted -- ^ Represents the JSON value @"completed"@
  | SubscriptionScheduleStatus'EnumNotStarted -- ^ Represents the JSON value @"not_started"@
  | SubscriptionScheduleStatus'EnumReleased -- ^ Represents the JSON value @"released"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleStatus'
    where {toJSON (SubscriptionScheduleStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> SubscriptionScheduleStatus'EnumActive
...
data SubscriptionScheduleSubscription'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleSubscription'NonNullableVariants
    where {toJSON (SubscriptionScheduleSubscription'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SubscriptionScheduleSubscription'NonNullableSubscription a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleSubscription'NonNullableVariants
    where {parseJSON val = case (SubscriptionScheduleSubscription'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleSubscription'NonNullableSubscription Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data SubscriptionScheduleTestClock'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleTestClock'NonNullableVariants
    where {toJSON (SubscriptionScheduleTestClock'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SubscriptionScheduleTestClock'NonNullableTestHelpers'testClock a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleTestClock'NonNullableVariants
    where {parseJSON val = case (SubscriptionScheduleTestClock'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleTestClock'NonNullableTestHelpers'testClock Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
