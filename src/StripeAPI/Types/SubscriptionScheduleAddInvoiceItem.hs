...
data SubscriptionScheduleAddInvoiceItem = SubscriptionScheduleAddInvoiceItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleAddInvoiceItem
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["discounts" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemDiscounts obj] : ["price" Data.Aeson.Types.ToJSON..= subscriptionScheduleAddInvoiceItemPrice obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("quantity" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemQuantity obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax_rates" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleAddInvoiceItemTaxRates obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleAddInvoiceItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionScheduleAddInvoiceItem" (\obj -> (((GHC.Base.pure SubscriptionScheduleAddInvoiceItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "discounts")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "price")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rates"))}
-- | Create a new 'SubscriptionScheduleAddInvoiceItem' with all required fields.
mkSubscriptionScheduleAddInvoiceItem :: [DiscountsResourceStackableDiscount] -- ^ 'subscriptionScheduleAddInvoiceItemDiscounts'
  -> SubscriptionScheduleAddInvoiceItemPrice'Variants -- ^ 'subscriptionScheduleAddInvoiceItemPrice'
  -> SubscriptionScheduleAddInvoiceItem
mkSubscriptionScheduleAddInvoiceItem subscriptionScheduleAddInvoiceItemDiscounts subscriptionScheduleAddInvoiceItemPrice = SubscriptionScheduleAddInvoiceItem{subscriptionScheduleAddInvoiceItemDiscounts = subscriptionScheduleAddInvoiceItemDiscounts,
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleAddInvoiceItemPrice'Variants
    where {toJSON (SubscriptionScheduleAddInvoiceItemPrice'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleAddInvoiceItemPrice'Variants
    where {parseJSON val = case (SubscriptionScheduleAddInvoiceItemPrice'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleAddInvoiceItemPrice'Price Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionScheduleAddInvoiceItemPrice'DeletedPrice Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched")) of
