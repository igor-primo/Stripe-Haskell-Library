...
data SubscriptionScheduleConfigurationItem = SubscriptionScheduleConfigurationItem {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleConfigurationItem
...
mkSubscriptionScheduleConfigurationItem :: [DiscountsResourceStackableDiscount] -- ^ 'subscriptionScheduleConfigurationItemDiscounts'
  -> SubscriptionScheduleConfigurationItemPrice'Variants -- ^ 'subscriptionScheduleConfigurationItemPrice'
  -> SubscriptionScheduleConfigurationItem
mkSubscriptionScheduleConfigurationItem subscriptionScheduleConfigurationItemDiscounts subscriptionScheduleConfigurationItemPrice = SubscriptionScheduleConfigurationItem{subscriptionScheduleConfigurationItemBillingThresholds = GHC.Maybe.Nothing,
...
data SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable = SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("usage_gte" Data.Aeson.Types.ToJSON..=)) (subscriptionScheduleConfigurationItemBillingThresholds'NonNullableUsageGte obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable" (\obj -> GHC.Base.pure SubscriptionScheduleConfigurationItemBillingThresholds'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "usage_gte"))}
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionScheduleConfigurationItemPrice'Variants
    where {toJSON (SubscriptionScheduleConfigurationItemPrice'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
