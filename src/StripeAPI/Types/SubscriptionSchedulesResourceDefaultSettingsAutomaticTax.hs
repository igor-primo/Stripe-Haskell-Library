...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionSchedulesResourceDefaultSettingsAutomaticTax
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionSchedulesResourceDefaultSettingsAutomaticTax" (\obj -> ((GHC.Base.pure SubscriptionSchedulesResourceDefaultSettingsAutomaticTax GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "disabled_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "enabled")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "liability"))}
...
mkSubscriptionSchedulesResourceDefaultSettingsAutomaticTax subscriptionSchedulesResourceDefaultSettingsAutomaticTaxEnabled = SubscriptionSchedulesResourceDefaultSettingsAutomaticTax{subscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason = GHC.Maybe.Nothing,
...
data SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullable =
   SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullableEnumRequiresLocationInputs -- ^ Represents the JSON value @"requires_location_inputs"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullable
    where {toJSON (SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "requires_location_inputs" -> SubscriptionSchedulesResourceDefaultSettingsAutomaticTaxDisabledReason'NonNullableEnumRequiresLocationInputs
