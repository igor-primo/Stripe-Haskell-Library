...
data SubscriptionTransferData = SubscriptionTransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionTransferData
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_percent" Data.Aeson.Types.ToJSON..=)) (subscriptionTransferDataAmountPercent obj) : ["destination" Data.Aeson.Types.ToJSON..= subscriptionTransferDataDestination obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionTransferData
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionTransferData" (\obj -> (GHC.Base.pure SubscriptionTransferData GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_percent")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "destination"))}
-- | Create a new 'SubscriptionTransferData' with all required fields.
mkSubscriptionTransferData :: SubscriptionTransferDataDestination'Variants -- ^ 'subscriptionTransferDataDestination'
  -> SubscriptionTransferData
mkSubscriptionTransferData subscriptionTransferDataDestination = SubscriptionTransferData{subscriptionTransferDataAmountPercent = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionTransferDataDestination'Variants
    where {toJSON (SubscriptionTransferDataDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (SubscriptionTransferDataDestination'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionTransferDataDestination'Variants
    where {parseJSON val = case (SubscriptionTransferDataDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((SubscriptionTransferDataDestination'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
