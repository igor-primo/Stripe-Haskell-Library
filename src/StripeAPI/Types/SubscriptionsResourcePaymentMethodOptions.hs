...
data SubscriptionsResourcePaymentMethodOptions = SubscriptionsResourcePaymentMethodOptions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptions
...
mkSubscriptionsResourcePaymentMethodOptions = SubscriptionsResourcePaymentMethodOptions{subscriptionsResourcePaymentMethodOptionsAcssDebit = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable = SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable" (\obj -> (GHC.Base.pure SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable = SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullable{subscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableMandateOptions = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod' =
   SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SubscriptionsResourcePaymentMethodOptionsAcssDebit'NonNullableVerificationMethod'EnumAutomatic
...
data SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable = SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("preferred_language" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable" (\obj -> GHC.Base.pure SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "preferred_language"))}
...
data SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage' =
   SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumDe -- ^ Represents the JSON value @"de"@
  | SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumEn -- ^ Represents the JSON value @"en"@
  | SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumFr -- ^ Represents the JSON value @"fr"@
  | SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumNl -- ^ Represents the JSON value @"nl"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "de" -> SubscriptionsResourcePaymentMethodOptionsBancontact'NonNullablePreferredLanguage'EnumDe
...
data SubscriptionsResourcePaymentMethodOptionsCard'NonNullable = SubscriptionsResourcePaymentMethodOptionsCard'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("mandate_options" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableMandateOptions obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("network" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("request_three_d_secure" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentMethodOptionsCard'NonNullable" (\obj -> ((GHC.Base.pure SubscriptionsResourcePaymentMethodOptionsCard'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure"))}
...
mkSubscriptionsResourcePaymentMethodOptionsCard'NonNullable = SubscriptionsResourcePaymentMethodOptionsCard'NonNullable{subscriptionsResourcePaymentMethodOptionsCard'NonNullableMandateOptions = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullable =
   SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumAmex -- ^ Represents the JSON value @"amex"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumDiners -- ^ Represents the JSON value @"diners"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumDiscover -- ^ Represents the JSON value @"discover"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumEftposAu -- ^ Represents the JSON value @"eftpos_au"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumInterac -- ^ Represents the JSON value @"interac"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumJcb -- ^ Represents the JSON value @"jcb"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumUnionpay -- ^ Represents the JSON value @"unionpay"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullable
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex" -> SubscriptionsResourcePaymentMethodOptionsCard'NonNullableNetwork'NonNullableEnumAmex
...
data SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable =
   SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAny -- ^ Represents the JSON value @"any"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "any" -> SubscriptionsResourcePaymentMethodOptionsCard'NonNullableRequestThreeDSecure'NonNullableEnumAny
...
data SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable = SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_transfer" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableBankTransfer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("funding_type" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("bank_transfer" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableBankTransfer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("funding_type" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable" (\obj -> (GHC.Base.pure SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_transfer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "funding_type"))}
...
mkSubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable = SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullable{subscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableBankTransfer = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable =
   SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableEnumBankTransfer -- ^ Represents the JSON value @"bank_transfer"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "bank_transfer" -> SubscriptionsResourcePaymentMethodOptionsCustomerBalance'NonNullableFundingType'NonNullableEnumBankTransfer
...
data SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable = SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("financial_connections" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("verification_method" Data.Aeson.Types.ToJSON..=)) (subscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable" (\obj -> (GHC.Base.pure SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_connections")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "verification_method"))}
...
mkSubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable = SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullable{subscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableFinancialConnections = GHC.Maybe.Nothing,
...
data SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod' =
   SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumAutomatic -- ^ Represents the JSON value @"automatic"@
  | SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumInstant -- ^ Represents the JSON value @"instant"@
  | SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumMicrodeposits -- ^ Represents the JSON value @"microdeposits"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'
    where {toJSON (SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "automatic" -> SubscriptionsResourcePaymentMethodOptionsUsBankAccount'NonNullableVerificationMethod'EnumAutomatic
