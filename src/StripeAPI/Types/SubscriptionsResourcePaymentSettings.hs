...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullable" (\obj -> ((GHC.Base.pure SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "mandate_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "request_three_d_secure"))}
...
data SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullable =
   SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumAmex -- ^ Represents the JSON value @"amex"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumCartesBancaires -- ^ Represents the JSON value @"cartes_bancaires"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumDiners -- ^ Represents the JSON value @"diners"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumDiscover -- ^ Represents the JSON value @"discover"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumEftposAu -- ^ Represents the JSON value @"eftpos_au"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumGirocard -- ^ Represents the JSON value @"girocard"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumInterac -- ^ Represents the JSON value @"interac"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumJcb -- ^ Represents the JSON value @"jcb"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumMastercard -- ^ Represents the JSON value @"mastercard"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumUnionpay -- ^ Represents the JSON value @"unionpay"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumUnknown -- ^ Represents the JSON value @"unknown"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumVisa -- ^ Represents the JSON value @"visa"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullable
    where {toJSON (SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amex" -> SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableNetwork'NonNullableEnumAmex
...
data SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullable =
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodOptions'NonNullableCard'NonNullableRequestThreeDSecure'NonNullableEnumChallenge -- ^ Represents the JSON value @"challenge"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
data SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullable =
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumAffirm -- ^ Represents the JSON value @"affirm"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumAmazonPay -- ^ Represents the JSON value @"amazon_pay"@
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumCashapp -- ^ Represents the JSON value @"cashapp"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumCrypto -- ^ Represents the JSON value @"crypto"@
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumEps -- ^ Represents the JSON value @"eps"@
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumJpCreditTransfer -- ^ Represents the JSON value @"jp_credit_transfer"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumKakaoPay -- ^ Represents the JSON value @"kakao_pay"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumKlarna -- ^ Represents the JSON value @"klarna"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumKonbini -- ^ Represents the JSON value @"konbini"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumKrCard -- ^ Represents the JSON value @"kr_card"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumLink -- ^ Represents the JSON value @"link"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumMultibanco -- ^ Represents the JSON value @"multibanco"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumNaverPay -- ^ Represents the JSON value @"naver_pay"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumNzBankAccount -- ^ Represents the JSON value @"nz_bank_account"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumP24 -- ^ Represents the JSON value @"p24"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumPayco -- ^ Represents the JSON value @"payco"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumPaynow -- ^ Represents the JSON value @"paynow"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumPaypal -- ^ Represents the JSON value @"paypal"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumPromptpay -- ^ Represents the JSON value @"promptpay"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumRevolutPay -- ^ Represents the JSON value @"revolut_pay"@
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumSepaCreditTransfer -- ^ Represents the JSON value @"sepa_credit_transfer"@
  ...
  | SubscriptionsResourcePaymentSettingsPaymentMethodTypes'NonNullableEnumSwish -- ^ Represents the JSON value @"swish"@
