...
data SubscriptionsResourceSubscriptionInvoiceSettings = SubscriptionsResourceSubscriptionInvoiceSettings {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourceSubscriptionInvoiceSettings
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsResourceSubscriptionInvoiceSettings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsResourceSubscriptionInvoiceSettings" (\obj -> (GHC.Base.pure SubscriptionsResourceSubscriptionInvoiceSettings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_tax_ids")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "issuer"))}
-- | Create a new 'SubscriptionsResourceSubscriptionInvoiceSettings' with all required fields.
mkSubscriptionsResourceSubscriptionInvoiceSettings :: ConnectAccountReference -- ^ 'subscriptionsResourceSubscriptionInvoiceSettingsIssuer'
  -> SubscriptionsResourceSubscriptionInvoiceSettings
mkSubscriptionsResourceSubscriptionInvoiceSettings subscriptionsResourceSubscriptionInvoiceSettingsIssuer = SubscriptionsResourceSubscriptionInvoiceSettings{subscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds'NonNullableVariants
    where {toJSON (SubscriptionsResourceSubscriptionInvoiceSettingsAccountTaxIds'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
