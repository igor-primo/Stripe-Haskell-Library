...
data SubscriptionsTrialsResourceEndBehavior = SubscriptionsTrialsResourceEndBehavior {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsTrialsResourceEndBehavior
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["missing_payment_method" Data.Aeson.Types.ToJSON..= subscriptionsTrialsResourceEndBehaviorMissingPaymentMethod obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsTrialsResourceEndBehavior
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "SubscriptionsTrialsResourceEndBehavior" (\obj -> GHC.Base.pure SubscriptionsTrialsResourceEndBehavior GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "missing_payment_method"))}
-- | Create a new 'SubscriptionsTrialsResourceEndBehavior' with all required fields.
mkSubscriptionsTrialsResourceEndBehavior :: SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod' -- ^ 'subscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'
...
data SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod' =
   SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'EnumCancel -- ^ Represents the JSON value @"cancel"@
  | SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'EnumCreateInvoice -- ^ Represents the JSON value @"create_invoice"@
  | SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'EnumPause -- ^ Represents the JSON value @"pause"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'
    where {toJSON (SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "cancel" -> SubscriptionsTrialsResourceEndBehaviorMissingPaymentMethod'EnumCancel
