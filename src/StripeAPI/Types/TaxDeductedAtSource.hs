...
mkTaxDeductedAtSource :: Data.Text.Internal.Text -- ^ 'taxDeductedAtSourceId'
  -> GHC.Types.Int -- ^ 'taxDeductedAtSourcePeriodEnd'
  -> GHC.Types.Int -- ^ 'taxDeductedAtSourcePeriodStart'
  -> Data.Text.Internal.Text -- ^ 'taxDeductedAtSourceTaxDeductionAccountNumber'
  -> TaxDeductedAtSource
mkTaxDeductedAtSource taxDeductedAtSourceId taxDeductedAtSourcePeriodEnd taxDeductedAtSourcePeriodStart taxDeductedAtSourceTaxDeductionAccountNumber = TaxDeductedAtSource{taxDeductedAtSourceId = taxDeductedAtSourceId,
