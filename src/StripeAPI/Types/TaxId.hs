...
data TaxIdOwner'NonNullable = TaxIdOwner'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxIdOwner'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("application" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableApplication obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableType obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableAccount obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("application" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableApplication obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("customer" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableCustomer obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (taxIdOwner'NonNullableType obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdOwner'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxIdOwner'NonNullable" (\obj -> (((GHC.Base.pure TaxIdOwner'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "application")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type"))}
-- | Create a new 'TaxIdOwner'NonNullable' with all required fields.
mkTaxIdOwner'NonNullable :: TaxIdOwner'NonNullable
mkTaxIdOwner'NonNullable = TaxIdOwner'NonNullable{taxIdOwner'NonNullableAccount = GHC.Maybe.Nothing,
...
data TaxIdOwner'NonNullableAccount'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxIdOwner'NonNullableAccount'Variants
    where {toJSON (TaxIdOwner'NonNullableAccount'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (TaxIdOwner'NonNullableAccount'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdOwner'NonNullableAccount'Variants
    where {parseJSON val = case (TaxIdOwner'NonNullableAccount'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((TaxIdOwner'NonNullableAccount'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data TaxIdOwner'NonNullableApplication'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxIdOwner'NonNullableApplication'Variants
    where {toJSON (TaxIdOwner'NonNullableApplication'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (TaxIdOwner'NonNullableApplication'Application a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdOwner'NonNullableApplication'Variants
    where {parseJSON val = case (TaxIdOwner'NonNullableApplication'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((TaxIdOwner'NonNullableApplication'Application Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data TaxIdOwner'NonNullableCustomer'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxIdOwner'NonNullableCustomer'Variants
    where {toJSON (TaxIdOwner'NonNullableCustomer'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (TaxIdOwner'NonNullableCustomer'Customer a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdOwner'NonNullableCustomer'Variants
    where {parseJSON val = case (TaxIdOwner'NonNullableCustomer'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((TaxIdOwner'NonNullableCustomer'Customer Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
...
data TaxIdOwner'NonNullableType' =
   TaxIdOwner'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxIdOwner'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxIdOwner'NonNullableType'EnumAccount -- ^ Represents the JSON value @"account"@
  | TaxIdOwner'NonNullableType'EnumApplication -- ^ Represents the JSON value @"application"@
  | TaxIdOwner'NonNullableType'EnumCustomer -- ^ Represents the JSON value @"customer"@
  | TaxIdOwner'NonNullableType'EnumSelf -- ^ Represents the JSON value @"self"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxIdOwner'NonNullableType'
    where {toJSON (TaxIdOwner'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdOwner'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account" -> TaxIdOwner'NonNullableType'EnumAccount
...
data TaxIdType' =
  ...
  | TaxIdType'EnumAdNrt -- ^ Represents the JSON value @"ad_nrt"@
  | TaxIdType'EnumAeTrn -- ^ Represents the JSON value @"ae_trn"@
  | TaxIdType'EnumAlTin -- ^ Represents the JSON value @"al_tin"@
  | TaxIdType'EnumAmTin -- ^ Represents the JSON value @"am_tin"@
  | TaxIdType'EnumAoTin -- ^ Represents the JSON value @"ao_tin"@
  | TaxIdType'EnumArCuit -- ^ Represents the JSON value @"ar_cuit"@
  | TaxIdType'EnumAuAbn -- ^ Represents the JSON value @"au_abn"@
  | TaxIdType'EnumAuArn -- ^ Represents the JSON value @"au_arn"@
  | TaxIdType'EnumAwTin -- ^ Represents the JSON value @"aw_tin"@
  | TaxIdType'EnumAzTin -- ^ Represents the JSON value @"az_tin"@
  | TaxIdType'EnumBaTin -- ^ Represents the JSON value @"ba_tin"@
  | TaxIdType'EnumBbTin -- ^ Represents the JSON value @"bb_tin"@
  | TaxIdType'EnumBdBin -- ^ Represents the JSON value @"bd_bin"@
  | TaxIdType'EnumBfIfu -- ^ Represents the JSON value @"bf_ifu"@
  | TaxIdType'EnumBgUic -- ^ Represents the JSON value @"bg_uic"@
  | TaxIdType'EnumBhVat -- ^ Represents the JSON value @"bh_vat"@
  | TaxIdType'EnumBjIfu -- ^ Represents the JSON value @"bj_ifu"@
  | TaxIdType'EnumBoTin -- ^ Represents the JSON value @"bo_tin"@
  | TaxIdType'EnumBrCnpj -- ^ Represents the JSON value @"br_cnpj"@
  | TaxIdType'EnumBrCpf -- ^ Represents the JSON value @"br_cpf"@
  | TaxIdType'EnumBsTin -- ^ Represents the JSON value @"bs_tin"@
  | TaxIdType'EnumByTin -- ^ Represents the JSON value @"by_tin"@
  ...
  | TaxIdType'EnumCdNif -- ^ Represents the JSON value @"cd_nif"@
  | TaxIdType'EnumChUid -- ^ Represents the JSON value @"ch_uid"@
  | TaxIdType'EnumChVat -- ^ Represents the JSON value @"ch_vat"@
  | TaxIdType'EnumClTin -- ^ Represents the JSON value @"cl_tin"@
  | TaxIdType'EnumCmNiu -- ^ Represents the JSON value @"cm_niu"@
  | TaxIdType'EnumCnTin -- ^ Represents the JSON value @"cn_tin"@
  | TaxIdType'EnumCoNit -- ^ Represents the JSON value @"co_nit"@
  | TaxIdType'EnumCrTin -- ^ Represents the JSON value @"cr_tin"@
  | TaxIdType'EnumCvNif -- ^ Represents the JSON value @"cv_nif"@
  | TaxIdType'EnumDeStn -- ^ Represents the JSON value @"de_stn"@
  | TaxIdType'EnumDoRcn -- ^ Represents the JSON value @"do_rcn"@
  | TaxIdType'EnumEcRuc -- ^ Represents the JSON value @"ec_ruc"@
  | TaxIdType'EnumEgTin -- ^ Represents the JSON value @"eg_tin"@
  | TaxIdType'EnumEsCif -- ^ Represents the JSON value @"es_cif"@
  | TaxIdType'EnumEtTin -- ^ Represents the JSON value @"et_tin"@
  ...
  | TaxIdType'EnumGnNif -- ^ Represents the JSON value @"gn_nif"@
  | TaxIdType'EnumHkBr -- ^ Represents the JSON value @"hk_br"@
  | TaxIdType'EnumHrOib -- ^ Represents the JSON value @"hr_oib"@
  ...
  | TaxIdType'EnumJpTrn -- ^ Represents the JSON value @"jp_trn"@
  | TaxIdType'EnumKePin -- ^ Represents the JSON value @"ke_pin"@
  | TaxIdType'EnumKgTin -- ^ Represents the JSON value @"kg_tin"@
  | TaxIdType'EnumKhTin -- ^ Represents the JSON value @"kh_tin"@
  | TaxIdType'EnumKrBrn -- ^ Represents the JSON value @"kr_brn"@
  | TaxIdType'EnumKzBin -- ^ Represents the JSON value @"kz_bin"@
  | TaxIdType'EnumLaTin -- ^ Represents the JSON value @"la_tin"@
  | TaxIdType'EnumLiUid -- ^ Represents the JSON value @"li_uid"@
  | TaxIdType'EnumLiVat -- ^ Represents the JSON value @"li_vat"@
  | TaxIdType'EnumMaVat -- ^ Represents the JSON value @"ma_vat"@
  | TaxIdType'EnumMdVat -- ^ Represents the JSON value @"md_vat"@
  | TaxIdType'EnumMePib -- ^ Represents the JSON value @"me_pib"@
  | TaxIdType'EnumMkVat -- ^ Represents the JSON value @"mk_vat"@
  | TaxIdType'EnumMrNif -- ^ Represents the JSON value @"mr_nif"@
  ...
  | TaxIdType'EnumNgTin -- ^ Represents the JSON value @"ng_tin"@
  | TaxIdType'EnumNoVat -- ^ Represents the JSON value @"no_vat"@
  | TaxIdType'EnumNoVoec -- ^ Represents the JSON value @"no_voec"@
  | TaxIdType'EnumNpPan -- ^ Represents the JSON value @"np_pan"@
  | TaxIdType'EnumNzGst -- ^ Represents the JSON value @"nz_gst"@
  | TaxIdType'EnumOmVat -- ^ Represents the JSON value @"om_vat"@
  | TaxIdType'EnumPeRuc -- ^ Represents the JSON value @"pe_ruc"@
  | TaxIdType'EnumPhTin -- ^ Represents the JSON value @"ph_tin"@
  | TaxIdType'EnumRoTin -- ^ Represents the JSON value @"ro_tin"@
  | TaxIdType'EnumRsPib -- ^ Represents the JSON value @"rs_pib"@
  ...
  | TaxIdType'EnumSnNinea -- ^ Represents the JSON value @"sn_ninea"@
  | TaxIdType'EnumSrFin -- ^ Represents the JSON value @"sr_fin"@
  | TaxIdType'EnumSvNit -- ^ Represents the JSON value @"sv_nit"@
  | TaxIdType'EnumThVat -- ^ Represents the JSON value @"th_vat"@
  | TaxIdType'EnumTjTin -- ^ Represents the JSON value @"tj_tin"@
  | TaxIdType'EnumTrTin -- ^ Represents the JSON value @"tr_tin"@
  | TaxIdType'EnumTwVat -- ^ Represents the JSON value @"tw_vat"@
  | TaxIdType'EnumTzVat -- ^ Represents the JSON value @"tz_vat"@
  | TaxIdType'EnumUaVat -- ^ Represents the JSON value @"ua_vat"@
  | TaxIdType'EnumUgTin -- ^ Represents the JSON value @"ug_tin"@
  | TaxIdType'EnumUnknown -- ^ Represents the JSON value @"unknown"@
  | TaxIdType'EnumUsEin -- ^ Represents the JSON value @"us_ein"@
  | TaxIdType'EnumUyRuc -- ^ Represents the JSON value @"uy_ruc"@
  | TaxIdType'EnumUzTin -- ^ Represents the JSON value @"uz_tin"@
  | TaxIdType'EnumUzVat -- ^ Represents the JSON value @"uz_vat"@
  | TaxIdType'EnumVeRif -- ^ Represents the JSON value @"ve_rif"@
  | TaxIdType'EnumVnTin -- ^ Represents the JSON value @"vn_tin"@
  | TaxIdType'EnumZaVat -- ^ Represents the JSON value @"za_vat"@
  | TaxIdType'EnumZmTin -- ^ Represents the JSON value @"zm_tin"@
  | TaxIdType'EnumZwTin -- ^ Represents the JSON value @"zw_tin"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxIdType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ad_nrt" -> TaxIdType'EnumAdNrt
