...
data TaxProductResourceJurisdiction = TaxProductResourceJurisdiction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceJurisdiction
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["country" Data.Aeson.Types.ToJSON..= taxProductResourceJurisdictionCountry obj] : ["display_name" Data.Aeson.Types.ToJSON..= taxProductResourceJurisdictionDisplayName obj] : ["level" Data.Aeson.Types.ToJSON..= taxProductResourceJurisdictionLevel obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("state" Data.Aeson.Types.ToJSON..=)) (taxProductResourceJurisdictionState obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceJurisdiction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceJurisdiction" (\obj -> (((GHC.Base.pure TaxProductResourceJurisdiction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "display_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "level")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "state"))}
-- | Create a new 'TaxProductResourceJurisdiction' with all required fields.
mkTaxProductResourceJurisdiction :: Data.Text.Internal.Text -- ^ 'taxProductResourceJurisdictionCountry'
  -> Data.Text.Internal.Text -- ^ 'taxProductResourceJurisdictionDisplayName'
  -> TaxProductResourceJurisdictionLevel' -- ^ 'taxProductResourceJurisdictionLevel'
  -> TaxProductResourceJurisdiction
mkTaxProductResourceJurisdiction taxProductResourceJurisdictionCountry taxProductResourceJurisdictionDisplayName taxProductResourceJurisdictionLevel = TaxProductResourceJurisdiction{taxProductResourceJurisdictionCountry = taxProductResourceJurisdictionCountry,
...
data TaxProductResourceJurisdictionLevel' =
   TaxProductResourceJurisdictionLevel'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceJurisdictionLevel'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceJurisdictionLevel'EnumCity -- ^ Represents the JSON value @"city"@
  | TaxProductResourceJurisdictionLevel'EnumCountry -- ^ Represents the JSON value @"country"@
  | TaxProductResourceJurisdictionLevel'EnumCounty -- ^ Represents the JSON value @"county"@
  | TaxProductResourceJurisdictionLevel'EnumDistrict -- ^ Represents the JSON value @"district"@
  | TaxProductResourceJurisdictionLevel'EnumState -- ^ Represents the JSON value @"state"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceJurisdictionLevel'
    where {toJSON (TaxProductResourceJurisdictionLevel'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceJurisdictionLevel'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "city" -> TaxProductResourceJurisdictionLevel'EnumCity
