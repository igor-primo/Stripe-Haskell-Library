...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxBreakdown
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceLineItemTaxBreakdown" (\obj -> (((((GHC.Base.pure TaxProductResourceLineItemTaxBreakdown GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "jurisdiction")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "sourcing")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_rate_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxability_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxable_amount"))}
-- | Create a new 'TaxProductResourceLineItemTaxBreakdown' with all required fields.
mkTaxProductResourceLineItemTaxBreakdown :: GHC.Types.Int -- ^ 'taxProductResourceLineItemTaxBreakdownAmount'
  -> TaxProductResourceJurisdiction -- ^ 'taxProductResourceLineItemTaxBreakdownJurisdiction'
  -> TaxProductResourceLineItemTaxBreakdownSourcing' -- ^ 'taxProductResourceLineItemTaxBreakdownSourcing'
  -> TaxProductResourceLineItemTaxBreakdownTaxabilityReason' -- ^ 'taxProductResourceLineItemTaxBreakdownTaxabilityReason'
  -> GHC.Types.Int -- ^ 'taxProductResourceLineItemTaxBreakdownTaxableAmount'
  -> TaxProductResourceLineItemTaxBreakdown
mkTaxProductResourceLineItemTaxBreakdown taxProductResourceLineItemTaxBreakdownAmount taxProductResourceLineItemTaxBreakdownJurisdiction taxProductResourceLineItemTaxBreakdownSourcing taxProductResourceLineItemTaxBreakdownTaxabilityReason taxProductResourceLineItemTaxBreakdownTaxableAmount = TaxProductResourceLineItemTaxBreakdown{taxProductResourceLineItemTaxBreakdownAmount = taxProductResourceLineItemTaxBreakdownAmount,
...
data TaxProductResourceLineItemTaxBreakdownSourcing' =
   TaxProductResourceLineItemTaxBreakdownSourcing'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceLineItemTaxBreakdownSourcing'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceLineItemTaxBreakdownSourcing'EnumDestination -- ^ Represents the JSON value @"destination"@
  | TaxProductResourceLineItemTaxBreakdownSourcing'EnumOrigin -- ^ Represents the JSON value @"origin"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxBreakdownSourcing'
    where {toJSON (TaxProductResourceLineItemTaxBreakdownSourcing'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxBreakdownSourcing'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "destination" -> TaxProductResourceLineItemTaxBreakdownSourcing'EnumDestination
...
data TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullable = TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullable
...
mkTaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullable = TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullable{taxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableDisplayName = GHC.Maybe.Nothing,
...
data TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType' =
   TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumAmusementTax -- ^ Represents the JSON value @"amusement_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumCommunicationsTax -- ^ Represents the JSON value @"communications_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumGst -- ^ Represents the JSON value @"gst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumHst -- ^ Represents the JSON value @"hst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumIgst -- ^ Represents the JSON value @"igst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumJct -- ^ Represents the JSON value @"jct"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumLeaseTax -- ^ Represents the JSON value @"lease_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumPst -- ^ Represents the JSON value @"pst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumQst -- ^ Represents the JSON value @"qst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumRetailDeliveryFee -- ^ Represents the JSON value @"retail_delivery_fee"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumRst -- ^ Represents the JSON value @"rst"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumSalesTax -- ^ Represents the JSON value @"sales_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumServiceTax -- ^ Represents the JSON value @"service_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumVat -- ^ Represents the JSON value @"vat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'
    where {toJSON (TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'Other val) = val;
           ...
           toJSON (TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumRetailDeliveryFee) = "retail_delivery_fee";
           ...
           toJSON (TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumServiceTax) = "service_tax";
           toJSON (TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumVat) = "vat"}
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amusement_tax" -> TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumAmusementTax
                                             ...
                                             | val GHC.Classes.== "retail_delivery_fee" -> TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumRetailDeliveryFee
                                             ...
                                             | val GHC.Classes.== "service_tax" -> TaxProductResourceLineItemTaxBreakdownTaxRateDetails'NonNullableTaxType'EnumServiceTax
...
data TaxProductResourceLineItemTaxBreakdownTaxabilityReason' =
   TaxProductResourceLineItemTaxBreakdownTaxabilityReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumCustomerExempt -- ^ Represents the JSON value @"customer_exempt"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumNotCollecting -- ^ Represents the JSON value @"not_collecting"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumNotSubjectToTax -- ^ Represents the JSON value @"not_subject_to_tax"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumNotSupported -- ^ Represents the JSON value @"not_supported"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumPortionProductExempt -- ^ Represents the JSON value @"portion_product_exempt"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumPortionReducedRated -- ^ Represents the JSON value @"portion_reduced_rated"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumPortionStandardRated -- ^ Represents the JSON value @"portion_standard_rated"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumProductExempt -- ^ Represents the JSON value @"product_exempt"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumProductExemptHoliday -- ^ Represents the JSON value @"product_exempt_holiday"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumProportionallyRated -- ^ Represents the JSON value @"proportionally_rated"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumReducedRated -- ^ Represents the JSON value @"reduced_rated"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumReverseCharge -- ^ Represents the JSON value @"reverse_charge"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumStandardRated -- ^ Represents the JSON value @"standard_rated"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumTaxableBasisReduced -- ^ Represents the JSON value @"taxable_basis_reduced"@
  | TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumZeroRated -- ^ Represents the JSON value @"zero_rated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxBreakdownTaxabilityReason'
    where {toJSON (TaxProductResourceLineItemTaxBreakdownTaxabilityReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxBreakdownTaxabilityReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_exempt" -> TaxProductResourceLineItemTaxBreakdownTaxabilityReason'EnumCustomerExempt
