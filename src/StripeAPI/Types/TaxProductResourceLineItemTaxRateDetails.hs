...
data TaxProductResourceLineItemTaxRateDetails = TaxProductResourceLineItemTaxRateDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxRateDetails
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["display_name" Data.Aeson.Types.ToJSON..= taxProductResourceLineItemTaxRateDetailsDisplayName obj] : ["percentage_decimal" Data.Aeson.Types.ToJSON..= taxProductResourceLineItemTaxRateDetailsPercentageDecimal obj] : ["tax_type" Data.Aeson.Types.ToJSON..= taxProductResourceLineItemTaxRateDetailsTaxType obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxRateDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceLineItemTaxRateDetails" (\obj -> ((GHC.Base.pure TaxProductResourceLineItemTaxRateDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "display_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "percentage_decimal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_type"))}
-- | Create a new 'TaxProductResourceLineItemTaxRateDetails' with all required fields.
mkTaxProductResourceLineItemTaxRateDetails :: Data.Text.Internal.Text -- ^ 'taxProductResourceLineItemTaxRateDetailsDisplayName'
  -> Data.Text.Internal.Text -- ^ 'taxProductResourceLineItemTaxRateDetailsPercentageDecimal'
  -> TaxProductResourceLineItemTaxRateDetailsTaxType' -- ^ 'taxProductResourceLineItemTaxRateDetailsTaxType'
  -> TaxProductResourceLineItemTaxRateDetails
mkTaxProductResourceLineItemTaxRateDetails taxProductResourceLineItemTaxRateDetailsDisplayName taxProductResourceLineItemTaxRateDetailsPercentageDecimal taxProductResourceLineItemTaxRateDetailsTaxType = TaxProductResourceLineItemTaxRateDetails{taxProductResourceLineItemTaxRateDetailsDisplayName = taxProductResourceLineItemTaxRateDetailsDisplayName,
...
data TaxProductResourceLineItemTaxRateDetailsTaxType' =
   TaxProductResourceLineItemTaxRateDetailsTaxType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceLineItemTaxRateDetailsTaxType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumAmusementTax -- ^ Represents the JSON value @"amusement_tax"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumCommunicationsTax -- ^ Represents the JSON value @"communications_tax"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumGst -- ^ Represents the JSON value @"gst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumHst -- ^ Represents the JSON value @"hst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumIgst -- ^ Represents the JSON value @"igst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumJct -- ^ Represents the JSON value @"jct"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumLeaseTax -- ^ Represents the JSON value @"lease_tax"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumPst -- ^ Represents the JSON value @"pst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumQst -- ^ Represents the JSON value @"qst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumRetailDeliveryFee -- ^ Represents the JSON value @"retail_delivery_fee"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumRst -- ^ Represents the JSON value @"rst"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumSalesTax -- ^ Represents the JSON value @"sales_tax"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumServiceTax -- ^ Represents the JSON value @"service_tax"@
  | TaxProductResourceLineItemTaxRateDetailsTaxType'EnumVat -- ^ Represents the JSON value @"vat"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceLineItemTaxRateDetailsTaxType'
    where {toJSON (TaxProductResourceLineItemTaxRateDetailsTaxType'Other val) = val;
           ...
           toJSON (TaxProductResourceLineItemTaxRateDetailsTaxType'EnumRetailDeliveryFee) = "retail_delivery_fee";
           ...
           toJSON (TaxProductResourceLineItemTaxRateDetailsTaxType'EnumServiceTax) = "service_tax";
           toJSON (TaxProductResourceLineItemTaxRateDetailsTaxType'EnumVat) = "vat"}
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceLineItemTaxRateDetailsTaxType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "amusement_tax" -> TaxProductResourceLineItemTaxRateDetailsTaxType'EnumAmusementTax
                                             ...
                                             | val GHC.Classes.== "retail_delivery_fee" -> TaxProductResourceLineItemTaxRateDetailsTaxType'EnumRetailDeliveryFee
                                             ...
                                             | val GHC.Classes.== "service_tax" -> TaxProductResourceLineItemTaxRateDetailsTaxType'EnumServiceTax
