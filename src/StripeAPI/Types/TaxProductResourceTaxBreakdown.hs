...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxBreakdown
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceTaxBreakdown" (\obj -> ((((GHC.Base.pure TaxProductResourceTaxBreakdown GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "inclusive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_rate_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxability_reason")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "taxable_amount"))}
-- | Create a new 'TaxProductResourceTaxBreakdown' with all required fields.
mkTaxProductResourceTaxBreakdown :: GHC.Types.Int -- ^ 'taxProductResourceTaxBreakdownAmount'
  -> GHC.Types.Bool -- ^ 'taxProductResourceTaxBreakdownInclusive'
  -> TaxProductResourceTaxRateDetails -- ^ 'taxProductResourceTaxBreakdownTaxRateDetails'
  -> TaxProductResourceTaxBreakdownTaxabilityReason' -- ^ 'taxProductResourceTaxBreakdownTaxabilityReason'
  -> GHC.Types.Int -- ^ 'taxProductResourceTaxBreakdownTaxableAmount'
  -> TaxProductResourceTaxBreakdown
mkTaxProductResourceTaxBreakdown taxProductResourceTaxBreakdownAmount taxProductResourceTaxBreakdownInclusive taxProductResourceTaxBreakdownTaxRateDetails taxProductResourceTaxBreakdownTaxabilityReason taxProductResourceTaxBreakdownTaxableAmount = TaxProductResourceTaxBreakdown{taxProductResourceTaxBreakdownAmount = taxProductResourceTaxBreakdownAmount,
...
data TaxProductResourceTaxBreakdownTaxabilityReason' =
   TaxProductResourceTaxBreakdownTaxabilityReason'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceTaxBreakdownTaxabilityReason'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumCustomerExempt -- ^ Represents the JSON value @"customer_exempt"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumNotCollecting -- ^ Represents the JSON value @"not_collecting"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumNotSubjectToTax -- ^ Represents the JSON value @"not_subject_to_tax"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumNotSupported -- ^ Represents the JSON value @"not_supported"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumPortionProductExempt -- ^ Represents the JSON value @"portion_product_exempt"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumPortionReducedRated -- ^ Represents the JSON value @"portion_reduced_rated"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumPortionStandardRated -- ^ Represents the JSON value @"portion_standard_rated"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumProductExempt -- ^ Represents the JSON value @"product_exempt"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumProductExemptHoliday -- ^ Represents the JSON value @"product_exempt_holiday"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumProportionallyRated -- ^ Represents the JSON value @"proportionally_rated"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumReducedRated -- ^ Represents the JSON value @"reduced_rated"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumReverseCharge -- ^ Represents the JSON value @"reverse_charge"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumStandardRated -- ^ Represents the JSON value @"standard_rated"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumTaxableBasisReduced -- ^ Represents the JSON value @"taxable_basis_reduced"@
  | TaxProductResourceTaxBreakdownTaxabilityReason'EnumZeroRated -- ^ Represents the JSON value @"zero_rated"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxBreakdownTaxabilityReason'
    where {toJSON (TaxProductResourceTaxBreakdownTaxabilityReason'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxBreakdownTaxabilityReason'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "customer_exempt" -> TaxProductResourceTaxBreakdownTaxabilityReason'EnumCustomerExempt
