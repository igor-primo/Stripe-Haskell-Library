...
data TaxProductResourceTaxSettingsDefaults = TaxProductResourceTaxSettingsDefaults {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxSettingsDefaults
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxSettingsDefaults
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceTaxSettingsDefaults" (\obj -> (GHC.Base.pure TaxProductResourceTaxSettingsDefaults GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_code"))}
...
mkTaxProductResourceTaxSettingsDefaults = TaxProductResourceTaxSettingsDefaults{taxProductResourceTaxSettingsDefaultsTaxBehavior = GHC.Maybe.Nothing,
...
data TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullable =
   TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableEnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableEnumInclusive -- ^ Represents the JSON value @"inclusive"@
  | TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableEnumInferredByCurrency -- ^ Represents the JSON value @"inferred_by_currency"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullable
    where {toJSON (TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> TaxProductResourceTaxSettingsDefaultsTaxBehavior'NonNullableEnumExclusive
