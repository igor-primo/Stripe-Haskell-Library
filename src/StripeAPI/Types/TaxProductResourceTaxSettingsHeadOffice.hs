...
data TaxProductResourceTaxSettingsHeadOffice = TaxProductResourceTaxSettingsHeadOffice {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxSettingsHeadOffice
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["address" Data.Aeson.Types.ToJSON..= taxProductResourceTaxSettingsHeadOfficeAddress obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxSettingsHeadOffice
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceTaxSettingsHeadOffice" (\obj -> GHC.Base.pure TaxProductResourceTaxSettingsHeadOffice GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "address"))}
-- | Create a new 'TaxProductResourceTaxSettingsHeadOffice' with all required fields.
mkTaxProductResourceTaxSettingsHeadOffice :: Address -- ^ 'taxProductResourceTaxSettingsHeadOfficeAddress'
