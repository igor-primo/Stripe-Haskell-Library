...
data TaxProductResourceTaxTransactionShippingCost = TaxProductResourceTaxTransactionShippingCost {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxTransactionShippingCost
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["amount" Data.Aeson.Types.ToJSON..= taxProductResourceTaxTransactionShippingCostAmount obj] : ["amount_tax" Data.Aeson.Types.ToJSON..= taxProductResourceTaxTransactionShippingCostAmountTax obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("shipping_rate" Data.Aeson.Types.ToJSON..=)) (taxProductResourceTaxTransactionShippingCostShippingRate obj) : ["tax_behavior" Data.Aeson.Types.ToJSON..= taxProductResourceTaxTransactionShippingCostTaxBehavior obj] : ["tax_code" Data.Aeson.Types.ToJSON..= taxProductResourceTaxTransactionShippingCostTaxCode obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxTransactionShippingCost
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxProductResourceTaxTransactionShippingCost" (\obj -> ((((GHC.Base.pure TaxProductResourceTaxTransactionShippingCost GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_code"))}
-- | Create a new 'TaxProductResourceTaxTransactionShippingCost' with all required fields.
mkTaxProductResourceTaxTransactionShippingCost :: GHC.Types.Int -- ^ 'taxProductResourceTaxTransactionShippingCostAmount'
  -> GHC.Types.Int -- ^ 'taxProductResourceTaxTransactionShippingCostAmountTax'
  -> TaxProductResourceTaxTransactionShippingCostTaxBehavior' -- ^ 'taxProductResourceTaxTransactionShippingCostTaxBehavior'
  -> Data.Text.Internal.Text -- ^ 'taxProductResourceTaxTransactionShippingCostTaxCode'
  -> TaxProductResourceTaxTransactionShippingCost
mkTaxProductResourceTaxTransactionShippingCost taxProductResourceTaxTransactionShippingCostAmount taxProductResourceTaxTransactionShippingCostAmountTax taxProductResourceTaxTransactionShippingCostTaxBehavior taxProductResourceTaxTransactionShippingCostTaxCode = TaxProductResourceTaxTransactionShippingCost{taxProductResourceTaxTransactionShippingCostAmount = taxProductResourceTaxTransactionShippingCostAmount,
...
data TaxProductResourceTaxTransactionShippingCostTaxBehavior' =
   TaxProductResourceTaxTransactionShippingCostTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxProductResourceTaxTransactionShippingCostTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxProductResourceTaxTransactionShippingCostTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | TaxProductResourceTaxTransactionShippingCostTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxProductResourceTaxTransactionShippingCostTaxBehavior'
    where {toJSON (TaxProductResourceTaxTransactionShippingCostTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxProductResourceTaxTransactionShippingCostTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> TaxProductResourceTaxTransactionShippingCostTaxBehavior'EnumExclusive
