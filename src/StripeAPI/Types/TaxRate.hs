...
data TaxRateFlatAmount'NonNullable = TaxRateFlatAmount'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxRateFlatAmount'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxRateFlatAmount'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TaxRateFlatAmount'NonNullable" (\obj -> (GHC.Base.pure TaxRateFlatAmount'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "currency"))}
...
mkTaxRateFlatAmount'NonNullable = TaxRateFlatAmount'NonNullable{taxRateFlatAmount'NonNullableAmount = GHC.Maybe.Nothing,
...
data TaxRateRateType'NonNullable =
   TaxRateRateType'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TaxRateRateType'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TaxRateRateType'NonNullableEnumFlatAmount -- ^ Represents the JSON value @"flat_amount"@
  | TaxRateRateType'NonNullableEnumPercentage -- ^ Represents the JSON value @"percentage"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TaxRateRateType'NonNullable
    where {toJSON (TaxRateRateType'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TaxRateRateType'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "flat_amount" -> TaxRateRateType'NonNullableEnumFlatAmount
...
data TaxRateTaxType'NonNullable =
  ...
  | TaxRateTaxType'NonNullableEnumRetailDeliveryFee -- ^ Represents the JSON value @"retail_delivery_fee"@
