...
data Tax'calculation = Tax'calculation {
  ...
  , tax'calculationShipFromDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Tax'calculationShipFromDetails'NonNullable))
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculation
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'calculation" (\obj -> (((((((((((((GHC.Base.pure Tax'calculation GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_total")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ship_from_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_cost")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_amount_exclusive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_amount_inclusive")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_breakdown")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_date"))}
-- | Create a new 'Tax'calculation' with all required fields.
mkTax'calculation :: GHC.Types.Int -- ^ 'tax'calculationAmountTotal'
  -> Data.Text.Internal.Text -- ^ 'tax'calculationCurrency'
  -> TaxProductResourceCustomerDetails -- ^ 'tax'calculationCustomerDetails'
  -> GHC.Types.Bool -- ^ 'tax'calculationLivemode'
  -> GHC.Types.Int -- ^ 'tax'calculationTaxAmountExclusive'
  -> GHC.Types.Int -- ^ 'tax'calculationTaxAmountInclusive'
  -> [TaxProductResourceTaxBreakdown] -- ^ 'tax'calculationTaxBreakdown'
  -> GHC.Types.Int -- ^ 'tax'calculationTaxDate'
  -> Tax'calculation
mkTax'calculation tax'calculationAmountTotal tax'calculationCurrency tax'calculationCustomerDetails tax'calculationLivemode tax'calculationTaxAmountExclusive tax'calculationTaxAmountInclusive tax'calculationTaxBreakdown tax'calculationTaxDate = Tax'calculation{tax'calculationAmountTotal = tax'calculationAmountTotal,
                                                                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                                                                     tax'calculationShipFromDetails = GHC.Maybe.Nothing,
...
data Tax'calculationLineItems'NonNullable = Tax'calculationLineItems'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'calculationLineItems'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["data" Data.Aeson.Types.ToJSON..= tax'calculationLineItems'NonNullableData obj] : ["has_more" Data.Aeson.Types.ToJSON..= tax'calculationLineItems'NonNullableHasMore obj] : ["url" Data.Aeson.Types.ToJSON..= tax'calculationLineItems'NonNullableUrl obj] : ["object" Data.Aeson.Types.ToJSON..= Data.Aeson.Types.Internal.String "list"] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculationLineItems'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'calculationLineItems'NonNullable" (\obj -> ((GHC.Base.pure Tax'calculationLineItems'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'Tax'calculationLineItems'NonNullable' with all required fields.
mkTax'calculationLineItems'NonNullable :: [Tax'calculationLineItem] -- ^ 'tax'calculationLineItems'NonNullableData'
  -> GHC.Types.Bool -- ^ 'tax'calculationLineItems'NonNullableHasMore'
  -> Data.Text.Internal.Text -- ^ 'tax'calculationLineItems'NonNullableUrl'
  -> Tax'calculationLineItems'NonNullable
mkTax'calculationLineItems'NonNullable tax'calculationLineItems'NonNullableData tax'calculationLineItems'NonNullableHasMore tax'calculationLineItems'NonNullableUrl = Tax'calculationLineItems'NonNullable{tax'calculationLineItems'NonNullableData = tax'calculationLineItems'NonNullableData,
...
-- | Defines the object schema located at @components.schemas.tax.calculation.properties.ship_from_details.anyOf@ in the specification.
-- 
-- The details of the ship from location, such as the address.
data Tax'calculationShipFromDetails'NonNullable = Tax'calculationShipFromDetails'NonNullable {
  -- | address: 
  tax'calculationShipFromDetails'NonNullableAddress :: (GHC.Maybe.Maybe TaxProductResourcePostalAddress)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'calculationShipFromDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (tax'calculationShipFromDetails'NonNullableAddress obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (tax'calculationShipFromDetails'NonNullableAddress obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculationShipFromDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'calculationShipFromDetails'NonNullable" (\obj -> GHC.Base.pure Tax'calculationShipFromDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address"))}
-- | Create a new 'Tax'calculationShipFromDetails'NonNullable' with all required fields.
mkTax'calculationShipFromDetails'NonNullable :: Tax'calculationShipFromDetails'NonNullable
mkTax'calculationShipFromDetails'NonNullable = Tax'calculationShipFromDetails'NonNullable{tax'calculationShipFromDetails'NonNullableAddress = GHC.Maybe.Nothing}
...
data Tax'calculationShippingCost'NonNullable = Tax'calculationShippingCost'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'calculationShippingCost'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculationShippingCost'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'calculationShippingCost'NonNullable" (\obj -> (((((GHC.Base.pure Tax'calculationShippingCost'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_breakdown")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_code"))}
...
mkTax'calculationShippingCost'NonNullable = Tax'calculationShippingCost'NonNullable{tax'calculationShippingCost'NonNullableAmount = GHC.Maybe.Nothing,
...
data Tax'calculationShippingCost'NonNullableTaxBehavior' =
   Tax'calculationShippingCost'NonNullableTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'calculationShippingCost'NonNullableTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'calculationShippingCost'NonNullableTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | Tax'calculationShippingCost'NonNullableTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'calculationShippingCost'NonNullableTaxBehavior'
    where {toJSON (Tax'calculationShippingCost'NonNullableTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculationShippingCost'NonNullableTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> Tax'calculationShippingCost'NonNullableTaxBehavior'EnumExclusive
