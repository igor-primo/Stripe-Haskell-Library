...
data Tax'calculationLineItem = Tax'calculationLineItem {
  ...
  , tax'calculationLineItemMetadata :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Aeson.Types.Internal.Object))
  ...
  -- 
  -- * Maximum length of 5000
  , tax'calculationLineItemReference :: Data.Text.Internal.Text
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'calculationLineItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'calculationLineItem" (\obj -> ((((((((((GHC.Base.pure Tax'calculationLineItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_breakdown")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_code"))}
...
mkTax'calculationLineItem tax'calculationLineItemAmount tax'calculationLineItemAmountTax tax'calculationLineItemId tax'calculationLineItemLivemode tax'calculationLineItemQuantity tax'calculationLineItemReference tax'calculationLineItemTaxBehavior tax'calculationLineItemTaxCode = Tax'calculationLineItem{tax'calculationLineItemAmount = tax'calculationLineItemAmount,
                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                tax'calculationLineItemMetadata = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                                                                                tax'calculationLineItemProduct = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                                                                                tax'calculationLineItemQuantity = tax'calculationLineItemQuantity,
                                                                                                                                                                                                                                                                                                                tax'calculationLineItemReference = tax'calculationLineItemReference,
                                                                                                                                                                                                                                                                                                                tax'calculationLineItemTaxBehavior = tax'calculationLineItemTaxBehavior,
