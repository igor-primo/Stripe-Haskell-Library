...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'registration
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'registration" (\obj -> (((((((GHC.Base.pure Tax'registration GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "active_from")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "country_options")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "expires_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status"))}
-- | Create a new 'Tax'registration' with all required fields.
mkTax'registration :: GHC.Types.Int -- ^ 'tax'registrationActiveFrom'
  -> Data.Text.Internal.Text -- ^ 'tax'registrationCountry'
  -> TaxProductRegistrationsResourceCountryOptions -- ^ 'tax'registrationCountryOptions'
  -> GHC.Types.Int -- ^ 'tax'registrationCreated'
  -> Data.Text.Internal.Text -- ^ 'tax'registrationId'
  -> GHC.Types.Bool -- ^ 'tax'registrationLivemode'
  -> Tax'registrationStatus' -- ^ 'tax'registrationStatus'
  -> Tax'registration
mkTax'registration tax'registrationActiveFrom tax'registrationCountry tax'registrationCountryOptions tax'registrationCreated tax'registrationId tax'registrationLivemode tax'registrationStatus = Tax'registration{tax'registrationActiveFrom = tax'registrationActiveFrom,
...
data Tax'registrationStatus' =
   Tax'registrationStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'registrationStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'registrationStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | Tax'registrationStatus'EnumExpired -- ^ Represents the JSON value @"expired"@
  | Tax'registrationStatus'EnumScheduled -- ^ Represents the JSON value @"scheduled"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'registrationStatus'
    where {toJSON (Tax'registrationStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'registrationStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> Tax'registrationStatus'EnumActive
