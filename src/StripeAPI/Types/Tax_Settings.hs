...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'settings
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'settings" (\obj -> ((((GHC.Base.pure Tax'settings GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "defaults")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "head_office")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status_details"))}
-- | Create a new 'Tax'settings' with all required fields.
mkTax'settings :: TaxProductResourceTaxSettingsDefaults -- ^ 'tax'settingsDefaults'
  -> GHC.Types.Bool -- ^ 'tax'settingsLivemode'
  -> Tax'settingsStatus' -- ^ 'tax'settingsStatus'
  -> TaxProductResourceTaxSettingsStatusDetails -- ^ 'tax'settingsStatusDetails'
  -> Tax'settings
mkTax'settings tax'settingsDefaults tax'settingsLivemode tax'settingsStatus tax'settingsStatusDetails = Tax'settings{tax'settingsDefaults = tax'settingsDefaults,
...
data Tax'settingsHeadOffice'NonNullable = Tax'settingsHeadOffice'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'settingsHeadOffice'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (tax'settingsHeadOffice'NonNullableAddress obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'settingsHeadOffice'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'settingsHeadOffice'NonNullable" (\obj -> GHC.Base.pure Tax'settingsHeadOffice'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address"))}
...
data Tax'settingsStatus' =
   Tax'settingsStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'settingsStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'settingsStatus'EnumActive -- ^ Represents the JSON value @"active"@
  | Tax'settingsStatus'EnumPending -- ^ Represents the JSON value @"pending"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'settingsStatus'
    where {toJSON (Tax'settingsStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'settingsStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "active" -> Tax'settingsStatus'EnumActive
