...
import {-# SOURCE #-} StripeAPI.Types.TaxProductResourceShipFromDetails
...
data Tax'transaction = Tax'transaction {
  ...
  , tax'transactionPostedAt :: GHC.Types.Int
  ...
  , tax'transactionShipFromDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Tax'transactionShipFromDetails'NonNullable))
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transaction" (\obj -> ((((((((((((((GHC.Base.pure Tax'transaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "customer")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "customer_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "posted_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reversal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ship_from_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_cost")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_date")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'Tax'transaction' with all required fields.
mkTax'transaction :: GHC.Types.Int -- ^ 'tax'transactionCreated'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionCurrency'
  -> TaxProductResourceCustomerDetails -- ^ 'tax'transactionCustomerDetails'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionId'
  -> GHC.Types.Bool -- ^ 'tax'transactionLivemode'
  -> GHC.Types.Int -- ^ 'tax'transactionPostedAt'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionReference'
  -> GHC.Types.Int -- ^ 'tax'transactionTaxDate'
  -> Tax'transactionType' -- ^ 'tax'transactionType'
  -> Tax'transaction
mkTax'transaction tax'transactionCreated tax'transactionCurrency tax'transactionCustomerDetails tax'transactionId tax'transactionLivemode tax'transactionPostedAt tax'transactionReference tax'transactionTaxDate tax'transactionType = Tax'transaction{tax'transactionCreated = tax'transactionCreated,
                                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                                        tax'transactionPostedAt = tax'transactionPostedAt,
                                                                                                                                                                                                                                                        tax'transactionReference = tax'transactionReference,
                                                                                                                                                                                                                                                        tax'transactionReversal = GHC.Maybe.Nothing,
                                                                                                                                                                                                                                                        tax'transactionShipFromDetails = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionLineItems'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionLineItems'NonNullable" (\obj -> ((GHC.Base.pure Tax'transactionLineItems'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'Tax'transactionLineItems'NonNullable' with all required fields.
mkTax'transactionLineItems'NonNullable :: [Tax'transactionLineItem] -- ^ 'tax'transactionLineItems'NonNullableData'
  -> GHC.Types.Bool -- ^ 'tax'transactionLineItems'NonNullableHasMore'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionLineItems'NonNullableUrl'
  -> Tax'transactionLineItems'NonNullable
mkTax'transactionLineItems'NonNullable tax'transactionLineItems'NonNullableData tax'transactionLineItems'NonNullableHasMore tax'transactionLineItems'NonNullableUrl = Tax'transactionLineItems'NonNullable{tax'transactionLineItems'NonNullableData = tax'transactionLineItems'NonNullableData,
...
data Tax'transactionReversal'NonNullable = Tax'transactionReversal'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionReversal'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("original_transaction" Data.Aeson.Types.ToJSON..=)) (tax'transactionReversal'NonNullableOriginalTransaction obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionReversal'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionReversal'NonNullable" (\obj -> GHC.Base.pure Tax'transactionReversal'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "original_transaction"))}
...
-- | Defines the object schema located at @components.schemas.tax.transaction.properties.ship_from_details.anyOf@ in the specification.
-- 
-- The details of the ship from location, such as the address.
data Tax'transactionShipFromDetails'NonNullable = Tax'transactionShipFromDetails'NonNullable {
  -- | address: 
  tax'transactionShipFromDetails'NonNullableAddress :: (GHC.Maybe.Maybe TaxProductResourcePostalAddress)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionShipFromDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (tax'transactionShipFromDetails'NonNullableAddress obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("address" Data.Aeson.Types.ToJSON..=)) (tax'transactionShipFromDetails'NonNullableAddress obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionShipFromDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionShipFromDetails'NonNullable" (\obj -> GHC.Base.pure Tax'transactionShipFromDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "address"))}
-- | Create a new 'Tax'transactionShipFromDetails'NonNullable' with all required fields.
mkTax'transactionShipFromDetails'NonNullable :: Tax'transactionShipFromDetails'NonNullable
mkTax'transactionShipFromDetails'NonNullable = Tax'transactionShipFromDetails'NonNullable{tax'transactionShipFromDetails'NonNullableAddress = GHC.Maybe.Nothing}
...
data Tax'transactionShippingCost'NonNullable = Tax'transactionShippingCost'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionShippingCost'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionShippingCost'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionShippingCost'NonNullable" (\obj -> ((((GHC.Base.pure Tax'transactionShippingCost'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "shipping_rate")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax_code"))}
...
mkTax'transactionShippingCost'NonNullable = Tax'transactionShippingCost'NonNullable{tax'transactionShippingCost'NonNullableAmount = GHC.Maybe.Nothing,
...
data Tax'transactionShippingCost'NonNullableTaxBehavior' =
   Tax'transactionShippingCost'NonNullableTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'transactionShippingCost'NonNullableTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'transactionShippingCost'NonNullableTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | Tax'transactionShippingCost'NonNullableTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionShippingCost'NonNullableTaxBehavior'
    where {toJSON (Tax'transactionShippingCost'NonNullableTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionShippingCost'NonNullableTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> Tax'transactionShippingCost'NonNullableTaxBehavior'EnumExclusive
...
data Tax'transactionType' =
   Tax'transactionType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'transactionType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'transactionType'EnumReversal -- ^ Represents the JSON value @"reversal"@
  | Tax'transactionType'EnumTransaction -- ^ Represents the JSON value @"transaction"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionType'
    where {toJSON (Tax'transactionType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "reversal" -> Tax'transactionType'EnumReversal
