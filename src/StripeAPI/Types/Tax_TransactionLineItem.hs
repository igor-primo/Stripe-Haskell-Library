...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionLineItem
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionLineItem" (\obj -> (((((((((((GHC.Base.pure Tax'transactionLineItem GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount_tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "product")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "quantity")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "reference")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reversal")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_behavior")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "tax_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type"))}
-- | Create a new 'Tax'transactionLineItem' with all required fields.
mkTax'transactionLineItem :: GHC.Types.Int -- ^ 'tax'transactionLineItemAmount'
  -> GHC.Types.Int -- ^ 'tax'transactionLineItemAmountTax'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionLineItemId'
  -> GHC.Types.Bool -- ^ 'tax'transactionLineItemLivemode'
  -> GHC.Types.Int -- ^ 'tax'transactionLineItemQuantity'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionLineItemReference'
  -> Tax'transactionLineItemTaxBehavior' -- ^ 'tax'transactionLineItemTaxBehavior'
  -> Data.Text.Internal.Text -- ^ 'tax'transactionLineItemTaxCode'
  -> Tax'transactionLineItemType' -- ^ 'tax'transactionLineItemType'
  -> Tax'transactionLineItem
mkTax'transactionLineItem tax'transactionLineItemAmount tax'transactionLineItemAmountTax tax'transactionLineItemId tax'transactionLineItemLivemode tax'transactionLineItemQuantity tax'transactionLineItemReference tax'transactionLineItemTaxBehavior tax'transactionLineItemTaxCode tax'transactionLineItemType = Tax'transactionLineItem{tax'transactionLineItemAmount = tax'transactionLineItemAmount,
...
data Tax'transactionLineItemReversal'NonNullable = Tax'transactionLineItemReversal'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionLineItemReversal'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("original_line_item" Data.Aeson.Types.ToJSON..=)) (tax'transactionLineItemReversal'NonNullableOriginalLineItem obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionLineItemReversal'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Tax'transactionLineItemReversal'NonNullable" (\obj -> GHC.Base.pure Tax'transactionLineItemReversal'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "original_line_item"))}
...
data Tax'transactionLineItemTaxBehavior' =
   Tax'transactionLineItemTaxBehavior'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'transactionLineItemTaxBehavior'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'transactionLineItemTaxBehavior'EnumExclusive -- ^ Represents the JSON value @"exclusive"@
  | Tax'transactionLineItemTaxBehavior'EnumInclusive -- ^ Represents the JSON value @"inclusive"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionLineItemTaxBehavior'
    where {toJSON (Tax'transactionLineItemTaxBehavior'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionLineItemTaxBehavior'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "exclusive" -> Tax'transactionLineItemTaxBehavior'EnumExclusive
...
data Tax'transactionLineItemType' =
   Tax'transactionLineItemType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Tax'transactionLineItemType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Tax'transactionLineItemType'EnumReversal -- ^ Represents the JSON value @"reversal"@
  | Tax'transactionLineItemType'EnumTransaction -- ^ Represents the JSON value @"transaction"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Tax'transactionLineItemType'
    where {toJSON (Tax'transactionLineItemType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Tax'transactionLineItemType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "reversal" -> Tax'transactionLineItemType'EnumReversal
