...
data TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig = TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("splashscreen" Data.Aeson.Types.ToJSON..=)) (terminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig" (\obj -> GHC.Base.pure TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfig GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "splashscreen"))}
...
instance Data.Aeson.Types.ToJSON.ToJSON TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen'Variants
    where {toJSON (TerminalConfigurationConfigurationResourceDeviceTypeSpecificConfigSplashscreen'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
