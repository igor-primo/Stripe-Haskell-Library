...
data TerminalReaderReaderResourceCart = TerminalReaderReaderResourceCart {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TerminalReaderReaderResourceCart
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["currency" Data.Aeson.Types.ToJSON..= terminalReaderReaderResourceCartCurrency obj] : ["line_items" Data.Aeson.Types.ToJSON..= terminalReaderReaderResourceCartLineItems obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("tax" Data.Aeson.Types.ToJSON..=)) (terminalReaderReaderResourceCartTax obj) : ["total" Data.Aeson.Types.ToJSON..= terminalReaderReaderResourceCartTotal obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TerminalReaderReaderResourceCart
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TerminalReaderReaderResourceCart" (\obj -> (((GHC.Base.pure TerminalReaderReaderResourceCart GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "line_items")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "tax")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "total"))}
-- | Create a new 'TerminalReaderReaderResourceCart' with all required fields.
mkTerminalReaderReaderResourceCart :: Data.Text.Internal.Text -- ^ 'terminalReaderReaderResourceCartCurrency'
  -> [TerminalReaderReaderResourceLineItem] -- ^ 'terminalReaderReaderResourceCartLineItems'
  -> GHC.Types.Int -- ^ 'terminalReaderReaderResourceCartTotal'
  -> TerminalReaderReaderResourceCart
mkTerminalReaderReaderResourceCart terminalReaderReaderResourceCartCurrency terminalReaderReaderResourceCartLineItems terminalReaderReaderResourceCartTotal = TerminalReaderReaderResourceCart{terminalReaderReaderResourceCartCurrency = terminalReaderReaderResourceCartCurrency,
