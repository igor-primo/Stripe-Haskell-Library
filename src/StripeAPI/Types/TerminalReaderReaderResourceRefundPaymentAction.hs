...
import {-# SOURCE #-} StripeAPI.Types.TerminalReaderReaderResourceRefundPaymentConfig
...
data TerminalReaderReaderResourceRefundPaymentAction = TerminalReaderReaderResourceRefundPaymentAction {
  ...
  -- | refund_payment_config: Represents a per-transaction override of a reader configuration
  , terminalReaderReaderResourceRefundPaymentActionRefundPaymentConfig :: (GHC.Maybe.Maybe TerminalReaderReaderResourceRefundPaymentConfig)
...
mkTerminalReaderReaderResourceRefundPaymentAction = TerminalReaderReaderResourceRefundPaymentAction{terminalReaderReaderResourceRefundPaymentActionAmount = GHC.Maybe.Nothing,
                                                                                                    ...
                                                                                                    terminalReaderReaderResourceRefundPaymentActionRefundPaymentConfig = GHC.Maybe.Nothing,
