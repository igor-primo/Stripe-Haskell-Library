...
data TerminalReaderReaderResourceTippingConfig = TerminalReaderReaderResourceTippingConfig {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TerminalReaderReaderResourceTippingConfig
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount_eligible" Data.Aeson.Types.ToJSON..=)) (terminalReaderReaderResourceTippingConfigAmountEligible obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TerminalReaderReaderResourceTippingConfig
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TerminalReaderReaderResourceTippingConfig" (\obj -> GHC.Base.pure TerminalReaderReaderResourceTippingConfig GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "amount_eligible"))}
