...
data Terminal'connectionToken = Terminal'connectionToken {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Terminal'connectionToken
...
instance Data.Aeson.Types.FromJSON.FromJSON Terminal'connectionToken
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Terminal'connectionToken" (\obj -> (GHC.Base.pure Terminal'connectionToken GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "location")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "secret"))}
-- | Create a new 'Terminal'connectionToken' with all required fields.
mkTerminal'connectionToken :: Data.Text.Internal.Text -- ^ 'terminal'connectionTokenSecret'
  -> Terminal'connectionToken
mkTerminal'connectionToken terminal'connectionTokenSecret = Terminal'connectionToken{terminal'connectionTokenLocation = GHC.Maybe.Nothing,
