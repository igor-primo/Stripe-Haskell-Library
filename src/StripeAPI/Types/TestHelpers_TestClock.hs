...
mkTestHelpers'testClock :: GHC.Types.Int -- ^ 'testHelpers'testClockCreated'
  ...
  -> TestHelpers'testClockStatus' -- ^ 'testHelpers'testClockStatus'
  -> BillingClocksResourceStatusDetailsStatusDetails -- ^ 'testHelpers'testClockStatusDetails'
  -> TestHelpers'testClock
mkTestHelpers'testClock testHelpers'testClockCreated testHelpers'testClockDeletesAfter testHelpers'testClockFrozenTime testHelpers'testClockId testHelpers'testClockLivemode testHelpers'testClockStatus testHelpers'testClockStatusDetails = TestHelpers'testClock{testHelpers'testClockCreated = testHelpers'testClockCreated,
