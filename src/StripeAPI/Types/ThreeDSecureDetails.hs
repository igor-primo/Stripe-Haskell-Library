...
data ThreeDSecureDetailsElectronicCommerceIndicator'NonNullable =
   ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum01 -- ^ Represents the JSON value @"01"@
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum02 -- ^ Represents the JSON value @"02"@
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum05 -- ^ Represents the JSON value @"05"@
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum06 -- ^ Represents the JSON value @"06"@
  | ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum07 -- ^ Represents the JSON value @"07"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ThreeDSecureDetailsElectronicCommerceIndicator'NonNullable
    where {toJSON (ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON ThreeDSecureDetailsElectronicCommerceIndicator'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "01" -> ThreeDSecureDetailsElectronicCommerceIndicator'NonNullableEnum01
...
data ThreeDSecureDetailsResult'NonNullable =
  ...
  | ThreeDSecureDetailsResult'NonNullableEnumExempted -- ^ Represents the JSON value @"exempted"@
