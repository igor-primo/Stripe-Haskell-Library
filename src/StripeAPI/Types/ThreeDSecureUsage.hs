...
data ThreeDSecureUsage = ThreeDSecureUsage {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON ThreeDSecureUsage
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["supported" Data.Aeson.Types.ToJSON..= threeDSecureUsageSupported obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["supported" Data.Aeson.Types.ToJSON..= threeDSecureUsageSupported obj] : GHC.Base.mempty)))}
...
mkThreeDSecureUsage :: GHC.Types.Bool -- ^ 'threeDSecureUsageSupported'
  -> ThreeDSecureUsage
