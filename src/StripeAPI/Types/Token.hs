...
data Token = Token {
  ...
  , tokenClientIp :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Token
...
instance Data.Aeson.Types.FromJSON.FromJSON Token
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Token" (\obj -> (((((((GHC.Base.pure Token GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "bank_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "card")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "client_ip")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "used"))}
-- | Create a new 'Token' with all required fields.
mkToken :: GHC.Types.Int -- ^ 'tokenCreated'
  -> Data.Text.Internal.Text -- ^ 'tokenId'
  -> GHC.Types.Bool -- ^ 'tokenLivemode'
  -> Data.Text.Internal.Text -- ^ 'tokenType'
  -> GHC.Types.Bool -- ^ 'tokenUsed'
  -> Token
mkToken tokenCreated tokenId tokenLivemode tokenType tokenUsed = Token{tokenBankAccount = GHC.Maybe.Nothing,
