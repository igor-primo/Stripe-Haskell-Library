...
data TransferData = TransferData {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TransferData
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("amount" Data.Aeson.Types.ToJSON..=)) (transferDataAmount obj) : ["destination" Data.Aeson.Types.ToJSON..= transferDataDestination obj] : GHC.Base.mempty));
...
mkTransferData :: TransferDataDestination'Variants -- ^ 'transferDataDestination'
  -> TransferData
mkTransferData transferDataDestination = TransferData{transferDataAmount = GHC.Maybe.Nothing,
...
instance Data.Aeson.Types.ToJSON.ToJSON TransferDataDestination'Variants
    where {toJSON (TransferDataDestination'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (TransferDataDestination'Account a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON TransferDataDestination'Variants
    where {parseJSON val = case (TransferDataDestination'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((TransferDataDestination'Account Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
