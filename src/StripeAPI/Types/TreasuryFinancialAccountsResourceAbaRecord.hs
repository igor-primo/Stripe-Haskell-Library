...
data TreasuryFinancialAccountsResourceAbaRecord = TreasuryFinancialAccountsResourceAbaRecord {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryFinancialAccountsResourceAbaRecord
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["account_holder_name" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordAccountHolderName obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_number" Data.Aeson.Types.ToJSON..=)) (treasuryFinancialAccountsResourceAbaRecordAccountNumber obj) : ["account_number_last4" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordAccountNumberLast4 obj] : ["bank_name" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordBankName obj] : ["routing_number" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordRoutingNumber obj] : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (["account_holder_name" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordAccountHolderName obj] : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("account_number" Data.Aeson.Types.ToJSON..=)) (treasuryFinancialAccountsResourceAbaRecordAccountNumber obj) : ["account_number_last4" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordAccountNumberLast4 obj] : ["bank_name" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordBankName obj] : ["routing_number" Data.Aeson.Types.ToJSON..= treasuryFinancialAccountsResourceAbaRecordRoutingNumber obj] : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryFinancialAccountsResourceAbaRecord
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryFinancialAccountsResourceAbaRecord" (\obj -> ((((GHC.Base.pure TreasuryFinancialAccountsResourceAbaRecord GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account_holder_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "account_number")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "account_number_last4")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "bank_name")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "routing_number"))}
-- | Create a new 'TreasuryFinancialAccountsResourceAbaRecord' with all required fields.
mkTreasuryFinancialAccountsResourceAbaRecord :: Data.Text.Internal.Text -- ^ 'treasuryFinancialAccountsResourceAbaRecordAccountHolderName'
  -> Data.Text.Internal.Text -- ^ 'treasuryFinancialAccountsResourceAbaRecordAccountNumberLast4'
  -> Data.Text.Internal.Text -- ^ 'treasuryFinancialAccountsResourceAbaRecordBankName'
  -> Data.Text.Internal.Text -- ^ 'treasuryFinancialAccountsResourceAbaRecordRoutingNumber'
  -> TreasuryFinancialAccountsResourceAbaRecord
mkTreasuryFinancialAccountsResourceAbaRecord treasuryFinancialAccountsResourceAbaRecordAccountHolderName treasuryFinancialAccountsResourceAbaRecordAccountNumberLast4 treasuryFinancialAccountsResourceAbaRecordBankName treasuryFinancialAccountsResourceAbaRecordRoutingNumber = TreasuryFinancialAccountsResourceAbaRecord{treasuryFinancialAccountsResourceAbaRecordAccountHolderName = treasuryFinancialAccountsResourceAbaRecordAccountHolderName,
