...
import {-# SOURCE #-} StripeAPI.Types.TreasuryFinancialAccountsResourceInboundAchToggleSettings
...
data TreasuryFinancialAccountsResourceInboundTransfers = TreasuryFinancialAccountsResourceInboundTransfers {
  -- | ach: Toggle settings for enabling\/disabling an inbound ACH specific feature
  treasuryFinancialAccountsResourceInboundTransfersAch :: (GHC.Maybe.Maybe TreasuryFinancialAccountsResourceInboundAchToggleSettings)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryFinancialAccountsResourceInboundTransfers
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach" Data.Aeson.Types.ToJSON..=)) (treasuryFinancialAccountsResourceInboundTransfersAch obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryFinancialAccountsResourceInboundTransfers
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryFinancialAccountsResourceInboundTransfers" (\obj -> GHC.Base.pure TreasuryFinancialAccountsResourceInboundTransfers GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ach"))}
