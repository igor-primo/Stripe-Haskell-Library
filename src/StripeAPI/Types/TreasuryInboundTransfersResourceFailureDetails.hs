...
data TreasuryInboundTransfersResourceFailureDetails = TreasuryInboundTransfersResourceFailureDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryInboundTransfersResourceFailureDetails
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["code" Data.Aeson.Types.ToJSON..= treasuryInboundTransfersResourceFailureDetailsCode obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryInboundTransfersResourceFailureDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryInboundTransfersResourceFailureDetails" (\obj -> GHC.Base.pure TreasuryInboundTransfersResourceFailureDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "code"))}
-- | Create a new 'TreasuryInboundTransfersResourceFailureDetails' with all required fields.
mkTreasuryInboundTransfersResourceFailureDetails :: TreasuryInboundTransfersResourceFailureDetailsCode' -- ^ 'treasuryInboundTransfersResourceFailureDetailsCode'
...
data TreasuryInboundTransfersResourceFailureDetailsCode' =
   TreasuryInboundTransfersResourceFailureDetailsCode'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TreasuryInboundTransfersResourceFailureDetailsCode'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumAccountClosed -- ^ Represents the JSON value @"account_closed"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumAccountFrozen -- ^ Represents the JSON value @"account_frozen"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumBankAccountRestricted -- ^ Represents the JSON value @"bank_account_restricted"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumBankOwnershipChanged -- ^ Represents the JSON value @"bank_ownership_changed"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumDebitNotAuthorized -- ^ Represents the JSON value @"debit_not_authorized"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumIncorrectAccountHolderAddress -- ^ Represents the JSON value @"incorrect_account_holder_address"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumIncorrectAccountHolderName -- ^ Represents the JSON value @"incorrect_account_holder_name"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumIncorrectAccountHolderTaxId -- ^ Represents the JSON value @"incorrect_account_holder_tax_id"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumInsufficientFunds -- ^ Represents the JSON value @"insufficient_funds"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumInvalidAccountNumber -- ^ Represents the JSON value @"invalid_account_number"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumInvalidCurrency -- ^ Represents the JSON value @"invalid_currency"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumNoAccount -- ^ Represents the JSON value @"no_account"@
  | TreasuryInboundTransfersResourceFailureDetailsCode'EnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryInboundTransfersResourceFailureDetailsCode'
    where {toJSON (TreasuryInboundTransfersResourceFailureDetailsCode'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryInboundTransfersResourceFailureDetailsCode'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_closed" -> TreasuryInboundTransfersResourceFailureDetailsCode'EnumAccountClosed
