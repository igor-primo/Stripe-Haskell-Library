...
data TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails = TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails" (\obj -> (GHC.Base.pure TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "present"))}
-- | Create a new 'TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails' with all required fields.
mkTreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails :: GHC.Types.Bool -- ^ 'treasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetailsPresent'
  -> TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails
mkTreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails treasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetailsPresent = TreasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetails{treasuryOutboundPaymentsResourceOutboundPaymentResourceEndUserDetailsIpAddress = GHC.Maybe.Nothing,
