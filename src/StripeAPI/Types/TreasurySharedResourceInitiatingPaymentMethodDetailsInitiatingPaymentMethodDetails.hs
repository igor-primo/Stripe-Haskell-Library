...
data TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails = TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails" (\obj -> (((((GHC.Base.pure TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "balance")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "billing_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "issuing_card")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "us_bank_account"))}
-- | Create a new 'TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails' with all required fields.
mkTreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails :: TreasurySharedResourceBillingDetails -- ^ 'treasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBillingDetails'
  -> TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType' -- ^ 'treasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'
...
data TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance' =
   TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'EnumPayments -- ^ Represents the JSON value @"payments"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'
    where {toJSON (TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "payments" -> TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsBalance'EnumPayments
...
data TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType' =
   TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumBalance -- ^ Represents the JSON value @"balance"@
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumFinancialAccount -- ^ Represents the JSON value @"financial_account"@
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumIssuingCard -- ^ Represents the JSON value @"issuing_card"@
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumStripe -- ^ Represents the JSON value @"stripe"@
  | TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumUsBankAccount -- ^ Represents the JSON value @"us_bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'
    where {toJSON (TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "balance" -> TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetailsType'EnumBalance
