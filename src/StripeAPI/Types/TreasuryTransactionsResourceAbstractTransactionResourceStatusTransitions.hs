...
data TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions = TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions" (\obj -> (GHC.Base.pure TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "posted_at")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "void_at"))}
...
mkTreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions = TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions{treasuryTransactionsResourceAbstractTransactionResourceStatusTransitionsPostedAt = GHC.Maybe.Nothing,
