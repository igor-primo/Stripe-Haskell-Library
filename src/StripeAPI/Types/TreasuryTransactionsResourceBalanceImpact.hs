...
data TreasuryTransactionsResourceBalanceImpact = TreasuryTransactionsResourceBalanceImpact {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON TreasuryTransactionsResourceBalanceImpact
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (["cash" Data.Aeson.Types.ToJSON..= treasuryTransactionsResourceBalanceImpactCash obj] : ["inbound_pending" Data.Aeson.Types.ToJSON..= treasuryTransactionsResourceBalanceImpactInboundPending obj] : ["outbound_pending" Data.Aeson.Types.ToJSON..= treasuryTransactionsResourceBalanceImpactOutboundPending obj] : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON TreasuryTransactionsResourceBalanceImpact
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "TreasuryTransactionsResourceBalanceImpact" (\obj -> ((GHC.Base.pure TreasuryTransactionsResourceBalanceImpact GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "cash")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "inbound_pending")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "outbound_pending"))}
-- | Create a new 'TreasuryTransactionsResourceBalanceImpact' with all required fields.
mkTreasuryTransactionsResourceBalanceImpact :: GHC.Types.Int -- ^ 'treasuryTransactionsResourceBalanceImpactCash'
  -> GHC.Types.Int -- ^ 'treasuryTransactionsResourceBalanceImpactInboundPending'
  -> GHC.Types.Int -- ^ 'treasuryTransactionsResourceBalanceImpactOutboundPending'
  -> TreasuryTransactionsResourceBalanceImpact
mkTreasuryTransactionsResourceBalanceImpact treasuryTransactionsResourceBalanceImpactCash treasuryTransactionsResourceBalanceImpactInboundPending treasuryTransactionsResourceBalanceImpactOutboundPending = TreasuryTransactionsResourceBalanceImpact{treasuryTransactionsResourceBalanceImpactCash = treasuryTransactionsResourceBalanceImpactCash,
