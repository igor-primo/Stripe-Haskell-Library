...
data Treasury'debitReversal = Treasury'debitReversal {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'debitReversal
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'debitReversal
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'debitReversal" (\obj -> (((((((((((((GHC.Base.pure Treasury'debitReversal GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_regulatory_receipt_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "linked_flows")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "metadata")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "received_debit")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status_transitions")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction"))}
-- | Create a new 'Treasury'debitReversal' with all required fields.
mkTreasury'debitReversal :: GHC.Types.Int -- ^ 'treasury'debitReversalAmount'
  -> GHC.Types.Int -- ^ 'treasury'debitReversalCreated'
  -> Data.Text.Internal.Text -- ^ 'treasury'debitReversalCurrency'
  -> Data.Text.Internal.Text -- ^ 'treasury'debitReversalId'
  -> GHC.Types.Bool -- ^ 'treasury'debitReversalLivemode'
  -> Data.Aeson.Types.Internal.Object -- ^ 'treasury'debitReversalMetadata'
  -> Treasury'debitReversalNetwork' -- ^ 'treasury'debitReversalNetwork'
  -> Data.Text.Internal.Text -- ^ 'treasury'debitReversalReceivedDebit'
  -> Treasury'debitReversalStatus' -- ^ 'treasury'debitReversalStatus'
  -> TreasuryReceivedDebitsResourceStatusTransitions -- ^ 'treasury'debitReversalStatusTransitions'
  -> Treasury'debitReversal
mkTreasury'debitReversal treasury'debitReversalAmount treasury'debitReversalCreated treasury'debitReversalCurrency treasury'debitReversalId treasury'debitReversalLivemode treasury'debitReversalMetadata treasury'debitReversalNetwork treasury'debitReversalReceivedDebit treasury'debitReversalStatus treasury'debitReversalStatusTransitions = Treasury'debitReversal{treasury'debitReversalAmount = treasury'debitReversalAmount,
...
data Treasury'debitReversalLinkedFlows'NonNullable = Treasury'debitReversalLinkedFlows'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'debitReversalLinkedFlows'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("issuing_dispute" Data.Aeson.Types.ToJSON..=)) (treasury'debitReversalLinkedFlows'NonNullableIssuingDispute obj) : GHC.Base.mempty));
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'debitReversalLinkedFlows'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'debitReversalLinkedFlows'NonNullable" (\obj -> GHC.Base.pure Treasury'debitReversalLinkedFlows'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "issuing_dispute"))}
...
data Treasury'debitReversalNetwork' =
   Treasury'debitReversalNetwork'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'debitReversalNetwork'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'debitReversalNetwork'EnumAch -- ^ Represents the JSON value @"ach"@
  | Treasury'debitReversalNetwork'EnumCard -- ^ Represents the JSON value @"card"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'debitReversalNetwork'
    where {toJSON (Treasury'debitReversalNetwork'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'debitReversalNetwork'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> Treasury'debitReversalNetwork'EnumAch
...
data Treasury'debitReversalStatus' =
   Treasury'debitReversalStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'debitReversalStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'debitReversalStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | Treasury'debitReversalStatus'EnumProcessing -- ^ Represents the JSON value @"processing"@
  | Treasury'debitReversalStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'debitReversalStatus'
    where {toJSON (Treasury'debitReversalStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'debitReversalStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> Treasury'debitReversalStatus'EnumFailed
