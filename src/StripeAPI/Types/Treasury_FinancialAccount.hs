...
data Treasury'financialAccount = Treasury'financialAccount {
  ...
  -- | is_default
  , treasury'financialAccountIsDefault :: (GHC.Maybe.Maybe GHC.Types.Bool)
  ...
  -- 
  -- * Maximum length of 5000
  , treasury'financialAccountNickname :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Data.Text.Internal.Text))
...
data Treasury'financialAccountActiveFeatures' =
   Treasury'financialAccountActiveFeatures'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountActiveFeatures'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountActiveFeatures'EnumCardIssuing -- ^ Represents the JSON value @"card_issuing"@
  | Treasury'financialAccountActiveFeatures'EnumDepositInsurance -- ^ Represents the JSON value @"deposit_insurance"@
  | Treasury'financialAccountActiveFeatures'EnumFinancialAddresses'aba -- ^ Represents the JSON value @"financial_addresses.aba"@
  | Treasury'financialAccountActiveFeatures'EnumFinancialAddresses'aba'forwarding -- ^ Represents the JSON value @"financial_addresses.aba.forwarding"@
  | Treasury'financialAccountActiveFeatures'EnumInboundTransfers'ach -- ^ Represents the JSON value @"inbound_transfers.ach"@
  | Treasury'financialAccountActiveFeatures'EnumIntraStripeFlows -- ^ Represents the JSON value @"intra_stripe_flows"@
  | Treasury'financialAccountActiveFeatures'EnumOutboundPayments'ach -- ^ Represents the JSON value @"outbound_payments.ach"@
  | Treasury'financialAccountActiveFeatures'EnumOutboundPayments'usDomesticWire -- ^ Represents the JSON value @"outbound_payments.us_domestic_wire"@
  | Treasury'financialAccountActiveFeatures'EnumOutboundTransfers'ach -- ^ Represents the JSON value @"outbound_transfers.ach"@
  | Treasury'financialAccountActiveFeatures'EnumOutboundTransfers'usDomesticWire -- ^ Represents the JSON value @"outbound_transfers.us_domestic_wire"@
  | Treasury'financialAccountActiveFeatures'EnumRemoteDepositCapture -- ^ Represents the JSON value @"remote_deposit_capture"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountActiveFeatures'
    where {toJSON (Treasury'financialAccountActiveFeatures'Other val) = val;
           ...
           toJSON (Treasury'financialAccountActiveFeatures'EnumFinancialAddresses'aba'forwarding) = "financial_addresses.aba.forwarding";
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountActiveFeatures'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card_issuing" -> Treasury'financialAccountActiveFeatures'EnumCardIssuing
                                             ...
                                             | val GHC.Classes.== "financial_addresses.aba.forwarding" -> Treasury'financialAccountActiveFeatures'EnumFinancialAddresses'aba'forwarding
...
data Treasury'financialAccountPendingFeatures' =
   Treasury'financialAccountPendingFeatures'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountPendingFeatures'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountPendingFeatures'EnumCardIssuing -- ^ Represents the JSON value @"card_issuing"@
  | Treasury'financialAccountPendingFeatures'EnumDepositInsurance -- ^ Represents the JSON value @"deposit_insurance"@
  | Treasury'financialAccountPendingFeatures'EnumFinancialAddresses'aba -- ^ Represents the JSON value @"financial_addresses.aba"@
  | Treasury'financialAccountPendingFeatures'EnumFinancialAddresses'aba'forwarding -- ^ Represents the JSON value @"financial_addresses.aba.forwarding"@
  | Treasury'financialAccountPendingFeatures'EnumInboundTransfers'ach -- ^ Represents the JSON value @"inbound_transfers.ach"@
  | Treasury'financialAccountPendingFeatures'EnumIntraStripeFlows -- ^ Represents the JSON value @"intra_stripe_flows"@
  | Treasury'financialAccountPendingFeatures'EnumOutboundPayments'ach -- ^ Represents the JSON value @"outbound_payments.ach"@
  | Treasury'financialAccountPendingFeatures'EnumOutboundPayments'usDomesticWire -- ^ Represents the JSON value @"outbound_payments.us_domestic_wire"@
  | Treasury'financialAccountPendingFeatures'EnumOutboundTransfers'ach -- ^ Represents the JSON value @"outbound_transfers.ach"@
  | Treasury'financialAccountPendingFeatures'EnumOutboundTransfers'usDomesticWire -- ^ Represents the JSON value @"outbound_transfers.us_domestic_wire"@
  | Treasury'financialAccountPendingFeatures'EnumRemoteDepositCapture -- ^ Represents the JSON value @"remote_deposit_capture"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountPendingFeatures'
    where {toJSON (Treasury'financialAccountPendingFeatures'Other val) = val;
           ...
           toJSON (Treasury'financialAccountPendingFeatures'EnumFinancialAddresses'aba'forwarding) = "financial_addresses.aba.forwarding";
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountPendingFeatures'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card_issuing" -> Treasury'financialAccountPendingFeatures'EnumCardIssuing
                                             ...
                                             | val GHC.Classes.== "financial_addresses.aba.forwarding" -> Treasury'financialAccountPendingFeatures'EnumFinancialAddresses'aba'forwarding
...
data Treasury'financialAccountPlatformRestrictions'NonNullable = Treasury'financialAccountPlatformRestrictions'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountPlatformRestrictions'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("inbound_flows" Data.Aeson.Types.ToJSON..=)) (treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("outbound_flows" Data.Aeson.Types.ToJSON..=)) (treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("inbound_flows" Data.Aeson.Types.ToJSON..=)) (treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("outbound_flows" Data.Aeson.Types.ToJSON..=)) (treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountPlatformRestrictions'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'financialAccountPlatformRestrictions'NonNullable" (\obj -> (GHC.Base.pure Treasury'financialAccountPlatformRestrictions'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "inbound_flows")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "outbound_flows"))}
...
mkTreasury'financialAccountPlatformRestrictions'NonNullable = Treasury'financialAccountPlatformRestrictions'NonNullable{treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows = GHC.Maybe.Nothing,
...
data Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullable =
   Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableEnumRestricted -- ^ Represents the JSON value @"restricted"@
  | Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableEnumUnrestricted -- ^ Represents the JSON value @"unrestricted"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullable
    where {toJSON (Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "restricted" -> Treasury'financialAccountPlatformRestrictions'NonNullableInboundFlows'NonNullableEnumRestricted
...
data Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullable =
   Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableEnumRestricted -- ^ Represents the JSON value @"restricted"@
  | Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableEnumUnrestricted -- ^ Represents the JSON value @"unrestricted"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullable
    where {toJSON (Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "restricted" -> Treasury'financialAccountPlatformRestrictions'NonNullableOutboundFlows'NonNullableEnumRestricted
...
data Treasury'financialAccountRestrictedFeatures' =
   Treasury'financialAccountRestrictedFeatures'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountRestrictedFeatures'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountRestrictedFeatures'EnumCardIssuing -- ^ Represents the JSON value @"card_issuing"@
  | Treasury'financialAccountRestrictedFeatures'EnumDepositInsurance -- ^ Represents the JSON value @"deposit_insurance"@
  | Treasury'financialAccountRestrictedFeatures'EnumFinancialAddresses'aba -- ^ Represents the JSON value @"financial_addresses.aba"@
  | Treasury'financialAccountRestrictedFeatures'EnumFinancialAddresses'aba'forwarding -- ^ Represents the JSON value @"financial_addresses.aba.forwarding"@
  | Treasury'financialAccountRestrictedFeatures'EnumInboundTransfers'ach -- ^ Represents the JSON value @"inbound_transfers.ach"@
  | Treasury'financialAccountRestrictedFeatures'EnumIntraStripeFlows -- ^ Represents the JSON value @"intra_stripe_flows"@
  | Treasury'financialAccountRestrictedFeatures'EnumOutboundPayments'ach -- ^ Represents the JSON value @"outbound_payments.ach"@
  | Treasury'financialAccountRestrictedFeatures'EnumOutboundPayments'usDomesticWire -- ^ Represents the JSON value @"outbound_payments.us_domestic_wire"@
  | Treasury'financialAccountRestrictedFeatures'EnumOutboundTransfers'ach -- ^ Represents the JSON value @"outbound_transfers.ach"@
  | Treasury'financialAccountRestrictedFeatures'EnumOutboundTransfers'usDomesticWire -- ^ Represents the JSON value @"outbound_transfers.us_domestic_wire"@
  | Treasury'financialAccountRestrictedFeatures'EnumRemoteDepositCapture -- ^ Represents the JSON value @"remote_deposit_capture"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountRestrictedFeatures'
    where {toJSON (Treasury'financialAccountRestrictedFeatures'Other val) = val;
           ...
           toJSON (Treasury'financialAccountRestrictedFeatures'EnumFinancialAddresses'aba'forwarding) = "financial_addresses.aba.forwarding";
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountRestrictedFeatures'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "card_issuing" -> Treasury'financialAccountRestrictedFeatures'EnumCardIssuing
                                             ...
                                             | val GHC.Classes.== "financial_addresses.aba.forwarding" -> Treasury'financialAccountRestrictedFeatures'EnumFinancialAddresses'aba'forwarding
...
data Treasury'financialAccountStatus' =
   Treasury'financialAccountStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'financialAccountStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'financialAccountStatus'EnumClosed -- ^ Represents the JSON value @"closed"@
  | Treasury'financialAccountStatus'EnumOpen -- ^ Represents the JSON value @"open"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'financialAccountStatus'
    where {toJSON (Treasury'financialAccountStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'financialAccountStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "closed" -> Treasury'financialAccountStatus'EnumClosed
