...
import {-# SOURCE #-} StripeAPI.Types.TreasuryOutboundPaymentsResourceOutboundPaymentResourceTrackingDetails
...
data Treasury'outboundPayment = Treasury'outboundPayment {
  ...
  , treasury'outboundPaymentTrackingDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Treasury'outboundPaymentTrackingDetails'NonNullable))
...
mkTreasury'outboundPayment treasury'outboundPaymentAmount treasury'outboundPaymentCancelable treasury'outboundPaymentCreated treasury'outboundPaymentCurrency treasury'outboundPaymentExpectedArrivalDate treasury'outboundPaymentFinancialAccount treasury'outboundPaymentId treasury'outboundPaymentLivemode treasury'outboundPaymentMetadata treasury'outboundPaymentStatementDescriptor treasury'outboundPaymentStatus treasury'outboundPaymentStatusTransitions treasury'outboundPaymentTransaction = Treasury'outboundPayment{treasury'outboundPaymentAmount = treasury'outboundPaymentAmount,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    treasury'outboundPaymentTrackingDetails = GHC.Maybe.Nothing,
...
data Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullable = Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullable
...
mkTreasury'outboundPaymentDestinationPaymentMethodDetails'NonNullable = Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullable{treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableBillingDetails = GHC.Maybe.Nothing,
...
data Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType' =
   Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'EnumFinancialAccount -- ^ Represents the JSON value @"financial_account"@
  | Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'EnumUsBankAccount -- ^ Represents the JSON value @"us_bank_account"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'
    where {toJSON (Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "financial_account" -> Treasury'outboundPaymentDestinationPaymentMethodDetails'NonNullableType'EnumFinancialAccount
...
data Treasury'outboundPaymentEndUserDetails'NonNullable = Treasury'outboundPaymentEndUserDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentEndUserDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip_address" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentEndUserDetails'NonNullableIpAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("present" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentEndUserDetails'NonNullablePresent obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ip_address" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentEndUserDetails'NonNullableIpAddress obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("present" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentEndUserDetails'NonNullablePresent obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentEndUserDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'outboundPaymentEndUserDetails'NonNullable" (\obj -> (GHC.Base.pure Treasury'outboundPaymentEndUserDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ip_address")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "present"))}
...
mkTreasury'outboundPaymentEndUserDetails'NonNullable = Treasury'outboundPaymentEndUserDetails'NonNullable{treasury'outboundPaymentEndUserDetails'NonNullableIpAddress = GHC.Maybe.Nothing,
...
data Treasury'outboundPaymentReturnedDetails'NonNullable = Treasury'outboundPaymentReturnedDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentReturnedDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("code" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentReturnedDetails'NonNullableCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentReturnedDetails'NonNullableTransaction obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("code" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentReturnedDetails'NonNullableCode obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("transaction" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentReturnedDetails'NonNullableTransaction obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentReturnedDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'outboundPaymentReturnedDetails'NonNullable" (\obj -> (GHC.Base.pure Treasury'outboundPaymentReturnedDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction"))}
...
mkTreasury'outboundPaymentReturnedDetails'NonNullable = Treasury'outboundPaymentReturnedDetails'NonNullable{treasury'outboundPaymentReturnedDetails'NonNullableCode = GHC.Maybe.Nothing,
...
data Treasury'outboundPaymentReturnedDetails'NonNullableCode' =
   Treasury'outboundPaymentReturnedDetails'NonNullableCode'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumAccountClosed -- ^ Represents the JSON value @"account_closed"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumAccountFrozen -- ^ Represents the JSON value @"account_frozen"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumBankAccountRestricted -- ^ Represents the JSON value @"bank_account_restricted"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumBankOwnershipChanged -- ^ Represents the JSON value @"bank_ownership_changed"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumDeclined -- ^ Represents the JSON value @"declined"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumIncorrectAccountHolderName -- ^ Represents the JSON value @"incorrect_account_holder_name"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumInvalidAccountNumber -- ^ Represents the JSON value @"invalid_account_number"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumInvalidCurrency -- ^ Represents the JSON value @"invalid_currency"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumNoAccount -- ^ Represents the JSON value @"no_account"@
  | Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentReturnedDetails'NonNullableCode'
    where {toJSON (Treasury'outboundPaymentReturnedDetails'NonNullableCode'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentReturnedDetails'NonNullableCode'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_closed" -> Treasury'outboundPaymentReturnedDetails'NonNullableCode'EnumAccountClosed
...
data Treasury'outboundPaymentReturnedDetails'NonNullableTransaction'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentReturnedDetails'NonNullableTransaction'Variants
    where {toJSON (Treasury'outboundPaymentReturnedDetails'NonNullableTransaction'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
...
data Treasury'outboundPaymentStatus' =
   Treasury'outboundPaymentStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'outboundPaymentStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'outboundPaymentStatus'EnumCanceled -- ^ Represents the JSON value @"canceled"@
  | Treasury'outboundPaymentStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | Treasury'outboundPaymentStatus'EnumPosted -- ^ Represents the JSON value @"posted"@
  | Treasury'outboundPaymentStatus'EnumProcessing -- ^ Represents the JSON value @"processing"@
  | Treasury'outboundPaymentStatus'EnumReturned -- ^ Represents the JSON value @"returned"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentStatus'
    where {toJSON (Treasury'outboundPaymentStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "canceled" -> Treasury'outboundPaymentStatus'EnumCanceled
...
-- | Defines the object schema located at @components.schemas.treasury.outbound_payment.properties.tracking_details.anyOf@ in the specification.
-- 
-- Details about network-specific tracking information if available.
data Treasury'outboundPaymentTrackingDetails'NonNullable = Treasury'outboundPaymentTrackingDetails'NonNullable {
  -- | ach: 
  treasury'outboundPaymentTrackingDetails'NonNullableAch :: (GHC.Maybe.Maybe TreasuryOutboundPaymentsResourceAchTrackingDetails)
  -- | type: The US bank account network used to send funds.
  , treasury'outboundPaymentTrackingDetails'NonNullableType :: (GHC.Maybe.Maybe Treasury'outboundPaymentTrackingDetails'NonNullableType')
  -- | us_domestic_wire: 
  , treasury'outboundPaymentTrackingDetails'NonNullableUsDomesticWire :: (GHC.Maybe.Maybe TreasuryOutboundPaymentsResourceUsDomesticWireTrackingDetails)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentTrackingDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableAch obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("us_domestic_wire" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableUsDomesticWire obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableAch obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("us_domestic_wire" Data.Aeson.Types.ToJSON..=)) (treasury'outboundPaymentTrackingDetails'NonNullableUsDomesticWire obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentTrackingDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'outboundPaymentTrackingDetails'NonNullable" (\obj -> ((GHC.Base.pure Treasury'outboundPaymentTrackingDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ach")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "us_domestic_wire"))}
-- | Create a new 'Treasury'outboundPaymentTrackingDetails'NonNullable' with all required fields.
mkTreasury'outboundPaymentTrackingDetails'NonNullable :: Treasury'outboundPaymentTrackingDetails'NonNullable
mkTreasury'outboundPaymentTrackingDetails'NonNullable = Treasury'outboundPaymentTrackingDetails'NonNullable{treasury'outboundPaymentTrackingDetails'NonNullableAch = GHC.Maybe.Nothing,
                                                                                                            treasury'outboundPaymentTrackingDetails'NonNullableType = GHC.Maybe.Nothing,
                                                                                                            treasury'outboundPaymentTrackingDetails'NonNullableUsDomesticWire = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @components.schemas.treasury.outbound_payment.properties.tracking_details.anyOf.properties.type@ in the specification.
-- 
-- The US bank account network used to send funds.
data Treasury'outboundPaymentTrackingDetails'NonNullableType' =
   Treasury'outboundPaymentTrackingDetails'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'outboundPaymentTrackingDetails'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumAch -- ^ Represents the JSON value @"ach"@
  | Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumUsDomesticWire -- ^ Represents the JSON value @"us_domestic_wire"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentTrackingDetails'NonNullableType'
    where {toJSON (Treasury'outboundPaymentTrackingDetails'NonNullableType'Other val) = val;
           toJSON (Treasury'outboundPaymentTrackingDetails'NonNullableType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumAch) = "ach";
           toJSON (Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumUsDomesticWire) = "us_domestic_wire"}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentTrackingDetails'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumAch
                                             | val GHC.Classes.== "us_domestic_wire" -> Treasury'outboundPaymentTrackingDetails'NonNullableType'EnumUsDomesticWire
                                             | GHC.Base.otherwise -> Treasury'outboundPaymentTrackingDetails'NonNullableType'Other val)}
...
data Treasury'outboundPaymentTransaction'Variants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundPaymentTransaction'Variants
    where {toJSON (Treasury'outboundPaymentTransaction'Text a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Treasury'outboundPaymentTransaction'Treasury'transaction a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundPaymentTransaction'Variants
    where {parseJSON val = case (Treasury'outboundPaymentTransaction'Text Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Treasury'outboundPaymentTransaction'Treasury'transaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
                           {Data.Aeson.Types.Internal.Success a -> GHC.Base.pure a;
                            Data.Aeson.Types.Internal.Error a -> Control.Monad.Fail.fail a}}
