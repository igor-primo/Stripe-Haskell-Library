...
import {-# SOURCE #-} StripeAPI.Types.TreasuryOutboundTransfersResourceOutboundTransferResourceTrackingDetails
...
data Treasury'outboundTransfer = Treasury'outboundTransfer {
  ...
  , treasury'outboundTransferTrackingDetails :: (GHC.Maybe.Maybe (StripeAPI.Common.Nullable Treasury'outboundTransferTrackingDetails'NonNullable))
...
mkTreasury'outboundTransfer treasury'outboundTransferAmount treasury'outboundTransferCancelable treasury'outboundTransferCreated treasury'outboundTransferCurrency treasury'outboundTransferDestinationPaymentMethodDetails treasury'outboundTransferExpectedArrivalDate treasury'outboundTransferFinancialAccount treasury'outboundTransferId treasury'outboundTransferLivemode treasury'outboundTransferMetadata treasury'outboundTransferStatementDescriptor treasury'outboundTransferStatus treasury'outboundTransferStatusTransitions treasury'outboundTransferTransaction = Treasury'outboundTransfer{treasury'outboundTransferAmount = treasury'outboundTransferAmount,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            treasury'outboundTransferTrackingDetails = GHC.Maybe.Nothing,
...
-- | Defines the object schema located at @components.schemas.treasury.outbound_transfer.properties.tracking_details.anyOf@ in the specification.
-- 
-- Details about network-specific tracking information if available.
data Treasury'outboundTransferTrackingDetails'NonNullable = Treasury'outboundTransferTrackingDetails'NonNullable {
  -- | ach: 
  treasury'outboundTransferTrackingDetails'NonNullableAch :: (GHC.Maybe.Maybe TreasuryOutboundTransfersResourceAchTrackingDetails)
  -- | type: The US bank account network used to send funds.
  , treasury'outboundTransferTrackingDetails'NonNullableType :: (GHC.Maybe.Maybe Treasury'outboundTransferTrackingDetails'NonNullableType')
  -- | us_domestic_wire: 
  , treasury'outboundTransferTrackingDetails'NonNullableUsDomesticWire :: (GHC.Maybe.Maybe TreasuryOutboundTransfersResourceUsDomesticWireTrackingDetails)
  } deriving (GHC.Show.Show
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundTransferTrackingDetails'NonNullable
    where {toJSON obj = Data.Aeson.Types.Internal.object (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableAch obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("us_domestic_wire" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableUsDomesticWire obj) : GHC.Base.mempty));
           toEncoding obj = Data.Aeson.Encoding.Internal.pairs (GHC.Base.mconcat (Data.Foldable.concat (Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("ach" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableAch obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("type" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableType obj) : Data.Maybe.maybe GHC.Base.mempty (GHC.Base.pure GHC.Base.. ("us_domestic_wire" Data.Aeson.Types.ToJSON..=)) (treasury'outboundTransferTrackingDetails'NonNullableUsDomesticWire obj) : GHC.Base.mempty)))}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundTransferTrackingDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'outboundTransferTrackingDetails'NonNullable" (\obj -> ((GHC.Base.pure Treasury'outboundTransferTrackingDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "ach")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "us_domestic_wire"))}
-- | Create a new 'Treasury'outboundTransferTrackingDetails'NonNullable' with all required fields.
mkTreasury'outboundTransferTrackingDetails'NonNullable :: Treasury'outboundTransferTrackingDetails'NonNullable
mkTreasury'outboundTransferTrackingDetails'NonNullable = Treasury'outboundTransferTrackingDetails'NonNullable{treasury'outboundTransferTrackingDetails'NonNullableAch = GHC.Maybe.Nothing,
                                                                                                              treasury'outboundTransferTrackingDetails'NonNullableType = GHC.Maybe.Nothing,
                                                                                                              treasury'outboundTransferTrackingDetails'NonNullableUsDomesticWire = GHC.Maybe.Nothing}
-- | Defines the enum schema located at @components.schemas.treasury.outbound_transfer.properties.tracking_details.anyOf.properties.type@ in the specification.
-- 
-- The US bank account network used to send funds.
data Treasury'outboundTransferTrackingDetails'NonNullableType' =
   Treasury'outboundTransferTrackingDetails'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'outboundTransferTrackingDetails'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'outboundTransferTrackingDetails'NonNullableType'EnumAch -- ^ Represents the JSON value @"ach"@
  | Treasury'outboundTransferTrackingDetails'NonNullableType'EnumUsDomesticWire -- ^ Represents the JSON value @"us_domestic_wire"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'outboundTransferTrackingDetails'NonNullableType'
    where {toJSON (Treasury'outboundTransferTrackingDetails'NonNullableType'Other val) = val;
           toJSON (Treasury'outboundTransferTrackingDetails'NonNullableType'Typed val) = Data.Aeson.Types.ToJSON.toJSON val;
           toJSON (Treasury'outboundTransferTrackingDetails'NonNullableType'EnumAch) = "ach";
           toJSON (Treasury'outboundTransferTrackingDetails'NonNullableType'EnumUsDomesticWire) = "us_domestic_wire"}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'outboundTransferTrackingDetails'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> Treasury'outboundTransferTrackingDetails'NonNullableType'EnumAch
                                             | val GHC.Classes.== "us_domestic_wire" -> Treasury'outboundTransferTrackingDetails'NonNullableType'EnumUsDomesticWire
                                             | GHC.Base.otherwise -> Treasury'outboundTransferTrackingDetails'NonNullableType'Other val)}
