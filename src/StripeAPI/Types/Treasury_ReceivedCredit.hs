...
data Treasury'receivedCredit = Treasury'receivedCredit {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCredit
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCredit
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'receivedCredit" (\obj -> ((((((((((((((GHC.Base.pure Treasury'receivedCredit GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "failure_code")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "financial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "hosted_regulatory_receipt_url")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "initiating_payment_method_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "linked_flows")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "network")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "reversal_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "transaction"))}
-- | Create a new 'Treasury'receivedCredit' with all required fields.
mkTreasury'receivedCredit :: GHC.Types.Int -- ^ 'treasury'receivedCreditAmount'
  -> GHC.Types.Int -- ^ 'treasury'receivedCreditCreated'
  -> Data.Text.Internal.Text -- ^ 'treasury'receivedCreditCurrency'
  -> Data.Text.Internal.Text -- ^ 'treasury'receivedCreditDescription'
  -> Data.Text.Internal.Text -- ^ 'treasury'receivedCreditId'
  -> TreasurySharedResourceInitiatingPaymentMethodDetailsInitiatingPaymentMethodDetails -- ^ 'treasury'receivedCreditInitiatingPaymentMethodDetails'
  -> TreasuryReceivedCreditsResourceLinkedFlows -- ^ 'treasury'receivedCreditLinkedFlows'
  -> GHC.Types.Bool -- ^ 'treasury'receivedCreditLivemode'
  -> Treasury'receivedCreditNetwork' -- ^ 'treasury'receivedCreditNetwork'
  -> Treasury'receivedCreditStatus' -- ^ 'treasury'receivedCreditStatus'
  -> Treasury'receivedCredit
mkTreasury'receivedCredit treasury'receivedCreditAmount treasury'receivedCreditCreated treasury'receivedCreditCurrency treasury'receivedCreditDescription treasury'receivedCreditId treasury'receivedCreditInitiatingPaymentMethodDetails treasury'receivedCreditLinkedFlows treasury'receivedCreditLivemode treasury'receivedCreditNetwork treasury'receivedCreditStatus = Treasury'receivedCredit{treasury'receivedCreditAmount = treasury'receivedCreditAmount,
...
data Treasury'receivedCreditFailureCode'NonNullable =
   Treasury'receivedCreditFailureCode'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'receivedCreditFailureCode'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'receivedCreditFailureCode'NonNullableEnumAccountClosed -- ^ Represents the JSON value @"account_closed"@
  | Treasury'receivedCreditFailureCode'NonNullableEnumAccountFrozen -- ^ Represents the JSON value @"account_frozen"@
  | Treasury'receivedCreditFailureCode'NonNullableEnumInternationalTransaction -- ^ Represents the JSON value @"international_transaction"@
  | Treasury'receivedCreditFailureCode'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditFailureCode'NonNullable
    where {toJSON (Treasury'receivedCreditFailureCode'NonNullableOther val) = val;
           ...
           toJSON (Treasury'receivedCreditFailureCode'NonNullableEnumInternationalTransaction) = "international_transaction";
           toJSON (Treasury'receivedCreditFailureCode'NonNullableEnumOther) = "other"}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditFailureCode'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "account_closed" -> Treasury'receivedCreditFailureCode'NonNullableEnumAccountClosed
                                             | val GHC.Classes.== "account_frozen" -> Treasury'receivedCreditFailureCode'NonNullableEnumAccountFrozen
                                             | val GHC.Classes.== "international_transaction" -> Treasury'receivedCreditFailureCode'NonNullableEnumInternationalTransaction
...
data Treasury'receivedCreditNetwork' =
   Treasury'receivedCreditNetwork'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'receivedCreditNetwork'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'receivedCreditNetwork'EnumAch -- ^ Represents the JSON value @"ach"@
  | Treasury'receivedCreditNetwork'EnumCard -- ^ Represents the JSON value @"card"@
  | Treasury'receivedCreditNetwork'EnumStripe -- ^ Represents the JSON value @"stripe"@
  | Treasury'receivedCreditNetwork'EnumUsDomesticWire -- ^ Represents the JSON value @"us_domestic_wire"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditNetwork'
    where {toJSON (Treasury'receivedCreditNetwork'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditNetwork'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "ach" -> Treasury'receivedCreditNetwork'EnumAch
...
data Treasury'receivedCreditReversalDetails'NonNullable = Treasury'receivedCreditReversalDetails'NonNullable {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditReversalDetails'NonNullable
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditReversalDetails'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'receivedCreditReversalDetails'NonNullable" (\obj -> (GHC.Base.pure Treasury'receivedCreditReversalDetails'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "deadline")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "restricted_reason"))}
...
mkTreasury'receivedCreditReversalDetails'NonNullable = Treasury'receivedCreditReversalDetails'NonNullable{treasury'receivedCreditReversalDetails'NonNullableDeadline = GHC.Maybe.Nothing,
...
data Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullable =
   Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableOther Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableTyped Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumAlreadyReversed -- ^ Represents the JSON value @"already_reversed"@
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumDeadlinePassed -- ^ Represents the JSON value @"deadline_passed"@
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumNetworkRestricted -- ^ Represents the JSON value @"network_restricted"@
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumOther -- ^ Represents the JSON value @"other"@
  | Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumSourceFlowRestricted -- ^ Represents the JSON value @"source_flow_restricted"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullable
    where {toJSON (Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableOther val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullable
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "already_reversed" -> Treasury'receivedCreditReversalDetails'NonNullableRestrictedReason'NonNullableEnumAlreadyReversed
...
data Treasury'receivedCreditStatus' =
   Treasury'receivedCreditStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'receivedCreditStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'receivedCreditStatus'EnumFailed -- ^ Represents the JSON value @"failed"@
  | Treasury'receivedCreditStatus'EnumSucceeded -- ^ Represents the JSON value @"succeeded"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditStatus'
    where {toJSON (Treasury'receivedCreditStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "failed" -> Treasury'receivedCreditStatus'EnumFailed
...
data Treasury'receivedCreditTransaction'NonNullableVariants =
  ...
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'receivedCreditTransaction'NonNullableVariants
    where {toJSON (Treasury'receivedCreditTransaction'NonNullableText a) = Data.Aeson.Types.ToJSON.toJSON a;
           toJSON (Treasury'receivedCreditTransaction'NonNullableTreasury'transaction a) = Data.Aeson.Types.ToJSON.toJSON a}
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'receivedCreditTransaction'NonNullableVariants
    where {parseJSON val = case (Treasury'receivedCreditTransaction'NonNullableText Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> ((Treasury'receivedCreditTransaction'NonNullableTreasury'transaction Data.Functor.<$> Data.Aeson.Types.FromJSON.fromJSON val) GHC.Base.<|> Data.Aeson.Types.Internal.Error "No variant matched") of
