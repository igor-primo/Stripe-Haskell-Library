...
data Treasury'transaction = Treasury'transaction {
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'transaction
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'transaction
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'transaction" (\obj -> (((((((((((((GHC.Base.pure Treasury'transaction GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "amount")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "balance_impact")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "created")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "currency")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "description")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "entries")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "financial_account")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "flow")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..:! "flow_details")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "flow_type")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "id")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "livemode")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "status_transitions"))}
-- | Create a new 'Treasury'transaction' with all required fields.
mkTreasury'transaction :: GHC.Types.Int -- ^ 'treasury'transactionAmount'
  -> TreasuryTransactionsResourceBalanceImpact -- ^ 'treasury'transactionBalanceImpact'
  -> GHC.Types.Int -- ^ 'treasury'transactionCreated'
  -> Data.Text.Internal.Text -- ^ 'treasury'transactionCurrency'
  -> Data.Text.Internal.Text -- ^ 'treasury'transactionDescription'
  -> Data.Text.Internal.Text -- ^ 'treasury'transactionFinancialAccount'
  -> Treasury'transactionFlowType' -- ^ 'treasury'transactionFlowType'
  -> Data.Text.Internal.Text -- ^ 'treasury'transactionId'
  -> GHC.Types.Bool -- ^ 'treasury'transactionLivemode'
  -> Treasury'transactionStatus' -- ^ 'treasury'transactionStatus'
  -> TreasuryTransactionsResourceAbstractTransactionResourceStatusTransitions -- ^ 'treasury'transactionStatusTransitions'
  -> Treasury'transaction
mkTreasury'transaction treasury'transactionAmount treasury'transactionBalanceImpact treasury'transactionCreated treasury'transactionCurrency treasury'transactionDescription treasury'transactionFinancialAccount treasury'transactionFlowType treasury'transactionId treasury'transactionLivemode treasury'transactionStatus treasury'transactionStatusTransitions = Treasury'transaction{treasury'transactionAmount = treasury'transactionAmount,
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'transactionEntries'NonNullable
    where {parseJSON = Data.Aeson.Types.FromJSON.withObject "Treasury'transactionEntries'NonNullable" (\obj -> ((GHC.Base.pure Treasury'transactionEntries'NonNullable GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "data")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "has_more")) GHC.Base.<*> (obj Data.Aeson.Types.FromJSON..: "url"))}
-- | Create a new 'Treasury'transactionEntries'NonNullable' with all required fields.
mkTreasury'transactionEntries'NonNullable :: [Treasury'transactionEntry] -- ^ 'treasury'transactionEntries'NonNullableData'
  -> GHC.Types.Bool -- ^ 'treasury'transactionEntries'NonNullableHasMore'
  -> Data.Text.Internal.Text -- ^ 'treasury'transactionEntries'NonNullableUrl'
  -> Treasury'transactionEntries'NonNullable
mkTreasury'transactionEntries'NonNullable treasury'transactionEntries'NonNullableData treasury'transactionEntries'NonNullableHasMore treasury'transactionEntries'NonNullableUrl = Treasury'transactionEntries'NonNullable{treasury'transactionEntries'NonNullableData = treasury'transactionEntries'NonNullableData,
...
data Treasury'transactionFlowDetails'NonNullable = Treasury'transactionFlowDetails'NonNullable {
  ...
  -- | inbound_transfer: Use [InboundTransfers](https:\/\/docs.stripe.com\/docs\/treasury\/moving-money\/financial-accounts\/into\/inbound-transfers) to add funds to your [FinancialAccount](https:\/\/stripe.com\/docs\/api\#financial_accounts) via a PaymentMethod that is owned by you. The funds will be transferred via an ACH debit.
  -- 
  ...
  , GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'transactionFlowDetails'NonNullable
...
mkTreasury'transactionFlowDetails'NonNullable = Treasury'transactionFlowDetails'NonNullable{treasury'transactionFlowDetails'NonNullableCreditReversal = GHC.Maybe.Nothing,
...
data Treasury'transactionFlowDetails'NonNullableType' =
   Treasury'transactionFlowDetails'NonNullableType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'transactionFlowDetails'NonNullableType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'transactionFlowDetails'NonNullableType'EnumCreditReversal -- ^ Represents the JSON value @"credit_reversal"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumDebitReversal -- ^ Represents the JSON value @"debit_reversal"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumInboundTransfer -- ^ Represents the JSON value @"inbound_transfer"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumIssuingAuthorization -- ^ Represents the JSON value @"issuing_authorization"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumOther -- ^ Represents the JSON value @"other"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumOutboundPayment -- ^ Represents the JSON value @"outbound_payment"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumOutboundTransfer -- ^ Represents the JSON value @"outbound_transfer"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumReceivedCredit -- ^ Represents the JSON value @"received_credit"@
  | Treasury'transactionFlowDetails'NonNullableType'EnumReceivedDebit -- ^ Represents the JSON value @"received_debit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'transactionFlowDetails'NonNullableType'
    where {toJSON (Treasury'transactionFlowDetails'NonNullableType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'transactionFlowDetails'NonNullableType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_reversal" -> Treasury'transactionFlowDetails'NonNullableType'EnumCreditReversal
...
data Treasury'transactionFlowType' =
   Treasury'transactionFlowType'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'transactionFlowType'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'transactionFlowType'EnumCreditReversal -- ^ Represents the JSON value @"credit_reversal"@
  | Treasury'transactionFlowType'EnumDebitReversal -- ^ Represents the JSON value @"debit_reversal"@
  | Treasury'transactionFlowType'EnumInboundTransfer -- ^ Represents the JSON value @"inbound_transfer"@
  | Treasury'transactionFlowType'EnumIssuingAuthorization -- ^ Represents the JSON value @"issuing_authorization"@
  | Treasury'transactionFlowType'EnumOther -- ^ Represents the JSON value @"other"@
  | Treasury'transactionFlowType'EnumOutboundPayment -- ^ Represents the JSON value @"outbound_payment"@
  | Treasury'transactionFlowType'EnumOutboundTransfer -- ^ Represents the JSON value @"outbound_transfer"@
  | Treasury'transactionFlowType'EnumReceivedCredit -- ^ Represents the JSON value @"received_credit"@
  | Treasury'transactionFlowType'EnumReceivedDebit -- ^ Represents the JSON value @"received_debit"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'transactionFlowType'
    where {toJSON (Treasury'transactionFlowType'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'transactionFlowType'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "credit_reversal" -> Treasury'transactionFlowType'EnumCreditReversal
...
data Treasury'transactionStatus' =
   Treasury'transactionStatus'Other Data.Aeson.Types.Internal.Value -- ^ This case is used if the value encountered during decoding does not match any of the provided cases in the specification.
  | Treasury'transactionStatus'Typed Data.Text.Internal.Text -- ^ This constructor can be used to send values to the server which are not present in the specification yet.
  | Treasury'transactionStatus'EnumOpen -- ^ Represents the JSON value @"open"@
  | Treasury'transactionStatus'EnumPosted -- ^ Represents the JSON value @"posted"@
  | Treasury'transactionStatus'EnumVoid -- ^ Represents the JSON value @"void"@
  deriving (GHC.Show.Show, GHC.Classes.Eq)
instance Data.Aeson.Types.ToJSON.ToJSON Treasury'transactionStatus'
    where {toJSON (Treasury'transactionStatus'Other val) = val;
...
instance Data.Aeson.Types.FromJSON.FromJSON Treasury'transactionStatus'
    where {parseJSON val = GHC.Base.pure (if | val GHC.Classes.== "open" -> Treasury'transactionStatus'EnumOpen
